...
export const FALLBACK_BRIDGE_ENDPOINTS = ["https://45.147.121.152:8434/", "https://192.168.0.200:8434/"] as const;
...
export const FALLBACK_RUNTIME_DEFAULTS = {
    ...
    broadcastTargets: [],
    clipboardPeerTargets: ["https:443", "https:8434", "http:8080", "http:80"],
    pollInterval: 100,
    httpTimeoutMs: 10000,
    secret: ""
} as const;
