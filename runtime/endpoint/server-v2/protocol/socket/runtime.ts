...
export class ServerV2SocketRuntime {
    ...
    private resolveBridgePreconnectTargets(): string[] {
        ...
        // WHY: bridge.endpoints / endpointUrl are coordinator origins (often self + peers),
        // NOT dial targets. Using them here forced endless initiate to offline L-110 via
        // network.json `https://192.168.0.110:8434/`.
        const rawTargets = [
