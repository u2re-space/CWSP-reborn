 ...
 * Default: https://127.0.0.1:8434/ (local). Use explicit URL for remote (e.g. https://45.147.121.152:8434/).
 */
...
const defaultUrl = "https://127.0.0.1:8434/";
...
req.on("error", (err) => {
    ...
    if (code === "ECONNREFUSED") {
        ...
        if (url.hostname !== "127.0.0.1" && url.hostname !== "localhost") {
            console.error("To check local only: npm run status:url -- https://127.0.0.1:8434/");
        }
