...
var clearCrxPublicTokenHint = async () => {
	try {
		if (typeof chrome === "undefined" || !chrome?.storage?.local) return;
...
*/
var showCrxControlPairModal = async (opts) => {
	ensureStyle();
...
//#endregion
export { clearCrxPublicTokenHint, showCrxControlPairModal };
