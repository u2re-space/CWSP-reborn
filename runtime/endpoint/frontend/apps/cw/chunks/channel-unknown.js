import { I as H, h as getSpeechPrompt, n as getCachedComponent, p as createTemplateManager, r as createFileHandler } from "../vendor/culori.js";
...
import { _ as validateReadableFileForIngress, g as validateIngressBeforeViewHandle, h as textIngressLooksCorrupt, m as pickAuthoritativeTransferFiles, v as settleIngressPaintForMinimalShell } from "../com/service.js";
import views_default from "./views2.js";
import { a as fetchSwCachedEntries } from "../com/app19.js";
	...
	*/
	...
	const renderHistoryView = async () => {
      ...
      <span>Loading History...</span>
		...
		content.append(loadingElement);
		try {
			const historyManager = (await getCachedComponent("history-manager", () => import("../vendor/culori.js").then((n) => n.t), { componentName: "HistoryManager" })).component.createHistoryManager();
	...
	const runPrompt = async (promptText, customAIFunction) => {
		...
		try {
			const res = customAIFunction ? await customAIFunction(input, { useActiveInstruction: true }) : await (await import("../vendor/@toon-format_toon.js").then((n) => n.n)).recognizeByInstructions(input, instructions);
		...
		try {
			...
			const renderer = {
				...
				"file-explorer": async () => {
					...
					await loadComponent("file-explorer", () => import("../com/app7.js"), { componentName: "FileManager" });
