...
var network_default = "@layer ui-network{.cw-network-view,.cw-network-view-host{block-size:100%;display:flex;flex-direction:column;min-block-size:0;overflow:hidden}.cw-network-view{background:var(--c2-surface,light-dark(#f5f5f5,#121212));color:var(--c2-on-surface,light-dark(#1a1a1a,#e8e8e8));font-family:system-ui,sans-serif;gap:0}.cw-network-view__header{flex:0 0 auto;padding:.85rem 1rem .65rem}.cw-network-view__header h1{font-size:1.15rem;font-weight:650;margin:0}.cw-network-view__header p{font-size:.88rem;margin:.25rem 0 0;opacity:.78}.cw-network-body{display:flex;flex:1 1 auto;flex-direction:column;gap:.75rem;min-block-size:0;overflow:auto;overscroll-behavior:contain;padding:0 1rem .75rem}.cw-network-status-grid{display:grid;gap:.55rem}.cw-network-status-card{background:light-dark(rgba(255,255,255,.72),rgba(255,255,255,.04));border:1px solid light-dark(rgba(0,0,0,.08),rgba(255,255,255,.1));border-radius:10px;display:grid;gap:.35rem;justify-content:start;justify-items:start;padding:.65rem .75rem;text-align:start}.cw-network-status-card[data-state=ok]{border-color:color-mix(in oklab,#2e7d32 55%,transparent)}.cw-network-status-card[data-state=bad]{border-color:color-mix(in oklab,#c62828 55%,transparent)}.cw-network-status-card[data-state=warn]{border-color:color-mix(in oklab,#ef6c00 55%,transparent)}.cw-network-status-card__title{font-size:.78rem;letter-spacing:.04em;opacity:.72;text-transform:uppercase}.cw-network-status-card__value{font-size:1rem;font-weight:600;word-break:break-word}.cw-network-status-card__detail{font-size:.82rem;opacity:.88;word-break:break-word}.cw-network-actions{display:flex;flex-wrap:wrap;gap:.5rem}.cw-network-actions button{appearance:none;background:light-dark(#fff,#1e1e1e);border:1px solid light-dark(rgba(0,0,0,.12),rgba(255,255,255,.14));border-radius:999px;color:inherit;cursor:pointer;font-size:.88rem;padding:.45rem .85rem}.cw-network-actions button:disabled{cursor:wait;opacity:.55}.cw-network-actions--logs button{font-size:.8rem}.cw-network-dest-field{display:flex;flex-direction:column;font-size:.88rem;gap:.35rem}.cw-network-dest-field input{appearance:none;background:light-dark(#fff,#1e1e1e);border:1px solid light-dark(rgba(0,0,0,.12),rgba(255,255,255,.14));border-radius:.5rem;color:inherit;font-size:.9rem;padding:.5rem .75rem}.cw-network-dest-hint{font-size:.8rem;margin:0;opacity:.8}.cw-network-probes{min-block-size:0}.cw-network-probes,.cw-network-probes [data-probe-list]{display:flex;flex-direction:column;flex-wrap:nowrap;gap:.45rem;min-block-size:max-content}.cw-network-probes h2{font-size:.95rem;margin:0}.cw-network-probe-row{background:light-dark(rgba(0,0,0,.04),rgba(255,255,255,.05));border-radius:8px;display:grid;font-size:.82rem;gap:.15rem;min-block-size:max-content;padding:.55rem .65rem}.cw-network-probe-row[data-ok=true]{box-shadow:inset 3px 0 0 #2e7d32}.cw-network-probe-row[data-ok=false]{box-shadow:inset 3px 0 0 #c62828}.cw-network-probe-row__head{display:flex;font-weight:600;gap:.5rem;justify-content:space-between}.cw-network-probe-row__error{color:#c62828;word-break:break-word}.cw-network-log-panel{background:light-dark(rgba(0,0,0,.03),rgba(0,0,0,.22));border-block-start:1px solid light-dark(rgba(0,0,0,.1),rgba(255,255,255,.12));display:flex;flex:0 0 auto;flex-direction:column;flex-wrap:nowrap;gap:.35rem;justify-content:start;justify-items:start;max-block-size:min(32vh,11rem);min-block-size:0;min-block-size:max-content;padding:.55rem 1rem .85rem;text-align:start}.cw-network-log-panel__title{flex:0 0 auto;font-size:.72rem;letter-spacing:.04em;margin:0;opacity:.72;text-transform:uppercase}.cw-network-log{background:light-dark(rgba(0,0,0,.05),rgba(0,0,0,.35));border-radius:8px;flex:1 1 auto;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.75rem;justify-content:start;justify-items:start;line-height:1.35;margin:0;min-block-size:3.5rem;overflow:auto;padding:.55rem .65rem;text-align:start;white-space:pre-wrap;word-break:break-word}.cw-network-dropzone{background:light-dark(rgba(37,99,235,.04),rgba(37,99,235,.1));border:1.5px dashed light-dark(rgba(0,0,0,.28),rgba(255,255,255,.28));border-radius:10px;margin:.75rem 1rem 0;outline:none;padding:1rem 1.1rem;transition:border-color .15s ease,background .15s ease}.cw-network-dropzone:focus-visible{border-color:light-dark(#2563eb,#60a5fa);box-shadow:0 0 0 2px light-dark(rgba(37,99,235,.25),rgba(96,165,250,.35))}.cw-network-dropzone.is-dragover{background:light-dark(rgba(37,99,235,.12),rgba(37,99,235,.22));border-color:light-dark(#2563eb,#60a5fa)}.cw-network-dropzone__title{font-size:.95rem;font-weight:650}.cw-network-dropzone__hint{font-size:.82rem;margin:.35rem 0 0;opacity:.78}.cw-network-dropzone__status{font-size:.8rem;margin-top:.55rem;min-block-size:1.1em;opacity:.9}}";
//#endregion
