	...
	*/
	...
	const renderHistoryView = async () => {
      ...
      <span>Loading History...</span>
		...
		content.append(loadingElement);
		try {
			const historyManager = (await getCachedComponent("history-manager", () => import("./app.js").then((n) => n.y), { componentName: "HistoryManager" })).component.createHistoryManager();
		...
		try {
			...
			const renderer = {
				"settings": async () => {
					...
					const settingsEl = (await loadComponent("settings", () => import("../chunks/src8.js"), { componentName: "Settings" })).component.createSettingsView({
				...
				"file-explorer": async () => {
					...
					await loadComponent("file-explorer", () => import("../chunks/src5.js"), { componentName: "FileManager" });
