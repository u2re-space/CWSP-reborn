...
import { A as elementPointerMap, L as vector2Ref, R as registerModal, k as createShapedTileShadow, l as handleIncomingEntries, v as pointerAnchorRef, z as navigate } from "./app2.js";
import "../fest/icon.js";
...
function SpeedDial(makeView) {
	...
	const tileShapeForItem = (item) => {
		String(getSpeedDialMeta(item.id)?.shape || "squircle").toLowerCase();
