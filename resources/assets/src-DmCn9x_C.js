import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{Mt as t,a as n,ft as r,kt as i}from"./HistoryManager-5Sa1FlA6.js";import{t as a}from"./src-mG6hxM_E.js";import{a as o,n as s}from"./channel-actions-DC9DgSYV.js";import{a as c,dispatchHistoryAction as l,getTransferHistoryStore as u,historyImageSrc as d,i as f,n as p,o as m,r as h,s as g,setTransferHistoryUiActive as _,startCapacitorTransferHistory as v,startNeutralinoTransferHistory as y,t as b}from"./transfer-history-runtime-BN40YXfL.js";var x,S=e((()=>{x=`/*
...
@layer view.history {
  ...
  .view-history {
    ...
    color: var(--vh-fg);
    color: contrast-color(var(--vh-bg));
  ...
  .view-history__clear-btn {
    ...
    color: contrast-color(color-mix(in oklab, var(--vh-danger) 12%, var(--vh-bg)));
  ...
  .view-history__clear-btn:hover {
    ...
    color: contrast-color(color-mix(in oklab, var(--vh-danger) 22%, var(--vh-bg)));
  }
  .view-history__list {
    flex: 1;
    min-block-size: 0;
  ...
  .view-history__item {
    ...
    color: var(--vh-fg);
    color: contrast-color(var(--vh-item-bg));
  ...
  .view-history__action-btn {
    ...
    color: contrast-color(color-mix(in oklab, var(--vh-primary) 14%, var(--vh-item-bg)));
  ...
  .view-history__action-btn:hover {
    ...
    color: contrast-color(color-mix(in oklab, var(--vh-primary) 24%, var(--vh-item-bg)));
  }
  ...
  .view-history__action-btn[data-action=accept], .view-history__action-btn[data-action=reveal], .view-history__action-btn[data-action=download], .view-history__action-btn[data-action=open] {
    ...
    color: contrast-color(var(--vh-primary));
  }
  .view-history__action-btn[data-action=remove], .view-history__action-btn[data-action=decline], .view-history__action-btn[data-action=cancel] {
    ...
    color: light-dark(#b71c1c, #ff8a80);
    color: contrast-color(color-mix(in oklab, var(--vh-danger) 14%, var(--vh-item-bg)));
  }
  .view-history__action-btn[data-action=dismiss] {
    ...
    color: var(--vh-fg);
    color: contrast-color(color-mix(in oklab, var(--vh-fg) 8%, var(--vh-item-bg)));
  }
