import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{At as t,J as n,Kt as r,Q as i,X as a,et as o,ft as s,jt as c,nt as l}from"./HistoryManager-5Sa1FlA6.js";import{_ as u,d,g as f,u as p}from"./registry-CmNmVMFX.js";import{n as m,t as h}from"./preload-helper-NDuSAHbO.js";import{a as g,i as _,n as v,r as y,t as b}from"./Canvas-2-BWwv8dPc.js";import{t as x}from"./src-BDKAvpBs.js";import{n as ee}from"./CSSIconRegistry-D88SYH0A.js";import{n as S,t as C}from"./shells-BUoQgQNR.js";import{i as te,n as w,r as T,t as E}from"./shell-slots-CDiat5LT.js";import{a as ne,c as re,d as D,f as O,h as k,i as A,l as j,m as M,n as N,o as P,p as F,r as ie,s as ae,t as oe,u as I}from"./src-fyM50C3T.js";var L=e((()=>{})),R,se,z,B,ce,le,ue,de,V,fe=e((()=>{s(),R=new WeakMap,se=r(),z=e=>e?.naturalWidth||e?.width||1,B=e=>e?.naturalHeight||e?.height||1,ce=(e,t,n=1,r,i=0)=>{let a=e.canvas;e.translate(a.width/2,a.height/2),e.rotate((-i||0)*(Math.PI*.5)),e.rotate((1-r)*(Math.PI/2)),e.translate(-(z(t)/2)*n,-(B(t)/2)*n)},le=e=>(!R.has(e)&&(e instanceof Blob||e instanceof File||e instanceof OffscreenCanvas||e instanceof ImageBitmap||e instanceof Image)&&R.set(e,createImageBitmap(e)),R.get(e)),ue=new WeakMap,de=(e,t)=>ue?.getOrInsertComputed?.(e,()=>e?.bind?.(t)),V=null,V=typeof HTMLCanvasElement<`u`?class extends HTMLCanvasElement{static observedAttributes=[`data-src`,`data-orient`,`orient`];ctx=null;image=null;#e=[1,1];#t=``;#n=``;get#i(){let e=this.getAttribute(`data-orient`)??this.getAttribute(`orient`)??`0`,t=Number.parseInt(e,10);return Number.isFinite(t)?t:0}set#i(e){let t=String(e);this.setAttribute(`data-orient`,t),this.setAttribute(`orient`,t)}attributeChangedCallback(e,t,n){e==`data-src`&&this.#a(n),(e==`data-orient`||e==`orient`)&&this.#o(this.#n)}connectedCallback(){let e=this.parentNode;this.style.setProperty(`max-inline-size`,`min(100%, min(100cqi, 100dvi))`),this.style.setProperty(`max-block-size`,`min(100%, min(100cqb, 100dvb))`),this.#e=[Math.min(Math.min(Math.max(this.clientWidth||e?.clientWidth||1,1),e?.clientWidth||1)*(this.currentCSSZoom||1),screen?.width||1)*(devicePixelRatio||1),Math.min(Math.min(Math.max(this.clientHeight||e?.clientHeight||1,1),e?.clientHeight||1)*(this.currentCSSZoom||1),screen?.height||1)*(devicePixelRatio||1)],this.#a(this.#t=this.dataset.src||this.#t),this.image&&this.#o(this.#n)}constructor(){super();let e=this,t=this.parentNode,n=()=>{let e=this.#e;this.#e=[Math.min(Math.min(Math.max(this.clientWidth||t?.clientWidth||1,1),t?.clientWidth||1)*(this.currentCSSZoom||1),screen?.width||1)*(devicePixelRatio||1),Math.min(Math.min(Math.max(this.clientHeight||t?.clientHeight||1,1),t?.clientHeight||1)*(this.currentCSSZoom||1),screen?.height||1)*(devicePixelRatio||1)],(e?.[0]!=this.#e[0]||e?.[1]!=this.#e[1])&&this.#o(this.#n)};se?.shedule?.(()=>{this.ctx=e.getContext(`2d`,{alpha:!0,desynchronized:!0,powerPreference:`high-performance`,preserveDrawingBuffer:!0,colorSpace:`rec2100-hlg`}),this.ctx?.configureHighDynamicRange?.({mode:`extended`}),e?.configureHighDynamicRange?.({mode:`extended`}),this.inert=!0,this.style.objectFit=`cover`,this.style.objectPosition=`center`,this.classList.add(`u-canvas`),this.classList.add(`u2-canvas`),this.classList.add(`ui-canvas`),this.style.setProperty(`max-inline-size`,`min(100%, min(100cqi, 100dvi))`),this.style.setProperty(`max-block-size`,`min(100%, min(100cqb, 100dvb))`),this.style.setProperty(`dynamic-range-limit`,`no-limit`),this.style.setProperty(`color-space`,`display-p3`),this.style.setProperty(`background-color`,`black`,`important`),this.style.setProperty(`opacity`,`1`,`important`),n(),new ResizeObserver(e=>{for(let t of e){let e=t?.devicePixelContentBoxSize?.[0];if(e){let t=this.#e;this.#e=[Math.max(e.inlineSize||this.width,1),Math.max(e.blockSize||this.height,1)],(t?.[0]!=this.#e[0]||t?.[1]!=this.#e[1])&&this.#o(this.#n)}}}).observe(this,{box:`device-pixel-content-box`}),this.#a(this.#t=this.dataset.src||this.#t)})}async $useImageAsSource(e,t){t||=this.#t;let n=e instanceof ImageBitmap?e:await le(e).catch(console.warn.bind(console));return n&&t==this.#t&&(this.image=n,this.#o(t)),e}$renderPass(e){let t=this,n=this.ctx,r=this.image;if(r&&n&&(e==this.#t||!e)){e&&(this.#n=e),this.width!=this.#e[0]&&(this.width=this.#e[0]),this.height!=this.#e[1]&&(this.height=this.#e[1]),this.style.aspectRatio=`${this.width||1} / ${this.height||1}`;let i=this.#i%2||0,a=+(z(r)<=B(r)),o=Math.max(t[[`height`,`width`][i]]/(a?B(r):z(r)),t[[`width`,`height`][i]]/(a?z(r):B(r)));n.save(),n.clearRect(0,0,t.width,t.height),ce(n,r,o,a,this.#i),n.drawImage(r,0,0,r.width*o,r.height*o),n.restore()}}#a(e){let t=e||this.#t;return this.#t=t,fetch(e,{cache:`force-cache`,mode:`same-origin`,priority:`high`})?.then?.(async e=>this.$useImageAsSource(await e.blob(),t)?.catch(console.warn.bind(console)))?.catch?.(console.warn.bind(console))}#o(e){let t=this.ctx;this.image&&t&&(e==this.#t||!e)&&se?.shedule?.(de(this.$renderPass,this))}}:class{constructor(){}$renderPass(e){}$useImageAsSource(e,t){return e}ctx=null;image=null};try{customElements.define(`ui-canvas`,V,{extends:`canvas`})}catch{}})),pe=e((()=>{L(),g(),y(),fe(),b()})),me,he=e((()=>{me=`/**
...
.esc-overlays {
  ...
  position: relative;
  overflow: visible;
}`}));function H(){return!ye&&!customElements.get(`env-shell-container`)&&(customElements.define(W,ve),ye=!0),ve}function ge(){H();let e=customElements.get(W);if(e)try{return new e}catch(e){console.warn("[env-shell-container] `new` failed, falling back to createElement",e)}return document.createElement(W)}function U(e){return e instanceof HTMLElement&&e.localName===`env-shell-container`}var W,_e,ve,ye,be=e((()=>{he(),w(),W=`env-shell-container`,_e=document.createElement(`template`),_e.innerHTML=`
...
</div>`,ve=class extends HTMLElement{#e=!1;get overlayMount(){return this.#t(),this.shadowRoot?.querySelector(`[data-shell-overlays]`)??null}constructor(){super(),this.#t()}connectedCallback(){this.#t()}#t(){if(this.#e&&this.shadowRoot)return;let e=this.shadowRoot??this.attachShadow({mode:`open`});if(e.querySelector(`.esc-stack`)||e.appendChild(_e.content.cloneNode(!0)),e.adoptedStyleSheets.length===0){let t=new CSSStyleSheet;t.replaceSync(me),e.adoptedStyleSheets=[t]}this.#e=!0}},ye=!1}));function xe(e){let t=`[${Se}]`,n=e.querySelector(t);if(n)return n.style.zIndex||(n.style.zIndex=G),n.style.position||(n.style.position=U(e)?`absolute`:`fixed`),n;let r=document.createElement(`div`);return r.setAttribute(Se,``),r.className=`env-shell-overlays`,r.setAttribute(`data-part`,`env-overlays`),U(e)?(r.slot=E.overlay,r.style.cssText=`position:absolute;inset:0;pointer-events:none;z-index:${G};box-sizing:border-box;`,e.appendChild(r),r):(r.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${G};box-sizing:border-box;`,e.appendChild(r),r)}var Se,G,Ce=e((()=>{be(),w(),Se=`data-env-shell-overlays`,G=`2147483600`})),we=e((()=>{pe()}));function Te(e,t={}){let{x:n=48,y:r=48,w:a=640,h:s=480,z:c=10,demoRole:l}=t,u=matchMedia(`(max-width: 640px)`);return{demoRole:l,title:e,bounds:{x:o(n),y:o(r),w:o(a),h:o(s)},z:o(c),maximizedMobile:i(u.matches),minimized:i(!1),desktopMaximized:i(!1),nativeMode:i(!1),visible:i(!0),isMobileMq:u}}var Ee=e((()=>{n(),Object.freeze({w:360,h:240})}));function K(e){let t=String(e??``).trim().toLowerCase();t=t.replace(/^#/,``);let n=/^todo:\s*(.*)$/i.exec(t);return n&&(t=String(n[1]??``).trim().toLowerCase()),t=t.replace(/\s+/g,``),t?t===`viewer`||Oe.has(t)?q:t:``}function De(e){return String(e||``).trim().toLowerCase()===q}var q,Oe,ke=e((()=>{q=`viewer`,Oe=new Set([`markdown`,`markdown-view`,`markdown-viewer`,`reader`,`env-viewer`])}));function Ae(e){return!!(e&&typeof e==`object`&&typeof e.render==`function`)}function J(e,t){let n=e?.lifecycle?.[t];typeof n==`function`&&Promise.resolve(n())}function je(e){if(typeof e!=`function`)return!1;try{let t=e.prototype;return!!(t!=null&&typeof HTMLElement<`u`&&HTMLElement.prototype.isPrototypeOf(t))}catch{return!1}}function Me(e,t){let n=e.default??e.createView??e.createHomeView;if(!n||typeof n!=`function`)throw Error(`window-frame view-mount: module has no default/createView factory`);let r=je(n)?new n(t):n(t);if(Ae(r)){let e=r,n=e.render(t);if(!(n instanceof HTMLElement))throw Error(`window-frame view-mount: view.render() must return HTMLElement`);return{root:n,view:e}}if(r instanceof HTMLElement)return{root:r};throw Error(`window-frame view-mount: factory did not return View or HTMLElement`)}function Ne(e,t){return e.replaceChildren(t),()=>{t.remove(),e.replaceChildren()}}async function Pe(e,t,n){let{root:r,view:i}=Me(await e(),n);r.classList.add(`wf-mounted-view`);let a=Ne(t,r);return J(i,`onMount`),J(i,`onShow`),()=>{J(i,`onHide`),J(i,`onUnmount`),a()}}var Fe=e((()=>{}));function Ie(e){let t=e?.closest?.(`.env-shell-root`)??e?.closest?.(`env-shell-container`);if(!(t instanceof HTMLElement))return 0;let n=getComputedStyle(t).getPropertyValue(`--env-window-z-boost`).trim(),r=Number.parseInt(n,10);return Number.isFinite(r)?r:0}function Le(e){let t=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.querySelector?.(`.env-shell-root, env-shell-container`);return t instanceof HTMLElement?t:null}function Y(e){let t=Le(e);if(!t)return;let n=!!t.querySelector?.(`ui-window[native-mode], ui-window[data-native-active]`);t.toggleAttribute(`data-env-native-task`,n)}function Re(e,t,n,r,o={}){let{bounds:s,z:c,maximizedMobile:l,minimized:u,desktopMaximized:d,visible:f,isMobileMq:p}=t;t.nativeMode||=i(!!o.startNative);let m=t.nativeMode;o.startNative&&(m.value=!0);let h=document.createElement(`ui-window`);h.setAttribute(`managed`,``),h.className=`env-ui-window`,h.setAttribute(`part`,`window`);{let e=document.documentElement.getAttribute(`data-theme`)||document.documentElement.style.colorScheme||``;(e===`light`||e===`dark`)&&(h.dataset.theme=e,h.style.colorScheme=e)}let g=document.createElement(`span`);g.slot=`title`,g.className=`env-ui-window__title`,g.textContent=t.title,n.slot=`content`,n.classList.add(`env-ui-window__body`),h.append(g,n),e.appendChild(h);let _=String(o?.managedViewKey??``).trim();_&&(h.setAttribute(`data-ui-window-view`,_),h.setAttribute(`data-wf-managed-view`,_));let v=null,y=()=>{o.onChromeChange?.(),Y(e)},b=()=>{h.style.right=``,h.style.bottom=``},x=()=>{h.style.left=`${X}px`,h.style.top=`${X}px`,h.style.right=`${X}px`,h.style.bottom=`${X}px`,h.style.width=`auto`,h.style.height=`auto`,h.style.removeProperty(`--ui-win-width`),h.style.removeProperty(`--ui-win-height`)},ee=()=>{h.style.left=`0`,h.style.top=`0`,h.style.right=`0`,h.style.bottom=`0`,h.style.width=`100%`,h.style.height=`100%`,h.style.removeProperty(`--ui-win-width`),h.style.removeProperty(`--ui-win-height`)},S=()=>{let t=!!p.matches,n=Ie(e),r=(c.value??10)+n;h.style.zIndex=String(r),t&&(d.value&&=!1,!u.value&&!m.value&&!l.value&&(l.value=!0));let i=!!m.value,a=!!u.value,o=!t&&!!d.value&&!i&&!a,g=t&&!i&&!a,_=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.querySelector?.(`.env-shell-root, env-shell-container`),v=_ instanceof HTMLElement&&_.hasAttribute(`data-status-overlay`)||document.documentElement.hasAttribute(`data-env-status-overlay`),y=_ instanceof HTMLElement&&_.hasAttribute(`data-standalone`)||document.documentElement.hasAttribute(`data-env-standalone`),S=v&&!i&&!a&&(g||o),C=y&&t&&!i&&!a;if(h.toggleAttribute(`native-mode`,i&&!a),h.toggleAttribute(`minimized`,a),h.toggleAttribute(`data-mobile-max`,g),h.toggleAttribute(`data-desk-max`,o),h.toggleAttribute(`data-status-gap`,S),h.toggleAttribute(`data-no-titlebar`,C),h.toggleAttribute(`maximized`,!a&&(o||g||i)),a){h.setVisible(!1),Y(e);return}if(h.setVisible(!!f.value),!f.value){Y(e);return}if(i){ee(),Y(e);return}if(g){h.style.left=`0`,h.style.top=`0`,h.style.right=`0`,h.style.bottom=`var(--env-mobile-dock-reserve, 3.25rem)`,h.style.width=`100%`,h.style.height=`auto`,Y(e);return}if(o){x(),Y(e);return}b(),h.applyBounds({x:s.x.value,y:s.y.value,w:s.w.value,h:s.h.value,z:r}),Y(e)},C=()=>{p.matches&&(m.value||(l.value=!0),d.value&&(d.value=!1,v&&=(s.x.value=v.x,s.y.value=v.y,s.w.value=v.w,s.h.value=v.h,null))),S(),y()},te=a(()=>{S()},[s.x,s.y,s.w,s.h,c,l,u,d,m,f],{triggerImmediately:!0});p.addEventListener(`change`,C),C();let w=()=>{S(),y()},T=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.documentElement;T?.addEventListener?.(`env-chrome-surface`,w);let E=()=>{u.value&&(u.value=!1,f.value=!0),r();let t=Ie(e),n=(c.value??10)+t;typeof h.bringToFront==`function`?h.bringToFront(n):(h.style.zIndex=String(n),h.toggleAttribute(`data-focused`,!0)),y()},ne=e=>{let t=e.detail;m.value||d.value||l.value||u.value||(typeof t?.x==`number`&&(s.x.value=t.x),typeof t?.y==`number`&&(s.y.value=t.y))},re=e=>{let t=e.detail;m.value||d.value||l.value||u.value||(typeof t?.w==`number`&&(s.w.value=t.w),typeof t?.h==`number`&&(s.h.value=t.h))},D=()=>{m.value&&=!1,d.value&&(d.value=!1,v&&=(s.x.value=v.x,s.y.value=v.y,s.w.value=v.w,s.h.value=v.h,null)),u.value=!0,S(),y()},O=()=>{if(m.value){A();return}if(p.matches){u.value=!1,l.value=!0,S(),y();return}if(u.value&&=!1,d.value){j();return}v={x:s.x.value,y:s.y.value,w:s.w.value,h:s.h.value},d.value=!0,S(),y()},k=()=>{u.value&&(u.value=!1,f.value=!0),!m.value&&!d.value&&!l.value&&(v={x:s.x.value,y:s.y.value,w:s.w.value,h:s.h.value}),d.value=!1,l.value=!1,m.value=!0,S(),y()},A=()=>{m.value&&(m.value=!1,v&&=(s.x.value=v.x,s.y.value=v.y,s.w.value=v.w,s.h.value=v.h,null),p.matches&&(l.value=!0),S(),y())},j=()=>{if(m.value){A();return}u.value&&(u.value=!1,f.value=!0),p.matches?l.value&&=!1:d.value&&(d.value=!1,v&&=(s.x.value=v.x,s.y.value=v.y,s.w.value=v.w,s.h.value=v.h,null)),S(),y()},M=!1,N=!1,P=t=>{if(t.preventDefault(),!(M||N)){M=!0;try{m.value&&=!1,f.value=!1,o.onClose?.()}catch(e){console.error(`[mount-ui-window] onClose failed`,e)}finally{if(!N){N=!0,te?.(),p.removeEventListener(`change`,C),T?.removeEventListener?.(`env-chrome-surface`,w);try{h.isConnected&&h.remove()}catch{}}Y(e)}}},F=0,ie=()=>{let e=typeof performance<`u`?performance.now():Date.now();return e-F<280?!1:(F=e,!0)},ae=e=>{if(!(M||N)&&ie()){if(e===`close`){P(new Event(`window-close`,{cancelable:!0}));return}if(e===`exit-native`){A();return}if(e===`maximize`){m.value||d.value||l.value?j():O();return}u.value?j():D()}},oe=e=>{let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t){if(!(e instanceof Element))continue;let t=e.getAttribute?.(`data-ui-win-action`);if(t===`close`||t===`exit-native`||t===`maximize`||t===`minimize`)return t;if(e.matches?.(`.title-close`))return`close`;if(e.matches?.(`.title-exit-native`))return`exit-native`;if(e.matches?.(`.title-maximize`))return`maximize`;if(e.matches?.(`.title-minimize`))return`minimize`}return null},I=e=>{if(M||N||e.defaultPrevented)return;let t=oe(e);t&&(e.preventDefault(),e.stopPropagation(),ae(t))},L=null,R=()=>{let e=h.shadowRoot;if(!e||M||N)return;let t=e.querySelectorAll(`[data-ui-win-action], .title-minimize, .title-maximize, .title-close, .title-exit-native`);for(let e of t){let t=e.getAttribute(`data-ui-win-action`);if(t||(e.classList.contains(`title-close`)?t=`close`:e.classList.contains(`title-exit-native`)?t=`exit-native`:e.classList.contains(`title-maximize`)?t=`maximize`:e.classList.contains(`title-minimize`)&&(t=`minimize`)),!t)continue;e.setAttribute(`data-ui-win-action`,t);let n=t,r=e=>{e.defaultPrevented||(e.preventDefault(),e.stopPropagation(),ae(n))};e.onclick=r,e.onpointerup=e=>{e.button===0&&r(e)}}};if(R(),queueMicrotask(R),requestAnimationFrame(R),typeof MutationObserver<`u`){L=new MutationObserver(()=>R());let e=()=>{h.shadowRoot?L?.observe(h.shadowRoot,{childList:!0,subtree:!0}):requestAnimationFrame(e)};e()}return h.addEventListener(`window-focus`,E),h.addEventListener(`window-move`,ne),h.addEventListener(`window-resize`,re),h.addEventListener(`window-minimize`,D),h.addEventListener(`window-maximize`,O),h.addEventListener(`window-restore`,j),h.addEventListener(`window-native`,k),h.addEventListener(`window-exit-native`,A),h.addEventListener(`window-close`,P),h.addEventListener(`click`,I),h.addEventListener(`pointerup`,I),()=>{if(!N){N=!0,M=!0,te?.(),L?.disconnect(),L=null,p.removeEventListener(`change`,C),T?.removeEventListener?.(`env-chrome-surface`,w),h.removeEventListener(`window-focus`,E),h.removeEventListener(`window-move`,ne),h.removeEventListener(`window-resize`,re),h.removeEventListener(`window-minimize`,D),h.removeEventListener(`window-maximize`,O),h.removeEventListener(`window-restore`,j),h.removeEventListener(`window-native`,k),h.removeEventListener(`window-exit-native`,A),h.removeEventListener(`window-close`,P),h.removeEventListener(`click`,I),h.removeEventListener(`pointerup`,I);try{m.value&&=!1,h.isConnected&&h.remove()}catch{}Y(e)}}}var X,ze=e((()=>{n(),oe(),X=8}));function Z(e,t){let n=typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(t):t.replace(/\\/g,`\\\\`).replace(/"/g,`\\"`),r=e.querySelector(`:scope > ui-window[data-ui-window-view="${n}"]`)||e.querySelector(`:scope > ui-window[data-wf-managed-view="${n}"]`)||e.querySelector(`:scope > section.wf-frame[data-wf-managed-view="${n}"]`);return r instanceof HTMLElement?r:null}function Be(e){let t=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??e.parentElement;if(!(t instanceof HTMLElement))return 0;let n=getComputedStyle(t).getPropertyValue(`--env-window-z-boost`).trim(),r=Number.parseInt(n,10);return Number.isFinite(r)?r:0}function Ve(e){return null}function Q(e,t){let n=K(e)||String(e||``).trim().toLowerCase();if(t?.[n])return t[n];if(Ge[n])return Ge[n];let r=String(e||``).trim();return r?r.charAt(0).toUpperCase()+r.slice(1):`View`}function He(e,t){let n=document.createElement(`div`);return n.className=`wf-view-placeholder`,n.setAttribute(`part`,`placeholder`),n.innerHTML=`<p class="wf-view-placeholder__title">${Q(e,t)}</p>
<p class="wf-view-placeholder__hint">No window module is registered for this shortcut in environment-shell yet.</p>`,n}function Ue(e,t={}){let n=o(120),r=new Map,i=!1,a=null,s=()=>{t.onTaskingChange?.(c())},c=()=>{let n=[];for(let i of r.values())Z(e,i.key)&&n.push({id:i.key,title:i.model.title||Q(i.key,t.viewTitles),icon:We[i.key]||`app-window`,focused:a===i.key,minimized:!!i.model.minimized.value,visible:!!i.model.visible.value});return n},l=()=>{for(let t of r.values()){let n=Z(e,t.key);if(!n)continue;n.toggleAttribute(`data-focused`,!1);let r=n.clearFocused;typeof r==`function`&&r.call(n)}},u=e=>{for(let[t,n]of r)e&&t===e||n.model.nativeMode?.value&&(n.model.nativeMode.value=!1)},d=(t,r)=>{if(a===r&&!t.minimized.value){let t=Z(e,r);if(t&&t===e.lastElementChild)return}n.value+=1,t.z.value=n.value,t.minimized.value=!1,t.visible.value=!0,a=r,t.nativeMode?.value&&u(r);let i=Z(e,r);if(i){let n=Be(e),r=(t.z.value??10)+n;l(),i.style.zIndex=String(r),i.toggleAttribute(`data-focused`,!0);let a=i.bringToFront;typeof a==`function`&&a.call(i,r),i.parentElement===e&&e.appendChild(i)}s()},f={},p=t.overlayMountHost?xe(t.overlayMountHost):null;f.resolveOverlayMountPoint=e=>{if(p)return p;if(t.environmentShellHost){let e=te(t.environmentShellHost);if(e)return e}return T(e??null)};let m=e=>{let n=K(e)||String(e||``).trim().toLowerCase();return t.viewLoaders?.[n]||Ve(n)},h=()=>{let i=t.readerWindow;if(!i?.content)return;let o=q,c=r.get(o);if(c&&Z(e,o)){d(c.model,o);return}if(c&&!Z(e,o)){r.delete(o);try{c.disposeFrame()}catch{}}let l=i.seed||{},u=Te(i.title||Q(o,t.viewTitles),{x:l.x??96,y:l.y??96,w:l.w??420,h:l.h??340,z:l.z??n.value+1});n.value=u.z.value;let f=()=>{};f=Re(e,u,i.content,()=>d(u,o),{managedViewKey:o,onChromeChange:s,onClose:()=>{let e=r.get(o);if(e){r.delete(o),a===o&&(a=null);try{e.disposeFrame()}catch{}s()}}}),r.set(o,{key:o,model:u,disposeFrame:f}),d(u,o)},g=(o,c)=>{if(i)return;let l=K(String(o||``));if(!l||l===`home`||l===`airpad`)return;if(De(l)&&t.readerWindow?.content){h();return}let p=new Set((t.startNativeViewIds||[]).map(e=>K(String(e||``)))).has(l)||String(c?.native||``)===`1`||String(c?.params?.native||``)===`1`,g=r.get(l);if(g&&Z(e,l)){d(g.model,l),p&&g.model.nativeMode&&(g.model.nativeMode.value=!0,g.model.minimized.value=!1,g.model.visible.value=!0,u(l));return}if(g&&!Z(e,l)){g.disposeView?.(),r.delete(l);try{g.disposeFrame()}catch{}}let _=m(l),v=document.createElement(`div`);v.className=`wf-view-host env-ui-window__view-host`,v.setAttribute(`part`,`view-host`);{let e=document.createElement(`p`);e.className=`wf-view-placeholder__hint`,e.style.cssText=`margin:1rem;font:400 .9rem/1.4 system-ui,sans-serif;opacity:.8`,e.textContent=`Loading ${Q(l,t.viewTitles)}…`,v.append(e)}let y=r.size*24,b=Te(Q(l,t.viewTitles),{x:72+y,y:72+y,w:640,h:480,z:n.value+1});n.value=b.z.value;let x=()=>{};x=Re(e,b,v,()=>d(b,l),{managedViewKey:l,startNative:p,onChromeChange:s,onClose:()=>{let e=r.get(l);if(e){r.delete(l),a===l&&(a=null);try{e.disposeView?.()}catch{}try{e.disposeFrame()}catch{}s()}}}),p&&(b.nativeMode.value=!0,u(l));let ee={key:l,model:b,disposeFrame:x,disposeView:void 0};r.set(l,ee),d(b,l);let S={...c||{},shellContext:f};if(!_){v.replaceChildren(He(l,t.viewTitles));return}Pe(_,v,S).then(e=>{if(i){e();return}let t=r.get(l);t&&(t.disposeView=e),(p||b.nativeMode?.value)&&(b.nativeMode.value=!0,b.minimized.value=!1,b.visible.value=!0,u(l),d(b,l))},e=>{console.error(`[workspace-window-layer] mountViewModule failed for view "${l}"`,e),v.replaceChildren(He(l,t.viewTitles))})};return f.navigate=(e,t)=>{g(String(e),t)},f.openView=(e,t)=>{g(String(e),t)},{shellContext:f,dispose:()=>{if(!i){i=!0;for(let e of r.values())e.disposeView?.(),e.disposeFrame();r.clear(),a=null,s()}},focusWindow:t=>{let n=K(String(t||``)),i=r.get(n);return!i||!Z(e,n)?!1:(d(i.model,n),!0)},minimizeWindow:t=>{let n=K(String(t||``)),i=r.get(n);return!i||!Z(e,n)?!1:(i.model.nativeMode?.value&&(i.model.nativeMode.value=!1),i.model.desktopMaximized?.value&&(i.model.desktopMaximized.value=!1),i.model.visible.value=!0,i.model.minimized.value=!0,a===n&&(a=null,l()),s(),!0)},minimizeAllWindows:()=>{if(!i){u(null),a=null,l();for(let t of r.values())Z(e,t.key)&&(t.model.desktopMaximized?.value&&(t.model.desktopMaximized.value=!1),t.model.visible.value=!0,t.model.minimized.value=!0);s()}},closeWindow:e=>{let t=K(String(e||``)),n=r.get(t);if(!n)return!1;r.delete(t),a===t&&(a=null);try{n.disposeView?.()}catch{}try{n.disposeFrame()}catch{}return s(),!0},blurWindows:()=>{u(null),a=null,l(),s()},closeAllWindows:()=>{if(!i){u(null);for(let e of[...r.values()]){try{e.disposeView?.()}catch{}try{e.disposeFrame()}catch{}}r.clear(),a=null,s()}},enterNative:t=>{let n=K(String(t||``)),i=r.get(n);return!i||!Z(e,n)?!1:(u(n),i.model.nativeMode.value=!0,i.model.minimized.value=!1,i.model.visible.value=!0,d(i.model,n),!0)},exitNative:e=>{if(e){let t=K(String(e||``)),n=r.get(t);n?.model.nativeMode&&(n.model.nativeMode.value=!1),s();return}u(null),s()},listWindowTasks:c,getFocusedKey:()=>a}}var We,Ge,Ke=e((()=>{n(),w(),Ee(),ke(),Fe(),Ce(),ze(),We={home:`house`,viewer:`article`,markdown:`article`,explorer:`books`,settings:`gear-six`,workcenter:`briefcase`,history:`clock-counter-clockwise`,editor:`pencil-simple-line`,network:`wifi-high`,task:`list-checks`,event:`calendar`,bonus:`gift`,person:`address-book`},Ge={home:`Home`,viewer:`Markdown`,explorer:`Explorer`,settings:`Settings`,workcenter:`Work Center`,history:`History`,editor:`Editor`,network:`Network`,task:`Plan`,event:`Events`,bonus:`Bonuses`,person:`Contacts`}}));function qe(e,t=Ye){try{localStorage.getItem(t)||localStorage.setItem(t,e)}catch{}}function Je(e,t){let n=A(),{element:r,dispose:i}=j(t.shell,t.introHtml,n),a=document.createElement(`div`);a.className=`env-shell-chrome wf-chrome-no-select`;let o;t.taskbar?(o=ie({...t.taskbar,device:n}),a.append(o.element,r)):a.append(r);let s=(e.classList?.contains(`env-shell-root`)?e:null)||e.closest?.(`.env-shell-root`)||e.closest?.(`env-shell-container`)||e;k(s),globalThis.__ENV_OVERLAY_MOUNT__=xe,xe(s),O();let c=typeof matchMedia==`function`?matchMedia(`(min-width: 641px) and (not ((pointer: coarse) or (hover: none)))`):null,l=typeof matchMedia==`function`?[`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`,`(display-mode: window-controls-overlay)`].map(e=>matchMedia(e)):[],u=()=>{let e=!c||c.matches,t=re(),n=ae(),r=I({desktop:e,standalone:n,displayMode:t});a.toggleAttribute(`data-desktop`,e),a.toggleAttribute(`data-standalone`,n),a.toggleAttribute(`data-status-overlay`,r),a.dataset.chromeLayout=e?`desktop`:`mobile`,a.dataset.displayMode=t,s.toggleAttribute(`data-standalone`,n),s.toggleAttribute(`data-status-overlay`,r),s.dataset.displayMode=t,s.style.setProperty(`--env-status-inset-top`,r?`max(2rem, env(safe-area-inset-top, 0px))`:`0px`),document.documentElement.toggleAttribute(`data-env-status-overlay`,r),document.documentElement.toggleAttribute(`data-env-standalone`,n);try{s.dispatchEvent(new CustomEvent(`env-chrome-surface`,{bubbles:!0,detail:{statusOverlay:r,standalone:n,displayMode:t,desktop:e}}))}catch{}};u(),c?.addEventListener?.(`change`,u);for(let e of l)e.addEventListener?.(`change`,u);document.addEventListener(`fullscreenchange`,u),document.addEventListener(`webkitfullscreenchange`,u);let d=ne(s);return U(e)&&(a.slot=E.overlay),e.appendChild(a),{root:a,device:n,statusBar:r,taskbar:o,disposeDevice:()=>{c?.removeEventListener?.(`change`,u);for(let e of l)e.removeEventListener?.(`change`,u);document.removeEventListener(`fullscreenchange`,u),document.removeEventListener(`webkitfullscreenchange`,u),d(),i(),n.dispose(),k(null)}}}var Ye,Xe=e((()=>{P(),N(),be(),Ce(),w(),M(),F(),D(),P(),N(),we(),M(),F(),D(),Ke(),ze(),Ye=`rs-wallpaper-image`})),Ze,Qe=e((()=>{Ze=`*,
*::before,
*::after {
    box-sizing: border-box;
}
...
`})),$e,et=e((()=>{$e=`/* environment-shell — default layout + chrome for wallpaper / home / window-frame hosts.
