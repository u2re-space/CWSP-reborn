import{n as e,r as t}from"./rolldown-runtime-C0FnF6B9.js";import{Gt as n,Wt as r,ft as i,t as a}from"./src-C8p-yYHh.js";import{d as o,u as s}from"./registry-1BhElAAe.js";import{n as c,t as l}from"./preload-helper-DFTwEg7x.js";import{s as u}from"./icon-CJpUOiBC.js";import{_ as d,g as f,n as p,t as m}from"./shells-DieeNVSZ.js";var h;function g(){return(g=e((()=>{h=`/* Minimal shell: layered tokens + nav/content grid, WCO-safe, shadow slot views. */
/*
...
}`})))()}function _(e){return b.has(e)}function v(e){return new x}var y,b,x;function S(){return(S=e((()=>{a(),n(),g(),u(),p(),s(),d(),c(),y=[{id:`viewer`,name:`Markdown`,icon:`eye`},{id:`explorer`,name:`Explorer`,icon:`folder`},{id:`workcenter`,name:`Work Center`,icon:`lightning`},{id:`network`,name:`Network`,icon:`wifi-high`},{id:`settings`,name:`Settings`,icon:`gear`},{id:`history`,name:`History`,icon:`clock-counter-clockwise`}].filter(e=>o(e.id)),b=new Set(y.map(e=>e.id)),x=class extends m{id=`minimal`;name=`Minimal`;layout={hasSidebar:!1,hasToolbar:!0,hasTabs:!1,supportsMultiView:!1,supportsWindowing:!1};createLayout(){let e=i`
