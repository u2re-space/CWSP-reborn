import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{Jt as t,Rt as n,Vt as r,Wt as i,Xt as a,_ as o,c as s,d as c,en as l,f as u,g as d,h as f,jt as p,l as m,m as h,o as g,p as ee,qt as _,s as te,st as v,t as y,u as ne,v as re,y as ie,zt as b}from"./src-OjdqEwqq.js";import{i as ae}from"./src-3hnp4NtN.js";import{B as x,Bt as oe,I as S,L as se,Lt as ce,N as le,Nt as ue,g as C,j as w,jt as de,nt as fe}from"./OPFS-Cs7Zbr2t.js";import{c as pe,g as me,p as he,s as ge,v as T,y as _e}from"./ecosystem-skus-Bz92tN57.js";import{n as E,t as D}from"./preload-helper-DFTwEg7x.js";import{_ as ve,a as ye,g as be,h as xe,n as O,v as Se}from"./registry-sf6h2dtK.js";import{a as Ce,f as we}from"./UnifiedMessaging-BEe_RbsB.js";import{a as k,n as Te,r as Ee,t as De}from"./view-ingress-validation-BFwuw_Yo.js";import{h as Oe,m as ke,o as Ae,p as je,r as Me,s as Ne}from"./open-policy-DV4wO_gQ.js";import{a as Pe,o as A}from"./Settings-Do5aJTKt.js";import{a as Fe,d as j,l as M,u as N}from"./Base64Data-Dn-vYTrP.js";import{i as Ie,o as Le,s as Re}from"./icon-s-qdKq1E.js";import{_ as ze,a as P,c as Be,g as Ve,h as F,i as He,n as Ue,o as We}from"./storage-bridge-DiC3BsE8.js";import{n as Ge,o as Ke,r as qe,s as Je}from"./render-8bB1QlM5.js";import{l as I,n as Ye,s as Xe}from"./sku-ingress-B3NuazEn.js";import{n as Ze,t as Qe}from"./registry-CwGaa-G9.js";import{a as $e,i as L,t as R}from"./channel-actions-DkmBPovk.js";import{a as et,i as tt,r as nt,t as rt}from"./highlight-C6lMFQgI.js";function it(e){return{load(){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}},save(t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}},clear(){try{localStorage.removeItem(e)}catch{}}}}function at(){return v`
        <div
    ...
    `}function st(){let e=v`<div class="view-viewer__chrome" data-viewer-chrome></div>`;return e.append(at(),ot()),e}function z(){return(z=e((()=>{y()})))()}function ct(e){let t=document.createElement(`pre`);t.className=`markdown-viewer-raw`,t.toggleAttribute(`data-raw-target`,!0),t.setAttribute(`aria-label`,`Raw content`),t.hidden=!0,e?.slot&&(t.slot=e.slot);let n=document.createElement(`code`);return n.className=`code-highlight-source`,n.setAttribute(`contenteditable`,`plaintext-only`),n.setAttribute(`spellcheck`,`false`),n.setAttribute(`autocapitalize`,`off`),n.setAttribute(`autocorrect`,`off`),t.appendChild(n),t}function lt(){return(lt=e((()=>{y()})))()}var ut,dt,ft,B;function pt(){return(pt=e((()=>{y(),Ce(),ut=e=>{if(typeof e==`string`||typeof Blob<`u`&&e instanceof Blob)return e;if(e&&typeof e==`object`&&`data`in e){let t=e.data;if(typeof t==`string`||t&&typeof Blob<`u`&&t instanceof Blob)return t}return null},dt=e=>String(e||`attachment`).toLowerCase().replace(/[^a-z0-9-]/g,`-`).replace(/-+/g,`-`).replace(/^-+|-+$/g,``)||`attachment`,ft=async(e,t=`view-ipc`)=>{let n=[];for(let r of e){let e=ut(r);if(e)try{let i=r&&typeof r==`object`&&`source`in r?String(r.source||t):t,a=await N(e,{namePrefix:dt(i),uriComponent:!0});n.push({hash:String(a.hash||``),name:String(a.name||a.file?.name||`attachment`),mimeType:String(a.type||a.file?.type||`application/octet-stream`),size:Number(a.size||a.file?.size||0),source:i,data:a.file})}catch(e){console.warn(`[UniformViewTransport] Attachment normalization failed:`,e)}}return n},B=async e=>{let t=await ft(e.attachments||[],e.source),n={...e.data||{},...t.length>0?{attachments:t,file:t[0]?.data,files:t.map(e=>e.data)}:{}},r=ae({type:e.type,source:e.source,destination:e.destination,contentType:e.contentType,data:n,purpose:e.purpose||(t.length>0?[`attach`,`deliver`]:[`deliver`,`mail`]),protocol:`window`,op:e.op||(t.length>0?`attach`:`deliver`),srcChannel:e.source,dstChannel:e.destination,metadata:{...e.metadata||{},attachmentCount:t.length}});return we(r)}})))()}function mt(e){return e===`light`||e===`dark`?e:typeof globalThis.matchMedia==`function`&&globalThis.matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`}function V(e){if(e===`light`||e===`dark`||e===`system`)return e;if(typeof e==`string`){let t=e.trim().toLowerCase();if(t===`light`||t===`dark`||t===`system`)return t}}function ht(e){if(e!=null){if(typeof e==`string`)return V(e.trim());if(typeof e==`object`){let t=e;return V(t.colorScheme??t.scheme??t.theme)}}}function gt(e){if(e)return e.colorScheme?e.colorScheme:V(e.params?.colorScheme??e.params?.theme)}var H;function _t(){return(_t=e((()=>{H=`/*
...
`)),t)}getFontFamilyFromPreset(){let e=this.markdownSettings.fontFamily;return e===`serif`?`Georgia, Cambria, 'Times New Roman', Times, serif`:e===`mono`?`ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', monospace`:e===`sans`?`Inter, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif`:`ui-sans-serif, system-ui, -apple-system, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif`}applyRenderedLinkBehavior(e){let t=Array.from(e.querySelectorAll(`a[href]`));for(let e of t){let t=(e.getAttribute(`href`)||``).trim();if(!t)continue;let n=t.startsWith(`#`),r=/^(https?:)?\/\//i.test(t);this.markdownSettings.plugins.externalLinksNewTab&&r&&!n?(e.target=`_blank`,e.rel=`noopener noreferrer`):(e.target===`_blank`&&e.removeAttribute(`target`),e.rel===`noopener noreferrer`&&e.removeAttribute(`rel`))}}getPresetVariablesCss(){let e=this.markdownSettings.preset;return e===`classic`?`
            ...
            --md-h2-size: 1.55em;
            --md-p-margin: 0.9em;
        `}buildCustomStyleText(){let e=this.markdownSettings.page.size||`auto`,n=this.markdownSettings.page.orientation||`portrait`,r=Number.isFinite(this.markdownSettings.page.marginMm)?Math.max(5,Math.min(40,this.markdownSettings.page.marginMm)):12,i=Number.isFinite(this.markdownSettings.printScale)?Math.max(.5,Math.min(1.5,this.markdownSettings.printScale)):1,o=Number.isFinite(this.markdownSettings.fontSizePx)?Math.max(12,Math.min(26,this.markdownSettings.fontSizePx)):16,s=Number.isFinite(this.markdownSettings.lineHeight)?Math.max(1.1,Math.min(2.2,this.markdownSettings.lineHeight)):1.7;Number.isFinite(this.markdownSettings.contentMaxWidthPx)&&Math.max(500,Math.min(1400,this.markdownSettings.contentMaxWidthPx));let c=`
