...
}`})),P,F=e((()=>{P=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/*
 * Filename: _tokens.scss
...
}`}));async function I(e){if(L===e)return;console.log(`[Veela] Loading variant:`,e);let t=async e=>{typeof e==`string`&&e.length&&await i(e)};if(e===`core`){await t(M),L=e;return}await t(P),L=e}var L,R=e((()=>{r(),N(),F(),L=null}));async function z(e){let t=B[e]||B[`vl-basic`];if(!t)throw Error(`Unknown style system: ${e}`);if(V===e){console.log(`[Styles] Style system '${e}' already loaded`);return}console.log(`[Styles] Loading style system: ${t.name}`),t.initFn&&await t.initFn(),V=e,console.log(`[Styles] Style system ${t.name} loaded`)}var B,V,he=e((()=>{R(),B={"vl-advanced":{id:`vl-advanced`,name:`Veela Advanced`,description:`Full-featured CSS framework with design tokens and effects`,variant:`advanced`,initFn:async()=>{try{await I(`advanced`),console.log(`[Styles] Veela Advanced loaded`)}catch{}}},"vl-basic":{id:`vl-basic`,name:`Veela Basic Styles`,description:`Lightweight minimal styling for basic functionality`,variant:`basic`,initFn:async()=>{try{await I(`basic`),console.log(`[Styles] Veela Basic Styles loaded`)}catch(e){console.warn(`[Styles] Failed to load Veela Basic Styles:`,e)}}},"vl-beercss":{id:`vl-beercss`,name:`Veela BeerCSS`,description:`Beer CSS compatible styling with Material Design 3`,variant:`beercss`,initFn:async()=>{try{await I(`beercss`),console.log(`[Styles] Veela BeerCSS loaded`)}catch(e){console.warn(`[Styles] Failed to load Veela BeerCSS:`,e)}}},"vl-core":{id:`vl-core`,name:`Veela Core`,description:`Shared foundation styles for all veela variants`,variant:`core`,initFn:async()=>{try{await I(`core`),console.log(`[Styles] Veela Core loaded`)}catch(e){console.warn(`[Styles] Failed to load Veela Core:`,e)}}},raw:{id:`raw`,name:`Raw`,description:`No styling framework, browser defaults`,variant:`core`,initFn:async()=>{console.log(`[Styles] Raw mode - no styles loaded`)}}},V=null})),H,U,W,G,K,q=e((()=>{de(),H=()=>{try{let e=globalThis?.Capacitor;return e&&typeof e==`object`?e:null}catch{return null}},U=e=>{let t=H()?.Plugins?.[e];return t&&typeof t==`object`?t:null},W=async(e,...t)=>{try{return typeof e==`function`?await e(...t):void 0}catch(e){console.warn(`[capacitor-settings-permissions]`,e);return}},G=async e=>{let t=[],n=[],r=!1;if(!w())return{lines:t,results:n,prompted:r};e.shell&&(e.shell.acceptSmsBridgeData=!1,e.shell.enableNativeSms=!1);let i=e.shell||{},a=i.acceptContactsBridgeData===!0,o=(i.bridgeDaemonEnabled??!0)!==!1,s=(i.enableRemoteClipboardBridge??!0)!==!1,c=o||s,l=U(`CwsPlatform`);if(a||c)if(l?.requestSettingsPermissions){let e=await W(l.requestSettingsPermissions,{contacts:a,sms:!1,notifications:c,overlay:!1}),i=!1;if(e&&typeof e==`object`){i=e.prompted===!0,r=i;let t=e.results;if(Array.isArray(t)){for(let e of t)if(e&&typeof e==`object`){let t=String(e.permission??``);if(t===`SYSTEM_ALERT_WINDOW`||t===`READ_SMS`||t===`RECEIVE_SMS`||t===`SEND_SMS`)continue;n.push({permission:t,granted:!!e.granted})}}}let o=n.filter(e=>e.granted===!1);o.length?t.push(`Permission denied: ${o.map(e=>e.permission).filter(Boolean).join(`, `)}`):i&&t.push(`Runtime permissions requested`)}else{let e=U(`DevicePermissions`)||U(`Permissions`),n=[];a&&n.push(`READ_CONTACTS`),c&&n.push(`POST_NOTIFICATIONS`),e?.requestPermissions&&n.length&&(await W(e.requestPermissions,{permissions:n}),t.push(`Runtime permissions requested (legacy plugin)`))}return o&&l?.startCwspBridge?(await W(l.startCwspBridge),t.push(`CWSP foreground service started`)):!o&&l?.stopCwspBridge&&(await W(l.stopCwspBridge),t.push(`CWSP foreground service stopped`)),{lines:t,results:n,prompted:r}},K=async e=>{if(!w()||((e?.shell||{}).bridgeDaemonEnabled??!0)===!1)return!1;e?.shell&&(e.shell.acceptSmsBridgeData=!1,e.shell.enableNativeSms=!1);let t=U(`CwsPlatform`);return t?.startCwspBridge?(await W(t.startCwspBridge),!0):!1}})),J,ge=e((()=>{r(),pe(),J=(e,t={})=>{let r=t.enableOrientLayer!==!1,i=t.enableCanvasLayer!==!1,a=e.querySelector(`[data-app-layer="canvas"]`),o=e.querySelector(`[data-app-layer="orient"]`),s=e.querySelector(`[data-app-layer="shell"]`),c=e.querySelector(`[data-app-layer="overlay"]`),l=()=>{let e=document.createElement(`div`);return e.dataset.appLayer=`canvas`,e.className=`app-layer app-layer--canvas`,e.style.position=`absolute`,e.style.inset=`0`,e.style.zIndex=`0`,e.style.pointerEvents=`none`,fe(e),e};if(s&&c){let t=a;if(i&&!t&&(t=l(),e.insertBefore(t,o??s)),!i&&t&&(t.remove(),t=null),r&&!o){let r=document.createElement(`div`);r.dataset.appLayer=`orient`,r.className=`app-layer app-layer--orient`,r.style.position=`absolute`,r.style.inset=`0`,r.style.zIndex=`5`,r.style.pointerEvents=`none`,r.style.background=`transparent`;let i=document.createElement(`cw-oriented-box`);return i.className=`ui-orientbox app-oriented-box`,i.setAttribute(`data-mixin`,`ui-orientbox`),i.style.position=`absolute`,i.style.inset=`0`,i.style.pointerEvents=`auto`,i.style.background=`transparent`,r.appendChild(i),n(i),e.insertBefore(r,s),{canvasLayer:t,orientLayer:r,shellLayer:s,overlayLayer:c}}return!r&&o?(o.remove(),{canvasLayer:t,orientLayer:null,shellLayer:s,overlayLayer:c}):{canvasLayer:t,orientLayer:r&&o||null,shellLayer:s,overlayLayer:c}}e.replaceChildren(),e.style.position=`relative`,e.style.overflow=`hidden`,e.dataset.appLayerRoot=`true`;try{let t=document.documentElement;(e===document.body||e.id===`app`)&&(t.style.minBlockSize||(t.style.minBlockSize=`100dvb`),!t.style.blockSize&&!t.style.height&&(t.style.blockSize=`100%`),!document.body.style.margin&&e===document.body&&(document.body.style.margin=`0`)),e.style.minBlockSize||(e.style.minBlockSize=`100dvb`),!e.style.blockSize&&!e.style.height&&(e.style.blockSize=`100%`)}catch{}let u=i?l():null,d=r?document.createElement(`div`):null;if(d){d.dataset.appLayer=`orient`,d.className=`app-layer app-layer--orient`,d.style.position=`absolute`,d.style.inset=`0`,d.style.zIndex=`5`,d.style.pointerEvents=`none`,d.style.background=`transparent`;let e=document.createElement(`cw-oriented-box`);e.className=`ui-orientbox app-oriented-box`,e.setAttribute(`data-mixin`,`ui-orientbox`),e.style.position=`absolute`,e.style.inset=`0`,e.style.pointerEvents=`auto`,e.style.background=`transparent`,d.appendChild(e),n(e)}let f=document.createElement(`div`);f.dataset.appLayer=`shell`,f.className=`app-layer app-layer--shell`,f.style.position=`absolute`,f.style.inset=`0`,f.style.zIndex=`10`,f.style.pointerEvents=`none`,f.style.display=`grid`,f.style.gridTemplateColumns=`[content-column] minmax(0px, 1fr)`,f.style.gridTemplateRows=`[status-row] minmax(0px, max-content) [content-row] minmax(0px, 1fr) [dock-row] minmax(0px, max-content)`,f.style.overflow=`hidden`,f.style.background=`transparent`,f.style.backgroundColor=`transparent`;let p=document.createElement(`div`);return p.dataset.appLayer=`overlay`,p.className=`app-layer app-layer--overlay`,p.style.position=`absolute`,p.style.inset=`0`,p.style.zIndex=`1000`,p.style.pointerEvents=`none`,p.style.background=`transparent`,p.style.backgroundColor=`transparent`,u&&e.append(u),d&&e.append(d),e.append(f,p),{canvasLayer:u,orientLayer:d,shellLayer:f,overlayLayer:p}}})),_e=t({BootLoader:()=>Q,bootLoader:()=>$,bootMinimal:()=>Y,default:()=>$});function ve(e){try{return e?.dataset?.appLayer===`shell`?e:e.querySelector?.(`:scope > [data-app-layer="shell"]`)||J(e,{enableOrientLayer:!1,enableCanvasLayer:!1}).shellLayer}catch(t){return console.warn(`[BootLoader] ensureAppLayers failed; mounting into container directly:`,t),e}}async function Y(e,t=`viewer`,n){let r=ne(t,`viewer`),i=re(r)?[r]:[`viewer`],a=i[0],o=ve(e);return $.boot(o,{styleSystem:`vl-basic`,shell:`minimal`,defaultView:r,channels:i,channelPriorityId:a,rememberChoice:n?.rememberChoice??!0,skipInitialNavigate:n?.skipInitialNavigate??!1})}var X,Z,Q,$,ye=e((()=>{r(),s(),ee(),a(),O(),ie(),b(),y(),j(),o(),he(),te(),se(),q(),ge(),h(),X=e=>e===`faint`?`tabbed`:e===`base`?`immersive`:e,Z={raw:{name:`Raw (No Framework)`,stylesheets:[],description:`No CSS framework, raw browser defaults`,recommendedShells:[`immersive`]},"vl-core":{name:`Core (Shared Foundation)`,stylesheets:[],description:`Shared foundation styles for all veela variants`,recommendedShells:[`immersive`,`minimal`]},"vl-basic":{name:`Basic Veela Styles`,stylesheets:[],description:`Minimal styling for basic functionality`,recommendedShells:[`window`,`tabbed`,`minimal`,`environment`,`immersive`,`content`]},"vl-advanced":{name:`Advanced (Full-Featured Styling)`,stylesheets:[],description:`Full-featured styling with design tokens and effects`,recommendedShells:[`tabbed`,`minimal`,`environment`]},"vl-beercss":{name:`BeerCSS (Beer CSS Compatible)`,stylesheets:[],description:`Beer CSS compatible styling with Material Design 3`,recommendedShells:[`tabbed`]}},Q=class e{static instance;state={phase:`idle`,styleSystem:null,shell:null,view:null,error:null};stateChangeHandlers=new Set;shellInstance=null;implicitBridgeCleanup=null;phaseHandlers=new Map;constructor(){u()}static getInstance(){return e.instance||=new e,e.instance}async boot(e,t){console.log(`[BootLoader] Starting boot sequence:`,t);try{if(this.shellInstance)try{this.implicitBridgeCleanup?.(),this.implicitBridgeCleanup=null,p.unload(this.shellInstance.id)}catch(e){console.warn(`[BootLoader] Failed to unload previous shell:`,e)}finally{this.shellInstance=null}me(),ae().catch(()=>{});try{let{initFrontendDebugCapture:e}=await g(async()=>{let{initFrontendDebugCapture:e}=await import(`./frontend-debug-capture-CQEyVisE.js`).then(e=>(e.i(),e.t));return{initFrontendDebugCapture:e}},[],import.meta.url);e()}catch{}let n=await S().catch(e=>(console.warn(`[BootLoader] Failed to load settings:`,e),null)),r=n;if(v()){let e=await x().catch(()=>null);e&&(r=e)}if(r&&ce(r).catch(()=>void 0),v()&&K(r).catch(e=>{console.warn(`[BootLoader] CWSP bridge daemon auto-start skipped:`,e)}),le(r??oe),!(()=>{try{let e=globalThis,t=typeof document<`u`?String(document.documentElement?.dataset?.cwspSurface||``):``;return!!(e.__CWS_SKIP_PWA__||e.__CWS_NEUTRALINO_BOOT__||e.__CWS_WEBNATIVE_BOOT__||e.Neutralino||typeof e.NL_OS==`string`||t===`cwsp-control`||t===`gateway`)}catch{return!1}})())try{let{initIngressPWA:e}=await g(async()=>{let{initIngressPWA:e}=await import(`./sw-handling-jvRhi52c.js`);return{initIngressPWA:e}},[],import.meta.url);await e()}catch(e){console.warn(`[BootLoader] Share-target / service worker ingress failed (non-fatal):`,e)}await this.loadStyles(t.styleSystem);let i=this.resolveThemeFromSettings(n),a=await this.loadShell(t.shell,e);if(a.setTheme(t.theme||i),await a.mount(e),this.implicitBridgeCleanup?.(),this.implicitBridgeCleanup=l(),t.channels&&t.channels.length>0&&await this.initChannels(t.channels,t.channelPriorityId),t.skipInitialNavigate)this.dismissShellLoadingSpinner(a);else{let e;try{e=Object.fromEntries(new URLSearchParams(globalThis.location?.search||``))}catch{e=void 0}await a.navigate(t.defaultView,e)}return this.setPhase(`ready`),t.rememberChoice&&this.savePreferences(t),console.log(`[BootLoader] Boot complete`),a}catch(e){throw console.error(`[BootLoader] Boot failed:`,e),this.updateState({phase:`error`,error:e}),e}}resolveThemeFromSettings(e){let t=e?.appearance?.theme||`auto`;return t===`dark`?d:t===`light`?f:c}dismissShellLoadingSpinner(e){try{let t=e.getElement().shadowRoot?.querySelector(`.app-shell__loading`);t&&(t.hidden=!0)}catch{}}async loadStyles(e){this.setPhase(`styles`),console.log(`[BootLoader] Loading style system: ${e}`);let t=Z[e]||Z[`vl-basic`];try{await z(e)}catch(t){throw console.error(`[BootLoader] Failed to load style system: ${e}`,t),t}for(let e of t.stylesheets)try{await i(e)}catch(t){console.warn(`[BootLoader] Failed to load stylesheet: ${e}`,t)}this.updateState({styleSystem:e}),console.log(`[BootLoader] Style system ${e} loaded`)}async loadShell(e,t){this.setPhase(`shell`);let n=X(e);n!==e&&console.warn(`[BootLoader] Shell "${e}" is temporarily disabled, redirecting to "${n}"`),console.log(`[BootLoader] Loading shell: ${n}`);let r=await p.load(n,t);return this.shellInstance=r,this.updateState({shell:n}),console.log(`[BootLoader] Shell ${n} loaded`),r}async initChannels(e,t){this.setPhase(`channels`);let n=[...new Set(e)];if(n.length===0)return;let r=(t&&n.includes(t)?t:null)??n[0],i=n.filter(e=>e!==r);console.log(`[BootLoader] Initializing primary channel:`,r,i.length?`(+${i.length} deferred)`:``);try{await _.initChannel(r)}catch(e){console.warn(`[BootLoader] Failed to init primary channel ${r}:`,e)}if(i.length===0){console.log(`[BootLoader] Channels initialized`);return}let a=()=>{(async()=>{for(let e of i)try{await _.initChannel(e)}catch(t){console.warn(`[BootLoader] Failed to init channel ${e}:`,t)}console.log(`[BootLoader] Deferred channels initialized:`,i)})()};typeof globalThis.requestIdleCallback==`function`?globalThis.requestIdleCallback(a,{timeout:5e3}):globalThis.setTimeout?.(a,0)}updateState(e){Object.assign(this.state,e),this.notifyStateChange()}setPhase(e){this.updateState({phase:e});let t=this.phaseHandlers.get(e);if(t)for(let e of t)try{e(this.state)}catch(e){console.error(`[BootLoader] Phase handler error:`,e)}}notifyStateChange(){for(let e of this.stateChangeHandlers)try{e(this.state)}catch(e){console.error(`[BootLoader] State handler error:`,e)}}onStateChange(e){return this.stateChangeHandlers.add(e),()=>{this.stateChangeHandlers.delete(e)}}onPhase(e,t){return this.phaseHandlers.has(e)||this.phaseHandlers.set(e,new Set),this.phaseHandlers.get(e).add(t),()=>{this.phaseHandlers.get(e)?.delete(t)}}getState(){return{...this.state}}getShell(){return this.shellInstance}savePreferences(e){try{let t=X(e.shell);localStorage.setItem(`rs-boot-style`,e.styleSystem),localStorage.setItem(`rs-boot-shell`,t),localStorage.setItem(`rs-boot-view`,e.defaultView),localStorage.setItem(`rs-boot-remember`,`1`)}catch(e){console.warn(`[BootLoader] Failed to save preferences:`,e)}}loadPreferences(){try{if(localStorage.getItem(`rs-boot-remember`)!==`1`)return null;let e=X(localStorage.getItem(`rs-boot-shell`)||`environment`);return{styleSystem:localStorage.getItem(`rs-boot-style`)||void 0,shell:e,defaultView:localStorage.getItem(`rs-boot-view`)||void 0}}catch{return null}}clearPreferences(){try{localStorage.removeItem(`rs-boot-style`),localStorage.removeItem(`rs-boot-shell`),localStorage.removeItem(`rs-boot-view`),localStorage.removeItem(`rs-boot-remember`),localStorage.removeItem(m)}catch{}}},$=Q.getInstance()}));export{G as a,q as i,Y as n,ye as r,_e as t};