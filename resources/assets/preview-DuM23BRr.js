import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{F as t,L as n,R as r,t as i}from"./src-kpjtbscK.js";import{n as a,t as o}from"./preload-helper-NDuSAHbO.js";import{G as s,W as c}from"./cwsp-app.js";import{t as l}from"./src-D4aHj_Yc.js";import{i as u,n as d,r as f,t as p}from"./shells-Byfc-klB.js";var m,h=e((()=>{m=`/* Minimal shell: layered tokens + nav/content grid, WCO-safe, shadow slot views. */
/*
  ...
  @media print {
    ...
    .app-shell__status {
      display: none !important;
...
}`}));function g(e){return y.has(e)}function _(e){return new b}var v,y,b,x=e((()=>{i(),n(),h(),l(),d(),c(),u(),a(),v=[{id:`viewer`,name:`Markdown`,icon:`eye`},{id:`explorer`,name:`Explorer`,icon:`folder`},{id:`workcenter`,name:`Work Center`,icon:`lightning`},{id:`network`,name:`Network`,icon:`wifi-high`},{id:`airpad`,name:`AirPad`,icon:`hand-pointing`},{id:`settings`,name:`Settings`,icon:`gear`},{id:`history`,name:`History`,icon:`clock-counter-clockwise`}].filter(e=>s(e.id)),y=new Set(v.map(e=>e.id)),b=class extends p{id=`minimal`;name=`Minimal`;layout={hasSidebar:!1,hasToolbar:!0,hasTabs:!1,supportsMultiView:!1,supportsWindowing:!1};createLayout(){let e=t`
        ...
        `;return this.setupNavClickHandlers(e),this.setupAdminDoorButton(e),e}setupAdminDoorButton(e){let n=e.querySelector(`[data-shell-toolbar]`);if(!n||n.querySelector(`[data-admin-door]`))return;let r=t`
            <button
                type="button"
