import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{M as t,N as n,Vt as r,b as i,j as a,jt as o,r as s,st as c,t as l}from"./src-OjdqEwqq.js";import{n as u,t as d}from"./preload-helper-DFTwEg7x.js";import{c as f,n as p,u as m}from"./Names-D5qspMxH.js";import{a as h,c as g,i as ee,n as te,o as _,p as v,r as ne,s as y}from"./UnifiedMessaging-BEe_RbsB.js";import{r as b,t as re}from"./view-inbound-timing-CxhYQUp2.js";import{a as ie,i as ae,n as oe,r as x,t as S}from"./view-ingress-validation-BFwuw_Yo.js";import{a as C,i as se}from"./ShareTargetGateway-OOEofy89.js";import{a as ce,o as le}from"./Settings-Do5aJTKt.js";import{a as ue,i as de,n as w,o as fe,r as pe,s as T,t as me}from"./icon-s-qdKq1E.js";var he;function E(){return(E=e((()=>{he=`@layer layout {
  /*
...
`,!0):(T.markdown=e,!0)}return!1},j=new Map,N=(e,t)=>{let n=(j.get(e)??Promise.resolve()).then(()=>t()).catch(t=>console.warn(`[Shell] Minimal ingress failed:`,e,t));return j.set(e,n),n},P=0;if(v.registerHandler(`markdown-viewer`,{canHandle:e=>e.destination===`markdown-viewer`,handle:async e=>{let t=++P;await N(`markdown-surface`,async()=>{t===P&&(await b(),t===P&&await O(e,t)&&(T.view=`markdown-viewer`,F(),$()))})}}),v.registerHandler(`viewer`,{canHandle:e=>e.destination===`viewer`,handle:async e=>{let t=++P;await N(`markdown-surface`,async()=>{t===P&&(await b(),t===P&&await O(e,t)&&(T.view=`markdown-viewer`,H(`markdown-viewer`),F(),$(),E(`Content loaded in viewer`)))})}}),v.registerHandler(`workcenter`,{canHandle:e=>e.destination===`workcenter`,handle:async e=>{await N(`workcenter`,async()=>{await b();let t=T.managers?.workCenter?.instance;if(t){try{S(e)?await C(e,T,H,$,E,!0):t?.handleExternalMessage&&await t.handleExternalMessage(e)}catch(e){console.error(`[Shell] WorkCenter message handling failed:`,e)}return}try{ne(`workcenter`,e)}catch(e){console.warn(`[Shell] Failed to enqueue pending workcenter message:`,e)}T.view!==`workcenter`&&(T.view=`workcenter`,H(`workcenter`),$())})}}),v.registerHandler(`explorer`,{canHandle:e=>e.destination===`explorer`,handle:async e=>{await N(`explorer`,async()=>{await b(),T.view!==`file-explorer`&&(T.view=`file-explorer`,H(`file-explorer`),$()),await new Promise(t=>{setTimeout(async()=>{try{let t=e.data?.action||`save`,n=e.data?.path||e.data?.into||`/`;if(t===`save`&&(e.data?.file||e.data?.text||e.data?.content)){let t=null;if(e.data.file instanceof File)t=e.data.file;else if(e.data.blob instanceof Blob){let n=e.data.filename||`file-${Date.now()}`;t=new File([e.data.blob],n,{type:e.data.blob.type})}else if(e.data.text||e.data.content){let n=e.data.text||e.data.content,r=typeof n==`string`?n:JSON.stringify(n,null,2),i=e.data.filename||`content-${Date.now()}.txt`;t=new File([r],i,{type:`text/plain`})}t&&T.components.explorer.element&&(n&&n!==T.components.explorer.element.path&&(T.components.explorer.element.path=n),console.log(`[Shell] Saving file ${t.name} to Explorer at: ${n}`),T.message=`Saved ${t.name} to Explorer`,J(),setTimeout(()=>{T.message=``,J()},3e3))}else if(t===`view`&&e.data?.path)T.components.explorer.element&&n&&(T.components.explorer.element.path=n,console.log(`[Shell] Navigated Explorer to path: ${n}`),T.message=`Opened Explorer at ${n}`,J(),setTimeout(()=>{T.message=``,J()},2e3));else if(t===`place`&&e.data?.place&&e.data?.into){let t=e.data.into;T.components.explorer.element&&t&&(T.components.explorer.element.path=t,console.log(`[Shell] Navigated Explorer to place data at: ${t}`),T.message=`Explorer ready at ${t}`,J(),setTimeout(()=>{T.message=``,J()},3e3))}else t===`navigate`&&n&&T.components.explorer.element&&(T.components.explorer.element.path=n,T.message=`Explorer navigated to ${n}`,J(),setTimeout(()=>{T.message=``,J()},2e3))}catch(e){console.warn(`[Shell] Failed to handle explorer action:`,e),T.message=`Failed to perform Explorer action`,J(),setTimeout(()=>{T.message=``,J()},3e3)}finally{t()}},100)})})}}),v.registerHandler(`print`,{canHandle:e=>e.destination===`print`,handle:async e=>{await N(`print`,async()=>{if(await b(),e.data?.text||e.data?.content){let t=e.data.text||e.data.content,n=typeof t==`string`?t:JSON.stringify(t,null,2),r=globalThis?.open?.(``,`_blank`,`width=800,height=600`);r&&(r.document.write(`
      ...
      <div class="left">
        ...
        <button class="btn ${T.view===`workcenter`?`active`:``}" data-action="view-workcenter" type="button" title="AI Work Center">
          ...
          ${T.managers.workCenter.instance&&T.managers.workCenter.instance.getState().files.length>0?c`<span class="workcenter-badge" title="${T.managers.workCenter.instance.getState().files.length} files ready for processing">${T.managers.workCenter.instance.getState().files.length}</span>`:``}
        </button>
      ...
      <div class="right">
        ${t?c`<button class="btn btn-icon" data-action="open-md" type="button" title="Open Markdown File">
        ...
        ${e?c`<button class="btn" data-action="voice" type="button" title="Voice Input">
          <ui-icon icon="microphone" icon-style="duotone"></ui-icon>
          <span>Voice</span>
        </button>`:``}
        ${n?c`<button class="btn" data-action="process-content" type="button" title="Process Content">
...
`),a=i?.ok&&i?.data?String(i.data):``;T.history.push({ts:Date.now(),prompt:e,before:n,after:a||n,ok:!!(i?.ok&&a),error:i?.ok?void 0:i?.error||`Failed`}),I(),a?(T.markdown=a,F(),z(``),T.message=`Done.`):T.message=i?.error||`No output.`}catch(t){T.history.push({ts:Date.now(),prompt:e,before:n,after:n,ok:!1,error:String(t)}),I(),T.message=String(t)}finally{T.busy=!1,J(),$(),setTimeout(()=>{T.message===`Done.`&&(T.message=``,J())},1200)}},Z=!1,Q=!1,$=async()=>{if(Z){Q=!0;return}Z=!0,Q=!1;try{let e=W();G.replaceWith(e),G=e,we(),H(T.view),K.replaceChildren();let t=(e,t)=>{console.error(`Failed to load ${e}:`,t),K.innerHTML=`<div class="component-error"><h3>Failed to load ${e}</h3><p>Please try refreshing the page.</p></div>`,J()},r=e=>{K.append(e),J()},i={settings:async()=>{K.innerHTML=`<div class="component-loading"><div class="loading-spinner"></div><span>Loading Settings...</span></div>`;let e=(await k(`settings`,()=>d(()=>import(`./src-D9Ti3osG.js`),[],import.meta.url),{componentName:`Settings`})).component.createSettingsView({isExtension:B(),onTheme:e=>U(o,e)});g(`settings-view`,`settings`);let t=_(`settings-view`);for(let e of t)console.log(`[Settings] Processing pending message:`,e),e.type===`navigation`&&(T.view=`settings`,setTimeout(()=>$(),0));return K.innerHTML=``,e},"file-explorer":async()=>{K.innerHTML=`<div class="component-loading"><div class="loading-spinner"></div><span>Loading File Explorer...</span></div>`,await k(`file-explorer`,()=>d(()=>import(`./_cwsp-disabled-entry_view-explorer-CUvWHUlh.js`),[],import.meta.url),{componentName:`FileManager`});let e=document.createElement(`ui-file-manager`);e.addEventListener(`open-item`,async t=>{let{item:n}=t.detail;n?.kind===`file`&&n?.file&&await v.sendMessage({id:crypto.randomUUID(),type:`content-share`,source:`explorer`,destination:`workcenter`,contentType:`file`,data:{file:n.file,filename:n.name,path:e.path},metadata:{title:n.name,timestamp:Date.now(),source:`file-explorer`}})}),e.addEventListener(`open`,async t=>{let{item:n}=t.detail;if(n?.kind===`file`&&n?.file){let t=u.isMarkdownFile(n.file),r=t?`viewer`:`workcenter`;await v.sendMessage({id:crypto.randomUUID(),type:`content-share`,source:`explorer`,destination:r,contentType:t?`markdown`:`file`,data:{file:n.file,filename:n.name,path:e.path},metadata:{title:n.name,timestamp:Date.now(),source:`file-explorer`}})}}),e.addEventListener(`context-action`,async t=>{let{action:n,item:r}=t.detail;if(n===`attach-workcenter`&&r?.kind===`file`&&r?.file)await v.sendMessage({id:crypto.randomUUID(),type:`content-share`,source:`explorer`,destination:`workcenter`,contentType:`file`,data:{file:r.file,filename:r.name,path:e.path},metadata:{title:`Attach ${r.name} to Work Center`,timestamp:Date.now(),source:`file-explorer`}});else if(n===`view`&&r?.kind===`file`&&r?.file){let t=u.isMarkdownFile(r.file),n=t?`viewer`:`workcenter`;await v.sendMessage({id:crypto.randomUUID(),type:`content-share`,source:`explorer`,destination:n,contentType:t?`markdown`:`file`,data:{file:r.file,filename:r.name,path:e.path},metadata:{title:`View ${r.name}`,timestamp:Date.now(),source:`file-explorer`}})}}),g(`file-explorer`,`explorer`),T.components.explorer.element=e;let t=_(`file-explorer`);for(let n of t){let t=n;if(console.log(`[Explorer] Processing pending message:`,t),t.type===`content-explorer`){let n=t.data?.action||`save`,r=t.data?.path||t.data?.into||`/`;setTimeout(async()=>{try{if(n===`save`&&(t.data?.file||t.data?.text||t.data?.content)){let n=null;if(t.data.file instanceof File)n=t.data.file;else if(t.data.blob instanceof Blob){let e=t.data.filename||`file-${Date.now()}`;n=new File([t.data.blob],e,{type:t.data.blob.type})}else if(t.data.text||t.data.content){let e=t.data.text||t.data.content,r=typeof e==`string`?e:JSON.stringify(e,null,2),i=t.data.filename||`content-${Date.now()}.txt`;n=new File([r],i,{type:`text/plain`})}n&&e&&(r&&r!==e.path&&(e.path=r),E(`Saved ${n.name} to Explorer`))}else n===`view`&&t.data?.path&&e&&r&&(e.path=r,E(`Opened Explorer at ${r}`))}catch(e){console.warn(`[Explorer] Failed to handle pending message:`,e),E(`Failed to perform Explorer action`)}},100)}}return K.innerHTML=``,e},history:()=>Se(),"markdown-viewer":()=>ye(),"markdown-editor":()=>be(),"rich-editor":()=>xe()}[T.view];if(i){try{let e=await i();e&&r(e)}catch(e){t(T.view.replace(`-`,` `).replace(/\b\w/g,e=>e.toUpperCase()),e)}return}if(T.view===`file-picker`){K.innerHTML=`
            ...
            `;let e=K.querySelector(`[data-action="open-markdown"]`),t=K.querySelector(`[data-action="open-any"]`);e&&e.addEventListener(`click`,()=>{q.accept=`.md,.markdown,.txt,text/markdown`,q.click()}),t&&t.addEventListener(`click`,()=>{q.accept=`*`,q.click()}),J();return}if(T.view===`workcenter`){K.innerHTML=`<div class="component-loading"><div class="loading-spinner"></div><span>Loading Work Center...</span></div>`,s(`workcenter`,()=>d(()=>import(`./WorkCenter-CTYllUWq.js`).then(e=>e.WorkCenterManager),[],import.meta.url),{componentName:`WorkCenter`}).then(async e=>{if(T.managers.workCenter.instance||(T.managers.workCenter.instance=new e.component({state:T,history:T.history,onFilesChanged:()=>{W()},getSpeechPrompt:n,showMessage:e=>E(e),render:()=>$()})),!T.managers.workCenter.initialized){T.managers.workCenter.initialized=!0,g(`workcenter-manager`,`workcenter`);let e=_(`workcenter-manager`);for(let t of e){console.log(`[WorkCenter] Processing pending message:`,t);try{S(t)?await C(t,T,H,$,E,!0):T.managers.workCenter.instance?.handleExternalMessage?await T.managers.workCenter.instance.handleExternalMessage(t):await C(t,T,H,$,E,!0)}catch(e){console.warn(`[WorkCenter] Failed to replay pending message:`,e)}}}let t=T.managers.workCenter.instance.renderWorkCenterView();K.innerHTML=``,K.append(t),J()}).catch(e=>{console.error(`Failed to load work center:`,e),K.innerHTML=`<div class="component-error"><h3>Failed to load Work Center</h3><p>Please try refreshing the page.</p></div>`,J()});return}ye().then(e=>{K.append(e),J()}).catch(e=>{console.error(`Failed to load default markdown viewer:`,e),K.innerHTML=`<div class="component-error"><h3>Failed to load Markdown Viewer</h3><p>Please try refreshing the page.</p></div>`,J()})}finally{Z=!1,Q&&setTimeout(()=>$(),0)}},we=()=>{G.addEventListener(`click`,async e=>{let t=(e.target?.closest?.(`button[data-action]`))?.dataset?.action;if(!t)return;let r=null;if(t===`view-markdown-viewer`&&(r=`markdown-viewer`),t===`view-markdown-editor`&&(r=`markdown-editor`),t===`view-rich-editor`&&(r=`rich-editor`),t===`view-workcenter`&&(r=`workcenter`),t===`view-settings`&&(r=`settings`),t===`view-history`&&(r=`history`),t===`view-file-explorer`&&(r=`file-explorer`),r&&(T.view=r,H(r)),t===`open-md`&&q.click(),t===`save-md`&&Ce(),t===`export-md`&&Y(),t===`export-docx`){let e=T.markdown||``;if(e.trim()){let{downloadMarkdownAsDocx:t}=await d(async()=>{let{downloadMarkdownAsDocx:e}=await import(`./DocxExport-DDt-HL8o.js`);return{downloadMarkdownAsDocx:e}},[],import.meta.url);await t(e,{title:`CWSP-shell`,filename:`crossword-${Date.now()}.docx`})}}if(t===`toggle-edit`){if(T.view!==`markdown-viewer`&&T.view!==`markdown-editor`)return;T.editing=!T.editing}if(t===`snip`){if(!l)return;try{chrome.tabs.query({active:!0,lastFocusedWindow:!0,currentWindow:!0},e=>{let t=e?.[0]?.id;t!=null&&chrome.tabs.sendMessage(t,{type:`START_SNIP`})?.catch?.(()=>void 0);try{globalThis?.close?.()}catch{}})}catch{}}if(t===`process-content`&&T.managers.workCenter.instance&&await v.sendMessage({id:crypto.randomUUID(),type:`content-process`,source:`main-app`,destination:`workcenter`,data:{prompt:T.markdown||`Process this content`},metadata:{timestamp:Date.now(),correlationId:`main-${Date.now()}`}}),t===`save-to-explorer`&&T.managers.workCenter.instance){let e=T.managers.workCenter.instance.getState().results||[];if(e.length>0){let t=e[e.length-1];await v.sendMessage({id:crypto.randomUUID(),type:`content-save`,source:`main-app`,destination:`explorer`,data:{action:`save`,text:typeof t==`string`?t:JSON.stringify(t,null,2),filename:`workcenter-result-${Date.now()}.txt`,path:`/workcenter-results/`},metadata:{title:`Work Center Result`,timestamp:Date.now(),source:`workcenter`}})}else T.message=`No results to save`,J(),setTimeout(()=>{T.message=``,J()},2e3)}t===`solve`&&await X(`Solve equations and answer questions from the content above`,solveAndAnswer),t===`code`&&await X(`Generate code based on the description or requirements above`,writeCode),t===`css`&&await X(`Extract or generate CSS from the content or image above`,extractCSS),t===`voice`&&(async()=>{let e=await n();e&&await X(e)})(),$()})};we(),q.addEventListener(`change`,()=>{let e=q.files?.[0];e&&e.text().then(t=>{T.markdown=t||``,F(),z(``),T.view!==`markdown-viewer`&&(T.view=`markdown-viewer`,H(`markdown-viewer`)),T.message=`Loaded ${e.name}`,J(),$(),setTimeout(()=>{T.message=``,J()},3e3)}).catch(()=>void 0).finally(()=>{q.value=``})}),le().then(e=>{T.lastSavedTheme=e?.appearance?.theme||`auto`,U(o,T.lastSavedTheme)}).catch(()=>U(o,`auto`));let Te=R();Te&&_e(Te).then(e=>{e&&(T.markdown=e,F(),$())}),$()}})))()}G();export{W as mountShellApp};