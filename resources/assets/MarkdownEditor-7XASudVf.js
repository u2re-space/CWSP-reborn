import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{J as t,Mt as n,Y as r,a as i,ft as a,kt as o,nt as s}from"./HistoryManager-D8ebz2Z7.js";import{o as c}from"./src-lWlSIf_Q.js";import{n as l,t as u}from"./preload-helper-NDuSAHbO.js";import{n as d,r as f}from"./channel-mixin-_kNsMznb.js";import{a as ee,f as te}from"./UnifiedMessaging-pXaB9ut5.js";import{a as p,n as ne,r as m,t as re}from"./view-ingress-validation-_AelCeIF.js";import{d as h,f as g,g as ie,h as ae,l as oe,p as _,t as v}from"./src-fiZCSwG5.js";import{a as se,o as ce}from"./Settings-DQArF03Y.js";import{t as y}from"./src-C9heO9y9.js";import{n as b,o as le}from"./CSSIconRegistry-D88SYH0A.js";import{n as ue,t as de}from"./auto-render-Cks6Fk-a.js";import{n as fe,t as pe}from"./purify.es-Bv6MVteU.js";import{i as me,n as he,r as ge,t as _e}from"./registry-DJBTJiLd.js";import{a as ve,i as x,t as S}from"./channel-actions-DC9DgSYV.js";var C,w,T,ye=e((()=>{v(),ee(),C=e=>String(e||`attachment`).toLowerCase().replace(/[^a-z0-9-]/g,`-`).replace(/-+/g,`-`).replace(/^-+|-+$/g,``)||`attachment`,w=async(e,t=`view-ipc`)=>{let n=[];for(let r of e){let e=r&&typeof r==`object`&&`data`in r?r.data:r;if(e)try{let i=r&&typeof r==`object`&&`source`in r?String(r.source||t):t,a=await g(e,{namePrefix:C(i),uriComponent:!0});n.push({hash:String(a.hash||``),name:String(a.name||a.file?.name||`attachment`),mimeType:String(a.mimeType||a.type||a.file?.type||`application/octet-stream`),size:Number(a.size||a.file?.size||0),source:i,data:a.file})}catch(e){console.warn(`[UniformViewTransport] Attachment normalization failed:`,e)}}return n},T=async e=>{let t=await w(e.attachments||[],e.source),n={...e.data||{},...t.length>0?{attachments:t,file:t[0]?.data,files:t.map(e=>e.data)}:{}};return te(c({type:e.type,source:e.source,destination:e.destination,contentType:e.contentType,data:n,purpose:e.purpose||(t.length>0?[`attach`,`deliver`]:[`deliver`,`mail`]),protocol:`window`,op:e.op||(t.length>0?`attach`:`deliver`),srcChannel:e.source,dstChannel:e.destination,metadata:{...e.metadata||{},attachmentCount:t.length}}))}}));function be(e){return e===`light`||e===`dark`?e:typeof globalThis.matchMedia==`function`&&globalThis.matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`}function E(e){if(e===`light`||e===`dark`||e===`system`)return e;if(typeof e==`string`){let t=e.trim().toLowerCase();if(t===`light`||t===`dark`||t===`system`)return t}}function D(e){if(e!=null){if(typeof e==`string`)return E(e.trim());if(typeof e==`object`){let t=e;return E(t.colorScheme??t.scheme??t.theme)}}}function xe(e){if(e)return e.colorScheme?e.colorScheme:E(e.params?.colorScheme??e.params?.theme)}var Se=e((()=>{})),O,k=e((()=>{O=`@function --hsv(--src-color <color>) returns <color> {
...
@scope (
  ...
  @layer layer.view.viewer {
    ...
    .view-viewer {
      ...
      */
      --view-bg: var(--color-surface, light-dark(--u2-color-mod(var(--base-color, var(--color-primary, #5a7fff)), 70), --u2-color-mod(var(--base-color, var(--color-primary, #5a7fff)), 960)));
      --view-fg: var(--color-on-surface, light-dark(--u2-color-mod(var(--base-color, var(--color-primary, #5a7fff)), 900), --u2-color-mod(var(--base-color, var(--color-primary, #5a7fff)), 100)));
      --view-border: var(--color-border, color-mix(in oklab, var(--view-fg) 12%, transparent));
      --view-toolbar-bg: color-mix(in oklab, var(--view-fg) 5%, transparent);
      --view-btn-hover-bg: color-mix(in oklab, var(--view-fg) 8%, transparent);
      --view-code-bg: light-dark(--u2-color-mod(var(--base-color, var(--color-primary, #5a7fff)), 120), --u2-color-mod(var(--base-color, var(--color-primary, #5a7fff)), 900));
    ...
    */
    ...
    .cw-view-viewer-shell[data-theme=light] {
      color-scheme: light;
      --base-color: var(--color-primary, #5a7fff);
      --color-on-surface: --u2-color-mod(var(--base-color), 860);
    }
    ...
    .cw-view-viewer-shell[data-theme=dark] {
      color-scheme: dark;
      --base-color: var(--color-primary, #5a7fff);
      --color-on-surface: --u2-color-mod(var(--base-color), 120);
    }
    /*
    ...
    */
    ...
    .view-viewer[data-theme=light] .view-viewer__toolbar {
      color-scheme: light;
      --base-color: var(--color-primary, #5a7fff);
      background: var(--viewer-toolbar-row-fill, --u2-color-mod(var(--base-color), 160));
      --color-on-surface: --u2-color-mod(var(--base-color), 880);
      --view-picon-fill: --u2-color-mod(var(--base-color), 780);
      --view-picon-fill-hover: var(--color-primary, --u2-color-mod(var(--base-color), 550));
      --color-surface-container-high: color-mix(in oklab, --u2-color-mod(var(--base-color), 900) 10%, transparent);
    }
    ...
    .view-viewer[data-theme=dark] .view-viewer__toolbar {
      color-scheme: dark;
      --base-color: var(--color-primary, #5a7fff);
      background: var(--viewer-toolbar-row-fill, --u2-color-mod(var(--base-color), 880));
      --color-on-surface: --u2-color-mod(var(--base-color), 120);
      /* Mid-light teal icons (not blue/purple #8ab4ff); hover = brighter seed. */
      --view-picon-fill: --u2-color-mod(var(--base-color), 280);
      --view-picon-fill-hover: --u2-color-mod(var(--base-color), 420);
      --color-surface-container-high: color-mix(in oklab, --u2-color-mod(var(--base-color), 100) 14%, transparent);
    }
...
}`}));function A(e){let t=[],n=`__MD_MASK_`;return{masked:(e=>e.replace(V,e=>{let r=`${n}${t.length}__`;return t.push(e),r}))((e=>e.replace(B,e=>{let r=`${n}${t.length}__`;return t.push(e),r}))(e)),restore:e=>e.replace(/__MD_MASK_(\d+)__/g,(e,n)=>t[Number(n)]??``)}}var j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q,Ce=e((()=>{v(),t(),a(),pe(),de(),y(),f(),me(),he(),ve(),se(),ye(),re(),Se(),k(),l(),j=null,M=`rs-viewer-outline`,N=/\$\$[\s\S]*?\$\$|\\\[[\s\S]*?\\\]|(?<!\$)\$[^$\n]+\$|\\\([\s\S]*?\\\)/,P=35e4,F=96e3,I=12e5,L=2*1024*1024,R=48e4,z=6e5,B=/(^|\n)(`{3,}|~{3,})[^\n]*\n[\s\S]*?\n\2(?=\n|$)/g,V=/`[^`\n]+`/g,H={USE_PROFILES:{html:!0,mathMl:!0,svg:!0},FORBID_TAGS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`link`,`meta`,`base`,`form`,`noscript`,`template`],FORBID_CONTENTS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`noscript`,`template`]},U=`g`,W=[`rs-md-base`,`rs-md-system`,`rs-md-modules`,`rs-md-user`,`rs-md-print`,`rs-md-user-print`],G=!1,K=()=>{if(!G)try{b(),le(),G=!0}catch(e){console.warn(`[Viewer] Failed to initialize icon runtime:`,e)}},q=e=>navigator?.clipboard?.writeText?.(e)??Promise.resolve(void 0),J=async()=>j||(j=(async()=>{let[{marked:e},{default:t}]=await Promise.all([u(()=>import(`./marked.esm-Cypg06Pf.js`).then(e=>(e.n(),e.r)),[],import.meta.url),u(()=>import(`./src-lBXlRhmP.js`).then(e=>(e.t(),e.r)),[],import.meta.url)]);return e?.use?.(t({throwOnError:!1,nonStandard:!0,output:`mathml`,strict:!1}),{hooks:{preprocess:e=>{if(e.length>P||!N.test(e))return e;let{masked:t,restore:n}=A(e),r=document.createElement(`div`);return r.textContent=t,ue(r,{throwOnError:!1,nonStandard:!0,output:`mathml`,strict:!1,delimiters:[{left:`$$`,right:`$$`,display:!0},{left:`\\[`,right:`\\]`,display:!0},{left:`$`,right:`$`,display:!1},{left:`\\(`,right:`\\)`,display:!1}]}),n(r.innerHTML)}}}),async t=>await e.parse(t??``)})(),j),Y=`rs-viewer-state`,X=`# This is content`,Z=`cw-view-viewer`,Q=_e(Z,e=>class extends e{id=`viewer`;name=`Viewer`;icon=`eye`;options;shellContext;element=null;slotProjectingHost=null;contentRef=s(``);contentRefSubscriptionDispose=null;renderSeq=0;stateManager=ge(Y);_sheet=null;pasteController=null;windowDnDController=null;isViewVisible=!1;isPointerInView=!1;sourceUrl=null;customSheet=null;userStyleModules={screenCss:``,printCss:``};markdownSettings={preset:`default`,fontFamily:`system`,fontSizePx:16,lineHeight:1.7,contentMaxWidthPx:860,printScale:1,page:{size:`auto`,orientation:`portrait`,marginMm:12},modules:{typography:!0,lists:!0,tables:!0,codeBlocks:!0,blockquotes:!0,media:!0,printBreaks:!0},plugins:{smartTypography:!1,softBreaksAsBr:!1,externalLinksNewTab:!0},customCss:``,printCss:``,extensions:[]};markdownSettingsPromise=null;outlineVisible=!1;viewerColorScheme=`system`;documentThemeSnapshot=null;disposeContentRefSubscription(){try{this.contentRefSubscriptionDispose?.()}catch{}this.contentRefSubscriptionDispose=null}subscribeContentRefToCurrentTargets(e,t){this.disposeContentRefSubscription();let n=r(this.contentRef,()=>{e&&t&&this.renderMarkdown(this.contentRef.value,e,t),this.saveState()});this.contentRefSubscriptionDispose=typeof n==`function`?n:null}lifecycle={onMount:()=>this.onMount(),onUnmount:()=>this.onUnmount(),onShow:()=>this.onShow(),onHide:()=>this.onHide(),onRefresh:()=>this.onRefresh()};constructor(e={}){super(),this.options=e,this.shellContext=e.shellContext,this.sourceUrl=this.normalizeSourceUrl(e.source),this.applyRouteParams(e.params),this.markdownSettingsPromise=this.loadMarkdownSettings();try{this.outlineVisible=globalThis.sessionStorage?.getItem(M)===`1`}catch{this.outlineVisible=!1}this.syncViewerColorSchemeFromOptions();let t=this.stateManager.load();if(this.contentRef.value=e.initialContent||t?.content||X,!e.initialContent){let t=(e.params?.content||``).trim();t&&(this.contentRef.value=t)}}render=function(e){K(),this.slotProjectingHost=null,e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,this.applyRouteParams(e.params)),this.syncViewerColorSchemeFromOptions(),this._sheet=o(O),this.element=this.createViewerShellElement();let t=this.element.querySelector(`[data-render-target]`),n=this.element.querySelector(`[data-raw-target]`);return this.setupEventHandlers(n||void 0),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),t&&n&&this.renderMarkdown(this.contentRef.value,t,n),this.subscribeContentRefToCurrentTargets(t,n),this.refreshDocumentTheme(),this.element};shellNavigateHydrate(e,t){if(!this.element?.isConnected)return;e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,e.params!==void 0&&this.applyRouteParams(e.params),this.syncViewerColorSchemeFromOptions());let n=this.queryViewerSlotted(`[data-render-target]`),r=this.queryViewerSlotted(`[data-raw-target]`);n&&r&&(this.subscribeContentRefToCurrentTargets(n,r),this.renderMarkdown(this.contentRef.value,n,r)),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.refreshDocumentTheme()}renderIntoWebComponentHost(e,t){K(),t&&(this.options={...this.options,...t},this.shellContext=t.shellContext||this.shellContext,this.applyRouteParams(t.params)),this.syncViewerColorSchemeFromOptions(),this.slotProjectingHost=e,this._sheet??=o(O),this.element=this.createViewerShellElement(),e.replaceChildren(this.element);let n=e.querySelector(`[data-raw-target]`),r=e.querySelector(`[data-render-target]`);e.setAttribute(`data-view-id`,`viewer`),e.toggleAttribute(`data-cw-view-host`,!0),this.syncAdoptedSheetsToShadow();let i=r,a=n;this.setupEventHandlers(a),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),i&&a&&this.renderMarkdown(this.contentRef.value,i,a),this.subscribeContentRefToCurrentTargets(i,a),this.refreshDocumentTheme()}getToolbar(){return null}setContent(e,t,n){this.contentRef.value=e,t&&(this.options.filename=t),n!==void 0&&(this.sourceUrl=this.normalizeSourceUrl(n),this.options.source=n||void 0),this.syncToolbarDocumentTitle()}ingestOpenedMarkdownBody(e,t,n){if(e.length>0&&m(e)){this.setContent(`> This payload does not look like UTF-8 markdown (binary file or unsupported format).
>
> Open a \`.md\` / \`.txt\` file, paste as plain text, or attach binaries via Work Center.

`,t,n);return}this.setContent(e,t,n??void 0)}getContent(){return this.contentRef.value}setViewerColorScheme(e){this.viewerColorScheme=e,this.options.colorScheme=e,this.refreshDocumentTheme()}refreshDocumentTheme(){typeof document>`u`||this.applyViewerDocumentTheme(this.viewerColorScheme)}applyViewerDocumentTheme(e){let t=document.documentElement;if(e===`system`)return;this.documentThemeSnapshot||={prevAttr:t.getAttribute(`data-theme`),prevInlineCs:t.style.getPropertyValue(`color-scheme`)};let n=be(e);t.setAttribute(`data-theme`,n),t.style.setProperty(`color-scheme`,n)}restoreViewerDocumentTheme(){let e=this.documentThemeSnapshot;if(this.documentThemeSnapshot=null,!e||typeof document>`u`)return;let t=document.documentElement;e.prevAttr===null||e.prevAttr===``?t.removeAttribute(`data-theme`):t.setAttribute(`data-theme`,e.prevAttr),e.prevInlineCs.trim()?t.style.setProperty(`color-scheme`,e.prevInlineCs):t.style.removeProperty(`color-scheme`)}syncViewerColorSchemeFromOptions(){let e=xe(this.options);e&&(this.viewerColorScheme=e)}createViewerShellElement(){return i`
