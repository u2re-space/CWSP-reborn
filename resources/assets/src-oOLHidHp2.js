import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{A as t,K as n,O as r,k as i,q as a,t as o}from"./src-6wudtv1A.js";import{n as s,t as c}from"./preload-helper-DcjHEl26.js";import{A as l,B as u,G as d,H as f,J as p,K as m,L as h,M as g,P as _,Q as v,R as y,V as b,W as x,X as S,g as C,j as w,q as T,t as E}from"./src-DOA8CgFN.js";import{a as D,dt as O,j as k,k as ee,u as A}from"./HistoryManager-lhXX01K8.js";import{a as j,t as te}from"./icon-aHIY67e3.js";import{A as M,C as ne,D as N,E as P,F as re,N as ie,O as ae,P as oe,S as se,T as ce,_ as le,a as ue,b as de,c as fe,d as pe,f as me,g as he,h as ge,i as _e,k as ve,l as ye,m as be,n as xe,o as Se,r as Ce,s as we,t as Te,u as Ee,v as De,w as Oe,x as ke,y as Ae}from"./launcher-state-JCaPMCu4.js";function F(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}function je(){return(je=e((()=>{})))()}var I,Me;function L(){return(L=e((()=>{E(),j(),I=class extends b(){theme=`default`;render=function(){return D`<slot></slot>`};constructor(){super()}onRender(){return super.onRender()}connectedCallback(){return super.connectedCallback?.()??this}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(te()),e}},F([x({source:`attr`})],I.prototype,`theme`,void 0),I=F([f(`ui-element`)],I),Me=I})))()}var Ne,R,Pe,Fe,Ie,Le,Re,ze,Be,z,Ve,He,Ue;function We(){return(We=e((()=>{E(),Ne=`2147483600`,R=new Map,Pe=new Map,Fe=null,Ie=[`[data-chrome-flyout-anchor]`,`.env-shell-taskbar__clock`,`.env-ui-statusbar__clock`,`.env-device-tray`],Le=()=>{if(typeof document<`u`){if(document.querySelector(`.env-shell-chrome[data-desktop]`))return!0;let e=document.querySelector(`[data-chrome-layout]`);if(e?.dataset.chromeLayout===`desktop`)return!0;if(e?.dataset.chromeLayout===`mobile`)return!1}return typeof matchMedia<`u`&&matchMedia(`(min-width: 641px)`).matches},Re=e=>{Fe=e},ze=e=>{let t=`data-env-shell-overlays`,n=e||Fe||document.querySelector(`.env-shell-root`)||document.querySelector(`#app`)||document.body,r=n.querySelector(`[${t}]`);if(r)return r.style.zIndex||(r.style.zIndex=Ne),r;try{let e=globalThis.__ENV_OVERLAY_MOUNT__;if(typeof e==`function`)return e(n)}catch{}let i=document.createElement(`div`);return i.setAttribute(t,``),i.className=`env-shell-overlays`,i.setAttribute(`data-part`,`env-overlays`),i.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${Ne};box-sizing:border-box;`,n.appendChild(i),i},Be=(e,t)=>{let n=Le();if(e.style.position=`fixed`,e.style.zIndex=String(Number(Ne)+1),e.style.pointerEvents=`auto`,e.style.margin=`0`,n){e.style.top=`auto`,e.style.left=`auto`,e.style.right=`0.75rem`,e.style.bottom=`4.5rem`,e.style.transform=`none`;return}if(t===`calendar`){e.style.top=`50%`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translate(-50%, -50%)`;return}e.style.top=`calc(env(safe-area-inset-top, 0px) + 0.75rem)`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translateX(-50%)`},z=e=>{let t=R.get(e);if(!t)return;R.delete(e);let n=Pe.get(e);Pe.delete(e),n?.disposeDismiss(),n?.unregisterBack();try{let e=t.el;typeof e.close==`function`?e.close():(e.removeAttribute(`open`),e.hidden=!0),e.dispatchEvent(new CustomEvent(`chrome-flyout-close`,{bubbles:!0}))}catch{}},Ve=e=>{R.has(e.kind)&&z(e.kind);for(let t of[...R.keys()])t!==e.kind&&z(t);R.set(e.kind,{...e,close:()=>z(e.kind)}),e.el.hidden=!1,e.el.removeAttribute(`hidden`),e.el.setAttribute(`open`,``),Pe.set(e.kind,{disposeDismiss:_({root:document,inside:e.el,isInside:t=>e.contains(t.target),exceptSelectors:Ie,onDismiss:()=>z(e.kind)}),unregisterBack:l({id:`chrome-flyout-${e.kind}`,kind:`overlay`,element:e.el,isActive:()=>R.get(e.kind)?.el===e.el&&e.el.isConnected&&!e.el.hidden&&e.el.hasAttribute(`open`),close:()=>(z(e.kind),!0)})})},He=e=>R.has(e),Ue=(e,t)=>{if(He(e)){z(e);return}let n=t();Ve(n)}})))()}var Ge;function Ke(){return(Ke=e((()=>{Ge=`/*
...
@layer calendar {
  ...
  .ui-cal-flyout__day[data-today][data-selected] {
    box-shadow: 0 0 0 2px color-mix(in oklab, var(--cal-base-color) 70%, #fff 20%) inset;
...
}`})))()}function qe(e){try{let t=new Intl.Locale(e),n=(t.weekInfo??t.getWeekInfo?.())?.firstDay;if(typeof n==`number`&&n>=1&&n<=7)return n%7}catch{}return 0}function Je(e,t){let n=new Intl.DateTimeFormat(e,{weekday:`short`,timeZone:`UTC`}),r=[];for(let e=0;e<7;e++){let i=(t+e)%7;r.push(n.format(new Date(tt+i*nt)))}return r}function Ye(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function Xe(e,t,n){let r=new Date,i=new Date(e,t,1),a=new Date(e,t+1,0).getDate(),o=(i.getDay()-n+7)%7,s=Math.ceil((o+a)/7)*7,c=[];for(let n=0;n<s;n++){let i=n-o+1,a=new Date(e,t,i);c.push({date:a,day:a.getDate(),otherMonth:a.getMonth()!==t,isToday:Ye(a,r)})}return c}function Ze(){if(it?.isConnected)return it;let e=ze(),t=e.querySelector(`ui-calendar-flyout`);return t||(t=document.createElement(`ui-calendar-flyout`),t.hidden=!0,e.appendChild(t)),it=t,t}function Qe(e){Ue(et,()=>{let e=Ze(),t=document.documentElement.getAttribute(`data-theme`);return(t===`light`||t===`dark`)&&(e.dataset.theme=t,e.style.colorScheme=t),Be(e,et),e.open(),{kind:et,el:e,close:()=>{e.close(),z(et)},contains:t=>t instanceof Node&&e.contains(t)}})}var $e,et,tt,nt,rt,it;function at(){return(at=e((()=>{E(),o(),L(),j(),We(),Ke(),$e=t(Ge),et=`calendar`,tt=Date.UTC(2023,0,1),nt=864e5,rt=class extends I{#e;#t;#n=null;#r=null;styles=function(){return $e};render=function(){return D`<div class="ui-cal-flyout__panel" part="panel">
        ...
        </div>`};constructor(){super();let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth()}onRender(){super.onRender(),this.#i(),this.#c()}disconnectedCallback(){this.#r?.(),this.#r=null,super.disconnectedCallback?.()}#i(){let e=this.shadowRoot;if(!e||this.#r)return;let t=a(e,`click`,e=>{let t=e.target,n=t?.closest?.(`[data-nav]`);if(n){n.dataset.nav===`prev`?this.#a(-1):n.dataset.nav===`next`&&this.#a(1);return}let r=t?.closest?.(`.ui-cal-flyout__day`);r&&this.#s(r)});this.#r=()=>t?.()}#a(e){this.#t+=e,this.#t<0?(this.#t=11,--this.#e):this.#t>11&&(this.#t=0,this.#e+=1),this.#c()}#o(){let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth(),this.#c()}#s(e){let t=e.dataset.date;t&&(this.#n=new Date(t),this.shadowRoot?.querySelectorAll(`.ui-cal-flyout__day[data-selected]`)?.forEach(e=>e.removeAttribute(`data-selected`)),e.setAttribute(`data-selected`,``),this.dispatchEvent(new CustomEvent(`calendar-select`,{bubbles:!0,composed:!0,detail:{date:this.#n}})))}#c(){let e=this.shadowRoot;if(!e)return;let t=typeof navigator<`u`?navigator.language:void 0,n=qe(t??`en-US`),r=new Date,i=e.querySelector(`.ui-cal-flyout__today`);i&&(i.textContent=r.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`}));let a=e.querySelector(`.ui-cal-flyout__month-label`);a&&(a.textContent=new Date(this.#e,this.#t,1).toLocaleDateString(t,{month:`long`,year:`numeric`}));let o=e.querySelector(`.ui-cal-flyout__weekdays`);o&&o.replaceChildren(...Je(t??`en-US`,n).map(e=>{let t=document.createElement(`span`);return t.className=`ui-cal-flyout__weekday`,t.setAttribute(`role`,`columnheader`),t.textContent=e,t}));let s=e.querySelector(`.ui-cal-flyout__grid`);if(s){let e=Xe(this.#e,this.#t,n);s.replaceChildren(...e.map(e=>{let n=document.createElement(`button`);return n.type=`button`,n.className=`ui-cal-flyout__day`,n.textContent=String(e.day),n.dataset.date=e.date.toISOString(),n.setAttribute(`role`,`gridcell`),e.otherMonth&&n.setAttribute(`data-other-month`,``),e.isToday&&n.setAttribute(`data-today`,``),this.#n&&Ye(e.date,this.#n)&&n.setAttribute(`data-selected`,``),n.setAttribute(`aria-label`,e.date.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`})),n}))}}open(){this.#o(),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},rt=F([f(`ui-calendar-flyout`)],rt),it=null})))()}function ot(){let e=ut.get();return typeof e==`function`?e:null}var st,ct,lt,ut;function dt(){return(dt=e((()=>{st=`__CWSP_SPEED_DIAL_VIEW_OPENER_V1__`,ct=`__CWSP_HOME_OVERLAY_MOUNT_V1__`,lt=e=>{let t=globalThis;return{get:()=>e in t?t[e]:null,set:n=>{t[e]=n}}},ut=lt(st),lt(ct)})))()}var ft;function pt(){return(pt=e((()=>{ft=`/*
...
}`})))()}function mt(){if(Kt?.isConnected)return Kt;let e=ze(),t=e.querySelector(`ui-quick-settings`);return t||(t=document.createElement(`ui-quick-settings`),t.hidden=!0,e.appendChild(t)),Kt=t,t}function ht(e){Ue(vt,()=>{let e=mt(),t=document.documentElement.getAttribute(`data-theme`);return(t===`light`||t===`dark`)&&(e.dataset.theme=t,e.style.colorScheme=t),Be(e,vt),e.open(),{kind:vt,el:e,close:()=>{e.close(),z(vt)},contains:t=>t instanceof Node&&e.contains(t)}})}function gt(){z(vt)}var _t,vt,yt,bt,xt,St,Ct,wt,Tt,Et,Dt,Ot,kt,At,jt,Mt,Nt,Pt,Ft,It,Lt,Rt,zt,Bt,Vt,Ht,Ut,Wt,Gt,Kt;function qt(){return(qt=e((()=>{E(),o(),L(),j(),dt(),We(),pt(),_t=t(ft),vt=`quick-settings`,yt=`data-theme`,bt=`rs-appearance-theme`,xt=`appearance.theme`,St=[`rs-settings`,`cwsp-settings`,`u2-settings`],Ct=()=>{try{return matchMedia?.(`(prefers-color-scheme: dark)`)?.matches??!0}catch{return!0}},wt=e=>{for(let t of St)try{let n=localStorage.getItem(t);if(!n)continue;let r=JSON.parse(n);if(!r||typeof r!=`object`)continue;r.appearance={...r.appearance??{},theme:e},localStorage.setItem(t,JSON.stringify(r))}catch{}},Tt=()=>{try{let e=document.documentElement.getAttribute(yt);if(e===`light`||e===`dark`)return e;let t=localStorage.getItem(bt);if(t===`light`||t===`dark`)return t}catch{}return Ct()?`dark`:`light`},Et=e=>{let t=document.documentElement,n=e===`auto`?Ct()?`dark`:`light`:e,r=e===`auto`?`auto`:e;t.setAttribute(`data-scheme`,r),t.setAttribute(yt,n),t.style.colorScheme=n;try{document.body&&(document.body.style.colorScheme=n)}catch{}try{document.querySelectorAll(`.env-shell-root, [data-shell], ui-window`).forEach(e=>{let t=e;t.dataset.theme=n,t.style.colorScheme=n;let r=t.shadowRoot?.querySelector?.(`.app-shell`);r&&(r.dataset.theme=n,r.style.colorScheme=n)})}catch{}try{localStorage.setItem(bt,e===`auto`?`auto`:e),localStorage.setItem(xt,e===`auto`?`auto`:e)}catch{}e!==`auto`&&wt(e),t.dispatchEvent(new CustomEvent(`u2-theme-change`,{bubbles:!0,detail:{source:`quick-settings`,theme:n,preference:e}}))},Dt=()=>{try{let e=String(localStorage.getItem(bt)||``).trim().toLowerCase();if(e===`light`||e===`dark`||e===`auto`)return e;let t=String(localStorage.getItem(xt)||``).trim().toLowerCase();if(t===`light`||t===`dark`||t===`auto`)return t}catch{}return`auto`},Ot=()=>{let e=globalThis;if(e.__CWSP_AUTO_THEME_FOLLOW__)return;e.__CWSP_AUTO_THEME_FOLLOW__=!0;let t=typeof matchMedia==`function`?matchMedia(`(prefers-color-scheme: dark)`):null;if(!t)return;let n=()=>{Dt()===`auto`&&Et(`auto`)};try{t.addEventListener(`change`,n)}catch{try{t.addListener(n)}catch{}}try{n()}catch{}},kt=e=>{document.documentElement.style.setProperty(`--orientation-lock`,e?`unlocked`:`locked`),document.documentElement.style.setProperty(`--orientation-lock-angle`,e?`0deg`:`90deg`),Promise.try(async()=>{try{let t=screen.orientation;if(e){t.unlock?.();return}if(typeof t.lock!=`function`)return;let n=t.lock(t.type||`natural`);n&&typeof n.catch==`function`&&await n.catch(()=>{})}catch(e){console.warn(e)}})?.catch?.(console.warn.bind(console))},At=`env-night-filter`,jt=`2147483001`,Mt=`rs-night-filter`,Nt=`rs-brightness-filter`,Pt=e=>Math.max(0,Math.min(100,Number.isFinite(e)?e:0)),Ft=()=>{let e=document.getElementById(At);if(e instanceof HTMLElement)return e;let t=document.createElement(`div`);return t.id=At,t.setAttribute(`aria-hidden`,`true`),t.style.cssText=[`dynamic-range-limit:no-limit`,`color-space:display-p3`,`position:fixed`,`inset:0`,`pointer-events:none`,`z-index:${jt}`,`background-color:color(display-p3 1 0.55 0.24)`,`mix-blend-mode:multiply`,`opacity:0`,`visibility:hidden`,`transition:opacity 160ms ease`].join(`;`),(document.body??document.documentElement).appendChild(t),t},It=e=>{let t=Pt(e),n=Ft(),r=t/100;n.style.opacity=String(r),n.style.visibility=r>=.01?`visible`:`hidden`;try{localStorage.setItem(Mt,String(t))}catch{}},Lt=e=>{let t=Pt(e);Ft(),t<=50?.4+t/50*.6:1+(t-50)/50*.2;try{localStorage.setItem(Nt,String(t))}catch{}},Rt=(e,t)=>{try{let n=localStorage.getItem(e);if(n==null)return t;let r=Number(n);return Number.isFinite(r)?Pt(r):t}catch{return t}},zt=()=>{let e=Rt(Mt,0),t=Rt(Nt,50);return It(e),Lt(t),{night:e,brightness:t}},typeof document<`u`&&(document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>zt(),{once:!0}):zt()),Bt=[`wifi`,`bluetooth`,`focus`,`airplane`,`orientation`],Vt={light:`sun`,dark:`moon`},Ht={light:`Light`,dark:`Dark`},Ut=e=>{let t=e.querySelector(`[data-qs-tile="theme"]`);if(!t)return;let n=Tt();t.querySelector(`ui-icon`)?.setAttribute(`icon`,Vt[n]);let r=t.querySelector(`[data-qs-tile-sub]`);r&&(r.textContent=Ht[n]),t.setAttribute(`aria-pressed`,n===`dark`?`true`:`false`)},Wt=e=>{let t=e.shadowRoot,r=t?.querySelector(`.qs-panel`);if(!t||!r||r.hasAttribute(`data-qs-wired`))return;r.setAttribute(`data-qs-wired`,``),Ut(t),t.querySelector(`[data-qs-tile="theme"]`)?.addEventListener(`click`,()=>{let e=Tt()===`dark`?`light`:`dark`;Et(e),Ut(t)});let i=e=>!!e?.getAttribute?.(`aria-pressed`)&&e?.getAttribute?.(`aria-pressed`)===`true`;t.querySelector?.(`[data-qs-tile="orientation"]`)?.addEventListener?.(`click`,e=>{let t=n((e?.target?.matches?.(`[data-qs-tile="orientation"]`)?e?.target:e?.target?.querySelector?.(`[data-qs-tile="orientation"]`))||e?.target,`[data-qs-tile="orientation"]`),r=i(t);kt(r);let a=t?.matches?.(`ui-icon`)?t:t?.querySelector?.(`ui-icon`);a&&a.setAttribute?.(`icon`,r?`device-rotate`:`lock`),a&&a.setAttribute?.(`icon-style`,`duotone`)});for(let e of Bt){let n=t.querySelector(`[data-qs-tile="${e}"]`);n&&n.addEventListener(`click`,()=>{let e=n.getAttribute(`aria-pressed`)!==`true`;n.setAttribute(`aria-pressed`,String(e));let t=n.querySelector(`[data-qs-tile-sub]`);t&&(t.textContent=e?`On`:`Off`)})}let{night:a,brightness:o}=zt(),s=t.querySelector(`[data-qs-slider="night"]`),c=t.querySelector(`[data-qs-slider="brightness"]`);s&&(s.value=String(a),s.addEventListener(`input`,()=>It(s.valueAsNumber))),c&&(c.value=String(o),c.addEventListener(`input`,()=>Lt(c.valueAsNumber)));let l=e=>{gt();let t=()=>{let t=ot();if(typeof t==`function`){t(e,{});return}let n=`#${e}`;typeof location<`u`&&location.hash!==n&&v(n)};typeof requestAnimationFrame==`function`?requestAnimationFrame(t):queueMicrotask(t)};t.querySelectorAll(`[data-qs-open]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=String(e.getAttribute(`data-qs-open`)||``).trim();(t===`settings`||t===`explorer`)&&l(t)})})},Gt=class extends I{constructor(){super()}styles=()=>_t;render=()=>D`
...
</div>`;onRender(){return super.onRender(),Wt(this),this}open(){Ut(this.shadowRoot),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},Gt=F([f(`ui-quick-settings`)],Gt),Kt=null,Promise.try(()=>{typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{Promise.try(()=>{screen?.orientation?.lock?.(`natural`)}).catch(console.warn.bind(console))})}).catch(console.warn.bind(console));try{Ot()}catch{}})))()}var Jt;function Yt(){return(Yt=e((()=>{Jt=`/*
...
@layer ui-statusbar {
  ...
  env-shell-container[data-env-native-task] .env-shell-chrome[data-desktop] {
    ...
    </div>`,r=n.querySelector(`.env-status-bar__pct`);return r instanceof HTMLElement&&A(r,{properties:{textContent:e.batteryPct}}),n}function cn(e,t,n){let r=document.createElement(`ui-statusbar`);r.className=`env-ui-statusbar wf-chrome-no-select`,r.setAttribute(`part`,`status-bar`);let i=document.createElement(`div`);i.slot=`left`,i.className=`env-ui-statusbar__left`;let a=document.createElement(`time`);a.className=`env-ui-statusbar__clock`,a.dateTime=``,a.textContent=tn(),a.setAttribute(`role`,`button`),a.setAttribute(`tabindex`,`0`),a.setAttribute(`aria-label`,`Calendar`),a.setAttribute(`aria-haspopup`,`dialog`),a.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let o=document.createElement(`div`);o.className=`env-ui-statusbar__intro`,t&&(o.innerHTML=t),i.append(a,o);let s=document.createElement(`div`);s.slot=`center`;let c=document.createElement(`p`);c.className=`env-status-bar__meta`,s.appendChild(c);let l=document.createElement(`div`);l.slot=`right`,l.className=`env-ui-statusbar__right`;let u=sn(n,`env-device-tray env-device-tray--footer`);u.setAttribute(`role`,`button`),u.setAttribute(`tabindex`,`0`),u.setAttribute(`aria-label`,`Quick settings`),u.setAttribute(`aria-haspopup`,`dialog`),u.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`),l.appendChild(u);let d=e=>{e.preventDefault(),e.stopPropagation(),Qe(a)},f=e=>{e.preventDefault(),e.stopPropagation(),ht(u)};a.addEventListener(`click`,d),a.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&d(e)}),u.addEventListener(`click`,f),u.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&f(e)}),r.append(i,s,l),ie(()=>{let t=e.navEcho.value?` │ ${e.navEcho.value}`:``;c.textContent=`doc=${e.selectedPath.value} │ viewer=${e.viewerStatus.value} │ layout=${e.mqLabel.value}${t}`},[e.selectedPath,e.viewerStatus,e.mqLabel,e.navEcho],{triggerImmediately:!0});let p=()=>{let e=new Date;a.textContent=tn(e),a.dateTime=e.toISOString()};p();let m=setInterval(p,15e3);return{element:r,dispose:()=>{clearInterval(m)}}}var ln,un;function dn(){return(dn=e((()=>{E(),oe(),at(),qt(),L(),Yt(),o(),ln=t(Jt),un=class extends Me{constructor(){super()}styles=()=>ln;render=()=>D`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},un=F([f(`ui-statusbar`)],un)})))()}function fn(){return(fn=e((()=>{ae(),E()})))()}var pn,mn,hn,B,V,H,U,gn,_n,W,vn,yn,bn,xn,G,Sn,Cn,wn,Tn,En,Dn,On,K,kn,An,q,jn;function Mn(){return(Mn=e((()=>{o(),E(),fn(),pn=320,mn=220,hn=`2147483640`,B=`important`,V=0,H=null,U=null,gn=null,_n=null,W=[],vn=new Map,yn=new Map,bn=new Map,xn=new Map,G=new Map,Sn=()=>{let e=document.documentElement,t=String(e.getAttribute(`data-theme`)||``).trim().toLowerCase();if(t===`light`||t===`dark`)return t;let n=String(e.getAttribute(`data-scheme`)||``).trim().toLowerCase();if(n===`light`||n===`dark`)return n;try{let e=String(localStorage.getItem(`rs-appearance-theme`)||``).trim().toLowerCase();if(e===`light`||e===`dark`)return e}catch{}return typeof matchMedia==`function`&&matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`},Cn=(e,t)=>{e.style.setProperty(`position`,`fixed`,B),e.style.setProperty(`box-sizing`,`border-box`,B),e.style.setProperty(`min-width`,t?`188px`:`220px`,B),e.style.setProperty(`max-width`,`min(320px, calc(100vw - 24px))`,B),e.style.setProperty(`padding`,t?`0.3rem`:`0.4rem`,B),e.style.setProperty(`border-radius`,`14px`,B),e.style.setProperty(`pointer-events`,`auto`,B),e.style.setProperty(`backdrop-filter`,`blur(10px)`,B),e.style.setProperty(`-webkit-backdrop-filter`,`blur(10px)`,B),e.style.removeProperty(`border`),e.style.removeProperty(`background`),e.style.removeProperty(`color`),e.style.removeProperty(`box-shadow`);let n=Sn();e.dataset.theme=n,e.style.setProperty(`color-scheme`,n===`light`?`light only`:`dark only`,B)},wn=e=>{e.style.setProperty(`list-style`,`none`,B),e.style.setProperty(`list-style-type`,`none`,B),e.style.setProperty(`margin`,`0`,B),e.style.setProperty(`padding`,`0`,B),e.style.setProperty(`display`,`flex`,B),e.style.setProperty(`flex-direction`,`column`,B),e.style.setProperty(`align-items`,`stretch`,B),e.style.setProperty(`gap`,`0.2rem`,B),e.style.setProperty(`width`,`100%`,B),e.style.setProperty(`box-sizing`,`border-box`,B)},Tn=(e,t)=>{if(e.style.setProperty(`appearance`,`none`,B),e.style.setProperty(`-webkit-appearance`,`none`,B),e.style.setProperty(`box-sizing`,`border-box`,B),e.style.setProperty(`width`,`100%`,B),e.style.setProperty(`max-width`,`100%`,B),e.style.setProperty(`margin`,`0`,B),e.style.setProperty(`display`,`grid`,B),e.style.setProperty(`grid-template-columns`,`1.375rem minmax(0, 1fr) auto`,B),e.style.setProperty(`align-items`,`center`,B),e.style.setProperty(`justify-items`,`start`,B),e.style.setProperty(`gap`,`0.55rem`,B),e.style.setProperty(`border`,`none`,B),e.style.setProperty(`border-radius`,`10px`,B),e.style.setProperty(`padding`,`0.5rem 0.6rem`,B),e.style.setProperty(`min-height`,`2.35rem`,B),e.style.setProperty(`font`,`inherit`,B),e.style.setProperty(`font-size`,`0.8125rem`,B),e.style.setProperty(`line-height`,`1.25`,B),e.style.setProperty(`text-align`,`start`,B),e.style.setProperty(`cursor`,`pointer`,B),e.style.removeProperty(`background`),e.style.removeProperty(`background-color`),!t)e.style.setProperty(`color`,`inherit`,B);else{let t=Sn()===`light`?`#9f1239`:`#fecaca`;e.style.setProperty(`color`,t,B),e.style.setProperty(`--cw-menu-fg`,t,B)}},En=()=>{let e=document.getElementById(`cw-unified-context-menu-style`);e||(e=document.createElement(`style`),e.id=`cw-unified-context-menu-style`,document.head.appendChild(e)),e.textContent=`
        .cw-context-menu-layer {
            position: fixed;
            inset: 0;
            z-index: var(--cw-context-menu-layer-z, ${hn});
            pointer-events: none;
        }
    ...
    `},Dn=()=>{for(let e of W)try{e()}catch{}W=[]},On=e=>{for(let[t,n]of Array.from(xn.entries()))t>=e&&(clearTimeout(n),xn.delete(t));for(let[t,n]of Array.from(G.entries()))t>=e&&(clearTimeout(n),G.delete(t))},K=e=>{On(e);for(let[t,n]of Array.from(vn.entries()))t>=e&&(bn.get(t)?.dispose(),bn.delete(t),n.remove(),vn.delete(t),yn.delete(t))},kn=e=>{for(let[t,n]of Array.from(G.entries()))t>=e&&(clearTimeout(n),G.delete(t))},An=(e,t,n,r,i)=>{let a=document.createElement(`div`);a.className=`cw-context-menu${t?` cw-context-menu--compact`:``}`,a.setAttribute(`role`,`menu`),a.dataset.menuDepth=String(n),a.style.zIndex=String(n+1);let o=document.createElement(`ul`);o.className=`cw-context-menu__list`,wn(o),a.appendChild(o);let s=(e,n,a)=>{if(r!==V||!U?.isConnected||!H?.isConnected||(K(a),!e.children?.length))return;let o=An(e.children,t,a,r,i);o.classList.add(`cw-context-menu--submenu`),H.appendChild(o),vn.set(a,o),yn.set(a,n),bn.set(a,C(o,{origin:{type:`element`,element:n},placement:`right-start`,fallbacks:[`left-start`,`right-end`,`left-end`],strategy:i}))},c=(e,t,n)=>{let r=xn.get(n);r&&clearTimeout(r),kn(n);let i=setTimeout(()=>{xn.delete(n),s(e,t,n)},pn);xn.set(n,i)},l=e=>{let t=G.get(e);t&&clearTimeout(t);let n=setTimeout(()=>{G.delete(e),K(e)},mn);G.set(e,n)};for(let t of e){let e=document.createElement(`button`);e.type=`button`,e.className=`cw-context-menu__item${t.danger?` cw-context-menu__item--danger`:``}`,e.setAttribute(`role`,`menuitem`),e.disabled=!!t.disabled,Tn(e,!!t.danger);let i=!!t.children?.length;if(e.innerHTML=`
        ...
        `,i){let i=n+1;e.setAttribute(`aria-haspopup`,`menu`),e.addEventListener(`pointerenter`,()=>c(t,e,i)),e.addEventListener(`pointerleave`,()=>l(i)),e.addEventListener(`click`,n=>{if(n.preventDefault(),n.stopPropagation(),r!==V||!U?.isConnected)return;kn(i);let a=vn.get(i),o=yn.get(i);if(a?.isConnected&&o===e){K(i);return}s(t,e,i)})}else e.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation(),!(r!==V||!U?.isConnected)&&(q(),!t.disabled&&await t.action())});let a=document.createElement(`li`);a.appendChild(e),o.appendChild(a)}return Cn(a,t),a.addEventListener(`pointerenter`,()=>kn(n)),a.addEventListener(`pointerleave`,()=>{if(n>0){let e=G.get(n);e&&clearTimeout(e);let t=setTimeout(()=>{G.delete(n),K(n)},mn);G.set(n,t)}}),a},q=()=>{Dn(),On(0),_n?.(),_n=null,gn?.dispose(),gn=null,K(1),vn.clear(),yn.clear(),bn.clear(),U?.remove(),U=null,H?.remove(),H=null,V+=1},jn=e=>{let t=(e.items||[]).filter(e=>e&&e.id&&e.label);if(!t.length){q();return}En(),q();let n=V,r=w()??document.body,i=document.createElement(`div`);i.className=`cw-context-menu-layer`,H=i,r.appendChild(i);let a=e.placementStrategy??`auto`,o=An(t,!!e.compact,0,n,a);U=o,i.appendChild(o),gn=C(o,{origin:{type:`point`,x:e.x,y:e.y},placement:`bottom-start`,gap:0,strategy:`js`}),_n=l({id:`context-menu-${n}`,kind:`context-menu`,element:i,isActive:()=>V===n&&H===i&&i.isConnected,close:()=>(q(),!0)});let s=e=>{if(n!==V||!H?.isConnected)return;let t=e.target;t&&H.contains(t)||q()},c=e=>{if(n!==V||!U?.isConnected)return;let t=e.target;if(!t)return;let r=t.closest?.(`.cw-context-menu__item`);if(!r){K(1);return}r.getAttribute(`aria-haspopup`)!==`menu`&&K(1)},u=e=>{n===V&&e.key===`Escape`&&q()},d=()=>q();document.addEventListener(`pointerdown`,s,{capture:!0}),document.addEventListener(`contextmenu`,s,{capture:!0}),document.addEventListener(`keydown`,u),o.addEventListener(`click`,c,{capture:!0}),window.addEventListener(`resize`,d,{passive:!0}),window.addEventListener(`blur`,d,{passive:!0}),W.push(()=>document.removeEventListener(`pointerdown`,s,{capture:!0})),W.push(()=>document.removeEventListener(`contextmenu`,s,{capture:!0})),W.push(()=>document.removeEventListener(`keydown`,u)),W.push(()=>o.removeEventListener(`click`,c,{capture:!0})),W.push(()=>window.removeEventListener(`resize`,d)),W.push(()=>window.removeEventListener(`blur`,d))}})))()}function Nn(e){globalThis.dispatchEvent?.(new CustomEvent(`view:toast`,{detail:{type:`success`,message:String(e||``)}}))}function Pn(e){let t=String(e||`default`).trim().toLowerCase();return zn[t]||`default`}function Fn(e){return String(e||``).trim().toLowerCase().startsWith(`android-icon:`)}function In(e,t=`default`,n=``,r=``){let i=String(e||``).trim();if(!i)return``;let a=Pn(t),o=String(n||``).trim(),s=String(r||``).trim(),c=new URLSearchParams;a!=="default"&&c.set(`v`,a),o&&c.set(`pack`,o),s&&c.set(`drawable`,s);let l=c.toString();return l?`android-icon:${i}?${l}`:`android-icon:${i}`}function Ln(e){let t=String(e||``).trim();if(!Fn(t))return null;let n=t.slice(13).replace(/^\/\//,``);if(!n)return null;let r=(e,t)=>{if(!e)return null;let n={packageName:e,variant:Pn(t.get(`v`)||`default`)},r=String(t.get(`pack`)||``).trim(),i=String(t.get(`drawable`)||``).trim();return r&&(n.pack=r),i&&(n.drawable=i),n};try{let e=new URL(n.includes(`://`)?n:`android-icon://${n}`);return r(String(e.hostname||e.pathname.replace(/^\//,``)||``).trim(),e.searchParams)}catch{let[e,t=``]=n.split(`?`);return r(String(e||``).trim(),new URLSearchParams(t))}}function Rn(e,t=`default`,n=``,r=``,i=0){let a=String(e||``).trim();if(!a)return``;let o=Pn(t),s=String(n||``).trim(),c=String(r||``).trim(),l=o==="default"?a:`${a}#${o}`;s&&(l=`${l}#pack:${s}`),c&&(l=`${l}#d:${c}`);let u=Math.round(Number(i)||0);return u>0&&(l=`${l}#s${u}`),l}var zn;function Bn(){return(Bn=e((()=>{zn={default:`default`,full:`default`,colored:`default`,monochrome:`monochrome`,mono:`monochrome`,material:`monochrome`,"material-you":`monochrome`,themed:`monochrome`,foreground:`foreground`,fg:`foreground`,"adaptive-fg":`foreground`}})))()}async function Vn(e){let t=await(await fetch(e)).blob(),n=t.type&&t.type.startsWith(`image/`)?t.type:`image/png`,r=t.type===n?t:new Blob([await t.arrayBuffer()],{type:n});return URL.createObjectURL(r)}function Hn(e,t=96,n=`default`,r=``,i=``){let a=String(e||``).trim();if(!a)return``;if(a.startsWith(`shortcut:`)){let e=a.slice(9),n=e.indexOf(`/`);return n>0?Wn(e.slice(0,n),e.slice(n+1),t):``}return Zn.get(Rn(a,n,r,i,t))||``}async function Un(e,t,n=96){let r=String(e||``).trim(),i=String(t||``).trim();if(!r||!i)return``;let a=Math.max(16,Math.min(512,Math.round(Number(n)||96))),o=`shortcut:${r}/${i}@${a}`,s=$n.get(o);if(s)return s;let c=er.get(o);return c||(c=(async()=>{let e=await qn();if(!e?.launcherShortcutIcon)return``;let t=``;try{t=String(await e.launcherShortcutIcon(r,i,a)||``).trim()}catch{return``}if(!t)return``;try{let e=await Vn(t);return $n.set(o,e),e}catch{return t}})().finally(()=>{er.delete(o)}),er.set(o,c)),c}function Wn(e,t,n=96){let r=String(e||``).trim(),i=String(t||``).trim();if(!r||!i)return``;let a=Math.max(16,Math.min(512,Math.round(Number(n)||96)));return $n.get(`shortcut:${r}/${i}@${a}`)||``}async function J(e,t=96,n=`default`,r=``,i=``){let a=String(e||``).trim();if(!a)return``;if(a.startsWith(`shortcut:`)){let e=a.slice(9),n=e.indexOf(`/`);return n>0?Un(e.slice(0,n),e.slice(n+1),t):``}let o=Pn(n),s=String(r||``).trim(),c=String(i||``).trim(),l=Math.max(16,Math.min(512,Math.round(Number(t)||96))),u=Rn(a,o,s,c,l),d=Zn.get(u);if(d)return d;let f=Qn.get(u);f||(f=(async()=>{let e=await qn();if(!e?.launcherIcon)return``;let t=``;try{t=await e.launcherIcon(a,l,o,s||void 0,c||void 0)}catch{return``}if(!t)return``;try{let e=await Vn(t);return Zn.set(u,e),e}catch{return``}})(),Qn.set(u,f));try{return await f}finally{Qn.delete(u)}}async function Gn(e,t=96){let n=String(e||``).trim();if(!n||n.startsWith(`blob:`))return``;let r=Ln(n);return r?J(r.packageName,t,r.variant,r.pack||``,r.drawable||``):n}function Kn(e,t=96){let n=Ln(e);return n?Hn(n.packageName,t,n.variant,n.pack||``,n.drawable||``):``}async function qn(){if(Xn)return Xn;try{return await c(()=>import(`./launcher-bridge-C3JnBhTN.js`),[],import.meta.url)}catch{return null}}async function Jn(){return qn()}function Yn(e,t,n=`colored`){let r=String(t||``).trim();if(!r)return;e.setAttribute(`icon-padding`,`0`),e.style.setProperty(`--icon-padding`,`0px`),e.style.setProperty(`--icon-size`,`100%`),e.toggleAttribute(`data-launcher-icon`,!0);let i=()=>{let t=e;return typeof t.setResourceIcon==`function`&&(t.setResourceIcon(r,n===`auto`?`auto`:n),n!==`auto`&&typeof t.setBitmapPresentationMode==`function`&&t.setBitmapPresentationMode(n,!0),e.toggleAttribute(`data-launcher-icon-ready`,!0),!0)};i()||customElements.whenDefined(`ui-icon`).then(()=>{e.isConnected&&i()})}var Xn,Zn,Qn,$n,er;function tr(){return(tr=e((()=>{E(),pe(),dt(),Bn(),s(),Xn=null,Zn=new Map,Qn=new Map,$n=new Map,er=new Map})))()}function nr(e,t=64){let n=String(e||``).trim();if(!n||!/^https?:\/\//i.test(n))return``;try{let e=new URL(n).hostname;return e?`https://www.google.com/s2/favicons?domain=${encodeURIComponent(e)}&sz=${t}`:``}catch{return``}}function rr(e){let t=String(e||``).trim().toLowerCase();return t?t.includes(`/_favicon/`)||t.includes(`s2/favicons`)||t.includes(`favicon`)?!0:(t.startsWith(`android-icon:`),!1):!1}function ir(e){wr=e}function ar(e){let t=e||(globalThis.chrome?.bookmarks??null);return!t?.getTree||!t?.getChildren?null:{resolveIconUrl:(e,t=128)=>{let n=String(e||``).trim();if(!/^https?:\/\//i.test(n))return``;let r=nr(n,t);if(r)return r;try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`){let r=new URL(e.getURL(`/_favicon/`));return r.searchParams.set(`pageUrl`,n),r.searchParams.set(`size`,String(t)),r.toString()}}catch{}return``},async listChildren(e){if(e)return(await Er(t,`getChildren`,e)||[]).map(Dr);let n=await Er(t,`getTree`)||[],r=[];for(let e of n)for(let t of e.children||[])r.push(Dr(t));return r},async search(e){let n=String(e||``).trim();if(!n)return this.listChildren();if(typeof t.search!=`function`){let e=await this.listChildren(),t=n.toLowerCase();return e.filter(e=>e.title.toLowerCase().includes(t)||String(e.url||``).toLowerCase().includes(t))}return(await Er(t,`search`,n)||[]).map(Dr)},async open(e){if(e.folder)return;let t=String(e.url||``).trim();if(t){try{let e=globalThis.chrome?.tabs;if(typeof e?.create==`function`){await Promise.resolve(e.create({url:t}));return}}catch{}globalThis.open?.(t,`_blank`,`noopener,noreferrer`)}}}}function or(){return wr||ar()}function sr(){return!!or()}function cr(){try{let e=localStorage.getItem(br);if(!e)return[];let t=JSON.parse(e);return Array.isArray(t)?t.filter(e=>e&&e.id&&e.title).slice(0,Sr):[]}catch{return[]}}function lr(e){if(!e?.id||e.folder)return;let t=[e,...cr().filter(t=>t.id!==e.id)].slice(0,Sr);try{localStorage.setItem(br,JSON.stringify(t))}catch{}}function ur(){return Or(xr,Cr)}function dr(e){return ur().some(t=>t.id===e)}function fr(e){if(!e?.id||e.folder||!String(e.url||``).trim())return!1;let t=[e,...ur().filter(t=>t.id!==e.id)].slice(0,Cr);try{return localStorage.setItem(xr,JSON.stringify(t)),!0}catch{return!1}}function pr(e){let t=String(e||``).trim();if(!t)return!1;let n=ur().filter(e=>e.id!==t);try{return localStorage.setItem(xr,JSON.stringify(n)),!0}catch{return!1}}function mr(e,t=Y){let n=String(e||``).trim();if(!n)return``;try{let e=new URL(n,globalThis.location?.href);if(e.searchParams.has(`pageUrl`))return e.searchParams.set(`size`,String(t)),e.toString();if(e.hostname.endsWith(`google.com`)&&e.pathname.includes(`favicon`))return e.searchParams.set(`sz`,String(t)),e.toString()}catch{}return n}function hr(e,t){let n=String(e.url||``).trim();return n&&(nr(n,Y)||nr(n,128)||nr(n,64)||t?.resolveIconUrl?.(n,Y)||t?.resolveIconUrl?.(n,128))||``}function gr(e,t,n,r=``){return vr(e,t,String(r||``).trim()||mr(hr(e,n),Y))}function _r(e,t=``){let n=String(e.url||``).trim();return JSON.stringify({state:{icon:e.folder?`folder`:`link`,label:e.title||n||`Bookmark`,action:e.folder?`open-path`:`open-link`},desc:{action:e.folder?`open-path`:`open-link`,href:e.folder?``:n,path:e.folder?`/bookmarks/${e.id}/`:`/bookmarks/${e.id}`,meta:{entityType:`bookmark`,bookmarkId:e.id,...t?{iconUrl:t}:{}}}})}function vr(e,t,n=``){if(e.folder||!String(e.url||``).trim())return null;let r=t??ye(),i=ge(_r(e,n),r);return i?(Ce(i),i):null}async function yr(e,t,n){if(e.replaceChildren(),t.folder)return kr(e,`folder`),e.toggleAttribute(`data-bookmark-bitmap`,!1),``;let r=String(t.url||``).trim(),i=[],a=nr(r,Y);a&&i.push(a);let o=nr(r,128);o&&!i.includes(o)&&i.push(o);let s=nr(r,64);s&&!i.includes(s)&&i.push(s);let c=n?.resolveIconUrl?.(r,Y)||``;c&&!i.includes(c)&&i.push(c);let l=n?.resolveIconUrl?.(r,128)||``;l&&!i.includes(l)&&i.push(l);let u=n?.resolveIconUrl?.(r,64)||``;u&&!i.includes(u)&&i.push(u);try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`&&r){let t=new URL(e.getURL(`/_favicon/`));t.searchParams.set(`pageUrl`,r),t.searchParams.set(`size`,String(Y));let n=t.toString();n&&!i.includes(n)&&i.push(n)}}catch{}return kr(e,`link`),e.toggleAttribute(`data-bookmark-bitmap`,!1),i.length?await new Promise(t=>{let n=0,r=()=>{if(n>=i.length){t(``);return}let a=i[n++],o=document.createElement(`img`);o.className=`env-shell-app-menu__tile-favicon`,o.alt=``,o.decoding=`async`,o.loading=`eager`,o.referrerPolicy=`no-referrer`,o.draggable=!1,o.addEventListener(`load`,()=>{e.replaceChildren(o),e.toggleAttribute(`data-bookmark-bitmap`,!0),t(a)},{once:!0}),o.addEventListener(`error`,()=>{r()},{once:!0}),o.src=a};r()}):``}var br,xr,Sr,Cr,wr,Tr,Er,Dr,Or,Y,kr;function Ar(){return(Ar=e((()=>{pe(),br=`rs-app-menu-bookmark-recent`,xr=`rs-app-menu-bookmark-pinned`,Sr=12,Cr=16,wr=null,Tr=()=>{try{let e=globalThis.chrome?.runtime?.lastError;return e?Error(String(e.message||e)):null}catch{return null}},Er=(e,t,...n)=>{let r=e[t];if(typeof r!=`function`)return Promise.reject(Error(`chrome.bookmarks.${String(t)} missing`));try{let t=r.apply(e,n);if(t!=null&&typeof t.then==`function`)return t}catch(e){return Promise.reject(e)}return new Promise((t,i)=>{try{r.apply(e,[...n,e=>{let n=Tr();n?i(n):t(e)}])}catch(e){i(e)}})},Dr=e=>{let t=typeof e.url==`string`&&e.url?e.url:void 0;return{id:String(e.id),title:String(e.title||e.url||e.id||`Bookmark`),url:t,folder:!t,parentId:e.parentId}},Or=(e,t)=>{try{let n=localStorage.getItem(e);if(!n)return[];let r=JSON.parse(n);return Array.isArray(r)?r.filter(e=>e&&e.id&&e.title&&!e.folder).slice(0,t):[]}catch{return[]}},Y=256,kr=(e,t)=>{let n=document.createElement(`ui-icon`);n.setAttribute(`icon`,t),n.setAttribute(`icon-style`,`duotone`),n.setAttribute(`aria-hidden`,`true`),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`),n.style.setProperty(`--icon-color`,`currentColor`),n.style.color=`currentColor`,e.append(n),customElements.whenDefined(`ui-icon`).then(()=>{n.isConnected&&(n.getAttribute(`icon`)||n.setAttribute(`icon`,t),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`))})}})))()}function jr(e){return e===`light`||e===`dark`?e:String(document.documentElement.getAttribute(`data-theme`)||``).toLowerCase()===`light`?`light`:`dark`}function Mr(e){let t=String(e||``).trim();return/^https?:\/\//i.test(t)?t:``}function Nr(e,t=128){try{let n=new URL(e).hostname;return n?`https://www.google.com/s2/favicons?domain=${encodeURIComponent(n)}&sz=${t}`:``}catch{return``}}function Pr(e,t=128){try{let n=globalThis.chrome?.runtime;if(typeof n?.getURL!=`function`)return``;let r=new URL(n.getURL(`/_favicon/`));return r.searchParams.set(`pageUrl`,e),r.searchParams.set(`size`,String(t)),r.toString()}catch{return``}}function Fr(e,t){let n=Mr(e);if(!n)return[];let r=[],i=new Set,a=(e,t)=>{let n=String(t||``).trim();!n||i.has(n)||(i.add(n),r.push({label:e,url:n}))},o=t?.resolveIconUrl?.(n,128)||t?.resolveIconUrl?.(n,64)||``,s=Nr(n,128);s&&a(`Google S2`,s);let c=Nr(n,64);c&&a(`Google S2 (64)`,c);let l=Pr(n,128);return l&&a(`Chrome favicon`,l),o&&a(`Bookmark favicon`,o),r}function Ir(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`sd-icon-picker__card`,n.title=t||e,n.style.setProperty(`display`,`flex`,`important`),n.style.setProperty(`flex-direction`,`column`,`important`),n.style.setProperty(`flex-wrap`,`nowrap`,`important`),n.style.setProperty(`align-items`,`center`,`important`),n.style.setProperty(`justify-content`,`center`,`important`),n.style.setProperty(`gap`,`0.28rem`,`important`),n.style.setProperty(`min-inline-size`,`0`,`important`),n.style.setProperty(`overflow`,`hidden`,`important`),n.style.setProperty(`inline-size`,`auto`,`important`),n.style.setProperty(`text-align`,`center`,`important`);let r=document.createElement(`img`);r.alt=``,r.decoding=`async`,r.draggable=!1,r.referrerPolicy=`no-referrer`,r.style.setProperty(`display`,`block`,`important`),r.style.setProperty(`order`,`0`,`important`);let i=document.createElement(`span`);return i.className=`sd-icon-picker__card-label`,i.textContent=e,i.style.setProperty(`display`,`block`,`important`),i.style.setProperty(`order`,`1`,`important`),i.style.setProperty(`inline-size`,`100%`,`important`),i.style.setProperty(`text-align`,`center`,`important`),i.style.setProperty(`overflow`,`hidden`,`important`),i.style.setProperty(`text-overflow`,`ellipsis`,`important`),i.style.setProperty(`white-space`,`nowrap`,`important`),n.append(r,i),{btn:n,img:r}}async function Lr(e,t,n,r,i){n.replaceChildren();let a=Gr.map(e=>({...e,available:!0}));try{let n=await e.launcherIconVariants?.(t);Array.isArray(n)&&n.length&&(a=n.map(e=>({id:Pn(e.id),label:String(e.label||e.id),available:e.available!==!1})))}catch{}for(let e of a){if(!e.available&&e.id!=="default")continue;let{btn:a,img:o}=Ir(e.label);n.append(a),J(t,96,e.id).then(t=>{if(!t){a.disabled=!0,a.title=`${e.label} (unavailable)`;return}o.src=t}),a.addEventListener(`click`,()=>{r({iconUrl:In(t,e.id),packageName:t,variant:e.id,label:e.label,source:`android`}),i()})}}async function Rr(e,t,n,r,i){if(n.replaceChildren(),!e.launcherIconPacks){n.textContent=`Icon packs unavailable.`;return}let a=[];try{a=await e.launcherIconPacks()}catch{n.textContent=`Failed to list icon packs.`;return}if(!a.length){n.textContent=`No icon packs installed.`;return}let o=document.createDocumentFragment();for(let s of a.slice(0,64)){let a=String(s.packageName||``).trim();if(!a)continue;let c=String(s.label||a),l=document.createElement(`div`);l.className=`sd-icon-picker__pack-wrap`,l.style.setProperty(`display`,`flex`,`important`),l.style.setProperty(`flex-direction`,`column`,`important`),l.style.setProperty(`gap`,`0.2rem`,`important`),l.style.setProperty(`min-inline-size`,`0`,`important`);let{btn:u,img:d}=Ir(c,`${c} — themed for this app`);J(t,96,`default`,a).then(e=>{if(e){d.src=e;return}u.disabled=!0,u.title=`${c} (no cover for this app)`,J(a,72,`default`).then(e=>{e&&(d.src=e)})}),u.addEventListener(`click`,()=>{u.disabled||(r({iconUrl:In(t,`default`,a),packageName:t,variant:`default`,pack:a,label:c,source:`icon-pack`}),i())});let f=document.createElement(`button`);f.type=`button`,f.className=`sd-icon-picker__pack-browse`,f.textContent=`Browse…`,f.title=`Browse icons in ${c}`,f.style.cssText=`font:inherit;font-size:0.68rem;padding:0.15rem 0.35rem;border-radius:6px;border:1px solid color-mix(in oklab,currentColor 22%,transparent);background:transparent;color:inherit;cursor:pointer;`,f.addEventListener(`click`,o=>{o.preventDefault(),o.stopPropagation(),zr(e,t,a,c,n,r,i,()=>{Rr(e,t,n,r,i)})}),l.append(u,f),o.append(l)}n.append(o)}async function zr(e,t,n,r,i,a,o,s){i.replaceChildren();let c=document.createElement(`div`);c.style.cssText=`display:flex;flex-wrap:wrap;gap:0.35rem;align-items:center;margin-block-end:0.35rem;grid-column:1/-1;`;let l=document.createElement(`button`);l.type=`button`,l.textContent=`← Packs`,l.style.cssText=`font:inherit;font-size:0.75rem;padding:0.2rem 0.45rem;border-radius:6px;border:1px solid color-mix(in oklab,currentColor 22%,transparent);background:transparent;color:inherit;cursor:pointer;`,l.addEventListener(`click`,()=>s());let u=document.createElement(`span`);u.textContent=r,u.style.cssText=`font-size:0.78rem;opacity:0.85;flex:1;min-inline-size:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;`;let d=document.createElement(`input`);d.type=`search`,d.placeholder=`Filter drawables…`,d.autocomplete=`off`,d.className=`sd-icon-picker__search`,d.style.setProperty(`flex`,`1 1 8rem`,`important`),c.append(l,u,d);let f=document.createElement(`div`);f.className=`sd-icon-picker__grid`,f.style.setProperty(`display`,`grid`,`important`),f.style.setProperty(`grid-template-columns`,`repeat(3, minmax(0, 1fr))`,`important`),f.style.setProperty(`gap`,`0.4rem`,`important`),f.style.setProperty(`grid-column`,`1 / -1`,`important`),i.style.setProperty(`display`,`flex`,`important`),i.style.setProperty(`flex-direction`,`column`,`important`),i.append(c,f);let p=0,m=()=>{(async()=>{if(f.replaceChildren(),!e.launcherIconPackIcons){f.textContent=`Pack browse unavailable.`;return}let i=[];try{i=await e.launcherIconPackIcons(n,String(d.value||``),96)}catch{f.textContent=`Failed to list pack icons.`;return}if(!i.length){f.textContent=`No matching icons.`;return}let s=document.createDocumentFragment(),c=t||n;for(let e of i){let t=String(e.drawable||``).trim();if(!t)continue;let{btn:i,img:l}=Ir(String(e.label||t),`${r}: ${t}`);s.append(i),J(c,72,`default`,n,t).then(e=>{e?l.src=e:i.disabled=!0}),i.addEventListener(`click`,()=>{i.disabled||(a({iconUrl:In(c,`default`,n,t),packageName:c,variant:`default`,pack:n,drawable:t,label:String(e.label||t),source:`icon-pack`}),o())})}f.append(s)})()};d.addEventListener(`input`,()=>{window.clearTimeout(p),p=window.setTimeout(m,160)}),m()}async function Br(e,t,n,r,i){if(n.replaceChildren(),!e.launcherList){n.textContent=`App list unavailable.`;return}let a=[];try{a=await e.launcherList(t)}catch{n.textContent=`Failed to list apps.`;return}if(!a.length){n.textContent=t.trim()?`No matches.`:`No apps.`;return}let o=document.createDocumentFragment();for(let e of a.slice(0,48)){let t=String(e.packageName||``).trim();if(!t)continue;let{btn:n,img:a}=Ir(String(e.label||t),`${e.label} (${t})`);o.append(n),J(String(e.iconCacheKey||t).trim()||t,72,`default`).then(e=>{e&&(a.src=e)}),n.addEventListener(`click`,()=>{r({iconUrl:In(t,`default`),packageName:t,variant:`default`,label:String(e.label||t),source:`android`}),i()})}n.append(o)}function Vr(e,t,n,r,i){n.replaceChildren();let a=Fr(e,t);if(!a.length){n.textContent=`No favicon sources for this URL.`;return}for(let e of a){let{btn:t,img:a}=Ir(e.label,e.url);a.src=e.url,a.addEventListener(`error`,()=>{t.disabled=!0,t.title=`${e.label} (failed to load)`}),t.addEventListener(`click`,()=>{r({iconUrl:e.url,label:e.label,source:`favicon`}),i()}),n.append(t)}}async function Hr(e,t,n,r,i){n.replaceChildren();let a=[];try{let n=String(t||``).trim();a=n?await e.search(n):await e.listChildren()}catch{n.textContent=`Failed to list bookmarks.`;return}let o=a.filter(e=>!e.folder&&Mr(e.url));if(!o.length){n.textContent=t.trim()?`No matching bookmarks.`:`No bookmarks.`;return}let s=document.createDocumentFragment();for(let t of o.slice(0,48)){let n=Mr(t.url);if(!n)continue;let a=e.resolveIconUrl?.(n,64)||Pr(n,64)||Nr(n,64),{btn:o,img:c}=Ir(String(t.title||n),n);a&&(c.src=a),s.append(o),o.addEventListener(`click`,()=>{let o=e.resolveIconUrl?.(n,128)||Pr(n,128)||Nr(n,128)||a;o&&(r({iconUrl:o,label:String(t.title||n),source:`bookmark`}),i())})}n.append(s)}async function Ur(e){let t=await Jn(),n=or(),r=!!t?.launcherIcon,i=Mr(e.pageUrl)||Mr(e.currentUrl)||``;if(!r&&!(n||i)){console.warn(`[icon-resource-picker] no launcher bridge or bookmarks/favicon source`);return}let a=jr(e.theme),o=String(e.packageName||``).trim(),s=r&&!!o,c=r&&!!o&&!!t?.launcherIconPacks,l=r&&!!t?.launcherList,u=!!i,d=!!n,f=document.createElement(`dialog`);f.className=`speed-dial-editor sd-icon-picker`,f.dataset.theme=a,f.innerHTML=`
        <form class="speed-dial-editor__form sd-icon-picker__form" data-theme="${a}" method="dialog">
            <header class="modal-header">
                <h2 class="modal-title">Pick icon</h2>
                <p class="modal-description">${r?`Material You / adaptive, icon packs, installed apps, or a favicon.`:`Favicon for this link, or pick from Chrome bookmarks.`}</p>
            </header>
            <div class="modal-fields sd-icon-picker__body">
                <section class="sd-icon-picker__section" data-section="variants" ${s?``:`hidden`}>
                    <div class="sd-icon-picker__section-title">For this package</div>
                    <div class="sd-icon-picker__grid" data-variants></div>
                </section>
                <section class="sd-icon-picker__section" data-section="packs" ${c?``:`hidden`}>
                    <div class="sd-icon-picker__section-title">Icon packs</div>
                    <div class="sd-icon-picker__grid" data-packs></div>
                </section>
                <section class="sd-icon-picker__section" data-section="favicon" ${u?``:`hidden`}>
                    <div class="sd-icon-picker__section-title">For this link</div>
                    <div class="sd-icon-picker__grid" data-favicon></div>
                </section>
                <section class="sd-icon-picker__section" data-section="browse" ${l?``:`hidden`}>
                ...
                <section class="sd-icon-picker__section" data-section="bookmarks" ${d?``:`hidden`}>
    ...
    `;let p=f.querySelector(`form`),m=f.querySelector(`[data-variants]`),h=f.querySelector(`[data-packs]`),g=f.querySelector(`[data-favicon]`),_=f.querySelector(`[data-browse]`),v=f.querySelector(`[data-bookmarks]`),y=f.querySelector(`[data-search="apps"]`),b=f.querySelector(`[data-search="bookmarks"]`),x=!1,S=()=>{if(!x){x=!0;try{f.open&&f.close()}catch{}f.remove()}},C=t=>{e.onPick(t)};p.addEventListener(`click`,e=>{e.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`)===`cancel`&&(e.preventDefault(),S())}),f.addEventListener(`cancel`,e=>{e.preventDefault(),S()}),f.addEventListener(`click`,e=>{e.target===f&&S()}),s&&t&&m&&Lr(t,o,m,C,S),c&&t&&h&&o&&Rr(t,o,h,C,S),u&&g&&Vr(i,n,g,C,S);let w=0,T=()=>{!_||!t||Br(t,String(y?.value||``),_,C,S)};l&&(y?.addEventListener(`input`,()=>{window.clearTimeout(w),w=window.setTimeout(T,180)}),T());let E=0,D=()=>{!v||!n||Hr(n,String(b?.value||``),v,C,S)};d&&n&&(b?.addEventListener(`input`,()=>{window.clearTimeout(E),E=window.setTimeout(D,180)}),D()),document.body.append(f),f.querySelectorAll(`.sd-icon-picker__grid`).forEach(e=>{e.style.setProperty(`display`,`grid`,`important`),e.style.setProperty(`grid-template-columns`,`repeat(3, minmax(0, 1fr))`,`important`),e.style.setProperty(`gap`,`0.4rem`,`important`),e.style.setProperty(`align-content`,`start`,`important`),e.style.setProperty(`min-inline-size`,`0`,`important`)});try{f.showModal()}catch{f.setAttribute(`open`,``)}}function Wr(e,t,n){let r=e.querySelector(`.sd-icon-resource-row`);r||(r=document.createElement(`div`),r.className=`sd-icon-resource-row`,t.replaceWith(r),r.append(t)),r.style.setProperty(`display`,`grid`,`important`),r.style.setProperty(`grid-template-columns`,`minmax(0,1fr) 2.5rem 2.5rem`,`important`),r.style.setProperty(`align-items`,`stretch`,`important`),r.style.setProperty(`gap`,`0.45rem`,`important`),r.style.setProperty(`min-inline-size`,`0`,`important`),r.style.setProperty(`inline-size`,`100%`,`important`);let i=r.querySelector(`[data-action='pick-icon']`);i||(i=document.createElement(`button`),i.type=`button`,i.className=`btn secondary sd-icon-resource-pick`,i.setAttribute(`data-action`,`pick-icon`),i.title=`Pick alternative icon`,i.setAttribute(`aria-label`,`Pick alternative icon`),i.innerHTML=`<ui-icon icon="squares-four" icon-style="duotone" aria-hidden="true"></ui-icon>`,r.append(i));let a=r.querySelector(`[data-action='pick-photo']`);a||(a=document.createElement(`button`),a.type=`button`,a.className=`btn secondary sd-icon-resource-pick`,a.setAttribute(`data-action`,`pick-photo`),a.title=`Use photo / avatar`,a.setAttribute(`aria-label`,`Use photo or avatar`),a.innerHTML=`<ui-icon icon="user-circle" icon-style="duotone" aria-hidden="true"></ui-icon>`,r.append(a)),t.parentElement!==r&&r.insertBefore(t,i),i.parentElement===r&&a.parentElement===r&&(r.append(i,a),r.insertBefore(t,i));let o=e=>{e.style.setProperty(`display`,`inline-flex`,`important`),e.style.setProperty(`align-items`,`center`,`important`),e.style.setProperty(`justify-content`,`center`,`important`),e.style.setProperty(`inline-size`,`2.5rem`,`important`),e.style.setProperty(`min-inline-size`,`2.5rem`,`important`),e.style.setProperty(`max-inline-size`,`2.5rem`,`important`),e.style.setProperty(`min-block-size`,`2.5rem`,`important`),e.style.setProperty(`padding`,`0`,`important`),e.style.setProperty(`margin`,`0`,`important`)};return o(i),o(a),i.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),Ur({packageName:typeof n.packageName==`function`?n.packageName():String(n.packageName||``).trim(),pageUrl:typeof n.pageUrl==`function`?n.pageUrl():String(n.pageUrl||``).trim(),currentUrl:t.value,theme:n.theme,onPick:e=>{t.value=e.iconUrl,t.setAttribute(`value`,e.iconUrl),t.dispatchEvent(new Event(`input`,{bubbles:!0})),t.dispatchEvent(new Event(`change`,{bubbles:!0}))}})}),a.addEventListener(`click`,n=>{n.preventDefault(),n.stopPropagation();let r=document.createElement(`input`);r.type=`file`,r.accept=`image/*`,r.style.display=`none`,document.body.append(r),r.addEventListener(`change`,()=>{let n=r.files?.[0];if(r.remove(),!n)return;let i=new FileReader;i.onload=()=>{let n=String(i.result||``).trim();if(!n.startsWith(`data:image/`))return;t.value=n,t.setAttribute(`value`,n),t.dispatchEvent(new Event(`input`,{bubbles:!0})),t.dispatchEvent(new Event(`change`,{bubbles:!0}));let r=e.closest(`form`)?.querySelector(`select[name="iconDisplay"]`);r&&(r.value=`colored`,r.dispatchEvent(new Event(`change`,{bubbles:!0})))},i.readAsDataURL(n)},{once:!0}),r.click()}),i}var Gr;function Kr(){return(Kr=e((()=>{tr(),Bn(),Ar(),Gr=[{id:`default`,label:`Default`},{id:`monochrome`,label:`Material You`},{id:`foreground`,label:`Adaptive FG`}]})))()}function qr(){if(X)return X;try{let e=localStorage.getItem(ti);if(!e)return X={},X;let t=JSON.parse(e);X=t&&typeof t==`object`?t:{}}catch{X={}}return X}function Jr(e){X=e;try{localStorage.setItem(ti,JSON.stringify(e))}catch{}}function Yr(e){return`app:${String(e||``).trim()}`}function Xr(e){return`bm:${String(e||``).trim()}`}function Zr(e){let t=String(e||``).trim();return t?{...qr()[t]||{}}:{}}function Qr(e,t){let n=String(e||``).trim();if(!n)return{};let r={...qr()},i={...r[n]||{},...t};return i.shape&&=N(i.shape,`circle`),i.iconDisplay&&=P(i.iconDisplay)||`colored`,i.iconScale!=null&&(i.iconScale=be(i.iconScale)),r[n]=i,Jr(r),i}function $r(e){let t=String(e||``).trim();if(!t)return;let n={...qr()};delete n[t],Jr(n)}function ei(e){let t={...e.defaults||{},...e.initial||{},...Zr(e.key)},n=String(t.iconUrl||``).trim(),r=n.startsWith(`blob:`)?``:n,i=document.createElement(`dialog`);i.className=`speed-dial-editor env-shell-app-menu__chrome-editor`,i.innerHTML=`
            ...
            <div class="modal-fields">
                <div class="modal-field">
                    ...
                    <select id="am-chrome-shape" name="shape">
                        ${ke.map(e=>`<option value="${e.value}"${N(t.shape,`circle`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-display">Icon display</label>
                    <select id="am-chrome-display" name="iconDisplay">
                        ${de.map(e=>`<option value="${e.value}"${(P(t.iconDisplay)||`colored`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-icon-scale">Icon scale (inside plate)</label>
                    <select id="am-chrome-icon-scale" name="iconScale">
                        ${Te.map(e=>`<option value="${e.value}"${be(t.iconScale)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
    ...
    `;let a=i.querySelector(`form`),o=a?.querySelector(`.modal-actions`);o&&(o.style.setProperty(`display`,`grid`,`important`),o.style.setProperty(`grid-template-columns`,`1fr auto auto`,`important`),o.style.setProperty(`align-items`,`center`,`important`),o.style.setProperty(`gap`,`0.45rem`,`important`));let s=i.querySelector(`select[name="shape"]`),c=i.querySelector(`select[name="iconDisplay"]`),l=i.querySelector(`select[name="iconScale"]`),u=i.querySelector(`input[name="icon"]`),d=i.querySelector(`input[name="iconUrl"]`),f=i.querySelector(`[data-field="glyph"]`),p=i.querySelector(`[data-field="url"]`),m=String(e.packageName||``).trim()||(e.key.startsWith(`app:`)?e.key.slice(4):``),h=String(e.pageUrl||``).trim();p&&d&&Wr(p,d,{packageName:m,pageUrl:h});let g=()=>{let e=P(c?.value)||`colored`;f&&(e===`glyph`?f.removeAttribute(`hidden`):f.setAttribute(`hidden`,``)),p&&(e===`glyph`?p.setAttribute(`hidden`,``):p.removeAttribute(`hidden`))};c?.addEventListener(`change`,g),g();let _=()=>{try{i.open&&i.close()}catch{}i.remove()};a?.addEventListener(`click`,t=>{let n=t.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`);n===`cancel`&&(t.preventDefault(),_()),n===`reset`&&(t.preventDefault(),$r(e.key),e.onSave({}),_())}),a?.addEventListener(`submit`,t=>{t.preventDefault();let n=String(d?.value||``).trim(),r={shape:N(s?.value,`circle`),iconDisplay:P(c?.value)||`colored`,iconScale:be(l?.value),icon:String(u?.value||``).trim(),iconUrl:n.startsWith(`blob:`)?``:n};Qr(e.key,r),e.onSave(r),_()}),i.addEventListener(`cancel`,e=>{e.preventDefault(),_()}),document.body.append(i);try{i.showModal()}catch{i.setAttribute(`open`,``)}}var ti,X;function ni(){return(ni=e((()=>{ce(),pe(),Kr(),ti=`cwsp-app-menu-tile-chrome-v1`,X=null})))()}var ri;function ii(){return(ii=e((()=>{ri=`@layer ui-app-menu {
  ...
  .env-shell-app-menu {
    ...
    --env-app-menu-ink: var(--color-on-surface, --u2-color-mod(var(--base-color, #5a9ec8), 100));
    --env-app-menu-plate: var(
        --color-primary-container,
        --u2-color-mod(var(--base-color, #5a9ec8), 880)
    );
  }
  ...
  .env-shell-app-menu__tile-icon {
    ...
    overflow: hidden;
    color: var(--env-app-menu-ink);
    --icon-color: var(--env-app-menu-accent, var(--color-primary, currentColor));
    /* Capacitor App Menu — circular plates by default (override via data-shape). */
  }
...
}`})))()}function ai(){return document.documentElement.dataset.cwspShellRole===`launcher`||globalThis.__RS_SHELL_ROLE__===`launcher`}function oi(){return ai()||sr()}function si(){return ai()?`launcher`:sr()?`bookmarks`:null}async function ci(){if(Ci)return Ci;try{return await c(()=>import(`./launcher-bridge-C3JnBhTN.js`),[],import.meta.url)}catch{return null}}function li(){if(!bi){bi=!0;try{document.adoptedStyleSheets=[...document.adoptedStyleSheets,yi]}catch{}}}function ui(){return document.querySelector(`.env-shell-root`)||document.querySelector(`env-shell-container`)||document.querySelector(`.env-shell-chrome`)?.parentElement||document.body}function di(e,t){let n=document.createElement(`div`);n.className=`env-shell-app-menu__drag-ghost`,n.setAttribute(`aria-hidden`,`true`);let r=e.cloneNode(!0);r.className=`env-shell-app-menu__drag-ghost-icon ui-ws-item-icon shaped`,r.setAttribute(`data-shape`,N(e.getAttribute(`data-shape`),`circle`));let i=document.createElement(`span`);return i.className=`env-shell-app-menu__drag-ghost-label`,i.textContent=t,n.append(r,i),n}function fi(e,t){let n=N(t.chrome.shape,wi);e.setAttribute(`data-shape`,n),e.classList.add(`ui-ws-item-icon`,`shaped`);let r=String(t.chrome.iconUrl||``).trim()||String(t.resourceUrl||``).trim(),i=Ae(t.chrome.iconScale),a=Fn(r)?Kn(r,i):``,o=String(a||(Fn(r)?``:r)||``).trim(),s=P(t.chrome.iconDisplay)||Oe({iconDisplay:t.chrome.iconDisplay,iconUrl:o||r,isLauncherApp:!!t.launcher,isBookmarkFavicon:!!(o||r)&&!t.launcher});if(e.setAttribute(`data-icon-display`,s),ue(e,ne(s,t.chrome.iconScale)),e.replaceChildren(),s===`glyph`){let n=String(t.chrome.icon||t.fallbackGlyph||`device-mobile`).trim()||`device-mobile`,r=document.createElement(`ui-icon`);r.setAttribute(`icon`,n),r.setAttribute(`icon-style`,`duotone`),r.setAttribute(`aria-hidden`,`true`),e.append(r),_e(e);return}if(s===`colored`){let n=document.createElement(`img`);n.className=t.launcher?`ui-ws-item-icon-img`:`ui-ws-item-icon-img env-shell-app-menu__tile-favicon`,n.alt=``,n.decoding=`async`,n.draggable=!1,n.referrerPolicy=`no-referrer`,!t.launcher&&(rr(o)||rr(r))?n.toggleAttribute(`data-bookmark-favicon`,!0):t.launcher&&n.toggleAttribute(`data-launcher-icon`,!0),o&&(n.src=o),e.append(n),_e(e),Fn(r)&&Gn(r,i).then(t=>{!t||!n.isConnected||(n.src=t,_e(e))});return}let c=se({display:s,glyph:String(t.chrome.icon||t.fallbackGlyph||`device-mobile`),resourceUrl:o||void 0,launcher:t.launcher,className:`ui-ws-item-icon-native`});e.append(c),_e(e),t.launcher&&o&&s!==`glyph`&&(Yn(c,o,s),_e(e)),Fn(r)&&Gn(r,i).then(t=>{!t||!c.isConnected||(Yn(c,t,s),_e(e))})}function pi(e,t,n,r){let i=()=>we(t),a=typeof window<`u`&&(window.matchMedia?.(`(pointer: coarse)`)?.matches||`ontouchstart`in window);e.draggable=!a,a||(e.addEventListener(`dragstart`,e=>{let t=i();if(e.dataTransfer?.setData(`text/plain`,t),e.dataTransfer?.setData(`application/json`,t),e.dataTransfer){e.dataTransfer.effectAllowed=`copy`;try{e.dataTransfer.setDragImage(n,24,24)}catch{}}document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0)}),e.addEventListener(`dragend`,()=>{document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1)}));let o,s=null,c=0,l=0,u=!1,d=!1,f=!1,p=null,m=()=>{o&&=(clearTimeout(o),void 0)},h=()=>{if(m(),u=!1,d&&(d=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),p?.remove(),p=null,s!=null)){try{e.releasePointerCapture(s)}catch{}s=null}},g=(r,i,a)=>{if(!d){u=!1,d=!0,f=!0,e.classList.add(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0),p=di(n,t.label),document.body.appendChild(p),p.style.transform=`translate(${r}px, ${i}px) translate(-50%, -50%)`;try{e.setPointerCapture(a)}catch{}}},_=(e,t)=>{p&&(p.style.transform=`translate(${e}px, ${t}px) translate(-50%, -50%)`)},v=(e,n)=>{if(!me(e,n))return;let i=le(e,n);he(t,i??void 0)&&(Nn(`Pinned ${t.label} to desktop`),r.onPinned?.())},y=t=>{if(d){if(d=!1,u=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),p?.remove(),p=null,s!=null){try{e.releasePointerCapture(s)}catch{}s=null}v(t.clientX,t.clientY)}};e.addEventListener(`pointerdown`,e=>{e.button===0&&(m(),s=e.pointerId,c=e.clientX,l=e.clientY,f=!1,d=!1,u=!1,o=setTimeout(()=>{o=void 0,u=!0,f=!0},xi))},{passive:!0}),e.addEventListener(`pointermove`,e=>{if(o&&!d&&!u){let t=e.clientX-c,n=e.clientY-l;Math.hypot(t,n)>Si&&m();return}if(u&&!d){let t=e.clientX-c,n=e.clientY-l;Math.hypot(t,n)>Si&&g(e.clientX,e.clientY,e.pointerId);return}d&&(_(e.clientX,e.clientY),e.preventDefault())},{passive:!1}),e.addEventListener(`pointerup`,e=>{if(m(),u=!1,d){y(e);return}}),e.addEventListener(`pointercancel`,e=>{m(),u=!1,d&&y(e)}),e.addEventListener(`contextmenu`,()=>{h()},!0),e.addEventListener(`click`,e=>{f&&=(e.preventDefault(),e.stopPropagation(),!1)},!0)}function mi(e,t,n,r,i){let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-app-menu__tile`,a.setAttribute(`data-package`,e.packageName),a.title=`${e.label} — right-click: desktop; hold and drag`;let o=Yr(e.packageName),s=document.createElement(`span`);s.className=`env-shell-app-menu__tile-icon ui-ws-item-icon shaped`;let c=document.createElement(`span`);c.className=`env-shell-app-menu__tile-label`,c.textContent=e.label,a.append(s,c);let l=e.iconCacheKey||e.packageName,u=(e=``)=>{fi(s,{chrome:Zr(o),fallbackGlyph:`device-mobile`,resourceUrl:e,launcher:!0})},d=Ae(Zr(o).iconScale);return u(Hn(l,d)),J(l,d).then(e=>{n===r()&&e&&u(e)}).catch(()=>{}),pi(a,e,s,i),a.addEventListener(`contextmenu`,n=>{n.preventDefault(),n.stopPropagation(),jn({x:n.clientX,y:n.clientY,compact:!0,items:[{id:`place-desktop`,label:`Place on desktop`,icon:`desktop`,action:()=>{he(e)&&(Nn(`Placed “${e.label}” on desktop`),i.onPinned?.())}},{id:`icon-design`,label:`Icon design…`,icon:`palette`,action:()=>{ei({title:e.label,key:o,packageName:e.packageName,defaults:{shape:wi,iconDisplay:`colored`},onSave:e=>{let t={...Zr(o),...e},n=Ae(t.iconScale),r=(e=``)=>{fi(s,{chrome:t,fallbackGlyph:`device-mobile`,resourceUrl:e,launcher:!0})};r(Hn(l,n)||(Fn(String(t.iconUrl||``))?``:String(t.iconUrl||``).trim())),Fn(String(t.iconUrl||``))?Gn(t.iconUrl,n).then(e=>{e&&r(e)}):J(l,n).then(e=>{e&&r(e)})}})}},{id:`launch`,label:`Open`,icon:`arrow-square-out`,action:async()=>{try{await t.launcherLaunch(e.packageName,e.componentName)}catch{}}}]})}),a.addEventListener(`click`,async n=>{n.preventDefault(),n.stopPropagation();try{await t.launcherLaunch(e.packageName,e.componentName)}catch{}}),a}function hi(e,t,n,r,i){if(t.folder||!String(t.url||``).trim())return;let a,o=!1,s=!1,c=0,l=0,u=-1,d=null,f=()=>{a!=null&&(clearTimeout(a),a=void 0)},p=()=>{if(f(),o=!1,s){s=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),d?.remove(),d=null;try{e.releasePointerCapture?.(u)}catch{}}},m=(r,i)=>{if(!s){o=!1,s=!0,e.classList.add(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0),d=di(n,t.title),document.body.appendChild(d),d.style.transform=`translate(${r}px, ${i}px) translate(-50%, -50%)`;try{e.setPointerCapture?.(u)}catch{}}},h=(n,a)=>{if(f(),o=!1,s){s=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),d?.remove(),d=null;try{e.releasePointerCapture?.(u)}catch{}if(me(n,a)){let e=le(n,a)??void 0,o=String(r.current||``).trim()||hr(t,or());gr(t,e,or(),o)&&(Nn(`Placed “${t.title}” on desktop`),i.onPinned?.())}}};e.addEventListener(`pointerdown`,e=>{(e.button==null||e.button===0)&&(c=e.clientX,l=e.clientY,u=e.pointerId,s=!1,o=!1,f(),a=setTimeout(()=>{a=void 0,o=!0},xi))}),e.addEventListener(`pointermove`,e=>{if(!s&&!o){if(a==null)return;let t=e.clientX-c,n=e.clientY-l;t*t+n*n>100&&f();return}if(o&&!s){let t=e.clientX-c,n=e.clientY-l;t*t+n*n>100&&m(e.clientX,e.clientY);return}d&&(d.style.transform=`translate(${e.clientX}px, ${e.clientY}px) translate(-50%, -50%)`,e.preventDefault())},{passive:!1}),e.addEventListener(`pointerup`,e=>h(e.clientX,e.clientY)),e.addEventListener(`pointercancel`,e=>h(e.clientX,e.clientY)),e.addEventListener(`contextmenu`,()=>p(),!0)}function gi(e,t,n,r,i){e.addEventListener(`contextmenu`,a=>{if(a.preventDefault(),a.stopPropagation(),t.folder){jn({x:a.clientX,y:a.clientY,compact:!0,items:[{id:`open-folder`,label:`Open folder`,icon:`folder-open`,action:()=>{e.click()}}]});return}let o=dr(t.id);jn({x:a.clientX,y:a.clientY,compact:!0,items:[{id:`place-desktop`,label:`Place on desktop`,icon:`desktop`,action:()=>{gr(t,void 0,n,String(r.current||``).trim()||hr(t,n))&&(Nn(`Placed “${t.title}” on desktop`),i.onPinned?.())}},{id:`icon-design`,label:`Icon design…`,icon:`palette`,action:()=>{let i=Xr(t.id);ei({title:t.title,key:i,pageUrl:String(t.url||``).trim(),defaults:{shape:wi,iconDisplay:`colored`},onSave:a=>{let o=e.querySelector(`.env-shell-app-menu__tile-icon`);if(!o)return;let s={...Zr(i),...a},c=String(s.iconUrl||``).trim()||String(r.current||``).trim()||hr(t,n);fi(o,{chrome:s,fallbackGlyph:t.folder?`folder`:`link`,resourceUrl:c}),c&&(r.current=c)}})}},o?{id:`unpin-start`,label:`Unpin from Start`,icon:`push-pin-slash`,action:()=>{pr(t.id)&&(Nn(`Unpinned “${t.title}”`),i.onStartPinsChanged?.())}}:{id:`pin-start`,label:`Pin to Start`,icon:`push-pin`,action:()=>{fr(t)&&(Nn(`Pinned “${t.title}” to Start`),i.onStartPinsChanged?.())}},{id:`open`,label:`Open`,icon:`arrow-square-out`,action:async()=>{lr(t);try{await n.open(t)}catch{}}}]})})}function _i(e,t,n,r){let i=document.createElement(`button`);i.type=`button`,i.className=`env-shell-app-menu__tile`,i.setAttribute(`data-bookmark-id`,e.id),e.folder&&i.setAttribute(`data-folder`,``),i.title=e.folder?`${e.title} — open folder`:`${e.title} — right-click: desktop / pin; hold to drag`;let a=Xr(e.id),o=document.createElement(`span`);o.className=`env-shell-app-menu__tile-icon ui-ws-item-icon shaped`,o.setAttribute(`data-shape`,wi);let s=document.createElement(`span`);s.className=`env-shell-app-menu__tile-label`,s.textContent=e.title,i.append(o,s);let c={current:``},l=t=>{let n=Zr(a);if(n.shape||n.iconDisplay||n.icon||n.iconUrl){fi(o,{chrome:n,fallbackGlyph:e.folder?`folder`:`link`,resourceUrl:String(n.iconUrl||t||``).trim()});return}o.setAttribute(`data-shape`,wi)};return yr(o,e,t).then(e=>{c.current=e,l(e)}),hi(i,e,o,c,n),gi(i,e,t,c,n),i.addEventListener(`click`,async n=>{if(n.preventDefault(),n.stopPropagation(),!document.documentElement.hasAttribute(`data-app-menu-dragging`)){if(e.folder){r(e.id,e.title);return}lr(e);try{await t.open(e)}catch{}}}),i}function vi(){li();let e=si(),t=document.createElement(`div`);t.className=`env-shell-app-menu`,t.hidden=!0,t.setAttribute(`role`,`dialog`),t.setAttribute(`aria-modal`,`false`),t.setAttribute(`aria-label`,e===`bookmarks`?`Bookmarks`:`Apps`),e&&t.setAttribute(`data-menu-mode`,e);let n=()=>{try{let e=document.documentElement,n=(e.getAttribute(`data-theme`)||``).toLowerCase(),r=(e.style.colorScheme||``).trim().toLowerCase(),i=n===`light`||n===`dark`?n:r===`light`||r===`dark`?r:``;if(i===`light`||i===`dark`){t.dataset.theme=i,t.style.colorScheme=i;return}delete t.dataset.theme,t.style.colorScheme=`inherit`}catch{}};n();let r=()=>n();document.addEventListener(`u2-theme-change`,r);let i=new MutationObserver(r);try{i.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`data-scheme`,`style`]})}catch{}let a=document.createElement(`div`);a.className=`env-shell-app-menu__panel`,e===`bookmarks`&&a.setAttribute(`data-layout`,`start-split`);let o=document.createElement(`div`);o.className=`env-shell-app-menu__banner`,o.hidden=!0;let s=document.createElement(`p`);s.className=`env-shell-app-menu__banner-text`,s.textContent=`Set CWSP Launcher as Home`;let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-app-menu__banner-action btn`,c.textContent=`Set as default`,o.append(s,c);let l=document.createElement(`input`);l.type=`search`,l.className=`env-shell-app-menu__search`,l.placeholder=e===`bookmarks`?`Search bookmarks`:`Search apps`,l.autocomplete=`off`,l.setAttribute(`aria-label`,e===`bookmarks`?`Search bookmarks`:`Search apps`);let u=document.createElement(`div`);u.className=`env-shell-app-menu__start-body`,u.hidden=e!==`bookmarks`;let d=document.createElement(`div`);d.className=`env-shell-app-menu__start-left`,d.setAttribute(`aria-label`,`Pinned and recent bookmarks`);let f=document.createElement(`div`);f.className=`env-shell-app-menu__start-heading`,f.textContent=`Pinned`;let p=document.createElement(`div`);p.className=`env-shell-app-menu__start-recent env-shell-app-menu__start-pinned`;let m=document.createElement(`div`);m.className=`env-shell-app-menu__start-heading`,m.textContent=`Recent`;let h=document.createElement(`div`);h.className=`env-shell-app-menu__start-recent`,d.append(f,p,m,h);let g=document.createElement(`div`);g.className=`env-shell-app-menu__start-right`;let _=document.createElement(`div`);_.className=`env-shell-app-menu__crumb`;let v=document.createElement(`div`);v.className=`env-shell-app-menu__grid`,v.setAttribute(`data-part`,`grid`),v.setAttribute(`aria-label`,e===`bookmarks`?`Bookmarks`:`Installed apps`),g.append(_,v),u.append(d,g),e===`bookmarks`?a.append(o,l,u):a.append(o,l,v),t.appendChild(a),ui().appendChild(t);let y=!1,b=0,x=``,S,C=[],w=()=>{if(!oi()){t.hidden=!0,t.toggleAttribute(`data-open`,!1);return}t.hidden=!y,t.toggleAttribute(`data-open`,y)},T=()=>{y&&(y=!1,t.toggleAttribute(`data-page`,!1),w(),t.dispatchEvent(new CustomEvent(`env-app-menu-close`,{bubbles:!0})))};t.addEventListener(`env-app-menu-request-close`,e=>{e.stopPropagation(),T()});let E=()=>{oi()&&(n(),y=!0,w(),M(),t.dispatchEvent(new CustomEvent(`env-app-menu-open`,{bubbles:!0})))},D=()=>{t.toggleAttribute(`data-page`,!0),E()},O=()=>{y?T():E()},k={onPinned:()=>{T()},onStartPinsChanged:()=>{M()}},ee=()=>{if(_.replaceChildren(),e!==`bookmarks`)return;let t=document.createElement(`button`);t.type=`button`,t.className=`env-shell-app-menu__crumb-item`,t.textContent=`Bookmarks`,t.addEventListener(`click`,()=>{C=[],M()}),_.appendChild(t),C.forEach((e,t)=>{let n=document.createElement(`span`);n.className=`env-shell-app-menu__crumb-sep`,n.textContent=`›`;let r=document.createElement(`button`);r.type=`button`,r.className=`env-shell-app-menu__crumb-item`,r.textContent=e.title,r.addEventListener(`click`,()=>{C=C.slice(0,t+1),M()}),_.append(n,r)})},A=async(e,t)=>{let n=[];try{n=await e.launcherList(x||void 0)}catch{n=[]}if(t!==b)return;if(v.replaceChildren(),n.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty`,e.textContent=x?`No matching apps`:`No apps found`,v.appendChild(e);return}let r=document.createDocumentFragment();for(let i of n)r.appendChild(mi(i,e,t,()=>b,k));v.appendChild(r)},j=(e,t)=>{C.push({id:e,title:t}),x=``,l.value=``,M()},te=async(e,t)=>{ee();let n=(t,n,r)=>{if(t.replaceChildren(),n.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty env-shell-app-menu__empty--compact`,e.textContent=r,t.appendChild(e);return}for(let r of n)t.appendChild(_i(r,e,k,j))};n(p,ur(),`No pinned bookmarks`),n(h,cr(),`No recent bookmarks`);let r=[];try{if(x)r=await e.search(x);else{let t=C.length?C[C.length-1].id:void 0;r=await e.listChildren(t)}}catch{r=[]}if(t!==b)return;if(v.replaceChildren(),r.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty`,e.textContent=x?`No matching bookmarks`:`This folder is empty`,v.appendChild(e);return}let i=document.createDocumentFragment(),a=r.filter(e=>e.folder),o=r.filter(e=>!e.folder);for(let t of[...a,...o])i.appendChild(_i(t,e,k,j));v.appendChild(i)},M=async()=>{let e=++b;o.hidden=!0,l.hidden=!1;let n=si();if(!n){w();return}if(t.setAttribute(`data-menu-mode`,n),n===`bookmarks`){a.setAttribute(`data-layout`,`start-split`),u.hidden=!1,a.contains(u)||(a.append(o,l,u),v.parentElement!==g&&g.append(_,v));let t=or();if(!t){o.hidden=!1,s.textContent=`Bookmarks API unavailable in this context`,c.hidden=!0,l.hidden=!0,u.hidden=!0;return}c.hidden=!0,await te(t,e);return}a.removeAttribute(`data-layout`),u.hidden=!0,v.parentElement!==a&&a.append(v);let r=await ci();if(e!==b)return;if(!r?.launcherList||!r?.launcherLaunch||!r?.launcherIcon){o.hidden=!1,s.textContent=`Launcher bridge unavailable — rebuild the Capacitor APK`,c.hidden=!0,l.hidden=!0,v.hidden=!0;return}let i=!1;try{i=await r.launcherIsDefault()}catch{i=!1}e===b&&(i?o.hidden=!0:(o.hidden=!1,s.textContent=`Set CWSP Launcher as Home for full launcher integration`,c.hidden=!1),l.hidden=!1,v.hidden=!1,await A(r,e))};l.addEventListener(`input`,()=>{x=l.value.trim(),S&&clearTimeout(S),S=setTimeout(()=>{M()},180)}),c.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation();let t=await ci();if(t){try{await t.launcherRequestDefault()}catch{}M()}});let ne=e=>{if(!y||document.documentElement.hasAttribute(`data-app-menu-dragging`))return;let n=typeof e.composedPath==`function`?e.composedPath():[];for(let e of n)if(e===t||e===a||e instanceof Element&&t.contains(e)||e instanceof Element&&e.closest?.(`.cw-context-menu-layer`)||e instanceof Element&&e.closest?.(`.env-shell-app-menu__chrome-editor`)||e instanceof Element&&e.closest?.(`dialog.speed-dial-editor`))return;T()};return document.addEventListener(`pointerdown`,ne,{capture:!0}),w(),{element:t,toggle:O,open:E,openPage:D,close:T,isOpen:()=>y,refresh:M,dispose:()=>{S&&clearTimeout(S),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),document.removeEventListener(`pointerdown`,ne,{capture:!0}),document.removeEventListener(`u2-theme-change`,r);try{i.disconnect()}catch{}t.remove()}}}var yi,bi,xi,Si,Ci,wi;function Ti(){return(Ti=e((()=>{o(),j(),pe(),tr(),Mn(),ce(),ni(),Ar(),ii(),s(),yi=t(ri),bi=!1,xi=420,Si=10,Ci=null,wi=`circle`})))()}var Ei,Di,Oi,ki,Ai;function ji(){return(ji=e((()=>{pe(),Ei=null,Di=e=>{let t=Ee(e.id);return Math.max(0,Number(t?.androidWidgetId)||0)},Oi=(e,t)=>{let n=t.getBoundingClientRect();return{widgetId:e,x:n.left,y:n.top,w:Math.max(8,n.width),h:Math.max(8,n.height),dpr:Number(window.devicePixelRatio)||1}},ki=e=>{if(!Ei)return;let t=e||document.getElementById(`home`);t&&t.querySelectorAll(`[data-speed-dial-item][data-widget="android"][data-layer="icons"]`).forEach(e=>{let t=(De||[]).find(t=>t?.id===e.dataset.id);if(!t)return;let n=Di(t);if(!n)return;let r=Oi(n,e);Ei.widgetAttach(r)})},Ai=()=>{Ei?.widgetHideAll?.()}})))()}var Mi,Ni,Pi,Fi,Ii,Li,Ri,zi,Bi,Vi,Hi,Ui,Wi,Gi,Ki,qi,Ji;function Yi(){return(Yi=e((()=>{ae(),pe(),ji(),Mi=`/user/workspaces/`,Ni=`cwsp:workspace-page`,Pi=`cw::workspace::pages`,Fi=e=>`${Mi}${e}/`,Ii=()=>[`side-a`,`side-b`,`side-c`].map(e=>({id:e,label:`Side ${e.slice(-1).toUpperCase()}`,path:Fi(e)})),Li=()=>({activeId:`side-a`,pages:Ii(),snapshots:{}}),Ri=()=>{try{let e=localStorage.getItem(Pi);if(!e)return Li();let t=JSON.parse(e);return!t||!Array.isArray(t.pages)||!t.pages.length?Li():{activeId:String(t.activeId||t.pages[0].id),pages:t.pages.map(e=>({id:String(e.id||``).trim(),label:String(e.label||e.id),path:String(e.path||Fi(e.id))})).filter(e=>e.id),snapshots:t.snapshots&&typeof t.snapshots==`object`?t.snapshots:{}}}catch{return Li()}},zi=e=>{try{localStorage.setItem(Pi,JSON.stringify(e))}catch{}},Bi=e=>{try{window.dispatchEvent(new CustomEvent(Ni,{detail:{id:e,pages:Vi()}}))}catch{}},Vi=()=>Ri().pages,Hi=()=>Ri().activeId||`side-a`,Ui=()=>{let e=Ri();e.pages.some(t=>t.id===e.activeId)&&(e.snapshots[e.activeId]=fe(),zi(e))};try{let e=globalThis;e.__CWSP_WORKSPACE_SNAPSHOT_SYNC_BOUND__||(e.__CWSP_WORKSPACE_SNAPSHOT_SYNC_BOUND__=!0,window.addEventListener(xe,Ui))}catch{}Wi=async e=>{try{let t=ve(`/user/`);if(!t?.mkdir||!t.writable)return;if(await t.mkdir(`/user/`,`workspaces`).catch(()=>void 0),await t.mkdir(Mi,e.id).catch(()=>void 0),t.writeFile){let n=new File([JSON.stringify({id:e.id,label:e.label,path:e.path},null,2)],`workspace.json`,{type:`application/json`});await t.writeFile(e.path,n).catch(()=>void 0)}}catch(t){console.warn(`[workspace-pages] explorer dir failed`,e.id,t)}},Gi=()=>{try{return matchMedia(`(prefers-reduced-motion: reduce)`).matches}catch{return!1}},Ki=()=>{let e=document.querySelector(`.speed-dial-root`)||document.getElementById(`home`);if(!e)return[];let t=[...e.querySelectorAll(`.speed-dial-grid`)];return t.length?t:[e]},qi=e=>{let t=Ki();if(!t.length||Gi()||typeof t[0].animate!=`function`)return()=>void 0;let n=e<0?-1:1,r=`${-88*n}deg`,i=`${88*n}deg`,a=`${-18*n}%`,o=`${18*n}%`,s=t[0].closest(`.speed-dial-root`)||t[0];s.dataset.wsTurning=n>0?`next`:`prev`;let c=[];for(let e of t){let t=e.cloneNode(!0);t.classList.add(`speed-dial-grid--turn-ghost`),t.dataset.wsGhost=`1`,t.setAttribute(`aria-hidden`,`true`),e.parentElement?.insertBefore(t,e.nextSibling),e.style.opacity=`0`,c.push(t),t.animate([{transform:`translateX(0) rotateY(0deg)`,opacity:1},{transform:`translateX(${a}) rotateY(${r})`,opacity:0}],{duration:180,easing:`cubic-bezier(.4, 0, .2, 1)`,fill:`forwards`})}return()=>{let e=t.map(e=>e.animate([{transform:`translateX(${o}) rotateY(${i})`,opacity:.2},{transform:`translateX(0) rotateY(0deg)`,opacity:1}],{duration:220,easing:`cubic-bezier(.22, 1, .36, 1)`,fill:`none`}));Promise.all(e.map(e=>e.finished.catch(()=>void 0))).then(()=>{for(let e of t)e.style.opacity=``;for(let e of c)e.remove();delete s.dataset.wsTurning})}},Ji=e=>{let t=Ri(),n=t.pages.find(t=>t.id===e);if(!n)return!1;let r=t.activeId||t.pages[0].id;if(r===n.id)return!0;let i=Math.max(0,t.pages.findIndex(e=>e.id===r)),a=Math.max(0,t.pages.findIndex(e=>e.id===n.id))-i;Math.abs(a)>t.pages.length/2&&(a+=a>0?-t.pages.length:t.pages.length),t.snapshots[r]=fe(),t.activeId=n.id,zi(t),Ai();let o=qi(a);return Se(t.snapshots[n.id]||{items:[]}),requestAnimationFrame(()=>{o(),requestAnimationFrame(()=>ki())}),Wi(n),Bi(n.id),!0}})))()}var Xi,Zi,Qi;function $i(){return($i=e((()=>{E(),Mn(),Xi=()=>{let e=globalThis;if(e.__CWSP_CAP_BACK_BOUND__)return;let t=e.Capacitor?.Plugins?.App;if(typeof t?.addListener==`function`){e.__CWSP_CAP_BACK_BOUND__=!0;try{t.addListener(`backButton`,({canGoBack:e})=>{if(T()&&m())return;if(document.querySelector(`.cw-context-menu-layer`)){q();return}if(document.querySelector(`.env-shell-app-menu[data-open]`)){document.querySelector(`.env-shell-app-menu`)?.dispatchEvent(new CustomEvent(`env-app-menu-request-close`,{bubbles:!0}));return}let t=document.querySelector(`dialog[open], .speed-dial-editor`);if(t){t.close?.(),t.remove?.();return}if(e){history.back();return}})}catch(e){console.warn(`[overlay-back] Capacitor backButton bind failed`,e)}}},Zi=()=>{S({id:`app-menu-overlay`,priority:d.SIDEBAR,isActive:()=>!!document.querySelector(`.env-shell-app-menu[data-open]`),close:()=>(document.querySelector(`.env-shell-app-menu`)?.dispatchEvent(new CustomEvent(`env-app-menu-request-close`,{bubbles:!0})),!0)}),S({id:`speed-dial-editor`,priority:d.MODAL,isActive:()=>!!document.querySelector(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`),close:()=>(document.querySelectorAll(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`).forEach(e=>{try{e.close()}catch{e.remove()}}),!0)})},Qi=()=>{let e=globalThis;if(e.__CWSP_LAUNCHER_BACK_STACK__){Xi();return}e.__CWSP_LAUNCHER_BACK_STACK__=!0;try{p({preventDefaultNavigation:!0,pushInitialState:!0})}catch{}Zi(),Xi()}})))()}var ea;function ta(){return(ta=e((()=>{ea=`/*
 ...
 * Reason for changes: Mobile Home is pinned to the physical right; slotted 3-col grid kept it on the left.
 */
...
@layer ui-taskbar {
  ...
  */
  .env-shell-taskbar {
    ...
    --env-taskbar-ink: var(--color-on-surface, --u2-color-mod(var(--base-color, #5a9ec8), 100));
  ...
  .env-shell-taskbar__pins ui-task::part(icon), .env-shell-taskbar__pins ui-task::part(glyph) {
    color: contrast-color(var(--env-taskbar-surface, black));
    --icon-color: contrast-color(var(--env-taskbar-surface, black));
  }
  .env-shell-taskbar__windows {
    flex: 1 1 auto;
    justify-content: flex-start;
  ...
  */
  .env-shell-chrome:not([data-desktop]) .env-shell-taskbar {
    ...
    background: color-mix(in oklab, var(--color-surface, --u2-color-mod(var(--base-color, #5a9ec8), 940)) 92%, transparent);
    border-block-start: 1px solid color-mix(in oklab, var(--color-outline-variant, var(--sv-outline)) 35%, transparent);
    backdrop-filter: blur(18px) saturate(1.2);
    -webkit-backdrop-filter: blur(18px) saturate(1.2);
    box-shadow: none;
    color: var(--color-on-surface, var(--env-taskbar-ink));
    --icon-color: currentColor;
  }
...
}`})))()}function na(e){return`${da}${String(e||``).trim().toLowerCase()}`}function ra(){let e=document.querySelector(`.env-shell-chrome`);return e instanceof HTMLElement&&e.hasAttribute(`data-desktop`)?!1:e instanceof HTMLElement&&e.dataset.chromeLayout===`mobile`||typeof matchMedia==`function`&&matchMedia(`(max-width: 640px)`).matches}function ia(e,t){if(e.some(e=>{let t=String(e.id||``).trim().toLowerCase();return!t||t===`home`?!1:e.visible!==!1&&!e.minimized}))return!0;let n=String(t.value||`home`).trim().toLowerCase();if(n&&n!==`home`&&n!==`viewer`)return!0;let r=document.querySelector(`.env-shell-workspace`);if(!r)return!1;for(let e of r.querySelectorAll(`ui-window`)){if(!(e instanceof HTMLElement)||e.hidden||e.hasAttribute(`data-minimized`))continue;let t=getComputedStyle(e);if(t.display!==`none`&&t.visibility!==`hidden`&&!(Number.parseFloat(t.opacity||`1`)<=0))return!0}return!1}function aa(e=new Date){return en(e)}function oa(e){let t=re([]);u(t),h(la,t,{title:`Home`,icon:`house-line`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`home`,e.onHome()}),h(ua,t,{title:`Markdown`,icon:`article`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`viewer`,e.onViewer()});let n=document.createElement(`ui-taskbar`);n.className=`env-shell-taskbar wf-chrome-no-select`,n.setAttribute(`part`,`taskbar`),n.setAttribute(`data-type`,`desktop`);let r=document.createElement(`div`);r.className=`env-shell-taskbar__pins`;let i=document.createElement(`div`);i.className=`env-shell-taskbar__windows`;let a=document.createElement(`ui-task`);a.setAttribute(`title`,`Home`),a.setAttribute(`icon`,`house-line`),a.setAttribute(`data-id`,la),a.setAttribute(`data-env-home`,``),a.setAttribute(`aria-label`,`Home`),a.setAttribute(`aria-haspopup`,`menu`),r.append(a);let o=document.createElement(`div`);o.className=`env-shell-taskbar__workspaces`,o.setAttribute(`aria-label`,`Workspaces`);let s=()=>{let e=Vi(),t=Hi();o.replaceChildren();for(let n of e){let e=document.createElement(`button`);e.type=`button`,e.className=`env-shell-taskbar__workspace`,e.title=n.label,e.textContent=n.label.replace(/^Side\s+/i,``)||n.id.slice(-1).toUpperCase(),e.toggleAttribute(`data-active`,n.id===t),e.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),Ji(n.id)}),o.append(e)}};s(),window.addEventListener(Ni,s),r.append(o),Qi();let c=()=>{let e=ra();a.setAttribute(`title`,e?`Home`:`Start`),a.setAttribute(`aria-label`,e?`Home`:`Start`),a.setAttribute(`icon`,e?`house-line`:`windows-logo`),a.toggleAttribute(`data-env-start`,!e),e?a.setAttribute(`aria-keyshortcuts`,`LongPress`):a.removeAttribute(`aria-keyshortcuts`)};c();let l=document.createElement(`div`);l.className=`env-shell-taskbar__tray-host`;let d=document.createElement(`div`);d.className=`env-shell-taskbar__clock`,d.setAttribute(`role`,`button`),d.setAttribute(`tabindex`,`0`),d.setAttribute(`aria-label`,`Calendar`),d.setAttribute(`aria-haspopup`,`dialog`),d.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let f=document.createElement(`span`);f.className=`env-shell-taskbar__clock-time`;let p=document.createElement(`span`);p.className=`env-shell-taskbar__clock-date`,d.append(f,p);let m=()=>{let{time:e,date:t}=aa();f.textContent=e,p.textContent=t,d.title=`${e} · ${t}`};m();let _=setInterval(m,pa),v=sn(e.device,`env-device-tray env-device-tray--taskbar`);v.setAttribute(`role`,`button`),v.setAttribute(`tabindex`,`0`),v.setAttribute(`aria-label`,`Quick settings`),v.setAttribute(`aria-haspopup`,`dialog`),v.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`);let b=e=>{e.preventDefault(),e.stopPropagation(),Qe(d)},x=e=>{e.preventDefault(),e.stopPropagation(),ht(v)};d.addEventListener(`click`,b),d.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&b(e)}),v.addEventListener(`click`,x),v.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&x(e)}),l.append(v,d);let S=document.createElement(`div`);S.className=`env-shell-navbar__switcher`,S.setAttribute(`role`,`menu`),S.setAttribute(`aria-label`,`Open apps`),S.hidden=!0;let C=document.createElement(`ul`);C.className=`env-shell-navbar__switcher-list`,S.appendChild(C),n.append(r,i,l,S);let w=oi(),T=w?vi():void 0,E=new Map,D=[],O=null,k=!1,ee=!1,A=null,j=[];j.push(()=>clearInterval(_));let te=e=>D.find(t=>String(t.id||``).trim().toLowerCase()===e),M=t=>{let n=String(t||``).trim().toLowerCase();if(!n)return;let r=te(n),i=String(e.focusedTaskId.value||``).trim().toLowerCase(),a=!!r?.focused||i===n||i===`markdown`&&n===`viewer`||i===`viewer`&&(n===`viewer`||n===`markdown`);if(r?.minimized){r.minimized=!1,r.focused=!0,E.get(n)?.toggleAttribute(`data-minimized`,!1),e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n);return}if(a&&r&&r.visible!==!1){r.minimized=!0,r.focused=!1,E.get(n)?.toggleAttribute(`data-minimized`,!0),e.onMinimizeWindow?.(n);return}e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n)},ne=(t,r,i)=>{if(ra())return;t.preventDefault(),t.stopPropagation();let a=String(r||``).trim().toLowerCase(),o=!!te(a)?.minimized,s=[{id:o?`restore`:`minimize`,label:o?`Restore`:`Minimize`,icon:o?`arrow-square-out`:`minus`,action:()=>{o?(e.focusedTaskId.value=a,e.onWindowTask?.(a)):e.onMinimizeWindow?.(a)}},{id:`close`,label:`Close`,icon:`x`,danger:!0,action:()=>e.onCloseWindow?.(a)}];jn({x:t.clientX,y:t.clientY,compact:!0,anchor:t.target instanceof Element?t.target:n,items:s})};n.addEventListener(`contextmenu`,t=>{if(ra())return;let r=typeof t.composedPath==`function`?t.composedPath():[];for(let e of r)if(e instanceof Element&&e.closest?.(`ui-task`))return;t.preventDefault(),t.stopPropagation(),jn({x:t.clientX,y:t.clientY,compact:!0,anchor:n,items:[{id:`show-desktop`,label:`Show desktop`,icon:`desktop`,action:()=>e.onHome()},{id:`home`,label:`Home`,icon:`house-line`,action:()=>e.onHome()}]})});let N=()=>{ee=!1,S.hidden=!0,C.replaceChildren(),n.removeAttribute(`data-switcher-open`)},P=()=>{let r=D.filter(e=>String(e.id||``).trim());if(C.replaceChildren(),r.length)for(let n of r){let r=String(n.id||``).trim().toLowerCase(),i=document.createElement(`li`);i.className=`env-shell-navbar__switcher-row`,i.setAttribute(`role`,`none`);let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-navbar__switcher-item`,a.setAttribute(`role`,`menuitem`),a.toggleAttribute(`data-active`,!!n.focused&&!n.minimized),a.toggleAttribute(`data-minimized`,!!n.minimized);let o=document.createElement(`ui-icon`);o.setAttribute(`icon`,n.icon||`app-window`),o.setAttribute(`icon-style`,`duotone`),o.setAttribute(`aria-hidden`,`true`);let s=document.createElement(`span`);s.className=`env-shell-navbar__switcher-label`,s.textContent=n.title||r,a.append(o,s),a.addEventListener(`click`,n=>{n.preventDefault(),n.stopPropagation(),N(),e.focusedTaskId.value=r;let i=na(r),a=y(t,i);a?a.focus=!0:e.onWindowTask?.(r)});let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-navbar__switcher-close`,c.setAttribute(`aria-label`,`Close ${n.title||r}`),c.title=`Close`;let l=document.createElement(`ui-icon`);l.setAttribute(`icon`,`x`),l.setAttribute(`icon-style`,`bold`),l.setAttribute(`aria-hidden`,`true`),c.appendChild(l),c.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.onCloseWindow?.(r),D=D.filter(e=>String(e.id||``).trim().toLowerCase()!==r),E.get(r)?.remove(),E.delete(r),D.length?P():N()}),i.append(a,c),C.appendChild(i)}else{let e=document.createElement(`li`);e.className=`env-shell-navbar__switcher-empty`,e.textContent=`No open apps`,C.appendChild(e)}ee=!0,S.hidden=!1,n.setAttribute(`data-switcher-open`,``)},ae=()=>{O!=null&&(clearTimeout(O),O=null)},oe=()=>{n.toggleAttribute(`data-app-menu-open`,!!T?.isOpen())},se=()=>{N(),T?.close(),oe(),y(t,la).focus=!0,e.onHome()},ce=()=>{N(),T?.toggle(),oe(),y(t,la).focus=!0,e.focusedTaskId.value=`home`,me()},le=()=>{!T||T.isOpen()||(N(),T.open(),oe(),y(t,la).focus=!0,e.focusedTaskId.value=`home`,me())},ue=()=>{T&&(N(),T.openPage(),oe(),y(t,la).focus=!0,e.focusedTaskId.value=`home`,me())};try{let e=globalThis;e.__CWSP_LAUNCHER_HOME__={...e.__CWSP_LAUNCHER_HOME__||{},openAppMenu:le,openAppMenuPage:ue}}catch{}let de=()=>{if(ia(D,e.focusedTaskId)){se();return}if(T?.isOpen()){T.close(),oe();return}ce()};a.addEventListener(`click`,e=>{if(k){e.preventDefault(),e.stopPropagation(),k=!1;return}if(w&&T){e.preventDefault(),e.stopPropagation(),de();return}se()}),a.addEventListener(`pointerdown`,e=>{if(ra()&&(e.button==null||e.button===0)){k=!1,ae(),O=setTimeout(()=>{O=null,k=!0;try{a.releasePointerCapture?.(e.pointerId)}catch{}P()},fa);try{a.setPointerCapture?.(e.pointerId)}catch{}}},{capture:!0});let fe=()=>{ae()};a.addEventListener(`pointerup`,fe,{capture:!0}),a.addEventListener(`pointercancel`,fe,{capture:!0}),a.addEventListener(`contextmenu`,e=>{ra()&&(e.preventDefault(),k=!0,ae(),P())});let pe=e=>{if(!ee)return;let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t)if(e===S||e===a||e instanceof Element&&(e===S||S.contains(e)||e===a))return;N()};document.addEventListener(`pointerdown`,pe,{capture:!0}),j.push(()=>document.removeEventListener(`pointerdown`,pe,{capture:!0}));let me=()=>{let t=String(e.focusedTaskId.value||`home`),n=(e,t)=>{e.toggleAttribute(`data-env-active`,t),e.toggleAttribute(`data-active`,t),e.toggleAttribute(`data-focus`,t)};n(a,t===`home`);for(let[e,r]of E)n(r,t===e)};ie(()=>{me()},[e.focusedTaskId],{triggerImmediately:!0});let he=e=>{let n=String(e.id||``).trim().toLowerCase();if(!n||n===`home`)return;let r=na(n),a=e.title||n,o=String(e.icon||``).trim()||`app-window`,s=E.get(n);if(!s){let e=h(r,null,{title:a,icon:o},{viewId:n},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,M(n)});e.list=t,t.push(e),s=document.createElement(`ui-task`),s.setAttribute(`data-id`,r),s.setAttribute(`data-view`,n),s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),M(n)}),s.addEventListener(`contextmenu`,e=>{ne(e,n,a)}),E.set(n,s),i.appendChild(s)}s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.toggleAttribute(`data-minimized`,!!e.minimized),s.hidden=e.visible===!1},ge=n=>{D=Array.isArray(n)?n.slice():[];let r=new Set;for(let t of n){let n=String(t.id||``).trim().toLowerCase();!n||n===`home`||(r.add(n),he(t),t.focused&&(e.focusedTaskId.value=n))}for(let[e,n]of[...E.entries()]){if(r.has(e))continue;let i=na(e),a=y(t,i);if(a){let e=t.indexOf(a);e>=0&&t.splice(e,1)}n.remove(),E.delete(e)}me(),ee&&P()},_e=n=>{let r=String(n||`home`).toLowerCase(),i=la;r===`viewer`||r===`markdown`?i=ua:r!==`home`&&(i=na(r));let a=y(t,i);if(a){for(let e of t)e!==a&&(e.active=!1);a.active=!0}e.focusedTaskId.value=r===`markdown`?`viewer`:r,me()},ve=()=>{let e=!ra();c(),e?!A&&n.isConnected&&(A=g(n,{className:`env-shell-taskbar-under`,shadowBlur:28,shadowOffsetY:8,shadowColor:`rgba(0, 0, 0, 0.4)`})):A&&=(A.destroy(),null)};queueMicrotask(ve);let ye=typeof matchMedia==`function`?matchMedia(`(min-width: 641px)`):null,be=()=>ve();if(ye?.addEventListener?.(`change`,be),j.push(()=>ye?.removeEventListener?.(`change`,be)),T){let e=()=>oe();n.addEventListener(`env-app-menu-open`,e),n.addEventListener(`env-app-menu-close`,e),j.push(()=>{n.removeEventListener(`env-app-menu-open`,e),n.removeEventListener(`env-app-menu-close`,e)})}return{element:n,taskList:t,setFocusedTaskId:_e,syncWindowTasks:ge,appMenu:T,openAppMenu:T?le:void 0,openAppMenuPage:T?ue:void 0,isSwitcherOpen:()=>ee,closeSwitcher:N,dispose:()=>{ae(),N(),T?.dispose(),A?.destroy(),A=null;for(let e of j)try{e()}catch{}j.length=0,E.clear(),i.replaceChildren()}}}var sa,ca,la,ua,da,fa,pa;function ma(){return(ma=e((()=>{j(),E(),oe(),Mn(),dn(),at(),qt(),Ti(),Yi(),$i(),L(),ta(),o(),sa=t(ea),ca=class extends Me{constructor(){super()}styles=()=>sa;render=()=>D`<div part="taskbar" class="taskbar"><slot></slot></div>`},ca=F([f(`ui-taskbar`)],ca),la=`#env-home`,ua=`#env-viewer`,da=`#env-win-`,fa=420,pa=3e4})))()}var ha;function ga(){return(ga=e((()=>{ha=`/**
 * Font Styles Index
 *
...
.ui-modal-panel {
  ...
  box-shadow: var(--modal-shadow, 0 20px 60px rgba(0, 0, 0, 0.42));
  pointer-events: auto;
}`})))()}function _a(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function va(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function ya(e,t,n=`font/woff2`){if(wa.has(t))return wa.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return wa.set(t,i),i}async function ba(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(Ta.has(o))return Ta.get(o);let s=_a(t),c=await ya(a?await va(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),Ta.set(o,l),l}async function xa(e){let t=e.map(e=>ba(e));return Promise.all(t)}async function Sa(){return Ea||(Ea=c(()=>import(`./font-registry-DGJ_haGr.js`),[],import.meta.url)?.catch?.(e=>{console.error(`Failed to load font registry:`,e)}),Ea)}async function Ca(){let e=await Sa();return xa(Object.values(e.fontRegistry))}var wa,Ta,Ea;function Da(){return(Da=e((()=>{s(),wa=new Map,Ta=new Map,Ea=null})))()}var Oa;function ka(){return(ka=e((()=>{Oa=`/*
 * Filename: layers.scss
 * FullPath: modules/projects/fl.ui/src/styles/layers.scss
 * Change date and time: 15.10.00_22.08.2026
 * Reason for changes: Match veela \`_layers.scss\` so fl.ui never establishes a shorter competing prelude.
...
}`})))()}var Aa,ja;function Ma(){return(Ma=e((()=>{Da(),o(),ga(),ka(),Aa=`
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
`,ja=async e=>{await r(Aa)?.catch(()=>void 0),await Ca().catch(()=>void 0),await r(ha)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await r(Oa)?.catch(()=>void 0)}})))()}var Na;function Pa(){return(Pa=e((()=>{Na=`:host(ui-task), :host(ui-task) * {
  box-sizing: border-box;
  user-select: none;
  touch-action: manipulation;
  -webkit-user-drag: none;
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})))()}var Fa,Ia,La,Ra;function za(){return(za=e((()=>{L(),o(),E(),Pa(),Fa=t(Na),Ia=e=>{let t=``;if(typeof e==`string`)t=e;else if(typeof e==`object`&&e&&`value`in e){let n=e.value;t=n==null?``:String(n)}else e!=null&&typeof e!=`object`&&(t=String(e));(!t||t===`undefined`||t===`null`||t===`[object Object]`)&&(t=``);let n=t.trim().charAt(0);return n?n.toUpperCase():`?`},La=(e,t,n)=>{let r=e.getAttribute(t);return r!=null&&String(r).trim()?String(r).trim():n},Ra=class extends Me{title;icon;constructor(){super()}styles=()=>Fa;render=function(){let e=La(this,`title`,`Task`),t=La(this,`icon`,`app-window`),n=Ia(e);return D`
        ...
        `}},F([x({source:`attr`})],Ra.prototype,`title`,void 0),F([x({source:`attr`})],Ra.prototype,`icon`,void 0),Ra=F([f(`ui-task`)],Ra)})))()}var Ba;function Va(){return(Va=e((()=>{Ba=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})))()}function Ha(){return(Ha=e((()=>{o(),Va(),t(Ba)})))()}var Ua;function Wa(){return(Wa=e((()=>{Ua=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}
...
:host(ui-taskbar[data-type=mobile]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})))()}function Ga(){return(Ga=e((()=>{o(),Wa(),t(Ua)})))()}function Ka(){try{return globalThis.navigator?.windowControlsOverlay??null}catch{return null}}function qa(){if(typeof globalThis.matchMedia!=`function`)return`unknown`;try{if(globalThis.matchMedia(`(display-mode: window-controls-overlay)`).matches)return`window-controls-overlay`;if(globalThis.matchMedia(`(display-mode: fullscreen)`).matches)return`fullscreen`;if(globalThis.matchMedia(`(display-mode: standalone)`).matches)return`standalone`;if(globalThis.matchMedia(`(display-mode: minimal-ui)`).matches)return`minimal-ui`;if(globalThis.matchMedia(`(display-mode: browser)`).matches)return`browser`}catch{}return`unknown`}function Ja(e){if(!e?.visible||typeof e.getTitlebarAreaRect!=`function`)return null;try{let t=e.getTitlebarAreaRect();return t?{x:t.x,y:t.y,width:t.width,height:t.height}:null}catch{return null}}function Ya(e){let t=Ka(),n=!!t?.visible,r=qa(),i=n||r===`standalone`||r===`fullscreen`||r===`window-controls-overlay`||r===`minimal-ui`,a=`off`;return e&&(a=n?`wco`:i?`standalone`:`fallback`),{requested:e,wcoVisible:n,displayMode:r,titlebarRect:Ja(t),isStandaloneLike:i,surface:a}}function Xa(e){let t=()=>{e.onChange(Ya(e.getRequested()))},n=[];if(typeof globalThis.matchMedia==`function`)for(let e of[`(display-mode: window-controls-overlay)`,`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`])try{n.push(globalThis.matchMedia(e))}catch{}let r=()=>t();for(let e of n)try{e.addEventListener?.(`change`,r)}catch{try{e.addListener?.(r)}catch{}}let i=Ka(),a=()=>t();try{i?.addEventListener?.(`geometrychange`,a)}catch{}return queueMicrotask(t),()=>{for(let e of n)try{e.removeEventListener?.(`change`,r)}catch{try{e.removeListener?.(r)}catch{}}try{i?.removeEventListener?.(`geometrychange`,a)}catch{}}}var Z,Za,Qa,$a,eo,to,no,ro,io,Q,ao,oo,so,co,lo,uo,$,fo,po,mo,ho,go,_o,vo,yo;function bo(){return(bo=e((()=>{Z=null,Za=null,Qa=null,$a=[],eo=null,to=0,no=null,ro=`#cbb8a4`,io=`__CWSP_NATIVE_THEME_COLOR_OWNED__`,Q=e=>{let t=String(e||``).trim().toLowerCase();if(!t)return!1;if(t===`#007acc`||t===`#007accff`||t===`#36c`||t===`#3366cc`)return!0;let n=t.match(/^rgba?\(\s*([\d.]+)\s*[, ]\s*([\d.]+)\s*[, ]\s*([\d.]+)/i);if(n&&(t?.startsWith?.(`#`)||t?.startsWith?.(`rgb`))){let e=Math.round(Number(n[1])),t=Math.round(Number(n[2])),r=Math.round(Number(n[3]));if(e<=20&&t>=100&&t<=140&&r>=180&&r<=220)return!0}return!1},ao=()=>{try{return!!globalThis?.[io]}catch{return!1}},oo=e=>{eo=e;try{globalThis[io]=!!e}catch{}},so=e=>{if(!e||!e.isConnected||e.hasAttribute(`minimized`))return!1;if(e.hasAttribute(`native-mode`))return!0;let t=e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`);if(!t)return!1;try{let t=e.getBoundingClientRect(),n=Math.max(1,globalThis.innerWidth||1),r=Math.max(1,globalThis.innerHeight||1);return t.top<=8&&t.left<=8&&t.width>=n*.92&&t.height>=r*.85}catch{return t}},co=()=>{if(typeof document>`u`)return null;if(eo?.isConnected&&so(eo))return eo;let e=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized])`));if(e.length)return e[e.length-1];let t=Array.from(document.querySelectorAll(`ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`));for(let e=t.length-1;e>=0;e--){let n=t[e];if(so(n))return n}return null},lo=()=>{Za||typeof MutationObserver>`u`||typeof document>`u`||(Za=new MutationObserver(()=>{let e=co();e?.isConnected?vo(e):go()}),Za.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`class`,`style`,`color-scheme`]}))},uo=e=>{Qa||typeof MutationObserver>`u`||(Qa=new MutationObserver(()=>{if(!ao())return;let t=(e.getAttribute(`content`)||``).toLowerCase(),n=(no||``).toLowerCase();if(n&&t===n&&!Q(t))return;let r=co();r?vo(r):Q(t)&&ho(ro,!0)}),Qa.observe(e,{attributes:!0,attributeFilter:[`content`]}))},$=e=>e,fo=()=>{if(typeof document>`u`)return null;let e=document.querySelector(`meta[data-theme-color]`)||document.querySelector(`meta[name="theme-color"]`);e||(e=document.createElement(`meta`),e.setAttribute(`name`,`theme-color`),e.setAttribute(`data-theme-color`,``),document.head?.appendChild(e));try{let t=Array.from(document.querySelectorAll(`meta[name="theme-color"]`));for(let n of t)n!==e&&n.remove()}catch{}return uo(e),e},po=(e,t)=>{try{let n=document.createElement(`div`);n.setAttribute(`data-theme-color-probe`,`true`),n.style.cssText=`position:fixed;left:-8px;top:-8px;inline-size:4px;block-size:4px;pointer-events:none;opacity:0;background:${t}`,e.appendChild(n);let r=$(getComputedStyle(n).backgroundColor);return n.remove(),r}catch{return null}},mo=e=>{let t=e.shadowRoot?.querySelector(`.title-handler`);if(t){let e=po(t,`var(--ui-win-titlebar-bg, var(--color-surface-container, Canvas))`);if(e)return e;let n=$(getComputedStyle(t).backgroundColor);if(n)return n}let n=getComputedStyle(e);for(let t of[`--ui-win-titlebar-bg`,`--color-surface-container`,`--color-surface`]){let r=po(e,`var(${t})`);if(r)return r;let i=n.getPropertyValue(t).trim();if(!i)continue;let a=$(i);if(a)return a}let r=getComputedStyle(document.documentElement);for(let e of[`--color-surface-container`,`--color-surface`,`--color-surface-container-low`]){let t=po(document.documentElement,`var(${e})`)||$(r.getPropertyValue(e).trim());if(t)return t}return null},ho=(e,t=!1)=>{let n=fo();if(!n||!e)return;let r=e.toLowerCase();Q(r)&&(r=ro);let i=(n.getAttribute(`content`)||``).toLowerCase();if(!(i===r&&!t&&!Q(i))&&(n.setAttribute(`content`,r),n.setAttribute(`data-theme-color`,``),n.removeAttribute(`media`),no=r,t||i!==r||Q(i)))try{let e=n.parentNode||document.head;e?.removeChild(n),e?.appendChild(n)}catch{}},go=()=>{if(typeof document>`u`||co())return;oo(null),no=null;let e=fo();if(!e)return;let t=document.documentElement,n=getComputedStyle(t),r=document.body?getComputedStyle(document.body):null,i=$(n.getPropertyValue(`--color-surface-container`).trim())||$(n.getPropertyValue(`--color-surface`).trim())||$(n.getPropertyValue(`--ui-win-titlebar-bg`).trim())||(r?$(r.backgroundColor):null)||$(n.backgroundColor);i?ho(i):Q(String(e.getAttribute(`content`)||``))&&ho(ro,!0),lo()},_o=e=>e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`),vo=e=>{if(!e||typeof document>`u`||e.hasAttribute(`minimized`)||!e.hasAttribute(`native-mode`)&&!_o(e)&&!so(e))return;let t=fo();if(!t)return;if(Z==null){let e=t.getAttribute(`content`)||``;Z=Q(e)?``:e}oo(e),Q(String(t.getAttribute(`content`)||``))&&ho(ro,!0);let n=++to,r=(t=!1)=>{if(n!==to||!e.isConnected||!e.hasAttribute(`native-mode`)&&!_o(e)&&!so(e))return;let r=mo(e)||ro;ho(r,t)};r(!0),requestAnimationFrame(()=>{r(!1),requestAnimationFrame(()=>r(!0))});for(let e of $a)clearTimeout(e);$a=[],$a.push(setTimeout(()=>r(!0),50),setTimeout(()=>r(!0),160),setTimeout(()=>r(!0),400)),lo()},yo=e=>{if(typeof document>`u`||!document.querySelector(`meta[name="theme-color"]`))return;let t=co();if(t&&t!==e){vo(t);return}let n=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized]), ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`)).filter(t=>t!==e&&so(t));if(n.length){vo(n[n.length-1]);return}oo(null),no=null,to+=1;for(let e of $a)clearTimeout(e);$a=[],Z!=null&&Z&&!Q(Z)?(ho(Z,!0),Z=null):(Z=null,go())},typeof document<`u`&&queueMicrotask(()=>{try{go()}catch{}})})))()}var xo;function So(){return(So=e((()=>{xo=`/*
...
:host(ui-window) :where(.footer-handler:empty, .footer-handler:not(:has-slotted)) {
  display: none !important;
}
...
:host(ui-window[data-native-active]) :where(.footer-handler:empty, .footer-handler:not(:has-slotted)) {
  display: none !important;
}
...
.window-resizer:hover {
  opacity: 0.9;
}`})))()}var Co,wo,To,Eo,Do,Oo,ko;function Ao(){return(Ao=e((()=>{E(),o(),L(),j(),bo(),So(),Co=t(xo),wo=`minus`,To=`corners-out`,Eo=`corners-in`,Do=`x`,Oo=Object.freeze({w:240,h:160}),ko=class extends I{titleHandler;contentHandler;footerHandler;resizer;#e=O(0);#t=O(0);#n=null;#r=null;#i=null;#a=null;#o=null;#s=null;#c=null;#l=!1;#u=0;#d=0;#f=null;styles=function(){return Co};render=function(){return D`<div class="window-container" part="window-container">
        ...
        </div>`};constructor(){super()}get managed(){return this.hasAttribute(`managed`)}get nativeMode(){return this.hasAttribute(`native-mode`)}set nativeMode(e){this.toggleAttribute(`native-mode`,!!e),this.#h()}get nativeSurface(){return this.#f?.surface??(this.nativeMode?`fallback`:`off`)}onInitialize(){super.onInitialize()}onRender(){super.onRender(),this.#p()}connectedCallback(){super.connectedCallback?.(),this.#p(),this.#m()}disconnectedCallback(){this.#s?.(),this.#s=null,this.#c?.disconnect(),this.#c=null,this.#o?.disconnect(),this.#o=null,this.#a?.(),this.#a=null,this.#l=!1,this.#u=0,this.#i?.(),this.#i=null,this.#n?.(),this.#n=null,this.#r?.(),this.#r=null,super.disconnectedCallback?.()}#p(){let e=()=>{this.#E(),this.#b(),this.#D(),this.#O(),this.#h(),this.#u<20&&(this.#u+=1,(!this.#l||this.#u<8)&&requestAnimationFrame(e))};queueMicrotask(e)}#m(){this.#s||(this.#s=Xa({getRequested:()=>this.nativeMode,onChange:e=>this.#g(e)}),typeof MutationObserver<`u`&&!this.#c&&(this.#c=new MutationObserver(e=>{let t=!1,n=!1;for(let r of e)r.attributeName===`native-mode`&&(t=!0),(r.attributeName===`maximized`||r.attributeName===`data-desk-max`||r.attributeName===`data-mobile-max`)&&(n=!0);(t||n)&&this.#h(),n&&this.#v()}),this.#c.observe(this,{attributes:!0,attributeFilter:[`native-mode`,`maximized`,`data-desk-max`,`data-mobile-max`]})))}#h(){this.#g(Ya(this.nativeMode))}#g(e){this.#f=e;let t=this;t.toggleAttribute(`data-native-wco`,e.surface===`wco`),t.toggleAttribute(`data-native-standalone`,e.surface===`standalone`),t.toggleAttribute(`data-native-fallback`,e.surface===`fallback`),t.toggleAttribute(`data-native-active`,e.surface!==`off`),this.#_(e.surface),e.titlebarRect?(t.style.setProperty(`--ui-win-titlebar-area-x`,`${e.titlebarRect.x}px`),t.style.setProperty(`--ui-win-titlebar-area-y`,`${e.titlebarRect.y}px`),t.style.setProperty(`--ui-win-titlebar-area-width`,`${e.titlebarRect.width}px`),t.style.setProperty(`--ui-win-titlebar-area-height`,`${e.titlebarRect.height}px`)):(t.style.removeProperty(`--ui-win-titlebar-area-x`),t.style.removeProperty(`--ui-win-titlebar-area-y`),t.style.removeProperty(`--ui-win-titlebar-area-width`),t.style.removeProperty(`--ui-win-titlebar-area-height`)),this.#n?.(),this.#n=null,this.#r?.(),this.#r=null,this.#D(),this.#O(),this.#v(),this.nativeMode||this.hasAttribute(`data-desk-max`)||this.hasAttribute(`maximized`)||this.hasAttribute(`data-mobile-max`)?vo(this):(yo(this),go()),this.dispatchEvent(new CustomEvent(`window-native-change`,{bubbles:!0,composed:!0,detail:e}))}#_(e=this.nativeSurface){let t=this.shadowRoot?.querySelector(`.title-exit-native`);t&&(t.hidden=e!==`standalone`)}#v(){let e=this.shadowRoot?.querySelector(`.title-maximize`),t=e?.querySelector(`ui-icon`);if(!e||!t)return;let n=!(this.nativeMode&&this.nativeSurface===`fallback`)&&(this.hasAttribute(`maximized`)||this.hasAttribute(`data-desk-max`)||this.hasAttribute(`data-mobile-max`)),r=n?Eo:To,i=n?`Restore`:`Maximize`;t.getAttribute(`icon`)!==r&&t.setAttribute(`icon`,r),e.setAttribute(`aria-label`,i),e.setAttribute(`title`,i)}applyBounds(e){let t=this;t.style.position=`absolute`,typeof e.x==`number`&&(t.style.left=`${e.x}px`),typeof e.y==`number`&&(t.style.top=`${e.y}px`),typeof e.w==`number`&&(t.style.width=`${e.w}px`,t.style.setProperty(`--ui-win-width`,`${e.w}px`)),typeof e.h==`number`&&(t.style.height=`${e.h}px`,t.style.setProperty(`--ui-win-height`,`${e.h}px`)),typeof e.z==`number`&&(t.style.zIndex=String(e.z)),t.style.right=``,t.style.bottom=``,this.managed&&(this.#e.value=0,this.#t.value=0,t.style.transform=``)}setVisible(e){this.toggleAttribute(`hidden-window`,!e),this.style.visibility=e?``:`hidden`,this.style.pointerEvents=e?``:`none`}get isMaximized(){return this.hasAttribute(`maximized`)||this.hasAttribute(`data-desk-max`)||this.hasAttribute(`data-mobile-max`)}get isMinimized(){return this.hasAttribute(`minimized`)}get usesNativeWindowDrag(){let e=this.nativeSurface;return e===`wco`||e===`standalone`}enterNativeMode(){if(this.managed){this.#y(`window-native`);return}this.nativeMode=!0,this.#y(`window-native`)}exitNativeMode(){if(this.managed){this.#y(`window-exit-native`);return}this.nativeMode=!1,this.#y(`window-exit-native`)}#y(e,t=!1){return this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,cancelable:t}))}toggleMaximize(){let e=this.isMaximized;if(this.managed){this.#y(e?`window-restore`:`window-maximize`);return}let t=!e;this.toggleAttribute(`maximized`,t),t&&this.removeAttribute(`minimized`),this.#v(),this.#y(t?`window-maximize`:`window-restore`)}toggleMinimize(){if(this.managed){this.#y(this.isMinimized?`window-restore`:`window-minimize`);return}let e=!this.isMinimized;this.toggleAttribute(`minimized`,e),e&&this.removeAttribute(`maximized`),this.#y(e?`window-minimize`:`window-restore`)}restoreWindow(){if(this.managed){this.#y(`window-restore`);return}let e=this.isMinimized,t=this.isMaximized;this.removeAttribute(`minimized`),this.removeAttribute(`maximized`),(e||t)&&this.#y(`window-restore`)}closeWindow(){this.#y(`window-close`,!0),this.isConnected&&this.remove()}#b(){this.#i||=a(this,`pointerdown`,()=>{this.requestFocus()},{capture:!0,passive:!0})}requestFocus(){this.dispatchEvent(new CustomEvent(`window-focus`,{bubbles:!0,composed:!0}))}bringToFront(e){let t=this;Number.isFinite(e)&&(t.style.zIndex=String(e)),t.toggleAttribute(`data-focused`,!0)}clearFocused(){this.toggleAttribute(`data-focused`,!1)}#x(e){let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t){if(!(e instanceof Element))continue;let t=e.getAttribute?.(`data-ui-win-action`);if(t===`close`||t===`exit-native`||t===`maximize`||t===`minimize`)return t;if(e.matches?.(`.title-close`))return`close`;if(e.matches?.(`.title-exit-native`))return`exit-native`;if(e.matches?.(`.title-maximize`))return`maximize`;if(e.matches?.(`.title-minimize`))return`minimize`}let n=e.target;if(n instanceof Element){let e=n.closest?.(`[data-ui-win-action], .title-close, .title-exit-native, .title-maximize, .title-minimize`)??null;if(!e)return null;let t=e.getAttribute(`data-ui-win-action`);if(t===`close`||t===`exit-native`||t===`maximize`||t===`minimize`)return t;if(e.classList.contains(`title-close`))return`close`;if(e.classList.contains(`title-exit-native`))return`exit-native`;if(e.classList.contains(`title-maximize`))return`maximize`;if(e.classList.contains(`title-minimize`))return`minimize`}return null}#S(){let e=typeof performance<`u`?performance.now():Date.now();return e-this.#d<280?!1:(this.#d=e,!0)}#C(e){e===`close`?this.closeWindow():e===`exit-native`?this.exitNativeMode():e===`maximize`?this.nativeMode&&this.nativeSurface===`fallback`?this.exitNativeMode():this.toggleMaximize():this.toggleMinimize()}#w(e){let t=this.#x(e);return t?(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation?.(),this.#S()&&this.#C(t),!0):!1}#T(){let e=this.shadowRoot;if(e)for(let[t,n]of[[`minimize`,`.title-minimize`],[`maximize`,`.title-maximize`],[`close`,`.title-close`],[`exit-native`,`.title-exit-native`]]){let r=e.querySelector(n);if(!r)continue;r.setAttribute(`data-ui-win-action`,t);let i=e=>{e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation?.(),this.#S()&&this.#C(t)};r.onclick=i,r.onpointerup=e=>{e.button===0&&i(e)}}}#E(){let e=this.shadowRoot;if(!e)return;let t=this.titleHandler,n=t instanceof HTMLElement?t:e.querySelector(`.title-handler`),r=e.querySelector(`.title-handler-buttons`);if(!n||!r)return;if(this.#T(),this.#l){this.#_(),this.#v();return}let i=e=>{this.#w(e)},o=e=>{this.#x(e)||(typeof e.composedPath==`function`?e.composedPath():[]).some(e=>e instanceof Element&&e.classList?.contains(`title-handler`))&&(e.target?.closest?.(`button, a, input, textarea, select, [data-no-drag]`)||(e.preventDefault(),this.#S()&&this.toggleMaximize()))},s=a(e,`click`,i,{capture:!0}),c=a(e,`pointerup`,i,{capture:!0}),l=a(this,`click`,i,{capture:!0}),u=a(this,`pointerup`,i,{capture:!0}),d=a(this,`dblclick`,o,{capture:!0});typeof MutationObserver<`u`&&!this.#o&&(this.#o=new MutationObserver(()=>{this.#T(),this.#_(),this.#v()}),this.#o.observe(e,{childList:!0,subtree:!0})),this.#a=()=>{s?.(),c?.(),l?.(),u?.(),d?.(),this.#o?.disconnect(),this.#o=null,this.#a=null,this.#l=!1},this.#l=!0,this.#u=0,this.#_(),this.#v()}#D(){let e=this.shadowRoot??this,t=this.titleHandler,n=t instanceof HTMLElement?t:e.querySelector?.(`.title-handler`);if(!n||this.#n)return;if(this.usesNativeWindowDrag){this.#n=()=>{this.#n=null};return}this.managed||k(this,ee`transform: translate(${this.#e}px, ${this.#t}px)`);let r=new Map,i=a(n,`pointerdown`,e=>{if(e.button!==0||this.#x(e)||e.target?.closest(`button, a, input, textarea, select, [data-no-drag]`)||this.isMaximized||this.isMinimized||this.nativeMode)return;this.requestFocus();let t=this;r.set(e.pointerId,{sx:e.clientX,sy:e.clientY,ox:this.#e.value,oy:this.#t.value,bx:Number.parseFloat(t.style.left||`0`)||0,by:Number.parseFloat(t.style.top||`0`)||0,dragging:!1});let n=a(document.body,`pointermove`,e=>{let t=r.get(e.pointerId);if(!t)return;let n=e.clientX-t.sx,i=e.clientY-t.sy;if(!t.dragging){if(Math.hypot(n,i)<4)return;t.dragging=!0;try{e.preventDefault()}catch{}this.setPointerCapture?.(e.pointerId)}if(this.managed){this.dispatchEvent(new CustomEvent(`window-move`,{bubbles:!0,composed:!0,detail:{x:t.bx+n,y:t.by+i,dx:n,dy:i}}));return}this.#e.value=t.ox+n,this.#t.value=t.oy+i}),i=e=>{if(!r.has(e.pointerId))return;let t=r.get(e.pointerId);if(r.delete(e.pointerId),t?.dragging)try{this.releasePointerCapture?.(e.pointerId)}catch{}n?.(),o?.(),s?.()},o=a(document.body,`pointerup`,i),s=a(document.body,`pointercancel`,i)});this.#n=()=>{i?.()}}#O(){let e=this.shadowRoot??this,t=this.resizer,n=t instanceof HTMLElement?t:e.querySelector?.(`.window-resizer`);if(!n||this.#r)return;let r=new Map,i=a(n,`pointerdown`,e=>{if(e.button!==0||this.isMaximized||this.isMinimized||this.nativeMode)return;e.preventDefault(),e.stopPropagation(),this.requestFocus(),this.setPointerCapture?.(e.pointerId);let t=this.getBoundingClientRect();r.set(e.pointerId,{sx:e.clientX,sy:e.clientY,w:t.width,h:t.height});let n=a(document.body,`pointermove`,e=>{let t=r.get(e.pointerId);if(!t)return;let n=Math.max(Oo.w,t.w+(e.clientX-t.sx)),i=Math.max(Oo.h,t.h+(e.clientY-t.sy));if(this.managed){this.dispatchEvent(new CustomEvent(`window-resize`,{bubbles:!0,composed:!0,detail:{w:n,h:i}}));return}this.style.width=`${n}px`,this.style.height=`${i}px`,this.style.setProperty(`--ui-win-width`,`${n}px`),this.style.setProperty(`--ui-win-height`,`${i}px`)}),i=e=>{if(r.has(e.pointerId)){r.delete(e.pointerId);try{this.releasePointerCapture?.(e.pointerId)}catch{}n?.(),o?.(),s?.()}},o=a(document.body,`pointerup`,i),s=a(document.body,`pointercancel`,i)});this.#r=()=>{i?.()}}},F([x({source:`query-shadow`,name:`.title-handler`})],ko.prototype,`titleHandler`,void 0),F([x({source:`query-shadow`,name:`.content-handler`})],ko.prototype,`contentHandler`,void 0),F([x({source:`query-shadow`,name:`.footer-handler`})],ko.prototype,`footerHandler`,void 0),F([x({source:`query-shadow`,name:`.window-resizer`})],ko.prototype,`resizer`,void 0),ko=F([f(`ui-window`)],ko)})))()}function jo(){return(jo=e((()=>{E()})))()}function Mo(){return(Mo=e((()=>{E(),jo(),[`button:not([disabled])`,`[href]`,`input:not([disabled])`,`select:not([disabled])`,`textarea:not([disabled])`,`[tabindex]:not([tabindex='-1'])`].join(`,`)})))()}function No(){return(No=e((()=>{E()})))()}function Po(){return(Po=e((()=>{L(),dn(),ma(),za(),Ha(),Ga(),We(),at(),qt(),Ti(),Ao(),jo(),Mo(),No()})))()}function Fo(){return{...Io}}var Io;function Lo(){return(Lo=e((()=>{o(),ga(),Ma(),Po(),Io={loadStyles:!0,includeGlobalNativeControlStyles:!1,styleVariant:`veela-basic`},(async()=>{let e=Fo();e.loadStyles!==!1&&(await ja({includeGlobalNativeControls:e.includeGlobalNativeControlStyles===!0}),await i(ha))})()?.catch?.(()=>void 0)})))()}export{je as C,F as S,at as _,Ar as a,I as b,nn as c,Zt as d,Xt as f,zt as g,qt as h,ar as i,dn as l,$t as m,ma as n,ir as o,cn as p,oa as r,on as s,Lo as t,Qt as u,We as v,L as x,Re as y};