import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{A as t,k as n,t as r}from"./src-C7QuTtnr.js";import{_ as i,d as a,g as o,u as s}from"./registry-D2pvZ4V6.js";import{n as c,t as l}from"./preload-helper-DcjHEl26.js";import{a as u,t as d}from"./cws-bridge-CJBOA0Wb.js";import{G as f,W as p,t as m}from"./src-R3RI73pV.js";import{i as h,n as g,t as _}from"./object-DpwBpfvO.js";import{i as v,s as y}from"./icon-M8fpRh7n.js";import{a as b,i as x,r as S,t as C}from"./image-DXfKzn7s.js";import{c as w,l as T,n as E,o as D,s as O,t as k}from"./shells-BJLRDF_1.js";import{F as A,M as j,N as M,P as ee}from"./launcher-state-DEXvEx9Y.js";import{_ as N,a as P,c as F,d as I,f as te,g as ne,h as re,i as ie,l as ae,m as L,n as R,o as z,p as oe,r as se,s as ce,t as le,u as ue,v as de,y as fe}from"./src-D2671Udg2.js";function pe(){if(typeof document>`u`||!document.body)return{top:0,bottom:0};let e=document.createElement(`div`);e.style.cssText=`position:fixed;top:0;left:0;padding-top:env(safe-area-inset-top);padding-bottom:env(safe-area-inset-bottom);visibility:hidden;pointer-events:none;`,document.body.appendChild(e);let t=getComputedStyle(e),n=Number.parseFloat(t.paddingTop)||0,r=Number.parseFloat(t.paddingBottom)||0;return e.remove(),{top:n,bottom:r}}function me(){try{if(!/android/i.test(navigator.userAgent))return 0}catch{return 0}return 28}function he(e,t){H=Math.max(0,Math.round(e)),U=Math.max(0,Math.round(t));let n=`${H}px`,r=`${U}px`;document.documentElement.style.setProperty(B,n),document.documentElement.style.setProperty(V,r),document.documentElement.toggleAttribute(`data-capacitor-native`,!0);for(let e of document.querySelectorAll(`.env-shell-root, env-shell-container`))e instanceof HTMLElement&&(e.style.setProperty(B,n),e.style.setProperty(V,r),e.toggleAttribute(`data-capacitor-native`,!0))}function ge(){if(H<=0&&U<=0)return;let e=`${H}px`,t=`${U}px`;for(let n of document.querySelectorAll(`.env-shell-root, env-shell-container`))n instanceof HTMLElement&&n.style.getPropertyValue(B)!==e&&(n.style.setProperty(B,e),n.style.setProperty(V,t),n.toggleAttribute(`data-capacitor-native`,!0))}async function _e(){let e=0;try{let t=await d.getShellInfo();e=Number(t.statusBarHeightCss)||0}catch{}let t=pe();return e=Math.max(e,t.top),e<=0&&(e=me()),{top:e,bottom:0}}async function ve(){if(!ue())return;if(ye){ge();return}ye=!0;let e=async()=>{let{top:e,bottom:t}=await _e();he(e,t)};await e(),window.addEventListener(`resize`,()=>void e()),window.visualViewport?.addEventListener(`resize`,()=>void e()),document.addEventListener(`orientationchange`,()=>void e()),ge(),globalThis.setTimeout?.(ge,400)}var B,V,H,U,ye;function be(){return(be=e((()=>{u(),ae(),B=`--env-native-safe-top`,V=`--env-native-safe-bottom`,H=0,U=0,ye=!1})))()}var xe;function Se(){return(Se=e((()=>{xe=`/**
...
.esc-overlays {
  ...
  position: relative;
  overflow: visible;
}`})))()}function Ce(){return!Oe&&!customElements.get(`env-shell-container`)&&(customElements.define(W,De),Oe=!0),De}function we(){Ce();let e=customElements.get(W);if(e)try{return new e}catch(e){console.warn("[env-shell-container] `new` failed, falling back to createElement",e)}return document.createElement(W)}function Te(e){return e instanceof HTMLElement&&e.localName===`env-shell-container`}var W,Ee,De,Oe;function ke(){return(ke=e((()=>{Se(),O(),W=`env-shell-container`,Ee=document.createElement(`template`),Ee.innerHTML=`
...
</div>`,De=class extends HTMLElement{#e=!1;get overlayMount(){return this.#t(),this.shadowRoot?.querySelector(`[data-shell-overlays]`)??null}constructor(){super(),this.#t()}connectedCallback(){this.#t()}#t(){if(this.#e&&this.shadowRoot)return;let e=this.shadowRoot??this.attachShadow({mode:`open`});if(e.querySelector(`.esc-stack`)||e.appendChild(Ee.content.cloneNode(!0)),e.adoptedStyleSheets.length===0){let t=new CSSStyleSheet;t.replaceSync(xe),e.adoptedStyleSheets=[t]}this.#e=!0}},Oe=!1})))()}function Ae(e){let t=`[${je}]`,n=e.querySelector(t);if(n)return n.style.zIndex||(n.style.zIndex=G),n.style.position||(n.style.position=Te(e)?`absolute`:`fixed`),n;let r=document.createElement(`div`);return r.setAttribute(je,``),r.className=`env-shell-overlays`,r.setAttribute(`data-part`,`env-overlays`),Te(e)?(r.slot=D.overlay,r.style.cssText=`position:absolute;inset:0;pointer-events:none;z-index:${G};box-sizing:border-box;`,e.appendChild(r),r):(r.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${G};box-sizing:border-box;`,e.appendChild(r),r)}var je,G;function Me(){return(Me=e((()=>{ke(),O(),je=`data-env-shell-overlays`,G=`2147483600`})))()}function Ne(){return(Ne=e((()=>{S()})))()}function Pe(e,t={}){let{x:n=48,y:r=48,w:i=640,h:a=480,z:o=10,demoRole:s}=t,c=matchMedia(`(max-width: 640px)`);return{demoRole:s,title:e,bounds:{x:M(n),y:M(r),w:M(i),h:M(a)},z:M(o),maximizedMobile:j(c.matches),minimized:j(!1),desktopMaximized:j(!1),nativeMode:j(!1),visible:j(!0),isMobileMq:c}}function Fe(){return(Fe=e((()=>{A(),Object.freeze({w:360,h:240})})))()}function K(e){let t=String(e??``).trim().toLowerCase();t=t.replace(/^#/,``);let n=/^todo:\s*(.*)$/i.exec(t);return n&&(t=String(n[1]??``).trim().toLowerCase()),t=t.replace(/\s+/g,``),t?t===`viewer`||Le.has(t)?q:t:``}function Ie(e){return String(e||``).trim().toLowerCase()===q}var q,Le;function Re(){return(Re=e((()=>{q=`viewer`,Le=new Set([`markdown`,`markdown-view`,`markdown-viewer`,`reader`,`env-viewer`])})))()}function ze(e){return!!(e&&typeof e==`object`&&typeof e.render==`function`)}function J(e,t){let n=e?.lifecycle?.[t];typeof n==`function`&&Promise.resolve(n())}function Be(e){if(typeof e!=`function`)return!1;try{let t=e.prototype;return!!(t!=null&&typeof HTMLElement<`u`&&HTMLElement.prototype.isPrototypeOf(t))}catch{return!1}}function Ve(e,t){let n=e.default??e.createView??e.createHomeView;if(!n||typeof n!=`function`)throw Error(`window-frame view-mount: module has no default/createView factory`);let r=Be(n)?new n(t):n(t);if(ze(r)){let e=r,n=e.render(t);if(!(n instanceof HTMLElement))throw Error(`window-frame view-mount: view.render() must return HTMLElement`);return{root:n,view:e}}if(r instanceof HTMLElement)return{root:r};throw Error(`window-frame view-mount: factory did not return View or HTMLElement`)}function He(e,t){return e.replaceChildren(t),()=>{t.remove(),e.replaceChildren()}}async function Ue(e,t,n){let r=await e();typeof requestAnimationFrame==`function`&&await new Promise(e=>requestAnimationFrame(()=>e()));let{root:i,view:a}=Ve(r,n);i.classList.add(`wf-mounted-view`);let o=He(t,i);return J(a,`onMount`),J(a,`onShow`),()=>{J(a,`onHide`),J(a,`onUnmount`),o()}}function We(){try{if(document.documentElement.dataset.cwspNativeShell===`capacitor`)return!0;let e=globalThis.Capacitor;return typeof e?.isNativePlatform==`function`&&!!e.isNativePlatform()}catch{return!1}}function Y(e){let t=e?.closest?.(`.env-shell-root`)??e?.closest?.(`env-shell-container`);if(!(t instanceof HTMLElement))return 0;if(qe?.shell===t)return qe.n;let n=t.style.getPropertyValue(`--env-window-z-boost`).trim()||getComputedStyle(t).getPropertyValue(`--env-window-z-boost`).trim(),r=Number.parseInt(n,10),i=Number.isFinite(r)?r:0;return qe={shell:t,n:i},i}function Ge(e){let t=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.querySelector?.(`.env-shell-root, env-shell-container`);return t instanceof HTMLElement?t:null}function X(e){let t=Ge(e);if(!t)return;let n=!!t.querySelector?.(`ui-window[native-mode], ui-window[data-native-active]`);t.toggleAttribute(`data-env-native-task`,n)}function Ke(e,t,n,r,i={}){let{bounds:a,z:o,maximizedMobile:s,minimized:c,desktopMaximized:l,visible:u,isMobileMq:d}=t;t.nativeMode||=j(!!i.startNative);let f=t.nativeMode;i.startNative&&(f.value=!0);let p=document.createElement(`ui-window`);p.setAttribute(`managed`,``),p.className=`env-ui-window`,p.setAttribute(`part`,`window`);{let e=document.documentElement.getAttribute(`data-theme`)||document.documentElement.style.colorScheme||``;(e===`light`||e===`dark`)&&(p.dataset.theme=e,p.style.colorScheme=e)}let m=document.createElement(`span`);m.slot=`title`,m.className=`env-ui-window__title`,m.textContent=t.title,n.slot=`content`,n.classList.add(`env-ui-window__body`),p.append(m,n),e.appendChild(p);let h=String(i?.managedViewKey??``).trim();h&&(p.setAttribute(`data-ui-window-view`,h),p.setAttribute(`data-wf-managed-view`,h));let g=null,_=()=>{i.onChromeChange?.(),X(e)},v=()=>{p.style.right=``,p.style.bottom=``},y=()=>{p.style.left=`0`,p.style.top=`0`,p.style.right=`0`,p.style.bottom=`var(--env-shell-chrome-stack-reserve, 2.5rem)`,p.style.width=`auto`,p.style.height=`auto`,p.style.removeProperty(`--ui-win-width`),p.style.removeProperty(`--ui-win-height`)},b=()=>{p.style.left=`0`,p.style.top=`0`,p.style.right=`0`,p.style.bottom=`0`,p.style.width=`100%`,p.style.height=`100%`,p.style.removeProperty(`--ui-win-width`),p.style.removeProperty(`--ui-win-height`)},x=()=>{let t=!!d.matches,n=Y(e),r=(o.value??10)+n;p.style.zIndex=String(r),t&&(l.value&&=!1,!c.value&&!f.value&&!s.value&&(s.value=!0));let i=!!f.value,m=!!c.value,h=!t&&!!l.value&&!i&&!m,g=t&&!i&&!m,_=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.querySelector?.(`.env-shell-root, env-shell-container`),x=_ instanceof HTMLElement&&_.hasAttribute(`data-status-overlay`)||document.documentElement.hasAttribute(`data-env-status-overlay`),S=_ instanceof HTMLElement&&_.hasAttribute(`data-standalone`)||document.documentElement.hasAttribute(`data-env-standalone`),C=x&&!i&&!m&&(g||h),w=We(),T=S&&t&&!i&&!m||w&&t&&!i&&!m;if(p.toggleAttribute(`native-mode`,i&&!m),p.toggleAttribute(`minimized`,m),p.toggleAttribute(`data-mobile-max`,g),p.toggleAttribute(`data-desk-max`,h),p.toggleAttribute(`data-status-gap`,C),p.toggleAttribute(`data-no-titlebar`,T),p.toggleAttribute(`maximized`,!m&&(h||g||i)),m){p.setVisible(!1),X(e);return}if(p.setVisible(!!u.value),!u.value){X(e);return}if(i){b(),X(e);return}if(g){p.style.left=`0`,p.style.top=`0`,p.style.right=`0`,p.style.bottom=`0`,p.style.width=`100%`,p.style.height=`auto`,X(e);return}if(h){y(),X(e);return}v(),p.applyBounds({x:a.x.value,y:a.y.value,w:a.w.value,h:a.h.value,z:r}),X(e)},S=()=>{d.matches&&(f.value||(s.value=!0),l.value&&(l.value=!1,g&&=(a.x.value=g.x,a.y.value=g.y,a.w.value=g.w,a.h.value=g.h,null))),x(),_()};d.matches&&!f.value&&!c.value&&(s.value=!0);let C=ee(()=>{x()},[a.x,a.y,a.w,a.h,o,s,c,l,f,u],{triggerImmediately:!0});d.addEventListener(`change`,S);let w=()=>{x(),_()},T=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.documentElement;T?.addEventListener?.(`env-chrome-surface`,w);let E=()=>{c.value&&(c.value=!1,u.value=!0),r();let t=Y(e),n=(o.value??10)+t;typeof p.bringToFront==`function`?p.bringToFront(n):(p.style.zIndex=String(n),p.toggleAttribute(`data-focused`,!0)),_()},D=e=>{let t=e.detail;f.value||l.value||s.value||c.value||(typeof t?.x==`number`&&(a.x.value=t.x),typeof t?.y==`number`&&(a.y.value=t.y))},O=e=>{let t=e.detail;f.value||l.value||s.value||c.value||(typeof t?.w==`number`&&(a.w.value=t.w),typeof t?.h==`number`&&(a.h.value=t.h))},k=()=>{f.value&&=!1,l.value&&(l.value=!1,g&&=(a.x.value=g.x,a.y.value=g.y,a.w.value=g.w,a.h.value=g.h,null)),c.value=!0,x(),_()},A=()=>{if(f.value){N();return}if(d.matches){c.value=!1,s.value=!0,x(),_();return}if(c.value&&=!1,l.value){P();return}g={x:a.x.value,y:a.y.value,w:a.w.value,h:a.h.value},l.value=!0,x(),_()},M=()=>{c.value&&(c.value=!1,u.value=!0),!f.value&&!l.value&&!s.value&&(g={x:a.x.value,y:a.y.value,w:a.w.value,h:a.h.value}),l.value=!1,s.value=!1,f.value=!0,x(),_()},N=()=>{f.value&&(f.value=!1,g&&=(a.x.value=g.x,a.y.value=g.y,a.w.value=g.w,a.h.value=g.h,null),d.matches&&(s.value=!0),x(),_())},P=()=>{if(f.value){N();return}c.value&&(c.value=!1,u.value=!0),d.matches?s.value&&=!1:l.value&&(l.value=!1,g&&=(a.x.value=g.x,a.y.value=g.y,a.w.value=g.w,a.h.value=g.h,null)),x(),_()},F=!1,I=!1,te=t=>{if(t.preventDefault(),!(F||I)){F=!0;try{f.value&&=!1,u.value=!1,i.onClose?.()}catch(e){console.error(`[mount-ui-window] onClose failed`,e)}finally{if(!I){I=!0,C?.(),d.removeEventListener(`change`,S),T?.removeEventListener?.(`env-chrome-surface`,w);try{p.isConnected&&p.remove()}catch{}}X(e)}}},ne=0,re=()=>{let e=typeof performance<`u`?performance.now():Date.now();return e-ne<280?!1:(ne=e,!0)},ie=e=>{if(!(F||I)&&re()){if(e===`close`){te(new Event(`window-close`,{cancelable:!0}));return}if(e===`exit-native`){N();return}if(e===`maximize`){f.value||l.value||s.value?P():A();return}c.value?P():k()}},ae=e=>{let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t){if(!(e instanceof Element))continue;let t=e.getAttribute?.(`data-ui-win-action`);if(t===`close`||t===`exit-native`||t===`maximize`||t===`minimize`)return t;if(e.matches?.(`.title-close`))return`close`;if(e.matches?.(`.title-exit-native`))return`exit-native`;if(e.matches?.(`.title-maximize`))return`maximize`;if(e.matches?.(`.title-minimize`))return`minimize`}return null},L=e=>{if(F||I||e.defaultPrevented)return;let t=ae(e);t&&(e.preventDefault(),e.stopPropagation(),ie(t))},R=null,z=()=>{let e=p.shadowRoot;if(!e||F||I)return;let t=e.querySelectorAll(`[data-ui-win-action], .title-minimize, .title-maximize, .title-close, .title-exit-native`);for(let e of t){let t=e.getAttribute(`data-ui-win-action`);if(t||(e.classList.contains(`title-close`)?t=`close`:e.classList.contains(`title-exit-native`)?t=`exit-native`:e.classList.contains(`title-maximize`)?t=`maximize`:e.classList.contains(`title-minimize`)&&(t=`minimize`)),!t)continue;e.setAttribute(`data-ui-win-action`,t);let n=t,r=e=>{e.defaultPrevented||(e.preventDefault(),e.stopPropagation(),ie(n))};e.onclick=r,e.onpointerup=e=>{e.button===0&&r(e)}}};if(z(),queueMicrotask(z),requestAnimationFrame(z),typeof MutationObserver<`u`){R=new MutationObserver(()=>z());let e=()=>{p.shadowRoot?R?.observe(p.shadowRoot,{childList:!0,subtree:!0}):requestAnimationFrame(e)};e()}return p.addEventListener(`window-focus`,E),p.addEventListener(`window-move`,D),p.addEventListener(`window-resize`,O),p.addEventListener(`window-minimize`,k),p.addEventListener(`window-maximize`,A),p.addEventListener(`window-restore`,P),p.addEventListener(`window-native`,M),p.addEventListener(`window-exit-native`,N),p.addEventListener(`window-close`,te),p.addEventListener(`click`,L),p.addEventListener(`pointerup`,L),()=>{if(!I){I=!0,F=!0,C?.(),R?.disconnect(),R=null,d.removeEventListener(`change`,S),T?.removeEventListener?.(`env-chrome-surface`,w),p.removeEventListener(`window-focus`,E),p.removeEventListener(`window-move`,D),p.removeEventListener(`window-resize`,O),p.removeEventListener(`window-minimize`,k),p.removeEventListener(`window-maximize`,A),p.removeEventListener(`window-restore`,P),p.removeEventListener(`window-native`,M),p.removeEventListener(`window-exit-native`,N),p.removeEventListener(`window-close`,te),p.removeEventListener(`click`,L),p.removeEventListener(`pointerup`,L);try{f.value&&=!1,p.isConnected&&p.remove()}catch{}X(e)}}}var qe;function Je(){return(Je=e((()=>{A(),le(),qe=null})))()}function Z(e,t){let n=typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(t):t.replace(/\\/g,`\\\\`).replace(/"/g,`\\"`),r=e.querySelector(`:scope > ui-window[data-ui-window-view="${n}"]`)||e.querySelector(`:scope > ui-window[data-wf-managed-view="${n}"]`)||e.querySelector(`:scope > section.wf-frame[data-wf-managed-view="${n}"]`);return r instanceof HTMLElement?r:null}function Ye(e){let t=String(e||``).trim();if(!t)return`browser`;let n=2166136261;for(let e=0;e<t.length;e++)n^=t.charCodeAt(e),n=Math.imul(n,16777619);return`browser:${(n>>>0).toString(36)}`}function Xe(e){try{return new URL(e).hostname.replace(/^www\./i,``)||`Browser`}catch{return`Browser`}}function Ze(e){let t=String(e||``).trim().toLowerCase();return t===`browser`||t===`web`||t===`iframe`||t===`web-view`||t===`webview`?`browser`:t}function Qe(e){let t=String(e||``).trim().toLowerCase();return rt[t]?rt[t]:t.startsWith(`browser:`)?rt.browser:`app-window`}function $e(e){return Ze(e)===`browser`?()=>l(()=>import(`./browser-view-DhO2i9yb.js`),[],import.meta.url):null}function et(e){if(!e||typeof e!=`object`)return``;let t=e,n=t.params&&typeof t.params==`object`&&!Array.isArray(t.params)?t.params:{};return String(n.url||n.href||n.src||t.url||t.href||t.src||``).trim()}function Q(e,t){let n=K(e)||String(e||``).trim().toLowerCase(),r=n.startsWith(`browser:`)?`browser`:n;if(t?.[n])return t[n];if(t?.[r])return t[r];if(it[r])return it[r];let i=String(e||``).trim();return i?i.charAt(0).toUpperCase()+i.slice(1):`View`}function tt(e,t){let n=document.createElement(`div`);return n.className=`wf-view-placeholder`,n.setAttribute(`part`,`placeholder`),n.innerHTML=`<p class="wf-view-placeholder__title">${Q(e,t)}</p>
<p class="wf-view-placeholder__hint">No window module is registered for this shortcut in environment-shell yet.</p>`,n}function nt(e,t={}){let n=g(120),r=new Map,i=!1,a=null;Y(e);let o=0,s=()=>{i||(o||=requestAnimationFrame(()=>{o=0,i||t.onTaskingChange?.(c())}))},c=()=>{let n=[];for(let i of r.values())Z(e,i.key)&&n.push({id:i.key,title:i.model.title||Q(i.key,t.viewTitles),icon:Qe(i.key),focused:a===i.key,minimized:!!i.model.minimized.value,visible:!!i.model.visible.value});return n},l=()=>{for(let t of r.values()){let n=Z(e,t.key);if(!n)continue;n.toggleAttribute(`data-focused`,!1);let r=n.clearFocused;typeof r==`function`&&r.call(n)}},u=e=>{for(let[t,n]of r)e&&t===e||n.model.nativeMode?.value&&(n.model.nativeMode.value=!1)},d=(t,r)=>{if(a===r&&!t.minimized.value){let t=Z(e,r);if(t&&t===e.lastElementChild)return}n.value+=1,t.z.value=n.value,t.minimized.value=!1,t.visible.value=!0,a=r,t.nativeMode?.value&&u(r);let i=Z(e,r);if(i){let n=Y(e),r=(t.z.value??10)+n;l(),i.style.zIndex=String(r),i.toggleAttribute(`data-focused`,!0);let a=i.bringToFront;typeof a==`function`&&a.call(i,r),i.parentElement===e&&i!==e.lastElementChild&&e.appendChild(i)}s()},f={},p=t.overlayMountHost?Ae(t.overlayMountHost):null;f.resolveOverlayMountPoint=e=>{if(p)return p;if(t.environmentShellHost){let e=T(t.environmentShellHost);if(e)return e}return w(e??null)};let m=e=>{let n=Ze(K(e)||String(e||``).trim().toLowerCase());return t.viewLoaders?.[n]||$e(n)},h=()=>{let i=t.readerWindow;if(!i?.content)return;let o=q,c=r.get(o);if(c&&Z(e,o)){d(c.model,o);return}if(c&&!Z(e,o)){r.delete(o);try{c.disposeFrame()}catch{}}let l=i.seed||{},u=Pe(i.title||Q(o,t.viewTitles),{x:l.x??96,y:l.y??96,w:l.w??420,h:l.h??340,z:l.z??n.value+1});n.value=u.z.value;let f=()=>{};f=Ke(e,u,i.content,()=>d(u,o),{managedViewKey:o,onChromeChange:s,onClose:()=>{let e=r.get(o);if(e){r.delete(o),a===o&&(a=null);try{e.disposeFrame()}catch{}s()}}}),r.set(o,{key:o,model:u,disposeFrame:f}),d(u,o)},_=(o,c)=>{if(i)return;let l=K(String(o||``).trim());if(l=Ze(l),!l||l===`home`||l===`airpad`)return;let p={...c?.params||{}},g=et(c);g&&(p.url=g,p.href=g);let _=l===`browser`?String(p.windowKey||``).trim()||Ye(g):l;if(Ie(l)&&t.readerWindow?.content){h();return}let v=new Set((t.startNativeViewIds||[]).map(e=>K(String(e||``)))).has(l)||String(c?.native||``)===`1`||String(p.native||``)===`1`,y=r.get(_);if(y&&Z(e,_)){if(d(y.model,_),v&&y.model.nativeMode&&(y.model.nativeMode.value=!0,y.model.minimized.value=!1,y.model.visible.value=!0,u(_)),l===`browser`&&g)try{let t=Z(e,_),n=t?.querySelector?.(`iframe.wf-browser__frame`),r=t?.querySelector?.(`input.wf-browser__url`);if(n&&n.src!==g&&(n.src=g),r&&(r.value=g),g)try{y.model.title=Xe(g)}catch{}}catch{}return}if(y&&!Z(e,_)){y.disposeView?.(),r.delete(_);try{y.disposeFrame()}catch{}}let b=m(l),x=document.createElement(`div`);x.className=`wf-view-host env-ui-window__view-host`,x.setAttribute(`part`,`view-host`);{let e=document.createElement(`p`);e.className=`wf-view-placeholder__hint`,e.style.cssText=`margin:1rem;font:400 .9rem/1.4 system-ui,sans-serif;opacity:.8`,e.textContent=`Loading ${Q(l,t.viewTitles)}…`,x.append(e)}let S=r.size*24,C=Pe(l===`browser`&&g?Xe(g):Q(l,t.viewTitles),{x:72+S,y:72+S,w:l===`browser`?720:640,h:l===`browser`?520:480,z:n.value+1});n.value=C.z.value;let w=()=>{};w=Ke(e,C,x,()=>d(C,_),{managedViewKey:_,startNative:v,onChromeChange:s,onClose:()=>{let e=r.get(_);if(e){r.delete(_),a===_&&(a=null);try{e.disposeView?.()}catch{}try{e.disposeFrame()}catch{}s()}}}),v&&(C.nativeMode.value=!0,u(_));let T={key:_,model:C,disposeFrame:w,disposeView:void 0};r.set(_,T),d(C,_);let E={...c||{},shellContext:f};if((l===`browser`&&g||g&&!(E.params&&(E.params.url||E.params.href)))&&(E.params={...E.params||{},url:g,href:g}),!b){x.replaceChildren(tt(l,t.viewTitles));return}Ue(b,x,E).then(e=>{if(i){e();return}let t=r.get(_);t&&(t.disposeView=e),(v||C.nativeMode?.value)&&(C.nativeMode.value=!0,C.minimized.value=!1,C.visible.value=!0,u(_),d(C,_))},e=>{console.error(`[workspace-window-layer] mountViewModule failed for view "${l}"`,e),x.replaceChildren(tt(l,t.viewTitles))})};return f.navigate=(e,t)=>{_(String(e),t)},f.openView=(e,t)=>{_(String(e),t)},{shellContext:f,dispose:()=>{if(!i){i=!0,o&&=(cancelAnimationFrame(o),0);for(let e of r.values())e.disposeView?.(),e.disposeFrame();r.clear(),a=null,s()}},focusWindow:t=>{let n=K(String(t||``)),i=r.get(n);return!i||!Z(e,n)?!1:(d(i.model,n),!0)},minimizeWindow:t=>{let n=K(String(t||``)),i=r.get(n);return!i||!Z(e,n)?!1:(i.model.nativeMode?.value&&(i.model.nativeMode.value=!1),i.model.desktopMaximized?.value&&(i.model.desktopMaximized.value=!1),i.model.visible.value=!0,i.model.minimized.value=!0,a===n&&(a=null,l()),s(),!0)},minimizeAllWindows:()=>{if(!i){u(null),a=null,l();for(let t of r.values())Z(e,t.key)&&(t.model.desktopMaximized?.value&&(t.model.desktopMaximized.value=!1),t.model.visible.value=!0,t.model.minimized.value=!0);s()}},closeWindow:e=>{let t=K(String(e||``)),n=r.get(t);if(!n)return!1;r.delete(t),a===t&&(a=null);try{n.disposeView?.()}catch{}try{n.disposeFrame()}catch{}return s(),!0},blurWindows:()=>{u(null),a=null,l(),s()},closeAllWindows:()=>{if(!i){u(null);for(let e of[...r.values()]){try{e.disposeView?.()}catch{}try{e.disposeFrame()}catch{}}r.clear(),a=null,s()}},enterNative:t=>{let n=K(String(t||``)),i=r.get(n);return!i||!Z(e,n)?!1:(u(n),i.model.nativeMode.value=!0,i.model.minimized.value=!1,i.model.visible.value=!0,d(i.model,n),!0)},exitNative:e=>{if(e){let t=K(String(e||``)),n=r.get(t);n?.model.nativeMode&&(n.model.nativeMode.value=!1),s();return}u(null),s()},listWindowTasks:c,getFocusedKey:()=>a}}var rt,it;function at(){return(at=e((()=>{h(),O(),Fe(),Re(),Me(),Je(),c(),rt={home:`house`,viewer:`article`,markdown:`article`,browser:`globe`,web:`globe`,explorer:`books`,settings:`gear-six`,apps:`squares-four`,workcenter:`briefcase`,history:`clock-counter-clockwise`,editor:`pencil-simple-line`,network:`wifi-high`,task:`list-checks`,event:`calendar`,bonus:`gift`,person:`address-book`},it={home:`Home`,viewer:`Markdown`,browser:`Browser`,web:`Browser`,explorer:`Explorer`,settings:`Settings`,apps:`Apps`,workcenter:`Work Center`,history:`History`,editor:`Editor`,network:`Network`,task:`Plan`,event:`Events`,bonus:`Bonuses`,person:`Contacts`}})))()}function ot(e,t=ct){try{localStorage.getItem(t)||localStorage.setItem(t,e)}catch{}}function st(e,t){let n=ce(),r=ue();r&&ve();let i,a;if(r)i=document.createElement(`ui-statusbar`),i.className=`env-ui-statusbar`,i.hidden=!0,a=()=>{i.remove()};else{let e=oe(t.shell,t.introHtml,n);i=e.element,a=e.dispose}let o=document.createElement(`div`);o.className=`env-shell-chrome wf-chrome-no-select`;let s;if(t.taskbar){try{let e=ie();e&&z(e)}catch{}s=se({...t.taskbar,device:n}),o.append(s.element,i)}else o.append(i);let c=(e.classList?.contains(`env-shell-root`)?e:null)||e.closest?.(`.env-shell-root`)||e.closest?.(`env-shell-container`)||e;fe(c),globalThis.__ENV_OVERLAY_MOUNT__=Ae,Ae(c),ne();let l=typeof matchMedia==`function`?matchMedia(`(min-width: 641px) and (not ((pointer: coarse) or (hover: none)))`):null,u=typeof matchMedia==`function`?[`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`,`(display-mode: window-controls-overlay)`].map(e=>matchMedia(e)):[],d=()=>{let e=!l||l.matches,t=te(),n=I(),r=L({desktop:e,standalone:n,displayMode:t});o.toggleAttribute(`data-desktop`,e),o.toggleAttribute(`data-standalone`,n),o.toggleAttribute(`data-status-overlay`,r),o.dataset.chromeLayout=e?`desktop`:`mobile`,o.dataset.displayMode=t,c.toggleAttribute(`data-standalone`,n),c.toggleAttribute(`data-status-overlay`,r),c.dataset.displayMode=t,c.style.setProperty(`--env-status-inset-top`,r?`max(2rem, env(safe-area-inset-top, 0px))`:`0px`),document.documentElement.toggleAttribute(`data-env-status-overlay`,r),document.documentElement.toggleAttribute(`data-env-standalone`,n);try{c.dispatchEvent(new CustomEvent(`env-chrome-surface`,{bubbles:!0,detail:{statusOverlay:r,standalone:n,displayMode:t,desktop:e}}))}catch{}};d(),l?.addEventListener?.(`change`,d);for(let e of u)e.addEventListener?.(`change`,d);document.addEventListener(`fullscreenchange`,d),document.addEventListener(`webkitfullscreenchange`,d);let f=r?()=>{}:F(c);return Te(e)&&(o.slot=D.overlay),e.appendChild(o),{root:o,device:n,statusBar:i,taskbar:s,disposeDevice:()=>{l?.removeEventListener?.(`change`,d);for(let e of u)e.removeEventListener?.(`change`,d);document.removeEventListener(`fullscreenchange`,d),document.removeEventListener(`webkitfullscreenchange`,d),f(),a(),n.dispose(),fe(null)}}}var ct;function lt(){return(lt=e((()=>{ae(),be(),R(),P(),ke(),Me(),O(),de(),N(),re(),Ne(),at(),Je(),ct=`rs-wallpaper-image`})))()}function ut(e){ft().set(e)}function dt(){let e=ft().get();if(typeof e?.focusSpeedDial==`function`){e.focusSpeedDial();return}let t=document.querySelector(`#home`);if(t)try{t.focus({preventScroll:!0})}catch{try{t.focus()}catch{}}}var $,ft;function pt(){return(pt=e((()=>{$=`__CWSP_LAUNCHER_HOME_HOOKS_V1__`,ft=()=>{let e=globalThis;return{get:()=>$ in e?e[$]:null,set:t=>{e[$]=t}}}})))()}var mt;function ht(){return(ht=e((()=>{mt=`*,
*::before,
*::after {
    box-sizing: border-box;
}
...
`})))()}var gt;function _t(){return(_t=e((()=>{gt=`/* environment-shell — default layout + chrome for wallpaper / home / window-frame hosts.
...
}`})))()}function vt(){try{if(document.documentElement.dataset.cwspNativeShell===`capacitor`)return!0;let e=globalThis.Capacitor;return typeof e?.isNativePlatform==`function`&&!!e.isNativePlatform()}catch{return!1}}function yt(){try{let e=new URLSearchParams(globalThis.location?.search||``);if(e.get(`native`)!==`1`&&e.get(`native`)!==`true`)return[];let t=(e.get(`view`)||``).trim().toLowerCase(),n=String(globalThis.location?.pathname||``).replace(/^\/+|\/+$/g,``).toLowerCase(),r=n.match(/^(cwsp|markdown|kvm)\/(.+)$/);r?.[2]&&(n=r[2]);let i=n.split(`/`)[0]||``,a=((i&&i!==`home`?i:t)||`explorer`).split(`/`)[0]||`explorer`;return!a||a===`home`?[`explorer`]:[a===`markdown`?`viewer`:a]}catch{return[]}}function bt(e){let t=e||{};return t.native===1||t.native===`1`||t.native===!0||t.params?.native===`1`||t.params?.native===`true`}function xt(e,t){if(!yt().includes(e)&&!bt(t))return t||{};let n={...t||{}};return n.native=`1`,n.params={...n.params||{},native:`1`},n}async function St(){try{let e=await l(()=>import(`./launcher-state-DEXvEx9Y.js`).then(e=>(e.d(),e.p)),[],import.meta.url),t=e.speedDialItems;if(!t||typeof t.findIndex!=`function`)return;let n=!1;for(let e=t.length-1;e>=0;e--){let r=t[e],i=String(r?.meta?.view||``).toLowerCase(),a=String(r?.id||``).toLowerCase();(i===`airpad`||a.includes(`airpad`))&&(t.splice(e,1),n=!0)}n&&e.persistSpeedDialItems?.()}catch(e){console.warn(`[EnvironmentShell] speed-dial seed skipped`,e)}}function Ct(e){return new Et}var wt,Tt,Et;function Dt(){return(Dt=e((()=>{h(),r(),y(),S(),m(),E(),O(),i(),s(),lt(),pt(),ht(),_t(),c(),Ce(),wt={network:()=>l(()=>import(`./src-CatWxJuF.js`),[],import.meta.url),settings:()=>l(()=>import(`./src-D02iHrGW.js`),[],import.meta.url),explorer:()=>l(()=>import(`./_cwsp-disabled-entry_view-explorer-CgPWJ5lY.js`),[],import.meta.url),viewer:()=>l(()=>import(`./_cwsp-disabled-entry_view-viewer-D_Fv3iM1.js`),[],import.meta.url),markdown:()=>l(()=>import(`./_cwsp-disabled-entry_view-viewer-D_Fv3iM1.js`),[],import.meta.url),history:()=>l(()=>import(`./src-Dxi__oVH.js`),[],import.meta.url),workcenter:()=>l(()=>import(`./_cwsp-disabled-entry_view-workcenter-wO1gmAI3.js`),[],import.meta.url),editor:()=>l(()=>import(`./_cwsp-disabled-entry_view-editor-072I_-zB.js`),[],import.meta.url),home:()=>l(()=>import(`./_cwsp-disabled-entry_view-home-DFq7GfDB.js`),[],import.meta.url)},Tt=[`home`,`network`,`settings`,`explorer`,`viewer`,`history`,`workcenter`,`editor`],Et=class extends k{id=`environment`;name=`Environment`;layout={hasSidebar:!1,hasToolbar:!1,hasTabs:!1,supportsMultiView:!0,supportsWindowing:!0};workspaceEl=null;homeMountEl=null;windowLayer=null;chromeDispose=null;wallpaperLifecycleDispose=null;homeUnmount=null;shellActivityDispose=null;focusedTaskId=_(`home`);setFocusedTaskId=null;syncWindowTasks=null;navEcho=_(``);mqLabel=_(`desktop`);_monoNativeBoot=!1;_pendingHomeMount=null;createLayout(){return document.createElement(`div`)}getStylesheet(){return gt}async mount(e){if(this.mounted){console.warn(`[${this.id}] Shell already mounted`);return}this.container=e,ot(`/assets/wallpaper.jpg`),Ce();try{await t(mt),n(mt)}catch(e){console.warn(`[EnvironmentShell] wf-demo tokens failed`,e)}let r=this.getStylesheet();if(r)try{await t(r),n(r)}catch(e){console.warn(`[EnvironmentShell] env shell styles failed`,e)}try{v()}catch{}try{document.documentElement.dataset.cwspSurface=`environment`}catch{}let i=we();i.className=`env-shell-root wf-demo-root`,i.setAttribute(`data-shell`,`environment`),i.setAttribute(`data-shell-system`,`task-tab`),i.style.gridColumn=`content-column`,i.style.gridRow=`content-row`,i.style.alignSelf=`stretch`,i.style.justifySelf=`stretch`,i.style.minInlineSize=`0`,i.style.minBlockSize=`0`,i.style.inlineSize=`100%`,i.style.blockSize=`100%`,i.style.pointerEvents=`auto`;let s=document.createElement(`div`);s.slot=D.underlying,s.className=`env-shell-wallpaper`,s.setAttribute(`data-env-wallpaper`,``);let c=document.createElement(`div`);c.className=`env-shell-workspace`,c.setAttribute(`data-shell-content`,``);let l=document.createElement(`div`);l.className=`env-shell-home-mount`,l.style.display=`flex`,l.style.flex=`1 1 auto`,l.style.flexDirection=`column`,l.style.alignSelf=`stretch`,l.style.minHeight=`0`,l.style.minWidth=`0`,c.appendChild(l),i.append(s,c),e.replaceChildren(i),this.rootElement=i,this.workspaceEl=c,this.homeMountEl=l,this.contentContainer=c,this.overlayContainer=i.overlayMount??i.shadowRoot?.querySelector?.(`[data-shell-overlays]`)??null,this.mounted=!0,this.shellActivityDispose=o(this.id);let u=vt();u&&(i.dataset.capacitorNative=``,document.documentElement.dataset.cwspNativeShell=document.documentElement.dataset.cwspNativeShell||`capacitor`);try{x(),u&&ot(`/assets/wallpaper.jpg`),C(s);let e=()=>{if(document.visibilityState===`visible`)try{b()}catch{}};window.addEventListener(`pageshow`,e),document.addEventListener(`visibilitychange`,e),this.wallpaperLifecycleDispose=()=>{window.removeEventListener(`pageshow`,e),document.removeEventListener(`visibilitychange`,e)}}catch(e){console.warn(`[EnvironmentShell] wallpaper init failed`,e)}let d={};for(let e of Tt){if(e===`home`||!a(e)&&e!==`viewer`)continue;let t=wt[e];t&&(d[e]=t)}d.viewer&&(d.markdown=d.viewer);let m=matchMedia(`(max-width: 640px)`);this.mqLabel.value=m.matches?`mobile`:`desktop`,m.addEventListener(`change`,()=>{this.mqLabel.value=m.matches?`mobile`:`desktop`});let h=st(i,{shell:{selectedPath:_(``),viewerStatus:_(``),navEcho:this.navEcho,mqLabel:this.mqLabel},introHtml:`<p><strong>CWSP environment</strong> — Speed Dial / desktop launcher. Views open in <code>ui-window</code>.</p>`,taskbar:{focusedTaskId:this.focusedTaskId,onHome:()=>this.focusHome(),onViewer:()=>{this.openInWindow(`viewer`)},onWindowTask:e=>{this.openInWindow(e)},onMinimizeWindow:e=>{let t=String(e||``).trim().toLowerCase();t&&this.windowLayer?.minimizeWindow?.(t)&&(this.setFocusedTaskId?.(`home`),this.focusedTaskId.value=`home`)},onCloseWindow:e=>{let t=String(e||``).trim().toLowerCase();t&&(this.windowLayer?.closeWindow?.(t),String(this.focusedTaskId.value||``)===t&&(this.setFocusedTaskId?.(`home`),this.focusedTaskId.value=`home`))}}});this.setFocusedTaskId=h.taskbar?.setFocusedTaskId??null,this.syncWindowTasks=h.taskbar?.syncWindowTasks??null,(document.documentElement.dataset.cwspShellRole===`launcher`||globalThis.__RS_SHELL_ROLE__===`launcher`)&&ut({navigateHome:()=>this.focusHome(),openAppMenu:()=>h.taskbar?.openAppMenu?.(),openAppMenuPage:()=>h.taskbar?.openAppMenuPage?.()??h.taskbar?.appMenu?.openPage?.(),closeAppMenu:()=>h.taskbar?.appMenu?.close(),isAppMenuOpen:()=>!!h.taskbar?.appMenu?.isOpen(),focusSpeedDial:()=>dt(),tryConsumeBack:()=>f()?p()!=null:h.taskbar?.isSwitcherOpen?.()?(h.taskbar.closeSwitcher?.(),!0):!1}),this.chromeDispose=()=>{h.disposeDevice(),h.taskbar?.dispose?.(),h.root.remove()};let g=yt();this.windowLayer=nt(c,{overlayMountHost:i,environmentShellHost:i,viewLoaders:d,startNativeViewIds:g,viewTitles:{network:`Network`,settings:`Settings`,explorer:`Explorer`,viewer:`Markdown`,browser:`Browser`,history:`History`,workcenter:`Work Center`,editor:`Editor`},onTaskingChange:e=>{this.syncWindowTasks?.(e);let t=e.find(e=>e.focused);t&&this.setFocusedTaskId?.(t.id)}});let y={...this.windowLayer.shellContext,navigate:(e,t)=>{this.navEcho.value=`shell.navigate("${e}")`,this.routeView(String(e),t)},openView:(e,t)=>{this.navEcho.value=`shell.openView("${e}")`,this.routeView(String(e),t)},showMessage:e=>{this.showMessage(typeof e==`string`?e:String(e??``))}};if(St(),g.length>0){for(let e of g)this.openInWindow(e,{native:`1`,params:{native:`1`}});this._monoNativeBoot=!0,this._pendingHomeMount={homeMount:l,shellContext:{shellContext:y}}}else this.mountHomeDesktop(l,y)}mountHomeDesktop(e,t){Ue(()=>l(()=>import(`./_cwsp-disabled-entry_view-home-DFq7GfDB.js`),[],import.meta.url),e,{shellContext:t}).then(e=>{this.homeUnmount=e}).catch(t=>{console.warn(`[EnvironmentShell] home-view failed`,t),e.innerHTML=`<p style="color:#eee;padding:1rem;font-family:system-ui">Home view failed to load.</p>`})}ensureHomeMounted(){let e=this._pendingHomeMount;!e||this.homeUnmount||(this._pendingHomeMount=null,this._monoNativeBoot=!1,this.mountHomeDesktop(e.homeMount,e.shellContext.shellContext))}syncLauncherHomeAddressBar(){if(!(typeof location>`u`||typeof history>`u`))try{let e=new URLSearchParams(location.search||``);e.set(`shell`,this.id),e.delete(`native`),e.delete(`view`);let t=e.toString()?`?${e.toString()}`:``,n=location.pathname||`/`,r=n.replace(/^\/+|\/+$/g,``).split(`/`)[0]?.toLowerCase()||``;new Set([`settings`,`explorer`,`viewer`,`markdown`,`network`,`history`,`workcenter`,`editor`]).has(r)&&(n=`/`);let i=`${n}${t}`;`${location.pathname}${location.search}`!==i&&history.replaceState({viewId:`home`,params:Object.fromEntries(e)},``,i)}catch{}}focusHome(){if(this.ensureHomeMounted(),typeof this.windowLayer?.minimizeAllWindows==`function`)this.windowLayer.minimizeAllWindows();else{for(let e of this.windowLayer?.listWindowTasks?.()??[])this.windowLayer?.minimizeWindow?.(e.id);this.windowLayer?.blurWindows?.()}this.setFocusedTaskId?.(`home`),this.focusedTaskId.value=`home`,this.currentView.value=`home`,this.syncLauncherHomeAddressBar();try{b()}catch{}}openInWindow(e,t){let n=String(e||``).trim().toLowerCase();if(!n||n===`airpad`)return;let r=xt(n,t);if(n===`browser`||n===`web`||n===`iframe`||n===`webview`?this.windowLayer?.shellContext.openView?.(n,r):this.windowLayer?.focusWindow(n)||this.windowLayer?.shellContext.openView?.(n,r),bt(r)){let e=()=>{this.windowLayer?.enterNative?.(n),this.preserveNativeDeepLink(n)};e(),requestAnimationFrame(e),setTimeout(e,0)}this.setFocusedTaskId?.(n===`markdown`?`viewer`:n),this.currentView.value=n}preserveNativeDeepLink(e){if(!(typeof location>`u`||typeof history>`u`))try{let t=String(e||``).trim().toLowerCase();if(!t||t===`home`)return;let n=new URLSearchParams(location.search||``);n.set(`shell`,this.id),n.set(`native`,`1`),n.set(`view`,t);let r=`${`/${t}`}?${n.toString()}`;`${location.pathname}${location.search}${location.hash||``}`!==r&&history.replaceState({viewId:t,params:Object.fromEntries(n)},``,r)}catch{}}async routeView(e,t){let n=String(e||``).trim().toLowerCase();if(!(!n||n===`airpad`)){if(n===`home`){this.focusHome();return}this.openInWindow(n,t)}}async navigate(e,t,n){let r=String(e||`home`).toLowerCase();if(r===`airpad`){this.showMessage(`AirPad view is disabled in environment shell`);return}if(r===`home`){let e=yt();if(e.length){for(let n of e)this.openInWindow(n,{native:`1`,params:{native:`1`,...t||{}}});return}this.focusHome();return}let i={};try{i=Object.fromEntries(new URLSearchParams(location.search||``))}catch{i={}}let a={...i,...t||{}},o={params:a};(a.native===`1`||a.native===`true`||yt().includes(r))&&(o.native=`1`,o.params={...a,native:`1`}),this.openInWindow(r,o)}unmount(){try{this.homeUnmount?.()}catch{}this.homeUnmount=null;try{this.windowLayer?.dispose()}catch{}this.windowLayer=null;try{this.chromeDispose?.()}catch{}this.chromeDispose=null;try{this.shellActivityDispose?.()}catch{}this.shellActivityDispose=null;try{this.wallpaperLifecycleDispose?.()}catch{}if(this.wallpaperLifecycleDispose=null,(document.documentElement.dataset.cwspShellRole===`launcher`||globalThis.__RS_SHELL_ROLE__===`launcher`)&&ut(null),this.mounted&&this.container&&this.rootElement)try{this.container.contains(this.rootElement)&&this.rootElement.remove()}catch{}this.rootElement=null,this.contentContainer=null,this.overlayContainer=null,this.workspaceEl=null,this.homeMountEl=null,this.container=null,this.mounted=!1}}})))()}export{Ct as n,Dt as r,Et as t};