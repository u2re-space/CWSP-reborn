import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{Et as t,Gt as n,Ht as r,Ut as i,gt as a,ht as o,in as s,rn as c,t as l}from"./src-C8p-yYHh.js";import{_ as u,d,g as f,u as p}from"./registry-1BhElAAe.js";import{n as m,t as h}from"./preload-helper-DFTwEg7x.js";import{a as g,t as _}from"./cws-bridge-BDddm-Gk.js";import{a as v,o as y,r as b,t as x}from"./image-d0hFG0A5.js";import{o as S,s as C}from"./icon-CJpUOiBC.js";import{_ as w,g as T,n as ee,t as te,v as ne,y as E}from"./shells-DieeNVSZ.js";import{G as D,K as re,W as O,q as k}from"./launcher-state-BoDlEt5b.js";import{_ as A,a as j,b as M,c as N,d as P,f as F,g as ie,h as ae,i as oe,l as I,m as L,n as R,o as se,p as ce,r as le,s as ue,t as de,u as fe,v as pe,x as me,y as he}from"./src-6xuhKCXd.js";function ge(){if(typeof document>`u`||!document.body)return{top:0,bottom:0};let e=document.createElement(`div`);e.style.cssText=`position:fixed;top:0;left:0;padding-top:env(safe-area-inset-top);padding-bottom:env(safe-area-inset-bottom);visibility:hidden;pointer-events:none;`,document.body.appendChild(e);let t=getComputedStyle(e),n=Number.parseFloat(t.paddingTop)||0,r=Number.parseFloat(t.paddingBottom)||0;return e.remove(),{top:n,bottom:r}}function _e(){try{if(!/android/i.test(navigator.userAgent))return 0}catch{return 0}return 28}function ve(e,t){V=Math.max(0,Math.round(e)),H=Math.max(0,Math.round(t));let n=`${V}px`,r=`${H}px`;document.documentElement.style.setProperty(z,n),document.documentElement.style.setProperty(B,r),document.documentElement.toggleAttribute(`data-capacitor-native`,!0);for(let e of document.querySelectorAll(`.env-shell-root, env-shell-container`))e instanceof HTMLElement&&(e.style.setProperty(z,n),e.style.setProperty(B,r),e.toggleAttribute(`data-capacitor-native`,!0))}function ye(){if(V<=0&&H<=0)return;let e=`${V}px`,t=`${H}px`;for(let n of document.querySelectorAll(`.env-shell-root, env-shell-container`))n instanceof HTMLElement&&n.style.getPropertyValue(z)!==e&&(n.style.setProperty(z,e),n.style.setProperty(B,t),n.toggleAttribute(`data-capacitor-native`,!0))}async function be(){let e=0;try{let t=await _.getShellInfo();e=Number(t.statusBarHeightCss)||0}catch{}let t=ge();return e=Math.max(e,t.top),e<=0&&(e=_e()),{top:e,bottom:0}}async function xe(){if(!F())return;if(Se){ye();return}Se=!0;let e=async()=>{let{top:e,bottom:t}=await be();ve(e,t)};await e(),window.addEventListener(`resize`,()=>void e()),window.visualViewport?.addEventListener(`resize`,()=>void e()),document.addEventListener(`orientationchange`,()=>void e()),ye(),globalThis.setTimeout?.(ye,400)}var z,B,V,H,Se;function Ce(){return(Ce=e((()=>{g(),P(),z=`--env-native-safe-top`,B=`--env-native-safe-bottom`,V=0,H=0,Se=!1})))()}var we;function Te(){return(Te=e((()=>{we=`/**
...
}`})))()}function yt(){try{if(document.documentElement.dataset.cwspNativeShell===`capacitor`)return!0;let e=globalThis.Capacitor;return typeof e?.isNativePlatform==`function`&&!!e.isNativePlatform()}catch{return!1}}function bt(){try{let e=new URLSearchParams(globalThis.location?.search||``);if(e.get(`native`)!==`1`&&e.get(`native`)!==`true`)return[];let t=(e.get(`view`)||``).trim().toLowerCase(),n=String(globalThis.location?.pathname||``).replace(/^\/+|\/+$/g,``).toLowerCase(),r=n.match(/^(cwsp|markdown|kvm)\/(.+)$/);r?.[2]&&(n=r[2]);let i=n.split(`/`)[0]||``,a=((i&&i!==`home`?i:t)||`explorer`).split(`/`)[0]||`explorer`;return!a||a===`home`?[`explorer`]:[a===`markdown`?`viewer`:a]}catch{return[]}}function xt(e){let t=e||{};return t.native===1||t.native===`1`||t.native===!0||t.params?.native===`1`||t.params?.native===`true`}function St(e,t){if(!bt().includes(e)&&!xt(t))return t||{};let n={...t||{}};return n.native=`1`,n.params={...n.params||{},native:`1`},n}async function Ct(){try{let e=await h(()=>import(`./launcher-state-BoDlEt5b.js`).then(e=>(e.d(),e.p)),[],import.meta.url),t=e.speedDialItems;if(!t||typeof t.findIndex!=`function`)return;let n=!1;for(let e=t.length-1;e>=0;e--){let r=t[e],i=String(r?.meta?.view||``).toLowerCase(),a=String(r?.id||``).toLowerCase();(i===`airpad`||a.includes(`airpad`))&&(t.splice(e,1),n=!0)}n&&e.persistSpeedDialItems?.()}catch(e){console.warn(`[EnvironmentShell] speed-dial seed skipped`,e)}}function wt(e){return new Dt}var Tt,Et,Dt;function Ot(){return(Ot=e((()=>{n(),t(),C(),v(),l(),ee(),w(),u(),p(),ut(),mt(),gt(),vt(),m(),Ee(),Tt={network:()=>h(()=>import(`./src-Dqu6PxMy.js`),[],import.meta.url),settings:()=>h(()=>import(`./src-CbOgZi7F.js`),[],import.meta.url),explorer:()=>h(()=>import(`./_cwsp-disabled-entry_view-explorer-CUvWHUlh.js`),[],import.meta.url),viewer:()=>h(()=>import(`./_cwsp-disabled-entry_view-viewer-eo9jCha0.js`),[],import.meta.url),markdown:()=>h(()=>import(`./_cwsp-disabled-entry_view-viewer-eo9jCha0.js`),[],import.meta.url),history:()=>h(()=>import(`./src-B5ce-S8I.js`),[],import.meta.url),workcenter:()=>h(()=>import(`./_cwsp-disabled-entry_view-workcenter-Dzgnpgn9.js`),[],import.meta.url),editor:()=>h(()=>import(`./_cwsp-disabled-entry_view-editor-fs8j1brL.js`),[],import.meta.url),home:()=>h(()=>import(`./_cwsp-disabled-entry_view-home-DPCToH21.js`),[],import.meta.url)},Et=[`home`,`network`,`settings`,`explorer`,`viewer`,`history`,`workcenter`,`editor`],Dt=class extends te{id=`environment`;name=`Environment`;layout={hasSidebar:!1,hasToolbar:!1,hasTabs:!1,supportsMultiView:!0,supportsWindowing:!0};workspaceEl=null;homeMountEl=null;windowLayer=null;chromeDispose=null;wallpaperLifecycleDispose=null;homeUnmount=null;shellActivityDispose=null;focusedTaskId=r(`home`);setFocusedTaskId=null;syncWindowTasks=null;navEcho=r(``);mqLabel=r(`desktop`);_monoNativeBoot=!1;_pendingHomeMount=null;createLayout(){return document.createElement(`div`)}getStylesheet(){return _t}async mount(e){if(this.mounted){console.warn(`[${this.id}] Shell already mounted`);return}this.container=e,st(`/assets/wallpaper.jpg`),Ee();try{await s(ht),c(ht)}catch(e){console.warn(`[EnvironmentShell] wf-demo tokens failed`,e)}let t=this.getStylesheet();if(t)try{await s(t),c(t)}catch(e){console.warn(`[EnvironmentShell] env shell styles failed`,e)}try{S()}catch{}try{document.documentElement.dataset.cwspSurface=`environment`}catch{}let n=De();n.className=`env-shell-root wf-demo-root`,n.setAttribute(`data-shell`,`environment`),n.setAttribute(`data-shell-system`,`task-tab`),n.style.gridColumn=`content-column`,n.style.gridRow=`content-row`,n.style.alignSelf=`stretch`,n.style.justifySelf=`stretch`,n.style.minInlineSize=`0`,n.style.minBlockSize=`0`,n.style.inlineSize=`100%`,n.style.blockSize=`100%`,n.style.pointerEvents=`auto`;let i=document.createElement(`div`);i.slot=T.underlying,i.className=`env-shell-wallpaper`,i.setAttribute(`data-env-wallpaper`,``);let l=document.createElement(`div`);l.className=`env-shell-workspace`,l.setAttribute(`data-shell-content`,``);let u=document.createElement(`div`);u.className=`env-shell-home-mount`,u.style.display=`flex`,u.style.flex=`1 1 auto`,u.style.flexDirection=`column`,u.style.alignSelf=`stretch`,u.style.minHeight=`0`,u.style.minWidth=`0`,l.appendChild(u),n.append(i,l),e.replaceChildren(n),this.rootElement=n,this.workspaceEl=l,this.homeMountEl=u,this.contentContainer=l,this.overlayContainer=n.overlayMount??n.shadowRoot?.querySelector?.(`[data-shell-overlays]`)??null,this.mounted=!0,this.shellActivityDispose=f(this.id);let p=yt();p&&(n.dataset.capacitorNative=``,document.documentElement.dataset.cwspNativeShell=document.documentElement.dataset.cwspNativeShell||`capacitor`);try{x(),p&&st(`/assets/wallpaper.jpg`),y(i);let e=()=>{if(document.visibilityState===`visible`)try{b()}catch{}};window.addEventListener(`pageshow`,e),document.addEventListener(`visibilitychange`,e),this.wallpaperLifecycleDispose=()=>{window.removeEventListener(`pageshow`,e),document.removeEventListener(`visibilitychange`,e)}}catch(e){console.warn(`[EnvironmentShell] wallpaper init failed`,e)}let m={};for(let e of Et){if(e===`home`||!d(e)&&e!==`viewer`)continue;let t=Tt[e];t&&(m[e]=t)}m.viewer&&(m.markdown=m.viewer);let h=matchMedia(`(max-width: 640px)`);this.mqLabel.value=h.matches?`mobile`:`desktop`,h.addEventListener(`change`,()=>{this.mqLabel.value=h.matches?`mobile`:`desktop`});let g=ct(n,{shell:{selectedPath:r(``),viewerStatus:r(``),navEcho:this.navEcho,mqLabel:this.mqLabel},introHtml:`<p><strong>CWSP environment</strong> — Speed Dial / desktop launcher. Views open in <code>ui-window</code>.</p>`,taskbar:{focusedTaskId:this.focusedTaskId,onHome:()=>this.focusHome(),onViewer:()=>{this.openInWindow(`viewer`)},onWindowTask:e=>{this.openInWindow(e)},onMinimizeWindow:e=>{let t=String(e||``).trim().toLowerCase();t&&this.windowLayer?.minimizeWindow?.(t)&&(this.setFocusedTaskId?.(`home`),this.focusedTaskId.value=`home`)},onCloseWindow:e=>{let t=String(e||``).trim().toLowerCase();t&&(this.windowLayer?.closeWindow?.(t),String(this.focusedTaskId.value||``)===t&&(this.setFocusedTaskId?.(`home`),this.focusedTaskId.value=`home`))}}});this.setFocusedTaskId=g.taskbar?.setFocusedTaskId??null,this.syncWindowTasks=g.taskbar?.syncWindowTasks??null,(document.documentElement.dataset.cwspShellRole===`launcher`||globalThis.__RS_SHELL_ROLE__===`launcher`)&&dt({navigateHome:()=>this.focusHome(),openAppMenu:()=>g.taskbar?.openAppMenu?.(),openAppMenuPage:()=>g.taskbar?.openAppMenuPage?.()??g.taskbar?.appMenu?.openPage?.(),closeAppMenu:()=>g.taskbar?.appMenu?.close(),isAppMenuOpen:()=>!!g.taskbar?.appMenu?.isOpen(),tryConsumeBack:()=>a()?o()!=null:g.taskbar?.isSwitcherOpen?.()?(g.taskbar.closeSwitcher?.(),!0):!1}),this.chromeDispose=()=>{g.disposeDevice(),g.taskbar?.dispose?.(),g.root.remove()};let _=bt();this.windowLayer=it(l,{overlayMountHost:n,environmentShellHost:n,viewLoaders:m,startNativeViewIds:_,viewTitles:{network:`Network`,settings:`Settings`,explorer:`Explorer`,viewer:`Markdown`,browser:`Browser`,history:`History`,workcenter:`Work Center`,editor:`Editor`},onTaskingChange:e=>{this.syncWindowTasks?.(e);let t=e.find(e=>e.focused);t&&this.setFocusedTaskId?.(t.id)}});let v={...this.windowLayer.shellContext,navigate:(e,t)=>{this.navEcho.value=`shell.navigate("${e}")`,this.routeView(String(e),t)},openView:(e,t)=>{this.navEcho.value=`shell.openView("${e}")`,this.routeView(String(e),t)},showMessage:e=>{this.showMessage(typeof e==`string`?e:String(e??``))}};if(Ct(),_.length>0){for(let e of _)this.openInWindow(e,{native:`1`,params:{native:`1`}});this._monoNativeBoot=!0,this._pendingHomeMount={homeMount:u,shellContext:{shellContext:v}}}else this.mountHomeDesktop(u,v)}mountHomeDesktop(e,t){Ke(()=>h(()=>import(`./_cwsp-disabled-entry_view-home-DPCToH21.js`),[],import.meta.url),e,{shellContext:t}).then(e=>{this.homeUnmount=e}).catch(t=>{console.warn(`[EnvironmentShell] home-view failed`,t),e.innerHTML=`<p style="color:#eee;padding:1rem;font-family:system-ui">Home view failed to load.</p>`})}ensureHomeMounted(){let e=this._pendingHomeMount;!e||this.homeUnmount||(this._pendingHomeMount=null,this._monoNativeBoot=!1,this.mountHomeDesktop(e.homeMount,e.shellContext.shellContext))}syncLauncherHomeAddressBar(){if(!(typeof location>`u`||typeof history>`u`))try{let e=new URLSearchParams(location.search||``);e.set(`shell`,this.id),e.delete(`native`),e.delete(`view`);let t=e.toString()?`?${e.toString()}`:``,n=location.pathname||`/`,r=n.replace(/^\/+|\/+$/g,``).split(`/`)[0]?.toLowerCase()||``;new Set([`settings`,`explorer`,`viewer`,`markdown`,`network`,`history`,`workcenter`,`editor`]).has(r)&&(n=`/`);let i=`${n}${t}`;`${location.pathname}${location.search}`!==i&&history.replaceState({viewId:`home`,params:Object.fromEntries(e)},``,i)}catch{}}focusHome(){if(this.ensureHomeMounted(),typeof this.windowLayer?.minimizeAllWindows==`function`)this.windowLayer.minimizeAllWindows();else{for(let e of this.windowLayer?.listWindowTasks?.()??[])this.windowLayer?.minimizeWindow?.(e.id);this.windowLayer?.blurWindows?.()}this.setFocusedTaskId?.(`home`),this.focusedTaskId.value=`home`,this.currentView.value=`home`,this.syncLauncherHomeAddressBar();try{b()}catch{}}openInWindow(e,t){let n=String(e||``).trim().toLowerCase();if(!n||n===`airpad`)return;let r=St(n,t);if(this.windowLayer?.shellContext.openView?.(n,r),xt(r)){let e=()=>{this.windowLayer?.enterNative?.(n),this.preserveNativeDeepLink(n)};e(),requestAnimationFrame(e),setTimeout(e,0)}this.setFocusedTaskId?.(n===`markdown`?`viewer`:n),this.currentView.value=n}preserveNativeDeepLink(e){if(!(typeof location>`u`||typeof history>`u`))try{let t=String(e||``).trim().toLowerCase();if(!t||t===`home`)return;let n=new URLSearchParams(location.search||``);n.set(`shell`,this.id),n.set(`native`,`1`),n.set(`view`,t);let r=`${`/${t}`}?${n.toString()}`;`${location.pathname}${location.search}${location.hash||``}`!==r&&history.replaceState({viewId:t,params:Object.fromEntries(n)},``,r)}catch{}}async routeView(e,t){let n=String(e||``).trim().toLowerCase();if(!(!n||n===`airpad`)){if(n===`home`){this.focusHome();return}this.openInWindow(n,t)}}async navigate(e,t,n){let r=String(e||`home`).toLowerCase();if(r===`airpad`){this.showMessage(`AirPad view is disabled in environment shell`);return}if(r===`home`){let e=bt();if(e.length){for(let n of e)this.openInWindow(n,{native:`1`,params:{native:`1`,...t||{}}});return}this.focusHome();return}let i={};try{i=Object.fromEntries(new URLSearchParams(location.search||``))}catch{i={}}let a={...i,...t||{}},o={params:a};(a.native===`1`||a.native===`true`||bt().includes(r))&&(o.native=`1`,o.params={...a,native:`1`}),this.openInWindow(r,o)}unmount(){try{this.homeUnmount?.()}catch{}this.homeUnmount=null;try{this.windowLayer?.dispose()}catch{}this.windowLayer=null;try{this.chromeDispose?.()}catch{}this.chromeDispose=null;try{this.shellActivityDispose?.()}catch{}this.shellActivityDispose=null;try{this.wallpaperLifecycleDispose?.()}catch{}if(this.wallpaperLifecycleDispose=null,(document.documentElement.dataset.cwspShellRole===`launcher`||globalThis.__RS_SHELL_ROLE__===`launcher`)&&dt(null),this.mounted&&this.container&&this.rootElement)try{this.container.contains(this.rootElement)&&this.rootElement.remove()}catch{}this.rootElement=null,this.contentContainer=null,this.overlayContainer=null,this.workspaceEl=null,this.homeMountEl=null,this.container=null,this.mounted=!1}}})))()}export{wt as n,Ot as r,Dt as t};