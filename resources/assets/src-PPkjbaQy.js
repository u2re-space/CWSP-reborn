import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{At as t,Ht as n,J as r,S as i,Ut as a,X as o,a as s,b as c,et as l,ft as u,jt as d,kt as f,nt as p,tt as ee,u as m}from"./HistoryManager-5Sa1FlA6.js";import{t as te}from"./src-BQ2lM3dn.js";import{n as ne,t as h}from"./preload-helper-NDuSAHbO.js";import{B as g,F as re,H as _,I as ie,M as ae,R as oe,t as v,z as y}from"./src-mG6hxM_E.js";import{t as b}from"./src-BDKAvpBs.js";import{n as se}from"./CSSIconRegistry-D88SYH0A.js";import{n as x,r as S}from"./shell-slots-CDiat5LT.js";function C(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var w=e((()=>{})),T,E,D=e((()=>{v(),b(),w(),T=class extends y(){theme=`default`;render=function(){return s`<slot></slot>`};constructor(){super()}onRender(){return super.onRender()}connectedCallback(){return super.connectedCallback?.()??this}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(se()),e}},C([_({source:`attr`})],T.prototype,`theme`,void 0),T=C([g(`ui-element`)],T),E=T})),O,k,A,ce,le,ue,de,fe,pe,me,he,ge,j,_e,ve,ye,be,xe=e((()=>{O=`2147483600`,k=new Map,A=!1,ce=null,le=()=>{if(typeof document<`u`){if(document.querySelector(`.env-shell-chrome[data-desktop]`))return!0;let e=document.querySelector(`[data-chrome-layout]`);if(e?.dataset.chromeLayout===`desktop`)return!0;if(e?.dataset.chromeLayout===`mobile`)return!1}return typeof matchMedia<`u`&&matchMedia(`(min-width: 641px)`).matches},ue=e=>{ce=e},de=e=>{let t=`data-env-shell-overlays`,n=e||ce||document.querySelector(`.env-shell-root`)||document.querySelector(`#app`)||document.body,r=n.querySelector(`[${t}]`);if(r)return r.style.zIndex||(r.style.zIndex=O),r;try{let e=globalThis.__ENV_OVERLAY_MOUNT__;if(typeof e==`function`)return e(n)}catch{}let i=document.createElement(`div`);return i.setAttribute(t,``),i.className=`env-shell-overlays`,i.setAttribute(`data-part`,`env-overlays`),i.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${O};box-sizing:border-box;`,n.appendChild(i),i},fe=(e,t)=>{let n=le();if(e.style.position=`fixed`,e.style.zIndex=String(Number(O)+1),e.style.pointerEvents=`auto`,e.style.margin=`0`,n){e.style.top=`auto`,e.style.left=`auto`,e.style.right=`0.75rem`,e.style.bottom=`4.5rem`,e.style.transform=`none`;return}if(t===`calendar`){e.style.top=`50%`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translate(-50%, -50%)`;return}e.style.top=`calc(env(safe-area-inset-top, 0px) + 0.75rem)`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translateX(-50%)`},pe=e=>{let t=e.target;for(let[e,n]of[...k.entries()])n.contains(t)||t?.closest?.(`[data-chrome-flyout-anchor], .env-shell-taskbar__clock, .env-ui-statusbar__clock, .env-device-tray`)||j(e)},me=e=>{e.key===`Escape`&&_e()},he=()=>{A||(A=!0,document.addEventListener(`pointerdown`,pe,!0),document.addEventListener(`keydown`,me,!0))},ge=()=>{k.size>0||A&&(A=!1,document.removeEventListener(`pointerdown`,pe,!0),document.removeEventListener(`keydown`,me,!0))},j=e=>{let t=k.get(e);if(t){k.delete(e);try{let e=t.el;typeof e.close==`function`?e.close():(e.removeAttribute(`open`),e.hidden=!0),e.dispatchEvent(new CustomEvent(`chrome-flyout-close`,{bubbles:!0}))}catch{}ge()}},_e=()=>{for(let e of[...k.keys()])j(e)},ve=e=>{for(let t of[...k.keys()])t!==e.kind&&j(t);k.set(e.kind,{...e,close:()=>j(e.kind)}),e.el.hidden=!1,e.el.removeAttribute(`hidden`),e.el.setAttribute(`open`,``),he()},ye=e=>k.has(e),be=(e,t)=>{if(ye(e)){j(e);return}let n=t();ve(n)}})),Se,Ce=e((()=>{Se=`/*
...
</div>`;onRender(){return super.onRender(),ft(this),this}open(){dt(this.shadowRoot),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},pt=C([g(`ui-quick-settings`)],pt),mt=null,Promise.try(()=>{typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{Promise.try(()=>{screen?.orientation?.lock?.(`natural`)}).catch(console.warn.bind(console))})}).catch(console.warn.bind(console))})),gt,_t=e((()=>{gt=`/*
...
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},kt=C([g(`ui-statusbar`)],kt)})),jt=e((()=>{r(),te(),v()}));function Mt(){let e=document.documentElement,t=String(e.getAttribute(`data-theme`)||``).trim().toLowerCase();if(t===`light`||t===`dark`)return t;let n=String(e.getAttribute(`data-scheme`)||``).trim().toLowerCase();if(n===`light`||n===`dark`)return n;try{let e=String(localStorage.getItem(`rs-appearance-theme`)||``).trim().toLowerCase();if(e===`light`||e===`dark`)return e}catch{}return typeof matchMedia==`function`&&matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`}function Nt(e,t){e.style.setProperty(`position`,`fixed`,V),e.style.setProperty(`box-sizing`,`border-box`,V),e.style.setProperty(`min-width`,t?`188px`:`220px`,V),e.style.setProperty(`max-width`,`min(320px, calc(100vw - 24px))`,V),e.style.setProperty(`padding`,t?`0.3rem`:`0.4rem`,V),e.style.setProperty(`border-radius`,`14px`,V),e.style.setProperty(`pointer-events`,`auto`,V),e.style.setProperty(`-webkit-backdrop-filter`,`none`,V),e.style.setProperty(`backdrop-filter`,`none`,V),e.style.removeProperty(`border`),e.style.removeProperty(`background`),e.style.removeProperty(`color`),e.style.removeProperty(`outline`),e.style.removeProperty(`box-shadow`);let n=Mt();e.dataset.theme=n,e.style.setProperty(`color-scheme`,n===`light`?`light only`:`dark only`,V)}function Pt(e){e.style.setProperty(`list-style`,`none`,V),e.style.setProperty(`list-style-type`,`none`,V),e.style.setProperty(`margin`,`0`,V),e.style.setProperty(`padding`,`0`,V),e.style.setProperty(`display`,`flex`,V),e.style.setProperty(`flex-direction`,`column`,V),e.style.setProperty(`align-items`,`stretch`,V),e.style.setProperty(`gap`,`0.2rem`,V),e.style.setProperty(`width`,`100%`,V),e.style.setProperty(`box-sizing`,`border-box`,V),e.style.setProperty(`text-align`,`left`,V)}function Ft(e){e.style.setProperty(`list-style`,`none`,V),e.style.setProperty(`list-style-type`,`none`,V),e.style.setProperty(`margin`,`0`,V),e.style.setProperty(`padding`,`0`,V),e.style.setProperty(`width`,`100%`,V),e.style.setProperty(`display`,`block`,V),e.style.setProperty(`box-sizing`,`border-box`,V)}function It(e,t){if(e.style.setProperty(`appearance`,`none`,V),e.style.setProperty(`-webkit-appearance`,`none`,V),e.style.setProperty(`box-sizing`,`border-box`,V),e.style.setProperty(`width`,`100%`,V),e.style.setProperty(`max-width`,`100%`,V),e.style.setProperty(`margin`,`0`,V),e.style.setProperty(`display`,`grid`,V),e.style.setProperty(`grid-template-columns`,`1.375rem minmax(0, 1fr) auto`,V),e.style.setProperty(`align-items`,`center`,V),e.style.setProperty(`justify-items`,`start`,V),e.style.setProperty(`gap`,`0.55rem`,V),e.style.setProperty(`border-style`,`none`,V),e.style.setProperty(`border-width`,`0`,V),e.style.setProperty(`outline`,`none`,V),e.style.setProperty(`border-radius`,`10px`,V),e.style.setProperty(`padding`,`0.5rem 0.6rem`,V),e.style.setProperty(`min-height`,`2.35rem`,V),e.style.setProperty(`font-family`,`inherit`,V),e.style.setProperty(`font-size`,`0.8125rem`,V),e.style.setProperty(`font-weight`,`400`,V),e.style.setProperty(`line-height`,`1.25`,V),e.style.setProperty(`text-align`,`start`,V),e.style.setProperty(`cursor`,`pointer`,V),e.style.removeProperty(`background`),e.style.removeProperty(`background-color`),e.style.removeProperty(`background-image`),e.style.setProperty(`box-shadow`,`none`,V),e.style.setProperty(`transition`,`none`,V),!t)e.style.setProperty(`color`,`inherit`,V);else{let t=Mt()===`light`?`#9f1239`:`#fecaca`;e.style.setProperty(`color`,t,V),e.style.setProperty(`--cw-menu-fg`,t,V),e.style.setProperty(`--icon-color`,t,V)}}function Lt(e){if(typeof customElements<`u`&&typeof customElements.upgrade==`function`)try{customElements.upgrade(e)}catch{}for(let t of e.querySelectorAll(`ui-icon`)){let e=t;e.style.setProperty(`--icon-size`,`1.125rem`,V),e.style.setProperty(`--icon-padding`,`0px`,V),e.style.setProperty(`--icon-color`,`var(--cw-menu-fg)`,V),e.style.setProperty(`color`,`var(--cw-menu-fg)`,V),e.style.setProperty(`width`,`1.125rem`,V),e.style.setProperty(`height`,`1.125rem`,V),e.style.setProperty(`min-width`,`1.125rem`,V),e.style.setProperty(`min-height`,`1.125rem`,V),e.style.setProperty(`display`,`inline-grid`,V),typeof e.updateIcon==`function`&&e.updateIcon.call(t)}}function Rt(e,t){let n=String(t||``).trim();if(!n)return;let r=document.createElement(`ui-icon`);r.setAttribute(`icon`,n),r.setAttribute(`icon-style`,`duotone`),r.setAttribute(`size`,`18`),r.setAttribute(`aria-hidden`,`true`),r.style.setProperty(`--icon-size`,`1.125rem`,V),r.style.setProperty(`--icon-padding`,`0px`,V),r.style.setProperty(`--icon-color`,`var(--cw-menu-fg)`,V),r.style.setProperty(`color`,`var(--cw-menu-fg)`,V),r.style.setProperty(`width`,`1.125rem`,V),r.style.setProperty(`height`,`1.125rem`,V),e.append(r)}var zt,Bt,Vt,M,N,P,F,I,Ht,Ut,Wt,L,R,z,B,V,Gt,Kt,qt,Jt,H,Yt,Xt,Zt,U,Qt,$t=e((()=>{u(),b(),v(),jt(),x(),zt=`2147483640`,Bt=320,Vt=220,M=0,N=null,P=null,F=[],I=new Map,Ht=()=>{for(let e of I.values())try{e.destroy()}catch{}I.clear()},Ut=e=>{I.get(e)?.destroy(),I.set(e,ae(e))},Wt=e=>{I.get(e)?.destroy(),I.delete(e)},L=new Map,R=new Map,z=new Map,B=new Map,typeof CSS<`u`&&(CSS.supports(`position-anchor: --cw-anchor-test`)||CSS.supports(`anchor-name: --cw-anchor-test`)),V=`important`,Gt=()=>{let e=document.getElementById(`cw-unified-context-menu-style`);e||(e=document.createElement(`style`),e.id=`cw-unified-context-menu-style`,document.head.appendChild(e)),e.textContent=`
    ...
    `},Kt=()=>{for(let e of F)try{e()}catch{}F=[]},qt=e=>{for(let[t,n]of Array.from(z.entries()))t>=e&&(clearTimeout(n),z.delete(t));for(let[t,n]of Array.from(B.entries()))t>=e&&(clearTimeout(n),B.delete(t))},Jt=(e,t,n)=>{e.style.left=`${t}px`,e.style.top=`${n}px`;let r=e.getBoundingClientRect(),i=Math.max(8,window.innerWidth-r.width-8),a=Math.max(8,window.innerHeight-r.height-8);e.style.left=`${Math.min(Math.max(8,t),i)}px`,e.style.top=`${Math.min(Math.max(8,n),a)}px`},H=e=>{qt(e);for(let[t,n]of Array.from(L.entries()))t>=e&&(Wt(n),n.remove(),L.delete(t),R.delete(t))},Yt=(e,t)=>{let n=t.getBoundingClientRect();Jt(e,Math.round(n.right+4),Math.round(n.top))},Xt=e=>{for(let[t,n]of Array.from(B.entries()))t>=e&&(clearTimeout(n),B.delete(t))},Zt=(e,t,n,r)=>{let i=document.createElement(`div`);i.className=`cw-context-menu${t?` cw-context-menu--compact`:``}`,i.setAttribute(`role`,`menu`),i.dataset.menuDepth=String(n),i.style.zIndex=String(n+1);let a=document.createElement(`ul`);a.className=`cw-context-menu__list`,Pt(a),i.appendChild(a);let o=(e,n,i)=>{if(r!==M||!P?.isConnected||!N?.isConnected||(H(i),!e.children?.length))return;let a=Zt(e.children,t,i,r);a.classList.add(`cw-context-menu--submenu`),N.appendChild(a),L.set(i,a),R.set(i,n),Yt(a,n),Ut(a)},s=(e,t,n)=>{let r=z.get(n);r&&clearTimeout(r),Xt(n);let i=setTimeout(()=>{z.delete(n),o(e,t,n)},Bt);z.set(n,i)},c=e=>{let t=B.get(e);t&&clearTimeout(t);let n=setTimeout(()=>{B.delete(e),H(e)},Vt);B.set(e,n)};for(let t of e){let e=document.createElement(`button`);e.type=`button`,e.className=`cw-context-menu__item${t.danger?` cw-context-menu__item--danger`:``}`,e.setAttribute(`role`,`menuitem`),e.disabled=!!t.disabled;let i=!!t.children?.length,l=document.createElement(`span`);l.className=`cw-context-menu__icon`,t.icon&&Rt(l,t.icon);let u=document.createElement(`span`);u.className=`cw-context-menu__label`,u.textContent=t.label;let d=document.createElement(`span`);if(d.className=`cw-context-menu__chevron`,i&&Rt(d,`caret-right`),e.append(l,u,d),It(e,!!t.danger),i){let i=n+1;e.setAttribute(`aria-haspopup`,`menu`),e.addEventListener(`pointerenter`,()=>s(t,e,i)),e.addEventListener(`pointerleave`,()=>c(i)),e.addEventListener(`click`,n=>{if(n.preventDefault(),n.stopPropagation(),r!==M||!P?.isConnected)return;Xt(i);let a=L.get(i),s=R.get(i);if(a?.isConnected&&s===e){H(i);return}o(t,e,i)})}else e.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation(),!(r!==M||!P?.isConnected)&&(U(),!t.disabled&&await t.action())});let f=document.createElement(`li`);Ft(f),f.appendChild(e),a.appendChild(f)}return Nt(i,t),i.addEventListener(`pointerenter`,()=>Xt(n)),i.addEventListener(`pointerleave`,()=>{if(n>0){let e=B.get(n);e&&clearTimeout(e);let t=setTimeout(()=>{B.delete(n),H(n)},Vt);B.set(n,t)}}),i},U=()=>{Kt(),qt(0),H(1),L.clear(),R.clear(),Ht(),P?.remove(),P=null,N?.remove(),N=null,M+=1},Qt=e=>{let t=(e.items||[]).filter(e=>e&&e.id&&e.label);if(!t.length){U();return}Gt(),U();let n=M,r=e.resolveOverlayMountPoint?.(e.anchor??null)??S(e.anchor??null),i=document.createElement(`div`);i.className=`cw-context-menu-layer`,i.style.setProperty(`position`,`fixed`,V),i.style.setProperty(`inset`,`0`,V),i.style.setProperty(`z-index`,zt,V),i.style.setProperty(`pointer-events`,`none`,V),i.style.setProperty(`backdrop-filter`,`none`,V),i.style.setProperty(`-webkit-backdrop-filter`,`none`,V),N=i,r.appendChild(i);let a=Zt(t,!!e.compact,0,n);P=a,i.appendChild(a),Jt(a,e.x,e.y),Ut(a);let o=()=>{n!==M||!a.isConnected||Lt(a)},s=typeof customElements<`u`&&customElements.whenDefined?customElements.whenDefined(`ui-icon`).then(o).catch(()=>{}):Promise.resolve();queueMicrotask(()=>{s.then(o),requestAnimationFrame(()=>{o(),requestAnimationFrame(o)})});let c=e=>{if(!N?.isConnected||!P)return!1;let t=typeof e.composedPath==`function`?e.composedPath():[],n=Array.isArray(t)&&t.length?t:[];for(let e of n)if(e instanceof Element&&(e===N||e===P||N.contains(e)||e.classList?.contains?.(`cw-context-menu`)||e.closest?.(`.cw-context-menu`)))return!0;let r=e.target;return!!(r instanceof Node&&N.contains(r)||r instanceof Element&&r.closest?.(`.cw-context-menu`))},l=e=>{n!==M||!N?.isConnected||c(e)||U()},u=e=>{if(n!==M||!P?.isConnected)return;let t=e.target;if(!t)return;let r=t.closest?.(`.cw-context-menu__item`);if(!r&&typeof e.composedPath==`function`){for(let t of e.composedPath())if(t instanceof Element&&t.classList?.contains?.(`cw-context-menu__item`)){r=t;break}}if(!r){H(1);return}r.getAttribute(`aria-haspopup`)!==`menu`&&H(1)},d=e=>{n===M&&e.key===`Escape`&&U()},f=()=>U();queueMicrotask(()=>{n===M&&(document.addEventListener(`pointerdown`,l,{capture:!0}),document.addEventListener(`contextmenu`,l,{capture:!0}),document.addEventListener(`keydown`,d),a.addEventListener(`click`,u,{capture:!0}),window.addEventListener(`resize`,f,{passive:!0}),window.addEventListener(`blur`,f,{passive:!0}),F.push(()=>document.removeEventListener(`pointerdown`,l,{capture:!0})),F.push(()=>document.removeEventListener(`contextmenu`,l,{capture:!0})),F.push(()=>document.removeEventListener(`keydown`,d)),F.push(()=>a.removeEventListener(`click`,u,{capture:!0})),F.push(()=>window.removeEventListener(`resize`,f)),F.push(()=>window.removeEventListener(`blur`,f)))})}})),en,tn=e((()=>{en=`/*
...
}`}));function nn(e){return`${un}${String(e||``).trim().toLowerCase()}`}function W(){let e=document.querySelector(`.env-shell-chrome`);return e instanceof HTMLElement&&e.hasAttribute(`data-desktop`)?!1:e instanceof HTMLElement&&e.dataset.chromeLayout===`mobile`||typeof matchMedia==`function`&&matchMedia(`(max-width: 640px)`).matches}function rn(e=new Date){return{time:e.toLocaleTimeString(void 0,{hour:`2-digit`,minute:`2-digit`}),date:e.toLocaleDateString(void 0,{weekday:`short`,day:`numeric`,month:`short`})}}function an(e){let t=ee([]);oe(t),re(cn,t,{title:`Home`,icon:`house-line`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`home`,e.onHome()}),re(ln,t,{title:`Markdown`,icon:`article`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`viewer`,e.onViewer()});let n=document.createElement(`ui-taskbar`);n.className=`env-shell-taskbar wf-chrome-no-select`,n.setAttribute(`part`,`taskbar`),n.setAttribute(`data-type`,`desktop`);let r=document.createElement(`div`);r.className=`env-shell-taskbar__pins`;let i=document.createElement(`div`);i.className=`env-shell-taskbar__windows`;let a=document.createElement(`ui-task`);a.setAttribute(`title`,`Home`),a.setAttribute(`icon`,`house-line`),a.setAttribute(`data-id`,cn),a.setAttribute(`data-env-home`,``),a.setAttribute(`aria-label`,`Home`),a.setAttribute(`aria-haspopup`,`menu`),a.setAttribute(`aria-keyshortcuts`,`LongPress`);let s=document.createElement(`ui-task`);s.setAttribute(`title`,`Markdown`),s.setAttribute(`icon`,`article`),s.setAttribute(`data-id`,ln),s.setAttribute(`data-env-pin`,`viewer`),s.setAttribute(`aria-label`,`Markdown`),r.append(a,s);let c=document.createElement(`div`);c.className=`env-shell-taskbar__tray-host`;let l=document.createElement(`div`);l.className=`env-shell-taskbar__clock`,l.setAttribute(`role`,`button`),l.setAttribute(`tabindex`,`0`),l.setAttribute(`aria-label`,`Calendar`),l.setAttribute(`aria-haspopup`,`dialog`),l.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let u=document.createElement(`span`);u.className=`env-shell-taskbar__clock-time`;let d=document.createElement(`span`);d.className=`env-shell-taskbar__clock-date`,l.append(u,d);let f=()=>{let{time:e,date:t}=rn();u.textContent=e,d.textContent=t,l.title=`${e} · ${t}`};f();let p=setInterval(f,fn),m=Et(e.device,`env-device-tray env-device-tray--taskbar`);m.setAttribute(`role`,`button`),m.setAttribute(`tabindex`,`0`),m.setAttribute(`aria-label`,`Quick settings`),m.setAttribute(`aria-haspopup`,`dialog`),m.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`);let te=e=>{e.preventDefault(),e.stopPropagation(),ke(l)},ne=e=>{e.preventDefault(),e.stopPropagation(),Be(m)};l.addEventListener(`click`,te),l.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&te(e)}),m.addEventListener(`click`,ne),m.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&ne(e)}),c.append(m,l);let h=document.createElement(`div`);h.className=`env-shell-navbar__switcher`,h.setAttribute(`role`,`menu`),h.setAttribute(`aria-label`,`Open apps`),h.hidden=!0;let g=document.createElement(`ul`);g.className=`env-shell-navbar__switcher-list`,h.appendChild(g),n.append(r,i,c,h);let _=new Map,v=[],y=null,b=!1,se=!1,x=null,S=[];S.push(()=>clearInterval(p));let C=e=>v.find(t=>String(t.id||``).trim().toLowerCase()===e),w=t=>{let n=String(t||``).trim().toLowerCase();if(!n)return;let r=C(n),i=String(e.focusedTaskId.value||``).trim().toLowerCase(),a=!!r?.focused||i===n||i===`markdown`&&n===`viewer`||i===`viewer`&&(n===`viewer`||n===`markdown`);if(r?.minimized){r.minimized=!1,r.focused=!0,_.get(n)?.toggleAttribute(`data-minimized`,!1),e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n);return}if(a&&r&&r.visible!==!1){r.minimized=!0,r.focused=!1,_.get(n)?.toggleAttribute(`data-minimized`,!0),e.onMinimizeWindow?.(n);return}e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n)},T=(t,r,i)=>{if(W())return;t.preventDefault(),t.stopPropagation();let a=String(r||``).trim().toLowerCase(),o=!!C(a)?.minimized,s=[{id:o?`restore`:`minimize`,label:o?`Restore`:`Minimize`,icon:o?`arrow-square-out`:`minus`,action:()=>{o?(e.focusedTaskId.value=a,e.onWindowTask?.(a)):e.onMinimizeWindow?.(a)}},{id:`close`,label:`Close`,icon:`x`,danger:!0,action:()=>e.onCloseWindow?.(a)}];Qt({x:t.clientX,y:t.clientY,compact:!0,anchor:t.target instanceof Element?t.target:n,items:s})};n.addEventListener(`contextmenu`,t=>{if(W())return;let r=typeof t.composedPath==`function`?t.composedPath():[];for(let e of r)if(e instanceof Element&&e.closest?.(`ui-task`))return;t.preventDefault(),t.stopPropagation(),Qt({x:t.clientX,y:t.clientY,compact:!0,anchor:n,items:[{id:`show-desktop`,label:`Show desktop`,icon:`desktop`,action:()=>e.onHome()},{id:`home`,label:`Home`,icon:`house-line`,action:()=>e.onHome()}]})});let E=()=>{se=!1,h.hidden=!0,g.replaceChildren(),n.removeAttribute(`data-switcher-open`)},D=()=>{let r=v.filter(e=>String(e.id||``).trim());if(g.replaceChildren(),r.length)for(let n of r){let r=String(n.id||``).trim().toLowerCase(),i=document.createElement(`li`);i.className=`env-shell-navbar__switcher-row`,i.setAttribute(`role`,`none`);let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-navbar__switcher-item`,a.setAttribute(`role`,`menuitem`),a.toggleAttribute(`data-active`,!!n.focused&&!n.minimized),a.toggleAttribute(`data-minimized`,!!n.minimized);let o=document.createElement(`ui-icon`);o.setAttribute(`icon`,n.icon||`app-window`),o.setAttribute(`icon-style`,`duotone`),o.setAttribute(`aria-hidden`,`true`);let s=document.createElement(`span`);s.className=`env-shell-navbar__switcher-label`,s.textContent=n.title||r,a.append(o,s),a.addEventListener(`click`,n=>{n.preventDefault(),n.stopPropagation(),E(),e.focusedTaskId.value=r;let i=nn(r),a=ie(t,i);a?a.focus=!0:e.onWindowTask?.(r)});let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-navbar__switcher-close`,c.setAttribute(`aria-label`,`Close ${n.title||r}`),c.title=`Close`;let l=document.createElement(`ui-icon`);l.setAttribute(`icon`,`x`),l.setAttribute(`icon-style`,`bold`),l.setAttribute(`aria-hidden`,`true`),c.appendChild(l),c.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.onCloseWindow?.(r),v=v.filter(e=>String(e.id||``).trim().toLowerCase()!==r),_.get(r)?.remove(),_.delete(r),v.length?D():E()}),i.append(a,c),g.appendChild(i)}else{let e=document.createElement(`li`);e.className=`env-shell-navbar__switcher-empty`,e.textContent=`No open apps`,g.appendChild(e)}se=!0,h.hidden=!1,n.setAttribute(`data-switcher-open`,``)},O=()=>{y!=null&&(clearTimeout(y),y=null)},k=()=>{E(),ie(t,cn).focus=!0};a.addEventListener(`click`,e=>{if(b){e.preventDefault(),e.stopPropagation(),b=!1;return}k()}),a.addEventListener(`pointerdown`,e=>{if(W()&&!(e.button!=null&&e.button!==0)){b=!1,O(),y=setTimeout(()=>{y=null,b=!0;try{a.releasePointerCapture?.(e.pointerId)}catch{}D()},dn);try{a.setPointerCapture?.(e.pointerId)}catch{}}},{capture:!0});let A=()=>{O()};a.addEventListener(`pointerup`,A,{capture:!0}),a.addEventListener(`pointercancel`,A,{capture:!0}),a.addEventListener(`contextmenu`,e=>{W()&&(e.preventDefault(),b=!0,O(),D())}),s.addEventListener(`click`,()=>{let e=C(`viewer`)||C(`markdown`);if(e){w(String(e.id||`viewer`).toLowerCase());return}ie(t,ln).focus=!0}),s.addEventListener(`contextmenu`,t=>{let n=C(`viewer`)||C(`markdown`);if(!n){if(W())return;t.preventDefault(),Qt({x:t.clientX,y:t.clientY,compact:!0,anchor:s,items:[{id:`open-markdown`,label:`Open Markdown`,icon:`article`,action:()=>e.onViewer()}]});return}T(t,String(n.id||`viewer`),n.title||`Markdown`)});let ce=e=>{if(!se)return;let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t)if(e===h||e===a||e instanceof Element&&(e===h||h.contains(e)||e===a))return;E()};document.addEventListener(`pointerdown`,ce,{capture:!0}),S.push(()=>document.removeEventListener(`pointerdown`,ce,{capture:!0}));let le=()=>{let t=String(e.focusedTaskId.value||`home`),n=(e,t)=>{e.toggleAttribute(`data-env-active`,t),e.toggleAttribute(`data-active`,t),e.toggleAttribute(`data-focus`,t)};n(a,t===`home`),n(s,t===`viewer`||t===`markdown`);for(let[e,r]of _)n(r,t===e)};o(()=>{le()},[e.focusedTaskId],{triggerImmediately:!0});let ue=e=>{let n=String(e.id||``).trim().toLowerCase();if(!n||n===`home`)return;let r=nn(n),a=e.title||n,o=String(e.icon||``).trim()||`app-window`,s=_.get(n);if(!s){let e=re(r,null,{title:a,icon:o},{viewId:n},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,w(n)});e.list=t,t.push(e),s=document.createElement(`ui-task`),s.setAttribute(`data-id`,r),s.setAttribute(`data-view`,n),s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),w(n)}),s.addEventListener(`contextmenu`,e=>{T(e,n,a)}),_.set(n,s),i.appendChild(s)}s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.toggleAttribute(`data-minimized`,!!e.minimized),s.hidden=e.visible===!1},de=n=>{v=Array.isArray(n)?n.slice():[];let r=new Set;for(let t of n){let n=String(t.id||``).trim().toLowerCase();!n||n===`home`||(r.add(n),ue(t),t.focused&&(e.focusedTaskId.value=n))}for(let[e,n]of[..._.entries()]){if(r.has(e))continue;let i=nn(e),a=ie(t,i);if(a){let e=t.indexOf(a);e>=0&&t.splice(e,1)}n.remove(),_.delete(e)}le(),se&&D()},fe=n=>{let r=String(n||`home`).toLowerCase(),i=cn;r===`viewer`||r===`markdown`?i=ln:r!==`home`&&(i=nn(r));let a=ie(t,i);if(a){for(let e of t)e!==a&&(e.active=!1);a.active=!0}e.focusedTaskId.value=r===`markdown`?`viewer`:r,le()},pe=()=>{W()?x&&=(x.destroy(),null):!x&&n.isConnected&&(x=ae(n,{className:`env-shell-taskbar-under`,shadowBlur:28,shadowOffsetY:8,shadowColor:`rgba(0, 0, 0, 0.4)`}))};queueMicrotask(pe);let me=typeof matchMedia==`function`?matchMedia(`(min-width: 641px)`):null,he=()=>pe();return me?.addEventListener?.(`change`,he),S.push(()=>me?.removeEventListener?.(`change`,he)),{element:n,taskList:t,setFocusedTaskId:fe,syncWindowTasks:de,dispose:()=>{O(),E(),x?.destroy(),x=null;for(let e of S)try{e()}catch{}S.length=0,_.clear(),i.replaceChildren()}}}var on,sn,cn,ln,un,dn,fn,pn=e((()=>{b(),v(),r(),$t(),At(),Ie(),ht(),D(),tn(),u(),w(),on=d(en),sn=class extends E{constructor(){super()}styles=()=>on;render=()=>s`<div part="taskbar" class="taskbar"><slot></slot></div>`},sn=C([g(`ui-taskbar`)],sn),cn=`#env-home`,ln=`#env-viewer`,un=`#env-win-`,dn=420,fn=3e4})),mn,hn=e((()=>{mn=`/**
 * Font Styles Index
 *
...
}`})),kn,An,jn=e((()=>{En(),u(),hn(),On(),En(),kn=`
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
`,An=async e=>{await f(kn)?.catch(()=>void 0),await Sn().catch(()=>void 0),await f(mn)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await f(Dn)?.catch(()=>void 0)}})),Mn,Nn=e((()=>{Mn=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/*
 * Filename: _tokens.scss
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
        ...
        `}},C([_({source:`attr`})],Ln.prototype,`title`,void 0),C([_({source:`attr`})],Ln.prototype,`icon`,void 0),Ln=C([g(`ui-task`)],Ln)})),zn,Bn=e((()=>{zn=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})),Vn=e((()=>{u(),Bn(),d(zn)})),Hn,Un=e((()=>{Hn=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}
...
:host(ui-taskbar[data-type=mobile]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})),Wn=e((()=>{u(),Un(),d(Hn)}));function Gn(){try{return globalThis.navigator?.windowControlsOverlay??null}catch{return null}}function Kn(){if(typeof globalThis.matchMedia!=`function`)return`unknown`;try{if(globalThis.matchMedia(`(display-mode: window-controls-overlay)`).matches)return`window-controls-overlay`;if(globalThis.matchMedia(`(display-mode: fullscreen)`).matches)return`fullscreen`;if(globalThis.matchMedia(`(display-mode: standalone)`).matches)return`standalone`;if(globalThis.matchMedia(`(display-mode: minimal-ui)`).matches)return`minimal-ui`;if(globalThis.matchMedia(`(display-mode: browser)`).matches)return`browser`}catch{}return`unknown`}function qn(e){if(!e?.visible||typeof e.getTitlebarAreaRect!=`function`)return null;try{let t=e.getTitlebarAreaRect();return t?{x:t.x,y:t.y,width:t.width,height:t.height}:null}catch{return null}}function Jn(e){let t=Gn(),n=!!t?.visible,r=Kn(),i=n||r===`standalone`||r===`fullscreen`||r===`window-controls-overlay`||r===`minimal-ui`,a=`off`;return e&&(a=n?`wco`:i?`standalone`:`fallback`),{requested:e,wcoVisible:n,displayMode:r,titlebarRect:qn(t),isStandaloneLike:i,surface:a}}function Yn(e){let t=()=>{e.onChange(Jn(e.getRequested()))},n=[];if(typeof globalThis.matchMedia==`function`)for(let e of[`(display-mode: window-controls-overlay)`,`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`])try{n.push(globalThis.matchMedia(e))}catch{}let r=()=>t();for(let e of n)try{e.addEventListener?.(`change`,r)}catch{try{e.addListener?.(r)}catch{}}let i=Gn(),a=()=>t();try{i?.addEventListener?.(`geometrychange`,a)}catch{}return queueMicrotask(t),()=>{for(let e of n)try{e.removeEventListener?.(`change`,r)}catch{try{e.removeListener?.(r)}catch{}}try{i?.removeEventListener?.(`geometrychange`,a)}catch{}}}var Xn=e((()=>{})),G,Zn,Qn,K,$n,er,tr,q,nr,J,rr,ir,Y,ar,or,sr,X,cr,lr,ur,Z,dr,fr,Q,pr,mr=e((()=>{G=null,Zn=null,Qn=null,K=[],$n=null,er=0,tr=null,q=`#cbb8a4`,nr=`__CWSP_NATIVE_THEME_COLOR_OWNED__`,J=e=>{let t=String(e||``).trim().toLowerCase();if(!t)return!1;if(t===`#007acc`||t===`#007accff`||t===`#36c`||t===`#3366cc`)return!0;let n=t.match(/^rgba?\(\s*([\d.]+)\s*[, ]\s*([\d.]+)\s*[, ]\s*([\d.]+)/i);if(n&&(t?.startsWith?.(`#`)||t?.startsWith?.(`rgb`))){let e=Math.round(Number(n[1])),t=Math.round(Number(n[2])),r=Math.round(Number(n[3]));if(e<=20&&t>=100&&t<=140&&r>=180&&r<=220)return!0}return!1},rr=()=>{try{return!!globalThis?.[nr]}catch{return!1}},ir=e=>{$n=e;try{globalThis[nr]=!!e}catch{}},Y=e=>{if(!e||!e.isConnected||e.hasAttribute(`minimized`))return!1;if(e.hasAttribute(`native-mode`))return!0;let t=e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`);if(!t)return!1;try{let t=e.getBoundingClientRect(),n=Math.max(1,globalThis.innerWidth||1),r=Math.max(1,globalThis.innerHeight||1);return t.top<=8&&t.left<=8&&t.width>=n*.92&&t.height>=r*.85}catch{return t}},ar=()=>{if(typeof document>`u`)return null;if($n?.isConnected&&Y($n))return $n;let e=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized])`));if(e.length)return e[e.length-1];let t=Array.from(document.querySelectorAll(`ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`));for(let e=t.length-1;e>=0;e--){let n=t[e];if(Y(n))return n}return null},or=()=>{Zn||typeof MutationObserver>`u`||typeof document>`u`||(Zn=new MutationObserver(()=>{let e=ar();e?.isConnected?Q(e):dr()}),Zn.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`class`,`style`,`color-scheme`]}))},sr=e=>{Qn||typeof MutationObserver>`u`||(Qn=new MutationObserver(()=>{if(!rr())return;let t=(e.getAttribute(`content`)||``).toLowerCase(),n=(tr||``).toLowerCase();if(n&&t===n&&!J(t))return;let r=ar();r?Q(r):J(t)&&Z(q,!0)}),Qn.observe(e,{attributes:!0,attributeFilter:[`content`]}))},X=e=>e,cr=()=>{if(typeof document>`u`)return null;let e=document.querySelector(`meta[data-theme-color]`)||document.querySelector(`meta[name="theme-color"]`);e||(e=document.createElement(`meta`),e.setAttribute(`name`,`theme-color`),e.setAttribute(`data-theme-color`,``),document.head?.appendChild(e));try{let t=Array.from(document.querySelectorAll(`meta[name="theme-color"]`));for(let n of t)n!==e&&n.remove()}catch{}return sr(e),e},lr=(e,t)=>{try{let n=document.createElement(`div`);n.setAttribute(`data-theme-color-probe`,`true`),n.style.cssText=`position:fixed;left:-8px;top:-8px;inline-size:4px;block-size:4px;pointer-events:none;opacity:0;background:${t}`,e.appendChild(n);let r=X(getComputedStyle(n).backgroundColor);return n.remove(),r}catch{return null}},ur=e=>{let t=e.shadowRoot?.querySelector(`.title-handler`);if(t){let e=lr(t,`var(--ui-win-titlebar-bg, var(--color-surface-container, Canvas))`);if(e)return e;let n=X(getComputedStyle(t).backgroundColor);if(n)return n}let n=getComputedStyle(e);for(let t of[`--ui-win-titlebar-bg`,`--color-surface-container`,`--color-surface`]){let r=lr(e,`var(${t})`);if(r)return r;let i=n.getPropertyValue(t).trim();if(!i)continue;let a=X(i);if(a)return a}let r=getComputedStyle(document.documentElement);for(let e of[`--color-surface-container`,`--color-surface`,`--color-surface-container-low`]){let t=lr(document.documentElement,`var(${e})`)||X(r.getPropertyValue(e).trim());if(t)return t}return null},Z=(e,t=!1)=>{let n=cr();if(!n||!e)return;let r=e.toLowerCase();J(r)&&(r=q);let i=(n.getAttribute(`content`)||``).toLowerCase();if(!(i===r&&!t&&!J(i))&&(n.setAttribute(`content`,r),n.setAttribute(`data-theme-color`,``),n.removeAttribute(`media`),tr=r,t||i!==r||J(i)))try{let e=n.parentNode||document.head;e?.removeChild(n),e?.appendChild(n)}catch{}},dr=()=>{if(typeof document>`u`||ar())return;ir(null),tr=null;let e=cr();if(!e)return;let t=document.documentElement,n=getComputedStyle(t),r=document.body?getComputedStyle(document.body):null,i=X(n.getPropertyValue(`--color-surface-container`).trim())||X(n.getPropertyValue(`--color-surface`).trim())||X(n.getPropertyValue(`--ui-win-titlebar-bg`).trim())||(r?X(r.backgroundColor):null)||X(n.backgroundColor);i?Z(i):J(String(e.getAttribute(`content`)||``))&&Z(q,!0),or()},fr=e=>e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`),Q=e=>{if(!e||typeof document>`u`||e.hasAttribute(`minimized`)||!e.hasAttribute(`native-mode`)&&!fr(e)&&!Y(e))return;let t=cr();if(!t)return;if(G==null){let e=t.getAttribute(`content`)||``;G=J(e)?``:e}ir(e),J(String(t.getAttribute(`content`)||``))&&Z(q,!0);let n=++er,r=(t=!1)=>{if(n!==er||!e.isConnected||!e.hasAttribute(`native-mode`)&&!fr(e)&&!Y(e))return;let r=ur(e)||q;Z(r,t)};r(!0),requestAnimationFrame(()=>{r(!1),requestAnimationFrame(()=>r(!0))});for(let e of K)clearTimeout(e);K=[],K.push(setTimeout(()=>r(!0),50),setTimeout(()=>r(!0),160),setTimeout(()=>r(!0),400)),or()},pr=e=>{if(typeof document>`u`||!document.querySelector(`meta[name="theme-color"]`))return;let t=ar();if(t&&t!==e){Q(t);return}let n=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized]), ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`)).filter(t=>t!==e&&Y(t));if(n.length){Q(n[n.length-1]);return}ir(null),tr=null,er+=1;for(let e of K)clearTimeout(e);K=[],G!=null&&G&&!J(G)?(Z(G,!0),G=null):(G=null,dr())},typeof document<`u`&&queueMicrotask(()=>{try{dr()}catch{}})})),hr,gr=e((()=>{hr=`/*
