...
`})))()}var re,g,_,v,y,ie;function b(){return(b=e((()=>{n(),re=[/```json\s*\n?([\s\S]*?)\n?```/i,/```toon\s*\n?([\s\S]*?)\n?```/i,/```\s*\n?([\s\S]*?)\n?```/,/(\{[\s\S]*\})/,/(\[[\s\S]*\])/],g=e=>!e||typeof e!=`string`?``:e.replace(/^\uFEFF/,``).replace(/[\u200B-\u200D\uFEFF]/g,``).replace(/\r\n/g,`
`).replace(/\r/g,`
`).trim(),_=e=>{let t=e;return t=t.replace(/,(\s*[}\]])/g,`$1`),t=t.replace(/:\s*"([^"]*)\n([^"]*)"/g,(e,t,n)=>`: "${t}\\n${n}"`),t=t.replace(/[\x00-\x08\x0B\x0C\x0E-\x1F]/g,``),t},v=e=>{if(!e)return{ok:!1,error:`Empty input`};try{return{ok:!0,data:t.parse(e)}}catch{}try{return{ok:!0,data:JSON.parse(e)}}catch{}try{let n=_(e);return{ok:!0,data:t.parse(n)}}catch{}try{let n=e.match(/^[^{[]*([{\[][\s\S]*[}\]])[^}\]]*$/);if(n?.[1])return{ok:!0,data:t.parse(n[1])}}catch{}return{ok:!1,error:`Failed to parse JSON with all strategies`}},y=e=>{if(e==null)return{ok:!1,error:`Response is null or undefined`};if(typeof e!=`string`)return typeof e==`object`?{ok:!0,data:e,source:`direct`}:{ok:!1,error:`Expected string, got ${typeof e}`};let t=g(e);if(!t)return{ok:!1,error:`Response is empty after cleaning`,raw:e};let n=v(t);if(n.ok)return{ok:!0,data:n.data,raw:e,source:`direct`};for(let n of re){let r=t.match(n);if(r?.[1]){let t=g(r[1]),n=v(t);if(n.ok)return{ok:!0,data:n.data,raw:e,source:`markdown_block`}}}let r=t.match(/(\{[\s\S]+\}|\[[\s\S]+\])/);if(r?.[1]){let t=_(r[1]),n=v(t);if(n.ok)return{ok:!0,data:n.data,raw:e,source:`recovered`}}return{ok:!1,error:`Could not extract valid JSON from response`,raw:e}},ie=`
...
`})))()}function ae(e){return e.replace(/\\/g,`\\\\`).replace(/"/g,`\\"`).replace(/\n/g,`\\n`).replace(/\r/g,`\\r`).replace(/\t/g,`\\t`).replace(/[\u0000-\u001F]/g,e=>`\\u${e.charCodeAt(0).toString(16).padStart(4,`0`)}`)}function oe(e){return e===`true`||e===`false`||e===`null`}function se(e,t,n){if(t===`__proto__`){Object.defineProperty(e,t,{value:n,enumerable:!0,writable:!0,configurable:!0});return}e[t]=n}function x(e){return e instanceof Ie}function S(e){if(e===null)return null;if(x(e))return e;if(typeof e==`object`&&e&&`toJSON`in e&&typeof e.toJSON==`function`){let t=e.toJSON();if(t!==e)return S(t)}if(typeof e==`string`)return ce(e,`string value`),e;if(typeof e==`boolean`)return e;if(typeof e==`number`)return Object.is(e,-0)?0:Number.isFinite(e)?e:null;if(typeof e==`bigint`)return e>=-(2**53-1)&&e<=2**53-1?Number(e):e.toString();if(e instanceof Date)return e.toISOString();if(Array.isArray(e))return e.map(S);if(e instanceof Set)return Array.from(e).map(S);if(e instanceof Map)return Object.fromEntries(Array.from(e,([e,t])=>[String(e),S(t)]));if(ue(e)){let t={};for(let n in e)Object.hasOwn(e,n)&&(ce(n,`object key`),se(t,n,S(e[n])));return t}return null}function ce(e,t){if(Le.test(e))for(let n=0;n<e.length;n++){let r=e.charCodeAt(n);if(r<55296||r>57343)continue;let i=r<=56319,a=e.charCodeAt(n+1);if(i&&a>=56320&&a<=57343){n++;continue}throw TypeError(`Cannot encode ${t} containing an unpaired surrogate U+${r.toString(16).toUpperCase()} at index ${n}`)}}function le(e){return e===null||typeof e==`string`||typeof e==`number`||typeof e==`boolean`}function C(e){return le(e)||x(e)}function w(e){return Array.isArray(e)}function T(e){return typeof e==`object`&&!!e&&!Array.isArray(e)&&!x(e)}function E(e){return Object.keys(e).length===0}function ue(e){if(typeof e!=`object`||!e)return!1;let t=Object.getPrototypeOf(e);return t===null||t===Object.prototype}function D(e){return e.length===0||e.every(e=>C(e))}function de(e){return e.length===0||e.every(e=>w(e))}function O(e){return e.length===0||e.every(e=>T(e))}function fe(e){if(!Object.values(G).includes(e))throw TypeError(`Invalid delimiter ${JSON.stringify(e)}. Valid delimiters are: comma (,), tab (\\t), pipe (|)`)}function pe(e){return/^[A-Z_][\w.]*$/i.test(e)}function me(e,t=K){return!(!e||/^[ \t]|[ \t]$/.test(e)||oe(e)||he(e)||e.includes(`:`)||e.includes(`"`)||e.includes(`\\`)||/[[\]{}]/.test(e)||/[\u0000-\u001F]/.test(e)||e.includes(t)||e.startsWith(`-`)||e.startsWith(`#`))}function he(e){return Re.test(e)}function k(e,t){return x(e)?e.value:e===null?Pe:typeof e==`boolean`||typeof e==`number`?String(e):ge(e,t)}function ge(e,t=K){return me(e,t)?e:`"${ae(e)}"`}function A(e){return pe(e)?e:`"${ae(e)}"`}function j(e,t=K){return e.map(e=>k(e,t)).join(t)}function M(e,t){let n=t?.key,r=t?.fields,i=t?.delimiter??`,`,a=``;return n!=null&&(a+=A(n)),a+=`[${e}${t?.keyed?`:`:``}${i===K?``:i}]`,r&&(a+=`{${_e(r,i)}}`),a+=`:`,a}function _e(e,t){return e.map(e=>A(e.name)+(e.children?`{${_e(e.children,t)}}`:``)).join(t)}function N(e){if(e.length===0)return;let t=Object.keys(e[0]);if(t.length===0)return;for(let n of e){if(Object.keys(n).length!==t.length)return;for(let e of t)if(!Object.hasOwn(n,e))return}let n=[];for(let r of t){let t=ve(r,e.map(e=>e[r]));if(!t)return;n.push(t)}return n}function P(e){let t=Object.values(e);if(!(t.length<2)&&t.every(e=>T(e)&&!E(e)))return N(t)}function F(e,t){let n=[];return I(e,t,n),n}function ve(e,t){if(t.every(e=>C(e)))return{name:e};if(!t.every(e=>T(e)&&!E(e)))return;let n=N(t);if(n)return{name:e,children:n}}function I(e,t,n){for(let r of t){let t=e[r.name];r.children?I(t,r.children,n):n.push(t)}}function*ye(e,t,n){if(C(e)){let n=k(e,t.delimiter);n!==``&&(yield n);return}if(w(e))yield*Ce(void 0,e,n,t);else if(T(e)){let r=P(e);if(r){yield*xe(void 0,e,r,n,t);return}yield*L(e,n,t)}}function*L(e,t,n){for(let[r,i]of Object.entries(e))yield*be(r,i,t,n)}function*be(e,t,n,r){let i=A(e);if(C(t))yield B(n,`${i}: ${k(t,r.delimiter)}`,r.indentSize);else if(w(t))yield*Ce(e,t,n,r);else if(T(t)){let a=P(t);if(a){yield*xe(e,t,a,n,r);return}yield B(n,`${i}:`,r.indentSize),E(t)||(yield*L(t,n+1,r))}}function*xe(e,t,n,r,i){let a=Object.entries(t);yield B(r,M(a.length,{key:e,fields:n,delimiter:i.delimiter,keyed:!0}),i.indentSize),yield*Se(a,n,r+1,i)}function*Se(e,t,n,r){for(let[i,a]of e){let e=F(a,t);yield B(n,`${A(i)}: ${j(e,r.delimiter)}`,r.indentSize)}}function*Ce(e,t,n,r){if(t.length===0){yield B(n,e==null?`[]`:`${A(e)}: []`,r.indentSize);return}if(D(t)){yield B(n,R(t,r.delimiter,e),r.indentSize);return}if(de(t)&&t.every(e=>D(e))){yield*we(e,t,n,r);return}if(O(t)){let i=N(t);i?yield*Te(e,t,i,n,r):yield*De(e,t,n,r);return}yield*De(e,t,n,r)}function*we(e,t,n,r){yield B(n,M(t.length,{key:e,delimiter:r.delimiter}),r.indentSize);for(let e of t)if(D(e)){let t=R(e,r.delimiter);yield V(n+1,t,r.indentSize)}}function R(e,t,n){let r=M(e.length,{key:n,delimiter:t}),i=j(e,t);return e.length===0?r:`${r} ${i}`}function*Te(e,t,n,r,i){yield B(r,M(t.length,{key:e,fields:n,delimiter:i.delimiter}),i.indentSize),yield*Ee(t,n,r+1,i)}function*Ee(e,t,n,r){for(let i of e)yield B(n,j(F(i,t),r.delimiter),r.indentSize)}function*De(e,t,n,r){yield B(n,M(t.length,{key:e,delimiter:r.delimiter}),r.indentSize);for(let e of t)yield*z(e,n+1,r)}function*Oe(e,t,n){if(E(e)){yield B(t,`-`,n.indentSize);return}let r=Object.entries(e),[i,a]=r[0],o=r.slice(1);if(w(a)&&O(a)){let e=N(a);if(e){yield V(t,M(a.length,{key:i,fields:e,delimiter:n.delimiter}),n.indentSize),yield*Ee(a,e,t+2,n),o.length>0&&(yield*L(Object.fromEntries(o),t+1,n));return}}if(T(a)){let e=P(a);if(e){let r=Object.entries(a);yield V(t,M(r.length,{key:i,fields:e,delimiter:n.delimiter,keyed:!0}),n.indentSize),yield*Se(r,e,t+2,n),o.length>0&&(yield*L(Object.fromEntries(o),t+1,n));return}}let s=A(i);if(C(a))yield V(t,`${s}: ${k(a,n.delimiter)}`,n.indentSize);else if(w(a)){if(a.length===0)yield V(t,`${s}: []`,n.indentSize);else if(D(a))yield V(t,`${s}${R(a,n.delimiter)}`,n.indentSize);else{yield V(t,`${s}${M(a.length,{delimiter:n.delimiter})}`,n.indentSize);for(let e of a)yield*z(e,t+2,n)}}else T(a)&&(yield V(t,`${s}:`,n.indentSize),E(a)||(yield*L(a,t+2,n)));o.length>0&&(yield*L(Object.fromEntries(o),t+1,n))}function*z(e,t,n){if(C(e))yield V(t,k(e,n.delimiter),n.indentSize);else if(w(e)){if(D(e))yield V(t,R(e,n.delimiter),n.indentSize);else{yield V(t,M(e.length,{delimiter:n.delimiter}),n.indentSize);for(let r of e)yield*z(r,t+1,n)}}else T(e)&&(yield*Oe(e,t,n))}function B(e,t,n){return` `.repeat(n*e)+t}function V(e,t,n){return B(e,`- `+t,n)}function ke(e,t){let n=t(``,e,[]);return n===void 0?U(e,t,[]):H(e,n,t,[])}function H(e,t,n,r){return x(t)&&!C(e)?U(e,n,r):U(S(t),n,r)}function U(e,t,n){return T(e)?Ae(e,t,n):w(e)?je(e,t,n):e}function Ae(e,t,n){let r={};for(let[i,a]of Object.entries(e)){let e=[...n,i],o=t(i,a,e);o!==void 0&&se(r,i,H(a,o,t,e))}return r}function je(e,t,n){let r=[];for(let i=0;i<e.length;i++){let a=e[i],o=[...n,i],s=t(String(i),a,o);s!==void 0&&r.push(H(a,s,t,o))}return r}function W(e,t){return Array.from(Me(e,t)).join(`
`)}function Me(e,t){let n=S(e),r=Ne(t);return ye(r.replacer?ke(n,r.replacer):n,r,0)}function Ne(e){let t=e?.delimiter??K;return fe(t),{indentSize:e?.indentSize??e?.indent??2,delimiter:t,replacer:e?.replacer}}var Pe,G,K,Fe,Ie,Le,Re;function ze(){return(ze=e((()=>{Pe=`null`,G={comma:`,`,tab:`	`,pipe:`|`},K=G.comma,Fe=RegExp(`(?:^﻿?|\\n) *#`),Ie=class{constructor(e){if(Fe.test(e))throw TypeError(`Raw string must not contain a line starting with "#": ${JSON.stringify(e)}`);this.value=e}},Le=/[\uD800-\uDFFF]/,Re=/^[+-]?\d+(?:\.\d+)?(?:e[+-]?\d+)?$/i})))()}function Be(e){let t=J(),n=t?.requestTimeout,r=typeof t?.maxRetries==`number`?Math.max(0,Math.floor(t.maxRetries)):2;return{timeout:We(n?.[e],Ue[e]),maxRetries:r}}var Ve,He,Ue,q,J,We,Ge,Y,Ke,qe;function X(){return(X=e((()=>{ze(),h(),n(),b(),s(),Ve=()=>globalThis.File!==void 0,He=()=>globalThis.Blob!==void 0,Ue={low:6e4,medium:3e5,high:9e5},q=2e3,J=()=>globalThis.runtimeSettings?.ai||{},We=(e,t)=>typeof e!=`number`||!Number.isFinite(e)||e<=0?t:e<1e3?e*1e3:e,Ge=e=>{if(globalThis.Buffer!==void 0)return globalThis.Buffer.from(e).toString(`base64`);let t=1048576;if(e.length>t){let n=``;for(let r=0;r<e.length;r+=t){let i=e.slice(r,r+t),a=``;for(let e=0;e<i.length;e++)a+=String.fromCharCode(i[e]);n+=typeof btoa==`function`?btoa(a):``}return n}let n=``;for(let t=0;t<e.length;t++)n+=String.fromCharCode(e[t]);return typeof btoa==`function`?btoa(n):``},Y=async e=>{let t=Ve()?globalThis.File:void 0,n=He()?globalThis.Blob:void 0;if(n&&e?.dataSource instanceof n||t&&e?.dataSource instanceof t){let t=e?.dataSource?.size||0,n=10485760;if(t>n)return console.warn(`[GPT-Responses] File too large: ${t} bytes > ${n} bytes`),{type:`input_text`,text:`[File too large: ${(t/1024/1024).toFixed(1)}MB. Maximum allowed: ${(n/1024/1024).toFixed(1)}MB]`};if(l?.[e?.dataKind||`input_text`]===`input_image`||e?.dataSource?.type?.startsWith?.(`image/`))try{let t=`data:${e?.dataSource?.type};base64,`,n=await e?.dataSource?.arrayBuffer();if(!n)throw Error(`Failed to read file as ArrayBuffer`);let r=new Uint8Array(n);return{type:`input_image`,detail:`auto`,image_url:t+Ge(r)}}catch(e){return console.error(`[GPT-Responses] Failed to process image file:`,e),{type:`input_text`,text:`[Failed to process image file: ${e}]`}}try{let t=await e?.dataSource?.text?.();if(t)return{type:`input_text`,text:t}}catch(e){return console.error(`[GPT-Responses] Failed to read text file:`,e),{type:`input_text`,text:`[Failed to read text file: ${e}]`}}}else if(typeof e?.dataSource==`string`){let t=e?.dataKind||d(e.dataSource);if(l?.[t]==`input_image`){let t=e?.dataSource?.trim?.()||``;if(t.startsWith(`data:image/`)&&t.includes(`;base64,`))try{let e=new URL(t);if(e.protocol===`data:`&&e.pathname.startsWith(`image/`))return{type:`input_image`,image_url:t,detail:`auto`}}catch{}else if(c(t))return{type:`input_image`,image_url:t,detail:`auto`}}return{type:`input_text`,text:e?.dataSource}}let r=e?.dataSource;try{r=typeof e?.dataSource==`object`?W(e?.dataSource):e?.dataSource}catch(e){console.warn(e)}return{type:l?.[e?.dataKind||`input_text`]||`text`,text:r}},Ke=class{apiKey;apiSecret;apiUrl=`https://api.proxyapi.ru/openai/v1`;model=`gpt-5.6-luna`;responseId=null;pending=[];messages=[];tools=new Map;context=null;responseMap=new Map;constructor(e,t,n,r){this.apiKey=e||``,this.apiUrl=t||this.apiUrl,this.apiSecret=n||``,this.model=r||this.model}setContext(e){return this.context=e,this}async useMCP(e,t,n,r){return this.tools.set(t?.trim?.(),{type:`mcp`,server_label:e,server_url:t,headers:{authorization:`Bearer ${n}:${r}`},require_approval:`never`}),this.tools.get(t?.trim?.())}async convertPlainToInput(e,t=null,n=null){t??=u(e?.type)||`input_text`;let r={dataSource:e,dataKind:t,context:this.context},i=await Y(r);return{type:`message`,role:`user`,content:[{type:`input_text`,text:`What to do: `+f(r)},n?{type:`text`,text:`Additional request data: `+n}:null,{type:`input_text`,text:`
 === BEGIN:ATTACHED_DATA === 
...
Expected output structure:
{
    ...
    "related_but_different": [...]
            ...
            `);let r=await this.sendRequest(`medium`,`medium`,null,{responseFormat:`json`,temperature:.3}),i=y(r);return i.ok?{ok:!0,data:i.data?.similar_items||[],responseId:this.responseId}:(console.warn(`JSON extraction failed:`,i.error,`Raw:`,i.raw),{ok:!1,error:i.error||`Failed to parse AI response`})}catch(e){return console.error(`Error in searchSimilar:`,e),{ok:!1,error:String(e)}}}async batchProcess(e,t,n=10){let r=[],i=[];for(let a=0;a<e.length;a+=n){let o=e.slice(a,a+n);await this.giveForRequest(`batch_items: \`${W(o)}\`\n`),await this.askToDoAction(`
Process this batch of ${o.length} items:
${t}

Return processed items in same order.
Expected output: { "processed": [...], "failed": [...] }
            `);let s=await this.sendRequest(`medium`,`low`,null,{responseFormat:`json`});if(s){let e=y(s);e.ok&&e.data?(r.push(...e.data?.processed||[]),e.data?.failed?.length&&i.push(...e.data.failed.map(e=>e?.error||`Unknown error`))):console.warn(`Batch parsing failed:`,e.error)}}return{ok:i.length===0,data:r,error:i.length?i.join(`; `):void 0,responseId:this.responseId}}clearPending(){return this.pending.splice(0,this.pending.length),this}getResponseId(){return this?.responseId}getMessages(){return this?.messages}getPending(){return this?.pending}getContext(){return this?.context}getResponse(e){return this?.responseMap?.get?.(e)}},qe=(e,t,n)=>new Ke(e,t||`https://api.proxyapi.ru/openai/v1`,``,n||`gpt-5.6-luna`)})))()}function Je(e){if(!e)return e;let t=e.trim().match(/^```(?:katex|md|markdown|html|xml|json|text)?\n([\s\S]*?)\n```$/);if(t){let n=t[1].trim(),r=n.split(`
`);return r.length===1||n.includes(`<math`)||n.includes(`<span class="katex`)||n.includes(`<content`)||n.startsWith(`<`)&&n.endsWith(`>`)||/^\s*<[^>]+>/.test(n)?n:r.length>3||r.some(e=>e.match(/^\s{4,}/)||e.includes(`function`)||e.includes(`const `)||e.includes(`let `))?e:n}return e}function Ye(e){return e instanceof File&&e.type.startsWith(`image/`)||e instanceof Blob&&e.type?.startsWith(`image/`)||typeof e==`string`&&(e.startsWith(`data:image/`)||e.startsWith(`http`)||e.startsWith(`https://`))}function Xe(e){return[`json`,`xml`,`yaml`].includes(e)?`json`:`text`}var Ze,Z,Qe,Q;function $(){return($=e((()=>{a(),X(),Ze=e=>{if(!Array.isArray(e))return[];let t=[];for(let n of e){let e=n;if(!e||typeof e!=`object`)continue;let r=String(e?.origin||``).trim(),i=String(e?.clientKey||``).trim(),a=String(e?.secretKey||``).trim();if(!r||!i||!a)continue;let o=String(e?.serverLabel||e?.label||r).trim()||r;t.push({id:String(e?.id||r),serverLabel:o,origin:r,clientKey:i,secretKey:a})}return t},Z=async(e,t)=>{let n=Ze(t);if(n.length)for(let t of n)await e.useMCP(t.serverLabel,t.origin,t.clientKey,t.secretKey)},Qe=(e,t)=>{let n=String(e||``).trim(),r=String(t||``).trim();return n===`custom`?r||`gpt-5.6-luna`:n||r||`gpt-5.6-luna`},Q=async e=>{let t=await o(),n=e?.apiKey||t?.ai?.apiKey;if(!n)return null;let r=e?.baseUrl||t?.ai?.baseUrl||`https://api.proxyapi.ru/openai/v1`,i=Qe(e?.model||t?.ai?.model,e?.customModel||t?.ai?.customModel),a=qe(n,r,i);return await Z(a,e?.mcp??t?.ai?.mcp),a}})))()}var $e;function et(){return(et=e((()=>{h(),b(),a(),$(),r(),$e=async(e,t)=>{try{let n=await Q(t);if(!n)return{ok:!1,error:`No GPT instance`};let r=typeof e==`string`?d(e):(e instanceof File||e instanceof Blob)&&e.type.startsWith(`image/`)?`input_image`:`input_text`;Array.isArray(e)&&(e?.[0]?.type===`message`||e?.[0]?.role)?await n?.getPending?.()?.push?.(...e):await n?.attachToRequest?.(e,r),await n.askToDoAction(i);let a=await n.sendRequest(`high`,`medium`,null,{responseFormat:`json`,temperature:.2});if(!a)return{ok:!1,error:`No response`};let o=y(a);return o.ok?{ok:!0,data:o.data?.entities||[],responseId:n.getResponseId()}:{ok:!1,error:o.error||`Failed to parse AI response`}}catch(e){return{ok:!1,error:String(e)}}}})))()}export{$ as a,X as c,Xe as i,y as l,et as n,Ye as o,Q as r,Je as s,$e as t,b as u};