import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{Jt as t,Rt as n,Zt as r,ft as i,t as a}from"./src-DaqdrrCE.js";import{a as o,n as s}from"./channel-actions-DkmBPovk.js";import{a as c,d as l,f as u,i as d,l as f,m as p,n as m,o as h,p as g,r as _,s as v,t as y,u as b}from"./transfer-history-runtime-CUKBGyXL.js";var x;function S(){return(S=e((()=>{x=`/*
        ...
        `,this.setupEventHandlers(),this.updateList(!0),requestAnimationFrame(()=>{this.visible&&c(!0)}),this.element}getToolbar(){return null}ensureRuntime(){let e=globalThis;e.__CWS_NEUTRALINO_BOOT__&&v(),e.Capacitor&&h(),m()}bindStore(){this.unsub||=m().subscribe(e=>{this.entries=e,this.scheduleUpdateList(!1)})}refreshFromStore(){this.entries=m().list()}teardown(){this.visible=!1,c(!1),this.listRaf&&=(cancelAnimationFrame(this.listRaf),0);try{this.unsub?.()}catch{}this.unsub=null,this.teardownSheet(),this.element=null,this.lastListSig=``,this.lastStructSig=``}teardownSheet(){try{this._sheet&&r(this._sheet)}catch{}this._sheet=null}renderEntries(){let e=document.createDocumentFragment();if(this.entries.length===0)return e.appendChild(i`
            ...
            `:``,S=d?i`
                <div class="view-history__media">
                    ${h?i`<img class="view-history__thumb" src="${m}" alt="" loading="lazy" decoding="async" />`:i`
                    ...
                    <div class="view-history__media-meta">
                        ...
                        ${t.subtitle?i`<p class="view-history__item-sub">${t.subtitle}</p>`:v?i`<p class="view-history__item-sub">${v}</p>`:``}
                        ${h?``:i`<p class="view-history__item-sub">Preview unavailable — Accept uses retained file when present</p>`}
                    </div>
                </div>
            `:i`
                <p class="view-history__item-desc">${t.title}</p>
                ${t.subtitle?i`<p class="view-history__item-sub">${t.subtitle}</p>`:``}
                ${t.textPreview?i`<pre class="view-history__item-preview">${t.textPreview}</pre>`:``}
            `,w=i`
                <div class="view-history__item${n}${d?` is-image`:``}" data-entry="${t.id}" data-status="${t.status}" data-kind="${t.kind}">
                    ...
                    ${S}
                    ${x}
                    ${t.error?i`<p class="view-history__item-error">${t.error}</p>`:``}
                    ${y}
                </div>
