import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{$ as t,F as n,L as r,M as i,P as a,Q as o,X as s,et as c,j as l,t as u}from"./src-D5Fm02dI.js";import{m as ee}from"./src-XPMlSw8I.js";import{n as te,t as ne}from"./preload-helper-NDuSAHbO.js";import{n as d}from"./CSSIconRegistry-D88SYH0A.js";import{t as f}from"./src-DUnEbC_E.js";function re(e){return{load(){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}},save(t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}},clear(){try{localStorage.removeItem(e)}catch{}}}}var ie=e((()=>{})),p,m=e((()=>{p=`/**
 * Font Styles Index
 *
...
}`}));function h(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function ae(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function oe(e,t,n=`font/woff2`){if(y.has(t))return y.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return y.set(t,i),i}async function g(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(b.has(o))return b.get(o);let s=h(t),c=await oe(a?await ae(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),b.set(o,l),l}async function _(e){let t=e.map(e=>g(e));return Promise.all(t)}async function se(){return x||(x=ne(()=>import(`./font-registry-D4KJRdpC.js`),[],import.meta.url)?.catch?.(e=>{console.error(`Failed to load font registry:`,e)}),x)}async function v(){let e=await se();return _(Object.values(e.fontRegistry))}var y,b,x,S=e((()=>{te(),y=new Map,b=new Map,x=null})),C,ce=e((()=>{C=`@layer tokens, base, layout, utilities, shells, shell, views, view, viewer, components, ux-layer, markdown, essentials, print, print-breaks, overrides;
@layer components {
  button {
    display: inline-flex;
    align-items: center;
...
}`})),w,T,le=e((()=>{S(),s(),m(),ce(),S(),w=`
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
`,T=async e=>{await o(w)?.catch(()=>void 0),await v().catch(()=>void 0),await o(p)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await o(C)?.catch(()=>void 0)}}));function E(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var D=e((()=>{})),O,k,A=e((()=>{u(),f(),D(),O=class extends l(){theme=`default`;render=function(){return n`<slot></slot>`};constructor(){super()}onRender(){return super.onRender()}connectedCallback(){return super.connectedCallback?.()??this}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(d()),e}},E([a({source:`attr`})],O.prototype,`theme`,void 0),O=E([i(`ui-element`)],O),k=O})),j,ue=e((()=>{j=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
/* ==========================================================================
...
}`})),M,N,de=e((()=>{A(),u(),ue(),s(),D(),M=c(j),N=class extends k{constructor(){super()}styles=()=>M;render=()=>n`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},N=E([i(`ui-statusbar`)],N)})),P,fe=e((()=>{P=`/* Taskbar */
@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
...
}`})),F,I,L=e((()=>{A(),u(),fe(),s(),D(),F=c(P),I=class extends k{constructor(){super()}styles=()=>F;render=()=>n`<div part="taskbar" class="taskbar"><slot></slot></div>`},I=E([i(`ui-taskbar`)],I)})),R,z=e((()=>{R=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
/* ==========================================================================
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})),B,V,pe=e((()=>{A(),s(),u(),z(),D(),B=c(R),V=class extends k{title=`Task`;icon=`github`;constructor(){super()}styles=()=>B;render=function(){return n`
        ...
        `}},E([a({source:`attr`})],V.prototype,`title`,void 0),E([a({source:`attr`})],V.prototype,`icon`,void 0),V=E([i(`ui-task`)],V)})),H,me=e((()=>{H=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}`})),he=e((()=>{s(),me(),c(H)})),U,ge=e((()=>{U=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}
...
:host(ui-taskbar[data-type=mobile]) ::slotted(ui-task[data-focus]) {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}`})),_e=e((()=>{s(),ge(),c(U)})),ve=e((()=>{})),ye=e((()=>{r(),u()})),be=e((()=>{A(),de(),L(),pe(),he(),_e(),ve(),ye()}));function xe(){return{...W}}var W,Se=e((()=>{s(),m(),le(),be(),W={loadStyles:!0,includeGlobalNativeControlStyles:!1,styleVariant:`veela-basic`},(async()=>{let e=xe();e.loadStyles!==!1&&(await T({includeGlobalNativeControls:e.includeGlobalNativeControlStyles===!0}),await t(p))})()?.catch?.(()=>void 0)}));function Ce(e,t){let n=e??{},r=t??{};return{...n,...r,lifecycle:{...n.lifecycle,...r.lifecycle}}}function G(e,t,n){let r=Object.getOwnPropertyDescriptor(e,t),i=r?.value;Object.defineProperty(e,t,{configurable:!0,enumerable:r?.enumerable??!0,writable:!0,value:function(...e){let t=i?.apply(this,e),r=n.apply(this,e);return r===void 0?t??this:r}})}function we(e,t){for(let n of[`onInitialize`,`onMount`,`onUnmount`,`onShow`,`onHide`]){let r=t[n];typeof r==`function`&&G(e,n,r)}}function Te(e,t){let n=e.prototype;t.initialization&&G(n,`onInitialize`,t.initialization),t.rendering&&G(n,`onRender`,t.rendering),t.render&&G(n,`render`,t.render),t.styles&&G(n,`styles`,t.styles),t.lifecycle&&we(n,t.lifecycle)}var K,q,J,Ee=e((()=>{ee(),Se(),u(),D(),K=new Map,q=class extends O{__options;__initialized=!1;__viewChannel=null;set options(e){this.__options=e}get options(){return this.__options}get viewChannel(){return this.__viewChannel||=new EventTarget,this.__viewChannel}dispatchViewChannel(e,t,n){return this.viewChannel.dispatchEvent(new CustomEvent(e,{...n,detail:t}))}subscribeViewChannel(e,t){let n=this.viewChannel;return n.addEventListener(e,t),()=>n.removeEventListener(e,t)}viewInitialize(){let e=this.options;return e?.initializator?.call?.(this,this,e),this}constructor(){super()}onInitialize(){return super.onInitialize?.call?.(this),this?.viewInitialize?.call?.(this),this}},q=E([i(`cw-view-base`)],q),J=(e,t,n)=>{let r=typeof t==`function`?n??{}:Ce(t,n??{}),a=r.extends?{extends:r.extends}:void 0,o;if(typeof t==`function`)o=t(q);else{class e extends q{constructor(){super()}}o=e}return i(e,a)(o),Te(o,r),K.set(e,o),o}})),Y,X,Z,Q,$,De=e((()=>{Y={ViewerPushToWorkcenter:`viewer.attach-to-workcenter`,WorkcenterAttach:`attach-files`,WorkcenterFileAttach:`file-attach`,WorkcenterShare:`content-share`},X={WallpaperSet:`workspace.wallpaper-set`,WallpaperFromFile:`workspace.wallpaper-from-file`,SpeedDialPinHref:`workspace.speed-dial-pin-href`,SpeedDialPinFile:`workspace.speed-dial-pin-file`},Z={NavigatePath:`navigate-path`,ContentExplorer:`content-explorer`,Navigate:`navigate`,GetPath:`get-path`,FileSave:`file-save`,RequestUpload:`explorer-request-upload`,RequestPaste:`explorer-request-paste`,RequestUse:`explorer-request-use`,SetColorScheme:`explorer-set-color-scheme`},Q={ContentView:`content-view`,ContentLoad:`content-load`,SetContent:`set-content`,OpenUrl:`open-url`,OpenMarkdownUrl:`open-markdown-url`,AttachToWorkcenter:Y.ViewerPushToWorkcenter,SetColorScheme:`viewer-set-color-scheme`},$={Patch:`patch`,SettingsUpdate:`settings-update`},{...X}}));export{J as a,ie as c,De as i,$ as n,Ee as o,Q as r,re as s,Z as t};