import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{E as t,Gt as n,Jt as r,Kt as i,Rt as a,S as o,T as s,Zt as c,_ as l,c as u,d,en as f,f as p,ft as m,g as h,h as g,l as ee,m as te,o as ne,p as re,rn as _,s as ie,sn as ae,t as v,tn as oe,u as se,w as y}from"./src-DaqdrrCE.js";import{i as ce}from"./src-CCm0-8P-.js";import{B as b,Bt as le,I as x,L as ue,Lt as de,N as fe,Nt as pe,g as S,j as C,jt as me}from"./OPFS-BTZVHSsd.js";import{c as he,g as ge,p as _e,s as w,v as T,y as ve}from"./ecosystem-skus-Bz92tN57.js";import{n as ye,t as E}from"./preload-helper-DFTwEg7x.js";import{_ as be,a as xe,g as Se,h as Ce,n as we,v as Te}from"./registry-B5ADTAyx.js";import{a as Ee,f as De}from"./UnifiedMessaging-CNtaQBln.js";import{a as D,n as Oe,r as ke,t as Ae}from"./view-ingress-validation-BFwuw_Yo.js";import{h as je,m as Me,o as Ne,p as Pe,r as Fe,s as Ie}from"./open-policy-DV4wO_gQ.js";import{a as Le,o as O}from"./Settings-D_-YuEG2.js";import{i as Re,o as ze,s as Be}from"./icon-DwAFT1ZT.js";import{f as k,r as Ve}from"./storage-bridge-L6ipofDd.js";import{n as He,o as Ue,r as We,s as Ge}from"./render-8bB1QlM5.js";import{l as A,n as Ke,s as qe}from"./sku-ingress-BZCb21hj.js";import{n as Je,t as Ye}from"./registry-Bib2ElTG.js";import{a as Xe,i as j,t as M}from"./channel-actions-DkmBPovk.js";import{i as Ze,n as Qe,r as $e,t as et}from"./highlight-CDrAW1CT.js";function tt(e){return{load(){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}},save(t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}},clear(){try{localStorage.removeItem(e)}catch{}}}}function nt(){return m`
        <div
    ...
    `}function it(){let e=m`<div class="view-viewer__chrome" data-viewer-chrome></div>`;return e.append(nt(),rt()),e}function at(){return(at=e((()=>{v()})))()}var ot,st,N,P;function F(){return(F=e((()=>{v(),Ee(),ot=e=>{if(typeof e==`string`||typeof Blob<`u`&&e instanceof Blob)return e;if(e&&typeof e==`object`&&`data`in e){let t=e.data;if(typeof t==`string`||t&&typeof Blob<`u`&&t instanceof Blob)return t}return null},st=e=>String(e||`attachment`).toLowerCase().replace(/[^a-z0-9-]/g,`-`).replace(/-+/g,`-`).replace(/^-+|-+$/g,``)||`attachment`,N=async(e,t=`view-ipc`)=>{let n=[];for(let r of e){let e=ot(r);if(e)try{let i=r&&typeof r==`object`&&`source`in r?String(r.source||t):t,a=await s(e,{namePrefix:st(i),uriComponent:!0});n.push({hash:String(a.hash||``),name:String(a.name||a.file?.name||`attachment`),mimeType:String(a.type||a.file?.type||`application/octet-stream`),size:Number(a.size||a.file?.size||0),source:i,data:a.file})}catch(e){console.warn(`[UniformViewTransport] Attachment normalization failed:`,e)}}return n},P=async e=>{let t=await N(e.attachments||[],e.source),n={...e.data||{},...t.length>0?{attachments:t,file:t[0]?.data,files:t.map(e=>e.data)}:{}},r=ce({type:e.type,source:e.source,destination:e.destination,contentType:e.contentType,data:n,purpose:e.purpose||(t.length>0?[`attach`,`deliver`]:[`deliver`,`mail`]),protocol:`window`,op:e.op||(t.length>0?`attach`:`deliver`),srcChannel:e.source,dstChannel:e.destination,metadata:{...e.metadata||{},attachmentCount:t.length}});return De(r)}})))()}function ct(e){return e===`light`||e===`dark`?e:typeof globalThis.matchMedia==`function`&&globalThis.matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`}function I(e){if(e===`light`||e===`dark`||e===`system`)return e;if(typeof e==`string`){let t=e.trim().toLowerCase();if(t===`light`||t===`dark`||t===`system`)return t}}function L(e){if(e!=null){if(typeof e==`string`)return I(e.trim());if(typeof e==`object`){let t=e;return I(t.colorScheme??t.scheme??t.theme)}}}function lt(e){if(e)return e.colorScheme?e.colorScheme:I(e.params?.colorScheme??e.params?.theme)}var R;function z(){return(z=e((()=>{R=`/*
...
}`})))()}var B,V,H,U,W,G,ut,dt,ft,K,q,J,Y,pt,mt,X,Z,ht,gt;function _t(){return(_t=e((()=>{v(),ie(),de(),pe(),a(),Ue(),Be(),Se(),be(),xe(),Je(),Xe(),at(),Ve(),Le(),F(),he(),qe(),Ne(),Ae(),z(),$e(),We(),ye(),B=e=>e===`launch-queue`||e===`share-target`||e===`clipboard`||e===`pending`,V=null,H=`rs-viewer-outline`,U=96e3,W=12e5,G=2097152,ut=48e4,dt=6e5,ft={USE_PROFILES:{html:!0,mathMl:!0,svg:!0},ADD_ATTR:[`data-language`,`data-lang`],FORBID_TAGS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`link`,`meta`,`base`,`form`,`noscript`,`template`],FORBID_CONTENTS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`noscript`,`template`]},K=`g`,q=!1,J=()=>{if(!q)try{ze(),Re(),q=!0}catch(e){console.warn(`[Viewer] Failed to initialize icon runtime:`,e)}},Y=e=>navigator?.clipboard?.writeText?.(e)??Promise.resolve(void 0),pt=async()=>V||(V=(async()=>{let{marked:e}=await E(async()=>{let{marked:e}=await import(`./marked.esm-OftzsWaf.js`).then(e=>(e.n(),e.r));return{marked:e}},[],import.meta.url);try{He()}catch(e){console.warn(`[ViewerView] markdown configure skipped`,e)}return async t=>await e.parse(t??``)})(),V),mt=`rs-viewer-state`,X=`# This is content`,Z=e=>{try{let t=new URL(e);if(t.hostname.replace(/^www\./i,``).toLowerCase()!==`github.com`)return e;let n=/\.(?:md|markdown|mdown|mkd|mkdn|mdtxt|mdtext)(?:$|[?#])/i,r=t.pathname.match(/^\/([^/]+)\/([^/]+)\/blob\/(.+)$/i);if(r&&n.test(r[3]))return`https://raw.githubusercontent.com/${r[1]}/${r[2]}/${r[3]}`;let i=t.pathname.match(/^\/([^/]+)\/([^/]+)\/raw\/(.+)$/i);return i&&n.test(i[3])?`https://raw.githubusercontent.com/${i[1]}/${i[2]}/${i[3]}`:e}catch{return e}},ht=`cw-view-viewer`,gt=Ye(ht,e=>class extends e{id=`viewer`;name=`Viewer`;icon=`eye`;options;shellContext;element=null;slotProjectingHost=null;contentRef=le(``);contentRefSubscriptionDispose=null;renderSeq=0;openEpoch=0;stateManager=tt(mt);_sheet=null;pasteController=null;documentOpenListener=null;shareIntentListener=null;visibilityOpenListener=null;capacitorOpenPull=Promise.resolve();pendingBinaryPreview=null;binaryPreviewActive=!1;windowDnDController=null;isViewVisible=!1;isPointerInView=!1;sourceUrl=null;pathHistory=[];pathHistoryIndex=-1;suppressPathHistory=!1;boundMountRoot=null;boundDirectory=null;sidecarAssets=new Map;assetObjectUrls=[];sourceObserver=null;boundFsChangeTimer=0;customSheet=null;userStyleModules={screenCss:``,printCss:``};markdownSettings={preset:`default`,fontFamily:`system`,fontSizePx:16,lineHeight:1.7,contentMaxWidthPx:860,printScale:1,page:{size:`auto`,orientation:`portrait`,marginMm:12},modules:{typography:!0,lists:!0,tables:!0,codeBlocks:!0,blockquotes:!0,media:!0,printBreaks:!0},plugins:{smartTypography:!1,softBreaksAsBr:!1,externalLinksNewTab:!0},customCss:``,printCss:``,extensions:[]};markdownSettingsPromise=null;outlineVisible=!1;viewerColorScheme=`system`;documentThemeSnapshot=null;disposeContentRefSubscription(){try{this.contentRefSubscriptionDispose?.()}catch{}this.contentRefSubscriptionDispose=null}subscribeContentRefToCurrentTargets(e,t){this.disposeContentRefSubscription();let n=me(this.contentRef,()=>{e&&this.renderMarkdown(this.contentRef.value,e,t),this.saveState()});this.contentRefSubscriptionDispose=typeof n==`function`?()=>{n()}:null}lifecycle={onMount:()=>this.onMount(),onUnmount:()=>this.onUnmount(),onShow:()=>this.onShow(),onHide:()=>this.onHide(),onRefresh:()=>this.onRefresh()};constructor(e={}){super(),this.options=e,this.shellContext=e.shellContext,this.sourceUrl=this.normalizeSourceUrl(e.source),this.markdownSettingsPromise=this.loadMarkdownSettings();try{this.outlineVisible=globalThis.sessionStorage?.getItem(H)===`1`}catch{this.outlineVisible=!1}this.syncViewerColorSchemeFromOptions();let t=this.stateManager.load();if(this.contentRef.value=e.initialContent||t?.content||X,this.applyRouteParams(e.params),!e.initialContent){let t=(e.params?.content)?.trim?.();t&&(this.contentRef.value=t)}}render=function(e){J(),this.slotProjectingHost=null,e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,this.applyRouteParams(e.params)),this.syncViewerColorSchemeFromOptions(),this._sheet=r(R),this.element=this.createViewerShellElement();let t=this.element.querySelector(`[data-render-target]`),n=this.element.querySelector(`[data-raw-target]`);return this.setupEventHandlers(n||void 0),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.flushPendingBinaryPreview(),!this.binaryPreviewActive&&t&&this.renderMarkdown(this.contentRef.value,t,n),this.subscribeContentRefToCurrentTargets(t,n),this.refreshDocumentTheme(),this.element};shellNavigateHydrate(e,t){if(!this.element?.isConnected)return;e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,e.params!==void 0&&this.applyRouteParams(e.params),this.syncViewerColorSchemeFromOptions());let n=this.queryViewerSlotted(`[data-render-target]`),r=this.queryViewerSlotted(`[data-raw-target]`);n&&(this.subscribeContentRefToCurrentTargets(n,r),this.renderMarkdown(this.contentRef.value,n,r)),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.refreshDocumentTheme()}renderIntoWebComponentHost(e,t){J(),t&&(this.options={...this.options,...t},this.shellContext=t.shellContext||this.shellContext,this.applyRouteParams(t.params)),this.syncViewerColorSchemeFromOptions(),this.slotProjectingHost=e,this._sheet??=r(R),this.element=this.createViewerShellElement(),e.replaceChildren(this.element);let n=e.querySelector(`[data-raw-target]`),i=e.querySelector(`[data-render-target]`);e.setAttribute(`data-view-id`,`viewer`),e.toggleAttribute(`data-cw-view-host`,!0),this.syncAdoptedSheetsToShadow();let a=i,o=n;this.setupEventHandlers(o||void 0),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.flushPendingBinaryPreview(),!this.binaryPreviewActive&&a&&this.renderMarkdown(this.contentRef.value,a,o),this.subscribeContentRefToCurrentTargets(a,o),this.refreshDocumentTheme(),this.pullCapacitorPendingOpen()}getToolbar(){return null}setContent(e,t,n){t&&(this.options.filename=t),n!==void 0&&(this.sourceUrl=this.normalizeSourceUrl(n),this.options.source=n||void 0),this.contentRef.value=e,this.syncToolbarDocumentTitle(),this.syncOpenedPath(this.sourceUrl),this.repaintMarkdown()}repaintMarkdown(){let e=this.queryViewerSlotted(`[data-render-target]`);if(!e)return;let t=this.queryViewerSlotted(`[data-raw-target]`);this.renderMarkdown(this.contentRef.value,e,t)}ingestOpenedMarkdownBody(e,t,n){if(this.binaryPreviewActive=!1,this.pendingBinaryPreview=null,e.length>0&&ke(e)){this.setContent(`> This payload does not look like UTF-8 markdown (binary file or unsupported format).
>
> Open a \`.md\` / \`.txt\` file, paste as plain text, or attach binaries via Work Center.

`,t,n);return}this.setContent(e,t,n??void 0)}getContent(){return this.contentRef.value}setViewerColorScheme(e){this.viewerColorScheme=e,this.options.colorScheme=e,this.refreshDocumentTheme()}refreshDocumentTheme(){typeof document>`u`||(this.applyViewerDocumentTheme(this.viewerColorScheme),this.bakeViewerScreenColors())}bakeViewerScreenColors(){let e=this.element;e instanceof HTMLElement&&n(e);let t=this.queryViewerSlotted(`[data-render-target]`);t instanceof HTMLElement&&t!==e&&n(t)}unbakeViewerScreenColors(){let e=this.element;e instanceof HTMLElement&&i(e);let t=this.queryViewerSlotted(`[data-render-target]`);t instanceof HTMLElement&&t!==e&&i(t)}applyViewerDocumentTheme(e){let t=document.documentElement;if(e===`system`)return;this.documentThemeSnapshot||={prevAttr:t.getAttribute(`data-theme`),prevInlineCs:t.style.getPropertyValue(`color-scheme`)};let n=ct(e);t.setAttribute(`data-theme`,n),t.style.setProperty(`color-scheme`,n)}restoreViewerDocumentTheme(){let e=this.documentThemeSnapshot;if(this.documentThemeSnapshot=null,!e||typeof document>`u`)return;let t=document.documentElement;e.prevAttr===null||e.prevAttr===``?t.removeAttribute(`data-theme`):t.setAttribute(`data-theme`,e.prevAttr),e.prevInlineCs.trim()?t.style.setProperty(`color-scheme`,e.prevInlineCs):t.style.removeProperty(`color-scheme`)}syncViewerColorSchemeFromOptions(){let e=lt(this.options);e&&(this.viewerColorScheme=e)}createViewerShellElement(){let e=it(),t=m`
