import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{At as t,Ht as n,J as r,S as i,Ut as a,X as o,a as s,b as c,et as l,ft as u,jt as d,kt as f,nt as p,tt as ee,u as te}from"./HistoryManager-5Sa1FlA6.js";import{t as ne}from"./src-BQ2lM3dn.js";import{n as m,t as h}from"./preload-helper-NDuSAHbO.js";import{B as g,I as re,L as ie,N as ae,U as _,V as v,t as y,z as oe}from"./src-B775YD6-.js";import{t as b}from"./src-BDKAvpBs.js";import{n as x}from"./CSSIconRegistry-D88SYH0A.js";import{n as S,r as se}from"./shell-slots-CDiat5LT.js";function C(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var w=e((()=>{})),T,E,D=e((()=>{y(),b(),w(),T=class extends g(){theme=`default`;render=function(){return s`<slot></slot>`};constructor(){super()}onRender(){return super.onRender()}connectedCallback(){return super.connectedCallback?.()??this}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(x()),e}},C([_({source:`attr`})],T.prototype,`theme`,void 0),T=C([v(`ui-element`)],T),E=T})),ce,O,k,A,le,ue,de,fe,pe,me,he,ge,j,_e,ve,ye,be,xe=e((()=>{ce=`2147483600`,O=new Map,k=!1,A=null,le=()=>{if(typeof document<`u`){if(document.querySelector(`.env-shell-chrome[data-desktop]`))return!0;let e=document.querySelector(`[data-chrome-layout]`);if(e?.dataset.chromeLayout===`desktop`)return!0;if(e?.dataset.chromeLayout===`mobile`)return!1}return typeof matchMedia<`u`&&matchMedia(`(min-width: 641px)`).matches},ue=e=>{A=e},de=e=>{let t=`data-env-shell-overlays`,n=e||A||document.querySelector(`.env-shell-root`)||document.querySelector(`#app`)||document.body,r=n.querySelector(`[${t}]`);if(r)return r.style.zIndex||(r.style.zIndex=ce),r;try{let e=globalThis.__ENV_OVERLAY_MOUNT__;if(typeof e==`function`)return e(n)}catch{}let i=document.createElement(`div`);return i.setAttribute(t,``),i.className=`env-shell-overlays`,i.setAttribute(`data-part`,`env-overlays`),i.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${ce};box-sizing:border-box;`,n.appendChild(i),i},fe=(e,t)=>{let n=le();if(e.style.position=`fixed`,e.style.zIndex=String(Number(ce)+1),e.style.pointerEvents=`auto`,e.style.margin=`0`,n){e.style.top=`auto`,e.style.left=`auto`,e.style.right=`0.75rem`,e.style.bottom=`4.5rem`,e.style.transform=`none`;return}if(t===`calendar`){e.style.top=`50%`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translate(-50%, -50%)`;return}e.style.top=`calc(env(safe-area-inset-top, 0px) + 0.75rem)`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translateX(-50%)`},pe=e=>{let t=e.target;for(let[e,n]of[...O.entries()])n.contains(t)||t?.closest?.(`[data-chrome-flyout-anchor], .env-shell-taskbar__clock, .env-ui-statusbar__clock, .env-device-tray`)||j(e)},me=e=>{e.key===`Escape`&&_e()},he=()=>{k||(k=!0,document.addEventListener(`pointerdown`,pe,!0),document.addEventListener(`keydown`,me,!0))},ge=()=>{O.size>0||k&&(k=!1,document.removeEventListener(`pointerdown`,pe,!0),document.removeEventListener(`keydown`,me,!0))},j=e=>{let t=O.get(e);if(t){O.delete(e);try{let e=t.el;typeof e.close==`function`?e.close():(e.removeAttribute(`open`),e.hidden=!0),e.dispatchEvent(new CustomEvent(`chrome-flyout-close`,{bubbles:!0}))}catch{}ge()}},_e=()=>{for(let e of[...O.keys()])j(e)},ve=e=>{for(let t of[...O.keys()])t!==e.kind&&j(t);O.set(e.kind,{...e,close:()=>j(e.kind)}),e.el.hidden=!1,e.el.removeAttribute(`hidden`),e.el.setAttribute(`open`,``),he()},ye=e=>O.has(e),be=(e,t)=>{if(ye(e)){j(e);return}let n=t();ve(n)}})),Se,Ce=e((()=>{Se=`/*
...
.ui-cal-flyout__nav-btn ui-icon {
  --icon-size: 1.05rem;
  /* WHY: mask fill must track button ink (dark/light); not a fixed @property slate. */
...
.ui-cal-flyout__day[data-today][data-selected] {
  box-shadow: 0 0 0 2px color-mix(in oklab, var(--cal-base-color) 70%, #fff 20%) inset;
}`}));function we(e){try{let t=new Intl.Locale(e),n=(t.weekInfo??t.getWeekInfo?.())?.firstDay;if(typeof n==`number`&&n>=1&&n<=7)return n%7}catch{}return 0}function Te(e,t){let n=new Intl.DateTimeFormat(e,{weekday:`short`,timeZone:`UTC`}),r=[];for(let e=0;e<7;e++){let i=(t+e)%7;r.push(n.format(new Date(Me+i*Ne)))}return r}function Ee(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function De(e,t,n){let r=new Date,i=new Date(e,t,1),a=new Date(e,t+1,0).getDate(),o=(i.getDay()-n+7)%7,s=Math.ceil((o+a)/7)*7,c=[];for(let n=0;n<s;n++){let i=n-o+1,a=new Date(e,t,i);c.push({date:a,day:a.getDate(),otherMonth:a.getMonth()!==t,isToday:Ee(a,r)})}return c}function Oe(){if(Fe?.isConnected)return Fe;let e=de(),t=e.querySelector(`ui-calendar-flyout`);return t||(t=document.createElement(`ui-calendar-flyout`),t.hidden=!0,e.appendChild(t)),Fe=t,t}function ke(e){be(je,()=>{let e=Oe(),t=document.documentElement.getAttribute(`data-theme`);return(t===`light`||t===`dark`)&&(e.dataset.theme=t,e.style.colorScheme=t),fe(e,je),e.open(),{kind:je,el:e,close:()=>{e.close(),j(je)},contains:t=>t instanceof Node&&e.contains(t)}})}var Ae,je,Me,Ne,Pe,Fe,Ie=e((()=>{y(),u(),D(),b(),xe(),Ce(),w(),Ae=d(Se),je=`calendar`,Me=Date.UTC(2023,0,1),Ne=864e5,Pe=class extends T{#e;#t;#n=null;#r=null;styles=function(){return Ae};render=function(){return s`<div class="ui-cal-flyout__panel" part="panel">
        ...
        </div>`};constructor(){super();let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth()}onRender(){super.onRender(),this.#i(),this.#c()}disconnectedCallback(){this.#r?.(),this.#r=null,super.disconnectedCallback?.()}#i(){let e=this.shadowRoot;if(!e||this.#r)return;let t=a(e,`click`,e=>{let t=e.target,n=t?.closest?.(`[data-nav]`);if(n){n.dataset.nav===`prev`?this.#a(-1):n.dataset.nav===`next`&&this.#a(1);return}let r=t?.closest?.(`.ui-cal-flyout__day`);r&&this.#s(r)});this.#r=()=>t?.()}#a(e){this.#t+=e,this.#t<0?(this.#t=11,--this.#e):this.#t>11&&(this.#t=0,this.#e+=1),this.#c()}#o(){let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth(),this.#c()}#s(e){let t=e.dataset.date;t&&(this.#n=new Date(t),this.shadowRoot?.querySelectorAll(`.ui-cal-flyout__day[data-selected]`)?.forEach(e=>e.removeAttribute(`data-selected`)),e.setAttribute(`data-selected`,``),this.dispatchEvent(new CustomEvent(`calendar-select`,{bubbles:!0,composed:!0,detail:{date:this.#n}})))}#c(){let e=this.shadowRoot;if(!e)return;let t=typeof navigator<`u`?navigator.language:void 0,n=we(t??`en-US`),r=new Date,i=e.querySelector(`.ui-cal-flyout__today`);i&&(i.textContent=r.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`}));let a=e.querySelector(`.ui-cal-flyout__month-label`);a&&(a.textContent=new Date(this.#e,this.#t,1).toLocaleDateString(t,{month:`long`,year:`numeric`}));let o=e.querySelector(`.ui-cal-flyout__weekdays`);o&&o.replaceChildren(...Te(t??`en-US`,n).map(e=>{let t=document.createElement(`span`);return t.className=`ui-cal-flyout__weekday`,t.setAttribute(`role`,`columnheader`),t.textContent=e,t}));let s=e.querySelector(`.ui-cal-flyout__grid`);if(s){let e=De(this.#e,this.#t,n);s.replaceChildren(...e.map(e=>{let n=document.createElement(`button`);return n.type=`button`,n.className=`ui-cal-flyout__day`,n.textContent=String(e.day),n.dataset.date=e.date.toISOString(),n.setAttribute(`role`,`gridcell`),e.otherMonth&&n.setAttribute(`data-other-month`,``),e.isToday&&n.setAttribute(`data-today`,``),this.#n&&Ee(e.date,this.#n)&&n.setAttribute(`data-selected`,``),n.setAttribute(`aria-label`,e.date.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`})),n}))}}open(){this.#o(),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},Pe=C([v(`ui-calendar-flyout`)],Pe),Fe=null})),Le,Re=e((()=>{Le=`/*
...
}`}));function ze(){if(mt?.isConnected)return mt;let e=de(),t=e.querySelector(`ui-quick-settings`);return t||(t=document.createElement(`ui-quick-settings`),t.hidden=!0,e.appendChild(t)),mt=t,t}function Be(e){be(He,()=>{let e=ze(),t=document.documentElement.getAttribute(`data-theme`);return(t===`light`||t===`dark`)&&(e.dataset.theme=t,e.style.colorScheme=t),fe(e,He),e.open(),{kind:He,el:e,close:()=>{e.close(),j(He)},contains:t=>t instanceof Node&&e.contains(t)}})}var Ve,He,Ue,We,Ge,Ke,qe,Je,Ye,Xe,Ze,Qe,$e,et,tt,nt,rt,it,at,ot,st,ct,lt,ut,dt,ft,pt,mt,ht=e((()=>{y(),u(),D(),b(),xe(),Re(),w(),Ve=d(Le),He=`quick-settings`,Ue=`data-theme`,We=`rs-appearance-theme`,Ge=`appearance.theme`,Ke=[`rs-settings`,`cwsp-settings`,`u2-settings`],qe=()=>{try{return matchMedia?.(`(prefers-color-scheme: dark)`)?.matches??!0}catch{return!0}},Je=e=>{for(let t of Ke)try{let n=localStorage.getItem(t);if(!n)continue;let r=JSON.parse(n);if(!r||typeof r!=`object`)continue;r.appearance={...r.appearance??{},theme:e},localStorage.setItem(t,JSON.stringify(r))}catch{}},Ye=()=>{try{let e=document.documentElement.getAttribute(Ue);if(e===`light`||e===`dark`)return e;let t=localStorage.getItem(We);if(t===`light`||t===`dark`)return t}catch{}return qe()?`dark`:`light`},Xe=e=>{let t=document.documentElement;t.setAttribute(`data-scheme`,e),t.setAttribute(Ue,e),t.style.colorScheme=e;try{document.body&&(document.body.style.colorScheme=e)}catch{}try{document.querySelectorAll(`.env-shell-root, [data-shell], ui-window`).forEach(t=>{let n=t;n.dataset.theme=e,n.style.colorScheme=e;let r=n.shadowRoot?.querySelector?.(`.app-shell`);r&&(r.dataset.theme=e,r.style.colorScheme=e)})}catch{}try{localStorage.setItem(We,e),localStorage.setItem(Ge,e)}catch{}Je(e),t.dispatchEvent(new CustomEvent(`u2-theme-change`,{bubbles:!0,detail:{source:`quick-settings`,theme:e}}))},Ze=e=>{document.documentElement.style.setProperty(`--orientation-lock`,e?`unlocked`:`locked`),document.documentElement.style.setProperty(`--orientation-lock-angle`,e?`0deg`:`90deg`),Promise.try(()=>{try{e?screen.orientation.unlock():screen.orientation.lock(screen.orientation.type||`natural`)}catch(e){console.warn(e)}})?.catch?.(console.warn.bind(console))},Qe=`env-night-filter`,$e=`2147483001`,et=`rs-night-filter`,tt=`rs-brightness-filter`,nt=e=>Math.max(0,Math.min(100,Number.isFinite(e)?e:0)),rt=()=>{let e=document.getElementById(Qe);if(e instanceof HTMLElement)return e;let t=document.createElement(`div`);return t.id=Qe,t.setAttribute(`aria-hidden`,`true`),t.style.cssText=[`dynamic-range-limit:no-limit`,`color-space:display-p3`,`position:fixed`,`inset:0`,`pointer-events:none`,`z-index:${$e}`,`background-color:color(display-p3 1 0.55 0.24)`,`mix-blend-mode:multiply`,`opacity:0`,`visibility:hidden`,`transition:opacity 160ms ease`].join(`;`),(document.body??document.documentElement).appendChild(t),t},it=e=>{let t=nt(e),n=rt(),r=t/100;n.style.opacity=String(r),n.style.visibility=r>=.01?`visible`:`hidden`;try{localStorage.setItem(et,String(t))}catch{}},at=e=>{let t=nt(e);rt(),t<=50?.4+t/50*.6:1+(t-50)/50*.2;try{localStorage.setItem(tt,String(t))}catch{}},ot=(e,t)=>{try{let n=localStorage.getItem(e);if(n==null)return t;let r=Number(n);return Number.isFinite(r)?nt(r):t}catch{return t}},st=()=>{let e=ot(et,0),t=ot(tt,50);return it(e),at(t),{night:e,brightness:t}},typeof document<`u`&&(document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>st(),{once:!0}):st()),ct=[`wifi`,`bluetooth`,`focus`,`airplane`,`orientation`],lt={light:`sun`,dark:`moon`},ut={light:`Light`,dark:`Dark`},dt=e=>{let t=e.querySelector(`[data-qs-tile="theme"]`);if(!t)return;let n=Ye();t.querySelector(`ui-icon`)?.setAttribute(`icon`,lt[n]);let r=t.querySelector(`[data-qs-tile-sub]`);r&&(r.textContent=ut[n]),t.setAttribute(`aria-pressed`,n===`dark`?`true`:`false`)},ft=e=>{let t=e.shadowRoot,r=t?.querySelector(`.qs-panel`);if(!t||!r||r.hasAttribute(`data-qs-wired`))return;r.setAttribute(`data-qs-wired`,``),dt(t),t.querySelector(`[data-qs-tile="theme"]`)?.addEventListener(`click`,()=>{let e=Ye()===`dark`?`light`:`dark`;Xe(e),dt(t)});let i=e=>!!e?.getAttribute?.(`aria-pressed`)&&e?.getAttribute?.(`aria-pressed`)===`true`;t.querySelector?.(`[data-qs-tile="orientation"]`)?.addEventListener?.(`click`,e=>{let t=n((e?.target?.matches?.(`[data-qs-tile="orientation"]`)?e?.target:e?.target?.querySelector?.(`[data-qs-tile="orientation"]`))||e?.target,`[data-qs-tile="orientation"]`),r=i(t);Ze(r);let a=t?.matches?.(`ui-icon`)?t:t?.querySelector?.(`ui-icon`);a&&a.setAttribute?.(`icon`,r?`device-rotate`:`lock`),a&&a.setAttribute?.(`icon-style`,`duotone`)});for(let e of ct){let n=t.querySelector(`[data-qs-tile="${e}"]`);n&&n.addEventListener(`click`,()=>{let e=n.getAttribute(`aria-pressed`)!==`true`;n.setAttribute(`aria-pressed`,String(e));let t=n.querySelector(`[data-qs-tile-sub]`);t&&(t.textContent=e?`On`:`Off`)})}let{night:a,brightness:o}=st(),s=t.querySelector(`[data-qs-slider="night"]`),c=t.querySelector(`[data-qs-slider="brightness"]`);s&&(s.value=String(a),s.addEventListener(`input`,()=>it(s.valueAsNumber))),c&&(c.value=String(o),c.addEventListener(`input`,()=>at(c.valueAsNumber)))},pt=class extends T{constructor(){super()}styles=()=>Ve;render=()=>s`
...
</div>`;onRender(){return super.onRender(),ft(this),this}open(){dt(this.shadowRoot),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},pt=C([v(`ui-quick-settings`)],pt),mt=null,Promise.try(()=>{typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{Promise.try(()=>{screen?.orientation?.lock?.(`natural`)}).catch(console.warn.bind(console))})}).catch(console.warn.bind(console))})),gt,_t=e((()=>{gt=`/*
...
@layer ui-statusbar {
  ...
  env-shell-container[data-env-native-task] .env-shell-chrome[data-desktop] {
    ...
    </div>`,r=n.querySelector(`.env-status-bar__pct`);return r instanceof HTMLElement&&te(r,{properties:{textContent:e.batteryPct}}),n}function Dt(e,t,n){let r=document.createElement(`ui-statusbar`);r.className=`env-ui-statusbar wf-chrome-no-select`,r.setAttribute(`part`,`status-bar`);let i=document.createElement(`div`);i.slot=`left`,i.className=`env-ui-statusbar__left`;let a=document.createElement(`time`);a.className=`env-ui-statusbar__clock`,a.dateTime=``,a.textContent=xt(),a.setAttribute(`role`,`button`),a.setAttribute(`tabindex`,`0`),a.setAttribute(`aria-label`,`Calendar`),a.setAttribute(`aria-haspopup`,`dialog`),a.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let s=document.createElement(`div`);s.className=`env-ui-statusbar__intro`,t&&(s.innerHTML=t),i.append(a,s);let c=document.createElement(`div`);c.slot=`center`;let l=document.createElement(`p`);l.className=`env-status-bar__meta`,c.appendChild(l);let u=document.createElement(`div`);u.slot=`right`,u.className=`env-ui-statusbar__right`;let d=Et(n,`env-device-tray env-device-tray--footer`);d.setAttribute(`role`,`button`),d.setAttribute(`tabindex`,`0`),d.setAttribute(`aria-label`,`Quick settings`),d.setAttribute(`aria-haspopup`,`dialog`),d.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`),u.appendChild(d);let f=e=>{e.preventDefault(),e.stopPropagation(),ke(a)},p=e=>{e.preventDefault(),e.stopPropagation(),Be(d)};a.addEventListener(`click`,f),a.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&f(e)}),d.addEventListener(`click`,p),d.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&p(e)}),r.append(i,c,u),o(()=>{let t=e.navEcho.value?` │ ${e.navEcho.value}`:``;l.textContent=`doc=${e.selectedPath.value} │ viewer=${e.viewerStatus.value} │ layout=${e.mqLabel.value}${t}`},[e.selectedPath,e.viewerStatus,e.mqLabel,e.navEcho],{triggerImmediately:!0});let ee=()=>{let e=new Date;a.textContent=xt(e),a.dateTime=e.toISOString()};ee();let te=setInterval(ee,15e3);return{element:r,dispose:()=>{clearInterval(te)}}}var Ot,kt,At=e((()=>{y(),r(),Ie(),ht(),D(),_t(),u(),w(),Ot=d(gt),kt=class extends E{constructor(){super()}styles=()=>Ot;render=()=>s`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},kt=C([v(`ui-statusbar`)],kt)})),jt=e((()=>{r(),ne(),y()}));function Mt(){let e=document.documentElement,t=String(e.getAttribute(`data-theme`)||``).trim().toLowerCase();if(t===`light`||t===`dark`)return t;let n=String(e.getAttribute(`data-scheme`)||``).trim().toLowerCase();if(n===`light`||n===`dark`)return n;try{let e=String(localStorage.getItem(`rs-appearance-theme`)||``).trim().toLowerCase();if(e===`light`||e===`dark`)return e}catch{}return typeof matchMedia==`function`&&matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`}function Nt(e,t){e.style.setProperty(`position`,`fixed`,B),e.style.setProperty(`box-sizing`,`border-box`,B),e.style.setProperty(`min-width`,t?`188px`:`220px`,B),e.style.setProperty(`max-width`,`min(320px, calc(100vw - 24px))`,B),e.style.setProperty(`padding`,t?`0.3rem`:`0.4rem`,B),e.style.setProperty(`border-radius`,`14px`,B),e.style.setProperty(`pointer-events`,`auto`,B),e.style.setProperty(`-webkit-backdrop-filter`,`none`,B),e.style.setProperty(`backdrop-filter`,`none`,B),e.style.removeProperty(`border`),e.style.removeProperty(`background`),e.style.removeProperty(`color`),e.style.removeProperty(`outline`),e.style.removeProperty(`box-shadow`);let n=Mt();e.dataset.theme=n,e.style.setProperty(`color-scheme`,n===`light`?`light only`:`dark only`,B)}function Pt(e){e.style.setProperty(`list-style`,`none`,B),e.style.setProperty(`list-style-type`,`none`,B),e.style.setProperty(`margin`,`0`,B),e.style.setProperty(`padding`,`0`,B),e.style.setProperty(`display`,`flex`,B),e.style.setProperty(`flex-direction`,`column`,B),e.style.setProperty(`align-items`,`stretch`,B),e.style.setProperty(`gap`,`0.2rem`,B),e.style.setProperty(`width`,`100%`,B),e.style.setProperty(`box-sizing`,`border-box`,B),e.style.setProperty(`text-align`,`left`,B)}function Ft(e){e.style.setProperty(`list-style`,`none`,B),e.style.setProperty(`list-style-type`,`none`,B),e.style.setProperty(`margin`,`0`,B),e.style.setProperty(`padding`,`0`,B),e.style.setProperty(`width`,`100%`,B),e.style.setProperty(`display`,`block`,B),e.style.setProperty(`box-sizing`,`border-box`,B)}function It(e,t){if(e.style.setProperty(`appearance`,`none`,B),e.style.setProperty(`-webkit-appearance`,`none`,B),e.style.setProperty(`box-sizing`,`border-box`,B),e.style.setProperty(`width`,`100%`,B),e.style.setProperty(`max-width`,`100%`,B),e.style.setProperty(`margin`,`0`,B),e.style.setProperty(`display`,`grid`,B),e.style.setProperty(`grid-template-columns`,`1.375rem minmax(0, 1fr) auto`,B),e.style.setProperty(`align-items`,`center`,B),e.style.setProperty(`justify-items`,`start`,B),e.style.setProperty(`gap`,`0.55rem`,B),e.style.setProperty(`border-style`,`none`,B),e.style.setProperty(`border-width`,`0`,B),e.style.setProperty(`outline`,`none`,B),e.style.setProperty(`border-radius`,`10px`,B),e.style.setProperty(`padding`,`0.5rem 0.6rem`,B),e.style.setProperty(`min-height`,`2.35rem`,B),e.style.setProperty(`font-family`,`inherit`,B),e.style.setProperty(`font-size`,`0.8125rem`,B),e.style.setProperty(`font-weight`,`400`,B),e.style.setProperty(`line-height`,`1.25`,B),e.style.setProperty(`text-align`,`start`,B),e.style.setProperty(`cursor`,`pointer`,B),e.style.removeProperty(`background`),e.style.removeProperty(`background-color`),e.style.removeProperty(`background-image`),e.style.setProperty(`box-shadow`,`none`,B),e.style.setProperty(`transition`,`none`,B),!t)e.style.setProperty(`color`,`inherit`,B);else{let t=Mt()===`light`?`#9f1239`:`#fecaca`;e.style.setProperty(`color`,t,B),e.style.setProperty(`--cw-menu-fg`,t,B),e.style.setProperty(`--icon-color`,t,B)}}function Lt(e){if(typeof customElements<`u`&&typeof customElements.upgrade==`function`)try{customElements.upgrade(e)}catch{}for(let t of e.querySelectorAll(`ui-icon`)){let e=t;e.style.setProperty(`--icon-size`,`1.125rem`,B),e.style.setProperty(`--icon-padding`,`0px`,B),e.style.setProperty(`--icon-color`,`var(--cw-menu-fg)`,B),e.style.setProperty(`color`,`var(--cw-menu-fg)`,B),e.style.setProperty(`width`,`1.125rem`,B),e.style.setProperty(`height`,`1.125rem`,B),e.style.setProperty(`min-width`,`1.125rem`,B),e.style.setProperty(`min-height`,`1.125rem`,B),e.style.setProperty(`display`,`inline-grid`,B),typeof e.updateIcon==`function`&&e.updateIcon.call(t)}}function Rt(e,t){let n=String(t||``).trim();if(!n)return;let r=document.createElement(`ui-icon`);r.setAttribute(`icon`,n),r.setAttribute(`icon-style`,`duotone`),r.setAttribute(`size`,`18`),r.setAttribute(`aria-hidden`,`true`),r.style.setProperty(`--icon-size`,`1.125rem`,B),r.style.setProperty(`--icon-padding`,`0px`,B),r.style.setProperty(`--icon-color`,`var(--cw-menu-fg)`,B),r.style.setProperty(`color`,`var(--cw-menu-fg)`,B),r.style.setProperty(`width`,`1.125rem`,B),r.style.setProperty(`height`,`1.125rem`,B),e.append(r)}var zt,Bt,Vt,M,N,P,F,I,Ht,Ut,Wt,L,Gt,R,z,B,Kt,qt,Jt,Yt,V,Xt,Zt,Qt,H,$t,en=e((()=>{u(),b(),y(),jt(),S(),zt=`2147483640`,Bt=320,Vt=220,M=0,N=null,P=null,F=[],I=new Map,Ht=()=>{for(let e of I.values())try{e.destroy()}catch{}I.clear()},Ut=e=>{I.get(e)?.destroy(),I.set(e,ae(e))},Wt=e=>{I.get(e)?.destroy(),I.delete(e)},L=new Map,Gt=new Map,R=new Map,z=new Map,typeof CSS<`u`&&(CSS.supports(`position-anchor: --cw-anchor-test`)||CSS.supports(`anchor-name: --cw-anchor-test`)),B=`important`,Kt=()=>{let e=document.getElementById(`cw-unified-context-menu-style`);e||(e=document.createElement(`style`),e.id=`cw-unified-context-menu-style`,document.head.appendChild(e)),e.textContent=`
        .cw-context-menu-layer {
            position: fixed;
            inset: 0;
            z-index: var(--cw-context-menu-layer-z, ${zt});
            pointer-events: none;
        }
    ...
    `},qt=()=>{for(let e of F)try{e()}catch{}F=[]},Jt=e=>{for(let[t,n]of Array.from(R.entries()))t>=e&&(clearTimeout(n),R.delete(t));for(let[t,n]of Array.from(z.entries()))t>=e&&(clearTimeout(n),z.delete(t))},Yt=(e,t,n)=>{e.style.left=`${t}px`,e.style.top=`${n}px`;let r=e.getBoundingClientRect(),i=Math.max(8,window.innerWidth-r.width-8),a=Math.max(8,window.innerHeight-r.height-8);e.style.left=`${Math.min(Math.max(8,t),i)}px`,e.style.top=`${Math.min(Math.max(8,n),a)}px`},V=e=>{Jt(e);for(let[t,n]of Array.from(L.entries()))t>=e&&(Wt(n),n.remove(),L.delete(t),Gt.delete(t))},Xt=(e,t)=>{let n=t.getBoundingClientRect();Yt(e,Math.round(n.right+4),Math.round(n.top))},Zt=e=>{for(let[t,n]of Array.from(z.entries()))t>=e&&(clearTimeout(n),z.delete(t))},Qt=(e,t,n,r)=>{let i=document.createElement(`div`);i.className=`cw-context-menu${t?` cw-context-menu--compact`:``}`,i.setAttribute(`role`,`menu`),i.dataset.menuDepth=String(n),i.style.zIndex=String(n+1);let a=document.createElement(`ul`);a.className=`cw-context-menu__list`,Pt(a),i.appendChild(a);let o=(e,n,i)=>{if(r!==M||!P?.isConnected||!N?.isConnected||(V(i),!e.children?.length))return;let a=Qt(e.children,t,i,r);a.classList.add(`cw-context-menu--submenu`),N.appendChild(a),L.set(i,a),Gt.set(i,n),Xt(a,n),Ut(a)},s=(e,t,n)=>{let r=R.get(n);r&&clearTimeout(r),Zt(n);let i=setTimeout(()=>{R.delete(n),o(e,t,n)},Bt);R.set(n,i)},c=e=>{let t=z.get(e);t&&clearTimeout(t);let n=setTimeout(()=>{z.delete(e),V(e)},Vt);z.set(e,n)};for(let t of e){let e=document.createElement(`button`);e.type=`button`,e.className=`cw-context-menu__item${t.danger?` cw-context-menu__item--danger`:``}`,e.setAttribute(`role`,`menuitem`),e.disabled=!!t.disabled;let i=!!t.children?.length,l=document.createElement(`span`);l.className=`cw-context-menu__icon`,t.icon&&Rt(l,t.icon);let u=document.createElement(`span`);u.className=`cw-context-menu__label`,u.textContent=t.label;let d=document.createElement(`span`);if(d.className=`cw-context-menu__chevron`,i&&Rt(d,`caret-right`),e.append(l,u,d),It(e,!!t.danger),i){let i=n+1;e.setAttribute(`aria-haspopup`,`menu`),e.addEventListener(`pointerenter`,()=>s(t,e,i)),e.addEventListener(`pointerleave`,()=>c(i)),e.addEventListener(`click`,n=>{if(n.preventDefault(),n.stopPropagation(),r!==M||!P?.isConnected)return;Zt(i);let a=L.get(i),s=Gt.get(i);if(a?.isConnected&&s===e){V(i);return}o(t,e,i)})}else e.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation(),!(r!==M||!P?.isConnected)&&(H(),!t.disabled&&await t.action())});let f=document.createElement(`li`);Ft(f),f.appendChild(e),a.appendChild(f)}return Nt(i,t),i.addEventListener(`pointerenter`,()=>Zt(n)),i.addEventListener(`pointerleave`,()=>{if(n>0){let e=z.get(n);e&&clearTimeout(e);let t=setTimeout(()=>{z.delete(n),V(n)},Vt);z.set(n,t)}}),i},H=()=>{qt(),Jt(0),V(1),L.clear(),Gt.clear(),Ht(),P?.remove(),P=null,N?.remove(),N=null,M+=1},$t=e=>{let t=(e.items||[]).filter(e=>e&&e.id&&e.label);if(!t.length){H();return}Kt(),H();let n=M,r=e.resolveOverlayMountPoint?.(e.anchor??null)??se(e.anchor??null),i=document.createElement(`div`);i.className=`cw-context-menu-layer`,i.style.setProperty(`position`,`fixed`,B),i.style.setProperty(`inset`,`0`,B),i.style.setProperty(`z-index`,zt,B),i.style.setProperty(`pointer-events`,`none`,B),i.style.setProperty(`backdrop-filter`,`none`,B),i.style.setProperty(`-webkit-backdrop-filter`,`none`,B),N=i,r.appendChild(i);let a=Qt(t,!!e.compact,0,n);P=a,i.appendChild(a),Yt(a,e.x,e.y),Ut(a);let o=()=>{n!==M||!a.isConnected||Lt(a)},s=typeof customElements<`u`&&customElements.whenDefined?customElements.whenDefined(`ui-icon`).then(o).catch(()=>{}):Promise.resolve();queueMicrotask(()=>{s.then(o),requestAnimationFrame(()=>{o(),requestAnimationFrame(o)})});let c=e=>{if(!N?.isConnected||!P)return!1;let t=typeof e.composedPath==`function`?e.composedPath():[],n=Array.isArray(t)&&t.length?t:[];for(let e of n)if(e instanceof Element&&(e===N||e===P||N.contains(e)||e.classList?.contains?.(`cw-context-menu`)||e.closest?.(`.cw-context-menu`)))return!0;let r=e.target;return!!(r instanceof Node&&N.contains(r)||r instanceof Element&&r.closest?.(`.cw-context-menu`))},l=e=>{n!==M||!N?.isConnected||c(e)||H()},u=e=>{if(n!==M||!P?.isConnected)return;let t=e.target;if(!t)return;let r=t.closest?.(`.cw-context-menu__item`);if(!r&&typeof e.composedPath==`function`){for(let t of e.composedPath())if(t instanceof Element&&t.classList?.contains?.(`cw-context-menu__item`)){r=t;break}}if(!r){V(1);return}r.getAttribute(`aria-haspopup`)!==`menu`&&V(1)},d=e=>{n===M&&e.key===`Escape`&&H()},f=()=>H();queueMicrotask(()=>{n===M&&(document.addEventListener(`pointerdown`,l,{capture:!0}),document.addEventListener(`contextmenu`,l,{capture:!0}),document.addEventListener(`keydown`,d),a.addEventListener(`click`,u,{capture:!0}),window.addEventListener(`resize`,f,{passive:!0}),window.addEventListener(`blur`,f,{passive:!0}),F.push(()=>document.removeEventListener(`pointerdown`,l,{capture:!0})),F.push(()=>document.removeEventListener(`contextmenu`,l,{capture:!0})),F.push(()=>document.removeEventListener(`keydown`,d)),F.push(()=>a.removeEventListener(`click`,u,{capture:!0})),F.push(()=>window.removeEventListener(`resize`,f)),F.push(()=>window.removeEventListener(`blur`,f)))})}})),tn,nn=e((()=>{tn=`/*
...
@layer ui-taskbar {
  ...
  */
  ...
  .env-shell-taskbar__pins [data-env-home] {
    ...
    background-color: color-mix(in oklab, var(--base-color, #1c1c1e) 10%, transparent);
  }
  :has(ui-window:not([minimized])) .env-shell-taskbar__pins [data-env-home] {
    --color-surface: light-dark(--u2-color-mod(var(--base-color-neutralized), 10), --u2-color-mod(var(--base-color-neutralized), 980));
    background-color: color-mix(in oklab, var(--color-surface, #1c1c1e) 10%, transparent);
    color: contrast-color(var(--color-surface, #1c1c1e));
    --icon-color: contrast-color(var(--color-surface, #1c1c1e));
  }
  .env-shell-taskbar__windows {
    flex: 1 1 auto;
    justify-content: flex-start;
...
}`}));function rn(e){return`${fn}${String(e||``).trim().toLowerCase()}`}function an(){let e=document.querySelector(`.env-shell-chrome`);return e instanceof HTMLElement&&e.hasAttribute(`data-desktop`)?!1:e instanceof HTMLElement&&e.dataset.chromeLayout===`mobile`||typeof matchMedia==`function`&&matchMedia(`(max-width: 640px)`).matches}function on(e=new Date){return{time:e.toLocaleTimeString(void 0,{hour:`2-digit`,minute:`2-digit`}),date:e.toLocaleDateString(void 0,{weekday:`short`,day:`numeric`,month:`short`})}}function sn(e){let t=ee([]);oe(t),re(un,t,{title:`Home`,icon:`house-line`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`home`,e.onHome()}),re(dn,t,{title:`Markdown`,icon:`article`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`viewer`,e.onViewer()});let n=document.createElement(`ui-taskbar`);n.className=`env-shell-taskbar wf-chrome-no-select`,n.setAttribute(`part`,`taskbar`),n.setAttribute(`data-type`,`desktop`);let r=document.createElement(`div`);r.className=`env-shell-taskbar__pins`;let i=document.createElement(`div`);i.className=`env-shell-taskbar__windows`;let a=document.createElement(`ui-task`);a.setAttribute(`title`,`Home`),a.setAttribute(`icon`,`house-line`),a.setAttribute(`data-id`,un),a.setAttribute(`data-env-home`,``),a.setAttribute(`aria-label`,`Home`),a.setAttribute(`aria-haspopup`,`menu`),a.setAttribute(`aria-keyshortcuts`,`LongPress`),r.append(a);let s=document.createElement(`div`);s.className=`env-shell-taskbar__tray-host`;let c=document.createElement(`div`);c.className=`env-shell-taskbar__clock`,c.setAttribute(`role`,`button`),c.setAttribute(`tabindex`,`0`),c.setAttribute(`aria-label`,`Calendar`),c.setAttribute(`aria-haspopup`,`dialog`),c.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let l=document.createElement(`span`);l.className=`env-shell-taskbar__clock-time`;let u=document.createElement(`span`);u.className=`env-shell-taskbar__clock-date`,c.append(l,u);let d=()=>{let{time:e,date:t}=on();l.textContent=e,u.textContent=t,c.title=`${e} · ${t}`};d();let f=setInterval(d,mn),p=Et(e.device,`env-device-tray env-device-tray--taskbar`);p.setAttribute(`role`,`button`),p.setAttribute(`tabindex`,`0`),p.setAttribute(`aria-label`,`Quick settings`),p.setAttribute(`aria-haspopup`,`dialog`),p.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`);let te=e=>{e.preventDefault(),e.stopPropagation(),ke(c)},ne=e=>{e.preventDefault(),e.stopPropagation(),Be(p)};c.addEventListener(`click`,te),c.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&te(e)}),p.addEventListener(`click`,ne),p.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&ne(e)}),s.append(p,c);let m=document.createElement(`div`);m.className=`env-shell-navbar__switcher`,m.setAttribute(`role`,`menu`),m.setAttribute(`aria-label`,`Open apps`),m.hidden=!0;let h=document.createElement(`ul`);h.className=`env-shell-navbar__switcher-list`,m.appendChild(h),n.append(r,i,s,m);let g=new Map,_=[],v=null,y=!1,b=!1,x=null,S=[];S.push(()=>clearInterval(f));let se=e=>_.find(t=>String(t.id||``).trim().toLowerCase()===e),C=t=>{let n=String(t||``).trim().toLowerCase();if(!n)return;let r=se(n),i=String(e.focusedTaskId.value||``).trim().toLowerCase(),a=!!r?.focused||i===n||i===`markdown`&&n===`viewer`||i===`viewer`&&(n===`viewer`||n===`markdown`);if(r?.minimized){r.minimized=!1,r.focused=!0,g.get(n)?.toggleAttribute(`data-minimized`,!1),e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n);return}if(a&&r&&r.visible!==!1){r.minimized=!0,r.focused=!1,g.get(n)?.toggleAttribute(`data-minimized`,!0),e.onMinimizeWindow?.(n);return}e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n)},w=(t,r,i)=>{if(an())return;t.preventDefault(),t.stopPropagation();let a=String(r||``).trim().toLowerCase(),o=!!se(a)?.minimized,s=[{id:o?`restore`:`minimize`,label:o?`Restore`:`Minimize`,icon:o?`arrow-square-out`:`minus`,action:()=>{o?(e.focusedTaskId.value=a,e.onWindowTask?.(a)):e.onMinimizeWindow?.(a)}},{id:`close`,label:`Close`,icon:`x`,danger:!0,action:()=>e.onCloseWindow?.(a)}];$t({x:t.clientX,y:t.clientY,compact:!0,anchor:t.target instanceof Element?t.target:n,items:s})};n.addEventListener(`contextmenu`,t=>{if(an())return;let r=typeof t.composedPath==`function`?t.composedPath():[];for(let e of r)if(e instanceof Element&&e.closest?.(`ui-task`))return;t.preventDefault(),t.stopPropagation(),$t({x:t.clientX,y:t.clientY,compact:!0,anchor:n,items:[{id:`show-desktop`,label:`Show desktop`,icon:`desktop`,action:()=>e.onHome()},{id:`home`,label:`Home`,icon:`house-line`,action:()=>e.onHome()}]})});let T=()=>{b=!1,m.hidden=!0,h.replaceChildren(),n.removeAttribute(`data-switcher-open`)},E=()=>{let r=_.filter(e=>String(e.id||``).trim());if(h.replaceChildren(),r.length)for(let n of r){let r=String(n.id||``).trim().toLowerCase(),i=document.createElement(`li`);i.className=`env-shell-navbar__switcher-row`,i.setAttribute(`role`,`none`);let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-navbar__switcher-item`,a.setAttribute(`role`,`menuitem`),a.toggleAttribute(`data-active`,!!n.focused&&!n.minimized),a.toggleAttribute(`data-minimized`,!!n.minimized);let o=document.createElement(`ui-icon`);o.setAttribute(`icon`,n.icon||`app-window`),o.setAttribute(`icon-style`,`duotone`),o.setAttribute(`aria-hidden`,`true`);let s=document.createElement(`span`);s.className=`env-shell-navbar__switcher-label`,s.textContent=n.title||r,a.append(o,s),a.addEventListener(`click`,n=>{n.preventDefault(),n.stopPropagation(),T(),e.focusedTaskId.value=r;let i=rn(r),a=ie(t,i);a?a.focus=!0:e.onWindowTask?.(r)});let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-navbar__switcher-close`,c.setAttribute(`aria-label`,`Close ${n.title||r}`),c.title=`Close`;let l=document.createElement(`ui-icon`);l.setAttribute(`icon`,`x`),l.setAttribute(`icon-style`,`bold`),l.setAttribute(`aria-hidden`,`true`),c.appendChild(l),c.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.onCloseWindow?.(r),_=_.filter(e=>String(e.id||``).trim().toLowerCase()!==r),g.get(r)?.remove(),g.delete(r),_.length?E():T()}),i.append(a,c),h.appendChild(i)}else{let e=document.createElement(`li`);e.className=`env-shell-navbar__switcher-empty`,e.textContent=`No open apps`,h.appendChild(e)}b=!0,m.hidden=!1,n.setAttribute(`data-switcher-open`,``)},D=()=>{v!=null&&(clearTimeout(v),v=null)},ce=()=>{T(),ie(t,un).focus=!0};a.addEventListener(`click`,e=>{if(y){e.preventDefault(),e.stopPropagation(),y=!1;return}ce()}),a.addEventListener(`pointerdown`,e=>{if(an()&&!(e.button!=null&&e.button!==0)){y=!1,D(),v=setTimeout(()=>{v=null,y=!0;try{a.releasePointerCapture?.(e.pointerId)}catch{}E()},pn);try{a.setPointerCapture?.(e.pointerId)}catch{}}},{capture:!0});let O=()=>{D()};a.addEventListener(`pointerup`,O,{capture:!0}),a.addEventListener(`pointercancel`,O,{capture:!0}),a.addEventListener(`contextmenu`,e=>{an()&&(e.preventDefault(),y=!0,D(),E())});let k=e=>{if(!b)return;let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t)if(e===m||e===a||e instanceof Element&&(e===m||m.contains(e)||e===a))return;T()};document.addEventListener(`pointerdown`,k,{capture:!0}),S.push(()=>document.removeEventListener(`pointerdown`,k,{capture:!0}));let A=()=>{let t=String(e.focusedTaskId.value||`home`),n=(e,t)=>{e.toggleAttribute(`data-env-active`,t),e.toggleAttribute(`data-active`,t),e.toggleAttribute(`data-focus`,t)};n(a,t===`home`);for(let[e,r]of g)n(r,t===e)};o(()=>{A()},[e.focusedTaskId],{triggerImmediately:!0});let le=e=>{let n=String(e.id||``).trim().toLowerCase();if(!n||n===`home`)return;let r=rn(n),a=e.title||n,o=String(e.icon||``).trim()||`app-window`,s=g.get(n);if(!s){let e=re(r,null,{title:a,icon:o},{viewId:n},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,C(n)});e.list=t,t.push(e),s=document.createElement(`ui-task`),s.setAttribute(`data-id`,r),s.setAttribute(`data-view`,n),s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),C(n)}),s.addEventListener(`contextmenu`,e=>{w(e,n,a)}),g.set(n,s),i.appendChild(s)}s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.toggleAttribute(`data-minimized`,!!e.minimized),s.hidden=e.visible===!1},ue=n=>{_=Array.isArray(n)?n.slice():[];let r=new Set;for(let t of n){let n=String(t.id||``).trim().toLowerCase();!n||n===`home`||(r.add(n),le(t),t.focused&&(e.focusedTaskId.value=n))}for(let[e,n]of[...g.entries()]){if(r.has(e))continue;let i=rn(e),a=ie(t,i);if(a){let e=t.indexOf(a);e>=0&&t.splice(e,1)}n.remove(),g.delete(e)}A(),b&&E()},de=n=>{let r=String(n||`home`).toLowerCase(),i=un;r===`viewer`||r===`markdown`?i=dn:r!==`home`&&(i=rn(r));let a=ie(t,i);if(a){for(let e of t)e!==a&&(e.active=!1);a.active=!0}e.focusedTaskId.value=r===`markdown`?`viewer`:r,A()},fe=()=>{an()?x&&=(x.destroy(),null):!x&&n.isConnected&&(x=ae(n,{className:`env-shell-taskbar-under`,shadowBlur:28,shadowOffsetY:8,shadowColor:`rgba(0, 0, 0, 0.4)`}))};queueMicrotask(fe);let pe=typeof matchMedia==`function`?matchMedia(`(min-width: 641px)`):null,me=()=>fe();return pe?.addEventListener?.(`change`,me),S.push(()=>pe?.removeEventListener?.(`change`,me)),{element:n,taskList:t,setFocusedTaskId:de,syncWindowTasks:ue,dispose:()=>{D(),T(),x?.destroy(),x=null;for(let e of S)try{e()}catch{}S.length=0,g.clear(),i.replaceChildren()}}}var cn,ln,un,dn,fn,pn,mn,hn=e((()=>{b(),y(),r(),en(),At(),Ie(),ht(),D(),nn(),u(),w(),cn=d(tn),ln=class extends E{constructor(){super()}styles=()=>cn;render=()=>s`<div part="taskbar" class="taskbar"><slot></slot></div>`},ln=C([v(`ui-taskbar`)],ln),un=`#env-home`,dn=`#env-viewer`,fn=`#env-win-`,pn=420,mn=3e4})),gn,_n=e((()=>{gn=`/**
 * Font Styles Index
 *
...
@layer ux-gridbox {
  ...
  .ui-gridlayout .ui-ws-item:not([data-layer=labels]) span {
    pointer-events: none;
    aspect-ratio: 1/1;
    inline-size: fit-content;
    block-size: fit-content;
...
@layer base {
  ...
  @media screen {
    ...
    *::after {
    ...
    :focus-visible {
      outline: none;
      box-shadow: 0 0 0 3px color-mix(in oklab, var(--color-primary, #0066cc) 35%, transparent);
...
.c-overlaying [data-axis] {
  pointer-events: auto;
}`}));function vn(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function yn(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function bn(e,t,n=`font/woff2`){if(Tn.has(t))return Tn.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return Tn.set(t,i),i}async function xn(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(En.has(o))return En.get(o);let s=vn(t),c=await bn(a?await yn(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),En.set(o,l),l}async function Sn(e){let t=e.map(e=>xn(e));return Promise.all(t)}async function Cn(){return Dn||(Dn=h(()=>import(`./font-registry-D4KJRdpC.js`),[],import.meta.url)?.catch?.(e=>{console.error(`Failed to load font registry:`,e)}),Dn)}async function wn(){let e=await Cn();return Sn(Object.values(e.fontRegistry))}var Tn,En,Dn,On=e((()=>{m(),Tn=new Map,En=new Map,Dn=null})),kn,An=e((()=>{kn=`@layer tokens, base, layout, utilities, shells, shell, views, view, viewer, components, ux-layer, markdown, essentials, print, print-breaks, overrides;
@layer components {
  button {
    display: inline-flex;
    align-items: center;
...
}`})),jn,Mn,Nn=e((()=>{On(),u(),_n(),An(),On(),jn=`
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
`,Mn=async e=>{await f(jn)?.catch(()=>void 0),await wn().catch(()=>void 0),await f(gn)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await f(kn)?.catch(()=>void 0)}})),Pn,Fn=e((()=>{Pn=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/*
 * Filename: _tokens.scss
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})),In,Ln,Rn,zn,Bn=e((()=>{D(),u(),y(),Fn(),w(),In=d(Pn),Ln=e=>{let t=``;if(typeof e==`string`)t=e;else if(typeof e==`object`&&e&&`value`in e){let n=e.value;t=n==null?``:String(n)}else e!=null&&typeof e!=`object`&&(t=String(e));(!t||t===`undefined`||t===`null`||t===`[object Object]`)&&(t=``);let n=t.trim().charAt(0);return n?n.toUpperCase():`?`},Rn=(e,t,n)=>{let r=e.getAttribute(t);return r!=null&&String(r).trim()?String(r).trim():n},zn=class extends E{title;icon;constructor(){super()}styles=()=>In;render=function(){let e=Rn(this,`title`,`Task`),t=Rn(this,`icon`,`app-window`),n=Ln(e);return s`
        ...
        `}},C([_({source:`attr`})],zn.prototype,`title`,void 0),C([_({source:`attr`})],zn.prototype,`icon`,void 0),zn=C([v(`ui-task`)],zn)})),Vn,Hn=e((()=>{Vn=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})),Un=e((()=>{u(),Hn(),d(Vn)})),Wn,Gn=e((()=>{Wn=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}
...
:host(ui-taskbar[data-type=mobile]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})),Kn=e((()=>{u(),Gn(),d(Wn)}));function qn(){try{return globalThis.navigator?.windowControlsOverlay??null}catch{return null}}function Jn(){if(typeof globalThis.matchMedia!=`function`)return`unknown`;try{if(globalThis.matchMedia(`(display-mode: window-controls-overlay)`).matches)return`window-controls-overlay`;if(globalThis.matchMedia(`(display-mode: fullscreen)`).matches)return`fullscreen`;if(globalThis.matchMedia(`(display-mode: standalone)`).matches)return`standalone`;if(globalThis.matchMedia(`(display-mode: minimal-ui)`).matches)return`minimal-ui`;if(globalThis.matchMedia(`(display-mode: browser)`).matches)return`browser`}catch{}return`unknown`}function Yn(e){if(!e?.visible||typeof e.getTitlebarAreaRect!=`function`)return null;try{let t=e.getTitlebarAreaRect();return t?{x:t.x,y:t.y,width:t.width,height:t.height}:null}catch{return null}}function Xn(e){let t=qn(),n=!!t?.visible,r=Jn(),i=n||r===`standalone`||r===`fullscreen`||r===`window-controls-overlay`||r===`minimal-ui`,a=`off`;return e&&(a=n?`wco`:i?`standalone`:`fallback`),{requested:e,wcoVisible:n,displayMode:r,titlebarRect:Yn(t),isStandaloneLike:i,surface:a}}function Zn(e){let t=()=>{e.onChange(Xn(e.getRequested()))},n=[];if(typeof globalThis.matchMedia==`function`)for(let e of[`(display-mode: window-controls-overlay)`,`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`])try{n.push(globalThis.matchMedia(e))}catch{}let r=()=>t();for(let e of n)try{e.addEventListener?.(`change`,r)}catch{try{e.addListener?.(r)}catch{}}let i=qn(),a=()=>t();try{i?.addEventListener?.(`geometrychange`,a)}catch{}return queueMicrotask(t),()=>{for(let e of n)try{e.removeEventListener?.(`change`,r)}catch{try{e.removeListener?.(r)}catch{}}try{i?.removeEventListener?.(`geometrychange`,a)}catch{}}}var Qn=e((()=>{})),U,$n,er,W,G,tr,nr,K,rr,q,ir,ar,J,or,sr,cr,Y,lr,ur,dr,X,Z,fr,Q,pr,mr=e((()=>{U=null,$n=null,er=null,W=[],G=null,tr=0,nr=null,K=`#cbb8a4`,rr=`__CWSP_NATIVE_THEME_COLOR_OWNED__`,q=e=>{let t=String(e||``).trim().toLowerCase();if(!t)return!1;if(t===`#007acc`||t===`#007accff`||t===`#36c`||t===`#3366cc`)return!0;let n=t.match(/^rgba?\(\s*([\d.]+)\s*[, ]\s*([\d.]+)\s*[, ]\s*([\d.]+)/i);if(n&&(t?.startsWith?.(`#`)||t?.startsWith?.(`rgb`))){let e=Math.round(Number(n[1])),t=Math.round(Number(n[2])),r=Math.round(Number(n[3]));if(e<=20&&t>=100&&t<=140&&r>=180&&r<=220)return!0}return!1},ir=()=>{try{return!!globalThis?.[rr]}catch{return!1}},ar=e=>{G=e;try{globalThis[rr]=!!e}catch{}},J=e=>{if(!e||!e.isConnected||e.hasAttribute(`minimized`))return!1;if(e.hasAttribute(`native-mode`))return!0;let t=e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`);if(!t)return!1;try{let t=e.getBoundingClientRect(),n=Math.max(1,globalThis.innerWidth||1),r=Math.max(1,globalThis.innerHeight||1);return t.top<=8&&t.left<=8&&t.width>=n*.92&&t.height>=r*.85}catch{return t}},or=()=>{if(typeof document>`u`)return null;if(G?.isConnected&&J(G))return G;let e=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized])`));if(e.length)return e[e.length-1];let t=Array.from(document.querySelectorAll(`ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`));for(let e=t.length-1;e>=0;e--){let n=t[e];if(J(n))return n}return null},sr=()=>{$n||typeof MutationObserver>`u`||typeof document>`u`||($n=new MutationObserver(()=>{let e=or();e?.isConnected?Q(e):Z()}),$n.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`class`,`style`,`color-scheme`]}))},cr=e=>{er||typeof MutationObserver>`u`||(er=new MutationObserver(()=>{if(!ir())return;let t=(e.getAttribute(`content`)||``).toLowerCase(),n=(nr||``).toLowerCase();if(n&&t===n&&!q(t))return;let r=or();r?Q(r):q(t)&&X(K,!0)}),er.observe(e,{attributes:!0,attributeFilter:[`content`]}))},Y=e=>e,lr=()=>{if(typeof document>`u`)return null;let e=document.querySelector(`meta[data-theme-color]`)||document.querySelector(`meta[name="theme-color"]`);e||(e=document.createElement(`meta`),e.setAttribute(`name`,`theme-color`),e.setAttribute(`data-theme-color`,``),document.head?.appendChild(e));try{let t=Array.from(document.querySelectorAll(`meta[name="theme-color"]`));for(let n of t)n!==e&&n.remove()}catch{}return cr(e),e},ur=(e,t)=>{try{let n=document.createElement(`div`);n.setAttribute(`data-theme-color-probe`,`true`),n.style.cssText=`position:fixed;left:-8px;top:-8px;inline-size:4px;block-size:4px;pointer-events:none;opacity:0;background:${t}`,e.appendChild(n);let r=Y(getComputedStyle(n).backgroundColor);return n.remove(),r}catch{return null}},dr=e=>{let t=e.shadowRoot?.querySelector(`.title-handler`);if(t){let e=ur(t,`var(--ui-win-titlebar-bg, var(--color-surface-container, Canvas))`);if(e)return e;let n=Y(getComputedStyle(t).backgroundColor);if(n)return n}let n=getComputedStyle(e);for(let t of[`--ui-win-titlebar-bg`,`--color-surface-container`,`--color-surface`]){let r=ur(e,`var(${t})`);if(r)return r;let i=n.getPropertyValue(t).trim();if(!i)continue;let a=Y(i);if(a)return a}let r=getComputedStyle(document.documentElement);for(let e of[`--color-surface-container`,`--color-surface`,`--color-surface-container-low`]){let t=ur(document.documentElement,`var(${e})`)||Y(r.getPropertyValue(e).trim());if(t)return t}return null},X=(e,t=!1)=>{let n=lr();if(!n||!e)return;let r=e.toLowerCase();q(r)&&(r=K);let i=(n.getAttribute(`content`)||``).toLowerCase();if(!(i===r&&!t&&!q(i))&&(n.setAttribute(`content`,r),n.setAttribute(`data-theme-color`,``),n.removeAttribute(`media`),nr=r,t||i!==r||q(i)))try{let e=n.parentNode||document.head;e?.removeChild(n),e?.appendChild(n)}catch{}},Z=()=>{if(typeof document>`u`||or())return;ar(null),nr=null;let e=lr();if(!e)return;let t=document.documentElement,n=getComputedStyle(t),r=document.body?getComputedStyle(document.body):null,i=Y(n.getPropertyValue(`--color-surface-container`).trim())||Y(n.getPropertyValue(`--color-surface`).trim())||Y(n.getPropertyValue(`--ui-win-titlebar-bg`).trim())||(r?Y(r.backgroundColor):null)||Y(n.backgroundColor);i?X(i):q(String(e.getAttribute(`content`)||``))&&X(K,!0),sr()},fr=e=>e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`),Q=e=>{if(!e||typeof document>`u`||e.hasAttribute(`minimized`)||!e.hasAttribute(`native-mode`)&&!fr(e)&&!J(e))return;let t=lr();if(!t)return;if(U==null){let e=t.getAttribute(`content`)||``;U=q(e)?``:e}ar(e),q(String(t.getAttribute(`content`)||``))&&X(K,!0);let n=++tr,r=(t=!1)=>{if(n!==tr||!e.isConnected||!e.hasAttribute(`native-mode`)&&!fr(e)&&!J(e))return;let r=dr(e)||K;X(r,t)};r(!0),requestAnimationFrame(()=>{r(!1),requestAnimationFrame(()=>r(!0))});for(let e of W)clearTimeout(e);W=[],W.push(setTimeout(()=>r(!0),50),setTimeout(()=>r(!0),160),setTimeout(()=>r(!0),400)),sr()},pr=e=>{if(typeof document>`u`||!document.querySelector(`meta[name="theme-color"]`))return;let t=or();if(t&&t!==e){Q(t);return}let n=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized]), ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`)).filter(t=>t!==e&&J(t));if(n.length){Q(n[n.length-1]);return}ar(null),nr=null,tr+=1;for(let e of W)clearTimeout(e);W=[],U!=null&&U&&!q(U)?(X(U,!0),U=null):(U=null,Z())},typeof document<`u`&&queueMicrotask(()=>{try{Z()}catch{}})})),hr,gr=e((()=>{hr=`/*
...
:host(ui-window) {
  ...
  --ui-win-titlebar-bg: var(--color-surface-container, light-dark(
      --u2-color-mod(var(--ui-win-seed), 20),
      --u2-color-mod(var(--ui-win-seed), 980)
  ));
...
.window-resizer:hover {
  opacity: 0.9;
}`})),_r,vr,yr,br,xr,Sr,$,Cr=e((()=>{y(),u(),D(),b(),Qn(),mr(),gr(),w(),_r=d(hr),vr=`minus`,yr=`corners-out`,br=`corners-in`,xr=`x`,Sr=Object.freeze({w:240,h:160}),$=class extends T{titleHandler;contentHandler;footerHandler;resizer;#e=l(0);#t=l(0);#n=null;#r=null;#i=null;#a=null;#o=null;#s=null;#c=null;#l=!1;#u=0;#d=0;#f=null;styles=function(){return _r};render=function(){return s`<div class="window-container" part="window-container">
        ...
        </div>`};constructor(){super()}get managed(){return this.hasAttribute(`managed`)}get nativeMode(){return this.hasAttribute(`native-mode`)}set nativeMode(e){this.toggleAttribute(`native-mode`,!!e),this.#h()}get nativeSurface(){return this.#f?.surface??(this.nativeMode?`fallback`:`off`)}onInitialize(){super.onInitialize()}onRender(){super.onRender(),this.#p()}connectedCallback(){super.connectedCallback?.(),this.#p(),this.#m()}disconnectedCallback(){this.#s?.(),this.#s=null,this.#c?.disconnect(),this.#c=null,this.#o?.disconnect(),this.#o=null,this.#a?.(),this.#a=null,this.#l=!1,this.#u=0,this.#i?.(),this.#i=null,this.#n?.(),this.#n=null,this.#r?.(),this.#r=null,super.disconnectedCallback?.()}#p(){let e=()=>{this.#E(),this.#b(),this.#D(),this.#O(),this.#h(),this.#u<20&&(this.#u+=1,(!this.#l||this.#u<8)&&requestAnimationFrame(e))};queueMicrotask(e)}#m(){this.#s||(this.#s=Zn({getRequested:()=>this.nativeMode,onChange:e=>this.#g(e)}),typeof MutationObserver<`u`&&!this.#c&&(this.#c=new MutationObserver(e=>{let t=!1,n=!1;for(let r of e)r.attributeName===`native-mode`&&(t=!0),(r.attributeName===`maximized`||r.attributeName===`data-desk-max`||r.attributeName===`data-mobile-max`)&&(n=!0);(t||n)&&this.#h(),n&&this.#v()}),this.#c.observe(this,{attributes:!0,attributeFilter:[`native-mode`,`maximized`,`data-desk-max`,`data-mobile-max`]})))}#h(){this.#g(Xn(this.nativeMode))}#g(e){this.#f=e;let t=this;t.toggleAttribute(`data-native-wco`,e.surface===`wco`),t.toggleAttribute(`data-native-standalone`,e.surface===`standalone`),t.toggleAttribute(`data-native-fallback`,e.surface===`fallback`),t.toggleAttribute(`data-native-active`,e.surface!==`off`),this.#_(e.surface),e.titlebarRect?(t.style.setProperty(`--ui-win-titlebar-area-x`,`${e.titlebarRect.x}px`),t.style.setProperty(`--ui-win-titlebar-area-y`,`${e.titlebarRect.y}px`),t.style.setProperty(`--ui-win-titlebar-area-width`,`${e.titlebarRect.width}px`),t.style.setProperty(`--ui-win-titlebar-area-height`,`${e.titlebarRect.height}px`)):(t.style.removeProperty(`--ui-win-titlebar-area-x`),t.style.removeProperty(`--ui-win-titlebar-area-y`),t.style.removeProperty(`--ui-win-titlebar-area-width`),t.style.removeProperty(`--ui-win-titlebar-area-height`)),this.#n?.(),this.#n=null,this.#r?.(),this.#r=null,this.#D(),this.#O(),this.#v(),this.nativeMode||this.hasAttribute(`data-desk-max`)||this.hasAttribute(`maximized`)||this.hasAttribute(`data-mobile-max`)?Q(this):(pr(this),Z()),this.dispatchEvent(new CustomEvent(`window-native-change`,{bubbles:!0,composed:!0,detail:e}))}#_(e=this.nativeSurface){let t=this.shadowRoot?.querySelector(`.title-exit-native`);t&&(t.hidden=e!==`standalone`)}#v(){let e=this.shadowRoot?.querySelector(`.title-maximize`),t=e?.querySelector(`ui-icon`);if(!e||!t)return;let n=!(this.nativeMode&&this.nativeSurface===`fallback`)&&(this.hasAttribute(`maximized`)||this.hasAttribute(`data-desk-max`)||this.hasAttribute(`data-mobile-max`)),r=n?br:yr,i=n?`Restore`:`Maximize`;t.getAttribute(`icon`)!==r&&t.setAttribute(`icon`,r),e.setAttribute(`aria-label`,i),e.setAttribute(`title`,i)}applyBounds(e){let t=this;t.style.position=`absolute`,typeof e.x==`number`&&(t.style.left=`${e.x}px`),typeof e.y==`number`&&(t.style.top=`${e.y}px`),typeof e.w==`number`&&(t.style.width=`${e.w}px`,t.style.setProperty(`--ui-win-width`,`${e.w}px`)),typeof e.h==`number`&&(t.style.height=`${e.h}px`,t.style.setProperty(`--ui-win-height`,`${e.h}px`)),typeof e.z==`number`&&(t.style.zIndex=String(e.z)),t.style.right=``,t.style.bottom=``,this.managed&&(this.#e.value=0,this.#t.value=0,t.style.transform=``)}setVisible(e){this.toggleAttribute(`hidden-window`,!e),this.style.visibility=e?``:`hidden`,this.style.pointerEvents=e?``:`none`}get isMaximized(){return this.hasAttribute(`maximized`)||this.hasAttribute(`data-desk-max`)||this.hasAttribute(`data-mobile-max`)}get isMinimized(){return this.hasAttribute(`minimized`)}get usesNativeWindowDrag(){let e=this.nativeSurface;return e===`wco`||e===`standalone`}enterNativeMode(){if(this.managed){this.#y(`window-native`);return}this.nativeMode=!0,this.#y(`window-native`)}exitNativeMode(){if(this.managed){this.#y(`window-exit-native`);return}this.nativeMode=!1,this.#y(`window-exit-native`)}#y(e,t=!1){return this.dispatchEvent(new CustomEvent(e,{bubbles:!0,composed:!0,cancelable:t}))}toggleMaximize(){let e=this.isMaximized;if(this.managed){this.#y(e?`window-restore`:`window-maximize`);return}let t=!e;this.toggleAttribute(`maximized`,t),t&&this.removeAttribute(`minimized`),this.#v(),this.#y(t?`window-maximize`:`window-restore`)}toggleMinimize(){if(this.managed){this.#y(this.isMinimized?`window-restore`:`window-minimize`);return}let e=!this.isMinimized;this.toggleAttribute(`minimized`,e),e&&this.removeAttribute(`maximized`),this.#y(e?`window-minimize`:`window-restore`)}restoreWindow(){if(this.managed){this.#y(`window-restore`);return}let e=this.isMinimized,t=this.isMaximized;this.removeAttribute(`minimized`),this.removeAttribute(`maximized`),(e||t)&&this.#y(`window-restore`)}closeWindow(){this.#y(`window-close`,!0),this.isConnected&&this.remove()}#b(){this.#i||=a(this,`pointerdown`,()=>{this.requestFocus()},{capture:!0,passive:!0})}requestFocus(){this.dispatchEvent(new CustomEvent(`window-focus`,{bubbles:!0,composed:!0}))}bringToFront(e){let t=this;Number.isFinite(e)&&(t.style.zIndex=String(e)),t.toggleAttribute(`data-focused`,!0)}clearFocused(){this.toggleAttribute(`data-focused`,!1)}#x(e){let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t){if(!(e instanceof Element))continue;let t=e.getAttribute?.(`data-ui-win-action`);if(t===`close`||t===`exit-native`||t===`maximize`||t===`minimize`)return t;if(e.matches?.(`.title-close`))return`close`;if(e.matches?.(`.title-exit-native`))return`exit-native`;if(e.matches?.(`.title-maximize`))return`maximize`;if(e.matches?.(`.title-minimize`))return`minimize`}let n=e.target;if(n instanceof Element){let e=n.closest?.(`[data-ui-win-action], .title-close, .title-exit-native, .title-maximize, .title-minimize`)??null;if(!e)return null;let t=e.getAttribute(`data-ui-win-action`);if(t===`close`||t===`exit-native`||t===`maximize`||t===`minimize`)return t;if(e.classList.contains(`title-close`))return`close`;if(e.classList.contains(`title-exit-native`))return`exit-native`;if(e.classList.contains(`title-maximize`))return`maximize`;if(e.classList.contains(`title-minimize`))return`minimize`}return null}#S(){let e=typeof performance<`u`?performance.now():Date.now();return e-this.#d<280?!1:(this.#d=e,!0)}#C(e){e===`close`?this.closeWindow():e===`exit-native`?this.exitNativeMode():e===`maximize`?this.nativeMode&&this.nativeSurface===`fallback`?this.exitNativeMode():this.toggleMaximize():this.toggleMinimize()}#w(e){let t=this.#x(e);return t?(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation?.(),this.#S()&&this.#C(t),!0):!1}#T(){let e=this.shadowRoot;if(e)for(let[t,n]of[[`minimize`,`.title-minimize`],[`maximize`,`.title-maximize`],[`close`,`.title-close`],[`exit-native`,`.title-exit-native`]]){let r=e.querySelector(n);if(!r)continue;r.setAttribute(`data-ui-win-action`,t);let i=e=>{e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation?.(),this.#S()&&this.#C(t)};r.onclick=i,r.onpointerup=e=>{e.button===0&&i(e)}}}#E(){let e=this.shadowRoot;if(!e)return;let t=this.titleHandler??e.querySelector(`.title-handler`),n=e.querySelector(`.title-handler-buttons`);if(!t||!n)return;if(this.#T(),this.#l){this.#_(),this.#v();return}let r=e=>{this.#w(e)},i=e=>{this.#x(e)||(typeof e.composedPath==`function`?e.composedPath():[]).some(e=>e instanceof Element&&e.classList?.contains(`title-handler`))&&(e.target?.closest?.(`button, a, input, textarea, select, [data-no-drag]`)||(e.preventDefault(),this.#S()&&this.toggleMaximize()))},o=a(e,`click`,r,{capture:!0}),s=a(e,`pointerup`,r,{capture:!0}),c=a(this,`click`,r,{capture:!0}),l=a(this,`pointerup`,r,{capture:!0}),u=a(this,`dblclick`,i,{capture:!0});typeof MutationObserver<`u`&&!this.#o&&(this.#o=new MutationObserver(()=>{this.#T(),this.#_(),this.#v()}),this.#o.observe(e,{childList:!0,subtree:!0})),this.#a=()=>{o?.(),s?.(),c?.(),l?.(),u?.(),this.#o?.disconnect(),this.#o=null,this.#a=null,this.#l=!1},this.#l=!0,this.#u=0,this.#_(),this.#v()}#D(){let e=this.shadowRoot??this,t=this.titleHandler??e.querySelector?.(`.title-handler`);if(!t||this.#n)return;if(this.usesNativeWindowDrag){this.#n=()=>{this.#n=null};return}this.managed||i(this,c`transform: translate(${this.#e}px, ${this.#t}px)`);let n=new Map,r=a(t,`pointerdown`,e=>{if(e.button!==0||this.#x(e)||e.target?.closest(`button, a, input, textarea, select, [data-no-drag]`)||this.isMaximized||this.isMinimized||this.nativeMode)return;this.requestFocus();let t=this;n.set(e.pointerId,{sx:e.clientX,sy:e.clientY,ox:this.#e.value,oy:this.#t.value,bx:Number.parseFloat(t.style.left||`0`)||0,by:Number.parseFloat(t.style.top||`0`)||0,dragging:!1});let r=a(document.body,`pointermove`,e=>{let t=n.get(e.pointerId);if(!t)return;let r=e.clientX-t.sx,i=e.clientY-t.sy;if(!t.dragging){if(Math.hypot(r,i)<4)return;t.dragging=!0;try{e.preventDefault()}catch{}this.setPointerCapture?.(e.pointerId)}if(this.managed){this.dispatchEvent(new CustomEvent(`window-move`,{bubbles:!0,composed:!0,detail:{x:t.bx+r,y:t.by+i,dx:r,dy:i}}));return}this.#e.value=t.ox+r,this.#t.value=t.oy+i}),i=e=>{if(!n.has(e.pointerId))return;let t=n.get(e.pointerId);if(n.delete(e.pointerId),t?.dragging)try{this.releasePointerCapture?.(e.pointerId)}catch{}r?.(),o?.(),s?.()},o=a(document.body,`pointerup`,i),s=a(document.body,`pointercancel`,i)});this.#n=()=>{r?.()}}#O(){let e=this.shadowRoot??this,t=this.resizer??e.querySelector?.(`.window-resizer`);if(!t||this.#r)return;let n=new Map,r=a(t,`pointerdown`,e=>{if(e.button!==0||this.isMaximized||this.isMinimized||this.nativeMode)return;e.preventDefault(),e.stopPropagation(),this.requestFocus(),this.setPointerCapture?.(e.pointerId);let t=this.getBoundingClientRect();n.set(e.pointerId,{sx:e.clientX,sy:e.clientY,w:t.width,h:t.height});let r=a(document.body,`pointermove`,e=>{let t=n.get(e.pointerId);if(!t)return;let r=Math.max(Sr.w,t.w+(e.clientX-t.sx)),i=Math.max(Sr.h,t.h+(e.clientY-t.sy));if(this.managed){this.dispatchEvent(new CustomEvent(`window-resize`,{bubbles:!0,composed:!0,detail:{w:r,h:i}}));return}this.style.width=`${r}px`,this.style.height=`${i}px`,this.style.setProperty(`--ui-win-width`,`${r}px`),this.style.setProperty(`--ui-win-height`,`${i}px`)}),i=e=>{if(n.has(e.pointerId)){n.delete(e.pointerId);try{this.releasePointerCapture?.(e.pointerId)}catch{}r?.(),o?.(),s?.()}},o=a(document.body,`pointerup`,i),s=a(document.body,`pointercancel`,i)});this.#r=()=>{r?.()}}},C([_({source:`query`,name:`.title-handler`})],$.prototype,`titleHandler`,void 0),C([_({source:`query`,name:`.content-handler`})],$.prototype,`contentHandler`,void 0),C([_({source:`query`,name:`.footer-handler`})],$.prototype,`footerHandler`,void 0),C([_({source:`query`,name:`.window-resizer`})],$.prototype,`resizer`,void 0),$=C([v(`ui-window`)],$)})),wr=e((()=>{y()})),Tr=e((()=>{})),Er=e((()=>{r(),y()})),Dr=e((()=>{D(),At(),hn(),Bn(),Un(),Kn(),xe(),Ie(),ht(),Cr(),wr(),Tr(),Er()}));function Or(){return{...kr}}var kr,Ar=e((()=>{u(),_n(),Nn(),Dr(),kr={loadStyles:!0,includeGlobalNativeControlStyles:!1,styleVariant:`veela-basic`},(async()=>{let e=Or();e.loadStyles!==!1&&(await Mn({includeGlobalNativeControls:e.includeGlobalNativeControlStyles===!0}),await t(gn))})()?.catch?.(()=>void 0)}));export{D as _,St as a,vt as c,ht as d,st as f,T as g,ue as h,Tt as i,Dt as l,xe as m,hn as n,At as o,Ie as p,sn as r,yt as s,Ar as t,bt as u,C as v,w as y};