import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{B as t,F as n,L as r,M as i,P as a,R as o,W as s,et as c,it as l,j as ee,nt as u,ot as d,rt as te,t as f}from"./src-0dseTezJ.js";import{m as ne}from"./src-XPMlSw8I.js";import{n as re,t as ie}from"./preload-helper-NDuSAHbO.js";import{n as ae}from"./CSSIconRegistry-D88SYH0A.js";import{t as p}from"./src-DUnEbC_E.js";function oe(e){return{load(){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}},save(t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}},clear(){try{localStorage.removeItem(e)}catch{}}}}var se=e((()=>{})),m,h=e((()=>{m=`/**
 * Font Styles Index
 *
...
}`}));function ce(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function le(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function ue(e,t,n=`font/woff2`){if(_.has(t))return _.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return _.set(t,i),i}async function de(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(v.has(o))return v.get(o);let s=ce(t),c=await ue(a?await le(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),v.set(o,l),l}async function fe(e){let t=e.map(e=>de(e));return Promise.all(t)}async function pe(){return y||(y=ie(()=>import(`./font-registry-D4KJRdpC.js`),[],import.meta.url)?.catch?.(e=>{console.error(`Failed to load font registry:`,e)}),y)}async function g(){let e=await pe();return fe(Object.values(e.fontRegistry))}var _,v,y,b=e((()=>{re(),_=new Map,v=new Map,y=null})),x,me=e((()=>{x=`@layer tokens, base, layout, utilities, shells, shell, views, view, viewer, components, ux-layer, markdown, essentials, print, print-breaks, overrides;
@layer components {
  button {
    display: inline-flex;
    align-items: center;
...
}`})),S,C,he=e((()=>{b(),c(),h(),me(),b(),S=`
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
`,C=async e=>{await u(S)?.catch(()=>void 0),await g().catch(()=>void 0),await u(m)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await u(x)?.catch(()=>void 0)}}));function w(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var T=e((()=>{})),E,D,O=e((()=>{f(),p(),T(),E=class extends ee(){theme=`default`;render=function(){return n`<slot></slot>`};constructor(){super()}onRender(){return super.onRender()}connectedCallback(){return super.connectedCallback?.()??this}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(ae()),e}},w([a({source:`attr`})],E.prototype,`theme`,void 0),E=w([i(`ui-element`)],E),D=E})),k,ge=e((()=>{k=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
/* ==========================================================================
...
}`})),A,j,_e=e((()=>{O(),f(),ge(),c(),T(),A=l(k),j=class extends D{constructor(){super()}styles=()=>A;render=()=>n`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},j=w([i(`ui-statusbar`)],j)})),M,ve=e((()=>{M=`/* Taskbar */
@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
...
}`})),N,P,F=e((()=>{O(),f(),ve(),c(),T(),N=l(M),P=class extends D{constructor(){super()}styles=()=>N;render=()=>n`<div part="taskbar" class="taskbar"><slot></slot></div>`},P=w([i(`ui-taskbar`)],P)})),I,ye=e((()=>{I=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
/* ==========================================================================
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})),L,R,be=e((()=>{O(),c(),f(),ye(),T(),L=l(I),R=class extends D{title=`Task`;icon=`github`;constructor(){super()}styles=()=>L;render=function(){return n`
        ...
        `}},w([a({source:`attr`})],R.prototype,`title`,void 0),w([a({source:`attr`})],R.prototype,`icon`,void 0),R=w([i(`ui-task`)],R)})),z,xe=e((()=>{z=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}`})),Se=e((()=>{c(),xe(),l(z)})),B,V=e((()=>{B=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}
...
.window-resizer:hover {
  opacity: 0.9;
}`})),U,W,G,K,q,J,Te=e((()=>{f(),c(),O(),p(),we(),T(),U=l(H),W=`minus`,G=`corners-out`,K=`corners-in`,q=`x`,J=class extends E{titleHandler;contentHandler;footerHandler;#e=s(0);#t=s(0);#n=null;styles=function(){return U};render=function(){return n`<div class="window-container" part="window-container">
            <header class="title-handler" part="title-handler">
                ...
                <div class="title-handler-buttons" part="controls">
                    <button class="title-minimize" type="button" aria-label="Minimize" title="Minimize">
                        <ui-icon icon=${W}></ui-icon>
                    </button>
                    <button class="title-maximize" type="button" aria-label="Maximize" title="Maximize">
                        <span class="icon-maximize" aria-hidden="true"><ui-icon icon=${G}></ui-icon></span>
                        <span class="icon-restore" aria-hidden="true"><ui-icon icon=${K}></ui-icon></span>
                    </button>
        ...
        </div>`};constructor(){super()}onInitialize(){super.onInitialize()}onRender(){super.onRender(),this.style.display||=`block`,queueMicrotask(()=>{this.#r(),this.#i()})}toggleMaximize(){let e=!this.hasAttribute(`maximized`);this.toggleAttribute(`maximized`,e),e&&this.removeAttribute(`minimized`),this.dispatchEvent(new CustomEvent(e?`window-maximize`:`window-restore`,{bubbles:!0}))}toggleMinimize(){let e=!this.hasAttribute(`minimized`);this.toggleAttribute(`minimized`,e),e&&this.removeAttribute(`maximized`),this.dispatchEvent(new CustomEvent(e?`window-minimize`:`window-restore`,{bubbles:!0}))}closeWindow(){this.dispatchEvent(new CustomEvent(`window-close`,{bubbles:!0,cancelable:!0}))&&this.remove()}#r(){this.dataset?.flWinControls!==`1`&&(this.dataset.flWinControls=`1`,d(this,`click`,e=>{let t=e.target;if(!t)return;let n=typeof e.composedPath==`function`?e.composedPath():[],r=e=>t.closest?.(e)||n.find(t=>t instanceof Element&&t.matches?.(e));if(r(`.title-close`)){e.preventDefault(),this.closeWindow();return}if(r(`.title-maximize`)){e.preventDefault(),this.toggleMaximize();return}r(`.title-minimize`)&&(e.preventDefault(),this.toggleMinimize())}))}#i(){let e=this.shadowRoot??this,t=this.titleHandler??e.querySelector?.(`.title-handler`);if(!t||this.#n)return;let n=new Map;o(this,r`transform: translate(${this.#e}px, ${this.#t}px)`);let i=d(t,`pointerdown`,e=>{if(e.button!==0||e.target?.closest(`button, a, input, textarea, select, [data-no-drag]`)||this.hasAttribute(`maximized`))return;e.preventDefault(),this.setPointerCapture?.(e.pointerId),n.set(e.pointerId,{sx:e.clientX,sy:e.clientY,ox:this.#e.value,oy:this.#t.value});let t=d(document.body,`pointermove`,e=>{let t=n.get(e.pointerId);t&&(this.#e.value=t.ox+(e.clientX-t.sx),this.#t.value=t.oy+(e.clientY-t.sy))}),r=e=>{if(n.has(e.pointerId)){n.delete(e.pointerId);try{this.releasePointerCapture?.(e.pointerId)}catch{}t?.(),i?.(),a?.()}},i=d(document.body,`pointerup`,r),a=d(document.body,`pointercancel`,r)});this.#n=()=>{i?.()}}},w([a({source:`query`,name:`.title-handler`})],J.prototype,`titleHandler`,void 0),w([a({source:`query`,name:`.content-handler`})],J.prototype,`contentHandler`,void 0),w([a({source:`query`,name:`.footer-handler`})],J.prototype,`footerHandler`,void 0),J=w([i(`ui-window`)],J)})),Ee=e((()=>{f()})),De=e((()=>{})),Oe=e((()=>{t(),f()})),ke=e((()=>{O(),_e(),F(),be(),Se(),Ce(),Te(),Ee(),De(),Oe()}));function Ae(){return{...Y}}var Y,je=e((()=>{c(),h(),he(),ke(),Y={loadStyles:!0,includeGlobalNativeControlStyles:!1,styleVariant:`veela-basic`},(async()=>{let e=Ae();e.loadStyles!==!1&&(await C({includeGlobalNativeControls:e.includeGlobalNativeControlStyles===!0}),await te(m))})()?.catch?.(()=>void 0)}));function Me(e,t){let n=e??{},r=t??{};return{...n,...r,lifecycle:{...n.lifecycle,...r.lifecycle}}}function X(e,t,n){let r=Object.getOwnPropertyDescriptor(e,t),i=r?.value;Object.defineProperty(e,t,{configurable:!0,enumerable:r?.enumerable??!0,writable:!0,value:function(...e){let t=i?.apply(this,e),r=n.apply(this,e);return r===void 0?t??this:r}})}function Ne(e,t){for(let n of[`onInitialize`,`onMount`,`onUnmount`,`onShow`,`onHide`]){let r=t[n];typeof r==`function`&&X(e,n,r)}}function Pe(e,t){let n=e.prototype;t.initialization&&X(n,`onInitialize`,t.initialization),t.rendering&&X(n,`onRender`,t.rendering),t.render&&X(n,`render`,t.render),t.styles&&X(n,`styles`,t.styles),t.lifecycle&&Ne(n,t.lifecycle)}var Z,Q,$,Fe=e((()=>{ne(),je(),f(),T(),Z=new Map,Q=class extends E{__options;__initialized=!1;__viewChannel=null;set options(e){this.__options=e}get options(){return this.__options}get viewChannel(){return this.__viewChannel||=new EventTarget,this.__viewChannel}dispatchViewChannel(e,t,n){return this.viewChannel.dispatchEvent(new CustomEvent(e,{...n,detail:t}))}subscribeViewChannel(e,t){let n=this.viewChannel;return n.addEventListener(e,t),()=>n.removeEventListener(e,t)}viewInitialize(){let e=this.options;return e?.initializator?.call?.(this,this,e),this}constructor(){super()}onInitialize(){return super.onInitialize?.call?.(this),this?.viewInitialize?.call?.(this),this}},Q=w([i(`cw-view-base`)],Q),$=(e,t,n)=>{let r=typeof t==`function`?n??{}:Me(t,n??{}),a=r.extends?{extends:r.extends}:void 0,o;if(typeof t==`function`)o=t(Q);else{class e extends Q{constructor(){super()}}o=e}return i(e,a)(o),Pe(o,r),Z.set(e,o),o}}));export{se as i,Fe as n,oe as r,$ as t};