...
`,Mn=async e=>{await f(jn)?.catch(()=>void 0),await wn().catch(()=>void 0),await f(gn)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await f(kn)?.catch(()=>void 0)}})),Pn,Fn=e((()=>{Pn=`:host(ui-task), :host(ui-task) * {
  box-sizing: border-box;
  user-select: none;
  touch-action: manipulation;
  -webkit-user-drag: none;
