import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{B as t,F as n,V as r,t as i}from"./src-0dseTezJ.js";import{d as a,u as o}from"./registry-_H3MKUFS.js";import{n as s,t as c}from"./preload-helper-NDuSAHbO.js";import{i as l,n as u,r as d,t as f}from"./shells-DYH-ktVl.js";import{t as p}from"./src-DUnEbC_E.js";var m,h=e((()=>{m=`/* Minimal shell: layered tokens + nav/content grid, WCO-safe, shadow slot views. */
/*
    ...
    .app-shell__status {
      display: none !important;
...
}`}));function g(e){return y.has(e)}function _(e){return new b}var v,y,b,x=e((()=>{i(),t(),h(),p(),u(),o(),l(),s(),v=[{id:`viewer`,name:`Markdown`,icon:`eye`},{id:`explorer`,name:`Explorer`,icon:`folder`},{id:`workcenter`,name:`Work Center`,icon:`lightning`},{id:`network`,name:`Network`,icon:`wifi-high`},{id:`settings`,name:`Settings`,icon:`gear`},{id:`history`,name:`History`,icon:`clock-counter-clockwise`}].filter(e=>a(e.id)),y=new Set(v.map(e=>e.id)),b=class extends f{id=`minimal`;name=`Minimal`;layout={hasSidebar:!1,hasToolbar:!0,hasTabs:!1,supportsMultiView:!1,supportsWindowing:!1};createLayout(){let e=n`
        ...
        `;t.appendChild(r),r.addEventListener(`click`,()=>{try{window.dispatchEvent(new CustomEvent(`cwsp:open-connection-source`))}catch(e){console.warn(`[MinimalShell] connection source:`,e)}})}setupAdminDoorButton(e){let t=e.querySelector(`[data-shell-toolbar]`);if(!t||t.querySelector(`[data-admin-door]`))return;let r=n`
            ...
            >ADM</button>
        `;t.appendChild(r),r.addEventListener(`click`,()=>{c(async()=>{let{loadSettings:e}=await import(`./Settings-DSXJPUz6.js`).then(e=>(e.a(),e.t));return{loadSettings:e}},[],import.meta.url).then(({loadSettings:e})=>e()).then(e=>c(async()=>{let{openAdminDoorFromCore:e}=await import(`./admin-doors-BoU4RSfd.js`).then(e=>(e.n(),e.t));return{openAdminDoorFromCore:e}},[],import.meta.url).then(({openAdminDoorFromCore:t})=>{t(e.core,`https`)})).catch(e=>console.warn(`[MinimalShell] admin door:`,e))})}renderNavButtons(){let e=document.createDocumentFragment();for(let t of v){let r=n`
                <button
