import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{$ as t,Bt as n,Et as r,L as i,Mt as a,Nt as o,Rt as s,St as c,Zt as l,_t as u,at as d,ct as f,dt as p,et as m,ft as h,gt as g,ht as _,in as v,it as y,lt as b,mt as x,nn as S,st as ee,t as C,tt as w,xt as T,yt as E,zt as D}from"./src-C8p-yYHh.js";import{n as O,t as k}from"./preload-helper-DFTwEg7x.js";import{st as A}from"./OPFS-VRGDKBUr.js";import{a as te,n as ne}from"./image-d0hFG0A5.js";import{o as j,s as M}from"./icon-CJpUOiBC.js";import{A as N,B as P,C as re,D as ie,E as ae,F as oe,H as F,I as se,J as ce,K as le,L as I,M as L,N as ue,O as de,P as fe,R as pe,S as me,T as he,U as ge,V as _e,_ as ve,a as ye,b as be,c as xe,d as Se,f as Ce,g as we,h as Te,i as Ee,j as De,k as Oe,l as ke,m as Ae,n as je,o as Me,q as Ne,r as Pe,s as Fe,t as Ie,u as Le,v as Re,w as ze,x as Be,y as Ve,z as He}from"./launcher-state-BoDlEt5b.js";import{t as Ue}from"./render-BELJnRc1.js";function R(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}function We(){return(We=e((()=>{})))()}var z,Ge;function B(){return(B=e((()=>{C(),s(),M(),z=class extends f(){theme=`default`;render(e){return h`<slot></slot>`}constructor(){super()}onRender(){return super.onRender()}connectedCallback(){let e=super.connectedCallback?.()??this;return e.loadStyleLibrary(j()),l(e),e}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(j()),e}},R([p({source:`attr`})],z.prototype,`theme`,void 0),z=R([b(`ui-element`)],z),Ge=z})))()}var Ke,qe,Je,Ye,Xe,Ze,Qe,$e,et,V,tt,nt,rt;function it(){return(it=e((()=>{C(),Ke=`2147483600`,qe=new Map,Je=new Map,Ye=null,Xe=[`[data-chrome-flyout-anchor]`,`.env-shell-taskbar__clock`,`.env-ui-statusbar__clock`,`.env-device-tray`],Ze=()=>{if(typeof document<`u`){if(document.querySelector(`.env-shell-chrome[data-desktop]`))return!0;let e=document.querySelector(`[data-chrome-layout]`);if(e?.dataset.chromeLayout===`desktop`)return!0;if(e?.dataset.chromeLayout===`mobile`)return!1}return typeof matchMedia<`u`&&matchMedia(`(min-width: 641px)`).matches},Qe=e=>{Ye=e},$e=e=>{let t=`data-env-shell-overlays`,n=e||Ye||document.querySelector(`.env-shell-root`)||document.querySelector(`#app`)||document.body,r=n.querySelector(`[${t}]`);if(r)return r.style.zIndex||(r.style.zIndex=Ke),r;try{let e=globalThis.__ENV_OVERLAY_MOUNT__;if(typeof e==`function`)return e(n)}catch{}let i=document.createElement(`div`);return i.setAttribute(t,``),i.className=`env-shell-overlays`,i.setAttribute(`data-part`,`env-overlays`),i.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${Ke};box-sizing:border-box;`,n.appendChild(i),i},et=(e,t)=>{let n=Ze();if(e.style.position=`fixed`,e.style.zIndex=String(Number(Ke)+1),e.style.pointerEvents=`auto`,e.style.margin=`0`,n){e.style.top=`auto`,e.style.left=`auto`,e.style.right=`0.75rem`,e.style.bottom=`4.5rem`,e.style.transform=`none`;return}if(t===`calendar`){e.style.top=`50%`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translate(-50%, -50%)`;return}e.style.top=`calc(env(safe-area-inset-top, 0px) + 0.75rem)`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translateX(-50%)`},V=e=>{let t=qe.get(e);if(!t)return;qe.delete(e);let n=Je.get(e);Je.delete(e),n?.disposeDismiss(),n?.unregisterBack();try{let e=t.el;typeof e.close==`function`?e.close():(e.removeAttribute(`open`),e.hidden=!0),e.dispatchEvent(new CustomEvent(`chrome-flyout-close`,{bubbles:!0}))}catch{}},tt=e=>{qe.has(e.kind)&&V(e.kind);for(let t of[...qe.keys()])t!==e.kind&&V(t);qe.set(e.kind,{...e,close:()=>V(e.kind)}),e.el.hidden=!1,e.el.removeAttribute(`hidden`),e.el.setAttribute(`open`,``),Je.set(e.kind,{disposeDismiss:w({root:document,inside:e.el,isInside:t=>e.contains(t.target),exceptSelectors:Xe,onDismiss:()=>V(e.kind)}),unregisterBack:t({id:`chrome-flyout-${e.kind}`,kind:`overlay`,element:e.el,isActive:()=>qe.get(e.kind)?.el===e.el&&e.el.isConnected&&!e.el.hidden&&e.el.hasAttribute(`open`),close:()=>(V(e.kind),!0)})})},nt=e=>qe.has(e),rt=(e,t)=>{if(nt(e)){V(e);return}let n=t();tt(n)}})))()}var at;function ot(){return(ot=e((()=>{at=`/*
...
@layer components {
  ...
  .ui-cal-flyout__day[data-today][data-selected] {
    box-shadow: 0 0 0 2px color-mix(in oklab, var(--cal-base-color) 70%, #fff 20%) inset;
...
}`})))()}function st(e){try{let t=new Intl.Locale(e),n=(t.weekInfo??t.getWeekInfo?.())?.firstDay;if(typeof n==`number`&&n>=1&&n<=7)return n%7}catch{}return 0}function ct(e,t){let n=new Intl.DateTimeFormat(e,{weekday:`short`,timeZone:`UTC`}),r=[];for(let e=0;e<7;e++){let i=(t+e)%7;r.push(n.format(new Date(ht+i*gt)))}return r}function lt(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function ut(e,t,n){let r=new Date,i=new Date(e,t,1),a=new Date(e,t+1,0).getDate(),o=(i.getDay()-n+7)%7,s=Math.ceil((o+a)/7)*7,c=[];for(let n=0;n<s;n++){let i=n-o+1,a=new Date(e,t,i);c.push({date:a,day:a.getDate(),otherMonth:a.getMonth()!==t,isToday:lt(a,r)})}return c}function dt(){if(vt?.isConnected)return vt;let e=$e(),t=e.querySelector(`ui-calendar-flyout`);return t||(t=document.createElement(`ui-calendar-flyout`),t.hidden=!0,e.appendChild(t)),vt=t,t}function ft(e){rt(mt,()=>{let e=dt(),t=document.documentElement.getAttribute(`data-theme`);return(t===`light`||t===`dark`)&&(e.dataset.theme=t,e.style.colorScheme=t),et(e,mt),e.open(),{kind:mt,el:e,close:()=>{e.close(),V(mt)},contains:t=>t instanceof Node&&e.contains(t)}})}var pt,mt,ht,gt,_t,vt;function yt(){return(yt=e((()=>{C(),r(),s(),B(),M(),it(),ot(),pt=v(at),mt=`calendar`,ht=Date.UTC(2023,0,1),gt=864e5,_t=class extends z{#e;#t;#n=null;#r=null;styles=function(){return pt};render=function(){return h`<div class="ui-cal-flyout__panel" part="panel">
        ...
        </div>`};constructor(){super();let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth()}onRender(){super.onRender(),this.#i(),this.#c()}disconnectedCallback(){this.#r?.(),this.#r=null,super.disconnectedCallback?.()}#i(){let e=this.shadowRoot;if(!e||this.#r)return;let t=o(e,`click`,e=>{let t=e.target,n=t?.closest?.(`[data-nav]`);if(n){n.dataset.nav===`prev`?this.#a(-1):n.dataset.nav===`next`&&this.#a(1);return}let r=t?.closest?.(`.ui-cal-flyout__day`);r&&this.#s(r)});this.#r=()=>t?.()}#a(e){this.#t+=e,this.#t<0?(this.#t=11,--this.#e):this.#t>11&&(this.#t=0,this.#e+=1),this.#c()}#o(){let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth(),this.#c()}#s(e){let t=e.dataset.date;t&&(this.#n=new Date(t),this.shadowRoot?.querySelectorAll(`.ui-cal-flyout__day[data-selected]`)?.forEach(e=>e.removeAttribute(`data-selected`)),e.setAttribute(`data-selected`,``),this.dispatchEvent(new CustomEvent(`calendar-select`,{bubbles:!0,composed:!0,detail:{date:this.#n}})))}#c(){let e=this.shadowRoot;if(!e)return;let t=typeof navigator<`u`?navigator.language:void 0,n=st(t??`en-US`),r=new Date,i=e.querySelector(`.ui-cal-flyout__today`);i&&(i.textContent=r.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`}));let a=e.querySelector(`.ui-cal-flyout__month-label`);a&&(a.textContent=new Date(this.#e,this.#t,1).toLocaleDateString(t,{month:`long`,year:`numeric`}));let o=e.querySelector(`.ui-cal-flyout__weekdays`);o&&o.replaceChildren(...ct(t??`en-US`,n).map(e=>{let t=document.createElement(`span`);return t.className=`ui-cal-flyout__weekday`,t.setAttribute(`role`,`columnheader`),t.textContent=e,t}));let s=e.querySelector(`.ui-cal-flyout__grid`);if(s){let e=ut(this.#e,this.#t,n);s.replaceChildren(...e.map(e=>{let n=document.createElement(`button`);return n.type=`button`,n.className=`ui-cal-flyout__day`,n.textContent=String(e.day),n.dataset.date=e.date.toISOString(),n.setAttribute(`role`,`gridcell`),e.otherMonth&&n.setAttribute(`data-other-month`,``),e.isToday&&n.setAttribute(`data-today`,``),this.#n&&lt(e.date,this.#n)&&n.setAttribute(`data-selected`,``),n.setAttribute(`aria-label`,e.date.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`})),n}))}}open(){this.#o(),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},_t=R([b(`ui-calendar-flyout`)],_t),vt=null})))()}function bt(){let e=wt.get();return typeof e==`function`?e:null}var xt,St,Ct,wt;function Tt(){return(Tt=e((()=>{xt=`__CWSP_SPEED_DIAL_VIEW_OPENER_V1__`,St=`__CWSP_HOME_OVERLAY_MOUNT_V1__`,Ct=e=>{let t=globalThis;return{get:()=>e in t?t[e]:null,set:n=>{t[e]=n}}},wt=Ct(xt),Ct(St)})))()}var Et;function Dt(){return(Dt=e((()=>{Et=`/*
...
}`})))()}function Ot(){if(sn?.isConnected)return sn;let e=$e(),t=e.querySelector(`ui-quick-settings`);return t||(t=document.createElement(`ui-quick-settings`),t.hidden=!0,e.appendChild(t)),sn=t,t}function kt(e){rt(Mt,()=>{let e=Ot(),t=document.documentElement.getAttribute(`data-theme`);return(t===`light`||t===`dark`)&&(e.dataset.theme=t,e.style.colorScheme=t),et(e,Mt),e.open(),{kind:Mt,el:e,close:()=>{e.close(),V(Mt)},contains:t=>t instanceof Node&&e.contains(t)}})}function At(){V(Mt)}var jt,Mt,Nt,Pt,Ft,It,Lt,Rt,zt,Bt,Vt,Ht,Ut,Wt,Gt,Kt,qt,Jt,Yt,Xt,Zt,Qt,$t,en,tn,nn,rn,an,on,sn;function cn(){return(cn=e((()=>{C(),r(),s(),B(),M(),Tt(),it(),Dt(),jt=v(Et),Mt=`quick-settings`,Nt=`data-theme`,Pt=`rs-appearance-theme`,Ft=`appearance.theme`,It=[`rs-settings`,`cwsp-settings`,`u2-settings`],Lt=()=>{try{return matchMedia?.(`(prefers-color-scheme: dark)`)?.matches??!0}catch{return!0}},Rt=e=>{for(let t of It)try{let n=localStorage.getItem(t);if(!n)continue;let r=JSON.parse(n);if(!r||typeof r!=`object`)continue;r.appearance={...r.appearance??{},theme:e},localStorage.setItem(t,JSON.stringify(r))}catch{}},zt=()=>{try{let e=document.documentElement.getAttribute(Nt);if(e===`light`||e===`dark`)return e;let t=localStorage.getItem(Pt);if(t===`light`||t===`dark`)return t}catch{}return Lt()?`dark`:`light`},Bt=e=>{let t=document.documentElement,n=e===`auto`?Lt()?`dark`:`light`:e,r=e===`auto`?`auto`:e;t.setAttribute(`data-scheme`,r),t.setAttribute(Nt,n),t.style.colorScheme=n;try{document.body&&(document.body.style.colorScheme=n)}catch{}try{document.querySelectorAll(`.env-shell-root, [data-shell], ui-window`).forEach(e=>{let t=e;t.dataset.theme=n,t.style.colorScheme=n;let r=t.shadowRoot?.querySelector?.(`.app-shell`);r&&(r.dataset.theme=n,r.style.colorScheme=n)})}catch{}try{localStorage.setItem(Pt,e===`auto`?`auto`:e),localStorage.setItem(Ft,e===`auto`?`auto`:e)}catch{}e!==`auto`&&Rt(e),t.dispatchEvent(new CustomEvent(`u2-theme-change`,{bubbles:!0,detail:{source:`quick-settings`,theme:n,preference:e}}))},Vt=()=>{try{let e=String(localStorage.getItem(Pt)||``).trim().toLowerCase();if(e===`light`||e===`dark`||e===`auto`)return e;let t=String(localStorage.getItem(Ft)||``).trim().toLowerCase();if(t===`light`||t===`dark`||t===`auto`)return t}catch{}return`auto`},Ht=()=>{let e=globalThis;if(e.__CWSP_AUTO_THEME_FOLLOW__)return;e.__CWSP_AUTO_THEME_FOLLOW__=!0;let t=typeof matchMedia==`function`?matchMedia(`(prefers-color-scheme: dark)`):null;if(!t)return;let n=()=>{Vt()===`auto`&&Bt(`auto`)};try{t.addEventListener(`change`,n)}catch{try{t.addListener(n)}catch{}}try{n()}catch{}},Ut=e=>{document.documentElement.style.setProperty(`--orientation-lock`,e?`unlocked`:`locked`),document.documentElement.style.setProperty(`--orientation-lock-angle`,e?`0deg`:`90deg`),Promise.try(async()=>{try{let t=screen.orientation;if(e){t.unlock?.();return}if(typeof t.lock!=`function`)return;let n=t.lock(t.type||`natural`);n&&typeof n.catch==`function`&&await n.catch(()=>{})}catch(e){console.warn(e)}})?.catch?.(console.warn.bind(console))},Wt=`env-night-filter`,Gt=`2147483001`,Kt=`rs-night-filter`,qt=`rs-brightness-filter`,Jt=e=>Math.max(0,Math.min(100,Number.isFinite(e)?e:0)),Yt=()=>{let e=document.getElementById(Wt);if(e instanceof HTMLElement)return e;let t=document.createElement(`div`);return t.id=Wt,t.setAttribute(`aria-hidden`,`true`),t.style.cssText=[`dynamic-range-limit:no-limit`,`color-space:display-p3`,`position:fixed`,`inset:0`,`pointer-events:none`,`z-index:${Gt}`,`background-color:color(display-p3 1 0.55 0.24)`,`mix-blend-mode:multiply`,`opacity:0`,`visibility:hidden`,`transition:opacity 160ms ease`].join(`;`),(document.body??document.documentElement).appendChild(t),t},Xt=e=>{let t=Jt(e),n=Yt(),r=t/100;n.style.opacity=String(r),n.style.visibility=r>=.01?`visible`:`hidden`;try{localStorage.setItem(Kt,String(t))}catch{}},Zt=e=>{let t=Jt(e);Yt(),t<=50?.4+t/50*.6:1+(t-50)/50*.2;try{localStorage.setItem(qt,String(t))}catch{}},Qt=(e,t)=>{try{let n=localStorage.getItem(e);if(n==null)return t;let r=Number(n);return Number.isFinite(r)?Jt(r):t}catch{return t}},$t=()=>{let e=Qt(Kt,0),t=Qt(qt,50);return Xt(e),Zt(t),{night:e,brightness:t}},typeof document<`u`&&(document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>$t(),{once:!0}):$t()),en=[`wifi`,`bluetooth`,`focus`,`airplane`,`orientation`],tn={light:`sun`,dark:`moon`},nn={light:`Light`,dark:`Dark`},rn=e=>{let t=e.querySelector(`[data-qs-tile="theme"]`);if(!t)return;let n=zt();t.querySelector(`ui-icon`)?.setAttribute(`icon`,tn[n]);let r=t.querySelector(`[data-qs-tile-sub]`);r&&(r.textContent=nn[n]),t.setAttribute(`aria-pressed`,n===`dark`?`true`:`false`)},an=e=>{let t=e.shadowRoot,n=t?.querySelector(`.qs-panel`);if(!t||!n||n.hasAttribute(`data-qs-wired`))return;n.setAttribute(`data-qs-wired`,``),rn(t),t.querySelector(`[data-qs-tile="theme"]`)?.addEventListener(`click`,()=>{let e=zt()===`dark`?`light`:`dark`;Bt(e),rn(t)});let r=e=>!!e?.getAttribute?.(`aria-pressed`)&&e?.getAttribute?.(`aria-pressed`)===`true`;t.querySelector?.(`[data-qs-tile="orientation"]`)?.addEventListener?.(`click`,e=>{let t=a((e?.target?.matches?.(`[data-qs-tile="orientation"]`)?e?.target:e?.target?.querySelector?.(`[data-qs-tile="orientation"]`))||e?.target,`[data-qs-tile="orientation"]`),n=r(t);Ut(n);let i=t?.matches?.(`ui-icon`)?t:t?.querySelector?.(`ui-icon`);i&&i.setAttribute?.(`icon`,n?`device-rotate`:`lock`),i&&i.setAttribute?.(`icon-style`,`duotone`)});for(let e of en){let n=t.querySelector(`[data-qs-tile="${e}"]`);n&&n.addEventListener(`click`,()=>{let e=n.getAttribute(`aria-pressed`)!==`true`;n.setAttribute(`aria-pressed`,String(e));let t=n.querySelector(`[data-qs-tile-sub]`);t&&(t.textContent=e?`On`:`Off`)})}let{night:i,brightness:o}=$t(),s=t.querySelector(`[data-qs-slider="night"]`),c=t.querySelector(`[data-qs-slider="brightness"]`);s&&(s.value=String(i),s.addEventListener(`input`,()=>Xt(s.valueAsNumber))),c&&(c.value=String(o),c.addEventListener(`input`,()=>Zt(c.valueAsNumber)));let l=e=>{At();let t=()=>{let t=bt();if(typeof t==`function`){t(e,{});return}let n=`#${e}`;typeof location<`u`&&location.hash!==n&&T(n)};typeof requestAnimationFrame==`function`?requestAnimationFrame(t):queueMicrotask(t)};t.querySelectorAll(`[data-qs-open]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=String(e.getAttribute(`data-qs-open`)||``).trim();(t===`settings`||t===`explorer`)&&l(t)})})},on=class extends z{constructor(){super()}styles=()=>jt;render=()=>h`
...
</div>`;onRender(){return super.onRender(),an(this),this}open(){rn(this.shadowRoot),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},on=R([b(`ui-quick-settings`)],on),sn=null,Promise.try(()=>{typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{Promise.try(async()=>{let e=screen?.orientation?.lock;if(typeof e!=`function`)return;let t=e.call(screen.orientation,`natural`);t&&typeof t.catch==`function`&&await t.catch(()=>{})}).catch(()=>{})})}).catch(()=>{});try{Ht()}catch{}})))()}var ln;function un(){return(un=e((()=>{ln=`/*
...
@layer components {
  ...
  env-shell-container[data-env-native-task] .env-shell-chrome[data-desktop] {
...
}`})))()}function dn(){if(typeof matchMedia!=`function`)return`unknown`;try{if(matchMedia(`(display-mode: window-controls-overlay)`).matches)return`window-controls-overlay`;if(matchMedia(`(display-mode: fullscreen)`).matches)return`fullscreen`;if(matchMedia(`(display-mode: standalone)`).matches)return`standalone`;if(matchMedia(`(display-mode: minimal-ui)`).matches)return`minimal-ui`;if(matchMedia(`(display-mode: browser)`).matches)return`browser`}catch{}return`unknown`}function fn(){let e=dn();if(e===`standalone`||e===`minimal-ui`)return!0;try{if(navigator.standalone===!0)return!0}catch{}return!1}function pn(){if(typeof document<`u`&&document.documentElement.dataset.cwspNativeShell===`capacitor`)return!0;try{let e=globalThis.Capacitor;return typeof e?.isNativePlatform==`function`&&!!e.isNativePlatform()}catch{return!1}}function mn(e){if(pn()||(e.standalone??fn()))return!1;let t=e.displayMode??dn(),n=typeof document<`u`&&!!(document.fullscreenElement||document.webkitFullscreenElement);return t===`fullscreen`||n?!0:!e.desktop}function hn(e=new Date){let t=e=>String(e).padStart(2,`0`);return{time:`${t(e.getHours())}:${t(e.getMinutes())}`,date:`${t(e.getDate())}.${t(e.getMonth()+1)}.${e.getFullYear()}`}}function gn(e=new Date){return hn(e).time}function _n(e){let t=!1,n=null,r=(e,t=48)=>{let n=0,r=0,i=0;for(let a=0;a<e.length;a+=4*t){if((e[a+3]??255)<16)continue;let t=e[a]/255,o=e[a+1]/255,s=e[a+2]/255;i=Math.max(i,t,o,s),n+=.2126*t+.7152*o+.0722*s,r++}return r<8||i<.02?null:n/r},i=t=>{let n=t>.55;e.style.setProperty(`--env-status-fg`,n?`#1c1c1e`:`#f5f5f7`),e.style.setProperty(`--env-status-fg-muted`,n?`rgba(28,28,30,0.72)`:`rgba(245,245,247,0.78)`),e.dataset.statusContrast=n?`dark`:`light`},a=()=>{e.style.setProperty(`--env-status-fg`,`var(--wallpaper-contrast-color)`),e.style.setProperty(`--env-status-fg-muted`,`color-mix(in oklab, var(--wallpaper-contrast-color) 78%, transparent)`),e.dataset.statusContrast=`wallpaper`},o=t=>{ne(t,[e]),e.dataset.launcherContrast=t>.52?`dark`:`light`},s=()=>{try{for(let t of document.querySelectorAll(`ui-window[managed]`)){if(t.hidden||t.hasAttribute(`hidden`)||t.getAttribute(`aria-hidden`)===`true`)continue;let n=getComputedStyle(t);if(n.display!==`none`&&n.visibility!==`hidden`&&Number(n.opacity)!==0&&(t.hasAttribute(`data-status-gap`)||t.hasAttribute(`data-status-overlay-gap`)||t.getBoundingClientRect().top<Math.max(8,parseFloat(getComputedStyle(e).getPropertyValue(`--env-status-inset-top`))||32)+8))return!0}}catch{}return!1},c=()=>{if(t)return;let n=(document.documentElement.getAttribute(`data-theme`)||``).toLowerCase(),c=s();c&&n===`light`?i(.9):c&&n===`dark`?i(.15):a();try{let t=e.querySelector(`.env-shell-wallpaper canvas`)||document.querySelector(`.env-shell-wallpaper canvas`);if(t instanceof HTMLCanvasElement&&t.width>0&&t.height>0){let e=t.getContext(`2d`,{willReadFrequently:!0});if(e){let n=t.width,i=Math.max(0,Math.round(t.height*.28)),s=Math.max(1,Math.round(t.height*.36)),l=r(e.getImageData(0,i,n,Math.min(s,t.height-i)).data);if(l!=null){o(l),c||a();return}}}}catch{}},l=()=>{n!=null&&clearTimeout(n),n=setTimeout(c,120)};c();let u=typeof MutationObserver==`function`?new MutationObserver(l):null,d=e.querySelector(`.env-shell-wallpaper`)||document.querySelector(`.env-shell-wallpaper`);d&&u&&u.observe(d,{childList:!0,subtree:!0,attributes:!0});let f=typeof MutationObserver==`function`?new MutationObserver(l):null;f?.observe(document.documentElement,{childList:!0,subtree:!0,attributes:!0,attributeFilter:[`hidden`,`data-status-gap`,`data-theme`,`aria-hidden`,`style`,`class`]}),window.addEventListener(`resize`,l),document.addEventListener(`visibilitychange`,l),document.addEventListener(`env-chrome-surface`,l),document.addEventListener(`u2-theme-change`,l);let p=typeof matchMedia==`function`?matchMedia(`(prefers-color-scheme: dark)`):null;p?.addEventListener?.(`change`,l);let m=setInterval(c,8e3);return()=>{t=!0,n!=null&&clearTimeout(n),clearInterval(m),u?.disconnect(),f?.disconnect(),window.removeEventListener(`resize`,l),document.removeEventListener(`visibilitychange`,l),document.removeEventListener(`env-chrome-surface`,l),document.removeEventListener(`u2-theme-change`,l),p?.removeEventListener?.(`change`,l)}}function vn(e){return e.connection}function yn(e){let t=e.toLowerCase();return t===`slow-2g`?`wifi-low`:t===`2g`?`wifi-medium`:`wifi-high`}function bn(){let e=ge(`wifi-high`),t=ge(``),n=ge(`battery-full`),r=ge(``),i=ge(``),a=()=>{if(!navigator.onLine){e.value=`wifi-slash`,t.value=`Offline`;return}let n=vn(navigator);if(!n||typeof n.effectiveType!=`string`){e.value=`globe`,t.value=`Online (connection details unavailable)`;return}let r=String(n.effectiveType||``).toLowerCase(),i=typeof n.downlink==`number`?`${n.downlink} Mb/s`:``,a=n.saveData?` · Data saver`:``;t.value=[r.toUpperCase(),i].filter(Boolean).join(` · `)+a,e.value=yn(r)},o=null,s=null,c=null,l=(e,t)=>{let a=Math.max(0,Math.min(100,Math.round(e*100)));if(i.value=`${a}%`,t){n.value=`battery-charging-vertical`,r.value=`Charging · ${i.value}`;return}r.value=`Battery · ${i.value}`,e<=.08?n.value=`battery-warning`:e<=.22?n.value=`battery-low`:e<=.5?n.value=`battery-medium`:e<=.8?n.value=`battery-high`:n.value=`battery-full`};a(),window.addEventListener(`online`,a),window.addEventListener(`offline`,a);let u=vn(navigator);return u?.addEventListener?.(`change`,a),typeof navigator.getBattery==`function`?navigator.getBattery().then(e=>{c=e,o=()=>l(e.level,e.charging),s=o,e.addEventListener(`levelchange`,o),e.addEventListener(`chargingchange`,s),l(e.level,e.charging)}):(n.value=`question`,r.value=`Battery status not supported in this browser`,i.value=`—`),{networkIcon:e,networkTitle:t,batteryIcon:n,batteryTitle:r,batteryPct:i,dispose:()=>{window.removeEventListener(`online`,a),window.removeEventListener(`offline`,a),u?.removeEventListener?.(`change`,a),c&&o&&s&&(c.removeEventListener(`levelchange`,o),c.removeEventListener(`chargingchange`,s))}}}function xn(e,t){let n=h`<div class="env-status-bar__tray ${t}">
    ...
    </div>`,r=n.querySelector(`.env-status-bar__pct`);return r instanceof HTMLElement&&c(r,{properties:{textContent:e.batteryPct}}),n}function Sn(e,t,n){let r=document.createElement(`ui-statusbar`);r.className=`env-ui-statusbar wf-chrome-no-select`,r.setAttribute(`part`,`status-bar`);let i=document.createElement(`div`);i.slot=`left`,i.className=`env-ui-statusbar__left`;let a=document.createElement(`time`);a.className=`env-ui-statusbar__clock`,a.dateTime=``,a.textContent=gn(),a.setAttribute(`role`,`button`),a.setAttribute(`tabindex`,`0`),a.setAttribute(`aria-label`,`Calendar`),a.setAttribute(`aria-haspopup`,`dialog`),a.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let o=document.createElement(`div`);o.className=`env-ui-statusbar__intro`,t&&(o.innerHTML=t),i.append(a,o);let s=document.createElement(`div`);s.slot=`center`;let c=document.createElement(`p`);c.className=`env-status-bar__meta`,s.appendChild(c);let l=document.createElement(`div`);l.slot=`right`,l.className=`env-ui-statusbar__right`;let u=xn(n,`env-device-tray env-device-tray--footer`);u.setAttribute(`role`,`button`),u.setAttribute(`tabindex`,`0`),u.setAttribute(`aria-label`,`Quick settings`),u.setAttribute(`aria-haspopup`,`dialog`),u.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`),l.appendChild(u);let d=e=>{e.preventDefault(),e.stopPropagation(),ft(a)},f=e=>{e.preventDefault(),e.stopPropagation(),kt(u)};a.addEventListener(`click`,d),a.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&d(e)}),u.addEventListener(`click`,f),u.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&f(e)}),r.append(i,s,l),le(()=>{let t=e.navEcho.value?` │ ${e.navEcho.value}`:``;c.textContent=`doc=${e.selectedPath.value} │ viewer=${e.viewerStatus.value} │ layout=${e.mqLabel.value}${t}`},[e.selectedPath,e.viewerStatus,e.mqLabel,e.navEcho],{triggerImmediately:!0});let p=()=>{let e=new Date;a.textContent=gn(e),a.dateTime=e.toISOString()};p();let m=setInterval(p,15e3);return{element:r,dispose:()=>{clearInterval(m)}}}var Cn,wn;function Tn(){return(Tn=e((()=>{C(),Ne(),te(),yt(),cn(),B(),un(),s(),Cn=v(ln),wn=class extends Ge{constructor(){super()}styles=()=>Cn;render=()=>h`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},wn=R([b(`ui-statusbar`)],wn)})))()}function En(){return(En=e((()=>{C(),N()})))()}function H(e){globalThis.dispatchEvent?.(new CustomEvent(`view:toast`,{detail:{type:`success`,message:String(e||``)}}))}function U(e){globalThis.dispatchEvent?.(new CustomEvent(`view:toast`,{detail:{type:`error`,message:String(e||``)}}))}function Dn(){if(W)return W;try{let e=localStorage.getItem(Fn);if(!e)return W={},W;let t=JSON.parse(e);W=t&&typeof t==`object`?t:{}}catch{W={}}return W}function On(e){W=e;try{localStorage.setItem(Fn,JSON.stringify(e))}catch{}}function kn(e){let t=e&&typeof e==`object`?e:{},n=t.extras&&typeof t.extras==`object`?t.extras:{},r={};for(let[e,t]of Object.entries(n)){let n=String(e||``).trim();n&&(typeof t==`boolean`||typeof t==`number`||typeof t==`string`)&&(r[n]=t)}let i=Array.isArray(t.flags)?t.flags.map(e=>String(e||``).trim().toUpperCase()).filter(Boolean):[],a=Array.isArray(t.categories)?t.categories.map(e=>String(e||``).trim()).filter(Boolean):[];return{action:String(t.action||``).trim(),data:Ln(String(t.data||``)),mimeType:String(t.mimeType||``).trim(),extras:r,flags:i,categories:a,componentName:String(t.componentName||``).trim()}}function An(e){return!e||!e.action&&!e.data&&!e.mimeType&&!e.componentName&&(!e.flags||e.flags.length===0)&&(!e.categories||e.categories.length===0)&&(!e.extras||Object.keys(e.extras).length===0)}function jn(e){let t=In(e);return!t||t===`app:`?{}:kn(Dn()[t])}function Mn(e,t){let n=In(e);if(!n||n===`app:`)return{};let r=kn(t),i={...Dn()};return An(r)?delete i[n]:i[n]=r,On(i),r}function Nn(e){let t=In(e);if(!t||t===`app:`)return;let n={...Dn()};delete n[t],On(n)}function Pn(e){return jn(e)}var Fn,W,In,Ln;function Rn(){return(Rn=e((()=>{Fn=`cwsp-app-launch-spec-v1`,W=null,In=e=>`app:${String(e||``).trim()}`,Ln=e=>{let t=String(e||``).trim();return!t||/^javascript:/i.test(t)?``:t}})))()}function zn(e,t=64){let n=String(e||``).trim();if(!n||!/^https?:\/\//i.test(n))return``;try{let e=new URL(n).hostname;return e?`https://www.google.com/s2/favicons?domain=${encodeURIComponent(e)}&sz=${t}`:``}catch{return``}}function Bn(e){let t=String(e||``).trim().toLowerCase();return t?t.includes(`/_favicon/`)||t.includes(`s2/favicons`)||t.includes(`favicon`)?!0:(t.startsWith(`android-icon:`),!1):!1}function Vn(e){let t=String(e||``).trim();return t?/^[a-z][a-z0-9+.-]*:/i.test(t)?t:`https://${t}`:``}function Hn(e){ur=e}function Un(e){let t=e||(globalThis.chrome?.bookmarks??null);return!t?.getTree||!t?.getChildren?null:{resolveIconUrl:(e,t=128)=>{let n=String(e||``).trim();if(!/^https?:\/\//i.test(n))return``;let r=zn(n,t);if(r)return r;try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`){let r=new URL(e.getURL(`/_favicon/`));return r.searchParams.set(`pageUrl`,n),r.searchParams.set(`size`,String(t)),r.toString()}}catch{}return``},async listChildren(e){if(e)return(await fr(t,`getChildren`,e)||[]).map(pr);let n=await fr(t,`getTree`)||[],r=[];for(let e of n)for(let t of e.children||[])r.push(pr(t));return r},async search(e){let n=String(e||``).trim();if(!n)return this.listChildren();if(typeof t.search!=`function`){let e=await this.listChildren(),t=n.toLowerCase();return e.filter(e=>e.title.toLowerCase().includes(t)||String(e.url||``).toLowerCase().includes(t))}return(await fr(t,`search`,n)||[]).map(pr)},async open(e){if(e.folder)return;let t=String(e.url||``).trim();if(t){try{let e=globalThis.chrome?.tabs;if(typeof e?.create==`function`){await Promise.resolve(e.create({url:t}));return}}catch{}globalThis.open?.(t,`_blank`,`noopener,noreferrer`)}},async remove(e){let n=String(e?.id||``).trim();if(!n)return!1;try{if(e.folder){if(typeof t.removeTree!=`function`)return!1;await fr(t,`removeTree`,n)}else{if(typeof t.remove!=`function`)return!1;await fr(t,`remove`,n)}return!0}catch{return!1}},async update(e,n){let r=String(e||``).trim();if(!r||typeof t.update!=`function`)return null;let i={};if(n.title!=null&&(i.title=String(n.title||``).trim()),n.url!=null){let e=Vn(n.url);e&&(i.url=e)}try{let e=await fr(t,`update`,r,i);return e?pr(e):null}catch{return null}},async create(e,n){if(typeof t.create!=`function`)return null;let r=String(n.title||``).trim();if(!r)return null;let i={parentId:String(e||`0`),title:r};if(n.url!=null){let e=Vn(n.url);if(!e)return null;i.url=e}let a=async e=>{let n=await fr(t,`create`,{...i,parentId:e});return n?pr(n):null};try{return await a(i.parentId)}catch{if(i.parentId===`0`)try{return await a(`1`)}catch{return null}return null}}}}function Wn(){return ur||Un()}function Gn(){return!!Wn()}function Kn(){try{let e=localStorage.getItem(or);if(!e)return[];let t=JSON.parse(e);return Array.isArray(t)?t.filter(e=>e&&e.id&&e.title).slice(0,cr):[]}catch{return[]}}function qn(e){if(!e?.id||e.folder)return;let t=[e,...Kn().filter(t=>t.id!==e.id)].slice(0,cr);try{localStorage.setItem(or,JSON.stringify(t))}catch{}}function Jn(){return mr(sr,lr)}function Yn(e){return Jn().some(t=>t.id===e)}function Xn(e){if(!e?.id||e.folder||!String(e.url||``).trim())return!1;let t=[e,...Jn().filter(t=>t.id!==e.id)].slice(0,lr);try{return localStorage.setItem(sr,JSON.stringify(t)),!0}catch{return!1}}function Zn(e){let t=String(e||``).trim();if(!t)return!1;let n=Jn().filter(e=>e.id!==t);try{return localStorage.setItem(sr,JSON.stringify(n)),!0}catch{return!1}}function Qn(e){let t=String(e?.id||``).trim();if(!t)return;let n=n=>n.map(n=>n.id===t?{...n,title:e.title||n.title,url:e.url||n.url}:n);try{hr(sr,n(Jn()),lr),hr(or,n(Kn()),cr)}catch{}}function $n(e){let t=String(e||``).trim();if(t){Zn(t);try{hr(or,Kn().filter(e=>e.id!==t),cr)}catch{}}}function er(e,t=gr){let n=String(e||``).trim();if(!n)return``;try{let e=new URL(n,globalThis.location?.href);if(e.searchParams.has(`pageUrl`))return e.searchParams.set(`size`,String(t)),e.toString();if(e.hostname.endsWith(`google.com`)&&e.pathname.includes(`favicon`))return e.searchParams.set(`sz`,String(t)),e.toString()}catch{}return n}function tr(e,t){let n=String(e.url||``).trim();return n&&(zn(n,gr)||zn(n,128)||zn(n,64)||t?.resolveIconUrl?.(n,gr)||t?.resolveIconUrl?.(n,128))||``}function nr(e,t,n,r=``){return ir(e,t,String(r||``).trim()||er(tr(e,n),gr))}function rr(e,t=``){let n=String(e.url||``).trim();return JSON.stringify({state:{icon:e.folder?`folder`:`link`,label:e.title||n||`Bookmark`,action:e.folder?`open-path`:`open-link`},desc:{action:e.folder?`open-path`:`open-link`,href:e.folder?``:n,path:e.folder?`/bookmarks/${e.id}/`:`/bookmarks/${e.id}`,meta:{entityType:`bookmark`,bookmarkId:e.id,...t?{iconUrl:t}:{}}}})}function ir(e,t,n=``){if(e.folder||!String(e.url||``).trim())return null;let r=t??ke(),i=Te(rr(e,n),r);return i?(Pe(i),i):null}async function ar(e,t,n){if(e.replaceChildren(),t.folder)return _r(e,`folder`),e.toggleAttribute(`data-bookmark-bitmap`,!1),``;let r=String(t.url||``).trim(),i=[],a=zn(r,gr);a&&i.push(a);let o=zn(r,128);o&&!i.includes(o)&&i.push(o);let s=zn(r,64);s&&!i.includes(s)&&i.push(s);let c=n?.resolveIconUrl?.(r,gr)||``;c&&!i.includes(c)&&i.push(c);let l=n?.resolveIconUrl?.(r,128)||``;l&&!i.includes(l)&&i.push(l);let u=n?.resolveIconUrl?.(r,64)||``;u&&!i.includes(u)&&i.push(u);try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`&&r){let t=new URL(e.getURL(`/_favicon/`));t.searchParams.set(`pageUrl`,r),t.searchParams.set(`size`,String(gr));let n=t.toString();n&&!i.includes(n)&&i.push(n)}}catch{}return _r(e,`link`),e.toggleAttribute(`data-bookmark-bitmap`,!1),i.length?await new Promise(t=>{let n=0,r=()=>{if(n>=i.length){t(``);return}let a=i[n++],o=document.createElement(`img`);o.className=`env-shell-app-menu__tile-favicon`,o.alt=``,o.decoding=`async`,o.loading=`eager`,o.referrerPolicy=`no-referrer`,o.draggable=!1,o.addEventListener(`load`,()=>{e.replaceChildren(o),e.toggleAttribute(`data-bookmark-bitmap`,!0),t(a)},{once:!0}),o.addEventListener(`error`,()=>{r()},{once:!0}),o.src=a};r()}):``}var or,sr,cr,lr,ur,dr,fr,pr,mr,hr,gr,_r;function vr(){return(vr=e((()=>{Se(),or=`rs-app-menu-bookmark-recent`,sr=`rs-app-menu-bookmark-pinned`,cr=12,lr=16,ur=null,dr=()=>{try{let e=globalThis.chrome?.runtime?.lastError;return e?Error(String(e.message||e)):null}catch{return null}},fr=(e,t,...n)=>{let r=e[t];if(typeof r!=`function`)return Promise.reject(Error(`chrome.bookmarks.${String(t)} missing`));try{let t=r.apply(e,n);if(t!=null&&typeof t.then==`function`)return t}catch(e){return Promise.reject(e)}return new Promise((t,i)=>{try{r.apply(e,[...n,e=>{let n=dr();n?i(n):t(e)}])}catch(e){i(e)}})},pr=e=>{let t=typeof e.url==`string`&&e.url?e.url:void 0;return{id:String(e.id),title:String(e.title||e.url||e.id||`Bookmark`),url:t,folder:!t,parentId:e.parentId}},mr=(e,t)=>{try{let n=localStorage.getItem(e);if(!n)return[];let r=JSON.parse(n);return Array.isArray(r)?r.filter(e=>e&&e.id&&e.title&&!e.folder).slice(0,t):[]}catch{return[]}},hr=(e,t,n)=>{localStorage.setItem(e,JSON.stringify(t.slice(0,n)))},gr=256,_r=(e,t)=>{let n=document.createElement(`ui-icon`);n.setAttribute(`icon`,t),n.setAttribute(`icon-style`,`duotone`),n.setAttribute(`aria-hidden`,`true`),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`),n.style.setProperty(`--icon-color`,`currentColor`),n.style.color=`currentColor`,e.append(n),customElements.whenDefined(`ui-icon`).then(()=>{n.isConnected&&(n.getAttribute(`icon`)||n.setAttribute(`icon`,t),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`))})}})))()}function yr(e){let t=e.info||{},n=String(t.packageName||e.fallback.packageName||``).trim(),r=String(t.label||e.fallback.label||e.title||n).trim(),i=[[`Label`,r],[`Package`,n],[`Activity`,String(t.componentName||e.fallback.componentName||`—`)],[`Version`,`${t.versionName||`—`} (${t.versionCode??`—`})`],[`Installer`,String(t.installer||`—`)],[`Enabled`,t.enabled===!1?`no`:`yes`],[`System`,t.system?t.updatedSystem?`updated system`:`yes`:`no`],[`Installed`,Dr(t.firstInstallTime)],[`Updated`,Dr(t.lastUpdateTime)]],a=Or(`
    ...
    `),o=a.__cwspClose;a.querySelector(`form`)?.addEventListener(`click`,t=>{let n=t.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`);n===`close`&&(t.preventDefault(),o?.()),n===`system`&&(t.preventDefault(),Promise.resolve(e.onOpenSystem?.()).finally(()=>o?.()))})}function br(e){let t=jn(e.packageName),n=new Set((t.flags||[]).map(e=>e.toUpperCase())),r=Or(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
            ...
            <div class="modal-fields">
                ...
                <div class="modal-field">
                    ...
                    <textarea id="am-launch-extras" name="extras" rows="5" placeholder='{"debug": true}'>${G(kr(t.extras))}</textarea>
                </div>
            </div>
            <div class="modal-actions" role="group">
    ...
    `),i=r.__cwspClose,a=r.querySelector(`form`),o=()=>{let e=[...r.querySelectorAll(`input[name="flag"]:checked`)].map(e=>e.value),t=String(r.querySelector(`[name="categories"]`)?.value||``).split(`,`).map(e=>e.trim()).filter(Boolean);return kn({componentName:r.querySelector(`[name="componentName"]`)?.value,action:r.querySelector(`[name="action"]`)?.value,data:r.querySelector(`[name="data"]`)?.value,mimeType:r.querySelector(`[name="mimeType"]`)?.value,categories:t,flags:e,extras:Ar(r.querySelector(`[name="extras"]`)?.value||``)})};a?.addEventListener(`click`,t=>{let n=t.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`);n===`cancel`&&(t.preventDefault(),i?.()),n===`reset`&&(t.preventDefault(),Nn(e.packageName),e.onSave?.({}),H(`Launch reset to default`),i?.())}),a?.addEventListener(`submit`,t=>{t.preventDefault();let n=o();Mn(e.packageName,n),e.onSave?.(n),H(An(n)?`Launch reset to default`:`Launch saved`),i?.()})}function xr(e,t=`Uninstall`){return globalThis.confirm?.(`${t} “${e}”?`)===!0}function Sr(e){let t=()=>{document.visibilityState===`visible`&&(document.removeEventListener(`visibilitychange`,t),e())};document.addEventListener(`visibilitychange`,t),globalThis.setTimeout?.(e,1600)}function Cr(e){let t=[[`Title`,e.title||`—`],[`URL`,e.url||`—`],[`Id`,e.id],[`Type`,e.folder?`Folder`:`Bookmark`]],n=Or(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
    ...
    `),r=n.__cwspClose;n.querySelector(`form`)?.addEventListener(`click`,e=>{e.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`)===`close`&&(e.preventDefault(),r?.())})}function wr(e){let t=e.showUrl!==!1;return new Promise(n=>{let r=!1,i=Or(`
        <form class="speed-dial-editor__form" autocomplete="off">
            <header class="modal-header">
    ...
    `),a=i.__cwspClose,o=e=>{r||(r=!0,a?.(),n(e))},s=i.querySelector(`form`);s?.addEventListener(`click`,e=>{e.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`)===`cancel`&&(e.preventDefault(),o(null))}),i.addEventListener(`cancel`,()=>o(null)),s?.addEventListener(`submit`,e=>{e.preventDefault();let n=String(i.querySelector(`[name="title"]`)?.value||``).trim();if(!n){U(`Title is required`);return}if(!t){o({title:n});return}let r=Vn(i.querySelector(`[name="url"]`)?.value||``);if(!r){U(`URL is required`);return}o({title:n,url:r})})})}function Tr(e){let t=e.entry;(async()=>{let n=await wr({heading:t.folder?`Rename folder`:`Edit bookmark`,description:t.folder?t.title:`${t.title} — Chrome bookmark`,initialTitle:t.title,initialUrl:t.url||``,showUrl:!t.folder,submitLabel:`Save`});if(!n)return;if(!e.api.update){U(`Bookmark edit unavailable`);return}let r=await e.api.update(t.id,t.folder?{title:n.title}:{title:n.title,url:n.url});if(!r){U(t.folder?`Could not rename folder`:`Could not update bookmark`);return}Qn(r),H(t.folder?`Folder renamed`:`Bookmark updated`),e.onSaved?.(r)})()}var Er,G,Dr,Or,kr,Ar;function jr(){return(jr=e((()=>{Rn(),vr(),Er=[`NEW_TASK`,`CLEAR_TOP`,`SINGLE_TOP`,`CLEAR_TASK`,`NO_HISTORY`,`REORDER_TO_FRONT`,`MULTIPLE_TASK`],G=e=>String(e??``).replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/"/g,`&quot;`),Dr=e=>{let t=Number(e);if(!Number.isFinite(t)||t<=0)return`—`;try{return new Date(t).toLocaleString()}catch{return String(t)}},Or=e=>{let t=document.createElement(`dialog`);t.className=`speed-dial-editor env-shell-app-menu__chrome-editor`,t.innerHTML=e;let n=()=>{try{t.open&&t.close()}catch{}t.remove()};t.addEventListener(`cancel`,e=>{e.preventDefault(),n()}),t.__cwspClose=n,document.body.append(t);try{t.showModal()}catch{t.setAttribute(`open`,``)}return t},kr=e=>{if(!e||!Object.keys(e).length)return``;try{return JSON.stringify(e,null,2)}catch{return``}},Ar=e=>{let t=String(e||``).trim();if(!t)return{};if(t.startsWith(`{`))try{return kn({extras:JSON.parse(t)}).extras||{}}catch{}let n={};for(let e of t.split(/\r?\n/)){let t=e.indexOf(`=`);if(t<1)continue;let r=e.slice(0,t).trim(),i=e.slice(t+1).trim();r&&(n[r]=i===`true`||i===`false`?i===`true`:/^-?\d+(\.\d+)?$/.test(i)?Number(i):i)}return n}})))()}function Mr(){return(Mr=e((()=>{N(),En(),jr(),C()})))()}var Nr,Pr,Fr,K,q,J,Ir,Lr,Rr,zr,Br,Vr,Hr,Ur,Y,Wr,Gr,Kr,qr,Jr,Yr,Xr,Zr,Qr,$r,ei,ti,ni,ri;function ii(){return(ii=e((()=>{r(),C(),Mr(),En(),Nr=320,Pr=220,Fr=`2147483640`,K=`important`,q=0,J=null,Ir=null,Lr=null,Rr=null,zr=[],Br=new Map,Vr=new Map,Hr=new Map,Ur=new Map,Y=new Map,Wr=[`left-start`,`right-end`,`left-end`,`bottom-start`,`top-start`],Gr=(e,t)=>{let n=i(e,{...t,strategy:`js`});return typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{n.update?.()}),n},Kr=()=>{let e=document.documentElement,t=String(e.getAttribute(`data-theme`)||``).trim().toLowerCase();if(t===`light`||t===`dark`)return t;let n=String(e.getAttribute(`data-scheme`)||``).trim().toLowerCase();if(n===`light`||n===`dark`)return n;try{let e=String(localStorage.getItem(`rs-appearance-theme`)||``).trim().toLowerCase();if(e===`light`||e===`dark`)return e}catch{}return typeof matchMedia==`function`&&matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`},qr=(e,t)=>{e.style.setProperty(`position`,`fixed`,K),e.style.setProperty(`box-sizing`,`border-box`,K),e.style.setProperty(`min-width`,t?`188px`:`220px`,K),e.style.setProperty(`max-width`,`min(320px, calc(100vw - 24px))`,K),e.style.setProperty(`padding`,t?`0.3rem`:`0.4rem`,K),e.style.setProperty(`border-radius`,`14px`,K),e.style.setProperty(`pointer-events`,`auto`,K),e.style.setProperty(`backdrop-filter`,`blur(10px)`,K),e.style.setProperty(`-webkit-backdrop-filter`,`blur(10px)`,K),e.style.removeProperty(`border`),e.style.removeProperty(`background`),e.style.removeProperty(`color`),e.style.removeProperty(`box-shadow`);let n=Kr();e.dataset.theme=n,e.style.setProperty(`color-scheme`,n===`light`?`light only`:`dark only`,K)},Jr=e=>{e.style.setProperty(`list-style`,`none`,K),e.style.setProperty(`list-style-type`,`none`,K),e.style.setProperty(`margin`,`0`,K),e.style.setProperty(`padding`,`0`,K),e.style.setProperty(`display`,`flex`,K),e.style.setProperty(`flex-direction`,`column`,K),e.style.setProperty(`align-items`,`stretch`,K),e.style.setProperty(`gap`,`0.2rem`,K),e.style.setProperty(`width`,`100%`,K),e.style.setProperty(`box-sizing`,`border-box`,K)},Yr=(e,t)=>{if(e.style.setProperty(`appearance`,`none`,K),e.style.setProperty(`-webkit-appearance`,`none`,K),e.style.setProperty(`box-sizing`,`border-box`,K),e.style.setProperty(`width`,`100%`,K),e.style.setProperty(`max-width`,`100%`,K),e.style.setProperty(`margin`,`0`,K),e.style.setProperty(`display`,`grid`,K),e.style.setProperty(`grid-template-columns`,`1.375rem minmax(0, 1fr) auto`,K),e.style.setProperty(`align-items`,`center`,K),e.style.setProperty(`justify-items`,`start`,K),e.style.setProperty(`gap`,`0.55rem`,K),e.style.setProperty(`border`,`none`,K),e.style.setProperty(`border-radius`,`10px`,K),e.style.setProperty(`padding`,`0.5rem 0.6rem`,K),e.style.setProperty(`min-height`,`2.35rem`,K),e.style.setProperty(`font`,`inherit`,K),e.style.setProperty(`font-size`,`0.8125rem`,K),e.style.setProperty(`line-height`,`1.25`,K),e.style.setProperty(`text-align`,`start`,K),e.style.setProperty(`cursor`,`pointer`,K),e.style.removeProperty(`background`),e.style.removeProperty(`background-color`),!t)e.style.setProperty(`color`,`inherit`,K);else{let t=Kr()===`light`?`#9f1239`:`#fecaca`;e.style.setProperty(`color`,t,K),e.style.setProperty(`--cw-menu-fg`,t,K)}},Xr=()=>{let e=document.getElementById(`cw-unified-context-menu-style`);e||(e=document.createElement(`style`),e.id=`cw-unified-context-menu-style`,document.head.appendChild(e)),e.textContent=`
        .cw-context-menu-layer {
            position: fixed;
            inset: 0;
            z-index: var(--cw-context-menu-layer-z, ${Fr});
            pointer-events: none;
        }
    ...
    `},Zr=()=>{for(let e of zr)try{e()}catch{}zr=[]},Qr=e=>{for(let[t,n]of Array.from(Ur.entries()))t>=e&&(clearTimeout(n),Ur.delete(t));for(let[t,n]of Array.from(Y.entries()))t>=e&&(clearTimeout(n),Y.delete(t))},$r=e=>{Qr(e);for(let[t,n]of Array.from(Br.entries()))t>=e&&(Hr.get(t)?.dispose(),Hr.delete(t),n.remove(),Br.delete(t),Vr.delete(t))},ei=e=>{for(let[t,n]of Array.from(Y.entries()))t>=e&&(clearTimeout(n),Y.delete(t))},ti=(e,t,n,r,i)=>{let a=document.createElement(`div`);a.className=`cw-context-menu${t?` cw-context-menu--compact`:``}`,a.setAttribute(`role`,`menu`),a.dataset.menuDepth=String(n),a.style.zIndex=String(n+1);let o=document.createElement(`ul`);o.className=`cw-context-menu__list`,Jr(o),a.appendChild(o);let s=(e,n,a)=>{if(r!==q||!Ir?.isConnected||!J?.isConnected||($r(a),!e.children?.length))return;let o=ti(e.children,t,a,r,i);o.classList.add(`cw-context-menu--submenu`),J.appendChild(o),Br.set(a,o),Vr.set(a,n),Hr.set(a,Gr(o,{origin:{type:`element`,element:n},placement:`right-start`,fallbacks:Wr,strategy:`js`}))},c=(e,t,n)=>{let r=Ur.get(n);r&&clearTimeout(r),ei(n);let i=setTimeout(()=>{Ur.delete(n),s(e,t,n)},Nr);Ur.set(n,i)},l=e=>{let t=Y.get(e);t&&clearTimeout(t);let n=setTimeout(()=>{Y.delete(e),$r(e)},Pr);Y.set(e,n)};for(let t of e){let e=document.createElement(`button`);e.type=`button`,e.className=`cw-context-menu__item${t.danger?` cw-context-menu__item--danger`:``}`,e.setAttribute(`role`,`menuitem`),e.disabled=!!t.disabled,Yr(e,!!t.danger);let i=!!t.children?.length;if(e.innerHTML=`
        ...
        `,i){let i=n+1;e.setAttribute(`aria-haspopup`,`menu`),e.addEventListener(`pointerenter`,()=>c(t,e,i)),e.addEventListener(`pointerleave`,()=>l(i)),e.addEventListener(`click`,n=>{if(n.preventDefault(),n.stopPropagation(),r!==q||!Ir?.isConnected)return;ei(i);let a=Br.get(i),o=Vr.get(i);if(a?.isConnected&&o===e){$r(i);return}s(t,e,i)})}else e.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation(),!(r!==q||!Ir?.isConnected)&&(ni(),!t.disabled&&await t.action())});let a=document.createElement(`li`);a.appendChild(e),o.appendChild(a)}return qr(a,t),a.addEventListener(`pointerenter`,()=>ei(n)),a.addEventListener(`pointerleave`,()=>{if(n>0){let e=Y.get(n);e&&clearTimeout(e);let t=setTimeout(()=>{Y.delete(n),$r(n)},Pr);Y.set(n,t)}}),a},ni=()=>{Zr(),Qr(0),Rr?.(),Rr=null,Lr?.dispose(),Lr=null,$r(1),Br.clear(),Vr.clear(),Hr.clear(),Ir?.remove(),Ir=null,J?.remove(),J=null,q+=1},ri=e=>{let n=(e.items||[]).filter(e=>e&&e.id&&e.label);if(!n.length){ni();return}Xr(),ni();let r=q,i=m()??document.body,a=document.createElement(`div`);a.className=`cw-context-menu-layer`,J=a,i.appendChild(a);let o=e.placementStrategy??`auto`,s=ti(n,!!e.compact,0,r,o);Ir=s,a.appendChild(s),Lr=Gr(s,{origin:{type:`point`,x:e.x,y:e.y},placement:`bottom-start`,gap:0,strategy:`js`}),Rr=t({id:`context-menu-${r}`,kind:`context-menu`,element:a,isActive:()=>q===r&&J===a&&a.isConnected,close:()=>(ni(),!0)});let c=e=>{if(r!==q||!J?.isConnected)return;let t=e.target;t&&J.contains(t)||ni()},l=e=>{if(r!==q||!Ir?.isConnected)return;let t=e.target;if(!t)return;let n=t.closest?.(`.cw-context-menu__item`);if(!n){$r(1);return}n.getAttribute(`aria-haspopup`)!==`menu`&&$r(1)},u=e=>{r===q&&e.key===`Escape`&&ni()},d=()=>ni();document.addEventListener(`pointerdown`,c,{capture:!0}),document.addEventListener(`contextmenu`,c,{capture:!0}),document.addEventListener(`keydown`,u),s.addEventListener(`click`,l,{capture:!0}),window.addEventListener(`resize`,d,{passive:!0}),window.addEventListener(`blur`,d,{passive:!0}),zr.push(()=>document.removeEventListener(`pointerdown`,c,{capture:!0})),zr.push(()=>document.removeEventListener(`contextmenu`,c,{capture:!0})),zr.push(()=>document.removeEventListener(`keydown`,u)),zr.push(()=>s.removeEventListener(`click`,l,{capture:!0})),zr.push(()=>window.removeEventListener(`resize`,d)),zr.push(()=>window.removeEventListener(`blur`,d))}})))()}function ai(e){let t=String(e||`default`).trim().toLowerCase();return ui[t]||`default`}function oi(e){return String(e||``).trim().toLowerCase().startsWith(`android-icon:`)}function si(e,t=`default`,n=``,r=``){let i=String(e||``).trim();if(!i)return``;let a=ai(t),o=String(n||``).trim(),s=String(r||``).trim(),c=new URLSearchParams;a!=="default"&&c.set(`v`,a),o&&c.set(`pack`,o),s&&c.set(`drawable`,s);let l=c.toString();return l?`android-icon:${i}?${l}`:`android-icon:${i}`}function ci(e){let t=String(e||``).trim();if(!oi(t))return null;let n=t.slice(13).replace(/^\/\//,``);if(!n)return null;let r=(e,t)=>{if(!e)return null;let n={packageName:e,variant:ai(t.get(`v`)||`default`)},r=String(t.get(`pack`)||``).trim(),i=String(t.get(`drawable`)||``).trim();return r&&(n.pack=r),i&&(n.drawable=i),n};try{let e=new URL(n.includes(`://`)?n:`android-icon://${n}`);return r(String(e.hostname||e.pathname.replace(/^\//,``)||``).trim(),e.searchParams)}catch{let[e,t=``]=n.split(`?`);return r(String(e||``).trim(),new URLSearchParams(t))}}function li(e,t=`default`,n=``,r=``,i=0){let a=String(e||``).trim();if(!a)return``;let o=ai(t),s=String(n||``).trim(),c=String(r||``).trim(),l=o==="default"?a:`${a}#${o}`;s&&(l=`${l}#pack:${s}`),c&&(l=`${l}#d:${c}`);let u=Math.round(Number(i)||0);return u>0&&(l=`${l}#s${u}`),l}var ui;function di(){return(di=e((()=>{ui={default:`default`,full:`default`,colored:`default`,monochrome:`monochrome`,mono:`monochrome`,material:`monochrome`,"material-you":`monochrome`,themed:`monochrome`,foreground:`foreground`,fg:`foreground`,"adaptive-fg":`foreground`}})))()}async function fi(e){let t=await(await fetch(e)).blob(),n=t.type&&t.type.startsWith(`image/`)?t.type:`image/png`,r=t.type===n?t:new Blob([await t.arrayBuffer()],{type:n});return URL.createObjectURL(r)}function pi(e){let t=String(e||``).trim();if(!t.startsWith(`shortcut:`))return null;let n=t.slice(9),r=n.indexOf(`::`);if(r>0){let e=n.slice(0,r).trim(),t=n.slice(r+2).trim();return e&&t?{packageName:e,shortcutId:t}:null}let i=n.indexOf(`/`);if(i>0){let e=n.slice(0,i).trim(),t=n.slice(i+1).trim();return e&&t?{packageName:e,shortcutId:t}:null}return null}function mi(e,t=96,n=`default`,r=``,i=``){let a=String(e||``).trim();if(!a)return``;let o=pi(a);return o?gi(o.packageName,o.shortcutId,t):Ei.get(li(a,n,r,i,t))||``}async function hi(e,t,n=96){let r=String(e||``).trim(),i=String(t||``).trim();if(!r||!i)return``;let a=Math.max(16,Math.min(512,Math.round(Number(n)||96))),o=`shortcut:${r}/${i}@${a}`,s=Oi.get(o);if(s)return s;let c=ki.get(o);return c||(c=(async()=>{let e=await bi();if(!e?.launcherShortcutIcon)return``;let t=``;try{t=String(await e.launcherShortcutIcon(r,i,a)||``).trim()}catch{return``}if(!t)return``;try{let e=await fi(t);return Oi.set(o,e),e}catch{return t}})().finally(()=>{ki.delete(o)}),ki.set(o,c)),c}function gi(e,t,n=96){let r=String(e||``).trim(),i=String(t||``).trim();if(!r||!i)return``;let a=Math.max(16,Math.min(512,Math.round(Number(n)||96)));return Oi.get(`shortcut:${r}/${i}@${a}`)||``}async function _i(e,t=96,n=`default`,r=``,i=``){let a=String(e||``).trim();if(!a)return``;let o=pi(a);if(o)return hi(o.packageName,o.shortcutId,t);let s=ai(n),c=String(r||``).trim(),l=String(i||``).trim(),u=Math.max(16,Math.min(512,Math.round(Number(t)||96))),d=li(a,s,c,l,u),f=Ei.get(d);if(f)return f;let p=Di.get(d);p||(p=(async()=>{let e=await bi();if(!e?.launcherIcon)return``;let t=``;try{t=await e.launcherIcon(a,u,s,c||void 0,l||void 0)}catch{return``}if(!t)return``;try{let e=await fi(t);return Ei.set(d,e),e}catch{return``}})(),Di.set(d,p));try{return await p}finally{Di.delete(d)}}async function vi(e,t=96){let n=String(e||``).trim();if(!n||n.startsWith(`blob:`))return``;let r=ci(n);return r?_i(r.packageName,t,r.variant,r.pack||``,r.drawable||``):n}function yi(e,t=96){let n=ci(e);return n?mi(n.packageName,t,n.variant,n.pack||``,n.drawable||``):``}async function bi(){if(Ti)return Ti;try{return await k(()=>import(`./launcher-bridge-TAl_sW_X.js`),[],import.meta.url)}catch{return null}}async function xi(){return bi()}async function Si(e){let{androidPackageForSku:t,isCwspSku:n}=await k(async()=>{let{androidPackageForSku:e,isCwspSku:t}=await import(`./ecosystem-skus-Bz92tN57.js`).then(e=>(e.c(),e.a));return{androidPackageForSku:e,isCwspSku:t}},[],import.meta.url);if(!n(e))return!1;let r=t(e);if(!r)return!1;let i=await bi();return i?.launcherLaunch?i.launcherLaunch(r):!1}async function Ci(e){try{let{isCwspNativeHost:t,readCwspSku:n,siblingSkuForView:r}=await k(async()=>{let{isCwspNativeHost:e,readCwspSku:t,siblingSkuForView:n}=await import(`./ecosystem-skus-Bz92tN57.js`).then(e=>(e.c(),e.a));return{isCwspNativeHost:e,readCwspSku:t,siblingSkuForView:n}},[],import.meta.url);if(!t())return!1;let i=n();if(i!==`launcher`&&i!==`explorer`)return!1;let a=r(e);return a?Si(a):!1}catch{return!1}}function wi(e,t,n=`colored`){let r=String(t||``).trim();if(!r)return;e.setAttribute(`icon-padding`,`0`),e.style.setProperty(`--icon-padding`,`0px`),e.style.setProperty(`--icon-size`,`100%`),e.toggleAttribute(`data-launcher-icon`,!0);let i=()=>{let t=e;return typeof t.setResourceIcon==`function`&&(t.setResourceIcon(r,n===`auto`?`auto`:n),n!==`auto`&&typeof t.setBitmapPresentationMode==`function`&&t.setBitmapPresentationMode(n,!0),e.removeAttribute(`data-icon-pending`),e.toggleAttribute(`data-launcher-icon-ready`,!0),!0)};i()||customElements.whenDefined(`ui-icon`).then(()=>{e.isConnected&&i()})}var Ti,Ei,Di,Oi,ki;function Ai(){return(Ai=e((()=>{C(),Se(),Tt(),di(),O(),Ti=null,Ei=new Map,Di=new Map,Oi=new Map,ki=new Map})))()}function ji(e){return e===`light`||e===`dark`?e:String(document.documentElement.getAttribute(`data-theme`)||``).toLowerCase()===`light`?`light`:`dark`}function Mi(e){let t=String(e||``).trim();return/^https?:\/\//i.test(t)?t:``}function Ni(e,t=128){try{let n=new URL(e).hostname;return n?`https://www.google.com/s2/favicons?domain=${encodeURIComponent(n)}&sz=${t}`:``}catch{return``}}function Pi(e,t=128){try{let n=globalThis.chrome?.runtime;if(typeof n?.getURL!=`function`)return``;let r=new URL(n.getURL(`/_favicon/`));return r.searchParams.set(`pageUrl`,e),r.searchParams.set(`size`,String(t)),r.toString()}catch{return``}}function Fi(e,t){let n=Mi(e);if(!n)return[];let r=[],i=new Set,a=(e,t)=>{let n=String(t||``).trim();!n||i.has(n)||(i.add(n),r.push({label:e,url:n}))},o=t?.resolveIconUrl?.(n,128)||t?.resolveIconUrl?.(n,64)||``,s=Ni(n,128);s&&a(`Google S2`,s);let c=Ni(n,64);c&&a(`Google S2 (64)`,c);let l=Pi(n,128);return l&&a(`Chrome favicon`,l),o&&a(`Bookmark favicon`,o),r}function Ii(e){X(e,{display:`grid`,"grid-template-columns":Ji,gap:`0.5rem 0.4rem`,"align-content":`start`,"justify-content":`stretch`,"min-inline-size":`0`,"min-block-size":`0`,"inline-size":`100%`})}function Li(e,t,n){X(e,{display:`grid`,"grid-template-columns":`minmax(0, 1fr)`,"grid-template-rows":`auto max-content`,"justify-items":`center`,"align-content":`start`,"align-items":`start`,"flex-direction":`column`,gap:`0.3rem`,margin:`0`,padding:`0.2rem 0.08rem 0.15rem`,"min-inline-size":`0`,"inline-size":`100%`,"max-inline-size":`100%`,"block-size":`auto`,"min-block-size":`0`,background:`transparent`,border:`0`,"border-radius":`0.7rem`,"box-shadow":`none`,appearance:`none`,"-webkit-appearance":`none`,position:`static`,"z-index":`auto`,overflow:`hidden`}),X(t,{display:`block`,"grid-row":`1`,"inline-size":`3rem`,"block-size":`3rem`,"max-inline-size":`3rem`,"max-block-size":`3rem`,"object-fit":`cover`,"border-radius":`50%`,"flex-shrink":`0`}),X(n,{display:`block`,"grid-row":`2`,"inline-size":`100%`,"max-inline-size":`100%`,overflow:`hidden`,"text-overflow":`ellipsis`,"white-space":`nowrap`,"font-size":`0.62rem`,"line-height":`1.2`,"text-align":`center`,opacity:`0.88`})}function Ri(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`sd-icon-picker__card`,n.title=t||e;let r=document.createElement(`img`);r.alt=``,r.decoding=`async`,r.draggable=!1,r.referrerPolicy=`no-referrer`;let i=document.createElement(`span`);return i.className=`sd-icon-picker__card-label`,i.textContent=e,n.append(r,i),Li(n,r,i),{btn:n,img:r}}async function zi(e,t,n,r,i){n.replaceChildren();let a=qi.map(e=>({...e,available:!0}));try{let n=await e.launcherIconVariants?.(t);Array.isArray(n)&&n.length&&(a=n.map(e=>({id:ai(e.id),label:String(e.label||e.id),available:e.available!==!1})))}catch{}for(let e of a){if(!e.available&&e.id!=="default")continue;let{btn:a,img:o}=Ri(e.label);n.append(a),_i(t,96,e.id).then(t=>{if(!t){a.disabled=!0,a.title=`${e.label} (unavailable)`;return}o.src=t}),a.addEventListener(`click`,()=>{r({iconUrl:si(t,e.id),packageName:t,variant:e.id,label:e.label,source:`android`}),i()})}}async function Bi(e,t,n,r,i){if(n.replaceChildren(),n.classList.remove(`sd-icon-picker__grid--browse`),Ii(n),!e.launcherIconPacks){n.textContent=`Icon packs unavailable.`;return}let a=[];try{a=await e.launcherIconPacks()}catch{n.textContent=`Failed to list icon packs.`;return}if(!a.length){n.textContent=`No icon packs installed.`;return}let o=document.createDocumentFragment();for(let s of a.slice(0,64)){let a=String(s.packageName||``).trim();if(!a)continue;let c=String(s.label||a),l=document.createElement(`div`);l.className=`sd-icon-picker__pack-wrap`,X(l,{position:`relative`,"min-inline-size":`0`,"inline-size":`100%`});let{btn:u,img:d}=Ri(c,`${c} — tap to apply, grid to browse`);_i(t,96,`default`,a).then(e=>{if(e){d.src=e;return}u.disabled=!0,u.title=`${c} (no cover for this app)`,_i(a,72,`default`).then(e=>{e&&(d.src=e)})}),u.addEventListener(`click`,()=>{u.disabled||(r({iconUrl:si(t,`default`,a),packageName:t,variant:`default`,pack:a,label:c,source:`icon-pack`}),i())});let f=document.createElement(`button`);f.type=`button`,f.className=`sd-icon-picker__pack-browse`,X(f,{position:`absolute`,"inset-block-start":`0`,"inset-inline-end":`0`,display:`grid`,"place-items":`center`,margin:`0`,padding:`0`,"inline-size":`1.2rem`,"block-size":`1.2rem`,"min-inline-size":`1.2rem`,"min-block-size":`1.2rem`,border:`0`,"border-radius":`999px`}),f.title=`Browse icons in ${c}`,f.setAttribute(`aria-label`,`Browse icons in ${c}`),f.innerHTML=`<ui-icon icon="squares-four" aria-hidden="true"></ui-icon>`,f.addEventListener(`click`,o=>{o.preventDefault(),o.stopPropagation(),n.dataset.packBrowse=`1`,Vi(e,t,a,c,n,r,i,()=>{delete n.dataset.packBrowse,Bi(e,t,n,r,i)})}),l.append(u,f),o.append(l)}n.append(o)}async function Vi(e,t,n,r,i,a,o,s){i.replaceChildren(),i.classList.add(`sd-icon-picker__grid--browse`),i.style.setProperty(`display`,`grid`,`important`),i.style.setProperty(`grid-template-columns`,`minmax(0, 1fr)`,`important`),i.style.setProperty(`grid-template-rows`,`auto minmax(0, 1fr)`,`important`),i.style.setProperty(`gap`,`0.35rem`,`important`);let c=document.createElement(`div`);c.className=`sd-icon-picker__pack-toolbar`;let l=document.createElement(`button`);l.type=`button`,l.className=`sd-icon-picker__pack-back`,l.textContent=`Packs`,l.addEventListener(`click`,()=>s());let u=document.createElement(`span`);u.className=`sd-icon-picker__pack-title`,u.textContent=r;let d=document.createElement(`input`);d.type=`search`,d.placeholder=`Filter…`,d.autocomplete=`off`,d.className=`sd-icon-picker__search`,c.append(l,u,d);let f=document.createElement(`div`);f.className=`sd-icon-picker__grid`,Ii(f),i.append(c,f);let p=0,m=()=>{(async()=>{if(f.replaceChildren(),!e.launcherIconPackIcons){f.textContent=`Pack browse unavailable.`;return}let i=[];try{i=await e.launcherIconPackIcons(n,String(d.value||``),96)}catch{f.textContent=`Failed to list pack icons.`;return}if(!i.length){f.textContent=`No matching icons.`;return}let s=document.createDocumentFragment(),c=t||n;for(let e of i){let t=String(e.drawable||``).trim();if(!t)continue;let{btn:i,img:l}=Ri(String(e.label||t),`${r}: ${t}`);s.append(i),_i(c,72,`default`,n,t).then(e=>{e?l.src=e:i.disabled=!0}),i.addEventListener(`click`,()=>{i.disabled||(a({iconUrl:si(c,`default`,n,t),packageName:c,variant:`default`,pack:n,drawable:t,label:String(e.label||t),source:`icon-pack`}),o())})}f.append(s)})()};d.addEventListener(`input`,()=>{window.clearTimeout(p),p=window.setTimeout(m,160)}),m()}async function Hi(e,t,n,r,i){if(n.replaceChildren(),!e.launcherList){n.textContent=`App list unavailable.`;return}let a=[];try{a=await e.launcherList(t)}catch{n.textContent=`Failed to list apps.`;return}if(!a.length){n.textContent=t.trim()?`No matches.`:`No apps.`;return}let o=document.createDocumentFragment();for(let e of a.slice(0,96)){let t=String(e.packageName||``).trim();if(!t)continue;let{btn:n,img:a}=Ri(String(e.label||t),`${e.label} (${t})`);o.append(n),_i(String(e.iconCacheKey||t).trim()||t,72,`default`).then(e=>{e&&(a.src=e)}),n.addEventListener(`click`,()=>{r({iconUrl:si(t,`default`),packageName:t,variant:`default`,label:String(e.label||t),source:`android`}),i()})}n.append(o)}function Ui(e,t,n,r,i){n.replaceChildren();let a=Fi(e,t);if(!a.length){n.textContent=`No favicon sources for this URL.`;return}for(let e of a){let{btn:t,img:a}=Ri(e.label,e.url);a.src=e.url,a.addEventListener(`error`,()=>{t.disabled=!0,t.title=`${e.label} (failed to load)`}),t.addEventListener(`click`,()=>{r({iconUrl:e.url,label:e.label,source:`favicon`}),i()}),n.append(t)}}async function Wi(e,t,n,r,i){n.replaceChildren();let a=[];try{let n=String(t||``).trim();a=n?await e.search(n):await e.listChildren()}catch{n.textContent=`Failed to list bookmarks.`;return}let o=a.filter(e=>!e.folder&&Mi(e.url));if(!o.length){n.textContent=t.trim()?`No matching bookmarks.`:`No bookmarks.`;return}let s=document.createDocumentFragment();for(let t of o.slice(0,80)){let n=Mi(t.url);if(!n)continue;let a=e.resolveIconUrl?.(n,64)||Pi(n,64)||Ni(n,64),{btn:o,img:c}=Ri(String(t.title||n),n);a&&(c.src=a),s.append(o),o.addEventListener(`click`,()=>{let o=e.resolveIconUrl?.(n,128)||Pi(n,128)||Ni(n,128)||a;o&&(r({iconUrl:o,label:String(t.title||n),source:`bookmark`}),i())})}n.append(s)}async function Gi(e){let t=await xi(),n=Wn(),r=!!t?.launcherIcon,i=Mi(e.pageUrl)||Mi(e.currentUrl)||``;if(!r&&!(n||i)){console.warn(`[icon-resource-picker] no launcher bridge or bookmarks/favicon source`);return}let a=ji(e.theme),o=String(e.packageName||``).trim(),s=r&&!!o,c=r&&!!o&&!!t?.launcherIconPacks,l=r&&!!t?.launcherList,u=!!i,d=!!n,f=[];s&&f.push({id:`variants`,label:`This app`}),c&&f.push({id:`packs`,label:`Packs`}),u&&f.push({id:`favicon`,label:`Link`}),l&&f.push({id:`browse`,label:`Apps`}),d&&f.push({id:`bookmarks`,label:`Bookmarks`});let p=f[0]?.id||`browse`,m=document.createElement(`dialog`);m.className=`sd-icon-picker`,m.dataset.theme=a,m.dataset.tab=p,m.innerHTML=`
            ...
            <div class="modal-fields">
                <div class="modal-field">
                    ...
                    <select id="am-chrome-shape" name="shape">
                        ${me.map(e=>`<option value="${e.value}"${de(t.shape,`circle`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-display">Icon display</label>
                    <select id="am-chrome-display" name="iconDisplay">
                        ${Be.map(e=>`<option value="${e.value}"${(ie(t.iconDisplay)||`colored`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-icon-scale">Icon scale (inside plate)</label>
                    <select id="am-chrome-icon-scale" name="iconScale">
                        ${Ie.map(e=>`<option value="${e.value}"${Ae(t.iconScale)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
    ...
    `;let a=i.querySelector(`form`),o=a?.querySelector(`.modal-actions`);o&&(o.style.setProperty(`display`,`grid`,`important`),o.style.setProperty(`grid-template-columns`,`1fr auto auto`,`important`),o.style.setProperty(`align-items`,`center`,`important`),o.style.setProperty(`gap`,`0.45rem`,`important`));let s=i.querySelector(`select[name="shape"]`),c=i.querySelector(`select[name="iconDisplay"]`),l=i.querySelector(`select[name="iconScale"]`),u=i.querySelector(`input[name="icon"]`),d=i.querySelector(`input[name="iconUrl"]`),f=i.querySelector(`[data-field="glyph"]`),p=i.querySelector(`[data-field="url"]`),m=String(e.packageName||``).trim()||(e.key.startsWith(`app:`)?e.key.slice(4):``),h=String(e.pageUrl||``).trim();p&&d&&Ki(p,d,{packageName:m,pageUrl:h});let g=()=>{let e=ie(c?.value)||`colored`;f&&(e===`glyph`?f.removeAttribute(`hidden`):f.setAttribute(`hidden`,``)),p&&(e===`glyph`?p.setAttribute(`hidden`,``):p.removeAttribute(`hidden`))};c?.addEventListener(`change`,g),g();let _=()=>{try{i.open&&i.close()}catch{}i.remove()};a?.addEventListener(`click`,t=>{let n=t.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`);n===`cancel`&&(t.preventDefault(),_()),n===`reset`&&(t.preventDefault(),na(e.key),e.onSave({}),_())}),a?.addEventListener(`submit`,t=>{t.preventDefault();let n=String(d?.value||``).trim(),r={shape:de(s?.value,`circle`),iconDisplay:ie(c?.value)||`colored`,iconScale:Ae(l?.value),icon:String(u?.value||``).trim(),iconUrl:n.startsWith(`blob:`)?``:n};ta(e.key,r),e.onSave(r),_()}),i.addEventListener(`cancel`,e=>{e.preventDefault(),_()}),document.body.append(i);try{i.showModal()}catch{i.setAttribute(`open`,``)}}var ia,aa;function oa(){return(oa=e((()=>{ae(),Se(),Yi(),ia=`cwsp-app-menu-tile-chrome-v1`,aa=null})))()}var sa,ca,la,ua,da,fa,pa,ma,ha,ga,_a,va,ya,ba,xa,Sa,Ca,wa,Ta,Ea,Da;function Oa(){return(Oa=e((()=>{oa(),ae(),Ai(),sa=`cwsp:app-menu-sort-change`,ca=`cwsp-app-menu-sort`,la=[[`name`,`Name`],[`installed`,`Date installed`],[`updated`,`Date updated`],[`color`,`Color (including mask)`],[`category`,`Category`],[`package`,`Package`]],ua=new Set(la.map(([e])=>e)),da=new Map,fa=(e,t=`name`)=>{let n=String(e||``).trim().toLowerCase();return n===`install`||n===`install-date`||n===`date-installed`?`installed`:n===`update`||n===`update-date`||n===`date-updated`||n===`recent`?`updated`:n===`hue`||n===`colour`?`color`:ua.has(n)?n:t},pa=(e,t=`asc`)=>{let n=String(e||``).trim().toLowerCase();return n===`desc`||n===`descending`||n===`newest`||n===`z-a`?`desc`:n===`asc`||n===`ascending`||n===`oldest`||n===`a-z`?`asc`:t},ma=e=>e===`installed`||e===`updated`?`desc`:`asc`,ha=()=>{try{let e=localStorage.getItem(ca);if(e){let t=JSON.parse(e),n=fa(t.sortBy);return{sortBy:n,sortDir:pa(t.sortDir,ma(n))}}}catch{}return{sortBy:`name`,sortDir:`asc`}},ga=e=>{let t=ha(),n=e.sortBy==null?t.sortBy:fa(e.sortBy,t.sortBy),r={sortBy:n,sortDir:e.sortDir==null?t.sortDir:pa(e.sortDir,ma(n))};try{localStorage.setItem(ca,JSON.stringify(r))}catch{}try{window.dispatchEvent(new CustomEvent(sa,{detail:r}))}catch{}return r},_a=(e,t)=>e.localeCompare(t,void 0,{numeric:!0,sensitivity:`base`})||e.localeCompare(t),va=(e,t)=>e===t?0:e<t?-1:1,ya=e=>String(e.category||``).trim().toLowerCase()||(e.system?`system`:String(e.installer||``).trim().toLowerCase()||`other`),ba=e=>{let t=ea(Qi(String(e.packageName||``)));return he({iconDisplay:t.iconDisplay,iconUrl:t.iconUrl,isLauncherApp:!0})||`colored`},xa=e=>{let t=String(e||``).trim(),n=/^#([0-9a-f]{3}|[0-9a-f]{6})$/i.exec(t);if(n){let e=n[1],t=e.length===3?e.split(``).map(e=>parseInt(e+e,16)):[parseInt(e.slice(0,2),16),parseInt(e.slice(2,4),16),parseInt(e.slice(4,6),16)];return{r:t[0],g:t[1],b:t[2]}}let r=/rgba?\(\s*([\d.]+)[,\s/]+([\d.]+)[,\s/]+([\d.]+)/i.exec(t);return r?{r:Number(r[1]),g:Number(r[2]),b:Number(r[3])}:null},Sa=(e,t,n)=>{let r=e/255,i=t/255,a=n/255,o=Math.max(r,i,a),s=o-Math.min(r,i,a);if(s<1e-4)return 0;let c=0;return c=o===r?(i-a)/s%6:o===i?(a-r)/s+2:(r-i)/s+4,c*=60,c<0&&(c+=360),c},Ca=e=>{try{let t=getComputedStyle(e||document.documentElement),n=t.getPropertyValue(`--env-app-menu-ink`)||t.color,r=xa(n);return r?Sa(r.r,r.g,r.b):210}catch{return 210}},wa=(e,t,n)=>new Promise(r=>{let i=new Image;i.decoding=`async`,i.onload=()=>{try{let e=document.createElement(`canvas`);e.width=32,e.height=32;let a=e.getContext(`2d`,{willReadFrequently:!0});if(!a){r(n);return}a.drawImage(i,0,0,32,32);let o=a.getImageData(0,0,32,32).data,s=0,c=0,l=0,u=0;for(let e=0;e<o.length;e+=4){let n=o[e+3]/255;if(n<.12)continue;let r=o[e],i=o[e+1],a=o[e+2],d=(.2126*r+.7152*i+.0722*a)/255,f=t===`masked-inverse`?1-d:d,p=t===`colored`?n:n*(.15+.85*f);s+=r*p,c+=i*p,l+=a*p,u+=p}if(u<.001){r(n);return}let d=Sa(s/u,c/u,l/u);(t===`masked`||t===`masked-inverse`)&&(d=(d*.28+n*.72)%360),r(d)}catch{r(n)}},i.onerror=()=>r(n),i.src=e}),Ta=async(e,t)=>{let n=Ca(t),r=[];for(let t of e){let e=String(t.packageName||t.iconCacheKey||``).trim();if(!e)continue;let i=ba(t),a=`${e}|${i}`;da.has(a)||r.push((async()=>{try{let r=await _i(t.iconCacheKey||e,32),o=r?await wa(r,i,n):n;da.set(a,o)}catch{da.set(a,n)}})())}for(let e=0;e<r.length;e+=12)await Promise.all(r.slice(e,e+12))},Ea=e=>{let t=String(e.packageName||e.iconCacheKey||``).trim(),n=ba(e);return da.get(`${t}|${n}`)??0},Da=(e,t)=>{let n=t.sortDir===`desc`?-1:1;return[...e].sort((e,r)=>{let i=0;return i=t.sortBy===`installed`?va(Number(e.firstInstallTime||0),Number(r.firstInstallTime||0)):t.sortBy===`updated`?va(Number(e.lastUpdateTime||0),Number(r.lastUpdateTime||0)):t.sortBy===`color`?va(Ea(e),Ea(r)):t.sortBy===`category`?_a(ya(e),ya(r)):t.sortBy===`package`?_a(String(e.packageName||``),String(r.packageName||``)):_a(String(e.label||e.packageName||``),String(r.label||r.packageName||``)),i||=_a(String(e.label||``),String(r.label||``)),i||=_a(String(e.packageName||``),String(r.packageName||``)),i*n})}})))()}var ka;function Aa(){return(Aa=e((()=>{ka=`@layer components {
...
}`})))()}function ja(){return document.documentElement.dataset.cwspShellRole===`launcher`||globalThis.__RS_SHELL_ROLE__===`launcher`}function Ma(){return ja()||Gn()}function Na(){return ja()?`launcher`:Gn()?`bookmarks`:null}async function Pa(){if(Xa)return Xa;try{return await k(()=>import(`./launcher-bridge-TAl_sW_X.js`),[],import.meta.url)}catch{return null}}function Fa(){if(!qa){qa=!0;try{document.adoptedStyleSheets=[...document.adoptedStyleSheets,Ka]}catch{}}}function Ia(){return document.querySelector(`.env-shell-root`)||document.querySelector(`env-shell-container`)||document.querySelector(`.env-shell-chrome`)?.parentElement||document.body}function La(e,t){let n=document.createElement(`div`);n.className=`env-shell-app-menu__drag-ghost`,n.setAttribute(`aria-hidden`,`true`);let r=e.cloneNode(!0);r.className=`env-shell-app-menu__drag-ghost-icon ui-ws-item-icon shaped`,r.setAttribute(`data-shape`,de(e.getAttribute(`data-shape`),`circle`));let i=document.createElement(`span`);return i.className=`env-shell-app-menu__drag-ghost-label`,i.textContent=t,n.append(r,i),n}function Ra(e,t){let n=de(t.chrome.shape,Za);e.setAttribute(`data-shape`,n),e.classList.add(`ui-ws-item-icon`,`shaped`);let r=String(t.chrome.iconUrl||``).trim()||String(t.resourceUrl||``).trim(),i=be(t.chrome.iconScale),a=oi(r)?yi(r,i):``,o=String(a||(oi(r)?``:r)||``).trim(),s=ie(t.chrome.iconDisplay)||he({iconDisplay:t.chrome.iconDisplay,iconUrl:o||r,isLauncherApp:!!t.launcher,isBookmarkFavicon:!!(o||r)&&!t.launcher});e.setAttribute(`data-icon-display`,s),ye(e,ze(s,t.chrome.iconScale)),e.replaceChildren();let c=()=>{Ee(e),Oe(e)};if(s===`glyph`){let n=String(t.chrome.icon||t.fallbackGlyph||`device-mobile`).trim()||`device-mobile`,r=document.createElement(`ui-icon`);r.setAttribute(`icon`,n),r.setAttribute(`icon-style`,`duotone`),r.setAttribute(`aria-hidden`,`true`),e.append(r),c();return}if(s===`colored`){let n=document.createElement(`img`);n.className=t.launcher?`ui-ws-item-icon-img`:`ui-ws-item-icon-img env-shell-app-menu__tile-favicon`,n.alt=``,n.decoding=`async`,n.draggable=!1,n.referrerPolicy=`no-referrer`,!t.launcher&&(Bn(o)||Bn(r))?n.toggleAttribute(`data-bookmark-favicon`,!0):t.launcher&&n.toggleAttribute(`data-launcher-icon`,!0),o?n.src=o:n.toggleAttribute(`data-icon-pending`,!0),e.append(n),c(),oi(r)&&vi(r,i).then(e=>{!e||!n.isConnected||(n.src=e,n.removeAttribute(`data-icon-pending`),c())});return}let l=re({display:s,glyph:String(t.chrome.icon||t.fallbackGlyph||`device-mobile`),resourceUrl:o||void 0,launcher:t.launcher,className:`ui-ws-item-icon-native`});e.append(l),c(),t.launcher&&o&&s!==`glyph`&&(wi(l,o,s),c()),oi(r)&&vi(r,i).then(e=>{!e||!l.isConnected||(wi(l,e,s),c())})}function za(e,t,n,r){let i=()=>Fe(t),a=typeof window<`u`&&(window.matchMedia?.(`(pointer: coarse)`)?.matches||`ontouchstart`in window);e.draggable=!a,a||(e.addEventListener(`dragstart`,e=>{let t=i();if(e.dataTransfer?.setData(`text/plain`,t),e.dataTransfer?.setData(`application/json`,t),e.dataTransfer){e.dataTransfer.effectAllowed=`copy`;try{e.dataTransfer.setDragImage(n,24,24)}catch{}}document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0)}),e.addEventListener(`dragend`,()=>{document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1)}));let o,s=null,c=0,l=0,u=!1,d=!1,f=!1,p=null,m=()=>{o&&=(clearTimeout(o),void 0)},h=()=>{if(m(),u=!1,d&&(d=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),p?.remove(),p=null,s!=null)){try{e.releasePointerCapture(s)}catch{}s=null}},g=(r,i,a)=>{if(!d){u=!1,d=!0,f=!0,e.classList.add(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0),p=La(n,t.label),document.body.appendChild(p),p.style.transform=`translate(${r}px, ${i}px) translate(-50%, -50%)`;try{e.setPointerCapture(a)}catch{}}},_=(e,t)=>{p&&(p.style.transform=`translate(${e}px, ${t}px) translate(-50%, -50%)`)},v=(e,n)=>{if(!Ce(e,n))return;let i=Re(e,n);ve(t,i??void 0)&&(H(`Pinned ${t.label} to desktop`),r.onPinned?.())},y=t=>{if(d){if(d=!1,u=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),p?.remove(),p=null,s!=null){try{e.releasePointerCapture(s)}catch{}s=null}v(t.clientX,t.clientY)}};e.addEventListener(`pointerdown`,e=>{e.button===0&&(m(),s=e.pointerId,c=e.clientX,l=e.clientY,f=!1,d=!1,u=!1,o=setTimeout(()=>{o=void 0,u=!0,f=!0},Ja))},{passive:!0}),e.addEventListener(`pointermove`,e=>{if(o&&!d&&!u){let t=e.clientX-c,n=e.clientY-l;Math.hypot(t,n)>Ya&&m();return}if(u&&!d){let t=e.clientX-c,n=e.clientY-l;Math.hypot(t,n)>Ya&&g(e.clientX,e.clientY,e.pointerId);return}d&&(_(e.clientX,e.clientY),e.preventDefault())},{passive:!1}),e.addEventListener(`pointerup`,e=>{if(m(),u=!1,d){y(e);return}}),e.addEventListener(`pointercancel`,e=>{m(),u=!1,d&&y(e)}),e.addEventListener(`contextmenu`,()=>{h()},!0),e.addEventListener(`click`,e=>{f&&=(e.preventDefault(),e.stopPropagation(),!1)},!0)}async function Ba(e,t){let n=Pn(t.packageName),r=n.componentName||t.componentName;await e.launcherLaunch(t.packageName,r,An(n)?void 0:n)||U(`Unable to open “${t.label}”`)}function Va(e,t,n,r,i){let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-app-menu__tile`,a.setAttribute(`data-package`,e.packageName),a.title=`${e.label} — right-click: info / uninstall / launch; hold and drag`;let o=Qi(e.packageName),s=document.createElement(`span`);s.className=`env-shell-app-menu__tile-icon ui-ws-item-icon shaped`;let c=document.createElement(`span`);c.className=`env-shell-app-menu__tile-label`,c.textContent=e.label,a.append(s,c);let l=e.iconCacheKey||e.packageName,u=(e=``)=>{Ra(s,{chrome:ea(o),fallbackGlyph:`device-mobile`,resourceUrl:e,launcher:!0})},d=be(ea(o).iconScale);return u(mi(l,d)),_i(l,d).then(e=>{n===r()&&e&&u(e)}).catch(()=>{}),za(a,e,s,i),a.addEventListener(`contextmenu`,n=>{n.preventDefault(),n.stopPropagation(),ri({x:n.clientX,y:n.clientY,compact:!0,items:[{id:`place-desktop`,label:`Place on desktop`,icon:`desktop`,action:()=>{ve(e)&&(H(`Placed “${e.label}” on desktop`),i.onPinned?.())}},{id:`icon-design`,label:`Icon design…`,icon:`palette`,action:()=>{ra({title:e.label,key:o,packageName:e.packageName,defaults:{shape:Za,iconDisplay:`colored`},onSave:e=>{let t={...ea(o),...e},n=be(t.iconScale),r=(e=``)=>{Ra(s,{chrome:t,fallbackGlyph:`device-mobile`,resourceUrl:e,launcher:!0})};r(mi(l,n)||(oi(String(t.iconUrl||``))?``:String(t.iconUrl||``).trim())),oi(String(t.iconUrl||``))?vi(t.iconUrl,n).then(e=>{e&&r(e)}):_i(l,n).then(e=>{e&&r(e)})}})}},{id:`launch`,label:`Open`,icon:`arrow-square-out`,action:async()=>{try{await Ba(t,e)}catch{}}},{id:`app-info`,label:`App info`,icon:`info`,action:async()=>{let n=null;try{n=await t.launcherAppInfo?.(e.packageName)||null}catch{n=null}yr({title:e.label,fallback:{packageName:e.packageName,componentName:e.componentName,label:e.label},info:n,onOpenSystem:t.launcherOpenAppInfo?()=>t.launcherOpenAppInfo(e.packageName):void 0})}},...t.launcherOpenAppInfo?[{id:`android-settings`,label:`Android settings`,icon:`gear`,action:async()=>{try{await t.launcherOpenAppInfo(e.packageName)||U(`Cannot open Android settings for “${e.label}”`)}catch{U(`Cannot open Android settings for “${e.label}”`)}}}]:[],{id:`edit-launch`,label:`Edit launch…`,icon:`sliders`,action:()=>{br({title:e.label,packageName:e.packageName,defaultComponent:e.componentName})}},...t.launcherUninstall?[{id:`uninstall`,label:`Uninstall`,icon:`trash`,danger:!0,action:async()=>{if(xr(e.label,`Uninstall`))try{if(!await t.launcherUninstall(e.packageName)){U(`Cannot uninstall “${e.label}”`);return}H(`Uninstall started for “${e.label}”`),Sr(()=>i.onAppsChanged?.())}catch{U(`Cannot uninstall “${e.label}”`)}}}]:[]]})}),a.addEventListener(`click`,async n=>{n.preventDefault(),n.stopPropagation();try{await Ba(t,e)}catch{}}),a}function Ha(e,t,n,r,i){if(t.folder||!String(t.url||``).trim())return;let a,o=!1,s=!1,c=0,l=0,u=-1,d=null,f=()=>{a!=null&&(clearTimeout(a),a=void 0)},p=()=>{if(f(),o=!1,s){s=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),d?.remove(),d=null;try{e.releasePointerCapture?.(u)}catch{}}},m=(r,i)=>{if(!s){o=!1,s=!0,e.classList.add(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0),d=La(n,t.title),document.body.appendChild(d),d.style.transform=`translate(${r}px, ${i}px) translate(-50%, -50%)`;try{e.setPointerCapture?.(u)}catch{}}},h=(n,a)=>{if(f(),o=!1,s){s=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),d?.remove(),d=null;try{e.releasePointerCapture?.(u)}catch{}if(Ce(n,a)){let e=Re(n,a)??void 0,o=String(r.current||``).trim()||tr(t,Wn());nr(t,e,Wn(),o)&&(H(`Placed “${t.title}” on desktop`),i.onPinned?.())}}};e.addEventListener(`pointerdown`,e=>{(e.button==null||e.button===0)&&(c=e.clientX,l=e.clientY,u=e.pointerId,s=!1,o=!1,f(),a=setTimeout(()=>{a=void 0,o=!0},Ja))}),e.addEventListener(`pointermove`,e=>{if(!s&&!o){if(a==null)return;let t=e.clientX-c,n=e.clientY-l;t*t+n*n>100&&f();return}if(o&&!s){let t=e.clientX-c,n=e.clientY-l;t*t+n*n>100&&m(e.clientX,e.clientY);return}d&&(d.style.transform=`translate(${e.clientX}px, ${e.clientY}px) translate(-50%, -50%)`,e.preventDefault())},{passive:!1}),e.addEventListener(`pointerup`,e=>h(e.clientX,e.clientY)),e.addEventListener(`pointercancel`,e=>h(e.clientX,e.clientY)),e.addEventListener(`contextmenu`,()=>p(),!0)}function Ua(e,t,n,r,i){e.addEventListener(`contextmenu`,a=>{if(a.preventDefault(),a.stopPropagation(),t.folder){ri({x:a.clientX,y:a.clientY,compact:!0,items:[{id:`open-folder`,label:`Open folder`,icon:`folder-open`,action:()=>{e.click()}},{id:`bm-info`,label:`Info`,icon:`info`,action:()=>{Cr(t)}},...n.update?[{id:`bm-edit`,label:`Rename folder…`,icon:`pencil`,action:()=>{Tr({entry:t,api:n,onSaved:()=>i.onAppsChanged?.()})}}]:[],...n.remove?[{id:`bm-delete`,label:`Delete folder`,icon:`trash`,danger:!0,action:async()=>{if(xr(t.title,`Delete`))try{if(!await n.remove(t)){U(`Could not delete “${t.title}”`);return}H(`Deleted “${t.title}”`),$n(t.id),i.onAppsChanged?.()}catch{U(`Could not delete “${t.title}”`)}}}]:[]]});return}let o=Yn(t.id);ri({x:a.clientX,y:a.clientY,compact:!0,items:[{id:`place-desktop`,label:`Place on desktop`,icon:`desktop`,action:()=>{nr(t,void 0,n,String(r.current||``).trim()||tr(t,n))&&(H(`Placed “${t.title}” on desktop`),i.onPinned?.())}},{id:`icon-design`,label:`Icon design…`,icon:`palette`,action:()=>{let i=$i(t.id);ra({title:t.title,key:i,pageUrl:String(t.url||``).trim(),defaults:{shape:Za,iconDisplay:`colored`},onSave:a=>{let o=e.querySelector(`.env-shell-app-menu__tile-icon`);if(!o)return;let s={...ea(i),...a},c=String(s.iconUrl||``).trim()||String(r.current||``).trim()||tr(t,n);Ra(o,{chrome:s,fallbackGlyph:t.folder?`folder`:`link`,resourceUrl:c}),c&&(r.current=c)}})}},o?{id:`unpin-start`,label:`Unpin from Start`,icon:`push-pin-slash`,action:()=>{Zn(t.id)&&(H(`Unpinned “${t.title}”`),i.onStartPinsChanged?.())}}:{id:`pin-start`,label:`Pin to Start`,icon:`push-pin`,action:()=>{Xn(t)&&(H(`Pinned “${t.title}” to Start`),i.onStartPinsChanged?.())}},{id:`open`,label:`Open`,icon:`arrow-square-out`,action:async()=>{qn(t);try{await n.open(t)}catch{}}},{id:`bm-info`,label:`Info`,icon:`info`,action:()=>{Cr(t)}},...n.update&&!t.folder?[{id:`bm-edit`,label:`Edit bookmark…`,icon:`pencil`,action:()=>{Tr({entry:t,api:n,onSaved:()=>i.onAppsChanged?.()})}}]:[],...n.remove?[{id:`bm-delete`,label:t.folder?`Delete folder`:`Delete`,icon:`trash`,danger:!0,action:async()=>{if(xr(t.title,`Delete`))try{if(!await n.remove(t)){U(`Could not delete “${t.title}”`);return}H(`Deleted “${t.title}”`),$n(t.id),i.onAppsChanged?.()}catch{U(`Could not delete “${t.title}”`)}}}]:[]]})})}function Wa(e,t,n,r){let i=document.createElement(`button`);i.type=`button`,i.className=`env-shell-app-menu__tile`,i.setAttribute(`data-bookmark-id`,e.id),e.folder&&i.setAttribute(`data-folder`,``),i.title=e.folder?`${e.title} — open folder`:`${e.title} — right-click: info / edit / delete; hold to drag`;let a=$i(e.id),o=document.createElement(`span`);o.className=`env-shell-app-menu__tile-icon ui-ws-item-icon shaped`,o.setAttribute(`data-shape`,Za);let s=document.createElement(`span`);s.className=`env-shell-app-menu__tile-label`,s.textContent=e.title,i.append(o,s);let c={current:``},l=t=>{let n=ea(a);if(n.shape||n.iconDisplay||n.icon||n.iconUrl){Ra(o,{chrome:n,fallbackGlyph:e.folder?`folder`:`link`,resourceUrl:String(n.iconUrl||t||``).trim()});return}o.setAttribute(`data-shape`,Za)};return ar(o,e,t).then(e=>{c.current=e,l(e)}),Ha(i,e,o,c,n),Ua(i,e,t,c,n),i.addEventListener(`click`,async n=>{if(n.preventDefault(),n.stopPropagation(),!document.documentElement.hasAttribute(`data-app-menu-dragging`)){if(e.folder){r(e.id,e.title);return}qn(e);try{await t.open(e)}catch{}}}),i}function Ga(){Fa();let e=Na(),t=document.createElement(`div`);t.className=`env-shell-app-menu`,t.hidden=!0,t.setAttribute(`role`,`dialog`),t.setAttribute(`aria-modal`,`false`),t.setAttribute(`aria-label`,e===`bookmarks`?`Bookmarks`:`Apps`),e&&t.setAttribute(`data-menu-mode`,e);let n=()=>{try{let e=document.documentElement,n=(e.getAttribute(`data-theme`)||``).toLowerCase(),r=(e.style.colorScheme||``).trim().toLowerCase(),i=n===`light`||n===`dark`?n:r===`light`||r===`dark`?r:``;if(i===`light`||i===`dark`){t.dataset.theme=i,t.style.colorScheme=i;return}delete t.dataset.theme,t.style.colorScheme=`inherit`}catch{}};n();let r=()=>n();document.addEventListener(`u2-theme-change`,r);let i=new MutationObserver(r);try{i.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`data-scheme`,`style`]})}catch{}let a=document.createElement(`div`);a.className=`env-shell-app-menu__panel`,e===`bookmarks`&&a.setAttribute(`data-layout`,`start-split`);let o=document.createElement(`div`);o.className=`env-shell-app-menu__banner`,o.hidden=!0;let s=document.createElement(`p`);s.className=`env-shell-app-menu__banner-text`,s.textContent=`Set CWSP Launcher as Home`;let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-app-menu__banner-action btn`,c.textContent=`Set as default`,o.append(s,c);let l=document.createElement(`input`);l.type=`search`,l.className=`env-shell-app-menu__search`,l.placeholder=e===`bookmarks`?`Search bookmarks`:`Search apps`,l.autocomplete=`off`,l.setAttribute(`aria-label`,e===`bookmarks`?`Search bookmarks`:`Search apps`);let u=document.createElement(`div`);u.className=`env-shell-app-menu__tools`;let d=document.createElement(`select`);d.className=`env-shell-app-menu__sort`,d.setAttribute(`aria-label`,`Sort apps`);for(let[e,t]of la){let n=document.createElement(`option`);n.value=e,n.textContent=t,d.appendChild(n)}let f=document.createElement(`select`);f.className=`env-shell-app-menu__sort-dir`,f.setAttribute(`aria-label`,`Sort order`);for(let[e,t]of[[`asc`,`A–Z / oldest`],[`desc`,`Z–A / newest`]]){let n=document.createElement(`option`);n.value=e,n.textContent=t,f.appendChild(n)}let p=()=>{let e=ha();d.value=e.sortBy,f.value=e.sortDir};p(),u.append(l,d,f);let m=document.createElement(`div`);m.className=`env-shell-app-menu__start-body`,m.hidden=e!==`bookmarks`;let h=document.createElement(`div`);h.className=`env-shell-app-menu__start-left`,h.setAttribute(`aria-label`,`Pinned and recent bookmarks`);let g=document.createElement(`div`);g.className=`env-shell-app-menu__start-heading`,g.textContent=`Pinned`;let _=document.createElement(`div`);_.className=`env-shell-app-menu__start-recent env-shell-app-menu__start-pinned`;let v=document.createElement(`div`);v.className=`env-shell-app-menu__start-heading`,v.textContent=`Recent`;let y=document.createElement(`div`);y.className=`env-shell-app-menu__start-recent`,h.append(g,_,v,y);let b=document.createElement(`div`);b.className=`env-shell-app-menu__start-right`;let x=document.createElement(`div`);x.className=`env-shell-app-menu__crumb`;let S=document.createElement(`div`);S.className=`env-shell-app-menu__crumb-nav`;let ee=document.createElement(`div`);ee.className=`env-shell-app-menu__crumb-actions`,x.append(S,ee);let C=document.createElement(`div`);C.className=`env-shell-app-menu__grid`,C.setAttribute(`data-part`,`grid`),C.setAttribute(`aria-label`,e===`bookmarks`?`Bookmarks`:`Installed apps`),b.append(x,C),m.append(h,b),e===`bookmarks`?a.append(o,u,m):a.append(o,u,C),t.appendChild(a),Ia().appendChild(t);let w=!1,T=0,E=``,D,O=[],k=()=>{if(!Ma()){t.hidden=!0,t.toggleAttribute(`data-open`,!1);return}t.hidden=!w,t.toggleAttribute(`data-open`,w)},A=()=>{w&&(w=!1,t.toggleAttribute(`data-page`,!1),k(),t.dispatchEvent(new CustomEvent(`env-app-menu-close`,{bubbles:!0})))};t.addEventListener(`env-app-menu-request-close`,e=>{e.stopPropagation(),A()});let te=()=>{Ma()&&(n(),w=!0,k(),F(),t.dispatchEvent(new CustomEvent(`env-app-menu-open`,{bubbles:!0})))},ne=()=>{t.toggleAttribute(`data-page`,!0),te()},j=()=>{w?A():te()},M={onPinned:()=>{A()},onStartPinsChanged:()=>{F()},onAppsChanged:()=>{F()}},N=e=>{let t=Wn();if(!t?.create){U(`Cannot create bookmark here`);return}let n=O.length?O[O.length-1]:null,r=n?.id||`0`,i=n?.title||`Bookmarks`;(async()=>{let n=await wr({heading:e===`folder`?`New folder`:`New bookmark`,description:`Add to “${i}” (Chrome bookmarks)`,showUrl:e===`url`,initialTitle:e===`folder`?`New folder`:``,initialUrl:e===`url`?`https://`:``,submitLabel:`Create`});if(!n)return;let a=await t.create(r,{title:n.title,url:e===`url`?n.url:void 0});if(!a){U(e===`folder`?`Could not create folder`:`Could not create bookmark`);return}H(e===`folder`?`Created folder “${a.title}”`:`Created “${a.title}”`),F()})()},P=(e,t)=>{let n=document.createElement(`button`);return n.type=`button`,n.className=`env-shell-app-menu__crumb-action`,n.textContent=e,n.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),t()}),n};ee.append(P(`New bookmark`,()=>N(`url`)),P(`New folder`,()=>N(`folder`))),C.addEventListener(`contextmenu`,e=>{e.target?.closest?.(`[data-bookmark-id]`)||Na()===`bookmarks`&&Wn()?.create&&(e.preventDefault(),e.stopPropagation(),ri({x:e.clientX,y:e.clientY,compact:!0,items:[{id:`new-bookmark`,label:`New bookmark…`,icon:`bookmark-simple`,action:()=>N(`url`)},{id:`new-folder`,label:`New folder…`,icon:`folder-plus`,action:()=>N(`folder`)}]}))});let re=()=>{if(S.replaceChildren(),ee.hidden=e!==`bookmarks`||!Wn()?.create,e!==`bookmarks`)return;let t=document.createElement(`button`);t.type=`button`,t.className=`env-shell-app-menu__crumb-item`,t.textContent=`Bookmarks`,t.addEventListener(`click`,()=>{O=[],F()}),S.appendChild(t),O.forEach((e,t)=>{let n=document.createElement(`span`);n.className=`env-shell-app-menu__crumb-sep`,n.textContent=`›`;let r=document.createElement(`button`);r.type=`button`,r.className=`env-shell-app-menu__crumb-item`,r.textContent=e.title,r.addEventListener(`click`,()=>{O=O.slice(0,t+1),F()}),S.append(n,r)})},ie=async(e,t)=>{let n=[];try{n=await e.launcherList(E||void 0)}catch{n=[]}if(t!==T)return;C.replaceChildren();let r=ha();if(r.sortBy===`color`&&(await Ta(n,C),t!==T))return;if(n=Da(n,r),n.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty`,e.textContent=E?`No matching apps`:`No apps found`,C.appendChild(e);return}let i=document.createDocumentFragment();for(let r of n)i.appendChild(Va(r,e,t,()=>T,M));C.appendChild(i)},ae=(e,t)=>{O.push({id:e,title:t}),E=``,l.value=``,F()},oe=async(e,t)=>{re();let n=(t,n,r)=>{if(t.replaceChildren(),n.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty env-shell-app-menu__empty--compact`,e.textContent=r,t.appendChild(e);return}for(let r of n)t.appendChild(Wa(r,e,M,ae))};n(_,Jn(),`No pinned bookmarks`),n(y,Kn(),`No recent bookmarks`);let r=[];try{if(E)r=await e.search(E);else{let t=O.length?O[O.length-1].id:void 0;r=await e.listChildren(t)}}catch{r=[]}if(t!==T)return;if(C.replaceChildren(),r.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty`,e.textContent=E?`No matching bookmarks`:`This folder is empty`,C.appendChild(e);return}let i=document.createDocumentFragment(),a=ha().sortDir===`desc`?-1:1,o=r.filter(e=>e.folder),s=r.filter(e=>!e.folder),c=(e,t)=>String(e.title||``).localeCompare(String(t.title||``),void 0,{numeric:!0,sensitivity:`base`})*a;for(let t of[...o.sort(c),...s.sort(c)])i.appendChild(Wa(t,e,M,ae));C.appendChild(i)},F=async()=>{let e=++T;o.hidden=!0,u.hidden=!1,l.hidden=!1;let n=Na();if(!n){k();return}if(t.setAttribute(`data-menu-mode`,n),n===`bookmarks`){a.setAttribute(`data-layout`,`start-split`),m.hidden=!1,a.contains(m)||(a.append(o,u,m),C.parentElement!==b&&b.append(x,C));let t=Wn();if(!t){o.hidden=!1,s.textContent=`Bookmarks API unavailable in this context`,c.hidden=!0,l.hidden=!0,u.hidden=!0,m.hidden=!0;return}c.hidden=!0,await oe(t,e);return}a.removeAttribute(`data-layout`),m.hidden=!0,C.parentElement!==a&&a.append(C);let r=await Pa();if(e!==T)return;if(!r?.launcherList||!r?.launcherLaunch||!r?.launcherIcon){o.hidden=!1,s.textContent=`Launcher bridge unavailable — rebuild the Capacitor APK`,c.hidden=!0,l.hidden=!0,u.hidden=!0,C.hidden=!0;return}let i=!1;try{i=await r.launcherIsDefault()}catch{i=!1}e===T&&(i?o.hidden=!0:(o.hidden=!1,s.textContent=`Set CWSP Launcher as Home for full launcher integration`,c.hidden=!1),l.hidden=!1,u.hidden=!1,C.hidden=!1,await ie(r,e))};d.addEventListener(`change`,()=>{let e=d.value;ga({sortBy:e,sortDir:ma(e)}),p()}),f.addEventListener(`change`,()=>{ga({sortDir:f.value===`desc`?`desc`:`asc`})});let se=()=>{p(),w&&F()};window.addEventListener(sa,se),l.addEventListener(`input`,()=>{E=l.value.trim(),D&&clearTimeout(D),D=setTimeout(()=>{F()},180)}),c.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation();let t=await Pa();if(t){try{await t.launcherRequestDefault()}catch{}F()}});let ce=e=>{if(!w||document.documentElement.hasAttribute(`data-app-menu-dragging`))return;let n=typeof e.composedPath==`function`?e.composedPath():[];for(let e of n)if(e===t||e===a||e instanceof Element&&t.contains(e)||e instanceof Element&&e.closest?.(`.cw-context-menu-layer`)||e instanceof Element&&e.closest?.(`.env-shell-app-menu__chrome-editor`)||e instanceof Element&&e.closest?.(`dialog.speed-dial-editor`))return;A()};document.addEventListener(`pointerdown`,ce,{capture:!0});let le=[`.env-shell-app-menu__tile`,`.env-shell-app-menu__search`,`.env-shell-app-menu__sort`,`.env-shell-app-menu__sort-dir`,`.env-shell-app-menu__tools`,`.env-shell-app-menu__banner`,`.env-shell-app-menu__pin-menu`,`.env-shell-app-menu__crumb-item`,`.env-shell-app-menu__start-heading`,`.env-shell-app-menu__chrome-editor`,`.env-shell-app-menu__drag-ghost`,`.cw-context-menu-layer`,`dialog.speed-dial-editor`].join(`, `),I=null,L=e=>e instanceof Element&&!!e.closest(le),ue=e=>{if(w&&(e.button==null||e.button===0)){if(document.documentElement.hasAttribute(`data-app-menu-dragging`)||L(e.target)){I=null;return}I={id:e.pointerId,x:e.clientX,y:e.clientY}}},de=e=>{if(!I||I.id!==e.pointerId)return;let t=e.clientX-I.x,n=e.clientY-I.y;I=null,w&&(document.documentElement.hasAttribute(`data-app-menu-dragging`)||L(e.target)||Math.hypot(t,n)>14||A())},fe=e=>{I?.id===e.pointerId&&(I=null)};return t.addEventListener(`pointerdown`,ue),t.addEventListener(`pointerup`,de),t.addEventListener(`pointercancel`,fe),k(),{element:t,toggle:j,open:te,openPage:ne,close:A,isOpen:()=>w,refresh:F,dispose:()=>{D&&clearTimeout(D),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),document.removeEventListener(`pointerdown`,ce,{capture:!0}),t.removeEventListener(`pointerdown`,ue),t.removeEventListener(`pointerup`,de),t.removeEventListener(`pointercancel`,fe),document.removeEventListener(`u2-theme-change`,r),window.removeEventListener(sa,se);try{i.disconnect()}catch{}t.remove()}}}var Ka,qa,Ja,Ya,Xa,Za;function Qa(){return(Qa=e((()=>{s(),M(),Se(),Rn(),jr(),Ai(),ii(),ae(),oa(),vr(),Oa(),Aa(),O(),Ka=v(ka),qa=!1,Ja=420,Ya=10,Xa=null,Za=`circle`})))()}var $a,eo,to,no,ro;function io(){return(io=e((()=>{Se(),$a=null,eo=e=>{let t=Le(e.id);return Math.max(0,Number(t?.androidWidgetId)||0)},to=(e,t)=>{let n=t.getBoundingClientRect();return{widgetId:e,x:n.left,y:n.top,w:Math.max(8,n.width),h:Math.max(8,n.height),dpr:Number(window.devicePixelRatio)||1}},no=e=>{if(!$a)return;let t=e||document.getElementById(`home`);t&&t.querySelectorAll(`[data-speed-dial-item][data-widget="android"][data-layer="icons"]`).forEach(e=>{let t=(Ve||[]).find(t=>t?.id===e.dataset.id);if(!t)return;let n=eo(t);if(!n)return;let r=to(n,e);$a.widgetAttach(r)})},ro=()=>{$a?.widgetHideAll?.()}})))()}var ao,oo,so,co,lo,uo,fo,po,mo,ho,go,_o,vo,yo,bo,xo,So,Co,wo;function To(){return(To=e((()=>{N(),Se(),io(),ao=`/user/workspaces/`,oo=`cwsp:workspace-page`,so=`cw::workspace::pages`,co=e=>`${ao}${e}/`,lo=()=>[`side-a`,`side-b`,`side-c`].map(e=>({id:e,label:`Side ${e.slice(-1).toUpperCase()}`,path:co(e)})),uo=()=>({activeId:`side-a`,pages:lo(),snapshots:{}}),fo=()=>{try{let e=localStorage.getItem(so);if(!e)return uo();let t=JSON.parse(e);return!t||!Array.isArray(t.pages)||!t.pages.length?uo():{activeId:String(t.activeId||t.pages[0].id),pages:t.pages.map(e=>({id:String(e.id||``).trim(),label:String(e.label||e.id),path:String(e.path||co(e.id))})).filter(e=>e.id),snapshots:t.snapshots&&typeof t.snapshots==`object`?t.snapshots:{}}}catch{return uo()}},po=e=>({items:(e?.items||[]).map(e=>{let t=String(e.meta?.iconUrl||``);if(!/^(data:|blob:)/i.test(t))return e;let n={...e.meta||{}};return/^data:/i.test(t)&&e.id?n.iconUrl=we(String(e.id),t):delete n.iconUrl,{...e,meta:n}})}),mo=e=>{try{localStorage.setItem(so,JSON.stringify(e))}catch(e){console.warn(`[workspace-pages] catalog persist failed`,e)}},ho=e=>{try{window.dispatchEvent(new CustomEvent(oo,{detail:{id:e,pages:go()}}))}catch{}},go=()=>fo().pages,_o=()=>fo().activeId||`side-a`,vo=()=>{let e=fo();e.pages.some(t=>t.id===e.activeId)&&(e.snapshots[e.activeId]=po(xe()),mo(e))};try{let e=globalThis;e.__CWSP_WORKSPACE_SNAPSHOT_SYNC_BOUND__||(e.__CWSP_WORKSPACE_SNAPSHOT_SYNC_BOUND__=!0,window.addEventListener(je,vo))}catch{}yo=async e=>{try{let t=De(`/user/`);if(!t?.mkdir||!t.writable)return;if(await t.mkdir(`/user/`,`workspaces`).catch(()=>void 0),await t.mkdir(ao,e.id).catch(()=>void 0),t.writeFile){let n=new File([JSON.stringify({id:e.id,label:e.label,path:e.path},null,2)],`workspace.json`,{type:`application/json`});await t.writeFile(e.path,n).catch(()=>void 0)}}catch(t){console.warn(`[workspace-pages] explorer dir failed`,e.id,t)}},bo=()=>{try{return matchMedia(`(prefers-reduced-motion: reduce)`).matches}catch{return!1}},xo=()=>{let e=document.querySelector(`.speed-dial-root`)||document.getElementById(`home`);if(!e)return[];let t=[...e.querySelectorAll(`.speed-dial-grid`)];return t.length?t:[e]},So=e=>{let t=e||(typeof document<`u`?document:null);t?.querySelectorAll&&(t.querySelectorAll(`.speed-dial-grid--turn-ghost`).forEach(e=>e.remove()),t.querySelectorAll(`[data-ws-turning]`).forEach(e=>{delete e.dataset.wsTurning,e.querySelectorAll(`.speed-dial-grid`).forEach(e=>{e.style.opacity=``})}))},Co=e=>{let t=xo(),n=t[0]?.closest(`.speed-dial-root`)||t[0]||null;if(So(n),!t.length||bo()||typeof t[0].animate!=`function`)return()=>void 0;let r=e<0?-1:1,i=`${-88*r}deg`,a=`${88*r}deg`,o=`${-18*r}%`,s=`${18*r}%`,c=n||t[0];c.dataset.wsTurning=r>0?`next`:`prev`;let l=[];for(let e of t){let t=e.cloneNode(!0);t.classList.add(`speed-dial-grid--turn-ghost`),t.dataset.wsGhost=`1`,t.setAttribute(`aria-hidden`,`true`),e.parentElement?.insertBefore(t,e.nextSibling),e.style.opacity=`0`,l.push(t),t.animate([{transform:`translateX(0) rotateY(0deg)`,opacity:1},{transform:`translateX(${o}) rotateY(${i})`,opacity:0}],{duration:180,easing:`cubic-bezier(.4, 0, .2, 1)`,fill:`forwards`})}let u=()=>{for(let e of t)e.style.opacity=``;for(let e of l)e.remove();delete c.dataset.wsTurning};return()=>{let e=t.map(e=>e.animate([{transform:`translateX(${s}) rotateY(${a})`,opacity:.2},{transform:`translateX(0) rotateY(0deg)`,opacity:1}],{duration:220,easing:`cubic-bezier(.22, 1, .36, 1)`,fill:`none`})),n=Promise.all(e.map(e=>e.finished.catch(()=>void 0))),r=new Promise(e=>{setTimeout(e,500)});Promise.race([n,r]).then(u)}},wo=e=>{let t=fo(),n=t.pages.find(t=>t.id===e);if(!n)return!1;let r=t.activeId||t.pages[0].id;if(r===n.id)return!0;let i=Math.max(0,t.pages.findIndex(e=>e.id===r)),a=Math.max(0,t.pages.findIndex(e=>e.id===n.id))-i;Math.abs(a)>t.pages.length/2&&(a+=a>0?-t.pages.length:t.pages.length),t.snapshots[r]=po(xe()),t.activeId=n.id,mo(t),ro();let o=Co(a);return Me(t.snapshots[n.id]||{items:[]}),requestAnimationFrame(()=>{o(),requestAnimationFrame(()=>no())}),yo(n),ho(n.id),!0}})))()}var Eo,Do,Oo,ko,Ao,jo,Mo,No,Po;function Fo(){return(Fo=e((()=>{Eo=`cwsp:explorer-sort-change`,Do=`cwsp-explorer-sort`,Oo=[[`name`,`Name`],[`date`,`Date modified`],[`type`,`Type`],[`size`,`Size`],[`kind`,`Kind (file / folder)`]],ko=new Set(Oo.map(([e])=>e)),Ao=(e,t=`name`)=>{let n=String(e||``).trim().toLowerCase();return n===`modified`||n===`mtime`||n===`updated`?`date`:n===`mime`||n===`ext`||n===`extension`?`type`:n===`bytes`||n===`length`?`size`:n===`folder`||n===`folders`?`kind`:ko.has(n)?n:t},jo=(e,t=`asc`)=>{let n=String(e||``).trim().toLowerCase();return n===`desc`||n===`descending`||n===`newest`||n===`z-a`?`desc`:n===`asc`||n===`ascending`||n===`oldest`||n===`a-z`?`asc`:t},Mo=e=>e===`date`||e===`size`?`desc`:`asc`,No=()=>{try{let e=localStorage.getItem(Do);if(e){let t=JSON.parse(e),n=Ao(t.sortBy);return{sortBy:n,sortDir:jo(t.sortDir,Mo(n)),foldersFirst:t.foldersFirst!==!1}}}catch{}return{sortBy:`name`,sortDir:`asc`,foldersFirst:!0}},Po=e=>{let t=No(),n=e.sortBy==null?t.sortBy:Ao(e.sortBy,t.sortBy),r={sortBy:n,sortDir:e.sortDir==null?t.sortDir:jo(e.sortDir,Mo(n)),foldersFirst:e.foldersFirst==null?t.foldersFirst:!!e.foldersFirst};try{localStorage.setItem(Do,JSON.stringify(r))}catch{}try{window.dispatchEvent(new CustomEvent(Eo,{detail:r}))}catch{}return r}})))()}var Io;function Lo(){return(Lo=e((()=>{Io=`/*
...
.explorer-settings__mount code {
  opacity: 0.7;
  font-size: 0.78rem;
}`})))()}var Ro,zo,Bo,Vo,Ho;function Uo(){return(Uo=e((()=>{C(),r(),s(),B(),ue(),Fo(),pe(),Lo();try{v(Io)}catch{}Ro=e=>{let t=e.querySelector(`[data-explorer-mounts]`);if(!t)return;let n=fe();if(t.replaceChildren(),!n.length){t.dataset.empty=`1`,t.textContent=`No mounted folders yet.`;return}t.dataset.empty=`0`;for(let r of n){let n=document.createElement(`div`);n.className=`explorer-settings__mount`,n.innerHTML=`<span>${r.label}</span><code>${r.path}</code>`;let i=document.createElement(`button`);i.className=`btn`,i.type=`button`,i.textContent=`Unmount`,i.addEventListener(`click`,()=>{oe(r.id),Ro(e),window.dispatchEvent(new CustomEvent(`cwsp:explorer-mount-change`))}),n.append(i),t.append(n)}},zo=e=>{let t=No(),n=e.querySelector(`[data-explorer-sort-by]`),r=e.querySelector(`[data-explorer-sort-dir]`),i=e.querySelector(`[data-explorer-folders-first]`);n&&(n.value=t.sortBy),r&&(r.value=t.sortDir),i&&(i.checked=t.foldersFirst)},Bo=(e,t,n=``)=>{let r=e.querySelector(`[data-explorer-status]`);r&&(r.textContent=[`All-files (/sdcard/): ${t?.allFilesAccess?`granted`:`not granted`}`,t?.note?t.note:``,n].filter(Boolean).join(`
`))},Vo=class extends z{styles=()=>Io;onInitialize(){let e=super.onInitialize();return queueMicrotask(()=>{zo(this),Ro(this),He()?I().then(e=>Bo(this,e)):Bo(this,null,`Browser / PWA: use Mount folder (showDirectoryPicker).`)}),e??this}render=function(){let e=this,t=He(),n=se();return h`<div class="explorer-settings" part="root">
            ...
            <section class="explorer-settings__card">
                ...
                <label class="explorer-settings__field">
                    <span>Sort by</span>
                    <select data-explorer-sort-by on:change=${e=>{let t=e.currentTarget.value;Po({sortBy:t})}}>
                ...
                <label class="explorer-settings__field">
                    <span>Order</span>
                    <select data-explorer-sort-dir on:change=${e=>{Po({sortDir:e.currentTarget.value===`desc`?`desc`:`asc`})}}>
                        <option value="asc">Ascending</option>
                        <option value="desc">Descending</option>
                    </select>
                </label>
                <label class="explorer-settings__check">
                    <input type="checkbox" data-explorer-folders-first on:change=${e=>{Po({foldersFirst:e.currentTarget.checked})}} />
            ...
            <section class="explorer-settings__card" hidden=${!t}>
                ...
                <div class="explorer-settings__actions">
                    <button class="btn btn--primary" type="button" disabled=${!t} on:click=${()=>{F().then(()=>I().then(t=>Bo(e,t,`Opened system all-files settings.`)))}}>Allow all files</button>
                    <button class="btn" type="button" disabled=${!t} on:click=${()=>{_e().then(t=>{Bo(e,null,t?`SAF tree: ${t}`:`SAF pick cancelled.`),window.dispatchEvent(new CustomEvent(`cwsp:explorer-mount-change`))})}}>Pick SAF folder</button>
                </div>
            </section>
            <section class="explorer-settings__card" hidden=${t||!n}>
                ...
                <div class="explorer-settings__actions">
                    <button class="btn" type="button" disabled=${!n} on:click=${()=>{P().then(t=>{t&&(L(t),Ro(e),window.dispatchEvent(new CustomEvent(`cwsp:explorer-mount-change`)))})}}>Mount folder</button>
                </div>
                <div data-explorer-mounts class="explorer-settings__mounts"></div>
            </section>
        </div>`}},Vo=R([b(`ui-explorer-settings`)],Vo),Ho=()=>{document.querySelectorAll(`ui-file-manager`).forEach(e=>{let t=e.shadowRoot?.querySelector(`.fm-root`);t?.classList.remove(`fm-root--settings`),t?.querySelector(`ui-explorer-settings`)?.remove()}),document.querySelector(`ui-explorer-settings`)?.remove()},o(window,`keydown`,e=>{e.key===`Escape`&&Ho()})})))()}var Wo,Go,Ko,qo,Jo,Yo,Xo;function Zo(){return(Zo=e((()=>{C(),ii(),Uo(),Wo=()=>document.querySelector(`ui-file-manager`),Go=()=>Wo()?.shadowRoot?.querySelector(`ui-explorer-settings`)??document.querySelector(`ui-explorer-settings`),Ko=()=>g()&&_()?!0:document.querySelector(`.cw-context-menu, .cw-context-menu-layer`)?(ni(),!0):Go()?(Ho(),!0):!1,qo=()=>{let e=globalThis;e.__CWSP_NATIVE_BACK__={handleBackPress:Ko};let t=e.__CWSP_LAUNCHER_HOME__?.handleBackPress;e.__CWSP_LAUNCHER_HOME__={...e.__CWSP_LAUNCHER_HOME__||{},handleBackPress:()=>Ko()||typeof t==`function`&&t()}},Jo=()=>{let e=globalThis;if(e.__CWSP_CAP_BACK_BOUND__)return;let t=e.Capacitor?.Plugins?.App;if(typeof t?.addListener==`function`){e.__CWSP_CAP_BACK_BOUND__=!0;try{t.addListener(`backButton`,()=>{Ko()})}catch(e){console.warn(`[overlay-back] Capacitor backButton bind failed`,e)}}},Yo=()=>{E({id:`app-menu-overlay`,priority:x.SIDEBAR,isActive:()=>!!document.querySelector(`.env-shell-app-menu[data-open]`),close:()=>(document.querySelector(`.env-shell-app-menu`)?.dispatchEvent(new CustomEvent(`env-app-menu-request-close`,{bubbles:!0})),!0)}),E({id:`speed-dial-editor`,priority:x.MODAL,isActive:()=>!!document.querySelector(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`),close:()=>(document.querySelectorAll(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`).forEach(e=>{try{e.close()}catch{e.remove()}}),!0)})},Xo=()=>{let e=globalThis;if(e.__CWSP_LAUNCHER_BACK_STACK__){Jo(),qo();return}e.__CWSP_LAUNCHER_BACK_STACK__=!0;try{u({preventDefaultNavigation:!0,pushInitialState:!1})}catch{}Yo(),Jo(),qo()}})))()}var Qo;function $o(){return($o=e((()=>{Qo=`/*
...
}`})))()}function es(e){return`${ls}${String(e||``).trim().toLowerCase()}`}function ts(){let e=document.querySelector(`.env-shell-chrome`);return e instanceof HTMLElement&&e.hasAttribute(`data-desktop`)?!1:e instanceof HTMLElement&&e.dataset.chromeLayout===`mobile`||typeof matchMedia==`function`&&matchMedia(`(max-width: 640px)`).matches}function ns(e,t){if(e.some(e=>{let t=String(e.id||``).trim().toLowerCase();return!t||t===`home`?!1:e.visible!==!1&&!e.minimized}))return!0;let n=String(t.value||`home`).trim().toLowerCase();if(n&&n!==`home`&&n!==`viewer`)return!0;let r=document.querySelector(`.env-shell-workspace`);if(!r)return!1;for(let e of r.querySelectorAll(`ui-window`)){if(!(e instanceof HTMLElement)||e.hidden||e.hasAttribute(`data-minimized`))continue;let t=getComputedStyle(e);if(t.display!==`none`&&t.visibility!==`hidden`&&!(Number.parseFloat(t.opacity||`1`)<=0))return!0}return!1}function rs(e=new Date){return hn(e)}function is(e){let t=ce([]);ee(t),y(ss,t,{title:`Home`,icon:`house-line`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`home`,e.onHome()}),y(cs,t,{title:`Markdown`,icon:`article`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`viewer`,e.onViewer()});let n=document.createElement(`ui-taskbar`);n.className=`env-shell-taskbar wf-chrome-no-select`,n.setAttribute(`part`,`taskbar`),n.setAttribute(`data-type`,`desktop`);let r=document.createElement(`div`);r.className=`env-shell-taskbar__pins`;let i=document.createElement(`div`);i.className=`env-shell-taskbar__windows`;let a=document.createElement(`ui-task`);a.setAttribute(`title`,`Home`),a.setAttribute(`icon`,`house-line`),a.setAttribute(`data-id`,ss),a.setAttribute(`data-env-home`,``),a.setAttribute(`aria-label`,`Home`),a.setAttribute(`aria-haspopup`,`menu`),r.append(a);let o=document.createElement(`div`);o.className=`env-shell-taskbar__workspaces`,o.setAttribute(`aria-label`,`Workspaces`);let s=()=>{let e=go(),t=_o();o.replaceChildren();for(let n of e){let e=document.createElement(`button`);e.type=`button`,e.className=`env-shell-taskbar__workspace`,e.title=n.label,e.textContent=n.label.replace(/^Side\s+/i,``)||n.id.slice(-1).toUpperCase(),e.toggleAttribute(`data-active`,n.id===t),e.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),wo(n.id)}),o.append(e)}};s(),window.addEventListener(oo,s),r.append(o),Xo();let c=()=>{let e=ts();a.setAttribute(`title`,e?`Home`:`Start`),a.setAttribute(`aria-label`,e?`Home`:`Start`),a.setAttribute(`icon`,e?`house-line`:`windows-logo`),a.toggleAttribute(`data-env-start`,!e),e?a.setAttribute(`aria-keyshortcuts`,`LongPress`):a.removeAttribute(`aria-keyshortcuts`)};c();let l=document.createElement(`div`);l.className=`env-shell-taskbar__tray-host`;let u=document.createElement(`div`);u.className=`env-shell-taskbar__clock`,u.setAttribute(`role`,`button`),u.setAttribute(`tabindex`,`0`),u.setAttribute(`aria-label`,`Calendar`),u.setAttribute(`aria-haspopup`,`dialog`),u.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let f=document.createElement(`span`);f.className=`env-shell-taskbar__clock-time`;let p=document.createElement(`span`);p.className=`env-shell-taskbar__clock-date`,u.append(f,p);let m=()=>{let{time:e,date:t}=rs();f.textContent=e,p.textContent=t,u.title=`${e} · ${t}`};m();let h=setInterval(m,ds),g=xn(e.device,`env-device-tray env-device-tray--taskbar`);g.setAttribute(`role`,`button`),g.setAttribute(`tabindex`,`0`),g.setAttribute(`aria-label`,`Quick settings`),g.setAttribute(`aria-haspopup`,`dialog`),g.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`);let _=e=>{e.preventDefault(),e.stopPropagation(),ft(u)},v=e=>{e.preventDefault(),e.stopPropagation(),kt(g)};u.addEventListener(`click`,_),u.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&_(e)}),g.addEventListener(`click`,v),g.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&v(e)}),l.append(g,u);let b=document.createElement(`div`);b.className=`env-shell-navbar__switcher`,b.setAttribute(`role`,`menu`),b.setAttribute(`aria-label`,`Open apps`),b.hidden=!0;let x=document.createElement(`ul`);x.className=`env-shell-navbar__switcher-list`,b.appendChild(x),n.append(r,i,l,b);let S=Ma(),C=S?Ga():void 0,w=new Map,T=[],E=null,D=!1,O=!1,k=[];k.push(()=>clearInterval(h));let A=e=>T.find(t=>String(t.id||``).trim().toLowerCase()===e),te=t=>{let n=String(t||``).trim().toLowerCase();if(!n)return;let r=A(n),i=String(e.focusedTaskId.value||``).trim().toLowerCase(),a=!!r?.focused||i===n||i===`markdown`&&n===`viewer`||i===`viewer`&&(n===`viewer`||n===`markdown`);if(r?.minimized){r.minimized=!1,r.focused=!0,w.get(n)?.toggleAttribute(`data-minimized`,!1),e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n);return}if(a&&r&&r.visible!==!1){r.minimized=!0,r.focused=!1,w.get(n)?.toggleAttribute(`data-minimized`,!0),e.onMinimizeWindow?.(n);return}e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n)},ne=(t,r,i)=>{if(ts())return;t.preventDefault(),t.stopPropagation();let a=String(r||``).trim().toLowerCase(),o=!!A(a)?.minimized,s=[{id:o?`restore`:`minimize`,label:o?`Restore`:`Minimize`,icon:o?`arrow-square-out`:`minus`,action:()=>{o?(e.focusedTaskId.value=a,e.onWindowTask?.(a)):e.onMinimizeWindow?.(a)}},{id:`close`,label:`Close`,icon:`x`,danger:!0,action:()=>e.onCloseWindow?.(a)}];ri({x:t.clientX,y:t.clientY,compact:!0,anchor:t.target instanceof Element?t.target:n,items:s})};n.addEventListener(`contextmenu`,t=>{if(ts())return;let r=typeof t.composedPath==`function`?t.composedPath():[];for(let e of r)if(e instanceof Element&&e.closest?.(`ui-task`))return;t.preventDefault(),t.stopPropagation(),ri({x:t.clientX,y:t.clientY,compact:!0,anchor:n,items:[{id:`show-desktop`,label:`Show desktop`,icon:`desktop`,action:()=>e.onHome()},{id:`home`,label:`Home`,icon:`house-line`,action:()=>e.onHome()}]})});let j=()=>{O=!1,b.hidden=!0,x.replaceChildren(),n.removeAttribute(`data-switcher-open`)},M=()=>{let r=T.filter(e=>String(e.id||``).trim());if(x.replaceChildren(),r.length)for(let n of r){let r=String(n.id||``).trim().toLowerCase(),i=document.createElement(`li`);i.className=`env-shell-navbar__switcher-row`,i.setAttribute(`role`,`none`);let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-navbar__switcher-item`,a.setAttribute(`role`,`menuitem`),a.toggleAttribute(`data-active`,!!n.focused&&!n.minimized),a.toggleAttribute(`data-minimized`,!!n.minimized);let o=document.createElement(`ui-icon`);o.setAttribute(`icon`,n.icon||`app-window`),o.setAttribute(`icon-style`,`duotone`),o.setAttribute(`aria-hidden`,`true`);let s=document.createElement(`span`);s.className=`env-shell-navbar__switcher-label`,s.textContent=n.title||r,a.append(o,s),a.addEventListener(`click`,n=>{n.preventDefault(),n.stopPropagation(),j(),e.focusedTaskId.value=r;let i=es(r),a=d(t,i);a?a.focus=!0:e.onWindowTask?.(r)});let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-navbar__switcher-close`,c.setAttribute(`aria-label`,`Close ${n.title||r}`),c.title=`Close`;let l=document.createElement(`ui-icon`);l.setAttribute(`icon`,`x`),l.setAttribute(`icon-style`,`bold`),l.setAttribute(`aria-hidden`,`true`),c.appendChild(l),c.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.onCloseWindow?.(r),T=T.filter(e=>String(e.id||``).trim().toLowerCase()!==r),w.get(r)?.remove(),w.delete(r),T.length?M():j()}),i.append(a,c),x.appendChild(i)}else{let e=document.createElement(`li`);e.className=`env-shell-navbar__switcher-empty`,e.textContent=`No open apps`,x.appendChild(e)}O=!0,b.hidden=!1,n.setAttribute(`data-switcher-open`,``)},N=()=>{E!=null&&(clearTimeout(E),E=null)},P=()=>{n.toggleAttribute(`data-app-menu-open`,!!C?.isOpen())},re=()=>{j(),C?.close(),P(),d(t,ss).focus=!0,e.onHome()},ie=()=>{j(),C?.toggle(),P(),d(t,ss).focus=!0,e.focusedTaskId.value=`home`,L()},ae=()=>{!C||C.isOpen()||(j(),C.open(),P(),d(t,ss).focus=!0,e.focusedTaskId.value=`home`,L())},oe=()=>{C&&(j(),C.openPage(),P(),d(t,ss).focus=!0,e.focusedTaskId.value=`home`,L())};try{let e=globalThis;e.__CWSP_LAUNCHER_HOME__={...e.__CWSP_LAUNCHER_HOME__||{},openAppMenu:ae,openAppMenuPage:oe}}catch{}let F=()=>{if(ns(T,e.focusedTaskId)){re();return}if(C?.isOpen()){C.close(),P();return}ie()};a.addEventListener(`click`,e=>{if(D){e.preventDefault(),e.stopPropagation(),D=!1;return}if(S&&C){e.preventDefault(),e.stopPropagation(),F();return}re()}),a.addEventListener(`pointerdown`,e=>{if(ts()&&(e.button==null||e.button===0)){D=!1,N(),E=setTimeout(()=>{E=null,D=!0;try{a.releasePointerCapture?.(e.pointerId)}catch{}M()},us);try{a.setPointerCapture?.(e.pointerId)}catch{}}},{capture:!0});let se=()=>{N()};a.addEventListener(`pointerup`,se,{capture:!0}),a.addEventListener(`pointercancel`,se,{capture:!0}),a.addEventListener(`contextmenu`,e=>{ts()&&(e.preventDefault(),D=!0,N(),M())});let I=e=>{if(!O)return;let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t)if(e===b||e===a||e instanceof Element&&(e===b||b.contains(e)||e===a))return;j()};document.addEventListener(`pointerdown`,I,{capture:!0}),k.push(()=>document.removeEventListener(`pointerdown`,I,{capture:!0}));let L=()=>{let t=String(e.focusedTaskId.value||`home`),n=(e,t)=>{e.toggleAttribute(`data-env-active`,t),e.toggleAttribute(`data-active`,t),e.toggleAttribute(`data-focus`,t)};n(a,t===`home`);for(let[e,r]of w)n(r,t===e)};le(()=>{L()},[e.focusedTaskId],{triggerImmediately:!0});let ue=e=>{let n=String(e.id||``).trim().toLowerCase();if(!n||n===`home`)return;let r=es(n),a=e.title||n,o=String(e.icon||``).trim()||`app-window`,s=w.get(n);if(!s){let e=y(r,null,{title:a,icon:o},{viewId:n},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,te(n)});e.list=t,t.push(e),s=document.createElement(`ui-task`),s.setAttribute(`data-id`,r),s.setAttribute(`data-view`,n),s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),te(n)}),s.addEventListener(`contextmenu`,e=>{ne(e,n,a)}),w.set(n,s),i.appendChild(s)}s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.toggleAttribute(`data-minimized`,!!e.minimized),s.hidden=e.visible===!1},de=n=>{T=Array.isArray(n)?n.slice():[];let r=new Set;for(let t of n){let n=String(t.id||``).trim().toLowerCase();!n||n===`home`||(r.add(n),ue(t),t.focused&&(e.focusedTaskId.value=n))}for(let[e,n]of[...w.entries()]){if(r.has(e))continue;let i=es(e),a=d(t,i);if(a){let e=t.indexOf(a);e>=0&&t.splice(e,1)}n.remove(),w.delete(e)}L(),O&&M()},fe=n=>{let r=String(n||`home`).toLowerCase(),i=ss;r===`viewer`||r===`markdown`?i=cs:r!==`home`&&(i=es(r));let a=d(t,i);if(a){for(let e of t)e!==a&&(e.active=!1);a.active=!0}e.focusedTaskId.value=r===`markdown`?`viewer`:r,L()};if(queueMicrotask(c),C){let e=()=>P();n.addEventListener(`env-app-menu-open`,e),n.addEventListener(`env-app-menu-close`,e),k.push(()=>{n.removeEventListener(`env-app-menu-open`,e),n.removeEventListener(`env-app-menu-close`,e)})}return{element:n,taskList:t,setFocusedTaskId:fe,syncWindowTasks:de,appMenu:C,openAppMenu:C?ae:void 0,openAppMenuPage:C?oe:void 0,isSwitcherOpen:()=>O,closeSwitcher:j,dispose:()=>{N(),j(),C?.dispose();for(let e of k)try{e()}catch{}k.length=0,w.clear(),i.replaceChildren()}}}var as,os,ss,cs,ls,us,ds;function fs(){return(fs=e((()=>{M(),Ne(),C(),ii(),Tn(),yt(),cn(),Qa(),To(),Zo(),B(),$o(),s(),as=v(Qo),os=class extends Ge{constructor(){super()}styles=()=>as;render=()=>h`<div part="taskbar" class="taskbar"><slot></slot></div>`},os=R([b(`ui-taskbar`)],os),ss=`#env-home`,cs=`#env-viewer`,ls=`#env-win-`,us=420,ds=3e4})))()}function ps(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function ms(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function hs(e,t,n=`font/woff2`){if(bs.has(t))return bs.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return bs.set(t,i),i}async function gs(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(xs.has(o))return xs.get(o);let s=ps(t),c=await hs(a?await ms(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),xs.set(o,l),l}async function _s(e){let t=e.map(e=>gs(e));return Promise.all(t)}async function vs(){return Ss||(Ss=k(()=>import(`./font-registry-C_zT3R8-.js`),[],import.meta.url)?.catch?.(e=>{console.error(`Failed to load font registry:`,e)}),Ss)}async function ys(){let e=await vs();return _s(Object.values(e.fontRegistry))}var bs,xs,Ss;function Cs(){return(Cs=e((()=>{O(),bs=new Map,xs=new Map,Ss=null})))()}var ws;function Ts(){return(Ts=e((()=>{ws=`/*
 * Filename: index.scss
...
.ui-modal-panel {
  ...
  box-shadow: var(--modal-shadow, 0 20px 60px rgba(0, 0, 0, 0.42));
  pointer-events: auto;
}`})))()}var Es;function Ds(){return(Ds=e((()=>{Es=`/*
...
}`})))()}var Os;function ks(){return(ks=e((()=>{Cs(),s(),Ts(),Ds(),Os=async e=>{await ys().catch(()=>void 0),await S(ws)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await S(Es)?.catch(()=>void 0)}})))()}var As;function js(){return(js=e((()=>{As=`:host(ui-task), :host(ui-task) * {
  box-sizing: border-box;
  user-select: none;
  touch-action: manipulation;
  -webkit-user-drag: none;
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})))()}var Ms,Ns,Ps,Fs;function Is(){return(Is=e((()=>{B(),s(),C(),js(),Ms=v(As),Ns=e=>{let t=``;if(typeof e==`string`)t=e;else if(typeof e==`object`&&e&&`value`in e){let n=e.value;t=n==null?``:String(n)}else e!=null&&typeof e!=`object`&&(t=String(e));(!t||t===`undefined`||t===`null`||t===`[object Object]`)&&(t=``);let n=t.trim().charAt(0);return n?n.toUpperCase():`?`},Ps=(e,t,n)=>{let r=e.getAttribute(t);return r!=null&&String(r).trim()?String(r).trim():n},Fs=class extends Ge{title;icon;constructor(){super()}styles=()=>Ms;render=function(){let e=Ps(this,`title`,`Task`),t=Ps(this,`icon`,`app-window`),n=Ns(e);return h`
        ...
        `}},R([p({source:`attr`})],Fs.prototype,`title`,void 0),R([p({source:`attr`})],Fs.prototype,`icon`,void 0),Fs=R([b(`ui-task`)],Fs)})))()}var Ls;function Rs(){return(Rs=e((()=>{Ls=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})))()}function zs(){return(zs=e((()=>{r(),s(),Rs(),v(Ls)})))()}var Bs;function Vs(){return(Vs=e((()=>{Bs=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}
...
:host(ui-taskbar[data-type=mobile]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})))()}function Hs(){return(Hs=e((()=>{r(),s(),Vs(),v(Bs)})))()}function Us(){try{return globalThis.navigator?.windowControlsOverlay??null}catch{return null}}function Ws(){if(Z)return Z;if(typeof globalThis.matchMedia!=`function`)return`unknown`;try{if(globalThis.matchMedia(`(display-mode: window-controls-overlay)`).matches)return Z=`window-controls-overlay`;if(globalThis.matchMedia(`(display-mode: fullscreen)`).matches)return Z=`fullscreen`;if(globalThis.matchMedia(`(display-mode: standalone)`).matches)return Z=`standalone`;if(globalThis.matchMedia(`(display-mode: minimal-ui)`).matches)return Z=`minimal-ui`;if(globalThis.matchMedia(`(display-mode: browser)`).matches)return Z=`browser`}catch{}return Z=`unknown`}function Gs(e){if(!e?.visible||typeof e.getTitlebarAreaRect!=`function`)return null;try{let t=e.getTitlebarAreaRect();return t?{x:t.x,y:t.y,width:t.width,height:t.height}:null}catch{return null}}function Ks(e){let t=Us(),n=!!t?.visible,r=Ws(),i=n||r===`standalone`||r===`fullscreen`||r===`window-controls-overlay`||r===`minimal-ui`,a=`off`;return e&&(a=n?`wco`:i?`standalone`:`fallback`),{requested:e,wcoVisible:n,displayMode:r,titlebarRect:Gs(t),isStandaloneLike:i,surface:a}}function qs(e){let t=()=>{Z=null,e.onChange(Ks(e.getRequested()))},n=[];if(typeof globalThis.matchMedia==`function`)for(let e of[`(display-mode: window-controls-overlay)`,`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`])try{n.push(globalThis.matchMedia(e))}catch{}let r=()=>t();for(let e of n)try{e.addEventListener?.(`change`,r)}catch{try{e.addListener?.(r)}catch{}}let i=Us(),a=()=>t();try{i?.addEventListener?.(`geometrychange`,a)}catch{}return queueMicrotask(t),()=>{for(let e of n)try{e.removeEventListener?.(`change`,r)}catch{try{e.removeListener?.(r)}catch{}}try{i?.removeEventListener?.(`geometrychange`,a)}catch{}}}var Z;function Js(){return(Js=e((()=>{Z=null})))()}var Ys,Xs,Zs,Qs,$s,ec,tc,nc,rc,ic,ac,Q,oc,sc,cc,lc,uc,dc,$,fc,pc,mc,hc,gc,_c,vc,yc,bc,xc,Sc;function Cc(){return(Cc=e((()=>{Ys=null,Xs=null,Zs=null,Qs=null,$s=null,ec=null,tc=null,nc=0,rc=null,ic=`#cbb8a4`,ac=`__CWSP_NATIVE_THEME_COLOR_OWNED__`,Q=e=>{let t=String(e||``).trim().toLowerCase();if(!t)return!1;if(t===`#007acc`||t===`#007accff`||t===`#36c`||t===`#3366cc`)return!0;let n=t.match(/^rgba?\(\s*([\d.]+)\s*[, ]\s*([\d.]+)\s*[, ]\s*([\d.]+)/i);if(n&&(t?.startsWith?.(`#`)||t?.startsWith?.(`rgb`))){let e=Math.round(Number(n[1])),t=Math.round(Number(n[2])),r=Math.round(Number(n[3]));if(e<=20&&t>=100&&t<=140&&r>=180&&r<=220)return!0}return!1},oc=()=>{try{return!!globalThis?.[ac]}catch{return!1}},sc=e=>{$s=e;try{globalThis[ac]=!!e}catch{}},cc=e=>!e||!e.isConnected||e.hasAttribute(`minimized`)?!1:e.hasAttribute(`native-mode`)?!0:e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`),lc=()=>{if(typeof document>`u`)return null;if($s?.isConnected&&cc($s))return $s;let e=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized])`));if(e.length)return e[e.length-1];let t=Array.from(document.querySelectorAll(`ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`));for(let e=t.length-1;e>=0;e--){let n=t[e];if(cc(n))return n}return null},uc=()=>{Xs||typeof MutationObserver>`u`||typeof document>`u`||(Xs=new MutationObserver(()=>{tc=null;let e=lc();e?.isConnected?xc(e):_c()}),Xs.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`class`,`style`,`color-scheme`]}))},dc=e=>{Zs||typeof MutationObserver>`u`||(Zs=new MutationObserver(()=>{if(!oc())return;let t=(e.getAttribute(`content`)||``).toLowerCase(),n=(ec||``).toLowerCase();if(n&&t===n&&!Q(t))return;let r=lc();r?xc(r):Q(t)&&gc(ic,!0)}),Zs.observe(e,{attributes:!0,attributeFilter:[`content`]}))},$=e=>{let t=String(e||``).trim();if(!t||t===`transparent`||t===`rgba(0, 0, 0, 0)`)return null;let n=t.match(/^#([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})$/i);if(n){let e=n[1];e.length===3?e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]:e.length===8&&(e=e.slice(0,6));let t=`#${e.toLowerCase()}`;return Q(t)?null:t}let r=t.match(/^rgba?\(\s*([\d.]+)\s*,\s*([\d.]+)\s*,\s*([\d.]+)(?:\s*,\s*([\d.]+))?\s*\)$/i);if(r){let e=r[4]===void 0?1:Number(r[4]);if(!Number.isFinite(e)||e<.5)return null;let t=`#${[Math.max(0,Math.min(255,Math.round(Number(r[1])))),Math.max(0,Math.min(255,Math.round(Number(r[2])))),Math.max(0,Math.min(255,Math.round(Number(r[3]))))].map(e=>e.toString(16).padStart(2,`0`)).join(``)}`;return Q(t)?null:t}let i=t.match(/^rgba?\(\s*([\d.]+)\s+([\d.]+)\s+([\d.]+)(?:\s*\/\s*([\d.]+%?))?\s*\)$/i);if(i){let e=1;if(i[4]!==void 0&&(e=String(i[4]).endsWith(`%`)?Number(i[4])/100:Number(i[4])),!Number.isFinite(e)||e<.5)return null;let t=`#${[Math.max(0,Math.min(255,Math.round(Number(i[1])))),Math.max(0,Math.min(255,Math.round(Number(i[2])))),Math.max(0,Math.min(255,Math.round(Number(i[3]))))].map(e=>e.toString(16).padStart(2,`0`)).join(``)}`;return Q(t)?null:t}try{if(typeof document>`u`)return null;Qs||(Qs=document.createElement(`canvas`),Qs.width=1,Qs.height=1);let e=Qs.getContext(`2d`,{willReadFrequently:!0});if(!e)return null;e.fillStyle=`#000000`,e.fillStyle=t;let n=String(e.fillStyle||``);if(n.startsWith(`#`)&&n.length>=7){let e=n.slice(0,7).toLowerCase();return Q(e)?null:e}return $(n)}catch{return null}},fc=()=>{if(typeof document>`u`)return null;let e=document.querySelector(`meta[data-theme-color]`)||document.querySelector(`meta[name="theme-color"]`);e||(e=document.createElement(`meta`),e.setAttribute(`name`,`theme-color`),e.setAttribute(`data-theme-color`,``),document.head?.appendChild(e));try{let t=Array.from(document.querySelectorAll(`meta[name="theme-color"]`));for(let n of t)n!==e&&n.remove()}catch{}return dc(e),e},pc=(e,t)=>{try{let n=document.createElement(`div`);n.setAttribute(`data-theme-color-probe`,`true`),n.style.cssText=`position:fixed;left:-8px;top:-8px;inline-size:4px;block-size:4px;pointer-events:none;opacity:0;background:${t}`,e.appendChild(n);let r=$(getComputedStyle(n).backgroundColor);return n.remove(),r}catch{return null}},mc=()=>{if(tc)return tc;try{let e=getComputedStyle(document.documentElement).getPropertyValue(`--color-surface-container`).trim();tc=$(e)||pc(document.documentElement,`var(--color-surface-container, Canvas)`)||ic}catch{tc=ic}return tc},hc=e=>{let t=e.querySelector(`.env-ui-window__body`),n=t?.querySelector(`.settings-screen__top, .view-settings, .view-explorer, .cw-view-viewer-shell`)||t;if(n){let e=$(getComputedStyle(n).backgroundColor);if(e)return e}return mc()},gc=(e,t=!1)=>{let n=fc();if(!n||!e)return;let r=e.toLowerCase();Q(r)&&(r=ic);let i=(n.getAttribute(`content`)||``).toLowerCase();if(!(i===r&&!t&&!Q(i))&&(n.setAttribute(`content`,r),n.setAttribute(`data-theme-color`,``),n.removeAttribute(`media`),ec=r,t||i!==r||Q(i)))try{let e=n.parentNode||document.head;e?.removeChild(n),e?.appendChild(n)}catch{}},_c=()=>{if(typeof document>`u`||lc())return;sc(null),ec=null;let e=fc();if(!e)return;let t=document.documentElement,n=getComputedStyle(t),r=document.body?getComputedStyle(document.body):null,i=$(n.getPropertyValue(`--color-surface-container`).trim())||$(n.getPropertyValue(`--color-surface`).trim())||$(n.getPropertyValue(`--ui-win-titlebar-bg`).trim())||(r?$(r.backgroundColor):null)||$(n.backgroundColor);i?gc(i):Q(String(e.getAttribute(`content`)||``))&&gc(ic,!0),uc()},vc=e=>e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`),yc=()=>{if(nc){if(typeof cancelIdleCallback==`function`)try{cancelIdleCallback(nc)}catch{clearTimeout(nc)}else clearTimeout(nc);nc=0,rc=null}},bc=e=>{if(rc=e,nc)return;let t=()=>{nc=0;let e=rc;rc=null,e?.isConnected&&(e.hasAttribute(`minimized`)||!e.hasAttribute(`native-mode`)&&!vc(e)||(gc(hc(e)||ic,!1),uc()))};nc=typeof requestIdleCallback==`function`?requestIdleCallback(t,{timeout:120}):setTimeout(t,0)},xc=e=>{if(!e||typeof document>`u`||e.hasAttribute(`minimized`)||!e.hasAttribute(`native-mode`)&&!vc(e)&&!cc(e))return;let t=fc();if(t){if(Ys==null){let e=t.getAttribute(`content`)||``;Ys=Q(e)?``:e}if(sc(e),Q(String(t.getAttribute(`content`)||``))&&gc(ic,!1),ec&&!Q(ec)){gc(ec,!1),uc();return}bc(e)}},Sc=e=>{if(typeof document>`u`||!document.querySelector(`meta[name="theme-color"]`))return;let t=lc();if(t&&t!==e){xc(t);return}let n=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized]), ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`)).filter(t=>t!==e&&cc(t));if(n.length){xc(n[n.length-1]);return}sc(null),ec=null,yc(),Ys!=null&&Ys&&!Q(Ys)?(gc(Ys,!0),Ys=null):(Ys=null,_c())},typeof document<`u`&&queueMicrotask(()=>{try{_c()}catch{}})})))()}var wc;function Tc(){return(Tc=e((()=>{wc=`/*
...
}`})))()}var Ec,Dc,Oc,kc,Ac,jc,Mc;function Nc(){return(Nc=e((()=>{C(),r(),s(),B(),M(),Js(),Cc(),Tc(),Ec=v(wc),Dc=`minus`,Oc=`corners-out`,kc=`corners-in`,Ac=`x`,jc=Object.freeze({w:240,h:160}),Mc=class extends z{titleHandler;contentHandler;footerHandler;resizer;#e=A(0);#t=A(0);#n=null;#r=null;#i=null;#a=null;#o=null;#s=null;#c=null;#l=!1;#u=0;#d=0;#f=null;#p=null;#m=null;styles=function(){return Ec};render=function(){return h`<div class="window-container" part="window-container">
