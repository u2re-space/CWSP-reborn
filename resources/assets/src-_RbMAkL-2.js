import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{A as t,K as n,O as r,k as i,q as a,t as o}from"./src-6wudtv1A.js";import{n as s,t as c}from"./preload-helper-DcjHEl26.js";import{A as l,B as u,G as d,H as f,J as p,K as m,L as h,M as g,P as _,Q as v,R as y,V as b,W as x,X as S,g as C,j as w,q as T,t as E}from"./src-bJzyvrxg.js";import{a as D,dt as O,j as k,k as A,u as j}from"./HistoryManager-lhXX01K8.js";import{i as M,s as N}from"./icon-M8fpRh7n.js";import{A as P,C as ee,D as F,E as I,F as te,I as ne,O as L,P as re,S as ie,T as ae,_ as oe,a as se,b as ce,c as le,d as ue,f as de,g as fe,h as pe,i as me,j as he,k as ge,l as _e,m as ve,n as ye,o as be,r as xe,s as Se,t as Ce,u as we,v as Te,w as Ee,x as De,y as Oe}from"./launcher-state-Bir2-5jG.js";function R(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}function ke(){return(ke=e((()=>{})))()}var z,Ae;function B(){return(B=e((()=>{E(),N(),z=class extends b(){theme=`default`;render=function(){return D`<slot></slot>`};constructor(){super()}onRender(){return super.onRender()}connectedCallback(){return super.connectedCallback?.()??this}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(M()),e}},R([x({source:`attr`})],z.prototype,`theme`,void 0),z=R([f(`ui-element`)],z),Ae=z})))()}var je,V,Me,Ne,Pe,Fe,Ie,Le,Re,H,ze,Be,Ve;function He(){return(He=e((()=>{E(),je=`2147483600`,V=new Map,Me=new Map,Ne=null,Pe=[`[data-chrome-flyout-anchor]`,`.env-shell-taskbar__clock`,`.env-ui-statusbar__clock`,`.env-device-tray`],Fe=()=>{if(typeof document<`u`){if(document.querySelector(`.env-shell-chrome[data-desktop]`))return!0;let e=document.querySelector(`[data-chrome-layout]`);if(e?.dataset.chromeLayout===`desktop`)return!0;if(e?.dataset.chromeLayout===`mobile`)return!1}return typeof matchMedia<`u`&&matchMedia(`(min-width: 641px)`).matches},Ie=e=>{Ne=e},Le=e=>{let t=`data-env-shell-overlays`,n=e||Ne||document.querySelector(`.env-shell-root`)||document.querySelector(`#app`)||document.body,r=n.querySelector(`[${t}]`);if(r)return r.style.zIndex||(r.style.zIndex=je),r;try{let e=globalThis.__ENV_OVERLAY_MOUNT__;if(typeof e==`function`)return e(n)}catch{}let i=document.createElement(`div`);return i.setAttribute(t,``),i.className=`env-shell-overlays`,i.setAttribute(`data-part`,`env-overlays`),i.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${je};box-sizing:border-box;`,n.appendChild(i),i},Re=(e,t)=>{let n=Fe();if(e.style.position=`fixed`,e.style.zIndex=String(Number(je)+1),e.style.pointerEvents=`auto`,e.style.margin=`0`,n){e.style.top=`auto`,e.style.left=`auto`,e.style.right=`0.75rem`,e.style.bottom=`4.5rem`,e.style.transform=`none`;return}if(t===`calendar`){e.style.top=`50%`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translate(-50%, -50%)`;return}e.style.top=`calc(env(safe-area-inset-top, 0px) + 0.75rem)`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translateX(-50%)`},H=e=>{let t=V.get(e);if(!t)return;V.delete(e);let n=Me.get(e);Me.delete(e),n?.disposeDismiss(),n?.unregisterBack();try{let e=t.el;typeof e.close==`function`?e.close():(e.removeAttribute(`open`),e.hidden=!0),e.dispatchEvent(new CustomEvent(`chrome-flyout-close`,{bubbles:!0}))}catch{}},ze=e=>{V.has(e.kind)&&H(e.kind);for(let t of[...V.keys()])t!==e.kind&&H(t);V.set(e.kind,{...e,close:()=>H(e.kind)}),e.el.hidden=!1,e.el.removeAttribute(`hidden`),e.el.setAttribute(`open`,``),Me.set(e.kind,{disposeDismiss:_({root:document,inside:e.el,isInside:t=>e.contains(t.target),exceptSelectors:Pe,onDismiss:()=>H(e.kind)}),unregisterBack:l({id:`chrome-flyout-${e.kind}`,kind:`overlay`,element:e.el,isActive:()=>V.get(e.kind)?.el===e.el&&e.el.isConnected&&!e.el.hidden&&e.el.hasAttribute(`open`),close:()=>(H(e.kind),!0)})})},Be=e=>V.has(e),Ve=(e,t)=>{if(Be(e)){H(e);return}let n=t();ze(n)}})))()}var Ue;function We(){return(We=e((()=>{Ue=`/*
...
@layer calendar {
  ...
  .ui-cal-flyout__day[data-today][data-selected] {
    box-shadow: 0 0 0 2px color-mix(in oklab, var(--cal-base-color) 70%, #fff 20%) inset;
...
}`})))()}function Ge(e){try{let t=new Intl.Locale(e),n=(t.weekInfo??t.getWeekInfo?.())?.firstDay;if(typeof n==`number`&&n>=1&&n<=7)return n%7}catch{}return 0}function Ke(e,t){let n=new Intl.DateTimeFormat(e,{weekday:`short`,timeZone:`UTC`}),r=[];for(let e=0;e<7;e++){let i=(t+e)%7;r.push(n.format(new Date($e+i*et)))}return r}function qe(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function Je(e,t,n){let r=new Date,i=new Date(e,t,1),a=new Date(e,t+1,0).getDate(),o=(i.getDay()-n+7)%7,s=Math.ceil((o+a)/7)*7,c=[];for(let n=0;n<s;n++){let i=n-o+1,a=new Date(e,t,i);c.push({date:a,day:a.getDate(),otherMonth:a.getMonth()!==t,isToday:qe(a,r)})}return c}function Ye(){if(nt?.isConnected)return nt;let e=Le(),t=e.querySelector(`ui-calendar-flyout`);return t||(t=document.createElement(`ui-calendar-flyout`),t.hidden=!0,e.appendChild(t)),nt=t,t}function Xe(e){Ve(Qe,()=>{let e=Ye(),t=document.documentElement.getAttribute(`data-theme`);return(t===`light`||t===`dark`)&&(e.dataset.theme=t,e.style.colorScheme=t),Re(e,Qe),e.open(),{kind:Qe,el:e,close:()=>{e.close(),H(Qe)},contains:t=>t instanceof Node&&e.contains(t)}})}var Ze,Qe,$e,et,tt,nt;function rt(){return(rt=e((()=>{E(),o(),B(),N(),He(),We(),Ze=t(Ue),Qe=`calendar`,$e=Date.UTC(2023,0,1),et=864e5,tt=class extends z{#e;#t;#n=null;#r=null;styles=function(){return Ze};render=function(){return D`<div class="ui-cal-flyout__panel" part="panel">
        ...
        </div>`};constructor(){super();let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth()}onRender(){super.onRender(),this.#i(),this.#c()}disconnectedCallback(){this.#r?.(),this.#r=null,super.disconnectedCallback?.()}#i(){let e=this.shadowRoot;if(!e||this.#r)return;let t=a(e,`click`,e=>{let t=e.target,n=t?.closest?.(`[data-nav]`);if(n){n.dataset.nav===`prev`?this.#a(-1):n.dataset.nav===`next`&&this.#a(1);return}let r=t?.closest?.(`.ui-cal-flyout__day`);r&&this.#s(r)});this.#r=()=>t?.()}#a(e){this.#t+=e,this.#t<0?(this.#t=11,--this.#e):this.#t>11&&(this.#t=0,this.#e+=1),this.#c()}#o(){let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth(),this.#c()}#s(e){let t=e.dataset.date;t&&(this.#n=new Date(t),this.shadowRoot?.querySelectorAll(`.ui-cal-flyout__day[data-selected]`)?.forEach(e=>e.removeAttribute(`data-selected`)),e.setAttribute(`data-selected`,``),this.dispatchEvent(new CustomEvent(`calendar-select`,{bubbles:!0,composed:!0,detail:{date:this.#n}})))}#c(){let e=this.shadowRoot;if(!e)return;let t=typeof navigator<`u`?navigator.language:void 0,n=Ge(t??`en-US`),r=new Date,i=e.querySelector(`.ui-cal-flyout__today`);i&&(i.textContent=r.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`}));let a=e.querySelector(`.ui-cal-flyout__month-label`);a&&(a.textContent=new Date(this.#e,this.#t,1).toLocaleDateString(t,{month:`long`,year:`numeric`}));let o=e.querySelector(`.ui-cal-flyout__weekdays`);o&&o.replaceChildren(...Ke(t??`en-US`,n).map(e=>{let t=document.createElement(`span`);return t.className=`ui-cal-flyout__weekday`,t.setAttribute(`role`,`columnheader`),t.textContent=e,t}));let s=e.querySelector(`.ui-cal-flyout__grid`);if(s){let e=Je(this.#e,this.#t,n);s.replaceChildren(...e.map(e=>{let n=document.createElement(`button`);return n.type=`button`,n.className=`ui-cal-flyout__day`,n.textContent=String(e.day),n.dataset.date=e.date.toISOString(),n.setAttribute(`role`,`gridcell`),e.otherMonth&&n.setAttribute(`data-other-month`,``),e.isToday&&n.setAttribute(`data-today`,``),this.#n&&qe(e.date,this.#n)&&n.setAttribute(`data-selected`,``),n.setAttribute(`aria-label`,e.date.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`})),n}))}}open(){this.#o(),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},tt=R([f(`ui-calendar-flyout`)],tt),nt=null})))()}function it(){let e=ct.get();return typeof e==`function`?e:null}var at,ot,st,ct;function lt(){return(lt=e((()=>{at=`__CWSP_SPEED_DIAL_VIEW_OPENER_V1__`,ot=`__CWSP_HOME_OVERLAY_MOUNT_V1__`,st=e=>{let t=globalThis;return{get:()=>e in t?t[e]:null,set:n=>{t[e]=n}}},ct=st(at),st(ot)})))()}var ut;function dt(){return(dt=e((()=>{ut=`/*
...
}`})))()}function ft(){if(Wt?.isConnected)return Wt;let e=Le(),t=e.querySelector(`ui-quick-settings`);return t||(t=document.createElement(`ui-quick-settings`),t.hidden=!0,e.appendChild(t)),Wt=t,t}function pt(e){Ve(gt,()=>{let e=ft(),t=document.documentElement.getAttribute(`data-theme`);return(t===`light`||t===`dark`)&&(e.dataset.theme=t,e.style.colorScheme=t),Re(e,gt),e.open(),{kind:gt,el:e,close:()=>{e.close(),H(gt)},contains:t=>t instanceof Node&&e.contains(t)}})}function mt(){H(gt)}var ht,gt,_t,vt,yt,bt,xt,St,Ct,wt,Tt,Et,Dt,Ot,kt,At,jt,Mt,Nt,Pt,Ft,It,Lt,Rt,zt,Bt,Vt,Ht,Ut,Wt;function Gt(){return(Gt=e((()=>{E(),o(),B(),N(),lt(),He(),dt(),ht=t(ut),gt=`quick-settings`,_t=`data-theme`,vt=`rs-appearance-theme`,yt=`appearance.theme`,bt=[`rs-settings`,`cwsp-settings`,`u2-settings`],xt=()=>{try{return matchMedia?.(`(prefers-color-scheme: dark)`)?.matches??!0}catch{return!0}},St=e=>{for(let t of bt)try{let n=localStorage.getItem(t);if(!n)continue;let r=JSON.parse(n);if(!r||typeof r!=`object`)continue;r.appearance={...r.appearance??{},theme:e},localStorage.setItem(t,JSON.stringify(r))}catch{}},Ct=()=>{try{let e=document.documentElement.getAttribute(_t);if(e===`light`||e===`dark`)return e;let t=localStorage.getItem(vt);if(t===`light`||t===`dark`)return t}catch{}return xt()?`dark`:`light`},wt=e=>{let t=document.documentElement,n=e===`auto`?xt()?`dark`:`light`:e,r=e===`auto`?`auto`:e;t.setAttribute(`data-scheme`,r),t.setAttribute(_t,n),t.style.colorScheme=n;try{document.body&&(document.body.style.colorScheme=n)}catch{}try{document.querySelectorAll(`.env-shell-root, [data-shell], ui-window`).forEach(e=>{let t=e;t.dataset.theme=n,t.style.colorScheme=n;let r=t.shadowRoot?.querySelector?.(`.app-shell`);r&&(r.dataset.theme=n,r.style.colorScheme=n)})}catch{}try{localStorage.setItem(vt,e===`auto`?`auto`:e),localStorage.setItem(yt,e===`auto`?`auto`:e)}catch{}e!==`auto`&&St(e),t.dispatchEvent(new CustomEvent(`u2-theme-change`,{bubbles:!0,detail:{source:`quick-settings`,theme:n,preference:e}}))},Tt=()=>{try{let e=String(localStorage.getItem(vt)||``).trim().toLowerCase();if(e===`light`||e===`dark`||e===`auto`)return e;let t=String(localStorage.getItem(yt)||``).trim().toLowerCase();if(t===`light`||t===`dark`||t===`auto`)return t}catch{}return`auto`},Et=()=>{let e=globalThis;if(e.__CWSP_AUTO_THEME_FOLLOW__)return;e.__CWSP_AUTO_THEME_FOLLOW__=!0;let t=typeof matchMedia==`function`?matchMedia(`(prefers-color-scheme: dark)`):null;if(!t)return;let n=()=>{Tt()===`auto`&&wt(`auto`)};try{t.addEventListener(`change`,n)}catch{try{t.addListener(n)}catch{}}try{n()}catch{}},Dt=e=>{document.documentElement.style.setProperty(`--orientation-lock`,e?`unlocked`:`locked`),document.documentElement.style.setProperty(`--orientation-lock-angle`,e?`0deg`:`90deg`),Promise.try(async()=>{try{let t=screen.orientation;if(e){t.unlock?.();return}if(typeof t.lock!=`function`)return;let n=t.lock(t.type||`natural`);n&&typeof n.catch==`function`&&await n.catch(()=>{})}catch(e){console.warn(e)}})?.catch?.(console.warn.bind(console))},Ot=`env-night-filter`,kt=`2147483001`,At=`rs-night-filter`,jt=`rs-brightness-filter`,Mt=e=>Math.max(0,Math.min(100,Number.isFinite(e)?e:0)),Nt=()=>{let e=document.getElementById(Ot);if(e instanceof HTMLElement)return e;let t=document.createElement(`div`);return t.id=Ot,t.setAttribute(`aria-hidden`,`true`),t.style.cssText=[`dynamic-range-limit:no-limit`,`color-space:display-p3`,`position:fixed`,`inset:0`,`pointer-events:none`,`z-index:${kt}`,`background-color:color(display-p3 1 0.55 0.24)`,`mix-blend-mode:multiply`,`opacity:0`,`visibility:hidden`,`transition:opacity 160ms ease`].join(`;`),(document.body??document.documentElement).appendChild(t),t},Pt=e=>{let t=Mt(e),n=Nt(),r=t/100;n.style.opacity=String(r),n.style.visibility=r>=.01?`visible`:`hidden`;try{localStorage.setItem(At,String(t))}catch{}},Ft=e=>{let t=Mt(e);Nt(),t<=50?.4+t/50*.6:1+(t-50)/50*.2;try{localStorage.setItem(jt,String(t))}catch{}},It=(e,t)=>{try{let n=localStorage.getItem(e);if(n==null)return t;let r=Number(n);return Number.isFinite(r)?Mt(r):t}catch{return t}},Lt=()=>{let e=It(At,0),t=It(jt,50);return Pt(e),Ft(t),{night:e,brightness:t}},typeof document<`u`&&(document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>Lt(),{once:!0}):Lt()),Rt=[`wifi`,`bluetooth`,`focus`,`airplane`,`orientation`],zt={light:`sun`,dark:`moon`},Bt={light:`Light`,dark:`Dark`},Vt=e=>{let t=e.querySelector(`[data-qs-tile="theme"]`);if(!t)return;let n=Ct();t.querySelector(`ui-icon`)?.setAttribute(`icon`,zt[n]);let r=t.querySelector(`[data-qs-tile-sub]`);r&&(r.textContent=Bt[n]),t.setAttribute(`aria-pressed`,n===`dark`?`true`:`false`)},Ht=e=>{let t=e.shadowRoot,r=t?.querySelector(`.qs-panel`);if(!t||!r||r.hasAttribute(`data-qs-wired`))return;r.setAttribute(`data-qs-wired`,``),Vt(t),t.querySelector(`[data-qs-tile="theme"]`)?.addEventListener(`click`,()=>{let e=Ct()===`dark`?`light`:`dark`;wt(e),Vt(t)});let i=e=>!!e?.getAttribute?.(`aria-pressed`)&&e?.getAttribute?.(`aria-pressed`)===`true`;t.querySelector?.(`[data-qs-tile="orientation"]`)?.addEventListener?.(`click`,e=>{let t=n((e?.target?.matches?.(`[data-qs-tile="orientation"]`)?e?.target:e?.target?.querySelector?.(`[data-qs-tile="orientation"]`))||e?.target,`[data-qs-tile="orientation"]`),r=i(t);Dt(r);let a=t?.matches?.(`ui-icon`)?t:t?.querySelector?.(`ui-icon`);a&&a.setAttribute?.(`icon`,r?`device-rotate`:`lock`),a&&a.setAttribute?.(`icon-style`,`duotone`)});for(let e of Rt){let n=t.querySelector(`[data-qs-tile="${e}"]`);n&&n.addEventListener(`click`,()=>{let e=n.getAttribute(`aria-pressed`)!==`true`;n.setAttribute(`aria-pressed`,String(e));let t=n.querySelector(`[data-qs-tile-sub]`);t&&(t.textContent=e?`On`:`Off`)})}let{night:a,brightness:o}=Lt(),s=t.querySelector(`[data-qs-slider="night"]`),c=t.querySelector(`[data-qs-slider="brightness"]`);s&&(s.value=String(a),s.addEventListener(`input`,()=>Pt(s.valueAsNumber))),c&&(c.value=String(o),c.addEventListener(`input`,()=>Ft(c.valueAsNumber)));let l=e=>{mt();let t=()=>{let t=it();if(typeof t==`function`){t(e,{});return}let n=`#${e}`;typeof location<`u`&&location.hash!==n&&v(n)};typeof requestAnimationFrame==`function`?requestAnimationFrame(t):queueMicrotask(t)};t.querySelectorAll(`[data-qs-open]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=String(e.getAttribute(`data-qs-open`)||``).trim();(t===`settings`||t===`explorer`)&&l(t)})})},Ut=class extends z{constructor(){super()}styles=()=>ht;render=()=>D`
...
</div>`;onRender(){return super.onRender(),Ht(this),this}open(){Vt(this.shadowRoot),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},Ut=R([f(`ui-quick-settings`)],Ut),Wt=null,Promise.try(()=>{typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{Promise.try(()=>{screen?.orientation?.lock?.(`natural`)}).catch(console.warn.bind(console))})}).catch(console.warn.bind(console));try{Et()}catch{}})))()}var Kt;function qt(){return(qt=e((()=>{Kt=`/*
...
@layer ui-statusbar {
  ...
  env-shell-container[data-env-native-task] .env-shell-chrome[data-desktop] {
    ...
    </div>`,r=n.querySelector(`.env-status-bar__pct`);return r instanceof HTMLElement&&j(r,{properties:{textContent:e.batteryPct}}),n}function on(e,t,n){let r=document.createElement(`ui-statusbar`);r.className=`env-ui-statusbar wf-chrome-no-select`,r.setAttribute(`part`,`status-bar`);let i=document.createElement(`div`);i.slot=`left`,i.className=`env-ui-statusbar__left`;let a=document.createElement(`time`);a.className=`env-ui-statusbar__clock`,a.dateTime=``,a.textContent=$t(),a.setAttribute(`role`,`button`),a.setAttribute(`tabindex`,`0`),a.setAttribute(`aria-label`,`Calendar`),a.setAttribute(`aria-haspopup`,`dialog`),a.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let o=document.createElement(`div`);o.className=`env-ui-statusbar__intro`,t&&(o.innerHTML=t),i.append(a,o);let s=document.createElement(`div`);s.slot=`center`;let c=document.createElement(`p`);c.className=`env-status-bar__meta`,s.appendChild(c);let l=document.createElement(`div`);l.slot=`right`,l.className=`env-ui-statusbar__right`;let u=an(n,`env-device-tray env-device-tray--footer`);u.setAttribute(`role`,`button`),u.setAttribute(`tabindex`,`0`),u.setAttribute(`aria-label`,`Quick settings`),u.setAttribute(`aria-haspopup`,`dialog`),u.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`),l.appendChild(u);let d=e=>{e.preventDefault(),e.stopPropagation(),Xe(a)},f=e=>{e.preventDefault(),e.stopPropagation(),pt(u)};a.addEventListener(`click`,d),a.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&d(e)}),u.addEventListener(`click`,f),u.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&f(e)}),r.append(i,s,l),re(()=>{let t=e.navEcho.value?` │ ${e.navEcho.value}`:``;c.textContent=`doc=${e.selectedPath.value} │ viewer=${e.viewerStatus.value} │ layout=${e.mqLabel.value}${t}`},[e.selectedPath,e.viewerStatus,e.mqLabel,e.navEcho],{triggerImmediately:!0});let p=()=>{let e=new Date;a.textContent=$t(e),a.dateTime=e.toISOString()};p();let m=setInterval(p,15e3);return{element:r,dispose:()=>{clearInterval(m)}}}var sn,cn;function ln(){return(ln=e((()=>{E(),te(),rt(),Gt(),B(),qt(),o(),sn=t(Kt),cn=class extends Ae{constructor(){super()}styles=()=>sn;render=()=>D`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},cn=R([f(`ui-statusbar`)],cn)})))()}function un(){return(un=e((()=>{ge(),E()})))()}var dn,fn,pn,U,W,G,mn,hn,gn,K,_n,vn,yn,bn,q,xn,Sn,Cn,wn,Tn,En,Dn,On,kn,An,jn,Mn,J,Nn;function Pn(){return(Pn=e((()=>{o(),E(),un(),dn=320,fn=220,pn=`2147483640`,U=`important`,W=0,G=null,mn=null,hn=null,gn=null,K=[],_n=new Map,vn=new Map,yn=new Map,bn=new Map,q=new Map,xn=[`left-start`,`right-end`,`left-end`,`bottom-start`,`top-start`],Sn=(e,t)=>{let n=C(e,{...t,strategy:`js`});return typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{n.update?.()}),n},Cn=()=>{let e=document.documentElement,t=String(e.getAttribute(`data-theme`)||``).trim().toLowerCase();if(t===`light`||t===`dark`)return t;let n=String(e.getAttribute(`data-scheme`)||``).trim().toLowerCase();if(n===`light`||n===`dark`)return n;try{let e=String(localStorage.getItem(`rs-appearance-theme`)||``).trim().toLowerCase();if(e===`light`||e===`dark`)return e}catch{}return typeof matchMedia==`function`&&matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`},wn=(e,t)=>{e.style.setProperty(`position`,`fixed`,U),e.style.setProperty(`box-sizing`,`border-box`,U),e.style.setProperty(`min-width`,t?`188px`:`220px`,U),e.style.setProperty(`max-width`,`min(320px, calc(100vw - 24px))`,U),e.style.setProperty(`padding`,t?`0.3rem`:`0.4rem`,U),e.style.setProperty(`border-radius`,`14px`,U),e.style.setProperty(`pointer-events`,`auto`,U),e.style.setProperty(`backdrop-filter`,`blur(10px)`,U),e.style.setProperty(`-webkit-backdrop-filter`,`blur(10px)`,U),e.style.removeProperty(`border`),e.style.removeProperty(`background`),e.style.removeProperty(`color`),e.style.removeProperty(`box-shadow`);let n=Cn();e.dataset.theme=n,e.style.setProperty(`color-scheme`,n===`light`?`light only`:`dark only`,U)},Tn=e=>{e.style.setProperty(`list-style`,`none`,U),e.style.setProperty(`list-style-type`,`none`,U),e.style.setProperty(`margin`,`0`,U),e.style.setProperty(`padding`,`0`,U),e.style.setProperty(`display`,`flex`,U),e.style.setProperty(`flex-direction`,`column`,U),e.style.setProperty(`align-items`,`stretch`,U),e.style.setProperty(`gap`,`0.2rem`,U),e.style.setProperty(`width`,`100%`,U),e.style.setProperty(`box-sizing`,`border-box`,U)},En=(e,t)=>{if(e.style.setProperty(`appearance`,`none`,U),e.style.setProperty(`-webkit-appearance`,`none`,U),e.style.setProperty(`box-sizing`,`border-box`,U),e.style.setProperty(`width`,`100%`,U),e.style.setProperty(`max-width`,`100%`,U),e.style.setProperty(`margin`,`0`,U),e.style.setProperty(`display`,`grid`,U),e.style.setProperty(`grid-template-columns`,`1.375rem minmax(0, 1fr) auto`,U),e.style.setProperty(`align-items`,`center`,U),e.style.setProperty(`justify-items`,`start`,U),e.style.setProperty(`gap`,`0.55rem`,U),e.style.setProperty(`border`,`none`,U),e.style.setProperty(`border-radius`,`10px`,U),e.style.setProperty(`padding`,`0.5rem 0.6rem`,U),e.style.setProperty(`min-height`,`2.35rem`,U),e.style.setProperty(`font`,`inherit`,U),e.style.setProperty(`font-size`,`0.8125rem`,U),e.style.setProperty(`line-height`,`1.25`,U),e.style.setProperty(`text-align`,`start`,U),e.style.setProperty(`cursor`,`pointer`,U),e.style.removeProperty(`background`),e.style.removeProperty(`background-color`),!t)e.style.setProperty(`color`,`inherit`,U);else{let t=Cn()===`light`?`#9f1239`:`#fecaca`;e.style.setProperty(`color`,t,U),e.style.setProperty(`--cw-menu-fg`,t,U)}},Dn=()=>{let e=document.getElementById(`cw-unified-context-menu-style`);e||(e=document.createElement(`style`),e.id=`cw-unified-context-menu-style`,document.head.appendChild(e)),e.textContent=`
        .cw-context-menu-layer {
            position: fixed;
            inset: 0;
            z-index: var(--cw-context-menu-layer-z, ${pn});
            pointer-events: none;
        }
    ...
    `},On=()=>{for(let e of K)try{e()}catch{}K=[]},kn=e=>{for(let[t,n]of Array.from(bn.entries()))t>=e&&(clearTimeout(n),bn.delete(t));for(let[t,n]of Array.from(q.entries()))t>=e&&(clearTimeout(n),q.delete(t))},An=e=>{kn(e);for(let[t,n]of Array.from(_n.entries()))t>=e&&(yn.get(t)?.dispose(),yn.delete(t),n.remove(),_n.delete(t),vn.delete(t))},jn=e=>{for(let[t,n]of Array.from(q.entries()))t>=e&&(clearTimeout(n),q.delete(t))},Mn=(e,t,n,r,i)=>{let a=document.createElement(`div`);a.className=`cw-context-menu${t?` cw-context-menu--compact`:``}`,a.setAttribute(`role`,`menu`),a.dataset.menuDepth=String(n),a.style.zIndex=String(n+1);let o=document.createElement(`ul`);o.className=`cw-context-menu__list`,Tn(o),a.appendChild(o);let s=(e,n,a)=>{if(r!==W||!mn?.isConnected||!G?.isConnected||(An(a),!e.children?.length))return;let o=Mn(e.children,t,a,r,i);o.classList.add(`cw-context-menu--submenu`),G.appendChild(o),_n.set(a,o),vn.set(a,n),yn.set(a,Sn(o,{origin:{type:`element`,element:n},placement:`right-start`,fallbacks:xn,strategy:`js`}))},c=(e,t,n)=>{let r=bn.get(n);r&&clearTimeout(r),jn(n);let i=setTimeout(()=>{bn.delete(n),s(e,t,n)},dn);bn.set(n,i)},l=e=>{let t=q.get(e);t&&clearTimeout(t);let n=setTimeout(()=>{q.delete(e),An(e)},fn);q.set(e,n)};for(let t of e){let e=document.createElement(`button`);e.type=`button`,e.className=`cw-context-menu__item${t.danger?` cw-context-menu__item--danger`:``}`,e.setAttribute(`role`,`menuitem`),e.disabled=!!t.disabled,En(e,!!t.danger);let i=!!t.children?.length;if(e.innerHTML=`
        ...
        `,i){let i=n+1;e.setAttribute(`aria-haspopup`,`menu`),e.addEventListener(`pointerenter`,()=>c(t,e,i)),e.addEventListener(`pointerleave`,()=>l(i)),e.addEventListener(`click`,n=>{if(n.preventDefault(),n.stopPropagation(),r!==W||!mn?.isConnected)return;jn(i);let a=_n.get(i),o=vn.get(i);if(a?.isConnected&&o===e){An(i);return}s(t,e,i)})}else e.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation(),!(r!==W||!mn?.isConnected)&&(J(),!t.disabled&&await t.action())});let a=document.createElement(`li`);a.appendChild(e),o.appendChild(a)}return wn(a,t),a.addEventListener(`pointerenter`,()=>jn(n)),a.addEventListener(`pointerleave`,()=>{if(n>0){let e=q.get(n);e&&clearTimeout(e);let t=setTimeout(()=>{q.delete(n),An(n)},fn);q.set(n,t)}}),a},J=()=>{On(),kn(0),gn?.(),gn=null,hn?.dispose(),hn=null,An(1),_n.clear(),vn.clear(),yn.clear(),mn?.remove(),mn=null,G?.remove(),G=null,W+=1},Nn=e=>{let t=(e.items||[]).filter(e=>e&&e.id&&e.label);if(!t.length){J();return}Dn(),J();let n=W,r=w()??document.body,i=document.createElement(`div`);i.className=`cw-context-menu-layer`,G=i,r.appendChild(i);let a=e.placementStrategy??`auto`,o=Mn(t,!!e.compact,0,n,a);mn=o,i.appendChild(o),hn=Sn(o,{origin:{type:`point`,x:e.x,y:e.y},placement:`bottom-start`,gap:0,strategy:`js`}),gn=l({id:`context-menu-${n}`,kind:`context-menu`,element:i,isActive:()=>W===n&&G===i&&i.isConnected,close:()=>(J(),!0)});let s=e=>{if(n!==W||!G?.isConnected)return;let t=e.target;t&&G.contains(t)||J()},c=e=>{if(n!==W||!mn?.isConnected)return;let t=e.target;if(!t)return;let r=t.closest?.(`.cw-context-menu__item`);if(!r){An(1);return}r.getAttribute(`aria-haspopup`)!==`menu`&&An(1)},u=e=>{n===W&&e.key===`Escape`&&J()},d=()=>J();document.addEventListener(`pointerdown`,s,{capture:!0}),document.addEventListener(`contextmenu`,s,{capture:!0}),document.addEventListener(`keydown`,u),o.addEventListener(`click`,c,{capture:!0}),window.addEventListener(`resize`,d,{passive:!0}),window.addEventListener(`blur`,d,{passive:!0}),K.push(()=>document.removeEventListener(`pointerdown`,s,{capture:!0})),K.push(()=>document.removeEventListener(`contextmenu`,s,{capture:!0})),K.push(()=>document.removeEventListener(`keydown`,u)),K.push(()=>o.removeEventListener(`click`,c,{capture:!0})),K.push(()=>window.removeEventListener(`resize`,d)),K.push(()=>window.removeEventListener(`blur`,d))}})))()}function Fn(e){globalThis.dispatchEvent?.(new CustomEvent(`view:toast`,{detail:{type:`success`,message:String(e||``)}}))}function In(e){let t=String(e||`default`).trim().toLowerCase();return Vn[t]||`default`}function Ln(e){return String(e||``).trim().toLowerCase().startsWith(`android-icon:`)}function Rn(e,t=`default`,n=``,r=``){let i=String(e||``).trim();if(!i)return``;let a=In(t),o=String(n||``).trim(),s=String(r||``).trim(),c=new URLSearchParams;a!=="default"&&c.set(`v`,a),o&&c.set(`pack`,o),s&&c.set(`drawable`,s);let l=c.toString();return l?`android-icon:${i}?${l}`:`android-icon:${i}`}function zn(e){let t=String(e||``).trim();if(!Ln(t))return null;let n=t.slice(13).replace(/^\/\//,``);if(!n)return null;let r=(e,t)=>{if(!e)return null;let n={packageName:e,variant:In(t.get(`v`)||`default`)},r=String(t.get(`pack`)||``).trim(),i=String(t.get(`drawable`)||``).trim();return r&&(n.pack=r),i&&(n.drawable=i),n};try{let e=new URL(n.includes(`://`)?n:`android-icon://${n}`);return r(String(e.hostname||e.pathname.replace(/^\//,``)||``).trim(),e.searchParams)}catch{let[e,t=``]=n.split(`?`);return r(String(e||``).trim(),new URLSearchParams(t))}}function Bn(e,t=`default`,n=``,r=``,i=0){let a=String(e||``).trim();if(!a)return``;let o=In(t),s=String(n||``).trim(),c=String(r||``).trim(),l=o==="default"?a:`${a}#${o}`;s&&(l=`${l}#pack:${s}`),c&&(l=`${l}#d:${c}`);let u=Math.round(Number(i)||0);return u>0&&(l=`${l}#s${u}`),l}var Vn;function Hn(){return(Hn=e((()=>{Vn={default:`default`,full:`default`,colored:`default`,monochrome:`monochrome`,mono:`monochrome`,material:`monochrome`,"material-you":`monochrome`,themed:`monochrome`,foreground:`foreground`,fg:`foreground`,"adaptive-fg":`foreground`}})))()}async function Un(e){let t=await(await fetch(e)).blob(),n=t.type&&t.type.startsWith(`image/`)?t.type:`image/png`,r=t.type===n?t:new Blob([await t.arrayBuffer()],{type:n});return URL.createObjectURL(r)}function Wn(e,t=96,n=`default`,r=``,i=``){let a=String(e||``).trim();if(!a)return``;if(a.startsWith(`shortcut:`)){let e=a.slice(9),n=e.indexOf(`/`);return n>0?Kn(e.slice(0,n),e.slice(n+1),t):``}return er.get(Bn(a,n,r,i,t))||``}async function Gn(e,t,n=96){let r=String(e||``).trim(),i=String(t||``).trim();if(!r||!i)return``;let a=Math.max(16,Math.min(512,Math.round(Number(n)||96))),o=`shortcut:${r}/${i}@${a}`,s=nr.get(o);if(s)return s;let c=rr.get(o);return c||(c=(async()=>{let e=await Xn();if(!e?.launcherShortcutIcon)return``;let t=``;try{t=String(await e.launcherShortcutIcon(r,i,a)||``).trim()}catch{return``}if(!t)return``;try{let e=await Un(t);return nr.set(o,e),e}catch{return t}})().finally(()=>{rr.delete(o)}),rr.set(o,c)),c}function Kn(e,t,n=96){let r=String(e||``).trim(),i=String(t||``).trim();if(!r||!i)return``;let a=Math.max(16,Math.min(512,Math.round(Number(n)||96)));return nr.get(`shortcut:${r}/${i}@${a}`)||``}async function qn(e,t=96,n=`default`,r=``,i=``){let a=String(e||``).trim();if(!a)return``;if(a.startsWith(`shortcut:`)){let e=a.slice(9),n=e.indexOf(`/`);return n>0?Gn(e.slice(0,n),e.slice(n+1),t):``}let o=In(n),s=String(r||``).trim(),c=String(i||``).trim(),l=Math.max(16,Math.min(512,Math.round(Number(t)||96))),u=Bn(a,o,s,c,l),d=er.get(u);if(d)return d;let f=tr.get(u);f||(f=(async()=>{let e=await Xn();if(!e?.launcherIcon)return``;let t=``;try{t=await e.launcherIcon(a,l,o,s||void 0,c||void 0)}catch{return``}if(!t)return``;try{let e=await Un(t);return er.set(u,e),e}catch{return``}})(),tr.set(u,f));try{return await f}finally{tr.delete(u)}}async function Jn(e,t=96){let n=String(e||``).trim();if(!n||n.startsWith(`blob:`))return``;let r=zn(n);return r?qn(r.packageName,t,r.variant,r.pack||``,r.drawable||``):n}function Yn(e,t=96){let n=zn(e);return n?Wn(n.packageName,t,n.variant,n.pack||``,n.drawable||``):``}async function Xn(){if($n)return $n;try{return await c(()=>import(`./launcher-bridge-C3JnBhTN.js`),[],import.meta.url)}catch{return null}}async function Zn(){return Xn()}function Qn(e,t,n=`colored`){let r=String(t||``).trim();if(!r)return;e.setAttribute(`icon-padding`,`0`),e.style.setProperty(`--icon-padding`,`0px`),e.style.setProperty(`--icon-size`,`100%`),e.toggleAttribute(`data-launcher-icon`,!0);let i=()=>{let t=e;return typeof t.setResourceIcon==`function`&&(t.setResourceIcon(r,n===`auto`?`auto`:n),n!==`auto`&&typeof t.setBitmapPresentationMode==`function`&&t.setBitmapPresentationMode(n,!0),e.removeAttribute(`data-icon-pending`),e.toggleAttribute(`data-launcher-icon-ready`,!0),!0)};i()||customElements.whenDefined(`ui-icon`).then(()=>{e.isConnected&&i()})}var $n,er,tr,nr,rr;function ir(){return(ir=e((()=>{E(),ue(),lt(),Hn(),s(),$n=null,er=new Map,tr=new Map,nr=new Map,rr=new Map})))()}function ar(e,t=64){let n=String(e||``).trim();if(!n||!/^https?:\/\//i.test(n))return``;try{let e=new URL(n).hostname;return e?`https://www.google.com/s2/favicons?domain=${encodeURIComponent(e)}&sz=${t}`:``}catch{return``}}function or(e){let t=String(e||``).trim().toLowerCase();return t?t.includes(`/_favicon/`)||t.includes(`s2/favicons`)||t.includes(`favicon`)?!0:(t.startsWith(`android-icon:`),!1):!1}function sr(e){Dr=e}function cr(e){let t=e||(globalThis.chrome?.bookmarks??null);return!t?.getTree||!t?.getChildren?null:{resolveIconUrl:(e,t=128)=>{let n=String(e||``).trim();if(!/^https?:\/\//i.test(n))return``;let r=ar(n,t);if(r)return r;try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`){let r=new URL(e.getURL(`/_favicon/`));return r.searchParams.set(`pageUrl`,n),r.searchParams.set(`size`,String(t)),r.toString()}}catch{}return``},async listChildren(e){if(e)return(await kr(t,`getChildren`,e)||[]).map(Ar);let n=await kr(t,`getTree`)||[],r=[];for(let e of n)for(let t of e.children||[])r.push(Ar(t));return r},async search(e){let n=String(e||``).trim();if(!n)return this.listChildren();if(typeof t.search!=`function`){let e=await this.listChildren(),t=n.toLowerCase();return e.filter(e=>e.title.toLowerCase().includes(t)||String(e.url||``).toLowerCase().includes(t))}return(await kr(t,`search`,n)||[]).map(Ar)},async open(e){if(e.folder)return;let t=String(e.url||``).trim();if(t){try{let e=globalThis.chrome?.tabs;if(typeof e?.create==`function`){await Promise.resolve(e.create({url:t}));return}}catch{}globalThis.open?.(t,`_blank`,`noopener,noreferrer`)}}}}function lr(){return Dr||cr()}function ur(){return!!lr()}function dr(){try{let e=localStorage.getItem(Cr);if(!e)return[];let t=JSON.parse(e);return Array.isArray(t)?t.filter(e=>e&&e.id&&e.title).slice(0,Tr):[]}catch{return[]}}function fr(e){if(!e?.id||e.folder)return;let t=[e,...dr().filter(t=>t.id!==e.id)].slice(0,Tr);try{localStorage.setItem(Cr,JSON.stringify(t))}catch{}}function pr(){return jr(wr,Er)}function mr(e){return pr().some(t=>t.id===e)}function hr(e){if(!e?.id||e.folder||!String(e.url||``).trim())return!1;let t=[e,...pr().filter(t=>t.id!==e.id)].slice(0,Er);try{return localStorage.setItem(wr,JSON.stringify(t)),!0}catch{return!1}}function gr(e){let t=String(e||``).trim();if(!t)return!1;let n=pr().filter(e=>e.id!==t);try{return localStorage.setItem(wr,JSON.stringify(n)),!0}catch{return!1}}function _r(e,t=Mr){let n=String(e||``).trim();if(!n)return``;try{let e=new URL(n,globalThis.location?.href);if(e.searchParams.has(`pageUrl`))return e.searchParams.set(`size`,String(t)),e.toString();if(e.hostname.endsWith(`google.com`)&&e.pathname.includes(`favicon`))return e.searchParams.set(`sz`,String(t)),e.toString()}catch{}return n}function vr(e,t){let n=String(e.url||``).trim();return n&&(ar(n,Mr)||ar(n,128)||ar(n,64)||t?.resolveIconUrl?.(n,Mr)||t?.resolveIconUrl?.(n,128))||``}function yr(e,t,n,r=``){return xr(e,t,String(r||``).trim()||_r(vr(e,n),Mr))}function br(e,t=``){let n=String(e.url||``).trim();return JSON.stringify({state:{icon:e.folder?`folder`:`link`,label:e.title||n||`Bookmark`,action:e.folder?`open-path`:`open-link`},desc:{action:e.folder?`open-path`:`open-link`,href:e.folder?``:n,path:e.folder?`/bookmarks/${e.id}/`:`/bookmarks/${e.id}`,meta:{entityType:`bookmark`,bookmarkId:e.id,...t?{iconUrl:t}:{}}}})}function xr(e,t,n=``){if(e.folder||!String(e.url||``).trim())return null;let r=t??_e(),i=pe(br(e,n),r);return i?(xe(i),i):null}async function Sr(e,t,n){if(e.replaceChildren(),t.folder)return Nr(e,`folder`),e.toggleAttribute(`data-bookmark-bitmap`,!1),``;let r=String(t.url||``).trim(),i=[],a=ar(r,Mr);a&&i.push(a);let o=ar(r,128);o&&!i.includes(o)&&i.push(o);let s=ar(r,64);s&&!i.includes(s)&&i.push(s);let c=n?.resolveIconUrl?.(r,Mr)||``;c&&!i.includes(c)&&i.push(c);let l=n?.resolveIconUrl?.(r,128)||``;l&&!i.includes(l)&&i.push(l);let u=n?.resolveIconUrl?.(r,64)||``;u&&!i.includes(u)&&i.push(u);try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`&&r){let t=new URL(e.getURL(`/_favicon/`));t.searchParams.set(`pageUrl`,r),t.searchParams.set(`size`,String(Mr));let n=t.toString();n&&!i.includes(n)&&i.push(n)}}catch{}return Nr(e,`link`),e.toggleAttribute(`data-bookmark-bitmap`,!1),i.length?await new Promise(t=>{let n=0,r=()=>{if(n>=i.length){t(``);return}let a=i[n++],o=document.createElement(`img`);o.className=`env-shell-app-menu__tile-favicon`,o.alt=``,o.decoding=`async`,o.loading=`eager`,o.referrerPolicy=`no-referrer`,o.draggable=!1,o.addEventListener(`load`,()=>{e.replaceChildren(o),e.toggleAttribute(`data-bookmark-bitmap`,!0),t(a)},{once:!0}),o.addEventListener(`error`,()=>{r()},{once:!0}),o.src=a};r()}):``}var Cr,wr,Tr,Er,Dr,Or,kr,Ar,jr,Mr,Nr;function Pr(){return(Pr=e((()=>{ue(),Cr=`rs-app-menu-bookmark-recent`,wr=`rs-app-menu-bookmark-pinned`,Tr=12,Er=16,Dr=null,Or=()=>{try{let e=globalThis.chrome?.runtime?.lastError;return e?Error(String(e.message||e)):null}catch{return null}},kr=(e,t,...n)=>{let r=e[t];if(typeof r!=`function`)return Promise.reject(Error(`chrome.bookmarks.${String(t)} missing`));try{let t=r.apply(e,n);if(t!=null&&typeof t.then==`function`)return t}catch(e){return Promise.reject(e)}return new Promise((t,i)=>{try{r.apply(e,[...n,e=>{let n=Or();n?i(n):t(e)}])}catch(e){i(e)}})},Ar=e=>{let t=typeof e.url==`string`&&e.url?e.url:void 0;return{id:String(e.id),title:String(e.title||e.url||e.id||`Bookmark`),url:t,folder:!t,parentId:e.parentId}},jr=(e,t)=>{try{let n=localStorage.getItem(e);if(!n)return[];let r=JSON.parse(n);return Array.isArray(r)?r.filter(e=>e&&e.id&&e.title&&!e.folder).slice(0,t):[]}catch{return[]}},Mr=256,Nr=(e,t)=>{let n=document.createElement(`ui-icon`);n.setAttribute(`icon`,t),n.setAttribute(`icon-style`,`duotone`),n.setAttribute(`aria-hidden`,`true`),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`),n.style.setProperty(`--icon-color`,`currentColor`),n.style.color=`currentColor`,e.append(n),customElements.whenDefined(`ui-icon`).then(()=>{n.isConnected&&(n.getAttribute(`icon`)||n.setAttribute(`icon`,t),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`))})}})))()}function Fr(e){return e===`light`||e===`dark`?e:String(document.documentElement.getAttribute(`data-theme`)||``).toLowerCase()===`light`?`light`:`dark`}function Ir(e){let t=String(e||``).trim();return/^https?:\/\//i.test(t)?t:``}function Lr(e,t=128){try{let n=new URL(e).hostname;return n?`https://www.google.com/s2/favicons?domain=${encodeURIComponent(n)}&sz=${t}`:``}catch{return``}}function Rr(e,t=128){try{let n=globalThis.chrome?.runtime;if(typeof n?.getURL!=`function`)return``;let r=new URL(n.getURL(`/_favicon/`));return r.searchParams.set(`pageUrl`,e),r.searchParams.set(`size`,String(t)),r.toString()}catch{return``}}function zr(e,t){let n=Ir(e);if(!n)return[];let r=[],i=new Set,a=(e,t)=>{let n=String(t||``).trim();!n||i.has(n)||(i.add(n),r.push({label:e,url:n}))},o=t?.resolveIconUrl?.(n,128)||t?.resolveIconUrl?.(n,64)||``,s=Lr(n,128);s&&a(`Google S2`,s);let c=Lr(n,64);c&&a(`Google S2 (64)`,c);let l=Rr(n,128);return l&&a(`Chrome favicon`,l),o&&a(`Bookmark favicon`,o),r}function Br(e){Y(e,{display:`grid`,"grid-template-columns":Qr,gap:`0.5rem 0.4rem`,"align-content":`start`,"justify-content":`stretch`,"min-inline-size":`0`,"min-block-size":`0`,"inline-size":`100%`})}function Vr(e,t,n){Y(e,{display:`grid`,"grid-template-columns":`minmax(0, 1fr)`,"grid-template-rows":`auto max-content`,"justify-items":`center`,"align-content":`start`,"align-items":`start`,"flex-direction":`column`,gap:`0.3rem`,margin:`0`,padding:`0.2rem 0.08rem 0.15rem`,"min-inline-size":`0`,"inline-size":`100%`,"max-inline-size":`100%`,"block-size":`auto`,"min-block-size":`0`,background:`transparent`,border:`0`,"border-radius":`0.7rem`,"box-shadow":`none`,appearance:`none`,"-webkit-appearance":`none`,position:`static`,"z-index":`auto`,overflow:`hidden`}),Y(t,{display:`block`,"grid-row":`1`,"inline-size":`3rem`,"block-size":`3rem`,"max-inline-size":`3rem`,"max-block-size":`3rem`,"object-fit":`cover`,"border-radius":`50%`,"flex-shrink":`0`}),Y(n,{display:`block`,"grid-row":`2`,"inline-size":`100%`,"max-inline-size":`100%`,overflow:`hidden`,"text-overflow":`ellipsis`,"white-space":`nowrap`,"font-size":`0.62rem`,"line-height":`1.2`,"text-align":`center`,opacity:`0.88`})}function Hr(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`sd-icon-picker__card`,n.title=t||e;let r=document.createElement(`img`);r.alt=``,r.decoding=`async`,r.draggable=!1,r.referrerPolicy=`no-referrer`;let i=document.createElement(`span`);return i.className=`sd-icon-picker__card-label`,i.textContent=e,n.append(r,i),Vr(n,r,i),{btn:n,img:r}}async function Ur(e,t,n,r,i){n.replaceChildren();let a=Zr.map(e=>({...e,available:!0}));try{let n=await e.launcherIconVariants?.(t);Array.isArray(n)&&n.length&&(a=n.map(e=>({id:In(e.id),label:String(e.label||e.id),available:e.available!==!1})))}catch{}for(let e of a){if(!e.available&&e.id!=="default")continue;let{btn:a,img:o}=Hr(e.label);n.append(a),qn(t,96,e.id).then(t=>{if(!t){a.disabled=!0,a.title=`${e.label} (unavailable)`;return}o.src=t}),a.addEventListener(`click`,()=>{r({iconUrl:Rn(t,e.id),packageName:t,variant:e.id,label:e.label,source:`android`}),i()})}}async function Wr(e,t,n,r,i){if(n.replaceChildren(),n.classList.remove(`sd-icon-picker__grid--browse`),Br(n),!e.launcherIconPacks){n.textContent=`Icon packs unavailable.`;return}let a=[];try{a=await e.launcherIconPacks()}catch{n.textContent=`Failed to list icon packs.`;return}if(!a.length){n.textContent=`No icon packs installed.`;return}let o=document.createDocumentFragment();for(let s of a.slice(0,64)){let a=String(s.packageName||``).trim();if(!a)continue;let c=String(s.label||a),l=document.createElement(`div`);l.className=`sd-icon-picker__pack-wrap`,Y(l,{position:`relative`,"min-inline-size":`0`,"inline-size":`100%`});let{btn:u,img:d}=Hr(c,`${c} — tap to apply, grid to browse`);qn(t,96,`default`,a).then(e=>{if(e){d.src=e;return}u.disabled=!0,u.title=`${c} (no cover for this app)`,qn(a,72,`default`).then(e=>{e&&(d.src=e)})}),u.addEventListener(`click`,()=>{u.disabled||(r({iconUrl:Rn(t,`default`,a),packageName:t,variant:`default`,pack:a,label:c,source:`icon-pack`}),i())});let f=document.createElement(`button`);f.type=`button`,f.className=`sd-icon-picker__pack-browse`,Y(f,{position:`absolute`,"inset-block-start":`0`,"inset-inline-end":`0`,display:`grid`,"place-items":`center`,margin:`0`,padding:`0`,"inline-size":`1.2rem`,"block-size":`1.2rem`,"min-inline-size":`1.2rem`,"min-block-size":`1.2rem`,border:`0`,"border-radius":`999px`}),f.title=`Browse icons in ${c}`,f.setAttribute(`aria-label`,`Browse icons in ${c}`),f.innerHTML=`<ui-icon icon="squares-four" aria-hidden="true"></ui-icon>`,f.addEventListener(`click`,o=>{o.preventDefault(),o.stopPropagation(),n.dataset.packBrowse=`1`,Gr(e,t,a,c,n,r,i,()=>{delete n.dataset.packBrowse,Wr(e,t,n,r,i)})}),l.append(u,f),o.append(l)}n.append(o)}async function Gr(e,t,n,r,i,a,o,s){i.replaceChildren(),i.classList.add(`sd-icon-picker__grid--browse`),i.style.setProperty(`display`,`grid`,`important`),i.style.setProperty(`grid-template-columns`,`minmax(0, 1fr)`,`important`),i.style.setProperty(`grid-template-rows`,`auto minmax(0, 1fr)`,`important`),i.style.setProperty(`gap`,`0.35rem`,`important`);let c=document.createElement(`div`);c.className=`sd-icon-picker__pack-toolbar`;let l=document.createElement(`button`);l.type=`button`,l.className=`sd-icon-picker__pack-back`,l.textContent=`Packs`,l.addEventListener(`click`,()=>s());let u=document.createElement(`span`);u.className=`sd-icon-picker__pack-title`,u.textContent=r;let d=document.createElement(`input`);d.type=`search`,d.placeholder=`Filter…`,d.autocomplete=`off`,d.className=`sd-icon-picker__search`,c.append(l,u,d);let f=document.createElement(`div`);f.className=`sd-icon-picker__grid`,Br(f),i.append(c,f);let p=0,m=()=>{(async()=>{if(f.replaceChildren(),!e.launcherIconPackIcons){f.textContent=`Pack browse unavailable.`;return}let i=[];try{i=await e.launcherIconPackIcons(n,String(d.value||``),96)}catch{f.textContent=`Failed to list pack icons.`;return}if(!i.length){f.textContent=`No matching icons.`;return}let s=document.createDocumentFragment(),c=t||n;for(let e of i){let t=String(e.drawable||``).trim();if(!t)continue;let{btn:i,img:l}=Hr(String(e.label||t),`${r}: ${t}`);s.append(i),qn(c,72,`default`,n,t).then(e=>{e?l.src=e:i.disabled=!0}),i.addEventListener(`click`,()=>{i.disabled||(a({iconUrl:Rn(c,`default`,n,t),packageName:c,variant:`default`,pack:n,drawable:t,label:String(e.label||t),source:`icon-pack`}),o())})}f.append(s)})()};d.addEventListener(`input`,()=>{window.clearTimeout(p),p=window.setTimeout(m,160)}),m()}async function Kr(e,t,n,r,i){if(n.replaceChildren(),!e.launcherList){n.textContent=`App list unavailable.`;return}let a=[];try{a=await e.launcherList(t)}catch{n.textContent=`Failed to list apps.`;return}if(!a.length){n.textContent=t.trim()?`No matches.`:`No apps.`;return}let o=document.createDocumentFragment();for(let e of a.slice(0,96)){let t=String(e.packageName||``).trim();if(!t)continue;let{btn:n,img:a}=Hr(String(e.label||t),`${e.label} (${t})`);o.append(n),qn(String(e.iconCacheKey||t).trim()||t,72,`default`).then(e=>{e&&(a.src=e)}),n.addEventListener(`click`,()=>{r({iconUrl:Rn(t,`default`),packageName:t,variant:`default`,label:String(e.label||t),source:`android`}),i()})}n.append(o)}function qr(e,t,n,r,i){n.replaceChildren();let a=zr(e,t);if(!a.length){n.textContent=`No favicon sources for this URL.`;return}for(let e of a){let{btn:t,img:a}=Hr(e.label,e.url);a.src=e.url,a.addEventListener(`error`,()=>{t.disabled=!0,t.title=`${e.label} (failed to load)`}),t.addEventListener(`click`,()=>{r({iconUrl:e.url,label:e.label,source:`favicon`}),i()}),n.append(t)}}async function Jr(e,t,n,r,i){n.replaceChildren();let a=[];try{let n=String(t||``).trim();a=n?await e.search(n):await e.listChildren()}catch{n.textContent=`Failed to list bookmarks.`;return}let o=a.filter(e=>!e.folder&&Ir(e.url));if(!o.length){n.textContent=t.trim()?`No matching bookmarks.`:`No bookmarks.`;return}let s=document.createDocumentFragment();for(let t of o.slice(0,80)){let n=Ir(t.url);if(!n)continue;let a=e.resolveIconUrl?.(n,64)||Rr(n,64)||Lr(n,64),{btn:o,img:c}=Hr(String(t.title||n),n);a&&(c.src=a),s.append(o),o.addEventListener(`click`,()=>{let o=e.resolveIconUrl?.(n,128)||Rr(n,128)||Lr(n,128)||a;o&&(r({iconUrl:o,label:String(t.title||n),source:`bookmark`}),i())})}n.append(s)}async function Yr(e){let t=await Zn(),n=lr(),r=!!t?.launcherIcon,i=Ir(e.pageUrl)||Ir(e.currentUrl)||``;if(!r&&!(n||i)){console.warn(`[icon-resource-picker] no launcher bridge or bookmarks/favicon source`);return}let a=Fr(e.theme),o=String(e.packageName||``).trim(),s=r&&!!o,c=r&&!!o&&!!t?.launcherIconPacks,l=r&&!!t?.launcherList,u=!!i,d=!!n,f=[];s&&f.push({id:`variants`,label:`This app`}),c&&f.push({id:`packs`,label:`Packs`}),u&&f.push({id:`favicon`,label:`Link`}),l&&f.push({id:`browse`,label:`Apps`}),d&&f.push({id:`bookmarks`,label:`Bookmarks`});let p=f[0]?.id||`browse`,m=document.createElement(`dialog`);m.className=`sd-icon-picker`,m.dataset.theme=a,m.dataset.tab=p,m.innerHTML=`
    ...
    `,Y(m,{position:`fixed`,inset:`0`,top:`0`,right:`0`,bottom:`0`,left:`0`,width:`100%`,height:`100%`,"inline-size":`100%`,"block-size":`100%`,"max-inline-size":`100%`,"max-block-size":`100%`,"max-width":`100%`,"max-height":`100%`,margin:`0`,padding:`1rem`,display:`grid`,"place-items":`center`,"place-content":`center`,background:`transparent`,border:`none`,"border-radius":`0`,"box-shadow":`none`,overflow:`auto`});let h=m.querySelector(`.sd-icon-picker__form`);h&&Y(h,{display:`flex`,"flex-direction":`column`,"inline-size":`min(90cqi, 100dvi)`,width:`min(90cqi, 100dvi)`,"max-inline-size":`100%`,"max-block-size":`min(86dvh, 36rem)`,margin:`0`,padding:`0`,"border-radius":`18px`,overflow:`hidden`,"justify-self":`center`,"align-self":`center`,background:`color-mix(in oklab, var(--color-surface-container, Canvas) 92%, transparent)`});let g=m.querySelector(`.sd-icon-picker__tabs`);g&&Y(g,{display:`grid`,"grid-auto-flow":`column`,"grid-auto-columns":`1fr`,gap:`0.28rem`,"inline-size":`100%`});let _=m.querySelector(`.sd-icon-picker__body`);_&&Y(_,{display:`block`,padding:`0.65rem 0.85rem 0.45rem`,"min-block-size":`0`,"max-block-size":`min(26rem, 52dvh)`,overflow:`auto`,background:`transparent`});let v=m.querySelector(`.sd-icon-picker__footer`);v&&Y(v,{display:`flex`,"justify-content":`flex-end`,"align-items":`center`,gap:`0.45rem`,padding:`0.55rem 0.85rem 0.7rem`});let y=m.querySelector(`.sd-icon-picker__cancel`);y&&Y(y,{display:`inline-flex`,"align-items":`center`,"justify-content":`center`,flex:`0 0 auto`,margin:`0`,padding:`0.42rem 0.86rem`,"inline-size":`auto`,width:`auto`,"min-inline-size":`0`,"max-inline-size":`none`,"border-radius":`0.65rem`});let b=m.querySelector(`form`),x=m.querySelector(`.sd-icon-picker__tabs`),S=m.querySelector(`[data-search]`),C=m.querySelector(`[data-variants]`),w=m.querySelector(`[data-packs]`),T=m.querySelector(`[data-favicon]`),E=m.querySelector(`[data-browse]`),D=m.querySelector(`[data-bookmarks]`),O=!1,k=()=>{if(!O){O=!0;try{m.open&&m.close()}catch{}m.remove()}},A=t=>{e.onPick(t)};b.addEventListener(`click`,e=>{e.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`)===`cancel`&&(e.preventDefault(),k())}),m.addEventListener(`cancel`,e=>{e.preventDefault(),k()}),m.addEventListener(`click`,e=>{e.target===m&&k()});let j=e=>{m.dataset.tab=e,m.querySelectorAll(`[data-section]`).forEach(t=>{t.hidden=t.dataset.section!==e}),x?.querySelectorAll(`[data-tab]`).forEach(t=>{let n=t.dataset.tab===e;t.toggleAttribute(`data-active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`),t.tabIndex=n?0:-1});let n=e===`browse`||e===`bookmarks`;S&&(S.hidden=!n,S.placeholder=e===`bookmarks`?`Search bookmarks…`:`Search apps…`,n&&(S.value=``)),e===`packs`&&w?.dataset.packBrowse===`1`&&t&&o&&(delete w.dataset.packBrowse,Wr(t,o,w,A,k))};if(x){let e=document.createDocumentFragment();for(let t of f){let n=document.createElement(`button`);n.type=`button`,n.className=`sd-icon-picker__tab`,n.dataset.tab=t.id,n.setAttribute(`role`,`tab`),n.textContent=t.label,Y(n,{display:`inline-flex`,flex:`1 1 0`,"align-items":`center`,"justify-content":`center`,margin:`0`,padding:`0.38rem 0.4rem`,border:`0`,"border-radius":`999px`,"inline-size":`100%`,"min-inline-size":`0`,"block-size":`auto`}),n.addEventListener(`click`,e=>{e.preventDefault(),j(t.id)}),e.append(n)}x.append(e),x.hidden=f.length<=1}s&&t&&C&&Ur(t,o,C,A,k),c&&t&&w&&o&&Wr(t,o,w,A,k),u&&T&&qr(i,n,T,A,k);let M=0,N=()=>{!E||!t||Kr(t,String(S?.value||``),E,A,k)},P=0,ee=()=>{!D||!n||Jr(n,String(S?.value||``),D,A,k)};S?.addEventListener(`input`,()=>{let e=m.dataset.tab;if(e===`browse`){window.clearTimeout(M),M=window.setTimeout(N,180);return}e===`bookmarks`&&(window.clearTimeout(P),P=window.setTimeout(ee,180))}),l&&N(),d&&n&&ee(),x?.addEventListener(`click`,e=>{let t=e.target?.closest?.(`[data-tab]`)?.getAttribute(`data-tab`);t===`browse`&&N(),t===`bookmarks`&&ee()}),j(p),document.body.append(m),m.querySelectorAll(`.sd-icon-picker__grid`).forEach(Br);try{m.showModal()}catch{m.setAttribute(`open`,``)}}function Xr(e,t,n){let r=e.querySelector(`.sd-icon-resource-row`);r||(r=document.createElement(`div`),r.className=`sd-icon-resource-row`,t.replaceWith(r),r.append(t)),r.style.setProperty(`display`,`grid`,`important`),r.style.setProperty(`grid-template-columns`,`minmax(0,1fr) 2.5rem 2.5rem`,`important`),r.style.setProperty(`align-items`,`stretch`,`important`),r.style.setProperty(`gap`,`0.45rem`,`important`),r.style.setProperty(`min-inline-size`,`0`,`important`),r.style.setProperty(`inline-size`,`100%`,`important`);let i=r.querySelector(`[data-action='pick-icon']`);i||(i=document.createElement(`button`),i.type=`button`,i.className=`btn secondary sd-icon-resource-pick`,i.setAttribute(`data-action`,`pick-icon`),i.title=`Pick alternative icon`,i.setAttribute(`aria-label`,`Pick alternative icon`),i.innerHTML=`<ui-icon icon="squares-four" icon-style="duotone" aria-hidden="true"></ui-icon>`,r.append(i));let a=r.querySelector(`[data-action='pick-photo']`);a||(a=document.createElement(`button`),a.type=`button`,a.className=`btn secondary sd-icon-resource-pick`,a.setAttribute(`data-action`,`pick-photo`),a.title=`Use photo / avatar`,a.setAttribute(`aria-label`,`Use photo or avatar`),a.innerHTML=`<ui-icon icon="user-circle" icon-style="duotone" aria-hidden="true"></ui-icon>`,r.append(a)),t.parentElement!==r&&r.insertBefore(t,i),i.parentElement===r&&a.parentElement===r&&(r.append(i,a),r.insertBefore(t,i));let o=e=>{e.style.setProperty(`display`,`inline-flex`,`important`),e.style.setProperty(`align-items`,`center`,`important`),e.style.setProperty(`justify-content`,`center`,`important`),e.style.setProperty(`inline-size`,`2.5rem`,`important`),e.style.setProperty(`min-inline-size`,`2.5rem`,`important`),e.style.setProperty(`max-inline-size`,`2.5rem`,`important`),e.style.setProperty(`min-block-size`,`2.5rem`,`important`),e.style.setProperty(`padding`,`0`,`important`),e.style.setProperty(`margin`,`0`,`important`)};return o(i),o(a),i.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),Yr({packageName:typeof n.packageName==`function`?n.packageName():String(n.packageName||``).trim(),pageUrl:typeof n.pageUrl==`function`?n.pageUrl():String(n.pageUrl||``).trim(),currentUrl:t.value,theme:n.theme,onPick:e=>{t.value=e.iconUrl,t.setAttribute(`value`,e.iconUrl),t.dispatchEvent(new Event(`input`,{bubbles:!0})),t.dispatchEvent(new Event(`change`,{bubbles:!0}))}})}),a.addEventListener(`click`,n=>{n.preventDefault(),n.stopPropagation();let r=document.createElement(`input`);r.type=`file`,r.accept=`image/*`,r.style.display=`none`,document.body.append(r),r.addEventListener(`change`,()=>{let n=r.files?.[0];if(r.remove(),!n)return;let i=new FileReader;i.onload=()=>{let n=String(i.result||``).trim();if(!n.startsWith(`data:image/`))return;t.value=n,t.setAttribute(`value`,n),t.dispatchEvent(new Event(`input`,{bubbles:!0})),t.dispatchEvent(new Event(`change`,{bubbles:!0}));let r=e.closest(`form`)?.querySelector(`select[name="iconDisplay"]`);r&&(r.value=`colored`,r.dispatchEvent(new Event(`change`,{bubbles:!0})))},i.readAsDataURL(n)},{once:!0}),r.click()}),i}var Zr,Qr,Y;function $r(){return($r=e((()=>{ir(),Hn(),Pr(),Zr=[{id:`default`,label:`Default`},{id:`monochrome`,label:`Material You`},{id:`foreground`,label:`Adaptive FG`}],Qr=`repeat(auto-fill, minmax(4.75rem, 1fr))`,Y=(e,t)=>{for(let[n,r]of Object.entries(t))e.style.setProperty(n,r,`important`)}})))()}function ei(){if(X)return X;try{let e=localStorage.getItem(ci);if(!e)return X={},X;let t=JSON.parse(e);X=t&&typeof t==`object`?t:{}}catch{X={}}return X}function ti(e){X=e;try{localStorage.setItem(ci,JSON.stringify(e))}catch{}}function ni(e){return`app:${String(e||``).trim()}`}function ri(e){return`bm:${String(e||``).trim()}`}function ii(e){let t=String(e||``).trim();return t?{...ei()[t]||{}}:{}}function ai(e,t){let n=String(e||``).trim();if(!n)return{};let r={...ei()},i={...r[n]||{},...t};return i.shape&&=F(i.shape,`circle`),i.iconDisplay&&=I(i.iconDisplay)||`colored`,i.iconScale!=null&&(i.iconScale=ve(i.iconScale)),r[n]=i,ti(r),i}function oi(e){let t=String(e||``).trim();if(!t)return;let n={...ei()};delete n[t],ti(n)}function si(e){let t={...e.defaults||{},...e.initial||{},...ii(e.key)},n=String(t.iconUrl||``).trim(),r=n.startsWith(`blob:`)?``:n,i=document.createElement(`dialog`);i.className=`speed-dial-editor env-shell-app-menu__chrome-editor`,i.innerHTML=`
            ...
            <div class="modal-fields">
                <div class="modal-field">
                    ...
                    <select id="am-chrome-shape" name="shape">
                        ${De.map(e=>`<option value="${e.value}"${F(t.shape,`circle`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-display">Icon display</label>
                    <select id="am-chrome-display" name="iconDisplay">
                        ${ce.map(e=>`<option value="${e.value}"${(I(t.iconDisplay)||`colored`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-icon-scale">Icon scale (inside plate)</label>
                    <select id="am-chrome-icon-scale" name="iconScale">
                        ${Ce.map(e=>`<option value="${e.value}"${ve(t.iconScale)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
    ...
    `;let a=i.querySelector(`form`),o=a?.querySelector(`.modal-actions`);o&&(o.style.setProperty(`display`,`grid`,`important`),o.style.setProperty(`grid-template-columns`,`1fr auto auto`,`important`),o.style.setProperty(`align-items`,`center`,`important`),o.style.setProperty(`gap`,`0.45rem`,`important`));let s=i.querySelector(`select[name="shape"]`),c=i.querySelector(`select[name="iconDisplay"]`),l=i.querySelector(`select[name="iconScale"]`),u=i.querySelector(`input[name="icon"]`),d=i.querySelector(`input[name="iconUrl"]`),f=i.querySelector(`[data-field="glyph"]`),p=i.querySelector(`[data-field="url"]`),m=String(e.packageName||``).trim()||(e.key.startsWith(`app:`)?e.key.slice(4):``),h=String(e.pageUrl||``).trim();p&&d&&Xr(p,d,{packageName:m,pageUrl:h});let g=()=>{let e=I(c?.value)||`colored`;f&&(e===`glyph`?f.removeAttribute(`hidden`):f.setAttribute(`hidden`,``)),p&&(e===`glyph`?p.setAttribute(`hidden`,``):p.removeAttribute(`hidden`))};c?.addEventListener(`change`,g),g();let _=()=>{try{i.open&&i.close()}catch{}i.remove()};a?.addEventListener(`click`,t=>{let n=t.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`);n===`cancel`&&(t.preventDefault(),_()),n===`reset`&&(t.preventDefault(),oi(e.key),e.onSave({}),_())}),a?.addEventListener(`submit`,t=>{t.preventDefault();let n=String(d?.value||``).trim(),r={shape:F(s?.value,`circle`),iconDisplay:I(c?.value)||`colored`,iconScale:ve(l?.value),icon:String(u?.value||``).trim(),iconUrl:n.startsWith(`blob:`)?``:n};ai(e.key,r),e.onSave(r),_()}),i.addEventListener(`cancel`,e=>{e.preventDefault(),_()}),document.body.append(i);try{i.showModal()}catch{i.setAttribute(`open`,``)}}var ci,X;function li(){return(li=e((()=>{ae(),ue(),$r(),ci=`cwsp-app-menu-tile-chrome-v1`,X=null})))()}var ui;function di(){return(di=e((()=>{ui=`@layer ui-app-menu {
...
}`})))()}function fi(){return document.documentElement.dataset.cwspShellRole===`launcher`||globalThis.__RS_SHELL_ROLE__===`launcher`}function pi(){return fi()||ur()}function mi(){return fi()?`launcher`:ur()?`bookmarks`:null}async function hi(){if(Ai)return Ai;try{return await c(()=>import(`./launcher-bridge-C3JnBhTN.js`),[],import.meta.url)}catch{return null}}function gi(){if(!Di){Di=!0;try{document.adoptedStyleSheets=[...document.adoptedStyleSheets,Ei]}catch{}}}function _i(){return document.querySelector(`.env-shell-root`)||document.querySelector(`env-shell-container`)||document.querySelector(`.env-shell-chrome`)?.parentElement||document.body}function vi(e,t){let n=document.createElement(`div`);n.className=`env-shell-app-menu__drag-ghost`,n.setAttribute(`aria-hidden`,`true`);let r=e.cloneNode(!0);r.className=`env-shell-app-menu__drag-ghost-icon ui-ws-item-icon shaped`,r.setAttribute(`data-shape`,F(e.getAttribute(`data-shape`),`circle`));let i=document.createElement(`span`);return i.className=`env-shell-app-menu__drag-ghost-label`,i.textContent=t,n.append(r,i),n}function yi(e,t){let n=F(t.chrome.shape,ji);e.setAttribute(`data-shape`,n),e.classList.add(`ui-ws-item-icon`,`shaped`);let r=String(t.chrome.iconUrl||``).trim()||String(t.resourceUrl||``).trim(),i=Oe(t.chrome.iconScale),a=Ln(r)?Yn(r,i):``,o=String(a||(Ln(r)?``:r)||``).trim(),s=I(t.chrome.iconDisplay)||Ee({iconDisplay:t.chrome.iconDisplay,iconUrl:o||r,isLauncherApp:!!t.launcher,isBookmarkFavicon:!!(o||r)&&!t.launcher});e.setAttribute(`data-icon-display`,s),se(e,ee(s,t.chrome.iconScale)),e.replaceChildren();let c=()=>{me(e),L(e)};if(s===`glyph`){let n=String(t.chrome.icon||t.fallbackGlyph||`device-mobile`).trim()||`device-mobile`,r=document.createElement(`ui-icon`);r.setAttribute(`icon`,n),r.setAttribute(`icon-style`,`duotone`),r.setAttribute(`aria-hidden`,`true`),e.append(r),c();return}if(s===`colored`){let n=document.createElement(`img`);n.className=t.launcher?`ui-ws-item-icon-img`:`ui-ws-item-icon-img env-shell-app-menu__tile-favicon`,n.alt=``,n.decoding=`async`,n.draggable=!1,n.referrerPolicy=`no-referrer`,!t.launcher&&(or(o)||or(r))?n.toggleAttribute(`data-bookmark-favicon`,!0):t.launcher&&n.toggleAttribute(`data-launcher-icon`,!0),o?n.src=o:n.toggleAttribute(`data-icon-pending`,!0),e.append(n),c(),Ln(r)&&Jn(r,i).then(e=>{!e||!n.isConnected||(n.src=e,n.removeAttribute(`data-icon-pending`),c())});return}let l=ie({display:s,glyph:String(t.chrome.icon||t.fallbackGlyph||`device-mobile`),resourceUrl:o||void 0,launcher:t.launcher,className:`ui-ws-item-icon-native`});e.append(l),c(),t.launcher&&o&&s!==`glyph`&&(Qn(l,o,s),c()),Ln(r)&&Jn(r,i).then(e=>{!e||!l.isConnected||(Qn(l,e,s),c())})}function bi(e,t,n,r){let i=()=>Se(t),a=typeof window<`u`&&(window.matchMedia?.(`(pointer: coarse)`)?.matches||`ontouchstart`in window);e.draggable=!a,a||(e.addEventListener(`dragstart`,e=>{let t=i();if(e.dataTransfer?.setData(`text/plain`,t),e.dataTransfer?.setData(`application/json`,t),e.dataTransfer){e.dataTransfer.effectAllowed=`copy`;try{e.dataTransfer.setDragImage(n,24,24)}catch{}}document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0)}),e.addEventListener(`dragend`,()=>{document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1)}));let o,s=null,c=0,l=0,u=!1,d=!1,f=!1,p=null,m=()=>{o&&=(clearTimeout(o),void 0)},h=()=>{if(m(),u=!1,d&&(d=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),p?.remove(),p=null,s!=null)){try{e.releasePointerCapture(s)}catch{}s=null}},g=(r,i,a)=>{if(!d){u=!1,d=!0,f=!0,e.classList.add(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0),p=vi(n,t.label),document.body.appendChild(p),p.style.transform=`translate(${r}px, ${i}px) translate(-50%, -50%)`;try{e.setPointerCapture(a)}catch{}}},_=(e,t)=>{p&&(p.style.transform=`translate(${e}px, ${t}px) translate(-50%, -50%)`)},v=(e,n)=>{if(!de(e,n))return;let i=oe(e,n);fe(t,i??void 0)&&(Fn(`Pinned ${t.label} to desktop`),r.onPinned?.())},y=t=>{if(d){if(d=!1,u=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),p?.remove(),p=null,s!=null){try{e.releasePointerCapture(s)}catch{}s=null}v(t.clientX,t.clientY)}};e.addEventListener(`pointerdown`,e=>{e.button===0&&(m(),s=e.pointerId,c=e.clientX,l=e.clientY,f=!1,d=!1,u=!1,o=setTimeout(()=>{o=void 0,u=!0,f=!0},Oi))},{passive:!0}),e.addEventListener(`pointermove`,e=>{if(o&&!d&&!u){let t=e.clientX-c,n=e.clientY-l;Math.hypot(t,n)>ki&&m();return}if(u&&!d){let t=e.clientX-c,n=e.clientY-l;Math.hypot(t,n)>ki&&g(e.clientX,e.clientY,e.pointerId);return}d&&(_(e.clientX,e.clientY),e.preventDefault())},{passive:!1}),e.addEventListener(`pointerup`,e=>{if(m(),u=!1,d){y(e);return}}),e.addEventListener(`pointercancel`,e=>{m(),u=!1,d&&y(e)}),e.addEventListener(`contextmenu`,()=>{h()},!0),e.addEventListener(`click`,e=>{f&&=(e.preventDefault(),e.stopPropagation(),!1)},!0)}function xi(e,t,n,r,i){let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-app-menu__tile`,a.setAttribute(`data-package`,e.packageName),a.title=`${e.label} — right-click: desktop; hold and drag`;let o=ni(e.packageName),s=document.createElement(`span`);s.className=`env-shell-app-menu__tile-icon ui-ws-item-icon shaped`;let c=document.createElement(`span`);c.className=`env-shell-app-menu__tile-label`,c.textContent=e.label,a.append(s,c);let l=e.iconCacheKey||e.packageName,u=(e=``)=>{yi(s,{chrome:ii(o),fallbackGlyph:`device-mobile`,resourceUrl:e,launcher:!0})},d=Oe(ii(o).iconScale);return u(Wn(l,d)),qn(l,d).then(e=>{n===r()&&e&&u(e)}).catch(()=>{}),bi(a,e,s,i),a.addEventListener(`contextmenu`,n=>{n.preventDefault(),n.stopPropagation(),Nn({x:n.clientX,y:n.clientY,compact:!0,items:[{id:`place-desktop`,label:`Place on desktop`,icon:`desktop`,action:()=>{fe(e)&&(Fn(`Placed “${e.label}” on desktop`),i.onPinned?.())}},{id:`icon-design`,label:`Icon design…`,icon:`palette`,action:()=>{si({title:e.label,key:o,packageName:e.packageName,defaults:{shape:ji,iconDisplay:`colored`},onSave:e=>{let t={...ii(o),...e},n=Oe(t.iconScale),r=(e=``)=>{yi(s,{chrome:t,fallbackGlyph:`device-mobile`,resourceUrl:e,launcher:!0})};r(Wn(l,n)||(Ln(String(t.iconUrl||``))?``:String(t.iconUrl||``).trim())),Ln(String(t.iconUrl||``))?Jn(t.iconUrl,n).then(e=>{e&&r(e)}):qn(l,n).then(e=>{e&&r(e)})}})}},{id:`launch`,label:`Open`,icon:`arrow-square-out`,action:async()=>{try{await t.launcherLaunch(e.packageName,e.componentName)}catch{}}}]})}),a.addEventListener(`click`,async n=>{n.preventDefault(),n.stopPropagation();try{await t.launcherLaunch(e.packageName,e.componentName)}catch{}}),a}function Si(e,t,n,r,i){if(t.folder||!String(t.url||``).trim())return;let a,o=!1,s=!1,c=0,l=0,u=-1,d=null,f=()=>{a!=null&&(clearTimeout(a),a=void 0)},p=()=>{if(f(),o=!1,s){s=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),d?.remove(),d=null;try{e.releasePointerCapture?.(u)}catch{}}},m=(r,i)=>{if(!s){o=!1,s=!0,e.classList.add(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0),d=vi(n,t.title),document.body.appendChild(d),d.style.transform=`translate(${r}px, ${i}px) translate(-50%, -50%)`;try{e.setPointerCapture?.(u)}catch{}}},h=(n,a)=>{if(f(),o=!1,s){s=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),d?.remove(),d=null;try{e.releasePointerCapture?.(u)}catch{}if(de(n,a)){let e=oe(n,a)??void 0,o=String(r.current||``).trim()||vr(t,lr());yr(t,e,lr(),o)&&(Fn(`Placed “${t.title}” on desktop`),i.onPinned?.())}}};e.addEventListener(`pointerdown`,e=>{(e.button==null||e.button===0)&&(c=e.clientX,l=e.clientY,u=e.pointerId,s=!1,o=!1,f(),a=setTimeout(()=>{a=void 0,o=!0},Oi))}),e.addEventListener(`pointermove`,e=>{if(!s&&!o){if(a==null)return;let t=e.clientX-c,n=e.clientY-l;t*t+n*n>100&&f();return}if(o&&!s){let t=e.clientX-c,n=e.clientY-l;t*t+n*n>100&&m(e.clientX,e.clientY);return}d&&(d.style.transform=`translate(${e.clientX}px, ${e.clientY}px) translate(-50%, -50%)`,e.preventDefault())},{passive:!1}),e.addEventListener(`pointerup`,e=>h(e.clientX,e.clientY)),e.addEventListener(`pointercancel`,e=>h(e.clientX,e.clientY)),e.addEventListener(`contextmenu`,()=>p(),!0)}function Ci(e,t,n,r,i){e.addEventListener(`contextmenu`,a=>{if(a.preventDefault(),a.stopPropagation(),t.folder){Nn({x:a.clientX,y:a.clientY,compact:!0,items:[{id:`open-folder`,label:`Open folder`,icon:`folder-open`,action:()=>{e.click()}}]});return}let o=mr(t.id);Nn({x:a.clientX,y:a.clientY,compact:!0,items:[{id:`place-desktop`,label:`Place on desktop`,icon:`desktop`,action:()=>{yr(t,void 0,n,String(r.current||``).trim()||vr(t,n))&&(Fn(`Placed “${t.title}” on desktop`),i.onPinned?.())}},{id:`icon-design`,label:`Icon design…`,icon:`palette`,action:()=>{let i=ri(t.id);si({title:t.title,key:i,pageUrl:String(t.url||``).trim(),defaults:{shape:ji,iconDisplay:`colored`},onSave:a=>{let o=e.querySelector(`.env-shell-app-menu__tile-icon`);if(!o)return;let s={...ii(i),...a},c=String(s.iconUrl||``).trim()||String(r.current||``).trim()||vr(t,n);yi(o,{chrome:s,fallbackGlyph:t.folder?`folder`:`link`,resourceUrl:c}),c&&(r.current=c)}})}},o?{id:`unpin-start`,label:`Unpin from Start`,icon:`push-pin-slash`,action:()=>{gr(t.id)&&(Fn(`Unpinned “${t.title}”`),i.onStartPinsChanged?.())}}:{id:`pin-start`,label:`Pin to Start`,icon:`push-pin`,action:()=>{hr(t)&&(Fn(`Pinned “${t.title}” to Start`),i.onStartPinsChanged?.())}},{id:`open`,label:`Open`,icon:`arrow-square-out`,action:async()=>{fr(t);try{await n.open(t)}catch{}}}]})})}function wi(e,t,n,r){let i=document.createElement(`button`);i.type=`button`,i.className=`env-shell-app-menu__tile`,i.setAttribute(`data-bookmark-id`,e.id),e.folder&&i.setAttribute(`data-folder`,``),i.title=e.folder?`${e.title} — open folder`:`${e.title} — right-click: desktop / pin; hold to drag`;let a=ri(e.id),o=document.createElement(`span`);o.className=`env-shell-app-menu__tile-icon ui-ws-item-icon shaped`,o.setAttribute(`data-shape`,ji);let s=document.createElement(`span`);s.className=`env-shell-app-menu__tile-label`,s.textContent=e.title,i.append(o,s);let c={current:``},l=t=>{let n=ii(a);if(n.shape||n.iconDisplay||n.icon||n.iconUrl){yi(o,{chrome:n,fallbackGlyph:e.folder?`folder`:`link`,resourceUrl:String(n.iconUrl||t||``).trim()});return}o.setAttribute(`data-shape`,ji)};return Sr(o,e,t).then(e=>{c.current=e,l(e)}),Si(i,e,o,c,n),Ci(i,e,t,c,n),i.addEventListener(`click`,async n=>{if(n.preventDefault(),n.stopPropagation(),!document.documentElement.hasAttribute(`data-app-menu-dragging`)){if(e.folder){r(e.id,e.title);return}fr(e);try{await t.open(e)}catch{}}}),i}function Ti(){gi();let e=mi(),t=document.createElement(`div`);t.className=`env-shell-app-menu`,t.hidden=!0,t.setAttribute(`role`,`dialog`),t.setAttribute(`aria-modal`,`false`),t.setAttribute(`aria-label`,e===`bookmarks`?`Bookmarks`:`Apps`),e&&t.setAttribute(`data-menu-mode`,e);let n=()=>{try{let e=document.documentElement,n=(e.getAttribute(`data-theme`)||``).toLowerCase(),r=(e.style.colorScheme||``).trim().toLowerCase(),i=n===`light`||n===`dark`?n:r===`light`||r===`dark`?r:``;if(i===`light`||i===`dark`){t.dataset.theme=i,t.style.colorScheme=i;return}delete t.dataset.theme,t.style.colorScheme=`inherit`}catch{}};n();let r=()=>n();document.addEventListener(`u2-theme-change`,r);let i=new MutationObserver(r);try{i.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`data-scheme`,`style`]})}catch{}let a=document.createElement(`div`);a.className=`env-shell-app-menu__panel`,e===`bookmarks`&&a.setAttribute(`data-layout`,`start-split`);let o=document.createElement(`div`);o.className=`env-shell-app-menu__banner`,o.hidden=!0;let s=document.createElement(`p`);s.className=`env-shell-app-menu__banner-text`,s.textContent=`Set CWSP Launcher as Home`;let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-app-menu__banner-action btn`,c.textContent=`Set as default`,o.append(s,c);let l=document.createElement(`input`);l.type=`search`,l.className=`env-shell-app-menu__search`,l.placeholder=e===`bookmarks`?`Search bookmarks`:`Search apps`,l.autocomplete=`off`,l.setAttribute(`aria-label`,e===`bookmarks`?`Search bookmarks`:`Search apps`);let u=document.createElement(`div`);u.className=`env-shell-app-menu__start-body`,u.hidden=e!==`bookmarks`;let d=document.createElement(`div`);d.className=`env-shell-app-menu__start-left`,d.setAttribute(`aria-label`,`Pinned and recent bookmarks`);let f=document.createElement(`div`);f.className=`env-shell-app-menu__start-heading`,f.textContent=`Pinned`;let p=document.createElement(`div`);p.className=`env-shell-app-menu__start-recent env-shell-app-menu__start-pinned`;let m=document.createElement(`div`);m.className=`env-shell-app-menu__start-heading`,m.textContent=`Recent`;let h=document.createElement(`div`);h.className=`env-shell-app-menu__start-recent`,d.append(f,p,m,h);let g=document.createElement(`div`);g.className=`env-shell-app-menu__start-right`;let _=document.createElement(`div`);_.className=`env-shell-app-menu__crumb`;let v=document.createElement(`div`);v.className=`env-shell-app-menu__grid`,v.setAttribute(`data-part`,`grid`),v.setAttribute(`aria-label`,e===`bookmarks`?`Bookmarks`:`Installed apps`),g.append(_,v),u.append(d,g),e===`bookmarks`?a.append(o,l,u):a.append(o,l,v),t.appendChild(a),_i().appendChild(t);let y=!1,b=0,x=``,S,C=[],w=()=>{if(!pi()){t.hidden=!0,t.toggleAttribute(`data-open`,!1);return}t.hidden=!y,t.toggleAttribute(`data-open`,y)},T=()=>{y&&(y=!1,t.toggleAttribute(`data-page`,!1),w(),t.dispatchEvent(new CustomEvent(`env-app-menu-close`,{bubbles:!0})))};t.addEventListener(`env-app-menu-request-close`,e=>{e.stopPropagation(),T()});let E=()=>{pi()&&(n(),y=!0,w(),P(),t.dispatchEvent(new CustomEvent(`env-app-menu-open`,{bubbles:!0})))},D=()=>{t.toggleAttribute(`data-page`,!0),E()},O=()=>{y?T():E()},k={onPinned:()=>{T()},onStartPinsChanged:()=>{P()}},A=()=>{if(_.replaceChildren(),e!==`bookmarks`)return;let t=document.createElement(`button`);t.type=`button`,t.className=`env-shell-app-menu__crumb-item`,t.textContent=`Bookmarks`,t.addEventListener(`click`,()=>{C=[],P()}),_.appendChild(t),C.forEach((e,t)=>{let n=document.createElement(`span`);n.className=`env-shell-app-menu__crumb-sep`,n.textContent=`›`;let r=document.createElement(`button`);r.type=`button`,r.className=`env-shell-app-menu__crumb-item`,r.textContent=e.title,r.addEventListener(`click`,()=>{C=C.slice(0,t+1),P()}),_.append(n,r)})},j=async(e,t)=>{let n=[];try{n=await e.launcherList(x||void 0)}catch{n=[]}if(t!==b)return;if(v.replaceChildren(),n.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty`,e.textContent=x?`No matching apps`:`No apps found`,v.appendChild(e);return}let r=document.createDocumentFragment();for(let i of n)r.appendChild(xi(i,e,t,()=>b,k));v.appendChild(r)},M=(e,t)=>{C.push({id:e,title:t}),x=``,l.value=``,P()},N=async(e,t)=>{A();let n=(t,n,r)=>{if(t.replaceChildren(),n.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty env-shell-app-menu__empty--compact`,e.textContent=r,t.appendChild(e);return}for(let r of n)t.appendChild(wi(r,e,k,M))};n(p,pr(),`No pinned bookmarks`),n(h,dr(),`No recent bookmarks`);let r=[];try{if(x)r=await e.search(x);else{let t=C.length?C[C.length-1].id:void 0;r=await e.listChildren(t)}}catch{r=[]}if(t!==b)return;if(v.replaceChildren(),r.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty`,e.textContent=x?`No matching bookmarks`:`This folder is empty`,v.appendChild(e);return}let i=document.createDocumentFragment(),a=r.filter(e=>e.folder),o=r.filter(e=>!e.folder);for(let t of[...a,...o])i.appendChild(wi(t,e,k,M));v.appendChild(i)},P=async()=>{let e=++b;o.hidden=!0,l.hidden=!1;let n=mi();if(!n){w();return}if(t.setAttribute(`data-menu-mode`,n),n===`bookmarks`){a.setAttribute(`data-layout`,`start-split`),u.hidden=!1,a.contains(u)||(a.append(o,l,u),v.parentElement!==g&&g.append(_,v));let t=lr();if(!t){o.hidden=!1,s.textContent=`Bookmarks API unavailable in this context`,c.hidden=!0,l.hidden=!0,u.hidden=!0;return}c.hidden=!0,await N(t,e);return}a.removeAttribute(`data-layout`),u.hidden=!0,v.parentElement!==a&&a.append(v);let r=await hi();if(e!==b)return;if(!r?.launcherList||!r?.launcherLaunch||!r?.launcherIcon){o.hidden=!1,s.textContent=`Launcher bridge unavailable — rebuild the Capacitor APK`,c.hidden=!0,l.hidden=!0,v.hidden=!0;return}let i=!1;try{i=await r.launcherIsDefault()}catch{i=!1}e===b&&(i?o.hidden=!0:(o.hidden=!1,s.textContent=`Set CWSP Launcher as Home for full launcher integration`,c.hidden=!1),l.hidden=!1,v.hidden=!1,await j(r,e))};l.addEventListener(`input`,()=>{x=l.value.trim(),S&&clearTimeout(S),S=setTimeout(()=>{P()},180)}),c.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation();let t=await hi();if(t){try{await t.launcherRequestDefault()}catch{}P()}});let ee=e=>{if(!y||document.documentElement.hasAttribute(`data-app-menu-dragging`))return;let n=typeof e.composedPath==`function`?e.composedPath():[];for(let e of n)if(e===t||e===a||e instanceof Element&&t.contains(e)||e instanceof Element&&e.closest?.(`.cw-context-menu-layer`)||e instanceof Element&&e.closest?.(`.env-shell-app-menu__chrome-editor`)||e instanceof Element&&e.closest?.(`dialog.speed-dial-editor`))return;T()};document.addEventListener(`pointerdown`,ee,{capture:!0});let F=[`.env-shell-app-menu__tile`,`.env-shell-app-menu__search`,`.env-shell-app-menu__banner`,`.env-shell-app-menu__pin-menu`,`.env-shell-app-menu__crumb-item`,`.env-shell-app-menu__start-heading`,`.env-shell-app-menu__chrome-editor`,`.env-shell-app-menu__drag-ghost`,`.cw-context-menu-layer`,`dialog.speed-dial-editor`].join(`, `),I=null,te=e=>e instanceof Element&&!!e.closest(F),ne=e=>{if(y&&(e.button==null||e.button===0)){if(document.documentElement.hasAttribute(`data-app-menu-dragging`)||te(e.target)){I=null;return}I={id:e.pointerId,x:e.clientX,y:e.clientY}}},L=e=>{if(!I||I.id!==e.pointerId)return;let t=e.clientX-I.x,n=e.clientY-I.y;I=null,y&&(document.documentElement.hasAttribute(`data-app-menu-dragging`)||te(e.target)||Math.hypot(t,n)>14||T())},re=e=>{I?.id===e.pointerId&&(I=null)};return t.addEventListener(`pointerdown`,ne),t.addEventListener(`pointerup`,L),t.addEventListener(`pointercancel`,re),w(),{element:t,toggle:O,open:E,openPage:D,close:T,isOpen:()=>y,refresh:P,dispose:()=>{S&&clearTimeout(S),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),document.removeEventListener(`pointerdown`,ee,{capture:!0}),t.removeEventListener(`pointerdown`,ne),t.removeEventListener(`pointerup`,L),t.removeEventListener(`pointercancel`,re),document.removeEventListener(`u2-theme-change`,r);try{i.disconnect()}catch{}t.remove()}}}var Ei,Di,Oi,ki,Ai,ji;function Mi(){return(Mi=e((()=>{o(),N(),ue(),ir(),Pn(),ae(),li(),Pr(),di(),s(),Ei=t(ui),Di=!1,Oi=420,ki=10,Ai=null,ji=`circle`})))()}var Ni,Pi,Fi,Ii,Li;function Ri(){return(Ri=e((()=>{ue(),Ni=null,Pi=e=>{let t=we(e.id);return Math.max(0,Number(t?.androidWidgetId)||0)},Fi=(e,t)=>{let n=t.getBoundingClientRect();return{widgetId:e,x:n.left,y:n.top,w:Math.max(8,n.width),h:Math.max(8,n.height),dpr:Number(window.devicePixelRatio)||1}},Ii=e=>{if(!Ni)return;let t=e||document.getElementById(`home`);t&&t.querySelectorAll(`[data-speed-dial-item][data-widget="android"][data-layer="icons"]`).forEach(e=>{let t=(Te||[]).find(t=>t?.id===e.dataset.id);if(!t)return;let n=Pi(t);if(!n)return;let r=Fi(n,e);Ni.widgetAttach(r)})},Li=()=>{Ni?.widgetHideAll?.()}})))()}var zi,Bi,Vi,Hi,Ui,Wi,Gi,Ki,qi,Ji,Yi,Xi,Zi,Qi,$i,ea,ta,na;function ra(){return(ra=e((()=>{ge(),ue(),Ri(),zi=`/user/workspaces/`,Bi=`cwsp:workspace-page`,Vi=`cw::workspace::pages`,Hi=e=>`${zi}${e}/`,Ui=()=>[`side-a`,`side-b`,`side-c`].map(e=>({id:e,label:`Side ${e.slice(-1).toUpperCase()}`,path:Hi(e)})),Wi=()=>({activeId:`side-a`,pages:Ui(),snapshots:{}}),Gi=()=>{try{let e=localStorage.getItem(Vi);if(!e)return Wi();let t=JSON.parse(e);return!t||!Array.isArray(t.pages)||!t.pages.length?Wi():{activeId:String(t.activeId||t.pages[0].id),pages:t.pages.map(e=>({id:String(e.id||``).trim(),label:String(e.label||e.id),path:String(e.path||Hi(e.id))})).filter(e=>e.id),snapshots:t.snapshots&&typeof t.snapshots==`object`?t.snapshots:{}}}catch{return Wi()}},Ki=e=>{try{localStorage.setItem(Vi,JSON.stringify(e))}catch{}},qi=e=>{try{window.dispatchEvent(new CustomEvent(Bi,{detail:{id:e,pages:Ji()}}))}catch{}},Ji=()=>Gi().pages,Yi=()=>Gi().activeId||`side-a`,Xi=()=>{let e=Gi();e.pages.some(t=>t.id===e.activeId)&&(e.snapshots[e.activeId]=le(),Ki(e))};try{let e=globalThis;e.__CWSP_WORKSPACE_SNAPSHOT_SYNC_BOUND__||(e.__CWSP_WORKSPACE_SNAPSHOT_SYNC_BOUND__=!0,window.addEventListener(ye,Xi))}catch{}Zi=async e=>{try{let t=P(`/user/`);if(!t?.mkdir||!t.writable)return;if(await t.mkdir(`/user/`,`workspaces`).catch(()=>void 0),await t.mkdir(zi,e.id).catch(()=>void 0),t.writeFile){let n=new File([JSON.stringify({id:e.id,label:e.label,path:e.path},null,2)],`workspace.json`,{type:`application/json`});await t.writeFile(e.path,n).catch(()=>void 0)}}catch(t){console.warn(`[workspace-pages] explorer dir failed`,e.id,t)}},Qi=()=>{try{return matchMedia(`(prefers-reduced-motion: reduce)`).matches}catch{return!1}},$i=()=>{let e=document.querySelector(`.speed-dial-root`)||document.getElementById(`home`);if(!e)return[];let t=[...e.querySelectorAll(`.speed-dial-grid`)];return t.length?t:[e]},ea=e=>{let t=e||(typeof document<`u`?document:null);t?.querySelectorAll&&(t.querySelectorAll(`.speed-dial-grid--turn-ghost`).forEach(e=>e.remove()),t.querySelectorAll(`[data-ws-turning]`).forEach(e=>{delete e.dataset.wsTurning,e.querySelectorAll(`.speed-dial-grid`).forEach(e=>{e.style.opacity=``})}))},ta=e=>{let t=$i(),n=t[0]?.closest(`.speed-dial-root`)||t[0]||null;if(ea(n),!t.length||Qi()||typeof t[0].animate!=`function`)return()=>void 0;let r=e<0?-1:1,i=`${-88*r}deg`,a=`${88*r}deg`,o=`${-18*r}%`,s=`${18*r}%`,c=n||t[0];c.dataset.wsTurning=r>0?`next`:`prev`;let l=[];for(let e of t){let t=e.cloneNode(!0);t.classList.add(`speed-dial-grid--turn-ghost`),t.dataset.wsGhost=`1`,t.setAttribute(`aria-hidden`,`true`),e.parentElement?.insertBefore(t,e.nextSibling),e.style.opacity=`0`,l.push(t),t.animate([{transform:`translateX(0) rotateY(0deg)`,opacity:1},{transform:`translateX(${o}) rotateY(${i})`,opacity:0}],{duration:180,easing:`cubic-bezier(.4, 0, .2, 1)`,fill:`forwards`})}let u=()=>{for(let e of t)e.style.opacity=``;for(let e of l)e.remove();delete c.dataset.wsTurning};return()=>{let e=t.map(e=>e.animate([{transform:`translateX(${s}) rotateY(${a})`,opacity:.2},{transform:`translateX(0) rotateY(0deg)`,opacity:1}],{duration:220,easing:`cubic-bezier(.22, 1, .36, 1)`,fill:`none`})),n=Promise.all(e.map(e=>e.finished.catch(()=>void 0))),r=new Promise(e=>{setTimeout(e,500)});Promise.race([n,r]).then(u)}},na=e=>{let t=Gi(),n=t.pages.find(t=>t.id===e);if(!n)return!1;let r=t.activeId||t.pages[0].id;if(r===n.id)return!0;let i=Math.max(0,t.pages.findIndex(e=>e.id===r)),a=Math.max(0,t.pages.findIndex(e=>e.id===n.id))-i;Math.abs(a)>t.pages.length/2&&(a+=a>0?-t.pages.length:t.pages.length),t.snapshots[r]=le(),t.activeId=n.id,Ki(t),Li();let o=ta(a);return be(t.snapshots[n.id]||{items:[]}),requestAnimationFrame(()=>{o(),requestAnimationFrame(()=>Ii())}),Zi(n),qi(n.id),!0}})))()}var ia,aa,oa;function sa(){return(sa=e((()=>{E(),Pn(),ia=()=>{let e=globalThis;if(e.__CWSP_CAP_BACK_BOUND__)return;let t=e.Capacitor?.Plugins?.App;if(typeof t?.addListener==`function`){e.__CWSP_CAP_BACK_BOUND__=!0;try{t.addListener(`backButton`,({canGoBack:e})=>{if(T()&&m())return;if(document.querySelector(`.cw-context-menu-layer`)){J();return}if(document.querySelector(`.env-shell-app-menu[data-open]`)){document.querySelector(`.env-shell-app-menu`)?.dispatchEvent(new CustomEvent(`env-app-menu-request-close`,{bubbles:!0}));return}let t=document.querySelector(`dialog[open], .speed-dial-editor`);if(t){t.close?.(),t.remove?.();return}if(e){history.back();return}})}catch(e){console.warn(`[overlay-back] Capacitor backButton bind failed`,e)}}},aa=()=>{S({id:`app-menu-overlay`,priority:d.SIDEBAR,isActive:()=>!!document.querySelector(`.env-shell-app-menu[data-open]`),close:()=>(document.querySelector(`.env-shell-app-menu`)?.dispatchEvent(new CustomEvent(`env-app-menu-request-close`,{bubbles:!0})),!0)}),S({id:`speed-dial-editor`,priority:d.MODAL,isActive:()=>!!document.querySelector(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`),close:()=>(document.querySelectorAll(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`).forEach(e=>{try{e.close()}catch{e.remove()}}),!0)})},oa=()=>{let e=globalThis;if(e.__CWSP_LAUNCHER_BACK_STACK__){ia();return}e.__CWSP_LAUNCHER_BACK_STACK__=!0;try{p({preventDefaultNavigation:!0,pushInitialState:!0})}catch{}aa(),ia()}})))()}var ca;function la(){return(la=e((()=>{ca=`/*
 ...
 * Reason for changes: Light theme — pin glyphs use on-surface ink, not contrast-color(surface).
 */
...
}`})))()}function ua(e){return`${ya}${String(e||``).trim().toLowerCase()}`}function da(){let e=document.querySelector(`.env-shell-chrome`);return e instanceof HTMLElement&&e.hasAttribute(`data-desktop`)?!1:e instanceof HTMLElement&&e.dataset.chromeLayout===`mobile`||typeof matchMedia==`function`&&matchMedia(`(max-width: 640px)`).matches}function fa(e,t){if(e.some(e=>{let t=String(e.id||``).trim().toLowerCase();return!t||t===`home`?!1:e.visible!==!1&&!e.minimized}))return!0;let n=String(t.value||`home`).trim().toLowerCase();if(n&&n!==`home`&&n!==`viewer`)return!0;let r=document.querySelector(`.env-shell-workspace`);if(!r)return!1;for(let e of r.querySelectorAll(`ui-window`)){if(!(e instanceof HTMLElement)||e.hidden||e.hasAttribute(`data-minimized`))continue;let t=getComputedStyle(e);if(t.display!==`none`&&t.visibility!==`hidden`&&!(Number.parseFloat(t.opacity||`1`)<=0))return!0}return!1}function pa(e=new Date){return Qt(e)}function ma(e){let t=ne([]);u(t),h(_a,t,{title:`Home`,icon:`house-line`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`home`,e.onHome()}),h(va,t,{title:`Markdown`,icon:`article`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`viewer`,e.onViewer()});let n=document.createElement(`ui-taskbar`);n.className=`env-shell-taskbar wf-chrome-no-select`,n.setAttribute(`part`,`taskbar`),n.setAttribute(`data-type`,`desktop`);let r=document.createElement(`div`);r.className=`env-shell-taskbar__pins`;let i=document.createElement(`div`);i.className=`env-shell-taskbar__windows`;let a=document.createElement(`ui-task`);a.setAttribute(`title`,`Home`),a.setAttribute(`icon`,`house-line`),a.setAttribute(`data-id`,_a),a.setAttribute(`data-env-home`,``),a.setAttribute(`aria-label`,`Home`),a.setAttribute(`aria-haspopup`,`menu`),r.append(a);let o=document.createElement(`div`);o.className=`env-shell-taskbar__workspaces`,o.setAttribute(`aria-label`,`Workspaces`);let s=()=>{let e=Ji(),t=Yi();o.replaceChildren();for(let n of e){let e=document.createElement(`button`);e.type=`button`,e.className=`env-shell-taskbar__workspace`,e.title=n.label,e.textContent=n.label.replace(/^Side\s+/i,``)||n.id.slice(-1).toUpperCase(),e.toggleAttribute(`data-active`,n.id===t),e.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),na(n.id)}),o.append(e)}};s(),window.addEventListener(Bi,s),r.append(o),oa();let c=()=>{let e=da();a.setAttribute(`title`,e?`Home`:`Start`),a.setAttribute(`aria-label`,e?`Home`:`Start`),a.setAttribute(`icon`,e?`house-line`:`windows-logo`),a.toggleAttribute(`data-env-start`,!e),e?a.setAttribute(`aria-keyshortcuts`,`LongPress`):a.removeAttribute(`aria-keyshortcuts`)};c();let l=document.createElement(`div`);l.className=`env-shell-taskbar__tray-host`;let d=document.createElement(`div`);d.className=`env-shell-taskbar__clock`,d.setAttribute(`role`,`button`),d.setAttribute(`tabindex`,`0`),d.setAttribute(`aria-label`,`Calendar`),d.setAttribute(`aria-haspopup`,`dialog`),d.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let f=document.createElement(`span`);f.className=`env-shell-taskbar__clock-time`;let p=document.createElement(`span`);p.className=`env-shell-taskbar__clock-date`,d.append(f,p);let m=()=>{let{time:e,date:t}=pa();f.textContent=e,p.textContent=t,d.title=`${e} · ${t}`};m();let _=setInterval(m,xa),v=an(e.device,`env-device-tray env-device-tray--taskbar`);v.setAttribute(`role`,`button`),v.setAttribute(`tabindex`,`0`),v.setAttribute(`aria-label`,`Quick settings`),v.setAttribute(`aria-haspopup`,`dialog`),v.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`);let b=e=>{e.preventDefault(),e.stopPropagation(),Xe(d)},x=e=>{e.preventDefault(),e.stopPropagation(),pt(v)};d.addEventListener(`click`,b),d.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&b(e)}),v.addEventListener(`click`,x),v.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&x(e)}),l.append(v,d);let S=document.createElement(`div`);S.className=`env-shell-navbar__switcher`,S.setAttribute(`role`,`menu`),S.setAttribute(`aria-label`,`Open apps`),S.hidden=!0;let C=document.createElement(`ul`);C.className=`env-shell-navbar__switcher-list`,S.appendChild(C),n.append(r,i,l,S);let w=pi(),T=w?Ti():void 0,E=new Map,D=[],O=null,k=!1,A=!1,j=null,M=[];M.push(()=>clearInterval(_));let N=e=>D.find(t=>String(t.id||``).trim().toLowerCase()===e),P=t=>{let n=String(t||``).trim().toLowerCase();if(!n)return;let r=N(n),i=String(e.focusedTaskId.value||``).trim().toLowerCase(),a=!!r?.focused||i===n||i===`markdown`&&n===`viewer`||i===`viewer`&&(n===`viewer`||n===`markdown`);if(r?.minimized){r.minimized=!1,r.focused=!0,E.get(n)?.toggleAttribute(`data-minimized`,!1),e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n);return}if(a&&r&&r.visible!==!1){r.minimized=!0,r.focused=!1,E.get(n)?.toggleAttribute(`data-minimized`,!0),e.onMinimizeWindow?.(n);return}e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n)},ee=(t,r,i)=>{if(da())return;t.preventDefault(),t.stopPropagation();let a=String(r||``).trim().toLowerCase(),o=!!N(a)?.minimized,s=[{id:o?`restore`:`minimize`,label:o?`Restore`:`Minimize`,icon:o?`arrow-square-out`:`minus`,action:()=>{o?(e.focusedTaskId.value=a,e.onWindowTask?.(a)):e.onMinimizeWindow?.(a)}},{id:`close`,label:`Close`,icon:`x`,danger:!0,action:()=>e.onCloseWindow?.(a)}];Nn({x:t.clientX,y:t.clientY,compact:!0,anchor:t.target instanceof Element?t.target:n,items:s})};n.addEventListener(`contextmenu`,t=>{if(da())return;let r=typeof t.composedPath==`function`?t.composedPath():[];for(let e of r)if(e instanceof Element&&e.closest?.(`ui-task`))return;t.preventDefault(),t.stopPropagation(),Nn({x:t.clientX,y:t.clientY,compact:!0,anchor:n,items:[{id:`show-desktop`,label:`Show desktop`,icon:`desktop`,action:()=>e.onHome()},{id:`home`,label:`Home`,icon:`house-line`,action:()=>e.onHome()}]})});let F=()=>{A=!1,S.hidden=!0,C.replaceChildren(),n.removeAttribute(`data-switcher-open`)},I=()=>{let r=D.filter(e=>String(e.id||``).trim());if(C.replaceChildren(),r.length)for(let n of r){let r=String(n.id||``).trim().toLowerCase(),i=document.createElement(`li`);i.className=`env-shell-navbar__switcher-row`,i.setAttribute(`role`,`none`);let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-navbar__switcher-item`,a.setAttribute(`role`,`menuitem`),a.toggleAttribute(`data-active`,!!n.focused&&!n.minimized),a.toggleAttribute(`data-minimized`,!!n.minimized);let o=document.createElement(`ui-icon`);o.setAttribute(`icon`,n.icon||`app-window`),o.setAttribute(`icon-style`,`duotone`),o.setAttribute(`aria-hidden`,`true`);let s=document.createElement(`span`);s.className=`env-shell-navbar__switcher-label`,s.textContent=n.title||r,a.append(o,s),a.addEventListener(`click`,n=>{n.preventDefault(),n.stopPropagation(),F(),e.focusedTaskId.value=r;let i=ua(r),a=y(t,i);a?a.focus=!0:e.onWindowTask?.(r)});let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-navbar__switcher-close`,c.setAttribute(`aria-label`,`Close ${n.title||r}`),c.title=`Close`;let l=document.createElement(`ui-icon`);l.setAttribute(`icon`,`x`),l.setAttribute(`icon-style`,`bold`),l.setAttribute(`aria-hidden`,`true`),c.appendChild(l),c.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.onCloseWindow?.(r),D=D.filter(e=>String(e.id||``).trim().toLowerCase()!==r),E.get(r)?.remove(),E.delete(r),D.length?I():F()}),i.append(a,c),C.appendChild(i)}else{let e=document.createElement(`li`);e.className=`env-shell-navbar__switcher-empty`,e.textContent=`No open apps`,C.appendChild(e)}A=!0,S.hidden=!1,n.setAttribute(`data-switcher-open`,``)},te=()=>{O!=null&&(clearTimeout(O),O=null)},L=()=>{n.toggleAttribute(`data-app-menu-open`,!!T?.isOpen())},ie=()=>{F(),T?.close(),L(),y(t,_a).focus=!0,e.onHome()},ae=()=>{F(),T?.toggle(),L(),y(t,_a).focus=!0,e.focusedTaskId.value=`home`,de()},oe=()=>{!T||T.isOpen()||(F(),T.open(),L(),y(t,_a).focus=!0,e.focusedTaskId.value=`home`,de())},se=()=>{T&&(F(),T.openPage(),L(),y(t,_a).focus=!0,e.focusedTaskId.value=`home`,de())};try{let e=globalThis;e.__CWSP_LAUNCHER_HOME__={...e.__CWSP_LAUNCHER_HOME__||{},openAppMenu:oe,openAppMenuPage:se}}catch{}let ce=()=>{if(fa(D,e.focusedTaskId)){ie();return}if(T?.isOpen()){T.close(),L();return}ae()};a.addEventListener(`click`,e=>{if(k){e.preventDefault(),e.stopPropagation(),k=!1;return}if(w&&T){e.preventDefault(),e.stopPropagation(),ce();return}ie()}),a.addEventListener(`pointerdown`,e=>{if(da()&&(e.button==null||e.button===0)){k=!1,te(),O=setTimeout(()=>{O=null,k=!0;try{a.releasePointerCapture?.(e.pointerId)}catch{}I()},ba);try{a.setPointerCapture?.(e.pointerId)}catch{}}},{capture:!0});let le=()=>{te()};a.addEventListener(`pointerup`,le,{capture:!0}),a.addEventListener(`pointercancel`,le,{capture:!0}),a.addEventListener(`contextmenu`,e=>{da()&&(e.preventDefault(),k=!0,te(),I())});let ue=e=>{if(!A)return;let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t)if(e===S||e===a||e instanceof Element&&(e===S||S.contains(e)||e===a))return;F()};document.addEventListener(`pointerdown`,ue,{capture:!0}),M.push(()=>document.removeEventListener(`pointerdown`,ue,{capture:!0}));let de=()=>{let t=String(e.focusedTaskId.value||`home`),n=(e,t)=>{e.toggleAttribute(`data-env-active`,t),e.toggleAttribute(`data-active`,t),e.toggleAttribute(`data-focus`,t)};n(a,t===`home`);for(let[e,r]of E)n(r,t===e)};re(()=>{de()},[e.focusedTaskId],{triggerImmediately:!0});let fe=e=>{let n=String(e.id||``).trim().toLowerCase();if(!n||n===`home`)return;let r=ua(n),a=e.title||n,o=String(e.icon||``).trim()||`app-window`,s=E.get(n);if(!s){let e=h(r,null,{title:a,icon:o},{viewId:n},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,P(n)});e.list=t,t.push(e),s=document.createElement(`ui-task`),s.setAttribute(`data-id`,r),s.setAttribute(`data-view`,n),s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),P(n)}),s.addEventListener(`contextmenu`,e=>{ee(e,n,a)}),E.set(n,s),i.appendChild(s)}s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.toggleAttribute(`data-minimized`,!!e.minimized),s.hidden=e.visible===!1},pe=n=>{D=Array.isArray(n)?n.slice():[];let r=new Set;for(let t of n){let n=String(t.id||``).trim().toLowerCase();!n||n===`home`||(r.add(n),fe(t),t.focused&&(e.focusedTaskId.value=n))}for(let[e,n]of[...E.entries()]){if(r.has(e))continue;let i=ua(e),a=y(t,i);if(a){let e=t.indexOf(a);e>=0&&t.splice(e,1)}n.remove(),E.delete(e)}de(),A&&I()},me=n=>{let r=String(n||`home`).toLowerCase(),i=_a;r===`viewer`||r===`markdown`?i=va:r!==`home`&&(i=ua(r));let a=y(t,i);if(a){for(let e of t)e!==a&&(e.active=!1);a.active=!0}e.focusedTaskId.value=r===`markdown`?`viewer`:r,de()},he=()=>{let e=!da();c(),e?!j&&n.isConnected&&(j=g(n,{className:`env-shell-taskbar-under`,shadowBlur:28,shadowOffsetY:8,shadowColor:`rgba(0, 0, 0, 0.4)`})):j&&=(j.destroy(),null)};queueMicrotask(he);let ge=typeof matchMedia==`function`?matchMedia(`(min-width: 641px)`):null,_e=()=>he();if(ge?.addEventListener?.(`change`,_e),M.push(()=>ge?.removeEventListener?.(`change`,_e)),T){let e=()=>L();n.addEventListener(`env-app-menu-open`,e),n.addEventListener(`env-app-menu-close`,e),M.push(()=>{n.removeEventListener(`env-app-menu-open`,e),n.removeEventListener(`env-app-menu-close`,e)})}return{element:n,taskList:t,setFocusedTaskId:me,syncWindowTasks:pe,appMenu:T,openAppMenu:T?oe:void 0,openAppMenuPage:T?se:void 0,isSwitcherOpen:()=>A,closeSwitcher:F,dispose:()=>{te(),F(),T?.dispose(),j?.destroy(),j=null;for(let e of M)try{e()}catch{}M.length=0,E.clear(),i.replaceChildren()}}}var ha,ga,_a,va,ya,ba,xa;function Sa(){return(Sa=e((()=>{N(),E(),te(),Pn(),ln(),rt(),Gt(),Mi(),ra(),sa(),B(),la(),o(),ha=t(ca),ga=class extends Ae{constructor(){super()}styles=()=>ha;render=()=>D`<div part="taskbar" class="taskbar"><slot></slot></div>`},ga=R([f(`ui-taskbar`)],ga),_a=`#env-home`,va=`#env-viewer`,ya=`#env-win-`,ba=420,xa=3e4})))()}var Ca;function wa(){return(wa=e((()=>{Ca=`/**
 * Font Styles Index
 *
...
.ui-modal-panel {
  ...
  box-shadow: var(--modal-shadow, 0 20px 60px rgba(0, 0, 0, 0.42));
  pointer-events: auto;
}`})))()}function Ta(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function Ea(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function Da(e,t,n=`font/woff2`){if(Ma.has(t))return Ma.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return Ma.set(t,i),i}async function Oa(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(Na.has(o))return Na.get(o);let s=Ta(t),c=await Da(a?await Ea(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),Na.set(o,l),l}async function ka(e){let t=e.map(e=>Oa(e));return Promise.all(t)}async function Aa(){return Pa||(Pa=c(()=>import(`./font-registry-DGJ_haGr.js`),[],import.meta.url)?.catch?.(e=>{console.error(`Failed to load font registry:`,e)}),Pa)}async function ja(){let e=await Aa();return ka(Object.values(e.fontRegistry))}var Ma,Na,Pa;function Fa(){return(Fa=e((()=>{s(),Ma=new Map,Na=new Map,Pa=null})))()}var Ia;function La(){return(La=e((()=>{Ia=`/*
 * Filename: layers.scss
 * FullPath: modules/projects/fl.ui/src/styles/layers.scss
 * Change date and time: 15.10.00_22.08.2026
 * Reason for changes: Match veela \`_layers.scss\` so fl.ui never establishes a shorter competing prelude.
...
}`})))()}var Ra,za;function Ba(){return(Ba=e((()=>{Fa(),o(),wa(),La(),Ra=`
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
`,za=async e=>{await r(Ra)?.catch(()=>void 0),await ja().catch(()=>void 0),await r(Ca)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await r(Ia)?.catch(()=>void 0)}})))()}var Va;function Ha(){return(Ha=e((()=>{Va=`:host(ui-task), :host(ui-task) * {
  box-sizing: border-box;
  user-select: none;
  touch-action: manipulation;
  -webkit-user-drag: none;
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})))()}var Ua,Wa,Ga,Ka;function qa(){return(qa=e((()=>{B(),o(),E(),Ha(),Ua=t(Va),Wa=e=>{let t=``;if(typeof e==`string`)t=e;else if(typeof e==`object`&&e&&`value`in e){let n=e.value;t=n==null?``:String(n)}else e!=null&&typeof e!=`object`&&(t=String(e));(!t||t===`undefined`||t===`null`||t===`[object Object]`)&&(t=``);let n=t.trim().charAt(0);return n?n.toUpperCase():`?`},Ga=(e,t,n)=>{let r=e.getAttribute(t);return r!=null&&String(r).trim()?String(r).trim():n},Ka=class extends Ae{title;icon;constructor(){super()}styles=()=>Ua;render=function(){let e=Ga(this,`title`,`Task`),t=Ga(this,`icon`,`app-window`),n=Wa(e);return D`
        ...
        `}},R([x({source:`attr`})],Ka.prototype,`title`,void 0),R([x({source:`attr`})],Ka.prototype,`icon`,void 0),Ka=R([f(`ui-task`)],Ka)})))()}var Ja;function Ya(){return(Ya=e((()=>{Ja=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})))()}function Xa(){return(Xa=e((()=>{o(),Ya(),t(Ja)})))()}var Za;function Qa(){return(Qa=e((()=>{Za=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}
...
:host(ui-taskbar[data-type=mobile]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})))()}function $a(){return($a=e((()=>{o(),Qa(),t(Za)})))()}function eo(){try{return globalThis.navigator?.windowControlsOverlay??null}catch{return null}}function to(){if(typeof globalThis.matchMedia!=`function`)return`unknown`;try{if(globalThis.matchMedia(`(display-mode: window-controls-overlay)`).matches)return`window-controls-overlay`;if(globalThis.matchMedia(`(display-mode: fullscreen)`).matches)return`fullscreen`;if(globalThis.matchMedia(`(display-mode: standalone)`).matches)return`standalone`;if(globalThis.matchMedia(`(display-mode: minimal-ui)`).matches)return`minimal-ui`;if(globalThis.matchMedia(`(display-mode: browser)`).matches)return`browser`}catch{}return`unknown`}function no(e){if(!e?.visible||typeof e.getTitlebarAreaRect!=`function`)return null;try{let t=e.getTitlebarAreaRect();return t?{x:t.x,y:t.y,width:t.width,height:t.height}:null}catch{return null}}function ro(e){let t=eo(),n=!!t?.visible,r=to(),i=n||r===`standalone`||r===`fullscreen`||r===`window-controls-overlay`||r===`minimal-ui`,a=`off`;return e&&(a=n?`wco`:i?`standalone`:`fallback`),{requested:e,wcoVisible:n,displayMode:r,titlebarRect:no(t),isStandaloneLike:i,surface:a}}function io(e){let t=()=>{e.onChange(ro(e.getRequested()))},n=[];if(typeof globalThis.matchMedia==`function`)for(let e of[`(display-mode: window-controls-overlay)`,`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`])try{n.push(globalThis.matchMedia(e))}catch{}let r=()=>t();for(let e of n)try{e.addEventListener?.(`change`,r)}catch{try{e.addListener?.(r)}catch{}}let i=eo(),a=()=>t();try{i?.addEventListener?.(`geometrychange`,a)}catch{}return queueMicrotask(t),()=>{for(let e of n)try{e.removeEventListener?.(`change`,r)}catch{try{e.removeListener?.(r)}catch{}}try{i?.removeEventListener?.(`geometrychange`,a)}catch{}}}var Z,ao,oo,so,co,lo,uo,fo,po,Q,mo,ho,go,_o,vo,yo,$,bo,xo,So,Co,wo,To,Eo,Do;function Oo(){return(Oo=e((()=>{Z=null,ao=null,oo=null,so=[],co=null,lo=0,uo=null,fo=`#cbb8a4`,po=`__CWSP_NATIVE_THEME_COLOR_OWNED__`,Q=e=>{let t=String(e||``).trim().toLowerCase();if(!t)return!1;if(t===`#007acc`||t===`#007accff`||t===`#36c`||t===`#3366cc`)return!0;let n=t.match(/^rgba?\(\s*([\d.]+)\s*[, ]\s*([\d.]+)\s*[, ]\s*([\d.]+)/i);if(n&&(t?.startsWith?.(`#`)||t?.startsWith?.(`rgb`))){let e=Math.round(Number(n[1])),t=Math.round(Number(n[2])),r=Math.round(Number(n[3]));if(e<=20&&t>=100&&t<=140&&r>=180&&r<=220)return!0}return!1},mo=()=>{try{return!!globalThis?.[po]}catch{return!1}},ho=e=>{co=e;try{globalThis[po]=!!e}catch{}},go=e=>{if(!e||!e.isConnected||e.hasAttribute(`minimized`))return!1;if(e.hasAttribute(`native-mode`))return!0;let t=e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`);if(!t)return!1;try{let t=e.getBoundingClientRect(),n=Math.max(1,globalThis.innerWidth||1),r=Math.max(1,globalThis.innerHeight||1);return t.top<=8&&t.left<=8&&t.width>=n*.92&&t.height>=r*.85}catch{return t}},_o=()=>{if(typeof document>`u`)return null;if(co?.isConnected&&go(co))return co;let e=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized])`));if(e.length)return e[e.length-1];let t=Array.from(document.querySelectorAll(`ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`));for(let e=t.length-1;e>=0;e--){let n=t[e];if(go(n))return n}return null},vo=()=>{ao||typeof MutationObserver>`u`||typeof document>`u`||(ao=new MutationObserver(()=>{let e=_o();e?.isConnected?Eo(e):wo()}),ao.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`class`,`style`,`color-scheme`]}))},yo=e=>{oo||typeof MutationObserver>`u`||(oo=new MutationObserver(()=>{if(!mo())return;let t=(e.getAttribute(`content`)||``).toLowerCase(),n=(uo||``).toLowerCase();if(n&&t===n&&!Q(t))return;let r=_o();r?Eo(r):Q(t)&&Co(fo,!0)}),oo.observe(e,{attributes:!0,attributeFilter:[`content`]}))},$=e=>e,bo=()=>{if(typeof document>`u`)return null;let e=document.querySelector(`meta[data-theme-color]`)||document.querySelector(`meta[name="theme-color"]`);e||(e=document.createElement(`meta`),e.setAttribute(`name`,`theme-color`),e.setAttribute(`data-theme-color`,``),document.head?.appendChild(e));try{let t=Array.from(document.querySelectorAll(`meta[name="theme-color"]`));for(let n of t)n!==e&&n.remove()}catch{}return yo(e),e},xo=(e,t)=>{try{let n=document.createElement(`div`);n.setAttribute(`data-theme-color-probe`,`true`),n.style.cssText=`position:fixed;left:-8px;top:-8px;inline-size:4px;block-size:4px;pointer-events:none;opacity:0;background:${t}`,e.appendChild(n);let r=$(getComputedStyle(n).backgroundColor);return n.remove(),r}catch{return null}},So=e=>{let t=e.shadowRoot?.querySelector(`.title-handler`);if(t){let e=xo(t,`var(--ui-win-titlebar-bg, var(--color-surface-container, Canvas))`);if(e)return e;let n=$(getComputedStyle(t).backgroundColor);if(n)return n}let n=getComputedStyle(e);for(let t of[`--ui-win-titlebar-bg`,`--color-surface-container`,`--color-surface`]){let r=xo(e,`var(${t})`);if(r)return r;let i=n.getPropertyValue(t).trim();if(!i)continue;let a=$(i);if(a)return a}let r=getComputedStyle(document.documentElement);for(let e of[`--color-surface-container`,`--color-surface`,`--color-surface-container-low`]){let t=xo(document.documentElement,`var(${e})`)||$(r.getPropertyValue(e).trim());if(t)return t}return null},Co=(e,t=!1)=>{let n=bo();if(!n||!e)return;let r=e.toLowerCase();Q(r)&&(r=fo);let i=(n.getAttribute(`content`)||``).toLowerCase();if(!(i===r&&!t&&!Q(i))&&(n.setAttribute(`content`,r),n.setAttribute(`data-theme-color`,``),n.removeAttribute(`media`),uo=r,t||i!==r||Q(i)))try{let e=n.parentNode||document.head;e?.removeChild(n),e?.appendChild(n)}catch{}},wo=()=>{if(typeof document>`u`||_o())return;ho(null),uo=null;let e=bo();if(!e)return;let t=document.documentElement,n=getComputedStyle(t),r=document.body?getComputedStyle(document.body):null,i=$(n.getPropertyValue(`--color-surface-container`).trim())||$(n.getPropertyValue(`--color-surface`).trim())||$(n.getPropertyValue(`--ui-win-titlebar-bg`).trim())||(r?$(r.backgroundColor):null)||$(n.backgroundColor);i?Co(i):Q(String(e.getAttribute(`content`)||``))&&Co(fo,!0),vo()},To=e=>e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`),Eo=e=>{if(!e||typeof document>`u`||e.hasAttribute(`minimized`)||!e.hasAttribute(`native-mode`)&&!To(e)&&!go(e))return;let t=bo();if(!t)return;if(Z==null){let e=t.getAttribute(`content`)||``;Z=Q(e)?``:e}ho(e),Q(String(t.getAttribute(`content`)||``))&&Co(fo,!0);let n=++lo,r=(t=!1)=>{if(n!==lo||!e.isConnected||!e.hasAttribute(`native-mode`)&&!To(e)&&!go(e))return;let r=So(e)||fo;Co(r,t)};r(!0),requestAnimationFrame(()=>{r(!1),requestAnimationFrame(()=>r(!0))});for(let e of so)clearTimeout(e);so=[],so.push(setTimeout(()=>r(!0),50),setTimeout(()=>r(!0),160),setTimeout(()=>r(!0),400)),vo()},Do=e=>{if(typeof document>`u`||!document.querySelector(`meta[name="theme-color"]`))return;let t=_o();if(t&&t!==e){Eo(t);return}let n=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized]), ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`)).filter(t=>t!==e&&go(t));if(n.length){Eo(n[n.length-1]);return}ho(null),uo=null,lo+=1;for(let e of so)clearTimeout(e);so=[],Z!=null&&Z&&!Q(Z)?(Co(Z,!0),Z=null):(Z=null,wo())},typeof document<`u`&&queueMicrotask(()=>{try{wo()}catch{}})})))()}var ko;function Ao(){return(Ao=e((()=>{ko=`/*
...
.window-resizer:hover {
  opacity: 0.9;
}`})))()}var jo,Mo,No,Po,Fo,Io,Lo;function Ro(){return(Ro=e((()=>{E(),o(),B(),N(),Oo(),Ao(),jo=t(ko),Mo=`minus`,No=`corners-out`,Po=`corners-in`,Fo=`x`,Io=Object.freeze({w:240,h:160}),Lo=class extends z{titleHandler;contentHandler;footerHandler;resizer;#e=O(0);#t=O(0);#n=null;#r=null;#i=null;#a=null;#o=null;#s=null;#c=null;#l=!1;#u=0;#d=0;#f=null;styles=function(){return jo};render=function(){return D`<div class="window-container" part="window-container">
