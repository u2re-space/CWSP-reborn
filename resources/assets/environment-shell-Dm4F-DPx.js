import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{A as t,k as n,t as r}from"./src-6wudtv1A.js";import{_ as i,d as a,g as o,u as s}from"./registry-D_zLBF-d.js";import{n as c,t as l}from"./preload-helper-DcjHEl26.js";import{a as u,t as d}from"./cws-bridge-e3UFl4Oo.js";import{K as f,q as p,t as m}from"./src-DOA8CgFN.js";import{i as h,n as g,t as _}from"./object-DpwBpfvO.js";import{a as v,t as y}from"./icon-aHIY67e3.js";import{a as b,i as x,n as S,r as C}from"./image-CbxuEy3X.js";import{c as w,l as T,n as E,o as D,s as O,t as k}from"./shells-Cf8BC2_U.js";import{M as A,N as ee,P as j,j as M}from"./launcher-state-JCaPMCu4.js";import{_ as N,a as P,c as F,d as I,f as L,g as te,h as ne,i as re,l as ie,m as R,n as z,o as B,p as ae,r as oe,s as se,t as ce,u as le,v as ue,y as de}from"./src-oOLHidHp2.js";function fe(){if(typeof document>`u`||!document.body)return{top:0,bottom:0};let e=document.createElement(`div`);e.style.cssText=`position:fixed;top:0;left:0;padding-top:env(safe-area-inset-top);padding-bottom:env(safe-area-inset-bottom);visibility:hidden;pointer-events:none;`,document.body.appendChild(e);let t=getComputedStyle(e),n=Number.parseFloat(t.paddingTop)||0,r=Number.parseFloat(t.paddingBottom)||0;return e.remove(),{top:n,bottom:r}}function pe(){try{if(!/android/i.test(navigator.userAgent))return 0}catch{return 0}return 28}function me(e,t){V=Math.max(0,Math.round(e)),H=Math.max(0,Math.round(t));let n=`${V}px`,r=`${H}px`;document.documentElement.style.setProperty(ve,n),document.documentElement.style.setProperty(ye,r),document.documentElement.toggleAttribute(`data-capacitor-native`,!0);for(let e of document.querySelectorAll(`.env-shell-root, env-shell-container`))e instanceof HTMLElement&&(e.style.setProperty(ve,n),e.style.setProperty(ye,r),e.toggleAttribute(`data-capacitor-native`,!0))}function he(){V<=0&&H<=0||me(V,H)}async function ge(){let e=0,t=0;try{let n=await d.getShellInfo();e=Number(n.statusBarHeightCss)||0,t=Number(n.navigationBarHeightCss)||0}catch{}let n=fe();return e=Math.max(e,n.top),t=Math.max(t,n.bottom),e<=0&&(e=pe()),{top:e,bottom:t}}async function _e(){if(!le())return;if(be){he();return}be=!0;let e=async()=>{let{top:e,bottom:t}=await ge();me(e,t)};await e(),window.addEventListener(`resize`,()=>void e()),window.visualViewport?.addEventListener(`resize`,()=>void e()),document.addEventListener(`orientationchange`,()=>void e()),typeof MutationObserver==`function`&&new MutationObserver(()=>he()).observe(document.documentElement,{childList:!0,subtree:!0})}var ve,ye,V,H,be;function xe(){return(xe=e((()=>{u(),ie(),ve=`--env-native-safe-top`,ye=`--env-native-safe-bottom`,V=0,H=0,be=!1})))()}var Se;function Ce(){return(Ce=e((()=>{Se=`/**
...
.esc-overlays {
  ...
  position: relative;
  overflow: visible;
}`})))()}function we(){return!ke&&!customElements.get(`env-shell-container`)&&(customElements.define(U,Oe),ke=!0),Oe}function Te(){we();let e=customElements.get(U);if(e)try{return new e}catch(e){console.warn("[env-shell-container] `new` failed, falling back to createElement",e)}return document.createElement(U)}function Ee(e){return e instanceof HTMLElement&&e.localName===`env-shell-container`}var U,De,Oe,ke;function Ae(){return(Ae=e((()=>{Ce(),O(),U=`env-shell-container`,De=document.createElement(`template`),De.innerHTML=`
...
</div>`,Oe=class extends HTMLElement{#e=!1;get overlayMount(){return this.#t(),this.shadowRoot?.querySelector(`[data-shell-overlays]`)??null}constructor(){super(),this.#t()}connectedCallback(){this.#t()}#t(){if(this.#e&&this.shadowRoot)return;let e=this.shadowRoot??this.attachShadow({mode:`open`});if(e.querySelector(`.esc-stack`)||e.appendChild(De.content.cloneNode(!0)),e.adoptedStyleSheets.length===0){let t=new CSSStyleSheet;t.replaceSync(Se),e.adoptedStyleSheets=[t]}this.#e=!0}},ke=!1})))()}function je(e){let t=`[${Me}]`,n=e.querySelector(t);if(n)return n.style.zIndex||(n.style.zIndex=W),n.style.position||(n.style.position=Ee(e)?`absolute`:`fixed`),n;let r=document.createElement(`div`);return r.setAttribute(Me,``),r.className=`env-shell-overlays`,r.setAttribute(`data-part`,`env-overlays`),Ee(e)?(r.slot=D.overlay,r.style.cssText=`position:absolute;inset:0;pointer-events:none;z-index:${W};box-sizing:border-box;`,e.appendChild(r),r):(r.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${W};box-sizing:border-box;`,e.appendChild(r),r)}var Me,W;function Ne(){return(Ne=e((()=>{Ae(),O(),Me=`data-env-shell-overlays`,W=`2147483600`})))()}function Pe(){return(Pe=e((()=>{S()})))()}function Fe(e,t={}){let{x:n=48,y:r=48,w:i=640,h:a=480,z:o=10,demoRole:s}=t,c=matchMedia(`(max-width: 640px)`);return{demoRole:s,title:e,bounds:{x:A(n),y:A(r),w:A(i),h:A(a)},z:A(o),maximizedMobile:M(c.matches),minimized:M(!1),desktopMaximized:M(!1),nativeMode:M(!1),visible:M(!0),isMobileMq:c}}function Ie(){return(Ie=e((()=>{j(),Object.freeze({w:360,h:240})})))()}function G(e){let t=String(e??``).trim().toLowerCase();t=t.replace(/^#/,``);let n=/^todo:\s*(.*)$/i.exec(t);return n&&(t=String(n[1]??``).trim().toLowerCase()),t=t.replace(/\s+/g,``),t?t===`viewer`||Re.has(t)?K:t:``}function Le(e){return String(e||``).trim().toLowerCase()===K}var K,Re;function ze(){return(ze=e((()=>{K=`viewer`,Re=new Set([`markdown`,`markdown-view`,`markdown-viewer`,`reader`,`env-viewer`])})))()}function Be(e){return!!(e&&typeof e==`object`&&typeof e.render==`function`)}function q(e,t){let n=e?.lifecycle?.[t];typeof n==`function`&&Promise.resolve(n())}function Ve(e){if(typeof e!=`function`)return!1;try{let t=e.prototype;return!!(t!=null&&typeof HTMLElement<`u`&&HTMLElement.prototype.isPrototypeOf(t))}catch{return!1}}function He(e,t){let n=e.default??e.createView??e.createHomeView;if(!n||typeof n!=`function`)throw Error(`window-frame view-mount: module has no default/createView factory`);let r=Ve(n)?new n(t):n(t);if(Be(r)){let e=r,n=e.render(t);if(!(n instanceof HTMLElement))throw Error(`window-frame view-mount: view.render() must return HTMLElement`);return{root:n,view:e}}if(r instanceof HTMLElement)return{root:r};throw Error(`window-frame view-mount: factory did not return View or HTMLElement`)}function Ue(e,t){return e.replaceChildren(t),()=>{t.remove(),e.replaceChildren()}}async function We(e,t,n){let{root:r,view:i}=He(await e(),n);r.classList.add(`wf-mounted-view`);let a=Ue(t,r);return q(i,`onMount`),q(i,`onShow`),()=>{q(i,`onHide`),q(i,`onUnmount`),a()}}function Ge(){try{if(document.documentElement.dataset.cwspNativeShell===`capacitor`)return!0;let e=globalThis.Capacitor;return typeof e?.isNativePlatform==`function`&&!!e.isNativePlatform()}catch{return!1}}function Ke(e){let t=e?.closest?.(`.env-shell-root`)??e?.closest?.(`env-shell-container`);if(!(t instanceof HTMLElement))return 0;let n=getComputedStyle(t).getPropertyValue(`--env-window-z-boost`).trim(),r=Number.parseInt(n,10);return Number.isFinite(r)?r:0}function qe(e){let t=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.querySelector?.(`.env-shell-root, env-shell-container`);return t instanceof HTMLElement?t:null}function J(e){let t=qe(e);if(!t)return;let n=!!t.querySelector?.(`ui-window[native-mode], ui-window[data-native-active]`);t.toggleAttribute(`data-env-native-task`,n)}function Je(e,t,n,r,i={}){let{bounds:a,z:o,maximizedMobile:s,minimized:c,desktopMaximized:l,visible:u,isMobileMq:d}=t;t.nativeMode||=M(!!i.startNative);let f=t.nativeMode;i.startNative&&(f.value=!0);let p=document.createElement(`ui-window`);p.setAttribute(`managed`,``),p.className=`env-ui-window`,p.setAttribute(`part`,`window`);{let e=document.documentElement.getAttribute(`data-theme`)||document.documentElement.style.colorScheme||``;(e===`light`||e===`dark`)&&(p.dataset.theme=e,p.style.colorScheme=e)}let m=document.createElement(`span`);m.slot=`title`,m.className=`env-ui-window__title`,m.textContent=t.title,n.slot=`content`,n.classList.add(`env-ui-window__body`),p.append(m,n),e.appendChild(p);let h=String(i?.managedViewKey??``).trim();h&&(p.setAttribute(`data-ui-window-view`,h),p.setAttribute(`data-wf-managed-view`,h));let g=null,_=()=>{i.onChromeChange?.(),J(e)},v=()=>{p.style.right=``,p.style.bottom=``},y=()=>{p.style.left=`${Y}px`,p.style.top=`${Y}px`,p.style.right=`${Y}px`,p.style.bottom=`${Y}px`,p.style.width=`auto`,p.style.height=`auto`,p.style.removeProperty(`--ui-win-width`),p.style.removeProperty(`--ui-win-height`)},b=()=>{p.style.left=`0`,p.style.top=`0`,p.style.right=`0`,p.style.bottom=`0`,p.style.width=`100%`,p.style.height=`100%`,p.style.removeProperty(`--ui-win-width`),p.style.removeProperty(`--ui-win-height`)},x=()=>{let t=!!d.matches,n=Ke(e),r=(o.value??10)+n;p.style.zIndex=String(r),t&&(l.value&&=!1,!c.value&&!f.value&&!s.value&&(s.value=!0));let i=!!f.value,m=!!c.value,h=!t&&!!l.value&&!i&&!m,g=t&&!i&&!m,_=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.querySelector?.(`.env-shell-root, env-shell-container`),x=_ instanceof HTMLElement&&_.hasAttribute(`data-status-overlay`)||document.documentElement.hasAttribute(`data-env-status-overlay`),S=_ instanceof HTMLElement&&_.hasAttribute(`data-standalone`)||document.documentElement.hasAttribute(`data-env-standalone`),C=x&&!i&&!m&&(g||h),w=Ge(),T=S&&t&&!i&&!m||w&&t&&!i&&!m;if(p.toggleAttribute(`native-mode`,i&&!m),p.toggleAttribute(`minimized`,m),p.toggleAttribute(`data-mobile-max`,g),p.toggleAttribute(`data-desk-max`,h),p.toggleAttribute(`data-status-gap`,C),p.toggleAttribute(`data-no-titlebar`,T),p.toggleAttribute(`maximized`,!m&&(h||g||i)),m){p.setVisible(!1),J(e);return}if(p.setVisible(!!u.value),!u.value){J(e);return}if(i){b(),J(e);return}if(g){p.style.left=`0`,p.style.top=`0`,p.style.right=`0`,p.style.bottom=`var(--env-mobile-dock-reserve, 3.25rem)`,p.style.width=`100%`,p.style.height=`auto`,J(e);return}if(h){y(),J(e);return}v(),p.applyBounds({x:a.x.value,y:a.y.value,w:a.w.value,h:a.h.value,z:r}),J(e)},S=()=>{d.matches&&(f.value||(s.value=!0),l.value&&(l.value=!1,g&&=(a.x.value=g.x,a.y.value=g.y,a.w.value=g.w,a.h.value=g.h,null))),x(),_()},C=ee(()=>{x()},[a.x,a.y,a.w,a.h,o,s,c,l,f,u],{triggerImmediately:!0});d.addEventListener(`change`,S),S();let w=()=>{x(),_()},T=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.documentElement;T?.addEventListener?.(`env-chrome-surface`,w);let E=()=>{c.value&&(c.value=!1,u.value=!0),r();let t=Ke(e),n=(o.value??10)+t;typeof p.bringToFront==`function`?p.bringToFront(n):(p.style.zIndex=String(n),p.toggleAttribute(`data-focused`,!0)),_()},D=e=>{let t=e.detail;f.value||l.value||s.value||c.value||(typeof t?.x==`number`&&(a.x.value=t.x),typeof t?.y==`number`&&(a.y.value=t.y))},O=e=>{let t=e.detail;f.value||l.value||s.value||c.value||(typeof t?.w==`number`&&(a.w.value=t.w),typeof t?.h==`number`&&(a.h.value=t.h))},k=()=>{f.value&&=!1,l.value&&(l.value=!1,g&&=(a.x.value=g.x,a.y.value=g.y,a.w.value=g.w,a.h.value=g.h,null)),c.value=!0,x(),_()},A=()=>{if(f.value){N();return}if(d.matches){c.value=!1,s.value=!0,x(),_();return}if(c.value&&=!1,l.value){P();return}g={x:a.x.value,y:a.y.value,w:a.w.value,h:a.h.value},l.value=!0,x(),_()},j=()=>{c.value&&(c.value=!1,u.value=!0),!f.value&&!l.value&&!s.value&&(g={x:a.x.value,y:a.y.value,w:a.w.value,h:a.h.value}),l.value=!1,s.value=!1,f.value=!0,x(),_()},N=()=>{f.value&&(f.value=!1,g&&=(a.x.value=g.x,a.y.value=g.y,a.w.value=g.w,a.h.value=g.h,null),d.matches&&(s.value=!0),x(),_())},P=()=>{if(f.value){N();return}c.value&&(c.value=!1,u.value=!0),d.matches?s.value&&=!1:l.value&&(l.value=!1,g&&=(a.x.value=g.x,a.y.value=g.y,a.w.value=g.w,a.h.value=g.h,null)),x(),_()},F=!1,I=!1,L=t=>{if(t.preventDefault(),!(F||I)){F=!0;try{f.value&&=!1,u.value=!1,i.onClose?.()}catch(e){console.error(`[mount-ui-window] onClose failed`,e)}finally{if(!I){I=!0,C?.(),d.removeEventListener(`change`,S),T?.removeEventListener?.(`env-chrome-surface`,w);try{p.isConnected&&p.remove()}catch{}}J(e)}}},te=0,ne=()=>{let e=typeof performance<`u`?performance.now():Date.now();return e-te<280?!1:(te=e,!0)},re=e=>{if(!(F||I)&&ne()){if(e===`close`){L(new Event(`window-close`,{cancelable:!0}));return}if(e===`exit-native`){N();return}if(e===`maximize`){f.value||l.value||s.value?P():A();return}c.value?P():k()}},ie=e=>{let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t){if(!(e instanceof Element))continue;let t=e.getAttribute?.(`data-ui-win-action`);if(t===`close`||t===`exit-native`||t===`maximize`||t===`minimize`)return t;if(e.matches?.(`.title-close`))return`close`;if(e.matches?.(`.title-exit-native`))return`exit-native`;if(e.matches?.(`.title-maximize`))return`maximize`;if(e.matches?.(`.title-minimize`))return`minimize`}return null},R=e=>{if(F||I||e.defaultPrevented)return;let t=ie(e);t&&(e.preventDefault(),e.stopPropagation(),re(t))},z=null,B=()=>{let e=p.shadowRoot;if(!e||F||I)return;let t=e.querySelectorAll(`[data-ui-win-action], .title-minimize, .title-maximize, .title-close, .title-exit-native`);for(let e of t){let t=e.getAttribute(`data-ui-win-action`);if(t||(e.classList.contains(`title-close`)?t=`close`:e.classList.contains(`title-exit-native`)?t=`exit-native`:e.classList.contains(`title-maximize`)?t=`maximize`:e.classList.contains(`title-minimize`)&&(t=`minimize`)),!t)continue;e.setAttribute(`data-ui-win-action`,t);let n=t,r=e=>{e.defaultPrevented||(e.preventDefault(),e.stopPropagation(),re(n))};e.onclick=r,e.onpointerup=e=>{e.button===0&&r(e)}}};if(B(),queueMicrotask(B),requestAnimationFrame(B),typeof MutationObserver<`u`){z=new MutationObserver(()=>B());let e=()=>{p.shadowRoot?z?.observe(p.shadowRoot,{childList:!0,subtree:!0}):requestAnimationFrame(e)};e()}return p.addEventListener(`window-focus`,E),p.addEventListener(`window-move`,D),p.addEventListener(`window-resize`,O),p.addEventListener(`window-minimize`,k),p.addEventListener(`window-maximize`,A),p.addEventListener(`window-restore`,P),p.addEventListener(`window-native`,j),p.addEventListener(`window-exit-native`,N),p.addEventListener(`window-close`,L),p.addEventListener(`click`,R),p.addEventListener(`pointerup`,R),()=>{if(!I){I=!0,F=!0,C?.(),z?.disconnect(),z=null,d.removeEventListener(`change`,S),T?.removeEventListener?.(`env-chrome-surface`,w),p.removeEventListener(`window-focus`,E),p.removeEventListener(`window-move`,D),p.removeEventListener(`window-resize`,O),p.removeEventListener(`window-minimize`,k),p.removeEventListener(`window-maximize`,A),p.removeEventListener(`window-restore`,P),p.removeEventListener(`window-native`,j),p.removeEventListener(`window-exit-native`,N),p.removeEventListener(`window-close`,L),p.removeEventListener(`click`,R),p.removeEventListener(`pointerup`,R);try{f.value&&=!1,p.isConnected&&p.remove()}catch{}J(e)}}}var Y;function Ye(){return(Ye=e((()=>{j(),ce(),Y=8})))()}function X(e,t){let n=typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(t):t.replace(/\\/g,`\\\\`).replace(/"/g,`\\"`),r=e.querySelector(`:scope > ui-window[data-ui-window-view="${n}"]`)||e.querySelector(`:scope > ui-window[data-wf-managed-view="${n}"]`)||e.querySelector(`:scope > section.wf-frame[data-wf-managed-view="${n}"]`);return r instanceof HTMLElement?r:null}function Xe(e){let t=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??e.parentElement;if(!(t instanceof HTMLElement))return 0;let n=getComputedStyle(t).getPropertyValue(`--env-window-z-boost`).trim(),r=Number.parseInt(n,10);return Number.isFinite(r)?r:0}function Ze(e){let t=String(e||``).trim();if(!t)return`browser`;let n=2166136261;for(let e=0;e<t.length;e++)n^=t.charCodeAt(e),n=Math.imul(n,16777619);return`browser:${(n>>>0).toString(36)}`}function Qe(e){try{return new URL(e).hostname.replace(/^www\./i,``)||`Browser`}catch{return`Browser`}}function $e(e){let t=String(e||``).trim().toLowerCase();return t===`browser`||t===`web`||t===`iframe`||t===`web-view`||t===`webview`?`browser`:t}function et(e){let t=String(e||``).trim().toLowerCase();return Q[t]?Q[t]:t.startsWith(`browser:`)?Q.browser:`app-window`}function tt(e){return $e(e)===`browser`?()=>l(()=>import(`./browser-view-DhO2i9yb.js`),[],import.meta.url):null}function nt(e){if(!e||typeof e!=`object`)return``;let t=e,n=t.params&&typeof t.params==`object`&&!Array.isArray(t.params)?t.params:{};return String(n.url||n.href||n.src||t.url||t.href||t.src||``).trim()}function Z(e,t){let n=G(e)||String(e||``).trim().toLowerCase(),r=n.startsWith(`browser:`)?`browser`:n;if(t?.[n])return t[n];if(t?.[r])return t[r];if(at[r])return at[r];let i=String(e||``).trim();return i?i.charAt(0).toUpperCase()+i.slice(1):`View`}function rt(e,t){let n=document.createElement(`div`);return n.className=`wf-view-placeholder`,n.setAttribute(`part`,`placeholder`),n.innerHTML=`<p class="wf-view-placeholder__title">${Z(e,t)}</p>
<p class="wf-view-placeholder__hint">No window module is registered for this shortcut in environment-shell yet.</p>`,n}function it(e,t={}){let n=g(120),r=new Map,i=!1,a=null,o=()=>{t.onTaskingChange?.(s())},s=()=>{let n=[];for(let i of r.values())X(e,i.key)&&n.push({id:i.key,title:i.model.title||Z(i.key,t.viewTitles),icon:et(i.key),focused:a===i.key,minimized:!!i.model.minimized.value,visible:!!i.model.visible.value});return n},c=()=>{for(let t of r.values()){let n=X(e,t.key);if(!n)continue;n.toggleAttribute(`data-focused`,!1);let r=n.clearFocused;typeof r==`function`&&r.call(n)}},l=e=>{for(let[t,n]of r)e&&t===e||n.model.nativeMode?.value&&(n.model.nativeMode.value=!1)},u=(t,r)=>{if(a===r&&!t.minimized.value){let t=X(e,r);if(t&&t===e.lastElementChild)return}n.value+=1,t.z.value=n.value,t.minimized.value=!1,t.visible.value=!0,a=r,t.nativeMode?.value&&l(r);let i=X(e,r);if(i){let n=Xe(e),r=(t.z.value??10)+n;c(),i.style.zIndex=String(r),i.toggleAttribute(`data-focused`,!0);let a=i.bringToFront;typeof a==`function`&&a.call(i,r),i.parentElement===e&&e.appendChild(i)}o()},d={},f=t.overlayMountHost?je(t.overlayMountHost):null;d.resolveOverlayMountPoint=e=>{if(f)return f;if(t.environmentShellHost){let e=T(t.environmentShellHost);if(e)return e}return w(e??null)};let p=e=>{let n=$e(G(e)||String(e||``).trim().toLowerCase());return t.viewLoaders?.[n]||tt(n)},m=()=>{let i=t.readerWindow;if(!i?.content)return;let s=K,c=r.get(s);if(c&&X(e,s)){u(c.model,s);return}if(c&&!X(e,s)){r.delete(s);try{c.disposeFrame()}catch{}}let l=i.seed||{},d=Fe(i.title||Z(s,t.viewTitles),{x:l.x??96,y:l.y??96,w:l.w??420,h:l.h??340,z:l.z??n.value+1});n.value=d.z.value;let f=()=>{};f=Je(e,d,i.content,()=>u(d,s),{managedViewKey:s,onChromeChange:o,onClose:()=>{let e=r.get(s);if(e){r.delete(s),a===s&&(a=null);try{e.disposeFrame()}catch{}o()}}}),r.set(s,{key:s,model:d,disposeFrame:f}),u(d,s)},h=(s,c)=>{if(i)return;let f=G(String(s||``).trim());if(f=$e(f),!f||f===`home`||f===`airpad`)return;let h={...c?.params||{}},g=nt(c);g&&(h.url=g,h.href=g);let _=f===`browser`?String(h.windowKey||``).trim()||Ze(g):f;if(Le(f)&&t.readerWindow?.content){m();return}let v=new Set((t.startNativeViewIds||[]).map(e=>G(String(e||``)))).has(f)||String(c?.native||``)===`1`||String(h.native||``)===`1`,y=r.get(_);if(y&&X(e,_)){if(u(y.model,_),v&&y.model.nativeMode&&(y.model.nativeMode.value=!0,y.model.minimized.value=!1,y.model.visible.value=!0,l(_)),f===`browser`&&g)try{let t=X(e,_),n=t?.querySelector?.(`iframe.wf-browser__frame`),r=t?.querySelector?.(`input.wf-browser__url`);if(n&&n.src!==g&&(n.src=g),r&&(r.value=g),g)try{y.model.title=Qe(g)}catch{}}catch{}return}if(y&&!X(e,_)){y.disposeView?.(),r.delete(_);try{y.disposeFrame()}catch{}}let b=p(f),x=document.createElement(`div`);x.className=`wf-view-host env-ui-window__view-host`,x.setAttribute(`part`,`view-host`);{let e=document.createElement(`p`);e.className=`wf-view-placeholder__hint`,e.style.cssText=`margin:1rem;font:400 .9rem/1.4 system-ui,sans-serif;opacity:.8`,e.textContent=`Loading ${Z(f,t.viewTitles)}…`,x.append(e)}let S=r.size*24,C=Fe(f===`browser`&&g?Qe(g):Z(f,t.viewTitles),{x:72+S,y:72+S,w:f===`browser`?720:640,h:f===`browser`?520:480,z:n.value+1});n.value=C.z.value;let w=()=>{};w=Je(e,C,x,()=>u(C,_),{managedViewKey:_,startNative:v,onChromeChange:o,onClose:()=>{let e=r.get(_);if(e){r.delete(_),a===_&&(a=null);try{e.disposeView?.()}catch{}try{e.disposeFrame()}catch{}o()}}}),v&&(C.nativeMode.value=!0,l(_));let T={key:_,model:C,disposeFrame:w,disposeView:void 0};r.set(_,T),u(C,_);let E={...c||{},shellContext:d};if((f===`browser`&&g||g&&!(E.params&&(E.params.url||E.params.href)))&&(E.params={...E.params||{},url:g,href:g}),!b){x.replaceChildren(rt(f,t.viewTitles));return}We(b,x,E).then(e=>{if(i){e();return}let t=r.get(_);t&&(t.disposeView=e),(v||C.nativeMode?.value)&&(C.nativeMode.value=!0,C.minimized.value=!1,C.visible.value=!0,l(_),u(C,_))},e=>{console.error(`[workspace-window-layer] mountViewModule failed for view "${f}"`,e),x.replaceChildren(rt(f,t.viewTitles))})};return d.navigate=(e,t)=>{h(String(e),t)},d.openView=(e,t)=>{h(String(e),t)},{shellContext:d,dispose:()=>{if(!i){i=!0;for(let e of r.values())e.disposeView?.(),e.disposeFrame();r.clear(),a=null,o()}},focusWindow:t=>{let n=G(String(t||``)),i=r.get(n);return!i||!X(e,n)?!1:(u(i.model,n),!0)},minimizeWindow:t=>{let n=G(String(t||``)),i=r.get(n);return!i||!X(e,n)?!1:(i.model.nativeMode?.value&&(i.model.nativeMode.value=!1),i.model.desktopMaximized?.value&&(i.model.desktopMaximized.value=!1),i.model.visible.value=!0,i.model.minimized.value=!0,a===n&&(a=null,c()),o(),!0)},minimizeAllWindows:()=>{if(!i){l(null),a=null,c();for(let t of r.values())X(e,t.key)&&(t.model.desktopMaximized?.value&&(t.model.desktopMaximized.value=!1),t.model.visible.value=!0,t.model.minimized.value=!0);o()}},closeWindow:e=>{let t=G(String(e||``)),n=r.get(t);if(!n)return!1;r.delete(t),a===t&&(a=null);try{n.disposeView?.()}catch{}try{n.disposeFrame()}catch{}return o(),!0},blurWindows:()=>{l(null),a=null,c(),o()},closeAllWindows:()=>{if(!i){l(null);for(let e of[...r.values()]){try{e.disposeView?.()}catch{}try{e.disposeFrame()}catch{}}r.clear(),a=null,o()}},enterNative:t=>{let n=G(String(t||``)),i=r.get(n);return!i||!X(e,n)?!1:(l(n),i.model.nativeMode.value=!0,i.model.minimized.value=!1,i.model.visible.value=!0,u(i.model,n),!0)},exitNative:e=>{if(e){let t=G(String(e||``)),n=r.get(t);n?.model.nativeMode&&(n.model.nativeMode.value=!1),o();return}l(null),o()},listWindowTasks:s,getFocusedKey:()=>a}}var Q,at;function ot(){return(ot=e((()=>{h(),O(),Ie(),ze(),Ne(),Ye(),c(),Q={home:`house`,viewer:`article`,markdown:`article`,browser:`globe`,web:`globe`,explorer:`books`,settings:`gear-six`,apps:`squares-four`,workcenter:`briefcase`,history:`clock-counter-clockwise`,editor:`pencil-simple-line`,network:`wifi-high`,task:`list-checks`,event:`calendar`,bonus:`gift`,person:`address-book`},at={home:`Home`,viewer:`Markdown`,browser:`Browser`,web:`Browser`,explorer:`Explorer`,settings:`Settings`,apps:`Apps`,workcenter:`Work Center`,history:`History`,editor:`Editor`,network:`Network`,task:`Plan`,event:`Events`,bonus:`Bonuses`,person:`Contacts`}})))()}function st(e,t=lt){try{localStorage.getItem(t)||localStorage.setItem(t,e)}catch{}}function ct(e,t){let n=se(),r=le();r&&_e();let i,a;if(r)i=document.createElement(`ui-statusbar`),i.className=`env-ui-statusbar`,i.hidden=!0,a=()=>{i.remove()};else{let e=ae(t.shell,t.introHtml,n);i=e.element,a=e.dispose}let o=document.createElement(`div`);o.className=`env-shell-chrome wf-chrome-no-select`;let s;if(t.taskbar){try{let e=re();e&&B(e)}catch{}s=oe({...t.taskbar,device:n}),o.append(s.element,i)}else o.append(i);let c=(e.classList?.contains(`env-shell-root`)?e:null)||e.closest?.(`.env-shell-root`)||e.closest?.(`env-shell-container`)||e;de(c),globalThis.__ENV_OVERLAY_MOUNT__=je,je(c),te();let l=typeof matchMedia==`function`?matchMedia(`(min-width: 641px) and (not ((pointer: coarse) or (hover: none)))`):null,u=typeof matchMedia==`function`?[`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`,`(display-mode: window-controls-overlay)`].map(e=>matchMedia(e)):[],d=()=>{let e=!l||l.matches,t=L(),n=I(),r=R({desktop:e,standalone:n,displayMode:t});o.toggleAttribute(`data-desktop`,e),o.toggleAttribute(`data-standalone`,n),o.toggleAttribute(`data-status-overlay`,r),o.dataset.chromeLayout=e?`desktop`:`mobile`,o.dataset.displayMode=t,c.toggleAttribute(`data-standalone`,n),c.toggleAttribute(`data-status-overlay`,r),c.dataset.displayMode=t,c.style.setProperty(`--env-status-inset-top`,r?`max(2rem, env(safe-area-inset-top, 0px))`:`0px`),document.documentElement.toggleAttribute(`data-env-status-overlay`,r),document.documentElement.toggleAttribute(`data-env-standalone`,n);try{c.dispatchEvent(new CustomEvent(`env-chrome-surface`,{bubbles:!0,detail:{statusOverlay:r,standalone:n,displayMode:t,desktop:e}}))}catch{}};d(),l?.addEventListener?.(`change`,d);for(let e of u)e.addEventListener?.(`change`,d);document.addEventListener(`fullscreenchange`,d),document.addEventListener(`webkitfullscreenchange`,d);let f=r?()=>{}:F(c);return Ee(e)&&(o.slot=D.overlay),e.appendChild(o),{root:o,device:n,statusBar:i,taskbar:s,disposeDevice:()=>{l?.removeEventListener?.(`change`,d);for(let e of u)e.removeEventListener?.(`change`,d);document.removeEventListener(`fullscreenchange`,d),document.removeEventListener(`webkitfullscreenchange`,d),f(),a(),n.dispose(),de(null)}}}var lt;function ut(){return(ut=e((()=>{ie(),xe(),z(),P(),Ae(),Ne(),O(),ue(),N(),ne(),Pe(),ot(),Ye(),lt=`rs-wallpaper-image`})))()}function dt(e){pt().set(e)}function ft(){let e=pt().get();if(typeof e?.focusSpeedDial==`function`){e.focusSpeedDial();return}let t=document.querySelector(`#home`);if(t)try{t.focus({preventScroll:!0})}catch{try{t.focus()}catch{}}}var $,pt;function mt(){return(mt=e((()=>{$=`__CWSP_LAUNCHER_HOME_HOOKS_V1__`,pt=()=>{let e=globalThis;return{get:()=>$ in e?e[$]:null,set:t=>{e[$]=t}}}})))()}var ht;function gt(){return(gt=e((()=>{ht=`*,
*::before,
*::after {
    box-sizing: border-box;
}
...
.env-shell-root {
  ...
  /*
   * NOTE: \`--env-status-fg\` / \`--env-status-fg-muted\` / \`--env-launcher-fg*\` color defaults are owned by
   * veela \`core/misc/_tokens.scss\` (single source of truth) and inherit via \`:root\` — veela
   * \`@property\` + tokens load before shell chrome (see "Bridge only" note below). The
   * \`&[data-status-overlay]\` block keeps a scoped override documenting wallpaper intent.
   */
  /*
...
html[data-theme=light] .env-shell-root .ui-ws-item-icon .ui-ws-item-icon-mask,
...
html[data-theme=dark] .env-shell-root .ui-ws-item-icon .ui-ws-item-icon-mask,
...
@layer launcher-icons {
  .ui-ws-item-icon-mask[data-launcher-icon] {
    ...
    flex-shrink: 0;
    background-color: var(--icon-color, var(--on-surface-variant, var(--on-surface-color, currentColor)));
    color: var(--icon-color, var(--on-surface-variant, var(--on-surface-color, currentColor)));
 ...
 * Reason for changes: Capacitor — native safe-area token + flat window body inset (settings/viewer/explorer).
 */
...
html[data-cwsp-native-shell=capacitor] .env-shell-root .env-shell-workspace ui-window.env-ui-window[managed][data-no-titlebar]:not([minimized]) > .env-ui-window__body {
  ...
  padding-block-end: max(0.35rem, var(--cwsp-native-safe-bottom));
  box-sizing: border-box;
}
.env-shell-root[data-capacitor-native],
html[data-cwsp-native-shell=capacitor] .env-shell-root {
...
html[data-cwsp-native-shell=capacitor] .env-shell-root .env-shell-workspace ui-window.env-ui-window[managed]:not([minimized]) .view-explorer ui-file-manager {
  ...
  block-size: 100%;
  inline-size: 100%;
  /* Reserve scroll room above mobile Home dock + gesture bar (body also pads bottom). */
  padding-block-end: max(0.35rem, var(--cwsp-native-safe-bottom));
  box-sizing: border-box;
}
.env-shell-root[data-capacitor-native],
