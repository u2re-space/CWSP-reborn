import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{$t as t,D as n,E as r,Gt as i,Ht as a,O as o,Rt as s,Wt as c,_ as l,an as u,c as d,cn as f,d as p,dn as ee,en as m,f as h,ft as g,g as te,h as ne,hn as re,l as _,ln as ie,m as ae,nn as v,o as oe,p as se,s as ce,t as y,u as b,v as le,w as ue,y as de}from"./src-C8p-yYHh.js";import{c as fe,g as x,p as pe,v as S,y as C}from"./ecosystem-skus-Bz92tN57.js";import{n as w,t as T}from"./preload-helper-DFTwEg7x.js";import{w as me}from"./UniformInterop-Dxklp0q4.js";import{n as he,r as ge}from"./channel-mixin-HfL7HKU7.js";import{a as _e,f as ve}from"./UnifiedMessaging-D97RqiW3.js";import{a as ye,n as be,r as xe,t as Se}from"./view-ingress-validation-pEGxQ7HC.js";import{h as Ce,m as we,o as Te,p as Ee,r as De,s as Oe}from"./open-policy-DV4wO_gQ.js";import{A as E,F as D,I as ke,M as Ae,g as O,z as k}from"./OPFS-VRGDKBUr.js";import{a as je,o as Me}from"./Settings-BdjZKlQM.js";import{i as Ne,o as Pe,s as Fe}from"./icon-CJpUOiBC.js";import{i as Ie,r as Le}from"./render-BELJnRc1.js";import{n as Re,t as ze}from"./registry-BDUaTly8.js";import{a as Be,i as A,t as j}from"./channel-actions-DkmBPovk.js";function Ve(e){return{load(){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}},save(t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}},clear(){try{localStorage.removeItem(e)}catch{}}}}var He,M,N,P;function F(){return(F=e((()=>{y(),_e(),He=e=>{if(typeof e==`string`||typeof Blob<`u`&&e instanceof Blob)return e;if(e&&typeof e==`object`&&`data`in e){let t=e.data;if(typeof t==`string`||t&&typeof Blob<`u`&&t instanceof Blob)return t}return null},M=e=>String(e||`attachment`).toLowerCase().replace(/[^a-z0-9-]/g,`-`).replace(/-+/g,`-`).replace(/^-+|-+$/g,``)||`attachment`,N=async(e,t=`view-ipc`)=>{let r=[];for(let i of e){let e=He(i);if(e)try{let a=i&&typeof i==`object`&&`source`in i?String(i.source||t):t,o=await n(e,{namePrefix:M(a),uriComponent:!0});r.push({hash:String(o.hash||``),name:String(o.name||o.file?.name||`attachment`),mimeType:String(o.type||o.file?.type||`application/octet-stream`),size:Number(o.size||o.file?.size||0),source:a,data:o.file})}catch(e){console.warn(`[UniformViewTransport] Attachment normalization failed:`,e)}}return r},P=async e=>{let t=await N(e.attachments||[],e.source),n={...e.data||{},...t.length>0?{attachments:t,file:t[0]?.data,files:t.map(e=>e.data)}:{}},r=me({type:e.type,source:e.source,destination:e.destination,contentType:e.contentType,data:n,purpose:e.purpose||(t.length>0?[`attach`,`deliver`]:[`deliver`,`mail`]),protocol:`window`,op:e.op||(t.length>0?`attach`:`deliver`),srcChannel:e.source,dstChannel:e.destination,metadata:{...e.metadata||{},attachmentCount:t.length}});return ve(r)}})))()}function Ue(e){return e===`light`||e===`dark`?e:typeof globalThis.matchMedia==`function`&&globalThis.matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`}function I(e){if(e===`light`||e===`dark`||e===`system`)return e;if(typeof e==`string`){let t=e.trim().toLowerCase();if(t===`light`||t===`dark`||t===`system`)return t}}function L(e){if(e!=null){if(typeof e==`string`)return I(e.trim());if(typeof e==`object`){let t=e;return I(t.colorScheme??t.scheme??t.theme)}}}function We(e){if(e)return e.colorScheme?e.colorScheme:I(e.params?.colorScheme??e.params?.theme)}var R;function z(){return(z=e((()=>{R=`/*
...
}`})))()}var B,V,H,U,W,G,K,q,J,Y,X,Z,Q,Ge,Ke,qe,Je,Ye;function Xe(){return(Xe=e((()=>{y(),d(),i(),s(),Le(),Fe(),ge(),Re(),Be(),je(),F(),fe(),Te(),Se(),z(),w(),B=e=>e===`launch-queue`||e===`share-target`||e===`clipboard`||e===`pending`,V=null,H=`rs-viewer-outline`,U=96e3,W=12e5,G=2097152,K=48e4,q=6e5,J={USE_PROFILES:{html:!0,mathMl:!0,svg:!0},FORBID_TAGS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`link`,`meta`,`base`,`form`,`noscript`,`template`],FORBID_CONTENTS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`noscript`,`template`]},Y=`g`,X=!1,Z=()=>{if(!X)try{Pe(),Ne(),X=!0}catch(e){console.warn(`[Viewer] Failed to initialize icon runtime:`,e)}},Q=e=>navigator?.clipboard?.writeText?.(e)??Promise.resolve(void 0),Ge=async()=>V||(V=(async()=>{let[{marked:e},{default:t}]=await Promise.all([T(()=>import(`./marked.esm-Cz1R6CpB.js`).then(e=>(e.n(),e.r)),[],import.meta.url),T(()=>import(`./src-u3lhysGj.js`).then(e=>(e.t(),e.r)),[],import.meta.url)]);return e?.use?.(t({throwOnError:!1,nonStandard:!0,output:`mathml`,strict:!1})),async t=>await e.parse(t??``)})(),V),Ke=`rs-viewer-state`,qe=`# This is content`,Je=`cw-view-viewer`,Ye=ze(Je,e=>class extends e{id=`viewer`;name=`Viewer`;icon=`eye`;options;shellContext;element=null;slotProjectingHost=null;contentRef=a(``);contentRefSubscriptionDispose=null;renderSeq=0;stateManager=Ve(Ke);_sheet=null;pasteController=null;documentOpenListener=null;shareIntentListener=null;pendingBinaryPreview=null;binaryPreviewActive=!1;windowDnDController=null;isViewVisible=!1;isPointerInView=!1;sourceUrl=null;boundMountRoot=null;boundDirectory=null;sidecarAssets=new Map;assetObjectUrls=[];sourceObserver=null;boundFsChangeTimer=0;customSheet=null;userStyleModules={screenCss:``,printCss:``};markdownSettings={preset:`default`,fontFamily:`system`,fontSizePx:16,lineHeight:1.7,contentMaxWidthPx:860,printScale:1,page:{size:`auto`,orientation:`portrait`,marginMm:12},modules:{typography:!0,lists:!0,tables:!0,codeBlocks:!0,blockquotes:!0,media:!0,printBreaks:!0},plugins:{smartTypography:!1,softBreaksAsBr:!1,externalLinksNewTab:!0},customCss:``,printCss:``,extensions:[]};markdownSettingsPromise=null;outlineVisible=!1;viewerColorScheme=`system`;documentThemeSnapshot=null;disposeContentRefSubscription(){try{this.contentRefSubscriptionDispose?.()}catch{}this.contentRefSubscriptionDispose=null}subscribeContentRefToCurrentTargets(e,t){this.disposeContentRefSubscription();let n=c(this.contentRef,()=>{e&&t&&this.renderMarkdown(this.contentRef.value,e,t),this.saveState()});this.contentRefSubscriptionDispose=typeof n==`function`?n:null}lifecycle={onMount:()=>this.onMount(),onUnmount:()=>this.onUnmount(),onShow:()=>this.onShow(),onHide:()=>this.onHide(),onRefresh:()=>this.onRefresh()};constructor(e={}){super(),this.options=e,this.shellContext=e.shellContext,this.sourceUrl=this.normalizeSourceUrl(e.source),this.markdownSettingsPromise=this.loadMarkdownSettings();try{this.outlineVisible=globalThis.sessionStorage?.getItem(H)===`1`}catch{this.outlineVisible=!1}this.syncViewerColorSchemeFromOptions();let t=this.stateManager.load();if(this.contentRef.value=e.initialContent||t?.content||qe,this.applyRouteParams(e.params),!e.initialContent){let t=(e.params?.content||``).trim();t&&(this.contentRef.value=t)}}render=function(e){Z(),this.slotProjectingHost=null,e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,this.applyRouteParams(e.params)),this.syncViewerColorSchemeFromOptions(),this._sheet=v(R),this.element=this.createViewerShellElement();let t=this.element.querySelector(`[data-render-target]`),n=this.element.querySelector(`[data-raw-target]`);return this.setupEventHandlers(n||void 0),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.flushPendingBinaryPreview(),!this.binaryPreviewActive&&t&&n&&this.renderMarkdown(this.contentRef.value,t,n),this.subscribeContentRefToCurrentTargets(t,n),this.refreshDocumentTheme(),this.element};shellNavigateHydrate(e,t){if(!this.element?.isConnected)return;e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,e.params!==void 0&&this.applyRouteParams(e.params),this.syncViewerColorSchemeFromOptions());let n=this.queryViewerSlotted(`[data-render-target]`),r=this.queryViewerSlotted(`[data-raw-target]`);n&&r&&(this.subscribeContentRefToCurrentTargets(n,r),this.renderMarkdown(this.contentRef.value,n,r)),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.refreshDocumentTheme()}renderIntoWebComponentHost(e,t){Z(),t&&(this.options={...this.options,...t},this.shellContext=t.shellContext||this.shellContext,this.applyRouteParams(t.params)),this.syncViewerColorSchemeFromOptions(),this.slotProjectingHost=e,this._sheet??=v(R),this.element=this.createViewerShellElement(),e.replaceChildren(this.element);let n=e.querySelector(`[data-raw-target]`),r=e.querySelector(`[data-render-target]`);e.setAttribute(`data-view-id`,`viewer`),e.toggleAttribute(`data-cw-view-host`,!0),this.syncAdoptedSheetsToShadow();let i=r,a=n;this.setupEventHandlers(a),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.flushPendingBinaryPreview(),!this.binaryPreviewActive&&i&&a&&this.renderMarkdown(this.contentRef.value,i,a),this.subscribeContentRefToCurrentTargets(i,a),this.refreshDocumentTheme(),this.pullCapacitorPendingOpen()}getToolbar(){return null}setContent(e,t,n){t&&(this.options.filename=t),n!==void 0&&(this.sourceUrl=this.normalizeSourceUrl(n),this.options.source=n||void 0),this.contentRef.value=e,this.syncToolbarDocumentTitle()}repaintMarkdown(){let e=this.queryViewerSlotted(`[data-render-target]`),t=this.queryViewerSlotted(`[data-raw-target]`);e&&this.renderMarkdown(this.contentRef.value,e,t)}ingestOpenedMarkdownBody(e,t,n){if(this.binaryPreviewActive=!1,this.pendingBinaryPreview=null,e.length>0&&xe(e)){this.setContent(`> This payload does not look like UTF-8 markdown (binary file or unsupported format).
>
> Open a \`.md\` / \`.txt\` file, paste as plain text, or attach binaries via Work Center.

`,t,n);return}this.setContent(e,t,n??void 0)}getContent(){return this.contentRef.value}setViewerColorScheme(e){this.viewerColorScheme=e,this.options.colorScheme=e,this.refreshDocumentTheme()}refreshDocumentTheme(){typeof document>`u`||(this.applyViewerDocumentTheme(this.viewerColorScheme),this.bakeViewerScreenColors())}bakeViewerScreenColors(){let e=this.element;e instanceof HTMLElement&&t(e);let n=this.queryViewerSlotted(`[data-render-target]`);n instanceof HTMLElement&&n!==e&&t(n)}unbakeViewerScreenColors(){let e=this.element;e instanceof HTMLElement&&m(e);let t=this.queryViewerSlotted(`[data-render-target]`);t instanceof HTMLElement&&t!==e&&m(t)}applyViewerDocumentTheme(e){let t=document.documentElement;if(e===`system`)return;this.documentThemeSnapshot||={prevAttr:t.getAttribute(`data-theme`),prevInlineCs:t.style.getPropertyValue(`color-scheme`)};let n=Ue(e);t.setAttribute(`data-theme`,n),t.style.setProperty(`color-scheme`,n)}restoreViewerDocumentTheme(){let e=this.documentThemeSnapshot;if(this.documentThemeSnapshot=null,!e||typeof document>`u`)return;let t=document.documentElement;e.prevAttr===null||e.prevAttr===``?t.removeAttribute(`data-theme`):t.setAttribute(`data-theme`,e.prevAttr),e.prevInlineCs.trim()?t.style.setProperty(`color-scheme`,e.prevInlineCs):t.style.removeProperty(`color-scheme`)}syncViewerColorSchemeFromOptions(){let e=We(this.options);e&&(this.viewerColorScheme=e)}createViewerShellElement(){return g`
