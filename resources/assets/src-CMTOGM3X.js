import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{At as t,Ht as n,J as r,S as i,a,b as o,et as s,ft as c,jt as l,kt as u}from"./HistoryManager-D8ebz2Z7.js";import{n as ee,t as te}from"./preload-helper-NDuSAHbO.js";import{I as ne,L as d,t as f,z as p}from"./src-CEYeiPXY.js";import{t as m}from"./src-C9heO9y9.js";import{n as re}from"./CSSIconRegistry-D88SYH0A.js";var h,g=e((()=>{h=`/**
 * Font Styles Index
 *
...
.c-overlaying [data-axis] {
  pointer-events: auto;
}`}));function _(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function ie(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function ae(e,t,n=`font/woff2`){if(v.has(t))return v.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return v.set(t,i),i}async function oe(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(y.has(o))return y.get(o);let s=_(t),c=await ae(a?await ie(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),y.set(o,l),l}async function se(e){let t=e.map(e=>oe(e));return Promise.all(t)}async function ce(){return b||(b=te(()=>import(`./font-registry-D4KJRdpC.js`),[],import.meta.url)?.catch?.(e=>{console.error(`Failed to load font registry:`,e)}),b)}async function le(){let e=await ce();return se(Object.values(e.fontRegistry))}var v,y,b,x=e((()=>{ee(),v=new Map,y=new Map,b=null})),S,ue=e((()=>{S=`@layer tokens, base, layout, utilities, shells, shell, views, view, viewer, components, ux-layer, markdown, essentials, print, print-breaks, overrides;
@layer components {
  button {
    display: inline-flex;
    align-items: center;
...
}`})),C,w,de=e((()=>{x(),c(),g(),ue(),x(),C=`
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
`,w=async e=>{await u(C)?.catch(()=>void 0),await le().catch(()=>void 0),await u(h)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await u(S)?.catch(()=>void 0)}}));function T(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var E=e((()=>{})),D,O,k=e((()=>{f(),m(),E(),D=class extends ne(){theme=`default`;render=function(){return a`<slot></slot>`};constructor(){super()}onRender(){return super.onRender()}connectedCallback(){return super.connectedCallback?.()??this}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(re()),e}},T([p({source:`attr`})],D.prototype,`theme`,void 0),D=T([d(`ui-element`)],D),O=D})),A,fe=e((()=>{A=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
/* ==========================================================================
...
}`})),j,M,pe=e((()=>{k(),f(),fe(),c(),E(),j=l(A),M=class extends O{constructor(){super()}styles=()=>j;render=()=>a`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},M=T([d(`ui-statusbar`)],M)})),N,me=e((()=>{N=`/* Taskbar */
@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
...
}`})),P,F,he=e((()=>{k(),f(),me(),c(),E(),P=l(N),F=class extends O{constructor(){super()}styles=()=>P;render=()=>a`<div part="taskbar" class="taskbar"><slot></slot></div>`},F=T([d(`ui-taskbar`)],F)})),I,L=e((()=>{I=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
/* ==========================================================================
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})),R,z,B,ge=e((()=>{k(),c(),f(),L(),E(),R=l(I),z=e=>{let t=String(e||``).trim().charAt(0);return t?t.toUpperCase():`?`},B=class extends O{title=`Task`;icon=`app-window`;constructor(){super()}styles=()=>R;render=function(){let e=z(this.title);return a`
            <div part="icon" class="task-icon c2-contrast c2-transparent" data-letter=${e}>
                <span class="task-letter" part="letter" aria-hidden="true">${e}</span>
                <ui-icon class="c2-contrast c2-transparent task-icon-glyph" part="glyph" icon=${String(this.icon||``).trim()||`app-window`} icon-style="duotone"></ui-icon>
            </div>
            <div part="title" class="task-title c2-contrast c2-transparent">${this.title}</div>
        `}},T([p({source:`attr`})],B.prototype,`title`,void 0),T([p({source:`attr`})],B.prototype,`icon`,void 0),B=T([d(`ui-task`)],B)})),V,_e=e((()=>{V=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}`})),ve=e((()=>{c(),_e(),l(V)})),H,ye=e((()=>{H=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}
...
:host(ui-taskbar[data-type=mobile]) ::slotted(ui-task[data-focus]) {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}`})),be=e((()=>{c(),ye(),l(H)}));function U(){try{return globalThis.navigator?.windowControlsOverlay??null}catch{return null}}function xe(){if(typeof globalThis.matchMedia!=`function`)return`unknown`;try{if(globalThis.matchMedia(`(display-mode: window-controls-overlay)`).matches)return`window-controls-overlay`;if(globalThis.matchMedia(`(display-mode: fullscreen)`).matches)return`fullscreen`;if(globalThis.matchMedia(`(display-mode: standalone)`).matches)return`standalone`;if(globalThis.matchMedia(`(display-mode: minimal-ui)`).matches)return`minimal-ui`;if(globalThis.matchMedia(`(display-mode: browser)`).matches)return`browser`}catch{}return`unknown`}function Se(e){if(!e?.visible||typeof e.getTitlebarAreaRect!=`function`)return null;try{let t=e.getTitlebarAreaRect();return t?{x:t.x,y:t.y,width:t.width,height:t.height}:null}catch{return null}}function W(e){let t=U(),n=!!t?.visible,r=xe(),i=n||r===`standalone`||r===`fullscreen`||r===`window-controls-overlay`||r===`minimal-ui`,a=`off`;return e&&(a=n?`wco`:i?`standalone`:`fallback`),{requested:e,wcoVisible:n,displayMode:r,titlebarRect:Se(t),isStandaloneLike:i,surface:a}}function Ce(e){let t=()=>{e.onChange(W(e.getRequested()))},n=[];if(typeof globalThis.matchMedia==`function`)for(let e of[`(display-mode: window-controls-overlay)`,`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`])try{n.push(globalThis.matchMedia(e))}catch{}let r=()=>t();for(let e of n)try{e.addEventListener?.(`change`,r)}catch{try{e.addListener?.(r)}catch{}}let i=U(),a=()=>t();try{i?.addEventListener?.(`geometrychange`,a)}catch{}return queueMicrotask(t),()=>{for(let e of n)try{e.removeEventListener?.(`change`,r)}catch{try{e.removeListener?.(r)}catch{}}try{i?.removeEventListener?.(`geometrychange`,a)}catch{}}}var we=e((()=>{})),G,Te=e((()=>{G=`/*
 * Filename: Windows2.scss
 * FullPath: modules/projects/fl.ui/src/ui/containers/window/Windows2.scss
 * Change date and time: 13.00.00_29.07.2026
 * Reason for changes: Titlebar above content so drag/clicks are not swallowed (settings etc.).
 */
/* WHY: Inline adopted sheet for <ui-window>; light-dark() + explicit theme attrs keep parity
 * without requiring full veela runtime on the host document. */
:host(ui-window) {
  ...
  --ui-win-bg: light-dark(#f7f8fb, #121826);
  --ui-win-fg: light-dark(#152033, #e8edf5);
  --ui-win-muted: light-dark(#5b6b86, #8b9bb8);
  --ui-win-border: light-dark(rgb(21 32 51 / 0.12), rgb(232 237 245 / 0.12));
  --ui-win-titlebar-bg: light-dark(#eef1f7, #1a2233);
  --ui-win-content-bg: light-dark(#ffffff, #0f1624);
  --ui-win-footer-bg: light-dark(#f0f3f9, #151d2e);
  --ui-win-shadow:
      light-dark(
  ...
  --ui-win-control-bg-hover: light-dark(rgb(21 32 51 / 0.12), rgb(232 237 245 / 0.16));
  --ui-win-control-fg: var(--ui-win-fg);
  --ui-win-close-bg: transparent;
  --ui-win-close-bg-hover: light-dark(rgb(220 38 38 / 0.92), rgb(239 68 68 / 0.95));
  --ui-win-close-fg: var(--ui-win-fg);
  --ui-win-close-fg-hover: #fff;
...
:host(ui-window[data-mobile-max]) {
  --ui-win-radius: 0;
  inset: 0 0 var(--env-mobile-dock-reserve, 3.25rem) 0 !important;
  inline-size: 100% !important;
...
.window-resizer:hover {
  opacity: 0.9;
}`})),K,q,J,Y,X,Z,Q,Ee=e((()=>{f(),c(),k(),m(),we(),Te(),E(),K=l(G),q=`minus`,J=`corners-out`,Y=`corners-in`,X=`x`,Z=Object.freeze({w:240,h:160}),Q=class extends D{titleHandler;contentHandler;footerHandler;resizer;#e=s(0);#t=s(0);#n=null;#r=null;#i=null;#a=null;#o=null;#s=null;#c=null;#l=!1;#u=0;#d=0;#f=null;styles=function(){return K};render=function(){return a`<div class="window-container" part="window-container">
