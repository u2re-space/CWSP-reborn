...
.env-shell-root {
  ...
  --wf-md-seed: var(--color-primary, #5a7fff);
  --color-surface: var(--wf-md-surface, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 940));
  --color-on-surface: var(--wf-md-on-surface, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 100));
  --color-on-surface-variant: var(--wf-md-on-surface-variant, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 280));
  --color-surface-container: var(--wf-md-surf-container, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 860));
  --color-surface-container-high: var(--wf-md-surf-container-high, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 820));
  ...
  --on-surface-color: var(--wf-md-on-surface, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 100));
  --on-surface-variant: var(--wf-md-on-surface-variant, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 280));
}
@media (prefers-color-scheme: light) {
  .env-shell-root {
    /* WHY: wf-demo.css pins a dark baseline; flip Material-ish tokens so launcher icons/labels contrast on light tiles. */
    --wf-md-surface: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 60);
    --wf-md-surf-container-low: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 100);
    --wf-md-surf-container: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 160);
    --wf-md-surf-container-high: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 220);
    --wf-md-outline-variant: color-mix(in oklab, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 900) 14%, transparent);
    --wf-md-on-surface: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 900);
    --wf-md-on-surface-variant: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 700);
