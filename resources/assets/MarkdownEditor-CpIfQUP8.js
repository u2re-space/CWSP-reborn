...
@layer layer.view.viewer {
  /* Root: view layout tokens only — never clobber Veela \`--color-on-surface\` for the shell. */
  :root:has([data-view=viewer]),
  html:has([data-view=viewer]) {
    /* layout */
    --view-layout: "flex";
