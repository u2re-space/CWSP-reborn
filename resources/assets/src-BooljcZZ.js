import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{B as t,F as n,G as r,K as i,at as a,et as o,t as s}from"./src-0dseTezJ.js";import{a as c,c as l,d as u,f as d,l as f,u as p}from"./registry-_H3MKUFS.js";import{n as m,t as h}from"./preload-helper-NDuSAHbO.js";import{n as g,t as _}from"./templates-Cp6qXLQ6.js";import{a as v,d as y}from"./UnifiedMessaging-Bb5xrVpZ.js";import{a as ee,i as te,r as b}from"./BootLoader-MS3lo88A.js";import{B as ne,K as re}from"./airpad-cwsp-client-parity-CXnZuSSw.js";import{a as ie,i as ae,r as x,t as oe}from"./SettingsTypes-D6q9S6cT.js";import{t as S,v as se}from"./remote-connection-runtime-DaB8YVvg.js";import{a as ce,c as le,i as ue,n as C,o as de,r as fe,s as pe}from"./Settings-DSXJPUz6.js";import{n as me,r as he}from"./Theme-npdn4gFC.js";import{n as ge,r as _e}from"./capacitor-permissions-Brl6YLsA.js";import{a as ve,c as w,d as ye,f as T,i as be,l as xe,n as E,o as D,p as Se,r as Ce,s as we,t as Te,u as Ee}from"./cwsp-app.js";import{a as De,n as Oe,o as ke,s as Ae}from"./shells-DYH-ktVl.js";import{i as je,n as Me,r as Ne}from"./admin-doors-BoU4RSfd.js";import{c as Pe,i as Fe,l as Ie,n as Le,o as Re,r as ze,s as Be}from"./CustomInstructions-Bde4nVi1.js";import{i as Ve,n as He}from"./registry-Wn4_ehZz.js";import{a as Ue,r as We}from"./channel-actions-DC9DgSYV.js";var Ge=e((()=>{})),O,Ke,k,A,j,M=e((()=>{Ge(),O=`data-settings-view-css`,Ke=e=>{let t=String(e||``).trim(),n=t.match(/^@layer\s+settings-view\s*\{([\s\S]*)\}\s*$/);return n&&(t=n[1].trim()),t},k=`
...
@layer settings-view {
  ...
  @container (max-inline-size: 480px) {
    ...
    </header>`})),mt,ht=e((()=>{s(),mt=()=>n`<section class="card settings-tab-panel" data-tab-panel="appearance">
      <h3>Appearance</h3>
      <label class="field">
        <span>Theme</span>
    ...
    </section>`})),gt,_t=e((()=>{s(),gt=()=>n`<section class="card settings-tab-panel" data-tab-panel="markdown">
        ...
        <textarea class="form-input" rows="10" data-field="appearance.markdown.extensions" placeholder='[
  {
    ...
    "enabled": true
    ...
    </section>`})),vt,yt=e((()=>{s(),vt=()=>n`<section class="card settings-tab-panel is-active" data-tab-panel="ai">
      <h3>AI</h3>
    ...
    </section>`})),bt,xt=e((()=>{s(),bt=()=>n`<section class="card settings-tab-panel" data-tab-panel="mcp">
      <h3>MCP</h3>
      <div class="mcp-section" data-mcp-section></div>
      <div class="mcp-actions">
        <button class="btn" type="button" data-action="add-mcp-server">Add MCP server</button>
      </div>
    </section>`})),St,Ct=e((()=>{s(),St=()=>n`<section class="card settings-tab-panel" data-tab-panel="server">
      <h3>Server</h3>
      ...
      <label class="field checkbox form-checkbox">
    ...
    </section>`})),wt,Tt=e((()=>{s(),t(),Be(),g(),wt=(e={})=>{let t=r({instructions:[],activeId:``,editingId:null,newLabel:``,newInstruction:``,isAdding:!1}),i=n`<div class="custom-instructions-editor">
        <div class="ci-row">
            <div class="ci-header">
        ...
        <div class="ci-actions">
    ...
    </div>`,a=i.querySelector(`[data-list]`),o=i.querySelector(`[data-action='select-active']`),s=i.querySelector(`[data-add-form]`),c=i.querySelector(`[data-field='label']`),l=i.querySelector(`[data-field='instruction']`),u=()=>{a.replaceChildren();let r=t.instructions??[];if(!r.length){a.append(n`<div class="ci-empty">No custom instructions. Add one or use templates.</div>`);return}for(let i of r){let r=t.editingId===i.id,o=t.activeId===i.id,s=n`<div class="ci-item ${o?`active`:``}" data-id="${i.id}">
            ...
            </div>`;s.addEventListener(`click`,n=>{let r=n.target.closest(`[data-action]`)?.getAttribute(`data-action`);if(r===`activate`&&Pe(i.id).then(p).then(()=>e.onUpdate?.()),r===`edit`&&(t.editingId=i.id,u()),r===`delete`&&confirm(`Delete "${i.label}"?`)&&Fe(i.id).then(p).then(()=>e.onUpdate?.()),r===`save-edit`){let n=s.querySelector(`[data-edit-field='label']`),r=s.querySelector(`[data-edit-field='instruction']`);Ie(i.id,{label:n.value.trim()||i.label,instruction:r.value.trim()}).then(()=>(t.editingId=null,p())).then(()=>e.onUpdate?.())}r===`cancel-edit`&&(t.editingId=null,u())}),a.append(s)}},d=()=>{o.replaceChildren(),o.append(n`<option value="">None (use default)</option>`);for(let e of t.instructions??[]){let r=n`<option value="${e.id}">${e.label}</option>`;e.id===t.activeId&&(r.selected=!0),o.append(r)}},f=(e,t)=>!e||e.length<=t?e||``:e.slice(0,t).trim()+`…`,p=async()=>{let e=await Re(),n=Array.isArray(e)?{instructions:e,activeId:``,activeInstruction:null}:e;t.instructions=n?.instructions??[],t.activeId=n?.activeId??``,u(),d()};return i.addEventListener(`click`,n=>{let r=n.target.closest(`[data-action]`)?.getAttribute(`data-action`);if(r===`add`&&(t.isAdding=!0,s.hidden=!1,c.value=``,l.value=``,c.focus()),r===`cancel-add`&&(t.isAdding=!1,s.hidden=!0),r===`save-new`){let n=c.value.trim(),r=l.value.trim();if(!r){l.focus();return}Le(n||`Custom`,r).then(e=>{if(e)return t.isAdding=!1,s.hidden=!0,p()}).then(()=>e.onUpdate?.())}if(r===`add-templates`){let n=new Set((t.instructions??[]).map(e=>e.label.trim().toLowerCase())),r=_.filter(e=>!n.has(e.label.trim().toLowerCase()));if(!r.length){alert(`All templates are already added.`);return}ze(r.map(e=>({label:e.label,instruction:e.instruction,enabled:e.enabled}))).then(p).then(()=>e.onUpdate?.())}}),o.addEventListener(`change`,()=>{Pe(o.value||null).then(p).then(()=>e.onUpdate?.())}),p(),i}})),Et,Dt=e((()=>{s(),Tt(),Et=e=>n`<section class="card settings-tab-panel" data-tab-panel="instructions" data-section="instructions">
      <h3>Recognition Instructions</h3>
      <div data-custom-instructions="editor">
        ${wt({onUpdate:()=>e(`Instructions updated.`)})}
      </div>
    </section>`})),Ot,kt=e((()=>{s(),Ot=()=>n`<section class="card settings-tab-panel" data-tab-panel="extension" data-section="extension" hidden>
      <h3>Extension</h3>
      <label class="field">
