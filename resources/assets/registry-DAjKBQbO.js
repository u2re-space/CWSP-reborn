...
}`}));function ae(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function h(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function g(e,t,n=`font/woff2`){if(b.has(t))return b.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return b.set(t,i),i}async function oe(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(x.has(o))return x.get(o);let s=ae(t),c=await g(a?await h(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),x.set(o,l),l}async function _(e){let t=e.map(e=>oe(e));return Promise.all(t)}async function v(){return S||(S=te(()=>import(`./font-registry-D4KJRdpC.js`),[],import.meta.url)?.catch?.(e=>{console.error(`Failed to load font registry:`,e)}),S)}async function y(){let e=await v();return _(Object.values(e.fontRegistry))}var b,x,S,C=e((()=>{ee(),b=new Map,x=new Map,S=null})),w,se=e((()=>{w=`@layer tokens, base, layout, utilities, shells, shell, views, view, viewer, components, ux-layer, markdown, essentials, print, print-breaks, overrides;
@layer components {
  button {
    display: inline-flex;
    align-items: center;
...
}`})),T,E,D=e((()=>{C(),s(),m(),se(),C(),T=`
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
`,E=async e=>{await o(T)?.catch(()=>void 0),await y().catch(()=>void 0),await o(p)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await o(w)?.catch(()=>void 0)}}));function O(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var k=e((()=>{})),A,j,M=e((()=>{u(),f(),k(),A=class extends l(){theme=`default`;render=function(){return n`<slot></slot>`};constructor(){super()}onRender(){return super.onRender()}connectedCallback(){return super.connectedCallback?.()??this}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(ne()),e}},O([a({source:`attr`})],A.prototype,`theme`,void 0),A=O([i(`ui-element`)],A),j=A})),N,ce=e((()=>{N=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
/* ==========================================================================
...
}`})),P,F,I=e((()=>{M(),u(),ce(),s(),k(),P=c(N),F=class extends j{constructor(){super()}styles=()=>P;render=()=>n`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},F=O([i(`ui-statusbar`)],F)})),L,R=e((()=>{L=`/* Taskbar */
@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
...
}`})),z,B,V=e((()=>{M(),u(),R(),s(),k(),z=c(L),B=class extends j{constructor(){super()}styles=()=>z;render=()=>n`<div part="taskbar" class="taskbar"><slot></slot></div>`},B=O([i(`ui-taskbar`)],B)})),H,U=e((()=>{H=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
/* ==========================================================================
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})),W,G,le=e((()=>{M(),s(),u(),U(),k(),W=c(H),G=class extends j{title=`Task`;icon=`github`;constructor(){super()}styles=()=>W;render=function(){return n`
        ...
        `}},O([a({source:`attr`})],G.prototype,`title`,void 0),O([a({source:`attr`})],G.prototype,`icon`,void 0),G=O([i(`ui-task`)],G)})),K,ue=e((()=>{K=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}`})),de=e((()=>{s(),ue(),c(K)})),q,fe=e((()=>{q=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}
...
:host(ui-taskbar[data-type=mobile]) ::slotted(ui-task[data-focus]) {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}`})),pe=e((()=>{s(),fe(),c(q)})),me=e((()=>{})),he=e((()=>{r(),u()})),ge=e((()=>{M(),I(),V(),le(),de(),pe(),me(),he()}));function _e(){return{...J}}var J,ve=e((()=>{s(),m(),D(),ge(),J={loadStyles:!0,includeGlobalNativeControlStyles:!1,styleVariant:`veela-basic`},(async()=>{let e=_e();e.loadStyles!==!1&&(await E({includeGlobalNativeControls:e.includeGlobalNativeControlStyles===!0}),await t(p))})()?.catch?.(()=>void 0)}));function Y(e,t){let n=e??{},r=t??{};return{...n,...r,lifecycle:{...n.lifecycle,...r.lifecycle}}}function X(e,t,n){let r=Object.getOwnPropertyDescriptor(e,t),i=r?.value;Object.defineProperty(e,t,{configurable:!0,enumerable:r?.enumerable??!0,writable:!0,value:function(...e){let t=i?.apply(this,e),r=n.apply(this,e);return r===void 0?t??this:r}})}function ye(e,t){for(let n of[`onInitialize`,`onMount`,`onUnmount`,`onShow`,`onHide`]){let r=t[n];typeof r==`function`&&X(e,n,r)}}function be(e,t){let n=e.prototype;t.initialization&&X(n,`onInitialize`,t.initialization),t.rendering&&X(n,`onRender`,t.rendering),t.render&&X(n,`render`,t.render),t.styles&&X(n,`styles`,t.styles),t.lifecycle&&ye(n,t.lifecycle)}var Z,Q,$,xe=e((()=>{d(),ve(),u(),k(),Z=new Map,Q=class extends A{__options;__initialized=!1;__viewChannel=null;set options(e){this.__options=e}get options(){return this.__options}get viewChannel(){return this.__viewChannel||=new EventTarget,this.__viewChannel}dispatchViewChannel(e,t,n){return this.viewChannel.dispatchEvent(new CustomEvent(e,{...n,detail:t}))}subscribeViewChannel(e,t){let n=this.viewChannel;return n.addEventListener(e,t),()=>n.removeEventListener(e,t)}viewInitialize(){let e=this.options;return e?.initializator?.call?.(this,this,e),this}constructor(){super()}onInitialize(){return super.onInitialize?.call?.(this),this?.viewInitialize?.call?.(this),this}},Q=O([i(`cw-view-base`)],Q),$=(e,t,n)=>{let r=typeof t==`function`?n??{}:Y(t,n??{}),a=r.extends?{extends:r.extends}:void 0,o;if(typeof t==`function`)o=t(Q);else{class e extends Q{constructor(){super()}}o=e}return i(e,a)(o),be(o,r),Z.set(e,o),o}}));export{ie as i,xe as n,re as r,$ as t};