import{n as e,r as t}from"./rolldown-runtime-DaJ6WEGw.js";import{J as n,Y as r,a as i}from"./HistoryManager-D8ebz2Z7.js";import{n as a,t as o}from"./preload-helper-NDuSAHbO.js";import{f as s,p as c}from"./views-CgiS38xE.js";import{t as l}from"./src-fiZCSwG5.js";import{t as u}from"./src-C9heO9y9.js";import{n as d,t as f}from"./shells-BG_WhheP.js";import{n as p,t as m}from"./shell-slots-CDiat5LT.js";var h,g=e((()=>{h=`/* Minimal shell: layered tokens + nav/content grid, WCO-safe, shadow slot views. */
/*
...
@layer shell.markdown-host-theme {
  ...
  @scope (
    ...
    :host([data-theme=light]) ::slotted([data-view=viewer]) {
      ...
      --view-bg: var(--color-surface, --u2-color-mod(var(--base-color), 70));
      --view-fg: var(--color-on-surface, --u2-color-mod(var(--base-color), 900));
      --view-toolbar-bg: color-mix(in oklab, --u2-color-mod(var(--base-color), 900) 6%, transparent);
      --view-btn-hover-bg: color-mix(in oklab, --u2-color-mod(var(--base-color), 900) 7%, transparent);
      --view-code-bg: --u2-color-mod(var(--base-color), 120);
      --view-blockquote-bg: color-mix(in oklab, --u2-color-mod(var(--base-color), 900) 3%, transparent);
    ...
    :host([data-theme=dark]) ::slotted([data-view=viewer]) {
      color-scheme: dark;
      --base-color: var(--color-primary, #5a7fff);
      --view-bg: var(--color-surface, --u2-color-mod(var(--base-color), 960));
      --view-fg: var(--color-on-surface, --u2-color-mod(var(--base-color), 100));
      --view-toolbar-bg: color-mix(in oklab, --u2-color-mod(var(--base-color), 100) 6%, transparent);
      --view-btn-hover-bg: color-mix(in oklab, --u2-color-mod(var(--base-color), 100) 8%, transparent);
      --view-code-bg: --u2-color-mod(var(--base-color), 900);
      --view-blockquote-bg: color-mix(in oklab, --u2-color-mod(var(--base-color), 100) 4%, transparent);
      --color-on-surface: --u2-color-mod(var(--base-color), 120);
      --viewer-toolbar-row-fill: --u2-color-mod(var(--base-color), 880);
    ...
    */
    :host([data-theme=light]) ::slotted([data-view=viewer]) :where(.markdown-body, [data-render-target].markdown-body) {
      --color-surface: --u2-color-mod(var(--base-color, var(--color-primary)), 40);
      --color-on-surface: --u2-color-mod(var(--base-color, var(--color-primary)), 900);
      color-scheme: light;
    }
    :host([data-theme=dark]) ::slotted([data-view=viewer]) :where(.markdown-body, [data-render-target].markdown-body) {
      --color-surface: --u2-color-mod(var(--base-color, var(--color-primary)), 950);
      --color-on-surface: --u2-color-mod(var(--base-color, var(--color-primary)), 100);
      color-scheme: dark;
    }
  }
}
...
}`}));function _(e){return b.has(e)}function v(e){return new x}var y,b,x,S=e((()=>{l(),n(),g(),u(),d(),s(),p(),a(),y=[{id:`viewer`,name:`Markdown`,icon:`eye`},{id:`explorer`,name:`Explorer`,icon:`folder`},{id:`workcenter`,name:`Work Center`,icon:`lightning`},{id:`network`,name:`Network`,icon:`wifi-high`},{id:`settings`,name:`Settings`,icon:`gear`},{id:`history`,name:`History`,icon:`clock-counter-clockwise`}].filter(e=>c(e.id)),b=new Set(y.map(e=>e.id)),x=class extends f{id=`minimal`;name=`Minimal`;layout={hasSidebar:!1,hasToolbar:!0,hasTabs:!1,supportsMultiView:!1,supportsWindowing:!1};createLayout(){let e=i`
