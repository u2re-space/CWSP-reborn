import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{A as t,G as n,O as r,W as i,k as a,t as o}from"./src-C7QuTtnr.js";import{n as s,t as c}from"./preload-helper-DcjHEl26.js";import{A as l,B as u,F as d,G as f,H as p,I as m,J as h,K as g,M as _,R as v,U as y,W as b,X as x,g as S,j as C,t as w,z as T}from"./src-R3RI73pV.js";import{a as E,j as D,k as O,st as k,u as A}from"./HistoryManager-B52KbQG4.js";import{i as ee,s as j}from"./icon-M8fpRh7n.js";import{A as te,C as M,D as N,E as P,F,I as ne,O as re,P as ie,S as ae,T as oe,_ as se,a as ce,b as le,c as ue,d as I,f as de,g as fe,h as pe,i as me,j as he,k as ge,l as _e,m as ve,n as ye,o as be,r as xe,s as Se,t as Ce,u as we,v as Te,w as Ee,x as De,y as Oe}from"./launcher-state-DEXvEx9Y.js";function L(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}function ke(){return(ke=e((()=>{})))()}var R,Ae;function z(){return(z=e((()=>{w(),j(),R=class extends T(){theme=`default`;render=function(){return E`<slot></slot>`};constructor(){super()}onRender(){return super.onRender()}connectedCallback(){return super.connectedCallback?.()??this}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(ee()),e}},L([p({source:`attr`})],R.prototype,`theme`,void 0),R=L([u(`ui-element`)],R),Ae=R})))()}var je,Me,Ne,Pe,Fe,Ie,Le,Re,ze,B,Be,Ve,He;function Ue(){return(Ue=e((()=>{w(),je=`2147483600`,Me=new Map,Ne=new Map,Pe=null,Fe=[`[data-chrome-flyout-anchor]`,`.env-shell-taskbar__clock`,`.env-ui-statusbar__clock`,`.env-device-tray`],Ie=()=>{if(typeof document<`u`){if(document.querySelector(`.env-shell-chrome[data-desktop]`))return!0;let e=document.querySelector(`[data-chrome-layout]`);if(e?.dataset.chromeLayout===`desktop`)return!0;if(e?.dataset.chromeLayout===`mobile`)return!1}return typeof matchMedia<`u`&&matchMedia(`(min-width: 641px)`).matches},Le=e=>{Pe=e},Re=e=>{let t=`data-env-shell-overlays`,n=e||Pe||document.querySelector(`.env-shell-root`)||document.querySelector(`#app`)||document.body,r=n.querySelector(`[${t}]`);if(r)return r.style.zIndex||(r.style.zIndex=je),r;try{let e=globalThis.__ENV_OVERLAY_MOUNT__;if(typeof e==`function`)return e(n)}catch{}let i=document.createElement(`div`);return i.setAttribute(t,``),i.className=`env-shell-overlays`,i.setAttribute(`data-part`,`env-overlays`),i.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${je};box-sizing:border-box;`,n.appendChild(i),i},ze=(e,t)=>{let n=Ie();if(e.style.position=`fixed`,e.style.zIndex=String(Number(je)+1),e.style.pointerEvents=`auto`,e.style.margin=`0`,n){e.style.top=`auto`,e.style.left=`auto`,e.style.right=`0.75rem`,e.style.bottom=`4.5rem`,e.style.transform=`none`;return}if(t===`calendar`){e.style.top=`50%`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translate(-50%, -50%)`;return}e.style.top=`calc(env(safe-area-inset-top, 0px) + 0.75rem)`,e.style.left=`50%`,e.style.right=`auto`,e.style.bottom=`auto`,e.style.transform=`translateX(-50%)`},B=e=>{let t=Me.get(e);if(!t)return;Me.delete(e);let n=Ne.get(e);Ne.delete(e),n?.disposeDismiss(),n?.unregisterBack();try{let e=t.el;typeof e.close==`function`?e.close():(e.removeAttribute(`open`),e.hidden=!0),e.dispatchEvent(new CustomEvent(`chrome-flyout-close`,{bubbles:!0}))}catch{}},Be=e=>{Me.has(e.kind)&&B(e.kind);for(let t of[...Me.keys()])t!==e.kind&&B(t);Me.set(e.kind,{...e,close:()=>B(e.kind)}),e.el.hidden=!1,e.el.removeAttribute(`hidden`),e.el.setAttribute(`open`,``),Ne.set(e.kind,{disposeDismiss:_({root:document,inside:e.el,isInside:t=>e.contains(t.target),exceptSelectors:Fe,onDismiss:()=>B(e.kind)}),unregisterBack:l({id:`chrome-flyout-${e.kind}`,kind:`overlay`,element:e.el,isActive:()=>Me.get(e.kind)?.el===e.el&&e.el.isConnected&&!e.el.hidden&&e.el.hasAttribute(`open`),close:()=>(B(e.kind),!0)})})},Ve=e=>Me.has(e),He=(e,t)=>{if(Ve(e)){B(e);return}let n=t();Be(n)}})))()}var We;function Ge(){return(Ge=e((()=>{We=`/*
...
@layer calendar {
  ...
  .ui-cal-flyout__day[data-today][data-selected] {
    box-shadow: 0 0 0 2px color-mix(in oklab, var(--cal-base-color) 70%, #fff 20%) inset;
...
}`})))()}function Ke(e){try{let t=new Intl.Locale(e),n=(t.weekInfo??t.getWeekInfo?.())?.firstDay;if(typeof n==`number`&&n>=1&&n<=7)return n%7}catch{}return 0}function qe(e,t){let n=new Intl.DateTimeFormat(e,{weekday:`short`,timeZone:`UTC`}),r=[];for(let e=0;e<7;e++){let i=(t+e)%7;r.push(n.format(new Date(et+i*tt)))}return r}function Je(e,t){return e.getFullYear()===t.getFullYear()&&e.getMonth()===t.getMonth()&&e.getDate()===t.getDate()}function Ye(e,t,n){let r=new Date,i=new Date(e,t,1),a=new Date(e,t+1,0).getDate(),o=(i.getDay()-n+7)%7,s=Math.ceil((o+a)/7)*7,c=[];for(let n=0;n<s;n++){let i=n-o+1,a=new Date(e,t,i);c.push({date:a,day:a.getDate(),otherMonth:a.getMonth()!==t,isToday:Je(a,r)})}return c}function Xe(){if(rt?.isConnected)return rt;let e=Re(),t=e.querySelector(`ui-calendar-flyout`);return t||(t=document.createElement(`ui-calendar-flyout`),t.hidden=!0,e.appendChild(t)),rt=t,t}function Ze(e){He($e,()=>{let e=Xe(),t=document.documentElement.getAttribute(`data-theme`);return(t===`light`||t===`dark`)&&(e.dataset.theme=t,e.style.colorScheme=t),ze(e,$e),e.open(),{kind:$e,el:e,close:()=>{e.close(),B($e)},contains:t=>t instanceof Node&&e.contains(t)}})}var Qe,$e,et,tt,nt,rt;function it(){return(it=e((()=>{w(),o(),z(),j(),Ue(),Ge(),Qe=t(We),$e=`calendar`,et=Date.UTC(2023,0,1),tt=864e5,nt=class extends R{#e;#t;#n=null;#r=null;styles=function(){return Qe};render=function(){return E`<div class="ui-cal-flyout__panel" part="panel">
        ...
        </div>`};constructor(){super();let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth()}onRender(){super.onRender(),this.#i(),this.#c()}disconnectedCallback(){this.#r?.(),this.#r=null,super.disconnectedCallback?.()}#i(){let e=this.shadowRoot;if(!e||this.#r)return;let t=n(e,`click`,e=>{let t=e.target,n=t?.closest?.(`[data-nav]`);if(n){n.dataset.nav===`prev`?this.#a(-1):n.dataset.nav===`next`&&this.#a(1);return}let r=t?.closest?.(`.ui-cal-flyout__day`);r&&this.#s(r)});this.#r=()=>t?.()}#a(e){this.#t+=e,this.#t<0?(this.#t=11,--this.#e):this.#t>11&&(this.#t=0,this.#e+=1),this.#c()}#o(){let e=new Date;this.#e=e.getFullYear(),this.#t=e.getMonth(),this.#c()}#s(e){let t=e.dataset.date;t&&(this.#n=new Date(t),this.shadowRoot?.querySelectorAll(`.ui-cal-flyout__day[data-selected]`)?.forEach(e=>e.removeAttribute(`data-selected`)),e.setAttribute(`data-selected`,``),this.dispatchEvent(new CustomEvent(`calendar-select`,{bubbles:!0,composed:!0,detail:{date:this.#n}})))}#c(){let e=this.shadowRoot;if(!e)return;let t=typeof navigator<`u`?navigator.language:void 0,n=Ke(t??`en-US`),r=new Date,i=e.querySelector(`.ui-cal-flyout__today`);i&&(i.textContent=r.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`}));let a=e.querySelector(`.ui-cal-flyout__month-label`);a&&(a.textContent=new Date(this.#e,this.#t,1).toLocaleDateString(t,{month:`long`,year:`numeric`}));let o=e.querySelector(`.ui-cal-flyout__weekdays`);o&&o.replaceChildren(...qe(t??`en-US`,n).map(e=>{let t=document.createElement(`span`);return t.className=`ui-cal-flyout__weekday`,t.setAttribute(`role`,`columnheader`),t.textContent=e,t}));let s=e.querySelector(`.ui-cal-flyout__grid`);if(s){let e=Ye(this.#e,this.#t,n);s.replaceChildren(...e.map(e=>{let n=document.createElement(`button`);return n.type=`button`,n.className=`ui-cal-flyout__day`,n.textContent=String(e.day),n.dataset.date=e.date.toISOString(),n.setAttribute(`role`,`gridcell`),e.otherMonth&&n.setAttribute(`data-other-month`,``),e.isToday&&n.setAttribute(`data-today`,``),this.#n&&Je(e.date,this.#n)&&n.setAttribute(`data-selected`,``),n.setAttribute(`aria-label`,e.date.toLocaleDateString(t,{weekday:`long`,month:`long`,day:`numeric`,year:`numeric`})),n}))}}open(){this.#o(),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},nt=L([u(`ui-calendar-flyout`)],nt),rt=null})))()}function at(){let e=lt.get();return typeof e==`function`?e:null}var ot,st,ct,lt;function ut(){return(ut=e((()=>{ot=`__CWSP_SPEED_DIAL_VIEW_OPENER_V1__`,st=`__CWSP_HOME_OVERLAY_MOUNT_V1__`,ct=e=>{let t=globalThis;return{get:()=>e in t?t[e]:null,set:n=>{t[e]=n}}},lt=ct(ot),ct(st)})))()}var dt;function ft(){return(ft=e((()=>{dt=`/*
...
}`})))()}function pt(){if(Gt?.isConnected)return Gt;let e=Re(),t=e.querySelector(`ui-quick-settings`);return t||(t=document.createElement(`ui-quick-settings`),t.hidden=!0,e.appendChild(t)),Gt=t,t}function mt(e){He(_t,()=>{let e=pt(),t=document.documentElement.getAttribute(`data-theme`);return(t===`light`||t===`dark`)&&(e.dataset.theme=t,e.style.colorScheme=t),ze(e,_t),e.open(),{kind:_t,el:e,close:()=>{e.close(),B(_t)},contains:t=>t instanceof Node&&e.contains(t)}})}function ht(){B(_t)}var gt,_t,vt,yt,bt,xt,St,Ct,wt,Tt,Et,Dt,Ot,kt,At,jt,Mt,Nt,Pt,Ft,It,Lt,Rt,zt,Bt,Vt,Ht,Ut,Wt,Gt;function Kt(){return(Kt=e((()=>{w(),o(),z(),j(),ut(),Ue(),ft(),gt=t(dt),_t=`quick-settings`,vt=`data-theme`,yt=`rs-appearance-theme`,bt=`appearance.theme`,xt=[`rs-settings`,`cwsp-settings`,`u2-settings`],St=()=>{try{return matchMedia?.(`(prefers-color-scheme: dark)`)?.matches??!0}catch{return!0}},Ct=e=>{for(let t of xt)try{let n=localStorage.getItem(t);if(!n)continue;let r=JSON.parse(n);if(!r||typeof r!=`object`)continue;r.appearance={...r.appearance??{},theme:e},localStorage.setItem(t,JSON.stringify(r))}catch{}},wt=()=>{try{let e=document.documentElement.getAttribute(vt);if(e===`light`||e===`dark`)return e;let t=localStorage.getItem(yt);if(t===`light`||t===`dark`)return t}catch{}return St()?`dark`:`light`},Tt=e=>{let t=document.documentElement,n=e===`auto`?St()?`dark`:`light`:e,r=e===`auto`?`auto`:e;t.setAttribute(`data-scheme`,r),t.setAttribute(vt,n),t.style.colorScheme=n;try{document.body&&(document.body.style.colorScheme=n)}catch{}try{document.querySelectorAll(`.env-shell-root, [data-shell], ui-window`).forEach(e=>{let t=e;t.dataset.theme=n,t.style.colorScheme=n;let r=t.shadowRoot?.querySelector?.(`.app-shell`);r&&(r.dataset.theme=n,r.style.colorScheme=n)})}catch{}try{localStorage.setItem(yt,e===`auto`?`auto`:e),localStorage.setItem(bt,e===`auto`?`auto`:e)}catch{}e!==`auto`&&Ct(e),t.dispatchEvent(new CustomEvent(`u2-theme-change`,{bubbles:!0,detail:{source:`quick-settings`,theme:n,preference:e}}))},Et=()=>{try{let e=String(localStorage.getItem(yt)||``).trim().toLowerCase();if(e===`light`||e===`dark`||e===`auto`)return e;let t=String(localStorage.getItem(bt)||``).trim().toLowerCase();if(t===`light`||t===`dark`||t===`auto`)return t}catch{}return`auto`},Dt=()=>{let e=globalThis;if(e.__CWSP_AUTO_THEME_FOLLOW__)return;e.__CWSP_AUTO_THEME_FOLLOW__=!0;let t=typeof matchMedia==`function`?matchMedia(`(prefers-color-scheme: dark)`):null;if(!t)return;let n=()=>{Et()===`auto`&&Tt(`auto`)};try{t.addEventListener(`change`,n)}catch{try{t.addListener(n)}catch{}}try{n()}catch{}},Ot=e=>{document.documentElement.style.setProperty(`--orientation-lock`,e?`unlocked`:`locked`),document.documentElement.style.setProperty(`--orientation-lock-angle`,e?`0deg`:`90deg`),Promise.try(async()=>{try{let t=screen.orientation;if(e){t.unlock?.();return}if(typeof t.lock!=`function`)return;let n=t.lock(t.type||`natural`);n&&typeof n.catch==`function`&&await n.catch(()=>{})}catch(e){console.warn(e)}})?.catch?.(console.warn.bind(console))},kt=`env-night-filter`,At=`2147483001`,jt=`rs-night-filter`,Mt=`rs-brightness-filter`,Nt=e=>Math.max(0,Math.min(100,Number.isFinite(e)?e:0)),Pt=()=>{let e=document.getElementById(kt);if(e instanceof HTMLElement)return e;let t=document.createElement(`div`);return t.id=kt,t.setAttribute(`aria-hidden`,`true`),t.style.cssText=[`dynamic-range-limit:no-limit`,`color-space:display-p3`,`position:fixed`,`inset:0`,`pointer-events:none`,`z-index:${At}`,`background-color:color(display-p3 1 0.55 0.24)`,`mix-blend-mode:multiply`,`opacity:0`,`visibility:hidden`,`transition:opacity 160ms ease`].join(`;`),(document.body??document.documentElement).appendChild(t),t},Ft=e=>{let t=Nt(e),n=Pt(),r=t/100;n.style.opacity=String(r),n.style.visibility=r>=.01?`visible`:`hidden`;try{localStorage.setItem(jt,String(t))}catch{}},It=e=>{let t=Nt(e);Pt(),t<=50?.4+t/50*.6:1+(t-50)/50*.2;try{localStorage.setItem(Mt,String(t))}catch{}},Lt=(e,t)=>{try{let n=localStorage.getItem(e);if(n==null)return t;let r=Number(n);return Number.isFinite(r)?Nt(r):t}catch{return t}},Rt=()=>{let e=Lt(jt,0),t=Lt(Mt,50);return Ft(e),It(t),{night:e,brightness:t}},typeof document<`u`&&(document.readyState===`loading`?document.addEventListener(`DOMContentLoaded`,()=>Rt(),{once:!0}):Rt()),zt=[`wifi`,`bluetooth`,`focus`,`airplane`,`orientation`],Bt={light:`sun`,dark:`moon`},Vt={light:`Light`,dark:`Dark`},Ht=e=>{let t=e.querySelector(`[data-qs-tile="theme"]`);if(!t)return;let n=wt();t.querySelector(`ui-icon`)?.setAttribute(`icon`,Bt[n]);let r=t.querySelector(`[data-qs-tile-sub]`);r&&(r.textContent=Vt[n]),t.setAttribute(`aria-pressed`,n===`dark`?`true`:`false`)},Ut=e=>{let t=e.shadowRoot,n=t?.querySelector(`.qs-panel`);if(!t||!n||n.hasAttribute(`data-qs-wired`))return;n.setAttribute(`data-qs-wired`,``),Ht(t),t.querySelector(`[data-qs-tile="theme"]`)?.addEventListener(`click`,()=>{let e=wt()===`dark`?`light`:`dark`;Tt(e),Ht(t)});let r=e=>!!e?.getAttribute?.(`aria-pressed`)&&e?.getAttribute?.(`aria-pressed`)===`true`;t.querySelector?.(`[data-qs-tile="orientation"]`)?.addEventListener?.(`click`,e=>{let t=i((e?.target?.matches?.(`[data-qs-tile="orientation"]`)?e?.target:e?.target?.querySelector?.(`[data-qs-tile="orientation"]`))||e?.target,`[data-qs-tile="orientation"]`),n=r(t);Ot(n);let a=t?.matches?.(`ui-icon`)?t:t?.querySelector?.(`ui-icon`);a&&a.setAttribute?.(`icon`,n?`device-rotate`:`lock`),a&&a.setAttribute?.(`icon-style`,`duotone`)});for(let e of zt){let n=t.querySelector(`[data-qs-tile="${e}"]`);n&&n.addEventListener(`click`,()=>{let e=n.getAttribute(`aria-pressed`)!==`true`;n.setAttribute(`aria-pressed`,String(e));let t=n.querySelector(`[data-qs-tile-sub]`);t&&(t.textContent=e?`On`:`Off`)})}let{night:a,brightness:o}=Rt(),s=t.querySelector(`[data-qs-slider="night"]`),c=t.querySelector(`[data-qs-slider="brightness"]`);s&&(s.value=String(a),s.addEventListener(`input`,()=>Ft(s.valueAsNumber))),c&&(c.value=String(o),c.addEventListener(`input`,()=>It(c.valueAsNumber)));let l=e=>{ht();let t=()=>{let t=at();if(typeof t==`function`){t(e,{});return}let n=`#${e}`;typeof location<`u`&&location.hash!==n&&x(n)};typeof requestAnimationFrame==`function`?requestAnimationFrame(t):queueMicrotask(t)};t.querySelectorAll(`[data-qs-open]`).forEach(e=>{e.addEventListener(`click`,()=>{let t=String(e.getAttribute(`data-qs-open`)||``).trim();(t===`settings`||t===`explorer`)&&l(t)})})},Wt=class extends R{constructor(){super()}styles=()=>gt;render=()=>E`
...
</div>`;onRender(){return super.onRender(),Ut(this),this}open(){Ht(this.shadowRoot),this.removeAttribute(`hidden`),this.hidden=!1,this.setAttribute(`open`,``)}close(){this.hidden=!0,this.setAttribute(`hidden`,``),this.removeAttribute(`open`)}toggle(e){this.hasAttribute(`open`)?this.close():this.open()}},Wt=L([u(`ui-quick-settings`)],Wt),Gt=null,Promise.try(()=>{typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{Promise.try(()=>{screen?.orientation?.lock?.(`natural`)}).catch(console.warn.bind(console))})}).catch(console.warn.bind(console));try{Dt()}catch{}})))()}var qt;function Jt(){return(Jt=e((()=>{qt=`/*
...
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},ln=L([u(`ui-statusbar`)],ln)})))()}function dn(){return(dn=e((()=>{ge(),w()})))()}var fn,pn,mn,V,H,U,hn,gn,_n,W,vn,yn,bn,xn,G,Sn,Cn,wn,Tn,En,Dn,On,kn,An,jn,Mn,Nn,K,Pn;function Fn(){return(Fn=e((()=>{o(),w(),dn(),fn=320,pn=220,mn=`2147483640`,V=`important`,H=0,U=null,hn=null,gn=null,_n=null,W=[],vn=new Map,yn=new Map,bn=new Map,xn=new Map,G=new Map,Sn=[`left-start`,`right-end`,`left-end`,`bottom-start`,`top-start`],Cn=(e,t)=>{let n=S(e,{...t,strategy:`js`});return typeof requestAnimationFrame==`function`&&requestAnimationFrame(()=>{n.update?.()}),n},wn=()=>{let e=document.documentElement,t=String(e.getAttribute(`data-theme`)||``).trim().toLowerCase();if(t===`light`||t===`dark`)return t;let n=String(e.getAttribute(`data-scheme`)||``).trim().toLowerCase();if(n===`light`||n===`dark`)return n;try{let e=String(localStorage.getItem(`rs-appearance-theme`)||``).trim().toLowerCase();if(e===`light`||e===`dark`)return e}catch{}return typeof matchMedia==`function`&&matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`},Tn=(e,t)=>{e.style.setProperty(`position`,`fixed`,V),e.style.setProperty(`box-sizing`,`border-box`,V),e.style.setProperty(`min-width`,t?`188px`:`220px`,V),e.style.setProperty(`max-width`,`min(320px, calc(100vw - 24px))`,V),e.style.setProperty(`padding`,t?`0.3rem`:`0.4rem`,V),e.style.setProperty(`border-radius`,`14px`,V),e.style.setProperty(`pointer-events`,`auto`,V),e.style.setProperty(`backdrop-filter`,`blur(10px)`,V),e.style.setProperty(`-webkit-backdrop-filter`,`blur(10px)`,V),e.style.removeProperty(`border`),e.style.removeProperty(`background`),e.style.removeProperty(`color`),e.style.removeProperty(`box-shadow`);let n=wn();e.dataset.theme=n,e.style.setProperty(`color-scheme`,n===`light`?`light only`:`dark only`,V)},En=e=>{e.style.setProperty(`list-style`,`none`,V),e.style.setProperty(`list-style-type`,`none`,V),e.style.setProperty(`margin`,`0`,V),e.style.setProperty(`padding`,`0`,V),e.style.setProperty(`display`,`flex`,V),e.style.setProperty(`flex-direction`,`column`,V),e.style.setProperty(`align-items`,`stretch`,V),e.style.setProperty(`gap`,`0.2rem`,V),e.style.setProperty(`width`,`100%`,V),e.style.setProperty(`box-sizing`,`border-box`,V)},Dn=(e,t)=>{if(e.style.setProperty(`appearance`,`none`,V),e.style.setProperty(`-webkit-appearance`,`none`,V),e.style.setProperty(`box-sizing`,`border-box`,V),e.style.setProperty(`width`,`100%`,V),e.style.setProperty(`max-width`,`100%`,V),e.style.setProperty(`margin`,`0`,V),e.style.setProperty(`display`,`grid`,V),e.style.setProperty(`grid-template-columns`,`1.375rem minmax(0, 1fr) auto`,V),e.style.setProperty(`align-items`,`center`,V),e.style.setProperty(`justify-items`,`start`,V),e.style.setProperty(`gap`,`0.55rem`,V),e.style.setProperty(`border`,`none`,V),e.style.setProperty(`border-radius`,`10px`,V),e.style.setProperty(`padding`,`0.5rem 0.6rem`,V),e.style.setProperty(`min-height`,`2.35rem`,V),e.style.setProperty(`font`,`inherit`,V),e.style.setProperty(`font-size`,`0.8125rem`,V),e.style.setProperty(`line-height`,`1.25`,V),e.style.setProperty(`text-align`,`start`,V),e.style.setProperty(`cursor`,`pointer`,V),e.style.removeProperty(`background`),e.style.removeProperty(`background-color`),!t)e.style.setProperty(`color`,`inherit`,V);else{let t=wn()===`light`?`#9f1239`:`#fecaca`;e.style.setProperty(`color`,t,V),e.style.setProperty(`--cw-menu-fg`,t,V)}},On=()=>{let e=document.getElementById(`cw-unified-context-menu-style`);e||(e=document.createElement(`style`),e.id=`cw-unified-context-menu-style`,document.head.appendChild(e)),e.textContent=`
        .cw-context-menu-layer {
            position: fixed;
            inset: 0;
            z-index: var(--cw-context-menu-layer-z, ${mn});
            pointer-events: none;
        }
    ...
    `},kn=()=>{for(let e of W)try{e()}catch{}W=[]},An=e=>{for(let[t,n]of Array.from(xn.entries()))t>=e&&(clearTimeout(n),xn.delete(t));for(let[t,n]of Array.from(G.entries()))t>=e&&(clearTimeout(n),G.delete(t))},jn=e=>{An(e);for(let[t,n]of Array.from(vn.entries()))t>=e&&(bn.get(t)?.dispose(),bn.delete(t),n.remove(),vn.delete(t),yn.delete(t))},Mn=e=>{for(let[t,n]of Array.from(G.entries()))t>=e&&(clearTimeout(n),G.delete(t))},Nn=(e,t,n,r,i)=>{let a=document.createElement(`div`);a.className=`cw-context-menu${t?` cw-context-menu--compact`:``}`,a.setAttribute(`role`,`menu`),a.dataset.menuDepth=String(n),a.style.zIndex=String(n+1);let o=document.createElement(`ul`);o.className=`cw-context-menu__list`,En(o),a.appendChild(o);let s=(e,n,a)=>{if(r!==H||!hn?.isConnected||!U?.isConnected||(jn(a),!e.children?.length))return;let o=Nn(e.children,t,a,r,i);o.classList.add(`cw-context-menu--submenu`),U.appendChild(o),vn.set(a,o),yn.set(a,n),bn.set(a,Cn(o,{origin:{type:`element`,element:n},placement:`right-start`,fallbacks:Sn,strategy:`js`}))},c=(e,t,n)=>{let r=xn.get(n);r&&clearTimeout(r),Mn(n);let i=setTimeout(()=>{xn.delete(n),s(e,t,n)},fn);xn.set(n,i)},l=e=>{let t=G.get(e);t&&clearTimeout(t);let n=setTimeout(()=>{G.delete(e),jn(e)},pn);G.set(e,n)};for(let t of e){let e=document.createElement(`button`);e.type=`button`,e.className=`cw-context-menu__item${t.danger?` cw-context-menu__item--danger`:``}`,e.setAttribute(`role`,`menuitem`),e.disabled=!!t.disabled,Dn(e,!!t.danger);let i=!!t.children?.length;if(e.innerHTML=`
        ...
        `,i){let i=n+1;e.setAttribute(`aria-haspopup`,`menu`),e.addEventListener(`pointerenter`,()=>c(t,e,i)),e.addEventListener(`pointerleave`,()=>l(i)),e.addEventListener(`click`,n=>{if(n.preventDefault(),n.stopPropagation(),r!==H||!hn?.isConnected)return;Mn(i);let a=vn.get(i),o=yn.get(i);if(a?.isConnected&&o===e){jn(i);return}s(t,e,i)})}else e.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation(),!(r!==H||!hn?.isConnected)&&(K(),!t.disabled&&await t.action())});let a=document.createElement(`li`);a.appendChild(e),o.appendChild(a)}return Tn(a,t),a.addEventListener(`pointerenter`,()=>Mn(n)),a.addEventListener(`pointerleave`,()=>{if(n>0){let e=G.get(n);e&&clearTimeout(e);let t=setTimeout(()=>{G.delete(n),jn(n)},pn);G.set(n,t)}}),a},K=()=>{kn(),An(0),_n?.(),_n=null,gn?.dispose(),gn=null,jn(1),vn.clear(),yn.clear(),bn.clear(),hn?.remove(),hn=null,U?.remove(),U=null,H+=1},Pn=e=>{let t=(e.items||[]).filter(e=>e&&e.id&&e.label);if(!t.length){K();return}On(),K();let n=H,r=C()??document.body,i=document.createElement(`div`);i.className=`cw-context-menu-layer`,U=i,r.appendChild(i);let a=e.placementStrategy??`auto`,o=Nn(t,!!e.compact,0,n,a);hn=o,i.appendChild(o),gn=Cn(o,{origin:{type:`point`,x:e.x,y:e.y},placement:`bottom-start`,gap:0,strategy:`js`}),_n=l({id:`context-menu-${n}`,kind:`context-menu`,element:i,isActive:()=>H===n&&U===i&&i.isConnected,close:()=>(K(),!0)});let s=e=>{if(n!==H||!U?.isConnected)return;let t=e.target;t&&U.contains(t)||K()},c=e=>{if(n!==H||!hn?.isConnected)return;let t=e.target;if(!t)return;let r=t.closest?.(`.cw-context-menu__item`);if(!r){jn(1);return}r.getAttribute(`aria-haspopup`)!==`menu`&&jn(1)},u=e=>{n===H&&e.key===`Escape`&&K()},d=()=>K();document.addEventListener(`pointerdown`,s,{capture:!0}),document.addEventListener(`contextmenu`,s,{capture:!0}),document.addEventListener(`keydown`,u),o.addEventListener(`click`,c,{capture:!0}),window.addEventListener(`resize`,d,{passive:!0}),window.addEventListener(`blur`,d,{passive:!0}),W.push(()=>document.removeEventListener(`pointerdown`,s,{capture:!0})),W.push(()=>document.removeEventListener(`contextmenu`,s,{capture:!0})),W.push(()=>document.removeEventListener(`keydown`,u)),W.push(()=>o.removeEventListener(`click`,c,{capture:!0})),W.push(()=>window.removeEventListener(`resize`,d)),W.push(()=>window.removeEventListener(`blur`,d))}})))()}function In(e){globalThis.dispatchEvent?.(new CustomEvent(`view:toast`,{detail:{type:`success`,message:String(e||``)}}))}function Ln(e){let t=String(e||`default`).trim().toLowerCase();return Hn[t]||`default`}function Rn(e){return String(e||``).trim().toLowerCase().startsWith(`android-icon:`)}function zn(e,t=`default`,n=``,r=``){let i=String(e||``).trim();if(!i)return``;let a=Ln(t),o=String(n||``).trim(),s=String(r||``).trim(),c=new URLSearchParams;a!=="default"&&c.set(`v`,a),o&&c.set(`pack`,o),s&&c.set(`drawable`,s);let l=c.toString();return l?`android-icon:${i}?${l}`:`android-icon:${i}`}function Bn(e){let t=String(e||``).trim();if(!Rn(t))return null;let n=t.slice(13).replace(/^\/\//,``);if(!n)return null;let r=(e,t)=>{if(!e)return null;let n={packageName:e,variant:Ln(t.get(`v`)||`default`)},r=String(t.get(`pack`)||``).trim(),i=String(t.get(`drawable`)||``).trim();return r&&(n.pack=r),i&&(n.drawable=i),n};try{let e=new URL(n.includes(`://`)?n:`android-icon://${n}`);return r(String(e.hostname||e.pathname.replace(/^\//,``)||``).trim(),e.searchParams)}catch{let[e,t=``]=n.split(`?`);return r(String(e||``).trim(),new URLSearchParams(t))}}function Vn(e,t=`default`,n=``,r=``,i=0){let a=String(e||``).trim();if(!a)return``;let o=Ln(t),s=String(n||``).trim(),c=String(r||``).trim(),l=o==="default"?a:`${a}#${o}`;s&&(l=`${l}#pack:${s}`),c&&(l=`${l}#d:${c}`);let u=Math.round(Number(i)||0);return u>0&&(l=`${l}#s${u}`),l}var Hn;function Un(){return(Un=e((()=>{Hn={default:`default`,full:`default`,colored:`default`,monochrome:`monochrome`,mono:`monochrome`,material:`monochrome`,"material-you":`monochrome`,themed:`monochrome`,foreground:`foreground`,fg:`foreground`,"adaptive-fg":`foreground`}})))()}async function Wn(e){let t=await(await fetch(e)).blob(),n=t.type&&t.type.startsWith(`image/`)?t.type:`image/png`,r=t.type===n?t:new Blob([await t.arrayBuffer()],{type:n});return URL.createObjectURL(r)}function Gn(e,t=96,n=`default`,r=``,i=``){let a=String(e||``).trim();if(!a)return``;if(a.startsWith(`shortcut:`)){let e=a.slice(9),n=e.indexOf(`/`);return n>0?qn(e.slice(0,n),e.slice(n+1),t):``}return tr.get(Vn(a,n,r,i,t))||``}async function Kn(e,t,n=96){let r=String(e||``).trim(),i=String(t||``).trim();if(!r||!i)return``;let a=Math.max(16,Math.min(512,Math.round(Number(n)||96))),o=`shortcut:${r}/${i}@${a}`,s=rr.get(o);if(s)return s;let c=ir.get(o);return c||(c=(async()=>{let e=await Zn();if(!e?.launcherShortcutIcon)return``;let t=``;try{t=String(await e.launcherShortcutIcon(r,i,a)||``).trim()}catch{return``}if(!t)return``;try{let e=await Wn(t);return rr.set(o,e),e}catch{return t}})().finally(()=>{ir.delete(o)}),ir.set(o,c)),c}function qn(e,t,n=96){let r=String(e||``).trim(),i=String(t||``).trim();if(!r||!i)return``;let a=Math.max(16,Math.min(512,Math.round(Number(n)||96)));return rr.get(`shortcut:${r}/${i}@${a}`)||``}async function Jn(e,t=96,n=`default`,r=``,i=``){let a=String(e||``).trim();if(!a)return``;if(a.startsWith(`shortcut:`)){let e=a.slice(9),n=e.indexOf(`/`);return n>0?Kn(e.slice(0,n),e.slice(n+1),t):``}let o=Ln(n),s=String(r||``).trim(),c=String(i||``).trim(),l=Math.max(16,Math.min(512,Math.round(Number(t)||96))),u=Vn(a,o,s,c,l),d=tr.get(u);if(d)return d;let f=nr.get(u);f||(f=(async()=>{let e=await Zn();if(!e?.launcherIcon)return``;let t=``;try{t=await e.launcherIcon(a,l,o,s||void 0,c||void 0)}catch{return``}if(!t)return``;try{let e=await Wn(t);return tr.set(u,e),e}catch{return``}})(),nr.set(u,f));try{return await f}finally{nr.delete(u)}}async function Yn(e,t=96){let n=String(e||``).trim();if(!n||n.startsWith(`blob:`))return``;let r=Bn(n);return r?Jn(r.packageName,t,r.variant,r.pack||``,r.drawable||``):n}function Xn(e,t=96){let n=Bn(e);return n?Gn(n.packageName,t,n.variant,n.pack||``,n.drawable||``):``}async function Zn(){if(er)return er;try{return await c(()=>import(`./launcher-bridge-C3JnBhTN.js`),[],import.meta.url)}catch{return null}}async function Qn(){return Zn()}function $n(e,t,n=`colored`){let r=String(t||``).trim();if(!r)return;e.setAttribute(`icon-padding`,`0`),e.style.setProperty(`--icon-padding`,`0px`),e.style.setProperty(`--icon-size`,`100%`),e.toggleAttribute(`data-launcher-icon`,!0);let i=()=>{let t=e;return typeof t.setResourceIcon==`function`&&(t.setResourceIcon(r,n===`auto`?`auto`:n),n!==`auto`&&typeof t.setBitmapPresentationMode==`function`&&t.setBitmapPresentationMode(n,!0),e.removeAttribute(`data-icon-pending`),e.toggleAttribute(`data-launcher-icon-ready`,!0),!0)};i()||customElements.whenDefined(`ui-icon`).then(()=>{e.isConnected&&i()})}var er,tr,nr,rr,ir;function ar(){return(ar=e((()=>{w(),I(),ut(),Un(),s(),er=null,tr=new Map,nr=new Map,rr=new Map,ir=new Map})))()}function or(e,t=64){let n=String(e||``).trim();if(!n||!/^https?:\/\//i.test(n))return``;try{let e=new URL(n).hostname;return e?`https://www.google.com/s2/favicons?domain=${encodeURIComponent(e)}&sz=${t}`:``}catch{return``}}function sr(e){let t=String(e||``).trim().toLowerCase();return t?t.includes(`/_favicon/`)||t.includes(`s2/favicons`)||t.includes(`favicon`)?!0:(t.startsWith(`android-icon:`),!1):!1}function cr(e){Or=e}function lr(e){let t=e||(globalThis.chrome?.bookmarks??null);return!t?.getTree||!t?.getChildren?null:{resolveIconUrl:(e,t=128)=>{let n=String(e||``).trim();if(!/^https?:\/\//i.test(n))return``;let r=or(n,t);if(r)return r;try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`){let r=new URL(e.getURL(`/_favicon/`));return r.searchParams.set(`pageUrl`,n),r.searchParams.set(`size`,String(t)),r.toString()}}catch{}return``},async listChildren(e){if(e)return(await Ar(t,`getChildren`,e)||[]).map(jr);let n=await Ar(t,`getTree`)||[],r=[];for(let e of n)for(let t of e.children||[])r.push(jr(t));return r},async search(e){let n=String(e||``).trim();if(!n)return this.listChildren();if(typeof t.search!=`function`){let e=await this.listChildren(),t=n.toLowerCase();return e.filter(e=>e.title.toLowerCase().includes(t)||String(e.url||``).toLowerCase().includes(t))}return(await Ar(t,`search`,n)||[]).map(jr)},async open(e){if(e.folder)return;let t=String(e.url||``).trim();if(t){try{let e=globalThis.chrome?.tabs;if(typeof e?.create==`function`){await Promise.resolve(e.create({url:t}));return}}catch{}globalThis.open?.(t,`_blank`,`noopener,noreferrer`)}}}}function ur(){return Or||lr()}function dr(){return!!ur()}function fr(){try{let e=localStorage.getItem(wr);if(!e)return[];let t=JSON.parse(e);return Array.isArray(t)?t.filter(e=>e&&e.id&&e.title).slice(0,Er):[]}catch{return[]}}function pr(e){if(!e?.id||e.folder)return;let t=[e,...fr().filter(t=>t.id!==e.id)].slice(0,Er);try{localStorage.setItem(wr,JSON.stringify(t))}catch{}}function mr(){return Mr(Tr,Dr)}function hr(e){return mr().some(t=>t.id===e)}function gr(e){if(!e?.id||e.folder||!String(e.url||``).trim())return!1;let t=[e,...mr().filter(t=>t.id!==e.id)].slice(0,Dr);try{return localStorage.setItem(Tr,JSON.stringify(t)),!0}catch{return!1}}function _r(e){let t=String(e||``).trim();if(!t)return!1;let n=mr().filter(e=>e.id!==t);try{return localStorage.setItem(Tr,JSON.stringify(n)),!0}catch{return!1}}function vr(e,t=Nr){let n=String(e||``).trim();if(!n)return``;try{let e=new URL(n,globalThis.location?.href);if(e.searchParams.has(`pageUrl`))return e.searchParams.set(`size`,String(t)),e.toString();if(e.hostname.endsWith(`google.com`)&&e.pathname.includes(`favicon`))return e.searchParams.set(`sz`,String(t)),e.toString()}catch{}return n}function yr(e,t){let n=String(e.url||``).trim();return n&&(or(n,Nr)||or(n,128)||or(n,64)||t?.resolveIconUrl?.(n,Nr)||t?.resolveIconUrl?.(n,128))||``}function br(e,t,n,r=``){return Sr(e,t,String(r||``).trim()||vr(yr(e,n),Nr))}function xr(e,t=``){let n=String(e.url||``).trim();return JSON.stringify({state:{icon:e.folder?`folder`:`link`,label:e.title||n||`Bookmark`,action:e.folder?`open-path`:`open-link`},desc:{action:e.folder?`open-path`:`open-link`,href:e.folder?``:n,path:e.folder?`/bookmarks/${e.id}/`:`/bookmarks/${e.id}`,meta:{entityType:`bookmark`,bookmarkId:e.id,...t?{iconUrl:t}:{}}}})}function Sr(e,t,n=``){if(e.folder||!String(e.url||``).trim())return null;let r=t??_e(),i=pe(xr(e,n),r);return i?(xe(i),i):null}async function Cr(e,t,n){if(e.replaceChildren(),t.folder)return Pr(e,`folder`),e.toggleAttribute(`data-bookmark-bitmap`,!1),``;let r=String(t.url||``).trim(),i=[],a=or(r,Nr);a&&i.push(a);let o=or(r,128);o&&!i.includes(o)&&i.push(o);let s=or(r,64);s&&!i.includes(s)&&i.push(s);let c=n?.resolveIconUrl?.(r,Nr)||``;c&&!i.includes(c)&&i.push(c);let l=n?.resolveIconUrl?.(r,128)||``;l&&!i.includes(l)&&i.push(l);let u=n?.resolveIconUrl?.(r,64)||``;u&&!i.includes(u)&&i.push(u);try{let e=globalThis.chrome?.runtime;if(typeof e?.getURL==`function`&&r){let t=new URL(e.getURL(`/_favicon/`));t.searchParams.set(`pageUrl`,r),t.searchParams.set(`size`,String(Nr));let n=t.toString();n&&!i.includes(n)&&i.push(n)}}catch{}return Pr(e,`link`),e.toggleAttribute(`data-bookmark-bitmap`,!1),i.length?await new Promise(t=>{let n=0,r=()=>{if(n>=i.length){t(``);return}let a=i[n++],o=document.createElement(`img`);o.className=`env-shell-app-menu__tile-favicon`,o.alt=``,o.decoding=`async`,o.loading=`eager`,o.referrerPolicy=`no-referrer`,o.draggable=!1,o.addEventListener(`load`,()=>{e.replaceChildren(o),e.toggleAttribute(`data-bookmark-bitmap`,!0),t(a)},{once:!0}),o.addEventListener(`error`,()=>{r()},{once:!0}),o.src=a};r()}):``}var wr,Tr,Er,Dr,Or,kr,Ar,jr,Mr,Nr,Pr;function Fr(){return(Fr=e((()=>{I(),wr=`rs-app-menu-bookmark-recent`,Tr=`rs-app-menu-bookmark-pinned`,Er=12,Dr=16,Or=null,kr=()=>{try{let e=globalThis.chrome?.runtime?.lastError;return e?Error(String(e.message||e)):null}catch{return null}},Ar=(e,t,...n)=>{let r=e[t];if(typeof r!=`function`)return Promise.reject(Error(`chrome.bookmarks.${String(t)} missing`));try{let t=r.apply(e,n);if(t!=null&&typeof t.then==`function`)return t}catch(e){return Promise.reject(e)}return new Promise((t,i)=>{try{r.apply(e,[...n,e=>{let n=kr();n?i(n):t(e)}])}catch(e){i(e)}})},jr=e=>{let t=typeof e.url==`string`&&e.url?e.url:void 0;return{id:String(e.id),title:String(e.title||e.url||e.id||`Bookmark`),url:t,folder:!t,parentId:e.parentId}},Mr=(e,t)=>{try{let n=localStorage.getItem(e);if(!n)return[];let r=JSON.parse(n);return Array.isArray(r)?r.filter(e=>e&&e.id&&e.title&&!e.folder).slice(0,t):[]}catch{return[]}},Nr=256,Pr=(e,t)=>{let n=document.createElement(`ui-icon`);n.setAttribute(`icon`,t),n.setAttribute(`icon-style`,`duotone`),n.setAttribute(`aria-hidden`,`true`),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`),n.style.setProperty(`--icon-color`,`currentColor`),n.style.color=`currentColor`,e.append(n),customElements.whenDefined(`ui-icon`).then(()=>{n.isConnected&&(n.getAttribute(`icon`)||n.setAttribute(`icon`,t),n.style.setProperty(`--icon-size`,`1.75rem`),n.style.setProperty(`--icon-padding`,`0px`))})}})))()}function Ir(e){return e===`light`||e===`dark`?e:String(document.documentElement.getAttribute(`data-theme`)||``).toLowerCase()===`light`?`light`:`dark`}function Lr(e){let t=String(e||``).trim();return/^https?:\/\//i.test(t)?t:``}function Rr(e,t=128){try{let n=new URL(e).hostname;return n?`https://www.google.com/s2/favicons?domain=${encodeURIComponent(n)}&sz=${t}`:``}catch{return``}}function zr(e,t=128){try{let n=globalThis.chrome?.runtime;if(typeof n?.getURL!=`function`)return``;let r=new URL(n.getURL(`/_favicon/`));return r.searchParams.set(`pageUrl`,e),r.searchParams.set(`size`,String(t)),r.toString()}catch{return``}}function Br(e,t){let n=Lr(e);if(!n)return[];let r=[],i=new Set,a=(e,t)=>{let n=String(t||``).trim();!n||i.has(n)||(i.add(n),r.push({label:e,url:n}))},o=t?.resolveIconUrl?.(n,128)||t?.resolveIconUrl?.(n,64)||``,s=Rr(n,128);s&&a(`Google S2`,s);let c=Rr(n,64);c&&a(`Google S2 (64)`,c);let l=zr(n,128);return l&&a(`Chrome favicon`,l),o&&a(`Bookmark favicon`,o),r}function Vr(e){q(e,{display:`grid`,"grid-template-columns":$r,gap:`0.5rem 0.4rem`,"align-content":`start`,"justify-content":`stretch`,"min-inline-size":`0`,"min-block-size":`0`,"inline-size":`100%`})}function Hr(e,t,n){q(e,{display:`grid`,"grid-template-columns":`minmax(0, 1fr)`,"grid-template-rows":`auto max-content`,"justify-items":`center`,"align-content":`start`,"align-items":`start`,"flex-direction":`column`,gap:`0.3rem`,margin:`0`,padding:`0.2rem 0.08rem 0.15rem`,"min-inline-size":`0`,"inline-size":`100%`,"max-inline-size":`100%`,"block-size":`auto`,"min-block-size":`0`,background:`transparent`,border:`0`,"border-radius":`0.7rem`,"box-shadow":`none`,appearance:`none`,"-webkit-appearance":`none`,position:`static`,"z-index":`auto`,overflow:`hidden`}),q(t,{display:`block`,"grid-row":`1`,"inline-size":`3rem`,"block-size":`3rem`,"max-inline-size":`3rem`,"max-block-size":`3rem`,"object-fit":`cover`,"border-radius":`50%`,"flex-shrink":`0`}),q(n,{display:`block`,"grid-row":`2`,"inline-size":`100%`,"max-inline-size":`100%`,overflow:`hidden`,"text-overflow":`ellipsis`,"white-space":`nowrap`,"font-size":`0.62rem`,"line-height":`1.2`,"text-align":`center`,opacity:`0.88`})}function Ur(e,t){let n=document.createElement(`button`);n.type=`button`,n.className=`sd-icon-picker__card`,n.title=t||e;let r=document.createElement(`img`);r.alt=``,r.decoding=`async`,r.draggable=!1,r.referrerPolicy=`no-referrer`;let i=document.createElement(`span`);return i.className=`sd-icon-picker__card-label`,i.textContent=e,n.append(r,i),Hr(n,r,i),{btn:n,img:r}}async function Wr(e,t,n,r,i){n.replaceChildren();let a=Qr.map(e=>({...e,available:!0}));try{let n=await e.launcherIconVariants?.(t);Array.isArray(n)&&n.length&&(a=n.map(e=>({id:Ln(e.id),label:String(e.label||e.id),available:e.available!==!1})))}catch{}for(let e of a){if(!e.available&&e.id!=="default")continue;let{btn:a,img:o}=Ur(e.label);n.append(a),Jn(t,96,e.id).then(t=>{if(!t){a.disabled=!0,a.title=`${e.label} (unavailable)`;return}o.src=t}),a.addEventListener(`click`,()=>{r({iconUrl:zn(t,e.id),packageName:t,variant:e.id,label:e.label,source:`android`}),i()})}}async function Gr(e,t,n,r,i){if(n.replaceChildren(),n.classList.remove(`sd-icon-picker__grid--browse`),Vr(n),!e.launcherIconPacks){n.textContent=`Icon packs unavailable.`;return}let a=[];try{a=await e.launcherIconPacks()}catch{n.textContent=`Failed to list icon packs.`;return}if(!a.length){n.textContent=`No icon packs installed.`;return}let o=document.createDocumentFragment();for(let s of a.slice(0,64)){let a=String(s.packageName||``).trim();if(!a)continue;let c=String(s.label||a),l=document.createElement(`div`);l.className=`sd-icon-picker__pack-wrap`,q(l,{position:`relative`,"min-inline-size":`0`,"inline-size":`100%`});let{btn:u,img:d}=Ur(c,`${c} — tap to apply, grid to browse`);Jn(t,96,`default`,a).then(e=>{if(e){d.src=e;return}u.disabled=!0,u.title=`${c} (no cover for this app)`,Jn(a,72,`default`).then(e=>{e&&(d.src=e)})}),u.addEventListener(`click`,()=>{u.disabled||(r({iconUrl:zn(t,`default`,a),packageName:t,variant:`default`,pack:a,label:c,source:`icon-pack`}),i())});let f=document.createElement(`button`);f.type=`button`,f.className=`sd-icon-picker__pack-browse`,q(f,{position:`absolute`,"inset-block-start":`0`,"inset-inline-end":`0`,display:`grid`,"place-items":`center`,margin:`0`,padding:`0`,"inline-size":`1.2rem`,"block-size":`1.2rem`,"min-inline-size":`1.2rem`,"min-block-size":`1.2rem`,border:`0`,"border-radius":`999px`}),f.title=`Browse icons in ${c}`,f.setAttribute(`aria-label`,`Browse icons in ${c}`),f.innerHTML=`<ui-icon icon="squares-four" aria-hidden="true"></ui-icon>`,f.addEventListener(`click`,o=>{o.preventDefault(),o.stopPropagation(),n.dataset.packBrowse=`1`,Kr(e,t,a,c,n,r,i,()=>{delete n.dataset.packBrowse,Gr(e,t,n,r,i)})}),l.append(u,f),o.append(l)}n.append(o)}async function Kr(e,t,n,r,i,a,o,s){i.replaceChildren(),i.classList.add(`sd-icon-picker__grid--browse`),i.style.setProperty(`display`,`grid`,`important`),i.style.setProperty(`grid-template-columns`,`minmax(0, 1fr)`,`important`),i.style.setProperty(`grid-template-rows`,`auto minmax(0, 1fr)`,`important`),i.style.setProperty(`gap`,`0.35rem`,`important`);let c=document.createElement(`div`);c.className=`sd-icon-picker__pack-toolbar`;let l=document.createElement(`button`);l.type=`button`,l.className=`sd-icon-picker__pack-back`,l.textContent=`Packs`,l.addEventListener(`click`,()=>s());let u=document.createElement(`span`);u.className=`sd-icon-picker__pack-title`,u.textContent=r;let d=document.createElement(`input`);d.type=`search`,d.placeholder=`Filter…`,d.autocomplete=`off`,d.className=`sd-icon-picker__search`,c.append(l,u,d);let f=document.createElement(`div`);f.className=`sd-icon-picker__grid`,Vr(f),i.append(c,f);let p=0,m=()=>{(async()=>{if(f.replaceChildren(),!e.launcherIconPackIcons){f.textContent=`Pack browse unavailable.`;return}let i=[];try{i=await e.launcherIconPackIcons(n,String(d.value||``),96)}catch{f.textContent=`Failed to list pack icons.`;return}if(!i.length){f.textContent=`No matching icons.`;return}let s=document.createDocumentFragment(),c=t||n;for(let e of i){let t=String(e.drawable||``).trim();if(!t)continue;let{btn:i,img:l}=Ur(String(e.label||t),`${r}: ${t}`);s.append(i),Jn(c,72,`default`,n,t).then(e=>{e?l.src=e:i.disabled=!0}),i.addEventListener(`click`,()=>{i.disabled||(a({iconUrl:zn(c,`default`,n,t),packageName:c,variant:`default`,pack:n,drawable:t,label:String(e.label||t),source:`icon-pack`}),o())})}f.append(s)})()};d.addEventListener(`input`,()=>{window.clearTimeout(p),p=window.setTimeout(m,160)}),m()}async function qr(e,t,n,r,i){if(n.replaceChildren(),!e.launcherList){n.textContent=`App list unavailable.`;return}let a=[];try{a=await e.launcherList(t)}catch{n.textContent=`Failed to list apps.`;return}if(!a.length){n.textContent=t.trim()?`No matches.`:`No apps.`;return}let o=document.createDocumentFragment();for(let e of a.slice(0,96)){let t=String(e.packageName||``).trim();if(!t)continue;let{btn:n,img:a}=Ur(String(e.label||t),`${e.label} (${t})`);o.append(n),Jn(String(e.iconCacheKey||t).trim()||t,72,`default`).then(e=>{e&&(a.src=e)}),n.addEventListener(`click`,()=>{r({iconUrl:zn(t,`default`),packageName:t,variant:`default`,label:String(e.label||t),source:`android`}),i()})}n.append(o)}function Jr(e,t,n,r,i){n.replaceChildren();let a=Br(e,t);if(!a.length){n.textContent=`No favicon sources for this URL.`;return}for(let e of a){let{btn:t,img:a}=Ur(e.label,e.url);a.src=e.url,a.addEventListener(`error`,()=>{t.disabled=!0,t.title=`${e.label} (failed to load)`}),t.addEventListener(`click`,()=>{r({iconUrl:e.url,label:e.label,source:`favicon`}),i()}),n.append(t)}}async function Yr(e,t,n,r,i){n.replaceChildren();let a=[];try{let n=String(t||``).trim();a=n?await e.search(n):await e.listChildren()}catch{n.textContent=`Failed to list bookmarks.`;return}let o=a.filter(e=>!e.folder&&Lr(e.url));if(!o.length){n.textContent=t.trim()?`No matching bookmarks.`:`No bookmarks.`;return}let s=document.createDocumentFragment();for(let t of o.slice(0,80)){let n=Lr(t.url);if(!n)continue;let a=e.resolveIconUrl?.(n,64)||zr(n,64)||Rr(n,64),{btn:o,img:c}=Ur(String(t.title||n),n);a&&(c.src=a),s.append(o),o.addEventListener(`click`,()=>{let o=e.resolveIconUrl?.(n,128)||zr(n,128)||Rr(n,128)||a;o&&(r({iconUrl:o,label:String(t.title||n),source:`bookmark`}),i())})}n.append(s)}async function Xr(e){let t=await Qn(),n=ur(),r=!!t?.launcherIcon,i=Lr(e.pageUrl)||Lr(e.currentUrl)||``;if(!r&&!(n||i)){console.warn(`[icon-resource-picker] no launcher bridge or bookmarks/favicon source`);return}let a=Ir(e.theme),o=String(e.packageName||``).trim(),s=r&&!!o,c=r&&!!o&&!!t?.launcherIconPacks,l=r&&!!t?.launcherList,u=!!i,d=!!n,f=[];s&&f.push({id:`variants`,label:`This app`}),c&&f.push({id:`packs`,label:`Packs`}),u&&f.push({id:`favicon`,label:`Link`}),l&&f.push({id:`browse`,label:`Apps`}),d&&f.push({id:`bookmarks`,label:`Bookmarks`});let p=f[0]?.id||`browse`,m=document.createElement(`dialog`);m.className=`sd-icon-picker`,m.dataset.theme=a,m.dataset.tab=p,m.innerHTML=`
    ...
    `,q(m,{position:`fixed`,inset:`0`,top:`0`,right:`0`,bottom:`0`,left:`0`,width:`100%`,height:`100%`,"inline-size":`100%`,"block-size":`100%`,"max-inline-size":`100%`,"max-block-size":`100%`,"max-width":`100%`,"max-height":`100%`,margin:`0`,padding:`1rem`,display:`grid`,"place-items":`center`,"place-content":`center`,background:`transparent`,border:`none`,"border-radius":`0`,"box-shadow":`none`,overflow:`auto`});let h=m.querySelector(`.sd-icon-picker__form`);h&&q(h,{display:`flex`,"flex-direction":`column`,"inline-size":`min(90cqi, 100dvi)`,width:`min(90cqi, 100dvi)`,"max-inline-size":`100%`,"max-block-size":`min(86dvh, 36rem)`,margin:`0`,padding:`0`,"border-radius":`18px`,overflow:`hidden`,"justify-self":`center`,"align-self":`center`,background:`color-mix(in oklab, var(--color-surface-container, Canvas) 92%, transparent)`});let g=m.querySelector(`.sd-icon-picker__tabs`);g&&q(g,{display:`grid`,"grid-auto-flow":`column`,"grid-auto-columns":`1fr`,gap:`0.28rem`,"inline-size":`100%`});let _=m.querySelector(`.sd-icon-picker__body`);_&&q(_,{display:`block`,padding:`0.65rem 0.85rem 0.45rem`,"min-block-size":`0`,"max-block-size":`min(26rem, 52dvh)`,overflow:`auto`,background:`transparent`});let v=m.querySelector(`.sd-icon-picker__footer`);v&&q(v,{display:`flex`,"justify-content":`flex-end`,"align-items":`center`,gap:`0.45rem`,padding:`0.55rem 0.85rem 0.7rem`});let y=m.querySelector(`.sd-icon-picker__cancel`);y&&q(y,{display:`inline-flex`,"align-items":`center`,"justify-content":`center`,flex:`0 0 auto`,margin:`0`,padding:`0.42rem 0.86rem`,"inline-size":`auto`,width:`auto`,"min-inline-size":`0`,"max-inline-size":`none`,"border-radius":`0.65rem`});let b=m.querySelector(`form`),x=m.querySelector(`.sd-icon-picker__tabs`),S=m.querySelector(`[data-search]`),C=m.querySelector(`[data-variants]`),w=m.querySelector(`[data-packs]`),T=m.querySelector(`[data-favicon]`),E=m.querySelector(`[data-browse]`),D=m.querySelector(`[data-bookmarks]`),O=!1,k=()=>{if(!O){O=!0;try{m.open&&m.close()}catch{}m.remove()}},A=t=>{e.onPick(t)};b.addEventListener(`click`,e=>{e.target?.closest?.(`[data-action]`)?.getAttribute(`data-action`)===`cancel`&&(e.preventDefault(),k())}),m.addEventListener(`cancel`,e=>{e.preventDefault(),k()}),m.addEventListener(`click`,e=>{e.target===m&&k()});let ee=e=>{m.dataset.tab=e,m.querySelectorAll(`[data-section]`).forEach(t=>{t.hidden=t.dataset.section!==e}),x?.querySelectorAll(`[data-tab]`).forEach(t=>{let n=t.dataset.tab===e;t.toggleAttribute(`data-active`,n),t.setAttribute(`aria-selected`,n?`true`:`false`),t.tabIndex=n?0:-1});let n=e===`browse`||e===`bookmarks`;S&&(S.hidden=!n,S.placeholder=e===`bookmarks`?`Search bookmarks…`:`Search apps…`,n&&(S.value=``)),e===`packs`&&w?.dataset.packBrowse===`1`&&t&&o&&(delete w.dataset.packBrowse,Gr(t,o,w,A,k))};if(x){let e=document.createDocumentFragment();for(let t of f){let n=document.createElement(`button`);n.type=`button`,n.className=`sd-icon-picker__tab`,n.dataset.tab=t.id,n.setAttribute(`role`,`tab`),n.textContent=t.label,q(n,{display:`inline-flex`,flex:`1 1 0`,"align-items":`center`,"justify-content":`center`,margin:`0`,padding:`0.38rem 0.4rem`,border:`0`,"border-radius":`999px`,"inline-size":`100%`,"min-inline-size":`0`,"block-size":`auto`}),n.addEventListener(`click`,e=>{e.preventDefault(),ee(t.id)}),e.append(n)}x.append(e),x.hidden=f.length<=1}s&&t&&C&&Wr(t,o,C,A,k),c&&t&&w&&o&&Gr(t,o,w,A,k),u&&T&&Jr(i,n,T,A,k);let j=0,te=()=>{!E||!t||qr(t,String(S?.value||``),E,A,k)},M=0,N=()=>{!D||!n||Yr(n,String(S?.value||``),D,A,k)};S?.addEventListener(`input`,()=>{let e=m.dataset.tab;if(e===`browse`){window.clearTimeout(j),j=window.setTimeout(te,180);return}e===`bookmarks`&&(window.clearTimeout(M),M=window.setTimeout(N,180))}),l&&te(),d&&n&&N(),x?.addEventListener(`click`,e=>{let t=e.target?.closest?.(`[data-tab]`)?.getAttribute(`data-tab`);t===`browse`&&te(),t===`bookmarks`&&N()}),ee(p),document.body.append(m),m.querySelectorAll(`.sd-icon-picker__grid`).forEach(Vr);try{m.showModal()}catch{m.setAttribute(`open`,``)}}function Zr(e,t,n){let r=e.querySelector(`.sd-icon-resource-row`);r||(r=document.createElement(`div`),r.className=`sd-icon-resource-row`,t.replaceWith(r),r.append(t)),r.style.setProperty(`display`,`grid`,`important`),r.style.setProperty(`grid-template-columns`,`minmax(0,1fr) 2.5rem 2.5rem`,`important`),r.style.setProperty(`align-items`,`stretch`,`important`),r.style.setProperty(`gap`,`0.45rem`,`important`),r.style.setProperty(`min-inline-size`,`0`,`important`),r.style.setProperty(`inline-size`,`100%`,`important`);let i=r.querySelector(`[data-action='pick-icon']`);i||(i=document.createElement(`button`),i.type=`button`,i.className=`btn secondary sd-icon-resource-pick`,i.setAttribute(`data-action`,`pick-icon`),i.title=`Pick alternative icon`,i.setAttribute(`aria-label`,`Pick alternative icon`),i.innerHTML=`<ui-icon icon="squares-four" icon-style="duotone" aria-hidden="true"></ui-icon>`,r.append(i));let a=r.querySelector(`[data-action='pick-photo']`);a||(a=document.createElement(`button`),a.type=`button`,a.className=`btn secondary sd-icon-resource-pick`,a.setAttribute(`data-action`,`pick-photo`),a.title=`Use photo / avatar`,a.setAttribute(`aria-label`,`Use photo or avatar`),a.innerHTML=`<ui-icon icon="user-circle" icon-style="duotone" aria-hidden="true"></ui-icon>`,r.append(a)),t.parentElement!==r&&r.insertBefore(t,i),i.parentElement===r&&a.parentElement===r&&(r.append(i,a),r.insertBefore(t,i));let o=e=>{e.style.setProperty(`display`,`inline-flex`,`important`),e.style.setProperty(`align-items`,`center`,`important`),e.style.setProperty(`justify-content`,`center`,`important`),e.style.setProperty(`inline-size`,`2.5rem`,`important`),e.style.setProperty(`min-inline-size`,`2.5rem`,`important`),e.style.setProperty(`max-inline-size`,`2.5rem`,`important`),e.style.setProperty(`min-block-size`,`2.5rem`,`important`),e.style.setProperty(`padding`,`0`,`important`),e.style.setProperty(`margin`,`0`,`important`)};return o(i),o(a),i.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),Xr({packageName:typeof n.packageName==`function`?n.packageName():String(n.packageName||``).trim(),pageUrl:typeof n.pageUrl==`function`?n.pageUrl():String(n.pageUrl||``).trim(),currentUrl:t.value,theme:n.theme,onPick:e=>{t.value=e.iconUrl,t.setAttribute(`value`,e.iconUrl),t.dispatchEvent(new Event(`input`,{bubbles:!0})),t.dispatchEvent(new Event(`change`,{bubbles:!0}))}})}),a.addEventListener(`click`,n=>{n.preventDefault(),n.stopPropagation();let r=document.createElement(`input`);r.type=`file`,r.accept=`image/*`,r.style.display=`none`,document.body.append(r),r.addEventListener(`change`,()=>{let n=r.files?.[0];if(r.remove(),!n)return;let i=new FileReader;i.onload=()=>{let n=String(i.result||``).trim();if(!n.startsWith(`data:image/`))return;t.value=n,t.setAttribute(`value`,n),t.dispatchEvent(new Event(`input`,{bubbles:!0})),t.dispatchEvent(new Event(`change`,{bubbles:!0}));let r=e.closest(`form`)?.querySelector(`select[name="iconDisplay"]`);r&&(r.value=`colored`,r.dispatchEvent(new Event(`change`,{bubbles:!0})))},i.readAsDataURL(n)},{once:!0}),r.click()}),i}var Qr,$r,q;function ei(){return(ei=e((()=>{ar(),Un(),Fr(),Qr=[{id:`default`,label:`Default`},{id:`monochrome`,label:`Material You`},{id:`foreground`,label:`Adaptive FG`}],$r=`repeat(auto-fill, minmax(4.75rem, 1fr))`,q=(e,t)=>{for(let[n,r]of Object.entries(t))e.style.setProperty(n,r,`important`)}})))()}function ti(){if(J)return J;try{let e=localStorage.getItem(li);if(!e)return J={},J;let t=JSON.parse(e);J=t&&typeof t==`object`?t:{}}catch{J={}}return J}function ni(e){J=e;try{localStorage.setItem(li,JSON.stringify(e))}catch{}}function ri(e){return`app:${String(e||``).trim()}`}function ii(e){return`bm:${String(e||``).trim()}`}function ai(e){let t=String(e||``).trim();return t?{...ti()[t]||{}}:{}}function oi(e,t){let n=String(e||``).trim();if(!n)return{};let r={...ti()},i={...r[n]||{},...t};return i.shape&&=N(i.shape,`circle`),i.iconDisplay&&=P(i.iconDisplay)||`colored`,i.iconScale!=null&&(i.iconScale=ve(i.iconScale)),r[n]=i,ni(r),i}function si(e){let t=String(e||``).trim();if(!t)return;let n={...ti()};delete n[t],ni(n)}function ci(e){let t={...e.defaults||{},...e.initial||{},...ai(e.key)},n=String(t.iconUrl||``).trim(),r=n.startsWith(`blob:`)?``:n,i=document.createElement(`dialog`);i.className=`speed-dial-editor env-shell-app-menu__chrome-editor`,i.innerHTML=`
            ...
            <div class="modal-fields">
                <div class="modal-field">
                    ...
                    <select id="am-chrome-shape" name="shape">
                        ${De.map(e=>`<option value="${e.value}"${N(t.shape,`circle`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
                    <label for="am-chrome-display">Icon display</label>
                    <select id="am-chrome-display" name="iconDisplay">
                        ${le.map(e=>`<option value="${e.value}"${(P(t.iconDisplay)||`colored`)===e.value?` selected`:``}>${e.label}</option>`).join(``)}
                    </select>
                </div>
                <div class="modal-field">
...
}`})))()}function pi(){return document.documentElement.dataset.cwspShellRole===`launcher`||globalThis.__RS_SHELL_ROLE__===`launcher`}function mi(){return pi()||dr()}function hi(){return pi()?`launcher`:dr()?`bookmarks`:null}async function gi(){if(ji)return ji;try{return await c(()=>import(`./launcher-bridge-C3JnBhTN.js`),[],import.meta.url)}catch{return null}}function _i(){if(!Oi){Oi=!0;try{document.adoptedStyleSheets=[...document.adoptedStyleSheets,Di]}catch{}}}function vi(){return document.querySelector(`.env-shell-root`)||document.querySelector(`env-shell-container`)||document.querySelector(`.env-shell-chrome`)?.parentElement||document.body}function yi(e,t){let n=document.createElement(`div`);n.className=`env-shell-app-menu__drag-ghost`,n.setAttribute(`aria-hidden`,`true`);let r=e.cloneNode(!0);r.className=`env-shell-app-menu__drag-ghost-icon ui-ws-item-icon shaped`,r.setAttribute(`data-shape`,N(e.getAttribute(`data-shape`),`circle`));let i=document.createElement(`span`);return i.className=`env-shell-app-menu__drag-ghost-label`,i.textContent=t,n.append(r,i),n}function bi(e,t){let n=N(t.chrome.shape,Mi);e.setAttribute(`data-shape`,n),e.classList.add(`ui-ws-item-icon`,`shaped`);let r=String(t.chrome.iconUrl||``).trim()||String(t.resourceUrl||``).trim(),i=Oe(t.chrome.iconScale),a=Rn(r)?Xn(r,i):``,o=String(a||(Rn(r)?``:r)||``).trim(),s=P(t.chrome.iconDisplay)||Ee({iconDisplay:t.chrome.iconDisplay,iconUrl:o||r,isLauncherApp:!!t.launcher,isBookmarkFavicon:!!(o||r)&&!t.launcher});e.setAttribute(`data-icon-display`,s),ce(e,M(s,t.chrome.iconScale)),e.replaceChildren();let c=()=>{me(e),re(e)};if(s===`glyph`){let n=String(t.chrome.icon||t.fallbackGlyph||`device-mobile`).trim()||`device-mobile`,r=document.createElement(`ui-icon`);r.setAttribute(`icon`,n),r.setAttribute(`icon-style`,`duotone`),r.setAttribute(`aria-hidden`,`true`),e.append(r),c();return}if(s===`colored`){let n=document.createElement(`img`);n.className=t.launcher?`ui-ws-item-icon-img`:`ui-ws-item-icon-img env-shell-app-menu__tile-favicon`,n.alt=``,n.decoding=`async`,n.draggable=!1,n.referrerPolicy=`no-referrer`,!t.launcher&&(sr(o)||sr(r))?n.toggleAttribute(`data-bookmark-favicon`,!0):t.launcher&&n.toggleAttribute(`data-launcher-icon`,!0),o?n.src=o:n.toggleAttribute(`data-icon-pending`,!0),e.append(n),c(),Rn(r)&&Yn(r,i).then(e=>{!e||!n.isConnected||(n.src=e,n.removeAttribute(`data-icon-pending`),c())});return}let l=ae({display:s,glyph:String(t.chrome.icon||t.fallbackGlyph||`device-mobile`),resourceUrl:o||void 0,launcher:t.launcher,className:`ui-ws-item-icon-native`});e.append(l),c(),t.launcher&&o&&s!==`glyph`&&($n(l,o,s),c()),Rn(r)&&Yn(r,i).then(e=>{!e||!l.isConnected||($n(l,e,s),c())})}function xi(e,t,n,r){let i=()=>Se(t),a=typeof window<`u`&&(window.matchMedia?.(`(pointer: coarse)`)?.matches||`ontouchstart`in window);e.draggable=!a,a||(e.addEventListener(`dragstart`,e=>{let t=i();if(e.dataTransfer?.setData(`text/plain`,t),e.dataTransfer?.setData(`application/json`,t),e.dataTransfer){e.dataTransfer.effectAllowed=`copy`;try{e.dataTransfer.setDragImage(n,24,24)}catch{}}document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0)}),e.addEventListener(`dragend`,()=>{document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1)}));let o,s=null,c=0,l=0,u=!1,d=!1,f=!1,p=null,m=()=>{o&&=(clearTimeout(o),void 0)},h=()=>{if(m(),u=!1,d&&(d=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),p?.remove(),p=null,s!=null)){try{e.releasePointerCapture(s)}catch{}s=null}},g=(r,i,a)=>{if(!d){u=!1,d=!0,f=!0,e.classList.add(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0),p=yi(n,t.label),document.body.appendChild(p),p.style.transform=`translate(${r}px, ${i}px) translate(-50%, -50%)`;try{e.setPointerCapture(a)}catch{}}},_=(e,t)=>{p&&(p.style.transform=`translate(${e}px, ${t}px) translate(-50%, -50%)`)},v=(e,n)=>{if(!de(e,n))return;let i=se(e,n);fe(t,i??void 0)&&(In(`Pinned ${t.label} to desktop`),r.onPinned?.())},y=t=>{if(d){if(d=!1,u=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),p?.remove(),p=null,s!=null){try{e.releasePointerCapture(s)}catch{}s=null}v(t.clientX,t.clientY)}};e.addEventListener(`pointerdown`,e=>{e.button===0&&(m(),s=e.pointerId,c=e.clientX,l=e.clientY,f=!1,d=!1,u=!1,o=setTimeout(()=>{o=void 0,u=!0,f=!0},ki))},{passive:!0}),e.addEventListener(`pointermove`,e=>{if(o&&!d&&!u){let t=e.clientX-c,n=e.clientY-l;Math.hypot(t,n)>Ai&&m();return}if(u&&!d){let t=e.clientX-c,n=e.clientY-l;Math.hypot(t,n)>Ai&&g(e.clientX,e.clientY,e.pointerId);return}d&&(_(e.clientX,e.clientY),e.preventDefault())},{passive:!1}),e.addEventListener(`pointerup`,e=>{if(m(),u=!1,d){y(e);return}}),e.addEventListener(`pointercancel`,e=>{m(),u=!1,d&&y(e)}),e.addEventListener(`contextmenu`,()=>{h()},!0),e.addEventListener(`click`,e=>{f&&=(e.preventDefault(),e.stopPropagation(),!1)},!0)}function Si(e,t,n,r,i){let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-app-menu__tile`,a.setAttribute(`data-package`,e.packageName),a.title=`${e.label} — right-click: desktop; hold and drag`;let o=ri(e.packageName),s=document.createElement(`span`);s.className=`env-shell-app-menu__tile-icon ui-ws-item-icon shaped`;let c=document.createElement(`span`);c.className=`env-shell-app-menu__tile-label`,c.textContent=e.label,a.append(s,c);let l=e.iconCacheKey||e.packageName,u=(e=``)=>{bi(s,{chrome:ai(o),fallbackGlyph:`device-mobile`,resourceUrl:e,launcher:!0})},d=Oe(ai(o).iconScale);return u(Gn(l,d)),Jn(l,d).then(e=>{n===r()&&e&&u(e)}).catch(()=>{}),xi(a,e,s,i),a.addEventListener(`contextmenu`,n=>{n.preventDefault(),n.stopPropagation(),Pn({x:n.clientX,y:n.clientY,compact:!0,items:[{id:`place-desktop`,label:`Place on desktop`,icon:`desktop`,action:()=>{fe(e)&&(In(`Placed “${e.label}” on desktop`),i.onPinned?.())}},{id:`icon-design`,label:`Icon design…`,icon:`palette`,action:()=>{ci({title:e.label,key:o,packageName:e.packageName,defaults:{shape:Mi,iconDisplay:`colored`},onSave:e=>{let t={...ai(o),...e},n=Oe(t.iconScale),r=(e=``)=>{bi(s,{chrome:t,fallbackGlyph:`device-mobile`,resourceUrl:e,launcher:!0})};r(Gn(l,n)||(Rn(String(t.iconUrl||``))?``:String(t.iconUrl||``).trim())),Rn(String(t.iconUrl||``))?Yn(t.iconUrl,n).then(e=>{e&&r(e)}):Jn(l,n).then(e=>{e&&r(e)})}})}},{id:`launch`,label:`Open`,icon:`arrow-square-out`,action:async()=>{try{await t.launcherLaunch(e.packageName,e.componentName)}catch{}}}]})}),a.addEventListener(`click`,async n=>{n.preventDefault(),n.stopPropagation();try{await t.launcherLaunch(e.packageName,e.componentName)}catch{}}),a}function Ci(e,t,n,r,i){if(t.folder||!String(t.url||``).trim())return;let a,o=!1,s=!1,c=0,l=0,u=-1,d=null,f=()=>{a!=null&&(clearTimeout(a),a=void 0)},p=()=>{if(f(),o=!1,s){s=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),d?.remove(),d=null;try{e.releasePointerCapture?.(u)}catch{}}},m=(r,i)=>{if(!s){o=!1,s=!0,e.classList.add(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!0),d=yi(n,t.title),document.body.appendChild(d),d.style.transform=`translate(${r}px, ${i}px) translate(-50%, -50%)`;try{e.setPointerCapture?.(u)}catch{}}},h=(n,a)=>{if(f(),o=!1,s){s=!1,e.classList.remove(`env-shell-app-menu__tile--dragging`),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),d?.remove(),d=null;try{e.releasePointerCapture?.(u)}catch{}if(de(n,a)){let e=se(n,a)??void 0,o=String(r.current||``).trim()||yr(t,ur());br(t,e,ur(),o)&&(In(`Placed “${t.title}” on desktop`),i.onPinned?.())}}};e.addEventListener(`pointerdown`,e=>{(e.button==null||e.button===0)&&(c=e.clientX,l=e.clientY,u=e.pointerId,s=!1,o=!1,f(),a=setTimeout(()=>{a=void 0,o=!0},ki))}),e.addEventListener(`pointermove`,e=>{if(!s&&!o){if(a==null)return;let t=e.clientX-c,n=e.clientY-l;t*t+n*n>100&&f();return}if(o&&!s){let t=e.clientX-c,n=e.clientY-l;t*t+n*n>100&&m(e.clientX,e.clientY);return}d&&(d.style.transform=`translate(${e.clientX}px, ${e.clientY}px) translate(-50%, -50%)`,e.preventDefault())},{passive:!1}),e.addEventListener(`pointerup`,e=>h(e.clientX,e.clientY)),e.addEventListener(`pointercancel`,e=>h(e.clientX,e.clientY)),e.addEventListener(`contextmenu`,()=>p(),!0)}function wi(e,t,n,r,i){e.addEventListener(`contextmenu`,a=>{if(a.preventDefault(),a.stopPropagation(),t.folder){Pn({x:a.clientX,y:a.clientY,compact:!0,items:[{id:`open-folder`,label:`Open folder`,icon:`folder-open`,action:()=>{e.click()}}]});return}let o=hr(t.id);Pn({x:a.clientX,y:a.clientY,compact:!0,items:[{id:`place-desktop`,label:`Place on desktop`,icon:`desktop`,action:()=>{br(t,void 0,n,String(r.current||``).trim()||yr(t,n))&&(In(`Placed “${t.title}” on desktop`),i.onPinned?.())}},{id:`icon-design`,label:`Icon design…`,icon:`palette`,action:()=>{let i=ii(t.id);ci({title:t.title,key:i,pageUrl:String(t.url||``).trim(),defaults:{shape:Mi,iconDisplay:`colored`},onSave:a=>{let o=e.querySelector(`.env-shell-app-menu__tile-icon`);if(!o)return;let s={...ai(i),...a},c=String(s.iconUrl||``).trim()||String(r.current||``).trim()||yr(t,n);bi(o,{chrome:s,fallbackGlyph:t.folder?`folder`:`link`,resourceUrl:c}),c&&(r.current=c)}})}},o?{id:`unpin-start`,label:`Unpin from Start`,icon:`push-pin-slash`,action:()=>{_r(t.id)&&(In(`Unpinned “${t.title}”`),i.onStartPinsChanged?.())}}:{id:`pin-start`,label:`Pin to Start`,icon:`push-pin`,action:()=>{gr(t)&&(In(`Pinned “${t.title}” to Start`),i.onStartPinsChanged?.())}},{id:`open`,label:`Open`,icon:`arrow-square-out`,action:async()=>{pr(t);try{await n.open(t)}catch{}}}]})})}function Ti(e,t,n,r){let i=document.createElement(`button`);i.type=`button`,i.className=`env-shell-app-menu__tile`,i.setAttribute(`data-bookmark-id`,e.id),e.folder&&i.setAttribute(`data-folder`,``),i.title=e.folder?`${e.title} — open folder`:`${e.title} — right-click: desktop / pin; hold to drag`;let a=ii(e.id),o=document.createElement(`span`);o.className=`env-shell-app-menu__tile-icon ui-ws-item-icon shaped`,o.setAttribute(`data-shape`,Mi);let s=document.createElement(`span`);s.className=`env-shell-app-menu__tile-label`,s.textContent=e.title,i.append(o,s);let c={current:``},l=t=>{let n=ai(a);if(n.shape||n.iconDisplay||n.icon||n.iconUrl){bi(o,{chrome:n,fallbackGlyph:e.folder?`folder`:`link`,resourceUrl:String(n.iconUrl||t||``).trim()});return}o.setAttribute(`data-shape`,Mi)};return Cr(o,e,t).then(e=>{c.current=e,l(e)}),Ci(i,e,o,c,n),wi(i,e,t,c,n),i.addEventListener(`click`,async n=>{if(n.preventDefault(),n.stopPropagation(),!document.documentElement.hasAttribute(`data-app-menu-dragging`)){if(e.folder){r(e.id,e.title);return}pr(e);try{await t.open(e)}catch{}}}),i}function Ei(){_i();let e=hi(),t=document.createElement(`div`);t.className=`env-shell-app-menu`,t.hidden=!0,t.setAttribute(`role`,`dialog`),t.setAttribute(`aria-modal`,`false`),t.setAttribute(`aria-label`,e===`bookmarks`?`Bookmarks`:`Apps`),e&&t.setAttribute(`data-menu-mode`,e);let n=()=>{try{let e=document.documentElement,n=(e.getAttribute(`data-theme`)||``).toLowerCase(),r=(e.style.colorScheme||``).trim().toLowerCase(),i=n===`light`||n===`dark`?n:r===`light`||r===`dark`?r:``;if(i===`light`||i===`dark`){t.dataset.theme=i,t.style.colorScheme=i;return}delete t.dataset.theme,t.style.colorScheme=`inherit`}catch{}};n();let r=()=>n();document.addEventListener(`u2-theme-change`,r);let i=new MutationObserver(r);try{i.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`data-scheme`,`style`]})}catch{}let a=document.createElement(`div`);a.className=`env-shell-app-menu__panel`,e===`bookmarks`&&a.setAttribute(`data-layout`,`start-split`);let o=document.createElement(`div`);o.className=`env-shell-app-menu__banner`,o.hidden=!0;let s=document.createElement(`p`);s.className=`env-shell-app-menu__banner-text`,s.textContent=`Set CWSP Launcher as Home`;let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-app-menu__banner-action btn`,c.textContent=`Set as default`,o.append(s,c);let l=document.createElement(`input`);l.type=`search`,l.className=`env-shell-app-menu__search`,l.placeholder=e===`bookmarks`?`Search bookmarks`:`Search apps`,l.autocomplete=`off`,l.setAttribute(`aria-label`,e===`bookmarks`?`Search bookmarks`:`Search apps`);let u=document.createElement(`div`);u.className=`env-shell-app-menu__start-body`,u.hidden=e!==`bookmarks`;let d=document.createElement(`div`);d.className=`env-shell-app-menu__start-left`,d.setAttribute(`aria-label`,`Pinned and recent bookmarks`);let f=document.createElement(`div`);f.className=`env-shell-app-menu__start-heading`,f.textContent=`Pinned`;let p=document.createElement(`div`);p.className=`env-shell-app-menu__start-recent env-shell-app-menu__start-pinned`;let m=document.createElement(`div`);m.className=`env-shell-app-menu__start-heading`,m.textContent=`Recent`;let h=document.createElement(`div`);h.className=`env-shell-app-menu__start-recent`,d.append(f,p,m,h);let g=document.createElement(`div`);g.className=`env-shell-app-menu__start-right`;let _=document.createElement(`div`);_.className=`env-shell-app-menu__crumb`;let v=document.createElement(`div`);v.className=`env-shell-app-menu__grid`,v.setAttribute(`data-part`,`grid`),v.setAttribute(`aria-label`,e===`bookmarks`?`Bookmarks`:`Installed apps`),g.append(_,v),u.append(d,g),e===`bookmarks`?a.append(o,l,u):a.append(o,l,v),t.appendChild(a),vi().appendChild(t);let y=!1,b=0,x=``,S,C=[],w=()=>{if(!mi()){t.hidden=!0,t.toggleAttribute(`data-open`,!1);return}t.hidden=!y,t.toggleAttribute(`data-open`,y)},T=()=>{y&&(y=!1,t.toggleAttribute(`data-page`,!1),w(),t.dispatchEvent(new CustomEvent(`env-app-menu-close`,{bubbles:!0})))};t.addEventListener(`env-app-menu-request-close`,e=>{e.stopPropagation(),T()});let E=()=>{mi()&&(n(),y=!0,w(),M(),t.dispatchEvent(new CustomEvent(`env-app-menu-open`,{bubbles:!0})))},D=()=>{t.toggleAttribute(`data-page`,!0),E()},O=()=>{y?T():E()},k={onPinned:()=>{T()},onStartPinsChanged:()=>{M()}},A=()=>{if(_.replaceChildren(),e!==`bookmarks`)return;let t=document.createElement(`button`);t.type=`button`,t.className=`env-shell-app-menu__crumb-item`,t.textContent=`Bookmarks`,t.addEventListener(`click`,()=>{C=[],M()}),_.appendChild(t),C.forEach((e,t)=>{let n=document.createElement(`span`);n.className=`env-shell-app-menu__crumb-sep`,n.textContent=`›`;let r=document.createElement(`button`);r.type=`button`,r.className=`env-shell-app-menu__crumb-item`,r.textContent=e.title,r.addEventListener(`click`,()=>{C=C.slice(0,t+1),M()}),_.append(n,r)})},ee=async(e,t)=>{let n=[];try{n=await e.launcherList(x||void 0)}catch{n=[]}if(t!==b)return;if(v.replaceChildren(),n.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty`,e.textContent=x?`No matching apps`:`No apps found`,v.appendChild(e);return}let r=document.createDocumentFragment();for(let i of n)r.appendChild(Si(i,e,t,()=>b,k));v.appendChild(r)},j=(e,t)=>{C.push({id:e,title:t}),x=``,l.value=``,M()},te=async(e,t)=>{A();let n=(t,n,r)=>{if(t.replaceChildren(),n.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty env-shell-app-menu__empty--compact`,e.textContent=r,t.appendChild(e);return}for(let r of n)t.appendChild(Ti(r,e,k,j))};n(p,mr(),`No pinned bookmarks`),n(h,fr(),`No recent bookmarks`);let r=[];try{if(x)r=await e.search(x);else{let t=C.length?C[C.length-1].id:void 0;r=await e.listChildren(t)}}catch{r=[]}if(t!==b)return;if(v.replaceChildren(),r.length===0){let e=document.createElement(`p`);e.className=`env-shell-app-menu__empty`,e.textContent=x?`No matching bookmarks`:`This folder is empty`,v.appendChild(e);return}let i=document.createDocumentFragment(),a=r.filter(e=>e.folder),o=r.filter(e=>!e.folder);for(let t of[...a,...o])i.appendChild(Ti(t,e,k,j));v.appendChild(i)},M=async()=>{let e=++b;o.hidden=!0,l.hidden=!1;let n=hi();if(!n){w();return}if(t.setAttribute(`data-menu-mode`,n),n===`bookmarks`){a.setAttribute(`data-layout`,`start-split`),u.hidden=!1,a.contains(u)||(a.append(o,l,u),v.parentElement!==g&&g.append(_,v));let t=ur();if(!t){o.hidden=!1,s.textContent=`Bookmarks API unavailable in this context`,c.hidden=!0,l.hidden=!0,u.hidden=!0;return}c.hidden=!0,await te(t,e);return}a.removeAttribute(`data-layout`),u.hidden=!0,v.parentElement!==a&&a.append(v);let r=await gi();if(e!==b)return;if(!r?.launcherList||!r?.launcherLaunch||!r?.launcherIcon){o.hidden=!1,s.textContent=`Launcher bridge unavailable — rebuild the Capacitor APK`,c.hidden=!0,l.hidden=!0,v.hidden=!0;return}let i=!1;try{i=await r.launcherIsDefault()}catch{i=!1}e===b&&(i?o.hidden=!0:(o.hidden=!1,s.textContent=`Set CWSP Launcher as Home for full launcher integration`,c.hidden=!1),l.hidden=!1,v.hidden=!1,await ee(r,e))};l.addEventListener(`input`,()=>{x=l.value.trim(),S&&clearTimeout(S),S=setTimeout(()=>{M()},180)}),c.addEventListener(`click`,async e=>{e.preventDefault(),e.stopPropagation();let t=await gi();if(t){try{await t.launcherRequestDefault()}catch{}M()}});let N=e=>{if(!y||document.documentElement.hasAttribute(`data-app-menu-dragging`))return;let n=typeof e.composedPath==`function`?e.composedPath():[];for(let e of n)if(e===t||e===a||e instanceof Element&&t.contains(e)||e instanceof Element&&e.closest?.(`.cw-context-menu-layer`)||e instanceof Element&&e.closest?.(`.env-shell-app-menu__chrome-editor`)||e instanceof Element&&e.closest?.(`dialog.speed-dial-editor`))return;T()};document.addEventListener(`pointerdown`,N,{capture:!0});let P=[`.env-shell-app-menu__tile`,`.env-shell-app-menu__search`,`.env-shell-app-menu__banner`,`.env-shell-app-menu__pin-menu`,`.env-shell-app-menu__crumb-item`,`.env-shell-app-menu__start-heading`,`.env-shell-app-menu__chrome-editor`,`.env-shell-app-menu__drag-ghost`,`.cw-context-menu-layer`,`dialog.speed-dial-editor`].join(`, `),F=null,ne=e=>e instanceof Element&&!!e.closest(P),re=e=>{if(y&&(e.button==null||e.button===0)){if(document.documentElement.hasAttribute(`data-app-menu-dragging`)||ne(e.target)){F=null;return}F={id:e.pointerId,x:e.clientX,y:e.clientY}}},ie=e=>{if(!F||F.id!==e.pointerId)return;let t=e.clientX-F.x,n=e.clientY-F.y;F=null,y&&(document.documentElement.hasAttribute(`data-app-menu-dragging`)||ne(e.target)||Math.hypot(t,n)>14||T())},ae=e=>{F?.id===e.pointerId&&(F=null)};return t.addEventListener(`pointerdown`,re),t.addEventListener(`pointerup`,ie),t.addEventListener(`pointercancel`,ae),w(),{element:t,toggle:O,open:E,openPage:D,close:T,isOpen:()=>y,refresh:M,dispose:()=>{S&&clearTimeout(S),document.documentElement.toggleAttribute(`data-app-menu-dragging`,!1),document.removeEventListener(`pointerdown`,N,{capture:!0}),t.removeEventListener(`pointerdown`,re),t.removeEventListener(`pointerup`,ie),t.removeEventListener(`pointercancel`,ae),document.removeEventListener(`u2-theme-change`,r);try{i.disconnect()}catch{}t.remove()}}}var Di,Oi,ki,Ai,ji,Mi;function Ni(){return(Ni=e((()=>{o(),j(),I(),ar(),Fn(),oe(),ui(),Fr(),fi(),s(),Di=t(di),Oi=!1,ki=420,Ai=10,ji=null,Mi=`circle`})))()}var Pi,Fi,Ii,Li,Ri;function zi(){return(zi=e((()=>{I(),Pi=null,Fi=e=>{let t=we(e.id);return Math.max(0,Number(t?.androidWidgetId)||0)},Ii=(e,t)=>{let n=t.getBoundingClientRect();return{widgetId:e,x:n.left,y:n.top,w:Math.max(8,n.width),h:Math.max(8,n.height),dpr:Number(window.devicePixelRatio)||1}},Li=e=>{if(!Pi)return;let t=e||document.getElementById(`home`);t&&t.querySelectorAll(`[data-speed-dial-item][data-widget="android"][data-layer="icons"]`).forEach(e=>{let t=(Te||[]).find(t=>t?.id===e.dataset.id);if(!t)return;let n=Fi(t);if(!n)return;let r=Ii(n,e);Pi.widgetAttach(r)})},Ri=()=>{Pi?.widgetHideAll?.()}})))()}var Bi,Vi,Hi,Ui,Wi,Gi,Ki,qi,Ji,Yi,Xi,Zi,Qi,$i,ea,ta,na,ra;function ia(){return(ia=e((()=>{ge(),I(),zi(),Bi=`/user/workspaces/`,Vi=`cwsp:workspace-page`,Hi=`cw::workspace::pages`,Ui=e=>`${Bi}${e}/`,Wi=()=>[`side-a`,`side-b`,`side-c`].map(e=>({id:e,label:`Side ${e.slice(-1).toUpperCase()}`,path:Ui(e)})),Gi=()=>({activeId:`side-a`,pages:Wi(),snapshots:{}}),Ki=()=>{try{let e=localStorage.getItem(Hi);if(!e)return Gi();let t=JSON.parse(e);return!t||!Array.isArray(t.pages)||!t.pages.length?Gi():{activeId:String(t.activeId||t.pages[0].id),pages:t.pages.map(e=>({id:String(e.id||``).trim(),label:String(e.label||e.id),path:String(e.path||Ui(e.id))})).filter(e=>e.id),snapshots:t.snapshots&&typeof t.snapshots==`object`?t.snapshots:{}}}catch{return Gi()}},qi=e=>{try{localStorage.setItem(Hi,JSON.stringify(e))}catch{}},Ji=e=>{try{window.dispatchEvent(new CustomEvent(Vi,{detail:{id:e,pages:Yi()}}))}catch{}},Yi=()=>Ki().pages,Xi=()=>Ki().activeId||`side-a`,Zi=()=>{let e=Ki();e.pages.some(t=>t.id===e.activeId)&&(e.snapshots[e.activeId]=ue(),qi(e))};try{let e=globalThis;e.__CWSP_WORKSPACE_SNAPSHOT_SYNC_BOUND__||(e.__CWSP_WORKSPACE_SNAPSHOT_SYNC_BOUND__=!0,window.addEventListener(ye,Zi))}catch{}Qi=async e=>{try{let t=te(`/user/`);if(!t?.mkdir||!t.writable)return;if(await t.mkdir(`/user/`,`workspaces`).catch(()=>void 0),await t.mkdir(Bi,e.id).catch(()=>void 0),t.writeFile){let n=new File([JSON.stringify({id:e.id,label:e.label,path:e.path},null,2)],`workspace.json`,{type:`application/json`});await t.writeFile(e.path,n).catch(()=>void 0)}}catch(t){console.warn(`[workspace-pages] explorer dir failed`,e.id,t)}},$i=()=>{try{return matchMedia(`(prefers-reduced-motion: reduce)`).matches}catch{return!1}},ea=()=>{let e=document.querySelector(`.speed-dial-root`)||document.getElementById(`home`);if(!e)return[];let t=[...e.querySelectorAll(`.speed-dial-grid`)];return t.length?t:[e]},ta=e=>{let t=e||(typeof document<`u`?document:null);t?.querySelectorAll&&(t.querySelectorAll(`.speed-dial-grid--turn-ghost`).forEach(e=>e.remove()),t.querySelectorAll(`[data-ws-turning]`).forEach(e=>{delete e.dataset.wsTurning,e.querySelectorAll(`.speed-dial-grid`).forEach(e=>{e.style.opacity=``})}))},na=e=>{let t=ea(),n=t[0]?.closest(`.speed-dial-root`)||t[0]||null;if(ta(n),!t.length||$i()||typeof t[0].animate!=`function`)return()=>void 0;let r=e<0?-1:1,i=`${-88*r}deg`,a=`${88*r}deg`,o=`${-18*r}%`,s=`${18*r}%`,c=n||t[0];c.dataset.wsTurning=r>0?`next`:`prev`;let l=[];for(let e of t){let t=e.cloneNode(!0);t.classList.add(`speed-dial-grid--turn-ghost`),t.dataset.wsGhost=`1`,t.setAttribute(`aria-hidden`,`true`),e.parentElement?.insertBefore(t,e.nextSibling),e.style.opacity=`0`,l.push(t),t.animate([{transform:`translateX(0) rotateY(0deg)`,opacity:1},{transform:`translateX(${o}) rotateY(${i})`,opacity:0}],{duration:180,easing:`cubic-bezier(.4, 0, .2, 1)`,fill:`forwards`})}let u=()=>{for(let e of t)e.style.opacity=``;for(let e of l)e.remove();delete c.dataset.wsTurning};return()=>{let e=t.map(e=>e.animate([{transform:`translateX(${s}) rotateY(${a})`,opacity:.2},{transform:`translateX(0) rotateY(0deg)`,opacity:1}],{duration:220,easing:`cubic-bezier(.22, 1, .36, 1)`,fill:`none`})),n=Promise.all(e.map(e=>e.finished.catch(()=>void 0))),r=new Promise(e=>{setTimeout(e,500)});Promise.race([n,r]).then(u)}},ra=e=>{let t=Ki(),n=t.pages.find(t=>t.id===e);if(!n)return!1;let r=t.activeId||t.pages[0].id;if(r===n.id)return!0;let i=Math.max(0,t.pages.findIndex(e=>e.id===r)),a=Math.max(0,t.pages.findIndex(e=>e.id===n.id))-i;Math.abs(a)>t.pages.length/2&&(a+=a>0?-t.pages.length:t.pages.length),t.snapshots[r]=ue(),t.activeId=n.id,qi(t),Ri();let o=na(a);return be(t.snapshots[n.id]||{items:[]}),requestAnimationFrame(()=>{o(),requestAnimationFrame(()=>Li())}),Qi(n),Ji(n.id),!0}})))()}var aa,oa,sa;function ca(){return(ca=e((()=>{w(),Fn(),aa=()=>{let e=globalThis;if(e.__CWSP_CAP_BACK_BOUND__)return;let t=e.Capacitor?.Plugins?.App;if(typeof t?.addListener==`function`){e.__CWSP_CAP_BACK_BOUND__=!0;try{t.addListener(`backButton`,({canGoBack:e})=>{if(f()&&b())return;if(document.querySelector(`.cw-context-menu-layer`)){K();return}if(document.querySelector(`.env-shell-app-menu[data-open]`)){document.querySelector(`.env-shell-app-menu`)?.dispatchEvent(new CustomEvent(`env-app-menu-request-close`,{bubbles:!0}));return}let t=document.querySelector(`dialog[open], .speed-dial-editor`);if(t){t.close?.(),t.remove?.();return}if(e){history.back();return}})}catch(e){console.warn(`[overlay-back] Capacitor backButton bind failed`,e)}}},oa=()=>{h({id:`app-menu-overlay`,priority:y.SIDEBAR,isActive:()=>!!document.querySelector(`.env-shell-app-menu[data-open]`),close:()=>(document.querySelector(`.env-shell-app-menu`)?.dispatchEvent(new CustomEvent(`env-app-menu-request-close`,{bubbles:!0})),!0)}),h({id:`speed-dial-editor`,priority:y.MODAL,isActive:()=>!!document.querySelector(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`),close:()=>(document.querySelectorAll(`dialog.speed-dial-editor[open], dialog.sd-icon-picker[open]`).forEach(e=>{try{e.close()}catch{e.remove()}}),!0)})},sa=()=>{let e=globalThis;if(e.__CWSP_LAUNCHER_BACK_STACK__){aa();return}e.__CWSP_LAUNCHER_BACK_STACK__=!0;try{g({preventDefaultNavigation:!0,pushInitialState:!0})}catch{}oa(),aa()}})))()}var la;function ua(){return(ua=e((()=>{la=`/*
...
}`})))()}function da(e){return`${ba}${String(e||``).trim().toLowerCase()}`}function fa(){let e=document.querySelector(`.env-shell-chrome`);return e instanceof HTMLElement&&e.hasAttribute(`data-desktop`)?!1:e instanceof HTMLElement&&e.dataset.chromeLayout===`mobile`||typeof matchMedia==`function`&&matchMedia(`(max-width: 640px)`).matches}function pa(e,t){if(e.some(e=>{let t=String(e.id||``).trim().toLowerCase();return!t||t===`home`?!1:e.visible!==!1&&!e.minimized}))return!0;let n=String(t.value||`home`).trim().toLowerCase();if(n&&n!==`home`&&n!==`viewer`)return!0;let r=document.querySelector(`.env-shell-workspace`);if(!r)return!1;for(let e of r.querySelectorAll(`ui-window`)){if(!(e instanceof HTMLElement)||e.hidden||e.hasAttribute(`data-minimized`))continue;let t=getComputedStyle(e);if(t.display!==`none`&&t.visibility!==`hidden`&&!(Number.parseFloat(t.opacity||`1`)<=0))return!0}return!1}function ma(e=new Date){return $t(e)}function ha(e){let t=ne([]);v(t),d(va,t,{title:`Home`,icon:`house-line`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`home`,e.onHome()}),d(ya,t,{title:`Markdown`,icon:`article`},{},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,e.focusedTaskId.value=`viewer`,e.onViewer()});let n=document.createElement(`ui-taskbar`);n.className=`env-shell-taskbar wf-chrome-no-select`,n.setAttribute(`part`,`taskbar`),n.setAttribute(`data-type`,`desktop`);let r=document.createElement(`div`);r.className=`env-shell-taskbar__pins`;let i=document.createElement(`div`);i.className=`env-shell-taskbar__windows`;let a=document.createElement(`ui-task`);a.setAttribute(`title`,`Home`),a.setAttribute(`icon`,`house-line`),a.setAttribute(`data-id`,va),a.setAttribute(`data-env-home`,``),a.setAttribute(`aria-label`,`Home`),a.setAttribute(`aria-haspopup`,`menu`),r.append(a);let o=document.createElement(`div`);o.className=`env-shell-taskbar__workspaces`,o.setAttribute(`aria-label`,`Workspaces`);let s=()=>{let e=Yi(),t=Xi();o.replaceChildren();for(let n of e){let e=document.createElement(`button`);e.type=`button`,e.className=`env-shell-taskbar__workspace`,e.title=n.label,e.textContent=n.label.replace(/^Side\s+/i,``)||n.id.slice(-1).toUpperCase(),e.toggleAttribute(`data-active`,n.id===t),e.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),ra(n.id)}),o.append(e)}};s(),window.addEventListener(Vi,s),r.append(o),sa();let c=()=>{let e=fa();a.setAttribute(`title`,e?`Home`:`Start`),a.setAttribute(`aria-label`,e?`Home`:`Start`),a.setAttribute(`icon`,e?`house-line`:`windows-logo`),a.toggleAttribute(`data-env-start`,!e),e?a.setAttribute(`aria-keyshortcuts`,`LongPress`):a.removeAttribute(`aria-keyshortcuts`)};c();let l=document.createElement(`div`);l.className=`env-shell-taskbar__tray-host`;let u=document.createElement(`div`);u.className=`env-shell-taskbar__clock`,u.setAttribute(`role`,`button`),u.setAttribute(`tabindex`,`0`),u.setAttribute(`aria-label`,`Calendar`),u.setAttribute(`aria-haspopup`,`dialog`),u.setAttribute(`data-chrome-flyout-anchor`,`calendar`);let f=document.createElement(`span`);f.className=`env-shell-taskbar__clock-time`;let p=document.createElement(`span`);p.className=`env-shell-taskbar__clock-date`,u.append(f,p);let h=()=>{let{time:e,date:t}=ma();f.textContent=e,p.textContent=t,u.title=`${e} · ${t}`};h();let g=setInterval(h,Sa),_=on(e.device,`env-device-tray env-device-tray--taskbar`);_.setAttribute(`role`,`button`),_.setAttribute(`tabindex`,`0`),_.setAttribute(`aria-label`,`Quick settings`),_.setAttribute(`aria-haspopup`,`dialog`),_.setAttribute(`data-chrome-flyout-anchor`,`quick-settings`);let y=e=>{e.preventDefault(),e.stopPropagation(),Ze(u)},b=e=>{e.preventDefault(),e.stopPropagation(),mt(_)};u.addEventListener(`click`,y),u.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&y(e)}),_.addEventListener(`click`,b),_.addEventListener(`keydown`,e=>{(e.key===`Enter`||e.key===` `)&&b(e)}),l.append(_,u);let x=document.createElement(`div`);x.className=`env-shell-navbar__switcher`,x.setAttribute(`role`,`menu`),x.setAttribute(`aria-label`,`Open apps`),x.hidden=!0;let S=document.createElement(`ul`);S.className=`env-shell-navbar__switcher-list`,x.appendChild(S),n.append(r,i,l,x);let C=mi(),w=C?Ei():void 0,T=new Map,E=[],D=null,O=!1,k=!1,A=[];A.push(()=>clearInterval(g));let ee=e=>E.find(t=>String(t.id||``).trim().toLowerCase()===e),j=t=>{let n=String(t||``).trim().toLowerCase();if(!n)return;let r=ee(n),i=String(e.focusedTaskId.value||``).trim().toLowerCase(),a=!!r?.focused||i===n||i===`markdown`&&n===`viewer`||i===`viewer`&&(n===`viewer`||n===`markdown`);if(r?.minimized){r.minimized=!1,r.focused=!0,T.get(n)?.toggleAttribute(`data-minimized`,!1),e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n);return}if(a&&r&&r.visible!==!1){r.minimized=!0,r.focused=!1,T.get(n)?.toggleAttribute(`data-minimized`,!0),e.onMinimizeWindow?.(n);return}e.focusedTaskId.value=n===`markdown`?`viewer`:n,e.onWindowTask?.(n)},te=(t,r,i)=>{if(fa())return;t.preventDefault(),t.stopPropagation();let a=String(r||``).trim().toLowerCase(),o=!!ee(a)?.minimized,s=[{id:o?`restore`:`minimize`,label:o?`Restore`:`Minimize`,icon:o?`arrow-square-out`:`minus`,action:()=>{o?(e.focusedTaskId.value=a,e.onWindowTask?.(a)):e.onMinimizeWindow?.(a)}},{id:`close`,label:`Close`,icon:`x`,danger:!0,action:()=>e.onCloseWindow?.(a)}];Pn({x:t.clientX,y:t.clientY,compact:!0,anchor:t.target instanceof Element?t.target:n,items:s})};n.addEventListener(`contextmenu`,t=>{if(fa())return;let r=typeof t.composedPath==`function`?t.composedPath():[];for(let e of r)if(e instanceof Element&&e.closest?.(`ui-task`))return;t.preventDefault(),t.stopPropagation(),Pn({x:t.clientX,y:t.clientY,compact:!0,anchor:n,items:[{id:`show-desktop`,label:`Show desktop`,icon:`desktop`,action:()=>e.onHome()},{id:`home`,label:`Home`,icon:`house-line`,action:()=>e.onHome()}]})});let M=()=>{k=!1,x.hidden=!0,S.replaceChildren(),n.removeAttribute(`data-switcher-open`)},N=()=>{let r=E.filter(e=>String(e.id||``).trim());if(S.replaceChildren(),r.length)for(let n of r){let r=String(n.id||``).trim().toLowerCase(),i=document.createElement(`li`);i.className=`env-shell-navbar__switcher-row`,i.setAttribute(`role`,`none`);let a=document.createElement(`button`);a.type=`button`,a.className=`env-shell-navbar__switcher-item`,a.setAttribute(`role`,`menuitem`),a.toggleAttribute(`data-active`,!!n.focused&&!n.minimized),a.toggleAttribute(`data-minimized`,!!n.minimized);let o=document.createElement(`ui-icon`);o.setAttribute(`icon`,n.icon||`app-window`),o.setAttribute(`icon-style`,`duotone`),o.setAttribute(`aria-hidden`,`true`);let s=document.createElement(`span`);s.className=`env-shell-navbar__switcher-label`,s.textContent=n.title||r,a.append(o,s),a.addEventListener(`click`,n=>{n.preventDefault(),n.stopPropagation(),M(),e.focusedTaskId.value=r;let i=da(r),a=m(t,i);a?a.focus=!0:e.onWindowTask?.(r)});let c=document.createElement(`button`);c.type=`button`,c.className=`env-shell-navbar__switcher-close`,c.setAttribute(`aria-label`,`Close ${n.title||r}`),c.title=`Close`;let l=document.createElement(`ui-icon`);l.setAttribute(`icon`,`x`),l.setAttribute(`icon-style`,`bold`),l.setAttribute(`aria-hidden`,`true`),c.appendChild(l),c.addEventListener(`click`,t=>{t.preventDefault(),t.stopPropagation(),e.onCloseWindow?.(r),E=E.filter(e=>String(e.id||``).trim().toLowerCase()!==r),T.get(r)?.remove(),T.delete(r),E.length?N():M()}),i.append(a,c),S.appendChild(i)}else{let e=document.createElement(`li`);e.className=`env-shell-navbar__switcher-empty`,e.textContent=`No open apps`,S.appendChild(e)}k=!0,x.hidden=!1,n.setAttribute(`data-switcher-open`,``)},P=()=>{D!=null&&(clearTimeout(D),D=null)},F=()=>{n.toggleAttribute(`data-app-menu-open`,!!w?.isOpen())},re=()=>{M(),w?.close(),F(),m(t,va).focus=!0,e.onHome()},ae=()=>{M(),w?.toggle(),F(),m(t,va).focus=!0,e.focusedTaskId.value=`home`,I()},oe=()=>{!w||w.isOpen()||(M(),w.open(),F(),m(t,va).focus=!0,e.focusedTaskId.value=`home`,I())},se=()=>{w&&(M(),w.openPage(),F(),m(t,va).focus=!0,e.focusedTaskId.value=`home`,I())};try{let e=globalThis;e.__CWSP_LAUNCHER_HOME__={...e.__CWSP_LAUNCHER_HOME__||{},openAppMenu:oe,openAppMenuPage:se}}catch{}let ce=()=>{if(pa(E,e.focusedTaskId)){re();return}if(w?.isOpen()){w.close(),F();return}ae()};a.addEventListener(`click`,e=>{if(O){e.preventDefault(),e.stopPropagation(),O=!1;return}if(C&&w){e.preventDefault(),e.stopPropagation(),ce();return}re()}),a.addEventListener(`pointerdown`,e=>{if(fa()&&(e.button==null||e.button===0)){O=!1,P(),D=setTimeout(()=>{D=null,O=!0;try{a.releasePointerCapture?.(e.pointerId)}catch{}N()},xa);try{a.setPointerCapture?.(e.pointerId)}catch{}}},{capture:!0});let le=()=>{P()};a.addEventListener(`pointerup`,le,{capture:!0}),a.addEventListener(`pointercancel`,le,{capture:!0}),a.addEventListener(`contextmenu`,e=>{fa()&&(e.preventDefault(),O=!0,P(),N())});let ue=e=>{if(!k)return;let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t)if(e===x||e===a||e instanceof Element&&(e===x||x.contains(e)||e===a))return;M()};document.addEventListener(`pointerdown`,ue,{capture:!0}),A.push(()=>document.removeEventListener(`pointerdown`,ue,{capture:!0}));let I=()=>{let t=String(e.focusedTaskId.value||`home`),n=(e,t)=>{e.toggleAttribute(`data-env-active`,t),e.toggleAttribute(`data-active`,t),e.toggleAttribute(`data-focus`,t)};n(a,t===`home`);for(let[e,r]of T)n(r,t===e)};ie(()=>{I()},[e.focusedTaskId],{triggerImmediately:!0});let de=e=>{let n=String(e.id||``).trim().toLowerCase();if(!n||n===`home`)return;let r=da(n),a=e.title||n,o=String(e.icon||``).trim()||`app-window`,s=T.get(n);if(!s){let e=d(r,null,{title:a,icon:o},{viewId:n},function(){for(let e of t)e!==this&&(e.active=!1);this.active=!0,j(n)});e.list=t,t.push(e),s=document.createElement(`ui-task`),s.setAttribute(`data-id`,r),s.setAttribute(`data-view`,n),s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.addEventListener(`click`,e=>{e.preventDefault(),e.stopPropagation(),j(n)}),s.addEventListener(`contextmenu`,e=>{te(e,n,a)}),T.set(n,s),i.appendChild(s)}s.setAttribute(`title`,a),s.setAttribute(`aria-label`,a),s.setAttribute(`icon`,o),s.toggleAttribute(`data-minimized`,!!e.minimized),s.hidden=e.visible===!1},fe=n=>{E=Array.isArray(n)?n.slice():[];let r=new Set;for(let t of n){let n=String(t.id||``).trim().toLowerCase();!n||n===`home`||(r.add(n),de(t),t.focused&&(e.focusedTaskId.value=n))}for(let[e,n]of[...T.entries()]){if(r.has(e))continue;let i=da(e),a=m(t,i);if(a){let e=t.indexOf(a);e>=0&&t.splice(e,1)}n.remove(),T.delete(e)}I(),k&&N()},pe=n=>{let r=String(n||`home`).toLowerCase(),i=va;r===`viewer`||r===`markdown`?i=ya:r!==`home`&&(i=da(r));let a=m(t,i);if(a){for(let e of t)e!==a&&(e.active=!1);a.active=!0}e.focusedTaskId.value=r===`markdown`?`viewer`:r,I()};if(queueMicrotask(c),w){let e=()=>F();n.addEventListener(`env-app-menu-open`,e),n.addEventListener(`env-app-menu-close`,e),A.push(()=>{n.removeEventListener(`env-app-menu-open`,e),n.removeEventListener(`env-app-menu-close`,e)})}return{element:n,taskList:t,setFocusedTaskId:pe,syncWindowTasks:fe,appMenu:w,openAppMenu:w?oe:void 0,openAppMenuPage:w?se:void 0,isSwitcherOpen:()=>k,closeSwitcher:M,dispose:()=>{P(),M(),w?.dispose();for(let e of A)try{e()}catch{}A.length=0,T.clear(),i.replaceChildren()}}}var ga,_a,va,ya,ba,xa,Sa;function Ca(){return(Ca=e((()=>{j(),F(),w(),Fn(),un(),it(),Kt(),Ni(),ia(),ca(),z(),ua(),o(),ga=t(la),_a=class extends Ae{constructor(){super()}styles=()=>ga;render=()=>E`<div part="taskbar" class="taskbar"><slot></slot></div>`},_a=L([u(`ui-taskbar`)],_a),va=`#env-home`,ya=`#env-viewer`,ba=`#env-win-`,xa=420,Sa=3e4})))()}var wa;function Ta(){return(Ta=e((()=>{wa=`/**
 * Font Styles Index
 *
...
.ui-modal-panel {
  ...
  box-shadow: var(--modal-shadow, 0 20px 60px rgba(0, 0, 0, 0.42));
  pointer-events: auto;
}`})))()}function Ea(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function Da(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function Oa(e,t,n=`font/woff2`){if(Na.has(t))return Na.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return Na.set(t,i),i}async function ka(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(Pa.has(o))return Pa.get(o);let s=Ea(t),c=await Oa(a?await Da(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),Pa.set(o,l),l}async function Aa(e){let t=e.map(e=>ka(e));return Promise.all(t)}async function ja(){return Fa||(Fa=c(()=>import(`./font-registry-DGJ_haGr.js`),[],import.meta.url)?.catch?.(e=>{console.error(`Failed to load font registry:`,e)}),Fa)}async function Ma(){let e=await ja();return Aa(Object.values(e.fontRegistry))}var Na,Pa,Fa;function Ia(){return(Ia=e((()=>{s(),Na=new Map,Pa=new Map,Fa=null})))()}var La;function Ra(){return(Ra=e((()=>{La=`/*
 * Filename: layers.scss
 * FullPath: modules/projects/fl.ui/src/styles/layers.scss
 * Change date and time: 15.10.00_22.08.2026
 * Reason for changes: Match veela \`_layers.scss\` so fl.ui never establishes a shorter competing prelude.
...
}`})))()}var za,Ba;function Va(){return(Va=e((()=>{Ia(),o(),Ta(),Ra(),za=`
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
`,Ba=async e=>{await r(za)?.catch(()=>void 0),await Ma().catch(()=>void 0),await r(wa)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await r(La)?.catch(()=>void 0)}})))()}var Ha;function Ua(){return(Ua=e((()=>{Ha=`:host(ui-task), :host(ui-task) * {
  box-sizing: border-box;
  user-select: none;
  touch-action: manipulation;
  -webkit-user-drag: none;
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})))()}var Wa,Ga,Ka,qa;function Ja(){return(Ja=e((()=>{z(),o(),w(),Ua(),Wa=t(Ha),Ga=e=>{let t=``;if(typeof e==`string`)t=e;else if(typeof e==`object`&&e&&`value`in e){let n=e.value;t=n==null?``:String(n)}else e!=null&&typeof e!=`object`&&(t=String(e));(!t||t===`undefined`||t===`null`||t===`[object Object]`)&&(t=``);let n=t.trim().charAt(0);return n?n.toUpperCase():`?`},Ka=(e,t,n)=>{let r=e.getAttribute(t);return r!=null&&String(r).trim()?String(r).trim():n},qa=class extends Ae{title;icon;constructor(){super()}styles=()=>Wa;render=function(){let e=Ka(this,`title`,`Task`),t=Ka(this,`icon`,`app-window`),n=Ga(e);return E`
        ...
        `}},L([p({source:`attr`})],qa.prototype,`title`,void 0),L([p({source:`attr`})],qa.prototype,`icon`,void 0),qa=L([u(`ui-task`)],qa)})))()}var Ya;function Xa(){return(Xa=e((()=>{Ya=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})))()}function Za(){return(Za=e((()=>{o(),Xa(),t(Ya)})))()}var Qa;function $a(){return($a=e((()=>{Qa=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}
...
:host(ui-taskbar[data-type=mobile]) ::slotted(ui-task[data-focus]) {
  ...
  color: --c2-on-surface(0, var(--current));
  color: contrast-color(var(--c2-surface(0, var(--current))));
}`})))()}function eo(){return(eo=e((()=>{o(),$a(),t(Qa)})))()}function to(){try{return globalThis.navigator?.windowControlsOverlay??null}catch{return null}}function no(){if(Y)return Y;if(typeof globalThis.matchMedia!=`function`)return`unknown`;try{if(globalThis.matchMedia(`(display-mode: window-controls-overlay)`).matches)return Y=`window-controls-overlay`;if(globalThis.matchMedia(`(display-mode: fullscreen)`).matches)return Y=`fullscreen`;if(globalThis.matchMedia(`(display-mode: standalone)`).matches)return Y=`standalone`;if(globalThis.matchMedia(`(display-mode: minimal-ui)`).matches)return Y=`minimal-ui`;if(globalThis.matchMedia(`(display-mode: browser)`).matches)return Y=`browser`}catch{}return Y=`unknown`}function ro(e){if(!e?.visible||typeof e.getTitlebarAreaRect!=`function`)return null;try{let t=e.getTitlebarAreaRect();return t?{x:t.x,y:t.y,width:t.width,height:t.height}:null}catch{return null}}function io(e){let t=to(),n=!!t?.visible,r=no(),i=n||r===`standalone`||r===`fullscreen`||r===`window-controls-overlay`||r===`minimal-ui`,a=`off`;return e&&(a=n?`wco`:i?`standalone`:`fallback`),{requested:e,wcoVisible:n,displayMode:r,titlebarRect:ro(t),isStandaloneLike:i,surface:a}}function ao(e){let t=()=>{Y=null,e.onChange(io(e.getRequested()))},n=[];if(typeof globalThis.matchMedia==`function`)for(let e of[`(display-mode: window-controls-overlay)`,`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`])try{n.push(globalThis.matchMedia(e))}catch{}let r=()=>t();for(let e of n)try{e.addEventListener?.(`change`,r)}catch{try{e.addListener?.(r)}catch{}}let i=to(),a=()=>t();try{i?.addEventListener?.(`geometrychange`,a)}catch{}return queueMicrotask(t),()=>{for(let e of n)try{e.removeEventListener?.(`change`,r)}catch{try{e.removeListener?.(r)}catch{}}try{i?.removeEventListener?.(`geometrychange`,a)}catch{}}}var Y;function oo(){return(oo=e((()=>{Y=null})))()}var X,so,co,lo,uo,fo,po,Z,mo,ho,go,Q,_o,vo,yo,bo,xo,So,$,Co,wo,To,Eo,Do,Oo,ko,Ao,jo,Mo,No;function Po(){return(Po=e((()=>{X=null,so=null,co=null,lo=null,uo=null,fo=null,po=null,Z=0,mo=null,ho=`#cbb8a4`,go=`__CWSP_NATIVE_THEME_COLOR_OWNED__`,Q=e=>{let t=String(e||``).trim().toLowerCase();if(!t)return!1;if(t===`#007acc`||t===`#007accff`||t===`#36c`||t===`#3366cc`)return!0;let n=t.match(/^rgba?\(\s*([\d.]+)\s*[, ]\s*([\d.]+)\s*[, ]\s*([\d.]+)/i);if(n&&(t?.startsWith?.(`#`)||t?.startsWith?.(`rgb`))){let e=Math.round(Number(n[1])),t=Math.round(Number(n[2])),r=Math.round(Number(n[3]));if(e<=20&&t>=100&&t<=140&&r>=180&&r<=220)return!0}return!1},_o=()=>{try{return!!globalThis?.[go]}catch{return!1}},vo=e=>{uo=e;try{globalThis[go]=!!e}catch{}},yo=e=>!e||!e.isConnected||e.hasAttribute(`minimized`)?!1:e.hasAttribute(`native-mode`)?!0:e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`),bo=()=>{if(typeof document>`u`)return null;if(uo?.isConnected&&yo(uo))return uo;let e=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized])`));if(e.length)return e[e.length-1];let t=Array.from(document.querySelectorAll(`ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`));for(let e=t.length-1;e>=0;e--){let n=t[e];if(yo(n))return n}return null},xo=()=>{so||typeof MutationObserver>`u`||typeof document>`u`||(so=new MutationObserver(()=>{po=null;let e=bo();e?.isConnected?Mo(e):Oo()}),so.observe(document.documentElement,{attributes:!0,attributeFilter:[`data-theme`,`class`,`style`,`color-scheme`]}))},So=e=>{co||typeof MutationObserver>`u`||(co=new MutationObserver(()=>{if(!_o())return;let t=(e.getAttribute(`content`)||``).toLowerCase(),n=(fo||``).toLowerCase();if(n&&t===n&&!Q(t))return;let r=bo();r?Mo(r):Q(t)&&Do(ho,!0)}),co.observe(e,{attributes:!0,attributeFilter:[`content`]}))},$=e=>{let t=String(e||``).trim();if(!t||t===`transparent`||t===`rgba(0, 0, 0, 0)`)return null;let n=t.match(/^#([0-9a-f]{3}|[0-9a-f]{6}|[0-9a-f]{8})$/i);if(n){let e=n[1];e.length===3?e=e[0]+e[0]+e[1]+e[1]+e[2]+e[2]:e.length===8&&(e=e.slice(0,6));let t=`#${e.toLowerCase()}`;return Q(t)?null:t}let r=t.match(/^rgba?\(\s*([\d.]+)\s*,\s*([\d.]+)\s*,\s*([\d.]+)(?:\s*,\s*([\d.]+))?\s*\)$/i);if(r){let e=r[4]===void 0?1:Number(r[4]);if(!Number.isFinite(e)||e<.5)return null;let t=`#${[Math.max(0,Math.min(255,Math.round(Number(r[1])))),Math.max(0,Math.min(255,Math.round(Number(r[2])))),Math.max(0,Math.min(255,Math.round(Number(r[3]))))].map(e=>e.toString(16).padStart(2,`0`)).join(``)}`;return Q(t)?null:t}let i=t.match(/^rgba?\(\s*([\d.]+)\s+([\d.]+)\s+([\d.]+)(?:\s*\/\s*([\d.]+%?))?\s*\)$/i);if(i){let e=1;if(i[4]!==void 0&&(e=String(i[4]).endsWith(`%`)?Number(i[4])/100:Number(i[4])),!Number.isFinite(e)||e<.5)return null;let t=`#${[Math.max(0,Math.min(255,Math.round(Number(i[1])))),Math.max(0,Math.min(255,Math.round(Number(i[2])))),Math.max(0,Math.min(255,Math.round(Number(i[3]))))].map(e=>e.toString(16).padStart(2,`0`)).join(``)}`;return Q(t)?null:t}try{if(typeof document>`u`)return null;lo||(lo=document.createElement(`canvas`),lo.width=1,lo.height=1);let e=lo.getContext(`2d`,{willReadFrequently:!0});if(!e)return null;e.fillStyle=`#000000`,e.fillStyle=t;let n=String(e.fillStyle||``);if(n.startsWith(`#`)&&n.length>=7){let e=n.slice(0,7).toLowerCase();return Q(e)?null:e}return $(n)}catch{return null}},Co=()=>{if(typeof document>`u`)return null;let e=document.querySelector(`meta[data-theme-color]`)||document.querySelector(`meta[name="theme-color"]`);e||(e=document.createElement(`meta`),e.setAttribute(`name`,`theme-color`),e.setAttribute(`data-theme-color`,``),document.head?.appendChild(e));try{let t=Array.from(document.querySelectorAll(`meta[name="theme-color"]`));for(let n of t)n!==e&&n.remove()}catch{}return So(e),e},wo=(e,t)=>{try{let n=document.createElement(`div`);n.setAttribute(`data-theme-color-probe`,`true`),n.style.cssText=`position:fixed;left:-8px;top:-8px;inline-size:4px;block-size:4px;pointer-events:none;opacity:0;background:${t}`,e.appendChild(n);let r=$(getComputedStyle(n).backgroundColor);return n.remove(),r}catch{return null}},To=()=>{if(po)return po;try{let e=getComputedStyle(document.documentElement).getPropertyValue(`--color-surface-container`).trim();po=$(e)||wo(document.documentElement,`var(--color-surface-container, Canvas)`)||ho}catch{po=ho}return po},Eo=e=>{let t=e.querySelector(`.env-ui-window__body`),n=t?.querySelector(`.settings-screen__top, .view-settings, .view-explorer, .cw-view-viewer-shell`)||t;if(n){let e=$(getComputedStyle(n).backgroundColor);if(e)return e}return To()},Do=(e,t=!1)=>{let n=Co();if(!n||!e)return;let r=e.toLowerCase();Q(r)&&(r=ho);let i=(n.getAttribute(`content`)||``).toLowerCase();if(!(i===r&&!t&&!Q(i))&&(n.setAttribute(`content`,r),n.setAttribute(`data-theme-color`,``),n.removeAttribute(`media`),fo=r,t||i!==r||Q(i)))try{let e=n.parentNode||document.head;e?.removeChild(n),e?.appendChild(n)}catch{}},Oo=()=>{if(typeof document>`u`||bo())return;vo(null),fo=null;let e=Co();if(!e)return;let t=document.documentElement,n=getComputedStyle(t),r=document.body?getComputedStyle(document.body):null,i=$(n.getPropertyValue(`--color-surface-container`).trim())||$(n.getPropertyValue(`--color-surface`).trim())||$(n.getPropertyValue(`--ui-win-titlebar-bg`).trim())||(r?$(r.backgroundColor):null)||$(n.backgroundColor);i?Do(i):Q(String(e.getAttribute(`content`)||``))&&Do(ho,!0),xo()},ko=e=>e.hasAttribute(`maximized`)||e.hasAttribute(`data-desk-max`)||e.hasAttribute(`data-mobile-max`)||e.hasAttribute(`data-native-active`),Ao=()=>{if(Z){if(typeof cancelIdleCallback==`function`)try{cancelIdleCallback(Z)}catch{clearTimeout(Z)}else clearTimeout(Z);Z=0,mo=null}},jo=e=>{if(mo=e,Z)return;let t=()=>{Z=0;let e=mo;mo=null,e?.isConnected&&(e.hasAttribute(`minimized`)||!e.hasAttribute(`native-mode`)&&!ko(e)||(Do(Eo(e)||ho,!1),xo()))};Z=typeof requestIdleCallback==`function`?requestIdleCallback(t,{timeout:120}):setTimeout(t,0)},Mo=e=>{if(!e||typeof document>`u`||e.hasAttribute(`minimized`)||!e.hasAttribute(`native-mode`)&&!ko(e)&&!yo(e))return;let t=Co();if(t){if(X==null){let e=t.getAttribute(`content`)||``;X=Q(e)?``:e}if(vo(e),Q(String(t.getAttribute(`content`)||``))&&Do(ho,!1),fo&&!Q(fo)){Do(fo,!1),xo();return}jo(e)}},No=e=>{if(typeof document>`u`||!document.querySelector(`meta[name="theme-color"]`))return;let t=bo();if(t&&t!==e){Mo(t);return}let n=Array.from(document.querySelectorAll(`ui-window[native-mode]:not([minimized]), ui-window[data-desk-max]:not([minimized]), ui-window[maximized]:not([minimized]), ui-window[data-mobile-max]:not([minimized])`)).filter(t=>t!==e&&yo(t));if(n.length){Mo(n[n.length-1]);return}vo(null),fo=null,Ao(),X!=null&&X&&!Q(X)?(Do(X,!0),X=null):(X=null,Oo())},typeof document<`u`&&queueMicrotask(()=>{try{Oo()}catch{}})})))()}var Fo;function Io(){return(Io=e((()=>{Fo=`/*
...
.window-resizer:hover {
  opacity: 0.9;
}`})))()}var Lo,Ro,zo,Bo,Vo,Ho,Uo;function Wo(){return(Wo=e((()=>{w(),o(),z(),j(),oo(),Po(),Io(),Lo=t(Fo),Ro=`minus`,zo=`corners-out`,Bo=`corners-in`,Vo=`x`,Ho=Object.freeze({w:240,h:160}),Uo=class extends R{titleHandler;contentHandler;footerHandler;resizer;#e=k(0);#t=k(0);#n=null;#r=null;#i=null;#a=null;#o=null;#s=null;#c=null;#l=!1;#u=0;#d=0;#f=null;#p=null;#m=null;styles=function(){return Lo};render=function(){return E`<div class="window-container" part="window-container">
