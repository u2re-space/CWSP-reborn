import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{O as t,j as n,t as r}from"./src-C7QuTtnr.js";import{_ as i,c as a,d as o,g as s,m as c}from"./ecosystem-skus-7pqekvU4.js";import{y as l}from"./UniformInterop-D6lR55tv.js";import{n as u,t as d}from"./preload-helper-DcjHEl26.js";import{n as f,r as p}from"./channel-mixin-xxxCJwOb.js";import{a as ee,f as te}from"./UnifiedMessaging-CDibs2yQ.js";import{a as m,n as ne,r as re,t as ie}from"./view-ingress-validation-BUwbjEBq.js";import{_ as h,b as ae,c as oe,d as se,f as g,h as _,i as ce,l as v,o as y,s as b,t as x,u as S,v as le,x as C,y as w}from"./src-DpSa8Erd.js";import{a as T}from"./HistoryManager-B52KbQG4.js";import{a as E,i as D,n as ue,o as O}from"./Base64Data-DpzxunTw.js";import{a as de,o as fe}from"./Settings-DJruQNwI.js";import{i as pe,r as me,t as he}from"./object-DpwBpfvO.js";import{i as ge,s as _e,t as ve}from"./icon-BI41b7Mj.js";import{n as ye,t as be}from"./purify.es-B-w98i1w.js";import{n as xe,t as Se}from"./registry-CQ_1dV-F.js";import{a as Ce,i as k,t as A}from"./channel-actions-D5ksGgGK.js";function we(e){return{load(){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}},save(t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}},clear(){try{localStorage.removeItem(e)}catch{}}}}var j,M,Te;function N(){return(N=e((()=>{x(),ee(),j=e=>String(e||`attachment`).toLowerCase().replace(/[^a-z0-9-]/g,`-`).replace(/-+/g,`-`).replace(/^-+|-+$/g,``)||`attachment`,M=async(e,t=`view-ipc`)=>{let n=[];for(let r of e){let e=r&&typeof r==`object`&&`data`in r?r.data:r;if(e)try{let i=r&&typeof r==`object`&&`source`in r?String(r.source||t):t,a=await E(e,{namePrefix:j(i),uriComponent:!0});n.push({hash:String(a.hash||``),name:String(a.name||a.file?.name||`attachment`),mimeType:String(a.mimeType||a.type||a.file?.type||`application/octet-stream`),size:Number(a.size||a.file?.size||0),source:i,data:a.file})}catch(e){console.warn(`[UniformViewTransport] Attachment normalization failed:`,e)}}return n},Te=async e=>{let t=await M(e.attachments||[],e.source),n={...e.data||{},...t.length>0?{attachments:t,file:t[0]?.data,files:t.map(e=>e.data)}:{}},r=l({type:e.type,source:e.source,destination:e.destination,contentType:e.contentType,data:n,purpose:e.purpose||(t.length>0?[`attach`,`deliver`]:[`deliver`,`mail`]),protocol:`window`,op:e.op||(t.length>0?`attach`:`deliver`),srcChannel:e.source,dstChannel:e.destination,metadata:{...e.metadata||{},attachmentCount:t.length}});return te(r)}})))()}function Ee(e){return e===`light`||e===`dark`?e:typeof globalThis.matchMedia==`function`&&globalThis.matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`}function P(e){if(e===`light`||e===`dark`||e===`system`)return e;if(typeof e==`string`){let t=e.trim().toLowerCase();if(t===`light`||t===`dark`||t===`system`)return t}}function F(e){if(e!=null){if(typeof e==`string`)return P(e.trim());if(typeof e==`object`){let t=e;return P(t.colorScheme??t.scheme??t.theme)}}}function De(e){if(e)return e.colorScheme?e.colorScheme:P(e.params?.colorScheme??e.params?.theme)}var I;function L(){return(L=e((()=>{I=`/*
 ...
 * \`--color-*\` (source of truth: veela \`core/misc/_tokens.scss\`) with \`light-dark()\`
...
}`})))()}var R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Oe,ke,Ae,je,Q;function Me(){return(Me=e((()=>{x(),pe(),r(),be(),_e(),p(),xe(),Ce(),de(),N(),a(),ie(),L(),u(),R=e=>e===`launch-queue`||e===`share-target`||e===`clipboard`||e===`pending`,z=null,B=`rs-viewer-outline`,V=96e3,H=12e5,U=2097152,W=48e4,G=6e5,K={USE_PROFILES:{html:!0,mathMl:!0,svg:!0},FORBID_TAGS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`link`,`meta`,`base`,`form`,`noscript`,`template`],FORBID_CONTENTS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`noscript`,`template`]},q=`g`,J=[`rs-md-base`,`rs-md-system`,`rs-md-modules`,`rs-md-user`,`rs-md-print`,`rs-md-user-print`],Y=!1,X=()=>{if(!Y)try{ge(),ve(),Y=!0}catch(e){console.warn(`[Viewer] Failed to initialize icon runtime:`,e)}},Z=e=>navigator?.clipboard?.writeText?.(e)??Promise.resolve(void 0),Oe=async()=>z||(z=(async()=>{let[{marked:e},{default:t}]=await Promise.all([d(()=>import(`./marked.esm-U97ULcOU.js`).then(e=>(e.n(),e.r)),[],import.meta.url),d(()=>import(`./src-CVKFD6_m.js`).then(e=>(e.t(),e.r)),[],import.meta.url)]);return e?.use?.(t({throwOnError:!1,nonStandard:!0,output:`mathml`,strict:!1})),async t=>await e.parse(t??``)})(),z),ke=`rs-viewer-state`,Ae=`# This is content`,je=`cw-view-viewer`,Q=Se(je,e=>class extends e{id=`viewer`;name=`Viewer`;icon=`eye`;options;shellContext;element=null;slotProjectingHost=null;contentRef=he(``);contentRefSubscriptionDispose=null;renderSeq=0;stateManager=we(ke);_sheet=null;pasteController=null;windowDnDController=null;isViewVisible=!1;isPointerInView=!1;sourceUrl=null;boundMountRoot=null;boundDirectory=null;sidecarAssets=new Map;assetObjectUrls=[];sourceObserver=null;customSheet=null;userStyleModules={screenCss:``,printCss:``};markdownSettings={preset:`default`,fontFamily:`system`,fontSizePx:16,lineHeight:1.7,contentMaxWidthPx:860,printScale:1,page:{size:`auto`,orientation:`portrait`,marginMm:12},modules:{typography:!0,lists:!0,tables:!0,codeBlocks:!0,blockquotes:!0,media:!0,printBreaks:!0},plugins:{smartTypography:!1,softBreaksAsBr:!1,externalLinksNewTab:!0},customCss:``,printCss:``,extensions:[]};markdownSettingsPromise=null;outlineVisible=!1;viewerColorScheme=`system`;documentThemeSnapshot=null;disposeContentRefSubscription(){try{this.contentRefSubscriptionDispose?.()}catch{}this.contentRefSubscriptionDispose=null}subscribeContentRefToCurrentTargets(e,t){this.disposeContentRefSubscription();let n=me(this.contentRef,()=>{e&&t&&this.renderMarkdown(this.contentRef.value,e,t),this.saveState()});this.contentRefSubscriptionDispose=typeof n==`function`?n:null}lifecycle={onMount:()=>this.onMount(),onUnmount:()=>this.onUnmount(),onShow:()=>this.onShow(),onHide:()=>this.onHide(),onRefresh:()=>this.onRefresh()};constructor(e={}){super(),this.options=e,this.shellContext=e.shellContext,this.sourceUrl=this.normalizeSourceUrl(e.source),this.applyRouteParams(e.params),this.markdownSettingsPromise=this.loadMarkdownSettings();try{this.outlineVisible=globalThis.sessionStorage?.getItem(B)===`1`}catch{this.outlineVisible=!1}this.syncViewerColorSchemeFromOptions();let t=this.stateManager.load();if(this.contentRef.value=e.initialContent||t?.content||Ae,!e.initialContent){let t=(e.params?.content||``).trim();t&&(this.contentRef.value=t)}}render=function(e){X(),this.slotProjectingHost=null,e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,this.applyRouteParams(e.params)),this.syncViewerColorSchemeFromOptions(),this._sheet=t(I),this.element=this.createViewerShellElement();let n=this.element.querySelector(`[data-render-target]`),r=this.element.querySelector(`[data-raw-target]`);return this.setupEventHandlers(r||void 0),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),n&&r&&this.renderMarkdown(this.contentRef.value,n,r),this.subscribeContentRefToCurrentTargets(n,r),this.refreshDocumentTheme(),this.element};shellNavigateHydrate(e,t){if(!this.element?.isConnected)return;e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,e.params!==void 0&&this.applyRouteParams(e.params),this.syncViewerColorSchemeFromOptions());let n=this.queryViewerSlotted(`[data-render-target]`),r=this.queryViewerSlotted(`[data-raw-target]`);n&&r&&(this.subscribeContentRefToCurrentTargets(n,r),this.renderMarkdown(this.contentRef.value,n,r)),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.refreshDocumentTheme()}renderIntoWebComponentHost(e,n){X(),n&&(this.options={...this.options,...n},this.shellContext=n.shellContext||this.shellContext,this.applyRouteParams(n.params)),this.syncViewerColorSchemeFromOptions(),this.slotProjectingHost=e,this._sheet??=t(I),this.element=this.createViewerShellElement(),e.replaceChildren(this.element);let r=e.querySelector(`[data-raw-target]`),i=e.querySelector(`[data-render-target]`);e.setAttribute(`data-view-id`,`viewer`),e.toggleAttribute(`data-cw-view-host`,!0),this.syncAdoptedSheetsToShadow();let a=i,o=r;this.setupEventHandlers(o),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),a&&o&&this.renderMarkdown(this.contentRef.value,a,o),this.subscribeContentRefToCurrentTargets(a,o),this.refreshDocumentTheme()}getToolbar(){return null}setContent(e,t,n){t&&(this.options.filename=t),n!==void 0&&(this.sourceUrl=this.normalizeSourceUrl(n),this.options.source=n||void 0),this.contentRef.value=e,this.syncToolbarDocumentTitle()}repaintMarkdown(){let e=this.queryViewerSlotted(`[data-render-target]`),t=this.queryViewerSlotted(`[data-raw-target]`);e&&this.renderMarkdown(this.contentRef.value,e,t)}ingestOpenedMarkdownBody(e,t,n){if(e.length>0&&re(e)){this.setContent(`> This payload does not look like UTF-8 markdown (binary file or unsupported format).
>
> Open a \`.md\` / \`.txt\` file, paste as plain text, or attach binaries via Work Center.

`,t,n);return}this.setContent(e,t,n??void 0)}getContent(){return this.contentRef.value}setViewerColorScheme(e){this.viewerColorScheme=e,this.options.colorScheme=e,this.refreshDocumentTheme()}refreshDocumentTheme(){typeof document>`u`||this.applyViewerDocumentTheme(this.viewerColorScheme)}applyViewerDocumentTheme(e){let t=document.documentElement;if(e===`system`)return;this.documentThemeSnapshot||={prevAttr:t.getAttribute(`data-theme`),prevInlineCs:t.style.getPropertyValue(`color-scheme`)};let n=Ee(e);t.setAttribute(`data-theme`,n),t.style.setProperty(`color-scheme`,n)}restoreViewerDocumentTheme(){let e=this.documentThemeSnapshot;if(this.documentThemeSnapshot=null,!e||typeof document>`u`)return;let t=document.documentElement;e.prevAttr===null||e.prevAttr===``?t.removeAttribute(`data-theme`):t.setAttribute(`data-theme`,e.prevAttr),e.prevInlineCs.trim()?t.style.setProperty(`color-scheme`,e.prevInlineCs):t.style.removeProperty(`color-scheme`)}syncViewerColorSchemeFromOptions(){let e=De(this.options);e&&(this.viewerColorScheme=e)}createViewerShellElement(){return T`
        ...
        `}adoptViewerStylesIntoShadowRoot(e){let t=this._sheet;!t||e.adoptedStyleSheets===void 0||e.adoptedStyleSheets.includes(t)||(e.adoptedStyleSheets=[...e.adoptedStyleSheets,t])}syncAdoptedSheetsToShadow(){let e=this.slotProjectingHost?.shadowRoot;if(!e||e.adoptedStyleSheets===void 0)return;let t=t=>{t&&(e.adoptedStyleSheets.includes(t)||(e.adoptedStyleSheets=[...e.adoptedStyleSheets,t]))};t(this._sheet),t(this.customSheet??null)}queryViewerSlotted(e){return this.slotProjectingHost?.querySelector(e)||(this.element?.querySelector(e)??null)}viewBranchesContain(e){return e?this.slotProjectingHost?.contains(e)?!0:!!this.element?.contains(e):!1}viewBranchesHover(){return!!this.slotProjectingHost?.matches(`:hover`)||!!this.element?.matches(`:hover`)}syncViewerRawMode(e){let t=this.element;if(!t?.classList.contains(`cw-view-viewer-shell`))return;t.toggleAttribute(`data-raw`,e),this.slotProjectingHost?.toggleAttribute(`data-raw`,e);let n=t.querySelector(`[data-viewer-content]`);e?n?.setAttribute(`data-raw`,``):n?.removeAttribute(`data-raw`)}syncOutlineToolbarState(){let e=(this.element?.querySelector(`[data-viewer-toolbar]`))?.querySelector(`[data-action="toggle-outline"]`);e&&e.setAttribute(`aria-pressed`,this.outlineVisible?`true`:`false`)}slugifyHeadingId(e,t){let n=(e||``).trim().toLowerCase().replace(/\s+/g,`-`).replace(/[^a-z0-9\u00c0-\u024f-]+/gi,`-`).replace(/^-+|-+$/g,``)||`section`,r=n,i=0;for(;t.has(r);)i+=1,r=`${n}-${i}`;return t.add(r),r}refreshDocumentOutline(e,t){if(e.hidden=!this.outlineVisible,e.innerHTML=``,!this.outlineVisible)return;let n=Array.from(t.querySelectorAll(`h1,h2,h3,h4,h5,h6`));if(n.length===0){e.innerHTML=`<div class="view-viewer__outline-empty" role="status">No headings in document</div>`;return}let r=new Set,i=document.createElement(`ul`);i.className=`view-viewer__outline-list`;for(let e of n){let t=(e.id||``).trim();t?r.add(t):(t=this.slugifyHeadingId(e.textContent||``,r),e.id=t);let n=document.createElement(`li`);n.className=`view-viewer__outline-item view-viewer__outline--h${e.tagName.slice(1)}`;let a=document.createElement(`a`);a.href=`#${t}`,a.textContent=(e.textContent||``).trim()||t,n.appendChild(a),i.appendChild(n)}e.appendChild(i)}setOutlineVisible(e){this.outlineVisible=e;try{e?globalThis.sessionStorage?.setItem(B,`1`):globalThis.sessionStorage?.removeItem(B)}catch{}let t=this.queryViewerSlotted(`[data-render-target]`);if(t){let n=t.querySelector(`:scope > nav.view-viewer__outline`),r=t.querySelector(`:scope > .view-viewer__md-root`);n&&r?this.refreshDocumentOutline(n,r):n&&(n.hidden=!e)}this.syncOutlineToolbarState()}renderMarkdown(e,t,n){if(!t)return;let r=++this.renderSeq,i=e=>{let t=(e||``).trimStart().toLowerCase();return!!(t.startsWith(`<!doctype html`)||t.startsWith(`<html`)||t.startsWith(`<head`)||t.startsWith(`<body`)||t.startsWith(`<?xml`)&&t.includes(`<html`))},a=()=>{r===this.renderSeq&&(t.removeAttribute(`aria-busy`),t.removeAttribute(`data-md-state`))};if(n){let t=e||``,i=()=>{r===this.renderSeq&&(n.textContent=t.length>H?`${t.slice(0,H)}\n\n… [truncated — open in editor for full source]`:t)};t.length>V?globalThis.setTimeout(i,0):i()}if(!String(e??``).trim()){if(r!==this.renderSeq)return;this.syncViewerRawMode(!1),t.hidden=!1,n&&(n.hidden=!0),t.removeAttribute(`aria-busy`),t.setAttribute(`data-md-state`,`empty`),t.innerHTML=`<div class="view-viewer__md-empty" role="status">Empty document</div>`,this.syncToolbarDocumentTitle();return}if(this.element?.querySelector(`.view-viewer__content`)&&i(e||``)){this.syncViewerRawMode(!0),n&&(n.hidden=!1),t.hidden=!0,this.syncToolbarDocumentTitle(),a();return}this.syncViewerRawMode(!1),t.hidden=!1,n&&(n.hidden=!0),t.setAttribute(`aria-busy`,`true`),t.setAttribute(`data-md-state`,`preparing`),t.innerHTML=`<div class="view-viewer__md-loading" role="status">Rendering preview…</div>`,queueMicrotask(()=>{if(r===this.renderSeq)try{let n=e=>{if(r!==this.renderSeq)return;let n=ye?.sanitize?.((e||``)?.trim?.()||``,K)||``;t.replaceChildren();let i=document.createElement(`nav`);i.className=`view-viewer__outline`,i.setAttribute(`aria-label`,`Document outline`);let o=document.createElement(`div`);o.className=`view-viewer__md-root`,o.innerHTML=n,this.captureOriginalRelRefs(o),t.append(i,o),this.boundMountRoot&&this.applyBoundProvideBlobs(o),this.applyRenderedLinkBehavior(o),this.watchVirtualSource(this.sourceUrl),this.refreshDocumentOutline(i,o),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(o),a(),console.log(`[ViewerView] Markdown rendered successfully`)},i=e=>{r===this.renderSeq&&(console.error(`[ViewerView] Error rendering markdown:`,e),t.innerHTML=`<div style="color: red; padding: 1rem; background: #fee; border: 1px solid #fcc; border-radius: 4px;">Error parsing markdown: ${e?.message}</div>`,a())},o=this.applyMarkdownPlugins((e||``)?.trim?.()||``),s=this.applyCustomMarkdownExtensions(o);Oe().then(e=>e(s)).then(n).catch(i)}catch(e){console.error(`[ViewerView] Error rendering markdown:`,e),t.innerHTML=`<div style="color: red; padding: 1rem; background: #fee; border: 1px solid #fcc; border-radius: 4px;">Error parsing markdown: ${e?.message}</div>`,a()}})}normalizeSourceUrl(e){let t=(e||``).trim();if(!t)return null;if(h(t))return t.startsWith(`/`)?t:`/${t}`;try{let e=new URL(t,globalThis.location.href);return h(e.pathname)?e.pathname:e.toString()}catch{return null}}revokeAssetUrls(){for(let e of this.assetObjectUrls)try{URL.revokeObjectURL(e)}catch{}this.assetObjectUrls=[]}watchVirtualSource(e){this.sourceObserver?.disconnect?.(),this.sourceObserver=null;let t=this.normalizeSourceUrl(e);!t||!h(t)||C(t).then(async()=>{let e=navigator,n=e?.storage?.getDirectory,r=null;try{let i=le(_(t)),a=i?await i.resolver():null;r=a instanceof FileSystemDirectoryHandle?a:null,!r&&typeof n==`function`&&t.startsWith(`/user/`)&&(r=await n.call(e.storage))}catch{return}r&&(this.sourceObserver=oe(r,()=>this.onRefresh()))})}applyRouteParams(e){let t=i(`viewer`,`document`);if(t?.content?.trim()&&(this.contentRef.value=t.content,t.filename&&(this.options.filename=t.filename),t.src&&(this.sourceUrl=this.normalizeSourceUrl(t.src),this.options.source=t.src)),!e)return;let n=String(e.detachKey||``).trim();if(n)try{let e=globalThis?.sessionStorage?.getItem?.(n)||``;if(e){let t=JSON.parse(e),n=String(t?.content||``);n.trim()&&(this.contentRef.value=n),t?.filename&&(this.options.filename=String(t.filename));let r=String(t?.source||``),i=globalThis.location!==void 0&&globalThis.location.protocol===`chrome-extension:`;r.trim()&&!(i&&/^file:/i.test(r.trim()))&&(this.sourceUrl=this.normalizeSourceUrl(r),this.options.source=r)}globalThis?.sessionStorage?.removeItem?.(n)}catch(e){console.warn(`[Viewer] Failed to restore detached payload:`,e)}let r=e.source||e.src||e.path||e.url;if(r){let e=String(r).trim(),t=/^https?:\/\//i.test(e)||/^\/\//.test(e)||/^www\./i.test(e),n=/\.(?:md|markdown|txt|mdx)(?:$|[?#])/i.test(e);if(t&&!n){let t=/^https?:\/\//i.test(e)?e:/^\/\//.test(e)?`https:${e}`:`https://${e.replace(/^\/+/,``)}`;try{let e=this.shellContext?.openView||this.shellContext?.navigate||this.options?.shellContext?.openView||this.options?.shellContext?.navigate;if(typeof e==`function`){Promise.resolve(e(`browser`,{params:{url:t,href:t},url:t,href:t})).catch(()=>{});return}}catch(e){console.warn(`[Viewer] redirect web URL to browser failed`,e)}}globalThis.location!==void 0&&globalThis.location.protocol===`chrome-extension:`&&/^file:/i.test(e)||(this.sourceUrl=this.normalizeSourceUrl(r),this.options.source=r)}let a=e.filename||e.name;a&&(this.options.filename=a);let o=String(e.content||``);o.trim()?this.contentRef.value=o:r&&h(String(r))&&C(String(r)).then(async e=>{if(!e)return;let t=await e.text().catch(()=>``);t&&this.ingestOpenedMarkdownBody(t,a?String(a):e.name,String(r))}),this.element&&this.syncToolbarDocumentTitle()}syncToolbarDocumentTitle(e){let t=this.element?.querySelector(`[data-viewer-toolbar-title]`);t&&(t.textContent=``,t.removeAttribute(`title`))}isUnsafeProtocol(e){return/^(?:javascript|vbscript|data:text\/html)/i.test((e||``).trim())}normalizeBareBase64Candidate(e){let t=(e||``).trim();if(!t||O(t))return null;let n=[t,t.replace(/[\s>]+$/g,``),t.replace(/[^A-Za-z0-9+/=_-]/g,``)];for(let e of n){let t=e.trim();if(t.length>=8&&D(t))return t}return null}sniffImageMimeFromBytes(e){let t=e.byteLength;if(t>=8&&e[0]===137&&e[1]===80&&e[2]===78&&e[3]===71)return`image/png`;if(t>=3&&e[0]===255&&e[1]===216&&e[2]===255)return`image/jpeg`;if(t>=6&&e[0]===71&&e[1]===73&&e[2]===70&&e[3]===56)return`image/gif`;if(t>=12&&e[0]===82&&e[1]===73&&e[2]===70&&e[3]===70)return`image/webp`;if(t>=2&&e[0]===66&&e[1]===77)return`image/bmp`;let n=new TextDecoder(`utf-8`,{fatal:!1}).decode(e.subarray(0,Math.min(400,t))).trimStart();return n.startsWith(`<svg`)||n.startsWith(`<?xml`)?`image/svg+xml`:`image/png`}coerceBareBase64ToDataUrl(e){let t=this.normalizeBareBase64Candidate(e);if(t)try{let e=ue(t);return`data:${this.sniffImageMimeFromBytes(e)};base64,${t.replace(/\s/g,``)}`}catch{return null}}captureOriginalRelRefs(e){let t=(e,t,n)=>{let r=(e.getAttribute(`data-md-rel`)||e.getAttribute(t)||``).trim(),i=v(r);if(i&&(e.setAttribute(`data-md-rel`,y(r)?r:i),n&&(e.removeAttribute(t),t===`src`&&`src`in e)))try{e.removeAttribute(`src`)}catch{}};for(let n of e.querySelectorAll(`img, source, video, audio, track`))t(n,`src`,!0);for(let n of e.querySelectorAll(`a[href]`)){let e=(n.getAttribute(`href`)||``).trim(),r=v(e)||(y(e)?e:``);!r||!this.isLikelyMarkdownUrl(r)||(t(n,`href`,!1),n.setAttribute(`href`,`#`))}}async applyBoundProvideBlobs(e){if(!this.boundMountRoot)return 0;this.revokeAssetUrls();let t=0;for(let n of e.querySelectorAll(`[data-md-rel]`)){let e=(n.getAttribute(`data-md-rel`)||``).trim();if(!e)continue;let r=await se(this.boundMountRoot,e,this.sourceUrl);if(!r)continue;let i=URL.createObjectURL(r);this.assetObjectUrls.push(i);let a=w(this.sourceUrl&&h(this.sourceUrl)?_(this.sourceUrl):this.boundMountRoot,g(e)[0]||e);n.tagName===`A`?(n.setAttribute(`href`,i),n.setAttribute(`data-md-virtual`,a)):(n.setAttribute(`src`,i),`src`in n&&(n.src=i)),t+=1}return t}async rewireMarkdownRefs(e){return this.captureOriginalRelRefs(e),this.boundMountRoot?this.applyBoundProvideBlobs(e):0}resolveUrlAgainstSource(e){let t=(e||``).trim();if(!t)return null;if(t.startsWith(`#`))return t;if(this.isUnsafeProtocol(t))return null;if(/^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(t)||t.startsWith(`//`))try{return new URL(t,globalThis.location.href).toString()}catch{return t}let n=this.coerceBareBase64ToDataUrl(t);if(n!==void 0)return n;if(!this.sourceUrl)return t;if(h(this.sourceUrl))return w(_(this.sourceUrl),t);try{let e=new URL(this.sourceUrl,globalThis.location.href);return e.origin===globalThis.location.origin?t:new URL(t,e).toString()}catch{return t}}isLikelyMarkdownUrl(e){let t=(e||``).trim();if(!t)return!1;let n=t.split(`#`)[0].split(`?`)[0];return/\.(?:md|markdown|mdown|mkd|mkdn|mdtxt|mdtext)$/i.test(n)}isLikelyBinaryAssetUrl(e){let t=(e||``).trim();if(!t)return!1;let n=t.split(`#`)[0].split(`?`)[0];return/\.(?:png|jpe?g|gif|webp|bmp|svg|ico|pdf|zip|rar|7z|gz|mp4|webm|mp3|wav|ogg|avi|mov)$/i.test(n)}async fetchMarkdownFromUrl(e){let t=(e||``).trim();if(!t||/^file:/i.test(t))return null;try{let e=await fetch(t,{credentials:`include`,cache:`no-store`});if(!e.ok)return null;let n=await e.text(),r=(n||``).trimStart().toLowerCase();return r.startsWith(`<!doctype html`)||r.startsWith(`<html`)||r.startsWith(`<head`)||r.startsWith(`<body`)?null:n}catch(e){return console.warn(`[ViewerView] Failed to load markdown URL:`,e),null}}async openMarkdownFromUrl(e,t){let n=this.queryViewerSlotted(`[data-render-target]`);n&&(n.setAttribute(`aria-busy`,`true`),n.setAttribute(`data-md-state`,`fetching`),n.innerHTML=`<div class="view-viewer__md-loading" role="status">Loading document…</div>`);let r=this.normalizeSourceUrl(e);if(!r)return!1;if(h(r)){let e=await C(r).catch(()=>null),n=e?await e.text().catch(()=>null):null;return n?(this.ingestOpenedMarkdownBody(n,t||e?.name,r),this.showMessage(t?`Opened ${t}`:`Opened markdown link`),!0):!1}if(/^blob:/i.test(r)||/^blob:/i.test(e))return this.openMarkdownBlob(e,t);let i=await this.fetchMarkdownFromUrl(r);return i!==null&&(this.ingestOpenedMarkdownBody(i,t,r),this.showMessage(t?`Opened ${t}`:`Opened markdown link`),!0)}async openMarkdownBlob(e,t){try{let n=await(await fetch(e)).text();if(!n)return!1;let r=(t||``).split(/[\\/]/).pop()||`document.md`,i=t&&this.boundMountRoot?w(this.sourceUrl&&h(this.sourceUrl)?_(this.sourceUrl):this.boundMountRoot,t):this.sourceUrl;return this.ingestOpenedMarkdownBody(n,r,i),this.showMessage(`Opened ${r}`),!0}catch{return!1}}setupEventHandlers(e){if(!this.element)return;let t=this.element.querySelector(`[data-viewer-toolbar]`),n=this.element.querySelector(`[data-viewer-content]`),r=this.element.classList.contains(`cw-view-viewer-shell`)?this.element:null,i=this.queryViewerSlotted(`[data-render-target]`),a=!1;t?.addEventListener(`click`,t=>{let n=t.target.closest(`[data-action]`);if(n)switch(n.dataset.action){case`open`:this.handleOpen();break;case`bind-assets`:this.handleBindAssets();break;case`paste`:this.handlePasteFromToolbar();break;case`copy`:this.handleCopy();break;case`toggle-raw`:a=!a,i&&(i.hidden=a),e&&(e.hidden=!a),this.syncViewerRawMode(a);break;case`copy-rendered`:i&&this.handleCopyRendered(i);break;case`download`:this.handleDownload();break;case`export-docx`:this.handleExportDocx();break;case`print`:i&&this.handlePrint(i);break;case`open-style-settings`:this.handleOpenStyleSettings();break;case`toggle-outline`:this.setOutlineVisible(!this.outlineVisible);break;case`attach`:this.attachCurrentContentToWorkcenter()}});let o=r||n;o&&(o.addEventListener(`mouseenter`,()=>{this.isPointerInView=!0}),o.addEventListener(`mouseleave`,()=>{this.isPointerInView=!1}),o.addEventListener(`dragover`,e=>{e.preventDefault(),(r??n)?.classList.add(`dragover`)}),o.addEventListener(`dragleave`,()=>{(r??n)?.classList.remove(`dragover`)})),this.bindWindowMarkdownDnD(r??n),this.pasteController?.abort(),this.pasteController=new AbortController,document.addEventListener(`paste`,e=>{this.handlePaste(e)},{signal:this.pasteController.signal}),i?.addEventListener(`click`,e=>{let t=e.target?.closest?.(`a[href]`);if(!t)return;let n=(t.getAttribute(`href`)||``).trim(),r=(t.getAttribute(`data-md-rel`)||``).trim(),i=(t.getAttribute(`data-md-virtual`)||``).trim();if(e.defaultPrevented||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey||e.button!==0)return;if(r||n.startsWith(`blob:`)){e.preventDefault();let t=i||(r&&this.boundMountRoot?w(this.sourceUrl&&h(this.sourceUrl)?_(this.sourceUrl):this.boundMountRoot,r):``);(t?this.openMarkdownFromUrl(t):this.openMarkdownBlob(n,r)).then(e=>{e||this.showMessage(`Failed to open markdown link`)});return}if(!n||n.startsWith(`#`))return;let a=this.resolveUrlAgainstSource(n);if(!a)return;let o=!/^[a-zA-Z][a-zA-Z\d+\-.]*:/.test(n)&&!n.startsWith(`//`);(this.isLikelyMarkdownUrl(a)||o&&!this.isLikelyBinaryAssetUrl(a))&&(e.preventDefault(),this.openMarkdownFromUrl(a).then(e=>{e||this.showMessage(`Failed to open markdown link`)}))})}handleOpen(){let e=globalThis.showOpenFilePicker;if(typeof globalThis.showDirectoryPicker==`function`&&typeof e==`function`){(async()=>{try{let t=await S({mode:`read`,id:`markdown-assets`});if(!t)return;let n=b(t,`md`);this.boundMountRoot=n,this.boundDirectory=t;let[r]=await e({startIn:t,multiple:!1,types:[{description:`Markdown`,accept:{"text/markdown":[`.md`,`.markdown`,`.mdown`,`.mkd`],"text/plain":[`.txt`]}}]}),i=`${n}${await ce(t,r)||r.name}`,a=await r.getFile();this.setContent(await a.text(),a.name,i),this.showMessage(`Opened ${a.name}`)}catch(e){if(e?.name===`AbortError`)return;console.warn(`[ViewerView] Directory picker open failed, falling back:`,e),this.handleOpenInputFallback()}})();return}this.handleOpenInputFallback()}async handleBindAssets(){if(typeof globalThis.showDirectoryPicker!=`function`){this.showMessage(`Folder picker is not available in this browser`);return}let e=await S({id:`markdown-assets`,mode:`read`});if(!e)return;let t=b(e,`md`);this.boundMountRoot=t,this.boundDirectory=e;let n=String(this.options.filename||`document.md`).trim()||`document.md`,r=`${t}${n}`;this.sourceUrl=this.normalizeSourceUrl(r),this.options.source=r,this.options.filename=n,this.watchVirtualSource(r);let i=await this.rewireBoundMedia();this.showMessage(i?`Bound folder (${i} refs)`:`Bound asset folder`)}viewerMarkdownRoot(){let e=this.queryViewerSlotted(`[data-render-target]`);return e?.querySelector(`:scope > .view-viewer__md-root`)||this.queryViewerSlotted(`.view-viewer__md-root`)||e||this.element}async rewireBoundMedia(){let e=this.viewerMarkdownRoot();return e?this.rewireMarkdownRefs(e):(this.repaintMarkdown(),0)}rememberSidecarFiles(e,t){this.sidecarAssets.clear();for(let n of e)n instanceof File&&(t&&(n===t||n.name===t.name&&n.size===t.size)||this.indexSidecarFile(n))}indexSidecarFile(e,t){let n=e.name,r=String(t||e.webkitRelativePath||``).replace(/^\/+/,``),i=new Set([n,n.toLowerCase()]),a=n.split(/[\\/]/).pop()||n;if(i.add(a),i.add(a.toLowerCase()),r){i.add(r),i.add(r.toLowerCase());for(let e of g(r))i.add(e),i.add(e.toLowerCase())}for(let t of i)this.sidecarAssets.set(t,e)}lookupSidecarFile(...e){for(let t of e){let e=String(t||``).trim();if(!e)continue;let n=e.split(`#`)[0].split(`?`)[0].replace(/^\.\//,``).replace(/^\/+/,``),r=n.split(/[\\/]/).pop()||n;for(let e of[n,n.toLowerCase(),r,r.toLowerCase(),...g(n)]){let t=this.sidecarAssets.get(e)||this.sidecarAssets.get(e.toLowerCase());if(t)return t}}return null}pickDocumentSourcePath(...e){for(let t of e){if(typeof t!=`string`)continue;let e=t.trim();if(!(!e||R(e))&&(h(e)||/^https?:/i.test(e)||/^file:/i.test(e)||e.includes(`/`)))return e}return null}handleOpenInputFallback(){let e=document.createElement(`input`);e.type=`file`,e.accept=`.md,.markdown,.mdown,.mkd,.mkdn,.mdtxt,.mdtext,.txt,text/markdown,text/plain,text/md`,e.onchange=async()=>{let t=e.files?.[0];if(t)try{let e=await t.text();this.setContent(e,t.name,null),this.showMessage(`Opened ${t.name}`)}catch(e){console.error(`[ViewerView] Failed to read file:`,e),this.showMessage(`Failed to read file`)}},e.click()}async handleCopy(){let e=this.contentRef.value||``;if(!e.trim()){this.showMessage(`No content to copy`);return}try{let t=await Promise.race([Z(e),new Promise(e=>globalThis.setTimeout(()=>e({ok:!1,error:`Clipboard timeout`}),3500))]);if(!t?.ok)throw Error(t?.error||`Clipboard write failed`);this.showMessage(`Copied raw content to clipboard`),this.options.onCopy?.(e)}catch(e){console.error(`[ViewerView] Failed to copy:`,e),this.showMessage(`Failed to copy to clipboard`)}}async handleCopyRendered(e){await new Promise(e=>{typeof requestAnimationFrame==`function`?requestAnimationFrame(()=>e()):globalThis.setTimeout(()=>e(),0)});let t=(e.querySelector(`:scope > .view-viewer__md-root`)?.textContent||e?.textContent||``).trim();if(!t){this.showMessage(`No content to copy`);return}if(t.length>G){this.showMessage(`Rendered page is too large to copy as text — use Copy (raw) instead`);return}try{let e=await Promise.race([Z(t),new Promise(e=>globalThis.setTimeout(()=>e({ok:!1,error:`Clipboard timeout`}),3500))]);if(!e?.ok)throw Error(e.error||`Clipboard write failed`);this.showMessage(`Copied rendered text to clipboard`)}catch{this.showMessage(`Failed to copy rendered text`)}}handleDownload(){let e=this.contentRef.value,t=this.options.filename||`document-${Date.now()}.md`,n=new Blob([e],{type:`text/markdown;charset=utf-8`}),r=URL.createObjectURL(n);if(typeof showSaveFilePicker<`u`)showSaveFilePicker({suggestedName:t,types:[{description:`Markdown files`,accept:{"text/markdown":[`.md`,`.markdown`]}}]})?.then?.(async n=>{if(n){let r=await n.createWritable();await r.write(e),await r.close(),this.showMessage(`Downloaded ${t}`),this.options.onDownload?.(e,t)}else this.showMessage(`Failed to save file`);return n})?.catch?.(()=>(this.showMessage(`Failed to save file`),null));else{let n=document.createElement(`a`);n.href=r,n.download=t,n.click(),setTimeout(()=>URL.revokeObjectURL(r),250),this.showMessage(`Downloaded ${t}`),this.options.onDownload?.(e,t)}}async handleExportDocx(){let e=this.contentRef.value;if(!e.trim()){this.showMessage(`No content to export`);return}try{let{downloadMarkdownAsDocx:t}=await d(async()=>{let{downloadMarkdownAsDocx:e}=await import(`./DocxExport-BkmeQ2DA.js`);return{downloadMarkdownAsDocx:e}},[],import.meta.url);await t(e,{title:this.options.filename||`Markdown Content`,filename:`document-${Date.now()}.docx`}),this.showMessage(`Exported as DOCX successfully`)}catch(e){console.error(`[ViewerView] Failed to export DOCX:`,e),this.showMessage(`Failed to export as DOCX`)}}handlePrint(e){try{let t=this.queryViewerSlotted(`[data-raw-target]`),n=t&&!t.hidden?t:e;if(!n||!(n.textContent||``).trim()){this.showMessage(`No content to print`);return}n.setAttribute(`data-print`,`true`),globalThis?.print?.(),setTimeout(()=>{n.removeAttribute(`data-print`)},1e3),this.options.onPrint?.(this.contentRef.value)}catch(e){console.error(`[ViewerView] Error printing content:`,e),this.showMessage(`Failed to print`)}}async navigateSingletonShell(e){try{let{bootLoader:t}=await d(async()=>{let{bootLoader:e}=await import(`./BootLoader-_xJvm9Bs.js`).then(e=>(e.r(),e.t));return{bootLoader:e}},[],import.meta.url),n=t.getShell();if(n?.navigate&&![`window`,`tabbed`,`environment`].includes(n.id)){await n.navigate(e);return}}catch(e){console.warn(`[Viewer] BootLoader.navigate unavailable (standalone build?):`,e)}await Promise.resolve(this.shellContext?.navigate?.(e))}async attachCurrentContentToWorkcenter(){let e=this.contentRef.value||``;if(!e.trim()){this.showMessage(`No content to attach`);return}let t=this.options.filename||`viewer-${Date.now()}.md`;if(c(`workcenter`)){s({dest:`workcenter`,content:e,filename:t}),globalThis.location.assign(o(`process`));return}let n={text:e,content:e,filename:t,source:`viewer-attach`},r={type:`content-share`,contentType:`markdown`,data:n};if(this.shellContext&&[`window`,`tabbed`,`environment`].includes(this.shellContext.shellId))try{requestOpenView({viewId:`workcenter`,target:`window`,body:r,contentType:`application/json`}),this.showMessage(`Content attached to Work Center`);return}catch(e){console.warn(`[Viewer] windowed workcenter attach failed:`,e)}await this.navigateSingletonShell(`workcenter`),await new Promise(e=>requestAnimationFrame(()=>requestAnimationFrame(()=>e()))),await this.navigateSingletonShell(`workcenter`);let i=new File([e],t,{type:`text/markdown;charset=utf-8`});try{if(await Te({type:`content-share`,source:`viewer`,destination:`workcenter`,contentType:`text/markdown`,attachments:[{data:i,source:`viewer-workcenter-attach`}],data:{...n,sourcePath:t},metadata:{filename:t,sourcePath:t}})){this.showMessage(`Content attached to Work Center`);return}}catch(e){console.warn(`[Viewer] protocol workcenter attach failed:`,e)}try{let e=ViewRegistry.getLoaded(`workcenter`)||await ViewRegistry.load(`workcenter`,{shellContext:this.shellContext});if(e?.handleMessage){await e.handleMessage({...r,data:{...n,file:i,files:[i]}}),this.showMessage(`Content attached to Work Center`);return}}catch(e){console.warn(`[Viewer] direct workcenter attach failed:`,e)}this.showMessage(`Attach failed — open Work Center and try again`)}handleOpenStyleSettings(){try{this.shellContext?.navigate(`settings`,{tab:`markdown`,focus:`style`}),this.showMessage(`Opened Markdown style settings`)}catch(e){console.warn(`[Viewer] Failed to open style settings:`,e),this.showMessage(`Failed to open style settings`)}}handleFileDrop(e){this.ingestDroppedFiles(e.dataTransfer)}viewerAcceptsGlobalInput(){return!(!this.isViewVisible||this.shellContext?.navigationState?.currentView&&this.shellContext.navigationState.currentView!==this.id)}bindWindowMarkdownDnD(e){this.windowDnDController?.abort(),this.windowDnDController=new AbortController;let t=this.windowDnDController.signal,n=e=>{if(!this.viewerAcceptsGlobalInput())return!1;let t=e.dataTransfer?.types;return!(!t||!Array.from(t).includes(`Files`)||e.target?.closest(`input, textarea, select, [contenteditable='true']`))};window.addEventListener(`dragover`,t=>{n(t)&&(t.preventDefault(),t.dataTransfer&&(t.dataTransfer.dropEffect=`copy`),e?.classList.add(`dragover`))},{signal:t,capture:!0}),window.addEventListener(`drop`,t=>{n(t)&&(t.preventDefault(),t.stopPropagation(),e?.classList.remove(`dragover`),this.handleFileDrop(t))},{signal:t,capture:!0})}async ingestDroppedFiles(e){if(!e)return;let t=Array.from(e.items||[]);for(let n of t){let t=n.getAsFileSystemHandle;if(typeof t==`function`)try{let r=await t.call(n);if(r&&r.kind===`directory`){let t=r,n=b(t,`md`);this.boundMountRoot=n,this.boundDirectory=t;let i=Array.from(e.files||[]),a=this.pickMarkdownOrTextFile(i);if(!a){this.showMessage(`Bound folder — open a .md`);return}let o=a.webkitRelativePath||a.name,s=g(o).find(e=>e.endsWith(a.name))||a.name;this.setContent(await a.text(),a.name,`${n}${s}`),this.showMessage(`Opened ${a.name}`);return}}catch{}}let n=e.files;if(n&&n.length>0){let e=Array.from(n),t=this.pickMarkdownOrTextFile(e);if(!t){this.showMessage(`Drop a .md or text file`);return}try{let e=await t.text();this.setContent(e,t.name,null),this.showMessage(`Loaded ${t.name}`)}catch{this.showMessage(`Failed to read dropped file`)}return}let r=(e.getData(`text/uri-list`)||``).split(/\r?\n/).find(e=>e.trim()&&!e.trim().startsWith(`#`))?.trim()||e.getData(`text/plain`)?.trim();if(r&&/^https?:\/\//i.test(r)&&this.isLikelyMarkdownUrl(r)){await this.openMarkdownFromUrl(r)?this.showMessage(`Opened dropped link`):this.showMessage(`Could not load dropped URL`);return}r&&this.isLikelyMarkdownUrl(r)&&this.showMessage(`Dropped link must be http(s) to load in the browser`)}pickMarkdownOrTextFile(e){let t=[...e].sort((e,t)=>!this.isMarkdownFilename(e.name)-+!this.isMarkdownFilename(t.name)||e.name.localeCompare(t.name));for(let e of t)if(this.isTextLikeFile(e))return e;return null}isMarkdownFilename(e){return/\.(?:md|markdown|mdown|mkd|mkdn|mdtxt|mdtext)$/i.test((e||``).trim())}async handlePaste(e){if(!this.shouldHandlePaste(e)||!e.clipboardData)return;let t=Array.from(e.clipboardData.items||[]).map(e=>e.kind===`file`&&e.getAsFile?e.getAsFile():null).filter(e=>!!e),n=t.length>0?t:Array.from(e.clipboardData.files||[]),r=e.clipboardData.getData(`text/plain`);n.length===0&&(!r||!r.trim())||(e.preventDefault(),e.stopPropagation(),await this.ingestPastedPayload(n,r))}async handlePasteFromToolbar(){if(!this.element||!this.viewerAcceptsGlobalInput()){this.showMessage(`Open the Viewer tab to paste`);return}if(document.visibilityState===`visible`)try{let{files:e,text:t}=await this.readSystemClipboard();if(e.length===0&&(!t||!t.trim())){this.showMessage(`Clipboard is empty or access denied`);return}await this.ingestPastedPayload(e,t)}catch(e){console.error(`[ViewerView] Paste from toolbar failed:`,e),this.showMessage(`Could not read clipboard — check permissions`)}}async readSystemClipboard(){let e=[],t;if(typeof navigator>`u`||!navigator.clipboard)return{files:e,text:t};try{if(typeof navigator.clipboard.read==`function`){let n=await Promise.race([navigator.clipboard.read(),new Promise(e=>globalThis.setTimeout(()=>e([]),3500))]),r=0;for(let i of n)for(let n of i.types){let a=n.toLowerCase();if(a===`text/html`)continue;let o;try{o=await i.getType(n)}catch{continue}if(!o||o.size===0)continue;if(a===`text/plain`){if(o.size>U)continue;let e=await o.text();e&&(t??=e);continue}if(a.startsWith(`image/`)){let t=a.split(`/`)[1]||`img`;e.push(new File([o],`paste.${t}`,{type:n}));continue}if(a===`text/markdown`||a===`text/x-markdown`||a===`text/md`||a.includes(`markdown`)){if(o.size>U)continue;e.push(new File([o],`pasted-${r++}.md`,{type:`text/markdown`}));continue}if(a.startsWith(`text/`)){if(o.size>U)continue;e.push(new File([o],`pasted-${r++}.md`,{type:n}));continue}let s=await this.sniffBlobAsUtf8MarkdownFile(o,r);s&&(e.push(s),r++)}if(e.length>0||t&&t.trim())return{files:e,text:t}}}catch{}try{let e=await navigator.clipboard.readText();e&&(t??=e)}catch{}return{files:e,text:t}}async sniffBlobAsUtf8MarkdownFile(e,t){if(e.size>4194304)return null;let n=Math.min(e.size,24576),r=e.slice(0,n),i=new Uint8Array(await r.arrayBuffer());if(i.length===0||i.includes(0))return null;let a=0;for(let e=0;e<i.length;e++){let t=i[e];(t===9||t===10||t===13||t>=32&&t<127||t>=160)&&a++}return a/i.length<.9?null:new File([e],`pasted-${t}.md`,{type:`text/markdown`})}async ingestPastedPayload(e,t){if(e.length>0){let t=e.find(e=>this.isTextLikeFile(e))||e[0];try{if(!this.isTextLikeFile(t)){this.showMessage(`Unsupported file type for viewer: ${t.name||t.type||`binary file`}`);return}let e=await t.text();this.setContent(e,t.name),this.showMessage(`Opened ${t.name||`pasted document`}`);return}catch(e){console.error(`[ViewerView] Failed to read pasted file:`,e),this.showMessage(`Failed to read pasted file`);return}}let n=t;if(!(!n||!n.trim()))try{let e=n.trim();if(e.length<=W&&(O(e)||D(e))){let t=await E(e,{namePrefix:`pasted-doc`,uriComponent:!0});if(!this.isTextLikeFile(t.file)){this.showMessage(`Pasted data is not a text/markdown document`);return}let n=await t.file.text();this.setContent(n,t.file.name,null),this.showMessage(`Opened pasted encoded document`);return}this.setContent(e,void 0,null),this.showMessage(`Content pasted`)}catch(e){console.error(`[ViewerView] Failed to process pasted data:`,e),this.showMessage(`Failed to process pasted content`)}}isTextLikeFile(e){let t=(e.name||``).toLowerCase(),n=(e.type||``).toLowerCase();return!n||n.startsWith(`text/`)||n.includes(`markdown`)||n.includes(`json`)||n.includes(`xml`)?!0:[`.md`,`.markdown`,`.mdown`,`.mkd`,`.mkdn`,`.mdtxt`,`.mdtext`,`.txt`,`.json`,`.xml`,`.html`,`.htm`,`.css`,`.js`,`.ts`,`.tsx`,`.yml`,`.yaml`].some(e=>t.endsWith(e))}shouldHandlePaste(e){if(!this.element||!this.viewerAcceptsGlobalInput()||document.visibilityState!==`visible`)return!1;let t=e.target;if(!t||t.tagName===`INPUT`||t.tagName===`TEXTAREA`||t.isContentEditable)return!1;let n=this.viewBranchesContain(document.activeElement),r=this.viewBranchesContain(t),i=this.isPointerInView||this.viewBranchesHover();return r||n||i}saveState(){this.stateManager.save({content:this.contentRef.value,filename:this.options.filename})}showMessage(e){this.shellContext?this.shellContext.showMessage(e):console.log(`[Viewer] ${e}`)}normalizeMarkdownExtensionFlags(e){return(e||q).split(``).filter((e,t,n)=>/[dgimsuvy]/.test(e)&&n.indexOf(e)===t).join(``)||q}applyCustomMarkdownExtensions(e){let t=e||``,n=Array.isArray(this.markdownSettings.extensions)?this.markdownSettings.extensions:[];if(n.length===0||!t)return t;let r=t;for(let e of n){if(!e||e.enabled===!1)continue;let t=(e.pattern||``).trim();if(t)try{let n=new RegExp(t,this.normalizeMarkdownExtensionFlags(e.flags));r=r.replace(n,e.replacement??``)}catch(n){console.warn(`[Viewer] Skipping invalid markdown extension rule:`,{id:e.id,pattern:t,flags:e.flags,error:n})}}return r}applyMarkdownPlugins(e){let t=e||``;return t&&(this.markdownSettings.plugins.smartTypography&&(t=t.replace(/\.\.\./g,`&hellip;`).replace(/(^|[^\-])---([^\-]|$)/g,`$1&mdash;$2`).replace(/(^|[^\-])--([^\-]|$)/g,`$1&ndash;$2`)),this.markdownSettings.plugins.softBreaksAsBr&&(t=t.replace(/([^\n])\n(?!\n)/g,`$1  
`)),t)}getFontFamilyFromPreset(){let e=this.markdownSettings.fontFamily;return e===`serif`?`Georgia, Cambria, 'Times New Roman', Times, serif`:e===`mono`?`ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, 'Liberation Mono', monospace`:e===`sans`?`Inter, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif`:`ui-sans-serif, system-ui, -apple-system, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif`}applyRenderedLinkBehavior(e){let t=Array.from(e.querySelectorAll(`a[href]`));for(let e of t){let t=(e.getAttribute(`href`)||``).trim();if(!t)continue;let n=t.startsWith(`#`),r=/^(https?:)?\/\//i.test(t);this.markdownSettings.plugins.externalLinksNewTab&&r&&!n?(e.target=`_blank`,e.rel=`noopener noreferrer`):(e.target===`_blank`&&e.removeAttribute(`target`),e.rel===`noopener noreferrer`&&e.removeAttribute(`rel`))}}createLayerBlock(e,t){let n=(t||``).trim();return n?`@layer ${e} {\n${n}\n}`:``}normalizeUserCssForLayer(e,t){let n=(t||``).trim();return n?n.startsWith(`@layer`)?n:this.createLayerBlock(e,n):``}getPresetVariablesCss(){let e=this.markdownSettings.preset;return e===`classic`?`
                --md-letter-spacing: 0;
                --md-h1-size: 2.05em;
                --md-h2-size: 1.65em;
                --md-p-margin: 1.05em;
            ...
            --md-h2-size: 1.55em;
            --md-p-margin: 0.9em;
        `}buildCustomStyleText(){let e=this.markdownSettings.page.size||`auto`,t=this.markdownSettings.page.orientation||`portrait`,n=Number.isFinite(this.markdownSettings.page.marginMm)?Math.max(5,Math.min(40,this.markdownSettings.page.marginMm)):12,r=Number.isFinite(this.markdownSettings.printScale)?Math.max(.5,Math.min(1.5,this.markdownSettings.printScale)):1,i=Number.isFinite(this.markdownSettings.fontSizePx)?Math.max(12,Math.min(26,this.markdownSettings.fontSizePx)):16,a=Number.isFinite(this.markdownSettings.lineHeight)?Math.max(1.1,Math.min(2.2,this.markdownSettings.lineHeight)):1.7;Number.isFinite(this.markdownSettings.contentMaxWidthPx)&&Math.max(500,Math.min(1400,this.markdownSettings.contentMaxWidthPx));let o=`
