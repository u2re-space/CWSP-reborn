import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{At as t,Gt as n,J as r,Q as i,X as a,et as o,ft as s,jt as c,nt as l,tt as u}from"./HistoryManager-D8ebz2Z7.js";import{d,f}from"./registry-8P8fLSwv.js";import{n as p,t as m}from"./preload-helper-NDuSAHbO.js";import{f as h,p as g}from"./views-CgiS38xE.js";import{a as _,i as v,n as y,r as b,t as x}from"./Canvas-2-CymZx7xM.js";import{t as ee}from"./src-C9heO9y9.js";import{n as S}from"./CSSIconRegistry-D88SYH0A.js";import{n as C,t as te}from"./shells-D8A4BlSP.js";import{i as w,n as T,r as ne,t as E}from"./shell-slots-CDiat5LT.js";import{a as re,c as D,i as O,l as ie,n as k,o as A,r as j,s as M,t as N,u as P}from"./src-DzYBqwR5.js";var ae=e((()=>{})),F,I,L,R,z,oe,se,ce,le,ue=e((()=>{s(),F=new WeakMap,I=n(),L=e=>e?.naturalWidth||e?.width||1,R=e=>e?.naturalHeight||e?.height||1,z=(e,t,n=1,r,i=0)=>{let a=e.canvas;e.translate(a.width/2,a.height/2),e.rotate((-i||0)*(Math.PI*.5)),e.rotate((1-r)*(Math.PI/2)),e.translate(-(L(t)/2)*n,-(R(t)/2)*n)},oe=e=>(!F.has(e)&&(e instanceof Blob||e instanceof File||e instanceof OffscreenCanvas||e instanceof ImageBitmap||e instanceof Image)&&F.set(e,createImageBitmap(e)),F.get(e)),se=new WeakMap,ce=(e,t)=>se?.getOrInsertComputed?.(e,()=>e?.bind?.(t)),le=null,le=typeof HTMLCanvasElement<`u`?class extends HTMLCanvasElement{static observedAttributes=[`data-src`,`data-orient`,`orient`];ctx=null;image=null;#e=[1,1];#t=``;#n=``;get#i(){let e=this.getAttribute(`data-orient`)??this.getAttribute(`orient`)??`0`,t=Number.parseInt(e,10);return Number.isFinite(t)?t:0}set#i(e){let t=String(e);this.setAttribute(`data-orient`,t),this.setAttribute(`orient`,t)}attributeChangedCallback(e,t,n){e==`data-src`&&this.#a(n),(e==`data-orient`||e==`orient`)&&this.#o(this.#n)}connectedCallback(){let e=this.parentNode;this.style.setProperty(`max-inline-size`,`min(100%, min(100cqi, 100dvi))`),this.style.setProperty(`max-block-size`,`min(100%, min(100cqb, 100dvb))`),this.#e=[Math.min(Math.min(Math.max(this.clientWidth||e?.clientWidth||1,1),e?.clientWidth||1)*(this.currentCSSZoom||1),screen?.width||1)*(devicePixelRatio||1),Math.min(Math.min(Math.max(this.clientHeight||e?.clientHeight||1,1),e?.clientHeight||1)*(this.currentCSSZoom||1),screen?.height||1)*(devicePixelRatio||1)],this.#a(this.#t=this.dataset.src||this.#t),this.image&&this.#o(this.#n)}constructor(){super();let e=this,t=this.parentNode,n=()=>{let e=this.#e;this.#e=[Math.min(Math.min(Math.max(this.clientWidth||t?.clientWidth||1,1),t?.clientWidth||1)*(this.currentCSSZoom||1),screen?.width||1)*(devicePixelRatio||1),Math.min(Math.min(Math.max(this.clientHeight||t?.clientHeight||1,1),t?.clientHeight||1)*(this.currentCSSZoom||1),screen?.height||1)*(devicePixelRatio||1)],(e?.[0]!=this.#e[0]||e?.[1]!=this.#e[1])&&this.#o(this.#n)};I?.shedule?.(()=>{this.ctx=e.getContext(`2d`,{alpha:!0,desynchronized:!0,powerPreference:`high-performance`,preserveDrawingBuffer:!0}),this.inert=!0,this.style.objectFit=`cover`,this.style.objectPosition=`center`,this.classList.add(`u-canvas`),this.classList.add(`u2-canvas`),this.classList.add(`ui-canvas`),this.style.setProperty(`max-inline-size`,`min(100%, min(100cqi, 100dvi))`),this.style.setProperty(`max-block-size`,`min(100%, min(100cqb, 100dvb))`),n(),new ResizeObserver(e=>{for(let t of e){let e=t?.devicePixelContentBoxSize?.[0];if(e){let t=this.#e;this.#e=[Math.max(e.inlineSize||this.width,1),Math.max(e.blockSize||this.height,1)],(t?.[0]!=this.#e[0]||t?.[1]!=this.#e[1])&&this.#o(this.#n)}}}).observe(this,{box:`device-pixel-content-box`}),this.#a(this.#t=this.dataset.src||this.#t)})}async $useImageAsSource(e,t){t||=this.#t;let n=e instanceof ImageBitmap?e:await oe(e).catch(console.warn.bind(console));return n&&t==this.#t&&(this.image=n,this.#o(t)),e}$renderPass(e){let t=this,n=this.ctx,r=this.image;if(r&&n&&(e==this.#t||!e)){e&&(this.#n=e),this.width!=this.#e[0]&&(this.width=this.#e[0]),this.height!=this.#e[1]&&(this.height=this.#e[1]),this.style.aspectRatio=`${this.width||1} / ${this.height||1}`;let i=this.#i%2||0,a=+(L(r)<=R(r)),o=Math.max(t[[`height`,`width`][i]]/(a?R(r):L(r)),t[[`width`,`height`][i]]/(a?L(r):R(r)));n.save(),n.clearRect(0,0,t.width,t.height),z(n,r,o,a,this.#i),n.drawImage(r,0,0,r.width*o,r.height*o),n.restore()}}#a(e){let t=e||this.#t;return this.#t=t,fetch(e,{cache:`force-cache`,mode:`same-origin`,priority:`high`})?.then?.(async e=>this.$useImageAsSource(await e.blob(),t)?.catch(console.warn.bind(console)))?.catch?.(console.warn.bind(console))}#o(e){let t=this.ctx;this.image&&t&&(e==this.#t||!e)&&I?.shedule?.(ce(this.$renderPass,this))}}:class{constructor(){}$renderPass(e){}$useImageAsSource(e,t){return e}ctx=null;image=null};try{customElements.define(`ui-canvas`,le,{extends:`canvas`})}catch{}})),de=e((()=>{ae(),_(),b(),ue(),x()})),fe,pe=e((()=>{fe=`/**
...
.esc-overlays {
  ...
  position: relative;
  overflow: visible;
}`}));function B(){return!he&&!customElements.get(`env-shell-container`)&&(customElements.define(H,W),he=!0),W}function me(){B();let e=customElements.get(H);if(e)try{return new e}catch(e){console.warn("[env-shell-container] `new` failed, falling back to createElement",e)}return document.createElement(H)}function V(e){return e instanceof HTMLElement&&e.localName===`env-shell-container`}var H,U,W,he,ge=e((()=>{pe(),T(),H=`env-shell-container`,U=document.createElement(`template`),U.innerHTML=`
<div class="esc-stack" part="stack">
  <div class="esc-layer esc-underlying" part="underlying">
    <slot name="${E.underlying}"></slot>
  </div>
  ...
  >
    <slot name="${E.overlay}"></slot>
  </div>
</div>`,W=class extends HTMLElement{#e=!1;get overlayMount(){return this.#t(),this.shadowRoot?.querySelector(`[data-shell-overlays]`)??null}constructor(){super(),this.#t()}connectedCallback(){this.#t()}#t(){if(this.#e&&this.shadowRoot)return;let e=this.shadowRoot??this.attachShadow({mode:`open`});if(e.querySelector(`.esc-stack`)||e.appendChild(U.content.cloneNode(!0)),e.adoptedStyleSheets.length===0){let t=new CSSStyleSheet;t.replaceSync(fe),e.adoptedStyleSheets=[t]}this.#e=!0}},he=!1})),_e=e((()=>{de()}));function ve(e,t={}){let{x:n=48,y:r=48,w:a=640,h:s=480,z:c=10,demoRole:l}=t,u=matchMedia(`(max-width: 640px)`);return{demoRole:l,title:e,bounds:{x:o(n),y:o(r),w:o(a),h:o(s)},z:o(c),maximizedMobile:i(u.matches),minimized:i(!1),desktopMaximized:i(!1),nativeMode:i(!1),visible:i(!0),isMobileMq:u}}var ye=e((()=>{r(),Object.freeze({w:360,h:240})}));function G(e){let t=String(e??``).trim().toLowerCase();t=t.replace(/^#/,``);let n=/^todo:\s*(.*)$/i.exec(t);return n&&(t=String(n[1]??``).trim().toLowerCase()),t=t.replace(/\s+/g,``),t?t===`viewer`||xe.has(t)?K:t:``}function be(e){return String(e||``).trim().toLowerCase()===K}var K,xe,Se=e((()=>{K=`viewer`,xe=new Set([`markdown`,`markdown-view`,`markdown-viewer`,`reader`,`env-viewer`])}));function Ce(e){return!!(e&&typeof e==`object`&&typeof e.render==`function`)}function q(e,t){let n=e?.lifecycle?.[t];typeof n==`function`&&Promise.resolve(n())}function we(e){if(typeof e!=`function`)return!1;try{let t=e.prototype;return!!(t!=null&&typeof HTMLElement<`u`&&HTMLElement.prototype.isPrototypeOf(t))}catch{return!1}}function Te(e,t){let n=e.default??e.createView??e.createHomeView;if(!n||typeof n!=`function`)throw Error(`window-frame view-mount: module has no default/createView factory`);let r=we(n)?new n(t):n(t);if(Ce(r)){let e=r,n=e.render(t);if(!(n instanceof HTMLElement))throw Error(`window-frame view-mount: view.render() must return HTMLElement`);return{root:n,view:e}}if(r instanceof HTMLElement)return{root:r};throw Error(`window-frame view-mount: factory did not return View or HTMLElement`)}function Ee(e,t){return e.replaceChildren(t),()=>{t.remove(),e.replaceChildren()}}async function De(e,t,n){let{root:r,view:i}=Te(await e(),n);r.classList.add(`wf-mounted-view`);let a=Ee(t,r);return q(i,`onMount`),q(i,`onShow`),()=>{q(i,`onHide`),q(i,`onUnmount`),a()}}var Oe=e((()=>{}));function ke(e){let t=`[${Ae}]`,n=e.querySelector(t);if(n)return n.style.zIndex||(n.style.zIndex=J),n.style.position||(n.style.position=V(e)?`absolute`:`fixed`),n;let r=document.createElement(`div`);return r.setAttribute(Ae,``),r.className=`env-shell-overlays`,r.setAttribute(`data-part`,`env-overlays`),V(e)?(r.slot=E.overlay,r.style.cssText=`position:absolute;inset:0;pointer-events:none;z-index:${J};box-sizing:border-box;`,e.appendChild(r),r):(r.style.cssText=`position:fixed;inset:0;pointer-events:none;z-index:${J};box-sizing:border-box;`,e.appendChild(r),r)}var Ae,J,je=e((()=>{ge(),T(),Ae=`data-env-shell-overlays`,J=`2147483600`}));function Me(e){let t=e?.closest?.(`.env-shell-root`)??e?.closest?.(`env-shell-container`);if(!(t instanceof HTMLElement))return 0;let n=getComputedStyle(t).getPropertyValue(`--env-window-z-boost`).trim(),r=Number.parseInt(n,10);return Number.isFinite(r)?r:0}function Ne(e){let t=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.querySelector?.(`.env-shell-root, env-shell-container`);return t instanceof HTMLElement?t:null}function Y(e){let t=Ne(e);if(!t)return;let n=!!t.querySelector?.(`ui-window[native-mode], ui-window[data-native-active]`);t.toggleAttribute(`data-env-native-task`,n)}function Pe(e,t,n,r,o={}){let{bounds:s,z:c,maximizedMobile:l,minimized:u,desktopMaximized:d,visible:f,isMobileMq:p}=t;t.nativeMode||=i(!!o.startNative);let m=t.nativeMode;o.startNative&&(m.value=!0);let h=document.createElement(`ui-window`);h.setAttribute(`managed`,``),h.className=`env-ui-window`,h.setAttribute(`part`,`window`);let g=document.createElement(`span`);g.slot=`title`,g.className=`env-ui-window__title`,g.textContent=t.title,n.slot=`content`,n.classList.add(`env-ui-window__body`),h.append(g,n),e.appendChild(h);let _=String(o?.managedViewKey??``).trim();_&&(h.setAttribute(`data-ui-window-view`,_),h.setAttribute(`data-wf-managed-view`,_));let v=null,y=()=>{o.onChromeChange?.(),Y(e)},b=()=>{h.style.right=``,h.style.bottom=``},x=()=>{h.style.left=`${X}px`,h.style.top=`${X}px`,h.style.right=`${X}px`,h.style.bottom=`${X}px`,h.style.width=`auto`,h.style.height=`auto`,h.style.removeProperty(`--ui-win-width`),h.style.removeProperty(`--ui-win-height`)},ee=()=>{h.style.left=`0`,h.style.top=`0`,h.style.right=`0`,h.style.bottom=`0`,h.style.width=`100%`,h.style.height=`100%`,h.style.removeProperty(`--ui-win-width`),h.style.removeProperty(`--ui-win-height`)},S=()=>{let t=!!p.matches,n=Me(e),r=(c.value??10)+n;h.style.zIndex=String(r),t&&(d.value&&=!1,!u.value&&!m.value&&!l.value&&(l.value=!0));let i=!!m.value,a=!!u.value,o=!t&&!!d.value&&!i&&!a,g=t&&!i&&!a,_=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.querySelector?.(`.env-shell-root, env-shell-container`),v=_ instanceof HTMLElement&&_.hasAttribute(`data-status-overlay`)||document.documentElement.hasAttribute(`data-env-status-overlay`),y=_ instanceof HTMLElement&&_.hasAttribute(`data-standalone`)||document.documentElement.hasAttribute(`data-env-standalone`),S=v&&!i&&!a&&(g||o),C=y&&t&&!i&&!a;if(h.toggleAttribute(`native-mode`,i&&!a),h.toggleAttribute(`minimized`,a),h.toggleAttribute(`data-mobile-max`,g),h.toggleAttribute(`data-desk-max`,o),h.toggleAttribute(`data-status-gap`,S),h.toggleAttribute(`data-no-titlebar`,C),h.toggleAttribute(`maximized`,!a&&(o||g||i)),a){h.setVisible(!1),Y(e);return}if(h.setVisible(!!f.value),!f.value){Y(e);return}if(i){ee(),Y(e);return}if(g){h.style.left=`0`,h.style.top=`0`,h.style.right=`0`,h.style.bottom=`var(--env-mobile-dock-reserve, 3.25rem)`,h.style.width=`100%`,h.style.height=`auto`,Y(e);return}if(o){x(),Y(e);return}b(),h.applyBounds({x:s.x.value,y:s.y.value,w:s.w.value,h:s.h.value,z:r}),Y(e)},C=()=>{p.matches&&(m.value||(l.value=!0),d.value&&(d.value=!1,v&&=(s.x.value=v.x,s.y.value=v.y,s.w.value=v.w,s.h.value=v.h,null))),S(),y()},te=a(()=>{S()},[s.x,s.y,s.w,s.h,c,l,u,d,m,f],{triggerImmediately:!0});p.addEventListener(`change`,C),C();let w=()=>{S(),y()},T=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??document.documentElement;T?.addEventListener?.(`env-chrome-surface`,w);let ne=()=>{u.value&&(u.value=!1,f.value=!0),r();let t=Me(e),n=(c.value??10)+t;typeof h.bringToFront==`function`?h.bringToFront(n):(h.style.zIndex=String(n),h.toggleAttribute(`data-focused`,!0)),y()},E=e=>{let t=e.detail;m.value||d.value||l.value||u.value||(typeof t?.x==`number`&&(s.x.value=t.x),typeof t?.y==`number`&&(s.y.value=t.y))},re=e=>{let t=e.detail;m.value||d.value||l.value||u.value||(typeof t?.w==`number`&&(s.w.value=t.w),typeof t?.h==`number`&&(s.h.value=t.h))},D=()=>{m.value&&=!1,d.value&&(d.value=!1,v&&=(s.x.value=v.x,s.y.value=v.y,s.w.value=v.w,s.h.value=v.h,null)),u.value=!0,S(),y()},O=()=>{if(m.value){k();return}if(p.matches){u.value=!1,l.value=!0,S(),y();return}if(u.value&&=!1,d.value){A();return}v={x:s.x.value,y:s.y.value,w:s.w.value,h:s.h.value},d.value=!0,S(),y()},ie=()=>{u.value&&(u.value=!1,f.value=!0),!m.value&&!d.value&&!l.value&&(v={x:s.x.value,y:s.y.value,w:s.w.value,h:s.h.value}),d.value=!1,l.value=!1,m.value=!0,S(),y()},k=()=>{m.value&&(m.value=!1,v&&=(s.x.value=v.x,s.y.value=v.y,s.w.value=v.w,s.h.value=v.h,null),p.matches&&(l.value=!0),S(),y())},A=()=>{if(m.value){k();return}u.value&&(u.value=!1,f.value=!0),p.matches?l.value&&=!1:d.value&&(d.value=!1,v&&=(s.x.value=v.x,s.y.value=v.y,s.w.value=v.w,s.h.value=v.h,null)),S(),y()},j=!1,M=!1,N=t=>{if(t.preventDefault(),!(j||M)){j=!0;try{m.value&&=!1,f.value=!1,o.onClose?.()}catch(e){console.error(`[mount-ui-window] onClose failed`,e)}finally{if(!M){M=!0,te?.(),p.removeEventListener(`change`,C),T?.removeEventListener?.(`env-chrome-surface`,w);try{h.isConnected&&h.remove()}catch{}}Y(e)}}},P=0,ae=()=>{let e=typeof performance<`u`?performance.now():Date.now();return e-P<280?!1:(P=e,!0)},F=e=>{if(!(j||M)&&ae()){if(e===`close`){N(new Event(`window-close`,{cancelable:!0}));return}if(e===`exit-native`){k();return}if(e===`maximize`){m.value||d.value||l.value?A():O();return}u.value?A():D()}},I=e=>{let t=typeof e.composedPath==`function`?e.composedPath():[];for(let e of t){if(!(e instanceof Element))continue;let t=e.getAttribute?.(`data-ui-win-action`);if(t===`close`||t===`exit-native`||t===`maximize`||t===`minimize`)return t;if(e.matches?.(`.title-close`))return`close`;if(e.matches?.(`.title-exit-native`))return`exit-native`;if(e.matches?.(`.title-maximize`))return`maximize`;if(e.matches?.(`.title-minimize`))return`minimize`}return null},L=e=>{if(j||M||e.defaultPrevented)return;let t=I(e);t&&(e.preventDefault(),e.stopPropagation(),F(t))},R=null,z=()=>{let e=h.shadowRoot;if(!e||j||M)return;let t=e.querySelectorAll(`[data-ui-win-action], .title-minimize, .title-maximize, .title-close, .title-exit-native`);for(let e of t){let t=e.getAttribute(`data-ui-win-action`);if(t||(e.classList.contains(`title-close`)?t=`close`:e.classList.contains(`title-exit-native`)?t=`exit-native`:e.classList.contains(`title-maximize`)?t=`maximize`:e.classList.contains(`title-minimize`)&&(t=`minimize`)),!t)continue;e.setAttribute(`data-ui-win-action`,t);let n=t,r=e=>{e.defaultPrevented||(e.preventDefault(),e.stopPropagation(),F(n))};e.onclick=r,e.onpointerup=e=>{e.button===0&&r(e)}}};if(z(),queueMicrotask(z),requestAnimationFrame(z),typeof MutationObserver<`u`){R=new MutationObserver(()=>z());let e=()=>{h.shadowRoot?R?.observe(h.shadowRoot,{childList:!0,subtree:!0}):requestAnimationFrame(e)};e()}return h.addEventListener(`window-focus`,ne),h.addEventListener(`window-move`,E),h.addEventListener(`window-resize`,re),h.addEventListener(`window-minimize`,D),h.addEventListener(`window-maximize`,O),h.addEventListener(`window-restore`,A),h.addEventListener(`window-native`,ie),h.addEventListener(`window-exit-native`,k),h.addEventListener(`window-close`,N),h.addEventListener(`click`,L),h.addEventListener(`pointerup`,L),()=>{if(!M){M=!0,j=!0,te?.(),R?.disconnect(),R=null,p.removeEventListener(`change`,C),T?.removeEventListener?.(`env-chrome-surface`,w),h.removeEventListener(`window-focus`,ne),h.removeEventListener(`window-move`,E),h.removeEventListener(`window-resize`,re),h.removeEventListener(`window-minimize`,D),h.removeEventListener(`window-maximize`,O),h.removeEventListener(`window-restore`,A),h.removeEventListener(`window-native`,ie),h.removeEventListener(`window-exit-native`,k),h.removeEventListener(`window-close`,N),h.removeEventListener(`click`,L),h.removeEventListener(`pointerup`,L);try{m.value&&=!1,h.isConnected&&h.remove()}catch{}Y(e)}}}var X,Fe=e((()=>{r(),N(),X=8}));function Z(e,t){let n=typeof CSS<`u`&&typeof CSS.escape==`function`?CSS.escape(t):t.replace(/\\/g,`\\\\`).replace(/"/g,`\\"`),r=e.querySelector(`:scope > ui-window[data-ui-window-view="${n}"]`)||e.querySelector(`:scope > ui-window[data-wf-managed-view="${n}"]`)||e.querySelector(`:scope > section.wf-frame[data-wf-managed-view="${n}"]`);return r instanceof HTMLElement?r:null}function Ie(e){let t=e.closest?.(`.env-shell-root`)??e.closest?.(`env-shell-container`)??e.parentElement;if(!(t instanceof HTMLElement))return 0;let n=getComputedStyle(t).getPropertyValue(`--env-window-z-boost`).trim(),r=Number.parseInt(n,10);return Number.isFinite(r)?r:0}function Le(e){return null}function Q(e,t){let n=G(e)||String(e||``).trim().toLowerCase();if(t?.[n])return t[n];if(Ve[n])return Ve[n];let r=String(e||``).trim();return r?r.charAt(0).toUpperCase()+r.slice(1):`View`}function Re(e,t){let n=document.createElement(`div`);return n.className=`wf-view-placeholder`,n.setAttribute(`part`,`placeholder`),n.innerHTML=`<p class="wf-view-placeholder__title">${Q(e,t)}</p>
<p class="wf-view-placeholder__hint">No window module is registered for this shortcut in environment-shell yet.</p>`,n}function ze(e,t={}){let n=o(120),r=new Map,i=!1,a=null,s=()=>{t.onTaskingChange?.(c())},c=()=>{let n=[];for(let i of r.values())Z(e,i.key)&&n.push({id:i.key,title:i.model.title||Q(i.key,t.viewTitles),icon:Be[i.key]||`app-window`,focused:a===i.key,minimized:!!i.model.minimized.value,visible:!!i.model.visible.value});return n},l=()=>{for(let t of r.values()){let n=Z(e,t.key);if(!n)continue;n.toggleAttribute(`data-focused`,!1);let r=n.clearFocused;typeof r==`function`&&r.call(n)}},u=e=>{for(let[t,n]of r)e&&t===e||n.model.nativeMode?.value&&(n.model.nativeMode.value=!1)},d=(t,r)=>{if(a===r&&!t.minimized.value){let t=Z(e,r);if(t&&t===e.lastElementChild)return}n.value+=1,t.z.value=n.value,t.minimized.value=!1,t.visible.value=!0,a=r,t.nativeMode?.value&&u(r);let i=Z(e,r);if(i){let n=Ie(e),r=(t.z.value??10)+n;l(),i.style.zIndex=String(r),i.toggleAttribute(`data-focused`,!0);let a=i.bringToFront;typeof a==`function`&&a.call(i,r),i.parentElement===e&&e.appendChild(i)}s()},f={},p=t.overlayMountHost?ke(t.overlayMountHost):null;f.resolveOverlayMountPoint=e=>{if(p)return p;if(t.environmentShellHost){let e=w(t.environmentShellHost);if(e)return e}return ne(e??null)};let m=e=>{let n=G(e)||String(e||``).trim().toLowerCase();return t.viewLoaders?.[n]||Le(n)},h=()=>{let i=t.readerWindow;if(!i?.content)return;let o=K,c=r.get(o);if(c&&Z(e,o)){d(c.model,o);return}if(c&&!Z(e,o)){r.delete(o);try{c.disposeFrame()}catch{}}let l=i.seed||{},u=ve(i.title||Q(o,t.viewTitles),{x:l.x??96,y:l.y??96,w:l.w??420,h:l.h??340,z:l.z??n.value+1});n.value=u.z.value;let f=()=>{};f=Pe(e,u,i.content,()=>d(u,o),{managedViewKey:o,onChromeChange:s,onClose:()=>{let e=r.get(o);if(e){r.delete(o),a===o&&(a=null);try{e.disposeFrame()}catch{}s()}}}),r.set(o,{key:o,model:u,disposeFrame:f}),d(u,o)},g=(o,c)=>{if(i)return;let l=G(String(o||``));if(!l||l===`home`||l===`airpad`)return;if(be(l)&&t.readerWindow?.content){h();return}let p=r.get(l);if(p&&Z(e,l)){d(p.model,l);return}if(p&&!Z(e,l)){p.disposeView?.(),r.delete(l);try{p.disposeFrame()}catch{}}let g=m(l),_=document.createElement(`div`);_.className=`wf-view-host env-ui-window__view-host`,_.setAttribute(`part`,`view-host`);let v=r.size*24,y=ve(Q(l,t.viewTitles),{x:72+v,y:72+v,w:640,h:480,z:n.value+1});n.value=y.z.value;let b=new Set((t.startNativeViewIds||[]).map(e=>G(String(e||``)))).has(l)||String(c?.native||``)===`1`||String(c?.params?.native||``)===`1`,x=()=>{};x=Pe(e,y,_,()=>d(y,l),{managedViewKey:l,startNative:b,onChromeChange:s,onClose:()=>{let e=r.get(l);if(e){r.delete(l),a===l&&(a=null);try{e.disposeView?.()}catch{}try{e.disposeFrame()}catch{}s()}}}),b&&(y.nativeMode.value=!0,u(l));let ee={key:l,model:y,disposeFrame:x,disposeView:void 0};r.set(l,ee),d(y,l);let S={...c||{},shellContext:f};if(!g){_.replaceChildren(Re(l,t.viewTitles));return}De(g,_,S).then(e=>{if(i){e();return}let t=r.get(l);t&&(t.disposeView=e)},e=>{console.error(`[workspace-window-layer] mountViewModule failed for view "${l}"`,e),_.replaceChildren(Re(l,t.viewTitles))})};return f.navigate=(e,t)=>{g(String(e),t)},f.openView=(e,t)=>{g(String(e),t)},{shellContext:f,dispose:()=>{if(!i){i=!0;for(let e of r.values())e.disposeView?.(),e.disposeFrame();r.clear(),a=null,s()}},focusWindow:t=>{let n=G(String(t||``)),i=r.get(n);return!i||!Z(e,n)?!1:(d(i.model,n),!0)},minimizeWindow:t=>{let n=G(String(t||``)),i=r.get(n);return!i||!Z(e,n)?!1:(i.model.nativeMode?.value&&(i.model.nativeMode.value=!1),i.model.desktopMaximized?.value&&(i.model.desktopMaximized.value=!1),i.model.visible.value=!0,i.model.minimized.value=!0,a===n&&(a=null,l()),s(),!0)},minimizeAllWindows:()=>{if(!i){u(null),a=null,l();for(let t of r.values())Z(e,t.key)&&(t.model.desktopMaximized?.value&&(t.model.desktopMaximized.value=!1),t.model.visible.value=!0,t.model.minimized.value=!0);s()}},closeWindow:e=>{let t=G(String(e||``)),n=r.get(t);if(!n)return!1;r.delete(t),a===t&&(a=null);try{n.disposeView?.()}catch{}try{n.disposeFrame()}catch{}return s(),!0},blurWindows:()=>{u(null),a=null,l(),s()},closeAllWindows:()=>{if(!i){u(null);for(let e of[...r.values()]){try{e.disposeView?.()}catch{}try{e.disposeFrame()}catch{}}r.clear(),a=null,s()}},enterNative:t=>{let n=G(String(t||``)),i=r.get(n);return!i||!Z(e,n)?!1:(u(n),i.model.nativeMode.value=!0,i.model.minimized.value=!1,i.model.visible.value=!0,d(i.model,n),!0)},exitNative:e=>{if(e){let t=G(String(e||``)),n=r.get(t);n?.model.nativeMode&&(n.model.nativeMode.value=!1),s();return}u(null),s()},listWindowTasks:c,getFocusedKey:()=>a}}var Be,Ve,He=e((()=>{r(),T(),ye(),Se(),Oe(),je(),Fe(),Be={home:`house`,viewer:`article`,markdown:`article`,explorer:`books`,settings:`gear-six`,workcenter:`briefcase`,history:`clock-counter-clockwise`,editor:`pencil-simple-line`,network:`wifi-high`,task:`list-checks`,event:`calendar`,bonus:`gift`,person:`address-book`},Ve={home:`Home`,viewer:`Markdown`,explorer:`Explorer`,settings:`Settings`,workcenter:`Work Center`,history:`History`,editor:`Editor`,network:`Network`,task:`Plan`,event:`Events`,bonus:`Bonuses`,person:`Contacts`}}));function Ue(e,t=Ge){try{localStorage.getItem(t)||localStorage.setItem(t,e)}catch{}}function We(e,t){let n=O(),{element:r,dispose:i}=ie(t.shell,t.introHtml,n),a=document.createElement(`div`);a.className=`env-shell-chrome wf-chrome-no-select`;let o;t.taskbar?(o=j({...t.taskbar,device:n}),a.append(o.element,r)):a.append(r);let s=(e.classList?.contains(`env-shell-root`)?e:null)||e.closest?.(`.env-shell-root`)||e.closest?.(`env-shell-container`)||e,c=typeof matchMedia==`function`?matchMedia(`(min-width: 641px)`):null,l=typeof matchMedia==`function`?[`(display-mode: standalone)`,`(display-mode: fullscreen)`,`(display-mode: minimal-ui)`,`(display-mode: browser)`,`(display-mode: window-controls-overlay)`].map(e=>matchMedia(e)):[],u=()=>{let e=!c||c.matches,t=D(),n=M(),r=P({desktop:e,standalone:n,displayMode:t});a.toggleAttribute(`data-desktop`,e),a.toggleAttribute(`data-standalone`,n),a.toggleAttribute(`data-status-overlay`,r),a.dataset.chromeLayout=e?`desktop`:`mobile`,a.dataset.displayMode=t,s.toggleAttribute(`data-standalone`,n),s.toggleAttribute(`data-status-overlay`,r),s.dataset.displayMode=t,s.style.setProperty(`--env-status-inset-top`,r?`max(2rem, env(safe-area-inset-top, 0px))`:`0px`),document.documentElement.toggleAttribute(`data-env-status-overlay`,r),document.documentElement.toggleAttribute(`data-env-standalone`,n);try{s.dispatchEvent(new CustomEvent(`env-chrome-surface`,{bubbles:!0,detail:{statusOverlay:r,standalone:n,displayMode:t,desktop:e}}))}catch{}};u(),c?.addEventListener?.(`change`,u);for(let e of l)e.addEventListener?.(`change`,u);document.addEventListener(`fullscreenchange`,u),document.addEventListener(`webkitfullscreenchange`,u);let d=re(s);return V(e)&&(a.slot=E.overlay),e.appendChild(a),{root:a,device:n,statusBar:r,taskbar:o,disposeDevice:()=>{c?.removeEventListener?.(`change`,u);for(let e of l)e.removeEventListener?.(`change`,u);document.removeEventListener(`fullscreenchange`,u),document.removeEventListener(`webkitfullscreenchange`,u),d(),i(),n.dispose()}}}var Ge,Ke=e((()=>{A(),k(),ge(),T(),A(),k(),_e(),He(),Fe(),je(),Ge=`rs-wallpaper-image`})),qe,Je=e((()=>{qe=`*,
*::before,
*::after {
    box-sizing: border-box;
}
...
`})),Ye,Xe=e((()=>{Ye=`/* environment-shell — default layout + chrome for wallpaper / home / window-frame hosts.
 ...
 * Reason for changes: Light --wf-md-* via --u2-color-mod; keep --color-* bridge.
 */
...
.env-shell-root {
  ...
  --wf-md-surface: --u2-color-mod(var(--base-color-neutralized), 990);
  --wf-md-surf-container-low: --u2-color-mod(var(--base-color-neutralized), 970);
  --wf-md-surf-container: --u2-color-mod(var(--base-color-neutralized), 980);
  --wf-md-surf-container-high: --u2-color-mod(var(--base-color-neutralized), 990);
  --wf-md-outline-variant: color-mix(in oklab, --u2-color-mod(var(--base-color-neutralized), 900) 14%, transparent);
  --wf-md-on-surface: --u2-color-mod(var(--base-color-neutralized), 10);
  --wf-md-on-surface-variant: --u2-color-mod(var(--base-color-neutralized), 20);
  ...
  --env-status-fg: #f5f5f7;
  --env-status-fg-muted: rgba(245, 245, 247, 0.78);
  /* Bridge wf-demo tokens → SpeedDial / launcher (\`--color-*\`, \`--on-surface-*\`). */
  /* WHY: WallpaperTheme may write --color-primary; box fallback = familiar veela blue. */
  --wf-md-seed: var(--base-color, var(--color-primary, #5a7fff));
  --color-surface: var(--wf-md-surface, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 980));
  --color-on-surface: var(--wf-md-on-surface, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 10));
  --color-on-surface-variant: var(--wf-md-on-surface-variant, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 20));
  --color-surface-container: var(--wf-md-surf-container, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 980));
  --color-surface-container-high: var(--wf-md-surf-container-high, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 990));
  --color-outline-variant: var(--wf-md-outline-variant, color-mix(in oklab, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 100) 12%, transparent));
  --on-surface-color: var(--wf-md-on-surface, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 10));
  --on-surface-variant: var(--wf-md-on-surface-variant, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 20));
}
@media (prefers-color-scheme: light) {
  .env-shell-root {
    /* WHY: wf-demo.css pins a dark baseline; flip Material-ish tokens so launcher icons/labels contrast on light tiles. */
    --wf-md-surface: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 10);
    --wf-md-surf-container-low: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 20);
    --wf-md-surf-container: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 10);
    --wf-md-surf-container-high: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 0);
    --wf-md-outline-variant: color-mix(in oklab, --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 900) 14%, transparent);
    --wf-md-on-surface: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 980);
    --wf-md-on-surface-variant: --u2-color-mod(var(--wf-md-primary, var(--wf-md-seed)), 970);
...
.env-shell-root[data-env-crx="1"] {
  isolation: isolate;
}`}));function Ze(){try{let e=new URLSearchParams(globalThis.location?.search||``);if(e.get(`native`)!==`1`&&e.get(`native`)!==`true`)return[];let t=(e.get(`view`)||``).trim().toLowerCase(),n=String(globalThis.location?.pathname||``).replace(/^\/+|\/+$/g,``).toLowerCase(),r=t||n||`explorer`;return!r||r===`home`?[`explorer`]:[r===`markdown`?`viewer`:r]}catch{return[]}}function Qe(e){let t=e||{};return t.native===1||t.native===`1`||t.native===!0||t.params?.native===`1`||t.params?.native===`true`}function $e(e,t){if(!Ze().includes(e)&&!Qe(t))return t||{};let n={...t||{}};return n.native=`1`,n.params={...n.params||{},native:`1`},n}async function et(){try{let e=await m(()=>import(`./launcher-state-C4miLiRN.js`),[],import.meta.url),t=e.speedDialItems;if(!t||typeof t.findIndex!=`function`)return;let n=!1;for(let e=t.length-1;e>=0;e--){let r=t[e],i=String(r?.meta?.view||``).toLowerCase(),a=String(r?.id||``).toLowerCase();(i===`airpad`||a.includes(`airpad`))&&(t.splice(e,1),n=!0)}let r=(n,r,i,a,o)=>{!g(o)&&o!==`home`||t.find?.(e=>String(e?.id)===n||String(e?.meta?.view||``).toLowerCase()===o)||e.addSpeedDialItem({id:n,cell:u(r),icon:i,label:a,action:`open-view`,meta:{view:o}})};r(`shortcut-network`,[0,0],`wifi-high`,`Network`,`network`),r(`shortcut-settings`,[1,0],`gear-six`,`Settings`,`settings`),r(`shortcut-explorer`,[2,0],`books`,`Explorer`,`explorer`),r(`shortcut-viewer`,[3,0],`article`,`Markdown`,`viewer`),r(`shortcut-history`,[0,1],`clock-counter-clockwise`,`History`,`history`),n&&e.persistSpeedDialItems?.()}catch(e){console.warn(`[EnvironmentShell] speed-dial seed skipped`,e)}}function tt(e){return new $}var nt,rt,$,it=e((()=>{r(),s(),ee(),de(),C(),T(),f(),h(),Ke(),Oe(),Je(),Xe(),p(),B(),nt={network:()=>m(()=>import(`./src-0u8u0B5z.js`),[],import.meta.url),settings:()=>m(()=>import(`./src-ZBYqyFwJ.js`),[],import.meta.url),explorer:()=>m(()=>import(`./_cwsp-disabled-entry_view-explorer-D-8MVImu.js`),[],import.meta.url),viewer:()=>m(()=>import(`./_cwsp-disabled-entry_view-viewer-CeLlddQ8.js`),[],import.meta.url),markdown:()=>m(()=>import(`./_cwsp-disabled-entry_view-viewer-CeLlddQ8.js`),[],import.meta.url),history:()=>m(()=>import(`./src-BsMeVUZb.js`),[],import.meta.url),workcenter:()=>m(()=>import(`./_cwsp-disabled-entry_view-workcenter-DV1PlEAR.js`),[],import.meta.url),editor:()=>m(()=>import(`./_cwsp-disabled-entry_view-editor-BtWewwh9.js`),[],import.meta.url),home:()=>m(()=>import(`./_cwsp-disabled-entry_view-home-gqgAY_Ff.js`),[],import.meta.url)},rt=[`home`,`network`,`settings`,`explorer`,`viewer`,`history`,`workcenter`,`editor`],$=class extends te{id=`environment`;name=`Environment`;layout={hasSidebar:!1,hasToolbar:!1,hasTabs:!1,supportsMultiView:!0,supportsWindowing:!0};workspaceEl=null;homeMountEl=null;windowLayer=null;chromeDispose=null;homeUnmount=null;shellActivityDispose=null;focusedTaskId=l(`home`);setFocusedTaskId=null;syncWindowTasks=null;navEcho=l(``);mqLabel=l(`desktop`);createLayout(){return document.createElement(`div`)}getStylesheet(){return Ye}async mount(e){if(this.mounted){console.warn(`[${this.id}] Shell already mounted`);return}this.container=e,Ue(`/assets/wallpaper.jpg`),B();try{await c(qe),t(qe)}catch(e){console.warn(`[EnvironmentShell] wf-demo tokens failed`,e)}let n=this.getStylesheet();if(n)try{await c(n),t(n)}catch(e){console.warn(`[EnvironmentShell] env shell styles failed`,e)}try{S()}catch{}try{document.documentElement.dataset.cwspSurface=`environment`}catch{}let r=me();r.className=`env-shell-root wf-demo-root`,r.setAttribute(`data-shell`,`environment`),r.setAttribute(`data-shell-system`,`task-tab`),r.style.gridColumn=`content-column`,r.style.gridRow=`content-row`,r.style.alignSelf=`stretch`,r.style.justifySelf=`stretch`,r.style.minInlineSize=`0`,r.style.minBlockSize=`0`,r.style.inlineSize=`100%`,r.style.blockSize=`100%`,r.style.pointerEvents=`auto`;let i=document.createElement(`div`);i.slot=E.underlying,i.className=`env-shell-wallpaper`,i.setAttribute(`data-env-wallpaper`,``);let a=document.createElement(`div`);a.className=`env-shell-workspace`,a.setAttribute(`data-shell-content`,``);let o=document.createElement(`div`);o.className=`env-shell-home-mount`,o.style.display=`flex`,o.style.flex=`1 1 auto`,o.style.flexDirection=`column`,o.style.alignSelf=`stretch`,o.style.minHeight=`0`,o.style.minWidth=`0`,a.appendChild(o),r.append(i,a),e.replaceChildren(r),this.rootElement=r,this.workspaceEl=a,this.homeMountEl=o,this.contentContainer=a,this.overlayContainer=r.overlayMount??r.shadowRoot?.querySelector?.(`[data-shell-overlays]`)??null,this.mounted=!0,this.shellActivityDispose=d(this.id);try{v(),y(i)}catch(e){console.warn(`[EnvironmentShell] wallpaper init failed`,e)}let s={};for(let e of rt){if(e===`home`||!g(e)&&e!==`viewer`)continue;let t=nt[e];t&&(s[e]=t)}s.viewer&&(s.markdown=s.viewer);let u=matchMedia(`(max-width: 640px)`);this.mqLabel.value=u.matches?`mobile`:`desktop`,u.addEventListener(`change`,()=>{this.mqLabel.value=u.matches?`mobile`:`desktop`});let f=We(r,{shell:{selectedPath:l(``),viewerStatus:l(``),navEcho:this.navEcho,mqLabel:this.mqLabel},introHtml:`<p><strong>CWSP environment</strong> — Speed Dial / desktop launcher. Views open in <code>ui-window</code>.</p>`,taskbar:{focusedTaskId:this.focusedTaskId,onHome:()=>this.focusHome(),onViewer:()=>{this.openInWindow(`viewer`)},onWindowTask:e=>{this.openInWindow(e)},onMinimizeWindow:e=>{let t=String(e||``).trim().toLowerCase();t&&this.windowLayer?.minimizeWindow?.(t)&&(this.setFocusedTaskId?.(`home`),this.focusedTaskId.value=`home`)},onCloseWindow:e=>{let t=String(e||``).trim().toLowerCase();t&&(this.windowLayer?.closeWindow?.(t),String(this.focusedTaskId.value||``)===t&&(this.setFocusedTaskId?.(`home`),this.focusedTaskId.value=`home`))}}});this.setFocusedTaskId=f.taskbar?.setFocusedTaskId??null,this.syncWindowTasks=f.taskbar?.syncWindowTasks??null,this.chromeDispose=()=>{f.disposeDevice(),f.taskbar?.dispose?.(),f.root.remove()};let p=Ze();this.windowLayer=ze(a,{overlayMountHost:r,environmentShellHost:r,viewLoaders:s,startNativeViewIds:p,viewTitles:{network:`Network`,settings:`Settings`,explorer:`Explorer`,viewer:`Markdown`,history:`History`,workcenter:`Work Center`,editor:`Editor`},onTaskingChange:e=>{this.syncWindowTasks?.(e);let t=e.find(e=>e.focused);t&&this.setFocusedTaskId?.(t.id)}});let h={...this.windowLayer.shellContext,navigate:(e,t)=>{this.navEcho.value=`shell.navigate("${e}")`,this.routeView(String(e),t)},openView:(e,t)=>{this.navEcho.value=`shell.openView("${e}")`,this.routeView(String(e),t)},showMessage:e=>{this.showMessage(typeof e==`string`?e:String(e??``))}};et(),De(()=>m(()=>import(`./_cwsp-disabled-entry_view-home-gqgAY_Ff.js`),[],import.meta.url),o,{shellContext:h}).then(e=>{this.homeUnmount=e}).catch(e=>{console.warn(`[EnvironmentShell] home-view failed`,e),o.innerHTML=`<p style="color:#eee;padding:1rem;font-family:system-ui">Home view failed to load.</p>`})}focusHome(){if(typeof this.windowLayer?.minimizeAllWindows==`function`)this.windowLayer.minimizeAllWindows();else{for(let e of this.windowLayer?.listWindowTasks?.()??[])this.windowLayer?.minimizeWindow?.(e.id);this.windowLayer?.blurWindows?.()}this.setFocusedTaskId?.(`home`),this.focusedTaskId.value=`home`,this.currentView.value=`home`}openInWindow(e,t){let n=String(e||``).trim().toLowerCase();if(!n||n===`airpad`)return;let r=$e(n,t);this.windowLayer?.focusWindow(n)?Qe(r)&&this.windowLayer?.enterNative?.(n):this.windowLayer?.shellContext.openView?.(n,r),this.setFocusedTaskId?.(n===`markdown`?`viewer`:n),this.currentView.value=n}async routeView(e,t){let n=String(e||``).trim().toLowerCase();if(!(!n||n===`airpad`)){if(n===`home`){this.focusHome();return}this.openInWindow(n,t)}}async navigate(e,t,n){let r=String(e||`home`).toLowerCase();if(r===`airpad`){this.showMessage(`AirPad view is disabled in environment shell`);return}if(r===`home`){this.focusHome();try{let e=new URLSearchParams(t||{});e.set(`shell`,this.id);let n=e.toString()?`?${e.toString()}`:``,r=`${location.pathname}${n}`;`${location.pathname}${location.search}`!==r&&history.replaceState({viewId:`home`,params:t},``,r)}catch{}return}this.openInWindow(r,t?{params:t}:void 0)}unmount(){try{this.homeUnmount?.()}catch{}this.homeUnmount=null;try{this.windowLayer?.dispose()}catch{}this.windowLayer=null;try{this.chromeDispose?.()}catch{}this.chromeDispose=null;try{this.shellActivityDispose?.()}catch{}if(this.shellActivityDispose=null,this.mounted&&this.container&&this.rootElement)try{this.container.contains(this.rootElement)&&this.rootElement.remove()}catch{}this.rootElement=null,this.contentContainer=null,this.overlayContainer=null,this.workspaceEl=null,this.homeMountEl=null,this.container=null,this.mounted=!1}}}));export{tt as n,it as r,$ as t};