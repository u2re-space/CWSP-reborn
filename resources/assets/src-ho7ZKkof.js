import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{F as t,H as n,L as r,V as i,X as a,t as o,tt as s}from"./src-BsfiZfT5.js";import{a as c,c as l,d as u,f as d,l as f,u as p}from"./registry-Bm5x2jZL.js";import{n as m,t as h}from"./preload-helper-NDuSAHbO.js";import{n as g,t as _}from"./templates-Cp6qXLQ6.js";import{a as v,d as y}from"./UnifiedMessaging-Bb5xrVpZ.js";import{a as ee,i as te,r as b}from"./BootLoader-c5jCFUEx.js";import{B as ne,K as re}from"./airpad-cwsp-client-parity-CXnZuSSw.js";import{a as ie,i as ae,r as x,t as oe}from"./SettingsTypes-D6q9S6cT.js";import{t as S,v as se}from"./remote-connection-runtime-DaB8YVvg.js";import{a as ce,c as le,i as ue,n as C,o as de,r as fe,s as pe}from"./Settings-Bj0gI75v.js";import{n as me,r as he}from"./Theme-CCs-jUsr.js";import{n as ge,r as _e}from"./capacitor-permissions-Brl6YLsA.js";import{a as ve,c as w,d as ye,f as T,i as be,l as xe,n as E,o as D,p as Se,r as Ce,s as we,t as Te,u as Ee}from"./cwsp-app.js";import{a as De,n as Oe,o as ke,s as Ae}from"./shells-HsChC3uj.js";import{i as je,n as Me,r as Ne}from"./admin-doors-BoU4RSfd.js";import{c as Pe,i as Fe,l as Ie,n as Le,o as Re,r as ze,s as Be}from"./CustomInstructions-DUVxQLxm.js";import{i as Ve,n as He}from"./registry-C70cxKBp.js";import{a as Ue,r as We}from"./channel-actions-DC9DgSYV.js";var Ge=e((()=>{})),O,Ke,k,A,j,M=e((()=>{Ge(),O=`data-settings-view-css`,Ke=e=>{let t=String(e||``).trim(),n=t.match(/^@layer\s+settings-view\s*\{([\s\S]*)\}\s*$/);return n&&(t=n[1].trim()),t},k=`
...
@layer settings-view {
        ...
        <textarea class="form-input" rows="10" data-field="appearance.markdown.extensions" placeholder='[
  {
    ...
    "enabled": true
      ...
      <label class="field checkbox form-checkbox">
    ...
    </section>`})),wt,Tt=e((()=>{o(),r(),Be(),g(),wt=(e={})=>{let n=i({instructions:[],activeId:``,editingId:null,newLabel:``,newInstruction:``,isAdding:!1}),r=t`<div class="custom-instructions-editor">
        <div class="ci-row">
            <div class="ci-header">
        ...
        <div class="ci-actions">
            ...
            </div>`;s.addEventListener(`click`,t=>{let r=t.target.closest(`[data-action]`)?.getAttribute(`data-action`);if(r===`activate`&&Pe(i.id).then(p).then(()=>e.onUpdate?.()),r===`edit`&&(n.editingId=i.id,u()),r===`delete`&&confirm(`Delete "${i.label}"?`)&&Fe(i.id).then(p).then(()=>e.onUpdate?.()),r===`save-edit`){let t=s.querySelector(`[data-edit-field='label']`),r=s.querySelector(`[data-edit-field='instruction']`);Ie(i.id,{label:t.value.trim()||i.label,instruction:r.value.trim()}).then(()=>(n.editingId=null,p())).then(()=>e.onUpdate?.())}r===`cancel-edit`&&(n.editingId=null,u())}),a.append(s)}},d=()=>{o.replaceChildren(),o.append(t`<option value="">None (use default)</option>`);for(let e of n.instructions??[]){let r=t`<option value="${e.id}">${e.label}</option>`;e.id===n.activeId&&(r.selected=!0),o.append(r)}},f=(e,t)=>!e||e.length<=t?e||``:e.slice(0,t).trim()+`…`,p=async()=>{let e=await Re(),t=Array.isArray(e)?{instructions:e,activeId:``,activeInstruction:null}:e;n.instructions=t?.instructions??[],n.activeId=t?.activeId??``,u(),d()};return r.addEventListener(`click`,t=>{let r=t.target.closest(`[data-action]`)?.getAttribute(`data-action`);if(r===`add`&&(n.isAdding=!0,s.hidden=!1,c.value=``,l.value=``,c.focus()),r===`cancel-add`&&(n.isAdding=!1,s.hidden=!0),r===`save-new`){let t=c.value.trim(),r=l.value.trim();if(!r){l.focus();return}Le(t||`Custom`,r).then(e=>{if(e)return n.isAdding=!1,s.hidden=!0,p()}).then(()=>e.onUpdate?.())}if(r===`add-templates`){let t=new Set((n.instructions??[]).map(e=>e.label.trim().toLowerCase())),r=_.filter(e=>!t.has(e.label.trim().toLowerCase()));if(!r.length){alert(`All templates are already added.`);return}ze(r.map(e=>({label:e.label,instruction:e.instruction,enabled:e.enabled}))).then(p).then(()=>e.onUpdate?.())}}),o.addEventListener(`change`,()=>{Pe(o.value||null).then(p).then(()=>e.onUpdate?.())}),p(),r}})),Et,Dt=e((()=>{o(),Tt(),Et=e=>t`<section class="card settings-tab-panel" data-tab-panel="instructions" data-section="instructions">
