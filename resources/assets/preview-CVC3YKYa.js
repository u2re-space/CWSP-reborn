import{n as e,r as t}from"./rolldown-runtime-DkW27tQK.js";import{d as n,u as r}from"./registry-Q3cayRgr.js";import{n as i,t as a}from"./preload-helper-DcjHEl26.js";import{t as o}from"./src-DpSa8Erd.js";import{a as s}from"./HistoryManager-B52KbQG4.js";import{i as c,r as l}from"./object-DpwBpfvO.js";import{s as u}from"./icon-BI41b7Mj.js";import{_ as d,g as f,n as p,t as m}from"./shells-BDG-l7Rw.js";var h;function g(){return(g=e((()=>{h=`/* Minimal shell: layered tokens + nav/content grid, WCO-safe, shadow slot views. */
/*
    ...
    .app-shell__status {
      display: none !important;
...
}`})))()}function _(e){return b.has(e)}function v(e){return new x}var y,b,x;function S(){return(S=e((()=>{o(),c(),g(),u(),p(),r(),d(),i(),y=[{id:`viewer`,name:`Markdown`,icon:`eye`},{id:`explorer`,name:`Explorer`,icon:`folder`},{id:`workcenter`,name:`Work Center`,icon:`lightning`},{id:`network`,name:`Network`,icon:`wifi-high`},{id:`settings`,name:`Settings`,icon:`gear`},{id:`history`,name:`History`,icon:`clock-counter-clockwise`}].filter(e=>n(e.id)),b=new Set(y.map(e=>e.id)),x=class extends m{id=`minimal`;name=`Minimal`;layout={hasSidebar:!1,hasToolbar:!0,hasTabs:!1,supportsMultiView:!1,supportsWindowing:!1};createLayout(){let e=s`
        ...
        `;return this.setupNavClickHandlers(e),this.setupConnectionSourceButton(e),this.setupAdminDoorButton(e),e}setupConnectionSourceButton(e){try{if(document.documentElement.dataset.cwspSurface!==`cwsp-control`)return}catch{return}let t=e.querySelector(`[data-shell-toolbar]`);if(!t||t.querySelector(`[data-connection-source]`))return;let n=s`
            ...
            >SRC</button>
        `;t.appendChild(n),n.addEventListener(`click`,()=>{try{window.dispatchEvent(new CustomEvent(`cwsp:open-connection-source`))}catch(e){console.warn(`[MinimalShell] connection source:`,e)}})}setupAdminDoorButton(e){let t=e.querySelector(`[data-shell-toolbar]`);if(!t||t.querySelector(`[data-admin-door]`))return;let n=s`
            <button
                type="button"
            ...
            >ADM</button>
        `;t.appendChild(n),n.addEventListener(`click`,()=>{a(async()=>{let{loadSettings:e}=await import(`./Settings-DJruQNwI.js`).then(e=>(e.a(),e.t));return{loadSettings:e}},[],import.meta.url).then(({loadSettings:e})=>e()).then(e=>a(async()=>{let{openAdminDoorFromCore:e}=await import(`./admin-doors-DkOVgiUY.js`).then(e=>(e.n(),e.t));return{openAdminDoorFromCore:e}},[],import.meta.url).then(({openAdminDoorFromCore:t})=>{t(e.core,`https`)})).catch(e=>console.warn(`[MinimalShell] admin door:`,e))})}renderNavButtons(){let e=document.createDocumentFragment();for(let t of y){let n=s`
                <button
