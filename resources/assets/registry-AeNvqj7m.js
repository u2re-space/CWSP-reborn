import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{$t as t,Qt as n,Rt as r,S as i,Tt as a,Zt as o,a as s,b as c,kt as l,rn as u}from"./HistoryManager-DVqS4qoS.js";import{t as ee}from"./src-DPHQSLwD.js";import{n as te,t as ne}from"./preload-helper-NDuSAHbO.js";import{A as d,M as f,k as re,t as p}from"./src-yMca1J0Q.js";import{n as ie}from"./CSSIconRegistry-D88SYH0A.js";import{t as m}from"./src-DUnEbC_E.js";function ae(e){return{load(){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}},save(t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}},clear(){try{localStorage.removeItem(e)}catch{}}}}var oe=e((()=>{})),h,g=e((()=>{h=`/**
 * Font Styles Index
 *
...
}`}));function se(e){if(typeof Uint8Array.fromBase64==`function`)return Uint8Array.fromBase64(e);let t=atob(e),n=new Uint8Array(t.length);for(let e=0;e<t.length;e++)n[e]=t.charCodeAt(e);return n}async function ce(e,t=`gzip`){if(typeof CompressionStream>`u`)throw Error(`Compression Streams API is not supported in this browser`);let n=new DecompressionStream(t),r=n.writable.getWriter(),i=n.readable.getReader();r.write(e),r.close();let a=[],o=!1;for(;!o;){let{value:e,done:t}=await i.read();o=t,e&&a.push(e)}let s=a.reduce((e,t)=>e+t.length,0),c=new Uint8Array(s),l=0;for(let e of a)c.set(e,l),l+=e.length;return c}async function le(e,t,n=`font/woff2`){if(_.has(t))return _.get(t);let r=new Blob([e],{type:n}),i=URL.createObjectURL(r);return _.set(t,i),i}async function ue(e){let{base64:t,family:n,style:r=`normal`,weight:i=`normal`,compressed:a=!1}=e,o=`${n}-${r}-${i}`;if(v.has(o))return v.get(o);let s=se(t),c=await le(a?await ce(s):s,o,a?`application/octet-stream`:`font/woff2`),l=new FontFace(n,`url(${c}) format('woff2')`,{style:r,weight:typeof i==`string`?i:`${i}`,display:`swap`});return await l.load(),document.fonts.add(l),v.set(o,l),l}async function de(e){let t=e.map(e=>ue(e));return Promise.all(t)}async function fe(){return y||(y=ne(()=>import(`./font-registry-D4KJRdpC.js`),[],import.meta.url)?.catch?.(e=>{console.error(`Failed to load font registry:`,e)}),y)}async function pe(){let e=await fe();return de(Object.values(e.fontRegistry))}var _,v,y,b=e((()=>{te(),_=new Map,v=new Map,y=null})),x,me=e((()=>{x=`@layer tokens, base, layout, utilities, shells, shell, views, view, viewer, components, ux-layer, markdown, essentials, print, print-breaks, overrides;
@layer components {
  button {
    display: inline-flex;
    align-items: center;
...
}`})),S,C,he=e((()=>{b(),r(),g(),me(),b(),S=`
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&display=swap');
`,C=async e=>{await o(S)?.catch(()=>void 0),await pe().catch(()=>void 0),await o(h)?.catch(()=>void 0),e?.includeGlobalNativeControls&&await o(x)?.catch(()=>void 0)}}));function w(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}var T=e((()=>{})),E,D,O=e((()=>{p(),m(),T(),E=class extends re(){theme=`default`;render=function(){return s`<slot></slot>`};constructor(){super()}onRender(){return super.onRender()}connectedCallback(){return super.connectedCallback?.()??this}onInitialize(){let e=super.onInitialize()??this;return e.loadStyleLibrary(ie()),e}},w([f({source:`attr`})],E.prototype,`theme`,void 0),E=w([d(`ui-element`)],E),D=E})),k,ge=e((()=>{k=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
/* ==========================================================================
...
}`})),A,j,_e=e((()=>{O(),p(),ge(),r(),T(),A=t(k),j=class extends D{constructor(){super()}styles=()=>A;render=()=>s`
<div style="background-color: transparent;" part="left"   class="left"  ><slot name="left"  ></slot></div>
        ...
        <div style="background-color: transparent;" part="right"  class="right" ><slot name="right" ></slot></div>`},j=w([d(`ui-statusbar`)],j)})),M,ve=e((()=>{M=`/* Taskbar */
@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
...
}`})),N,P,F=e((()=>{O(),p(),ve(),r(),T(),N=t(M),P=class extends D{constructor(){super()}styles=()=>N;render=()=>s`<div part="taskbar" class="taskbar"><slot></slot></div>`},P=w([d(`ui-taskbar`)],P)})),I,ye=e((()=>{I=`@function --hsv(--src-color <color>) returns <color> {
  result: hsl(from var(--src-color, black) h calc(calc((calc(l / 100) - calc(calc(l / 100) * (1 - calc(s / 100) / 2))) / clamp(0.0001, min(calc(calc(l / 100) * (1 - calc(s / 100) / 2)), calc(1 - calc(calc(l / 100) * (1 - calc(s / 100) / 2)))), 1)) * 100) calc(calc(calc(l / 100) * (1 - calc(s / 100) / 2)) * 100) / alpha);
}
/* ai-refactor: optimized/refactored at 2026-02-13T02:50:43Z */
/* ==========================================================================
...
:host(ui-task:not([data-active])) {
  opacity: 0.6;
}`})),L,R,be=e((()=>{O(),r(),p(),ye(),T(),L=t(I),R=class extends D{title=`Task`;icon=`github`;constructor(){super()}styles=()=>L;render=function(){return s`
        ...
        `}},w([f({source:`attr`})],R.prototype,`title`,void 0),w([f({source:`attr`})],R.prototype,`icon`,void 0),R=w([d(`ui-task`)],R)})),z,xe=e((()=>{z=`ui-taskbar[data-type=desktop] > ui-task[data-focus] {
...
:host(ui-taskbar[data-type=desktop]) ::slotted(ui-task[data-focus]) {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}`})),Se=e((()=>{r(),xe(),t(z)})),B,Ce=e((()=>{B=`ui-taskbar[data-type=mobile] > ui-task[data-focus] {
  background: --c2-surface(0, var(--current));
  color: --c2-on-surface(0, var(--current));
}
 ...
 * Reason for changes: High-quality ui-window chrome with light/dark tokens and control buttons.
 */
...
:host(ui-window[minimized]) {
  block-size: var(--ui-win-titlebar-height);
...
/* WHY: wrap ui-icon — it sets display:grid !important unlayered, which beats host-layer rules. */
.title-maximize .icon-restore {
  display: none !important;
}

:host([maximized]) .title-maximize .icon-maximize {
  display: none !important;
}

:host([maximized]) .title-maximize .icon-restore {
...
.content-handler {
  ...
  min-inline-size: 0;
  overflow: auto;
  padding: var(--ui-win-pad-block) var(--ui-win-pad-inline);
...
.window-resizer:hover {
  opacity: 0.9;
}`})),H,U,W,G,K,q,Ee=e((()=>{p(),r(),O(),m(),Te(),T(),H=t(V),U=`minus`,W=`corners-out`,G=`corners-in`,K=`x`,q=class extends E{titleHandler;contentHandler;footerHandler;#e=l(0);#t=l(0);#n=null;styles=function(){return H};render=function(){return s`<div class="window-container" part="window-container">
            <header class="title-handler" part="title-handler">
                ...
                <div class="title-handler-buttons" part="controls">
                    <button class="title-minimize" type="button" aria-label="Minimize" title="Minimize">
                        <ui-icon icon=${U}></ui-icon>
                    </button>
                    <button class="title-maximize" type="button" aria-label="Maximize" title="Maximize">
                        <span class="icon-maximize" aria-hidden="true"><ui-icon icon=${W}></ui-icon></span>
                        <span class="icon-restore" aria-hidden="true"><ui-icon icon=${G}></ui-icon></span>
                    </button>
                    <button class="title-close" type="button" aria-label="Close" title="Close">
                        <ui-icon icon=${K}></ui-icon>
                    </button>
                </div>
            </header>
        ...
        </div>`};constructor(){super()}onInitialize(){super.onInitialize()}onRender(){super.onRender(),this.style.display||=`block`,queueMicrotask(()=>{this.#r(),this.#i()})}toggleMaximize(){let e=!this.hasAttribute(`maximized`);this.toggleAttribute(`maximized`,e),e&&this.removeAttribute(`minimized`),this.dispatchEvent(new CustomEvent(e?`window-maximize`:`window-restore`,{bubbles:!0}))}toggleMinimize(){let e=!this.hasAttribute(`minimized`);this.toggleAttribute(`minimized`,e),e&&this.removeAttribute(`maximized`),this.dispatchEvent(new CustomEvent(e?`window-minimize`:`window-restore`,{bubbles:!0}))}closeWindow(){this.dispatchEvent(new CustomEvent(`window-close`,{bubbles:!0,cancelable:!0}))&&this.remove()}#r(){this.dataset?.flWinControls!==`1`&&(this.dataset.flWinControls=`1`,u(this,`click`,e=>{let t=e.target;if(!t)return;let n=typeof e.composedPath==`function`?e.composedPath():[],r=e=>t.closest?.(e)||n.find(t=>t instanceof Element&&t.matches?.(e));if(r(`.title-close`)){e.preventDefault(),this.closeWindow();return}if(r(`.title-maximize`)){e.preventDefault(),this.toggleMaximize();return}r(`.title-minimize`)&&(e.preventDefault(),this.toggleMinimize())}))}#i(){let e=this.shadowRoot??this,t=this.titleHandler??e.querySelector?.(`.title-handler`);if(!t||this.#n)return;let n=new Map;i(this,c`transform: translate(${this.#e}px, ${this.#t}px)`);let r=u(t,`pointerdown`,e=>{if(e.button!==0||e.target?.closest(`button, a, input, textarea, select, [data-no-drag]`)||this.hasAttribute(`maximized`))return;e.preventDefault(),this.setPointerCapture?.(e.pointerId),n.set(e.pointerId,{sx:e.clientX,sy:e.clientY,ox:this.#e.value,oy:this.#t.value});let t=u(document.body,`pointermove`,e=>{let t=n.get(e.pointerId);t&&(this.#e.value=t.ox+(e.clientX-t.sx),this.#t.value=t.oy+(e.clientY-t.sy))}),r=e=>{if(n.has(e.pointerId)){n.delete(e.pointerId);try{this.releasePointerCapture?.(e.pointerId)}catch{}t?.(),i?.(),a?.()}},i=u(document.body,`pointerup`,r),a=u(document.body,`pointercancel`,r)});this.#n=()=>{r?.()}}},w([f({source:`query`,name:`.title-handler`})],q.prototype,`titleHandler`,void 0),w([f({source:`query`,name:`.content-handler`})],q.prototype,`contentHandler`,void 0),w([f({source:`query`,name:`.footer-handler`})],q.prototype,`footerHandler`,void 0),q=w([d(`ui-window`)],q)})),De=e((()=>{p()})),J=e((()=>{})),Oe=e((()=>{a(),p()})),ke=e((()=>{O(),_e(),F(),be(),Se(),we(),Ee(),De(),J(),Oe()}));function Ae(){return{...Y}}var Y,je=e((()=>{r(),g(),he(),ke(),Y={loadStyles:!0,includeGlobalNativeControlStyles:!1,styleVariant:`veela-basic`},(async()=>{let e=Ae();e.loadStyles!==!1&&(await C({includeGlobalNativeControls:e.includeGlobalNativeControlStyles===!0}),await n(h))})()?.catch?.(()=>void 0)}));function Me(e,t){let n=e??{},r=t??{};return{...n,...r,lifecycle:{...n.lifecycle,...r.lifecycle}}}function X(e,t,n){let r=Object.getOwnPropertyDescriptor(e,t),i=r?.value;Object.defineProperty(e,t,{configurable:!0,enumerable:r?.enumerable??!0,writable:!0,value:function(...e){let t=i?.apply(this,e),r=n.apply(this,e);return r===void 0?t??this:r}})}function Ne(e,t){for(let n of[`onInitialize`,`onMount`,`onUnmount`,`onShow`,`onHide`]){let r=t[n];typeof r==`function`&&X(e,n,r)}}function Pe(e,t){let n=e.prototype;t.initialization&&X(n,`onInitialize`,t.initialization),t.rendering&&X(n,`onRender`,t.rendering),t.render&&X(n,`render`,t.render),t.styles&&X(n,`styles`,t.styles),t.lifecycle&&Ne(n,t.lifecycle)}var Z,Q,$,Fe=e((()=>{ee(),je(),p(),T(),Z=new Map,Q=class extends E{__options;__initialized=!1;__viewChannel=null;set options(e){this.__options=e}get options(){return this.__options}get viewChannel(){return this.__viewChannel||=new EventTarget,this.__viewChannel}dispatchViewChannel(e,t,n){return this.viewChannel.dispatchEvent(new CustomEvent(e,{...n,detail:t}))}subscribeViewChannel(e,t){let n=this.viewChannel;return n.addEventListener(e,t),()=>n.removeEventListener(e,t)}viewInitialize(){let e=this.options;return e?.initializator?.call?.(this,this,e),this}constructor(){super()}onInitialize(){return super.onInitialize?.call?.(this),this?.viewInitialize?.call?.(this),this}},Q=w([d(`cw-view-base`)],Q),$=(e,t,n)=>{let r=typeof t==`function`?n??{}:Me(t,n??{}),i=r.extends?{extends:r.extends}:void 0,a;if(typeof t==`function`)a=t(Q);else{class e extends Q{constructor(){super()}}a=e}return d(e,i)(a),Pe(a,r),Z.set(e,a),a}}));export{oe as i,Fe as n,ae as r,$ as t};