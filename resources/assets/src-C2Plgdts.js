import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{J as t,Mt as n,a as r,ft as i,nt as a,tt as o}from"./HistoryManager-D8ebz2Z7.js";import{a as s}from"./registry-D523OM5k.js";import{n as c,t as l}from"./preload-helper-NDuSAHbO.js";import{n as u,t as d}from"./templates-Cp6qXLQ6.js";import{a as f,d as p}from"./UnifiedMessaging-pXaB9ut5.js";import{f as m,m as h,n as g,p as _,t as v}from"./views-CgiS38xE.js";import{a as ee,i as y,r as b}from"./BootLoader-BkqEEgZE.js";import{B as te,K as ne}from"./airpad-cwsp-client-parity-CXnZuSSw.js";import{t as x}from"./src-fiZCSwG5.js";import{a as re,i as ie,r as S,t as ae}from"./SettingsTypes-D6q9S6cT.js";import{t as C,v as oe}from"./remote-connection-runtime-DMQizJyk.js";import{a as se,c as ce,i as le,n as w,o as ue,r as de,s as fe}from"./Settings-DQArF03Y.js";import{n as pe,r as me}from"./Theme-BHjr86YO.js";import{n as he,r as ge}from"./capacitor-permissions-Brl6YLsA.js";import{a as _e,c as T,d as ve,f as E,i as ye,l as be,n as D,o as O,p as xe,r as Se,s as Ce,t as we,u as Te}from"./cwsp-app.js";import{a as Ee,i as De,n as Oe,r as ke}from"./shells-BG_WhheP.js";import{i as Ae,n as je,r as Me}from"./admin-doors-BoU4RSfd.js";import{c as Ne,i as Pe,l as Fe,n as Ie,o as Le,r as Re,s as ze}from"./CustomInstructions-B1_0ILm4.js";import{i as Be,n as Ve}from"./registry-BYiZ4l9x.js";import{a as He,r as Ue}from"./channel-actions-DC9DgSYV.js";var We=e((()=>{})),k,Ge,A,j,M,N=e((()=>{We(),k=`data-settings-view-css`,Ge=e=>{let t=String(e||``).trim();t=t.replace(/^(@charset\s+[^;]+;\s*)+/i,``);for(let e=0;e<8;e++){let e=t.replace(/^\/\*[\s\S]*?\*\/\s*/,``);if(e===t)break;t=e.trim()}let n=t.match(/^@layer\s+settings-view\s*\{([\s\S]*)\}\s*$/);return n&&(t=n[1].trim()),t},A=`
...
@layer settings-view {
  ...
  .view-settings {
    ...
    --sv-primary: var(--color-primary, #5a7fff);
    /*
    ...
    --sv-accent: light-dark(
        --u2-color-mod(var(--sv-primary), 550),
        --u2-color-mod(var(--sv-primary), 400)
    );
    --sv-on-primary: var(
        --color-on-primary,
        light-dark(
            --u2-color-mod(var(--sv-primary), 40),
            --u2-color-mod(var(--sv-primary), 940)
        )
    );
  ...
  .view-settings .settings-tab-btn.is-active {
    ...
    box-shadow: 0 2px 16px color-mix(in oklab, var(--sv-accent, var(--sv-primary)) 42%, transparent), 0 0 0 1px color-mix(in oklab, var(--sv-accent, var(--sv-primary)) 55%, transparent);
  }
  .view-settings {
    /*
  ...
  .view-settings .btn.primary {
    background: var(--sv-accent, var(--sv-primary));
    color: var(--sv-on-primary);
    box-shadow: 0 2px 16px color-mix(in oklab, var(--sv-accent, var(--sv-primary)) 40%, transparent), 0 0 0 1px color-mix(in oklab, var(--sv-accent, var(--sv-primary)) 55%, transparent);
  }
        ...
        <textarea class="form-input" rows="10" data-field="appearance.markdown.extensions" placeholder='[
  {
    ...
    </section>`})),wt,Tt=e((()=>{x(),t(),ze(),u(),wt=(e={})=>{let t=o({instructions:[],activeId:``,editingId:null,newLabel:``,newInstruction:``,isAdding:!1}),n=r`<div class="custom-instructions-editor">
        <div class="ci-row">
            <div class="ci-header">
        ...
        <div class="ci-actions">
            ...
            <button class="btn small" type="button" data-action="add-templates">Add Templates</button>
                ...
                ${n?r`<div class="ci-edit-form">
                    ...
                    </div>`:r`<div class="ci-item-preview">${p(a.instruction,120)}</div>`}
            </div>`;s.addEventListener(`click`,n=>{let r=n.target.closest(`[data-action]`)?.getAttribute(`data-action`);if(r===`activate`&&Ne(a.id).then(m).then(()=>e.onUpdate?.()),r===`edit`&&(t.editingId=a.id,u()),r===`delete`&&confirm(`Delete "${a.label}"?`)&&Pe(a.id).then(m).then(()=>e.onUpdate?.()),r===`save-edit`){let n=s.querySelector(`[data-edit-field='label']`),r=s.querySelector(`[data-edit-field='instruction']`);Fe(a.id,{label:n.value.trim()||a.label,instruction:r.value.trim()}).then(()=>(t.editingId=null,m())).then(()=>e.onUpdate?.())}r===`cancel-edit`&&(t.editingId=null,u())}),i.append(s)}},f=()=>{a.replaceChildren(),a.append(r`<option value="">None (use default)</option>`);for(let e of t.instructions??[]){let n=r`<option value="${e.id}">${e.label}</option>`;e.id===t.activeId&&(n.selected=!0),a.append(n)}},p=(e,t)=>!e||e.length<=t?e||``:e.slice(0,t).trim()+`…`,m=async()=>{let e=await Le(),n=Array.isArray(e)?{instructions:e,activeId:``,activeInstruction:null}:e;t.instructions=n?.instructions??[],t.activeId=n?.activeId??``,u(),f()};return n.addEventListener(`click`,n=>{let r=n.target.closest(`[data-action]`)?.getAttribute(`data-action`);if(r===`add`&&(t.isAdding=!0,s.hidden=!1,c.value=``,l.value=``,c.focus()),r===`cancel-add`&&(t.isAdding=!1,s.hidden=!0),r===`save-new`){let n=c.value.trim(),r=l.value.trim();if(!r){l.focus();return}Ie(n||`Custom`,r).then(e=>{if(e)return t.isAdding=!1,s.hidden=!0,m()}).then(()=>e.onUpdate?.())}if(r===`add-templates`){let n=new Set((t.instructions??[]).map(e=>e.label.trim().toLowerCase())),r=d.filter(e=>!n.has(e.label.trim().toLowerCase()));if(!r.length){alert(`All templates are already added.`);return}Re(r.map(e=>({label:e.label,instruction:e.instruction,enabled:e.enabled}))).then(m).then(()=>e.onUpdate?.())}}),a.addEventListener(`change`,()=>{Ne(a.value||null).then(m).then(()=>e.onUpdate?.())}),m(),n}})),Et,Dt=e((()=>{x(),Tt(),Et=e=>r`<section class="card settings-tab-panel" data-tab-panel="instructions" data-section="instructions">
