import{n as e}from"./rolldown-runtime-C0FnF6B9.js";import{B as t,R as n,Rt as r,b as i,ft as a,nn as o,r as s,t as c,z as l}from"./src-C8p-yYHh.js";import{n as u,t as d}from"./preload-helper-DFTwEg7x.js";import{a as f,d as p,p as m}from"./UniformInterop-Dxklp0q4.js";import{a as h,c as g,i as ee,n as te,o as _,p as v,r as ne,s as y}from"./UnifiedMessaging-D97RqiW3.js";import{r as b,t as re}from"./view-inbound-timing-CxhYQUp2.js";import{a as ie,i as ae,n as oe,r as se,t as x}from"./view-ingress-validation-pEGxQ7HC.js";import{a as S,i as ce}from"./ShareTargetGateway-By2ahyX6.js";import{a as le,o as ue}from"./Settings-BdjZKlQM.js";import{a as de,i as C,n as w,o as fe,r as pe,s as T,t as me}from"./icon-CJpUOiBC.js";var he;function E(){return(E=e((()=>{he=`@layer layout {
  /*
...
}`})))()}var D,O,k,A,ge,j,M,N,P,F,I,L,R,z,B,V,H,U,_e,W;function G(){return(G=e((()=>{c(),T(),h(),x(),re(),l(),m(),r(),le(),S(),E(),u(),D={SHARE_TARGET:f.SHARE_TARGET,TOAST:f.TOAST,CLIPBOARD:f.CLIPBOARD,MINIMAL_APP:f.MINIMAL_APP,MAIN_APP:f.MAIN_APP,FILE_EXPLORER:f.FILE_EXPLORER,PRINT_VIEWER:f.PRINT_VIEWER},O={get:(e,t=``)=>{try{return localStorage.getItem(e)||t}catch{return t}},set:(e,t)=>{try{localStorage.setItem(e,t)}catch{}}},k=async(e,t,n={componentName:e})=>{try{return await s(e,t,n)}catch(t){throw console.error(`Failed to load ${e}:`,t),t}},A=!1,ge=`rs-history`,j=`rs-last-src`,M=`# CWSP-shell (Basic)

Open a markdown file or paste content here.
`,N=/\.(?:md|markdown|mdown|mkd|mkdn|mdtxt|mdtext)(?:$|[?#])/i,P={"#viewer":`markdown-viewer`,"#editor":`markdown-editor`,"#workcenter":`workcenter`,"#settings":`settings`,"#history":`history`,"#explorer":`file-explorer`,"#rich-editor":`rich-editor`,"#share-target-text":`workcenter`,"#share-target-files":`workcenter`,"#share-target-url":`workcenter`,"#share-target-image":`workcenter`},F={"markdown-viewer":`#viewer`,"markdown-editor":`#editor`,workcenter:`#workcenter`,settings:`#settings`,history:`#history`,"file-explorer":`#explorer`,"rich-editor":`#rich-editor`},I={viewer:`markdown-viewer`,editor:`markdown-editor`,"rich-editor":`rich-editor`,workcenter:`workcenter`,settings:`settings`,history:`history`,explorer:`file-explorer`},L=()=>{if(typeof window>`u`)return null;let e=(globalThis?.location?.pathname||``).replace(/^\/+|\/+$/g,``).toLowerCase();return e&&I[e]||null},R=()=>O.get(j),z=e=>O.set(j,e),B=()=>{try{return typeof chrome<`u`&&!!chrome?.runtime?.id&&globalThis?.location?.protocol===`chrome-extension:`}catch{return!1}},V=()=>{if(typeof window>`u`)return null;let e=globalThis?.location?.hash;return P[e]||null},H=e=>{if(typeof window>`u`)return;let t=F[e];t&&globalThis?.history?.replaceState?.(null,``,t)},U=(e,t)=>{let n=typeof window<`u`&&globalThis?.matchMedia?.(`(prefers-color-scheme: dark)`)?.matches,r=t===`dark`?`dark`:t===`light`?`light`:n?`dark`:`light`;e.dataset.theme=r;try{e.style.colorScheme=r}catch{}},_e=async e=>{let t=e.trim();if(!t)return null;try{let e=new URL(t);if(!N.test(e.pathname))return null;let n=await fetch(e.href,{credentials:`include`,cache:`no-store`});return n.ok?await n.text():null}catch{return null}},W=(e,r={})=>{o(he);let c=a`<div class="app-shell" />`;e.replaceChildren(c);try{let e=fe();C(),console.log(`[Icons] Initialized stylesheet:`,e)}catch(e){console.error(`[Icons] Failed to initialize stylesheet:`,e)}typeof window<`u`&&typeof window<`u`&&(globalThis.clearIconCaches=()=>{w(),me().catch(console.error),console.log(`[Debug] Icon caches cleared`)},globalThis.invalidateIconCache=w,globalThis.testIconRacing=pe,globalThis.reinitializeIconRegistry=C,globalThis.debugIconSystem=de);let l=B(),u=i({onFilesAdded:e=>{for(let t of e){let e=t.type?.startsWith(`text/`)?`text`:t.type?.startsWith(`image/`)?`image`:t.name?.toLowerCase().endsWith(`.md`)?`markdown`:`file`,n=T.view===`workcenter`?`drag-drop`:(T.view,`file-open`);y({content:{file:t,filename:t.name,type:t.type},contentType:e,context:n,source:`manual`,metadata:{title:`File: ${t.name}`,filename:t.name,mimeType:t.type}}).then(()=>{E(`Processed ${t.name}`)}).catch(e=>{console.warn(`[Main] Failed to process file ${t.name}:`,e),E(`Failed to process ${t.name}`)})}},onError:e=>{E(`File error: ${e}`)}}),f=n(),m=globalThis?.localStorage?.getItem?.(`rs-markdown`)||r.initialMarkdown,h=L(),re=r.initialView||h||(m?`markdown-viewer`:`file-picker`),x=e=>{let t=String(e?.type||``).trim().toLowerCase();return t===`content-attach`||t===`file-attach`},S=async(e,t,n,r,i,a=!1)=>{if(A){console.log(`[Shell] Work center attachment already in progress, ignoring duplicate request`);return}A=!0;try{t.view!==`workcenter`&&(t.view=`workcenter`,n(`workcenter`));let o=[];try{if(e.data.file instanceof File)o.push(e.data.file);else if(Array.isArray(e.data.files)){let t=e.data.files.filter(e=>e instanceof File);t.length>0&&o.push(...t)}else if(e.data.blob instanceof Blob){let t=e.data.filename||`attachment-${Date.now()}.${e.contentType===`markdown`?`md`:`txt`}`;o.push(new File([e.data.blob],t,{type:e.data.blob.type}))}else if(e.data.text||e.data.content){let t=e.data.text||e.data.content,n=typeof t==`string`?t:JSON.stringify(t,null,2),r=e.data.filename||`content-${Date.now()}.${e.contentType===`markdown`?`md`:`txt`}`,i=e.contentType===`markdown`?`text/markdown`:`text/plain`;o.push(new File([n],r,{type:i})),console.log(`[Shell] Created file for attachment:`,{filename:r,mimeType:i,size:n.length})}}catch(e){console.warn(`[Shell] Failed to create file from message data:`,e),i(`Failed to process content`);return}if(o.length===0){console.warn(`[Shell] No valid file content found in message`);return}a||r();for(let e of o)await le(e,t,i)}finally{A=!1}},le=async(e,t,n)=>{try{if(t.managers.workCenter.instance){t.managers.workCenter.instance.getState().files.push(e),t.managers.workCenter.instance.ui.updateFileList(t.managers.workCenter.instance.getState()),t.managers.workCenter.instance.ui.updateFileCounter(t.managers.workCenter.instance.getState()),n(`Attached ${e.name} to Work Center`);return}let r=0;for(;!t.managers.workCenter.instance&&r<50;)await new Promise(e=>setTimeout(e,100)),r++;if(t.managers.workCenter.instance)t.managers.workCenter.instance.getState().files.push(e),t.managers.workCenter.instance.ui.updateFileList(t.managers.workCenter.instance.getState()),t.managers.workCenter.instance.ui.updateFileCounter(t.managers.workCenter.instance.getState()),n(`Attached ${e.name} to Work Center`);else throw Error(`Work center failed to load`)}catch(e){console.warn(`[Shell] Failed to attach content to workcenter:`,e),n(`Failed to attach content`)}},T={view:re,markdown:typeof r.initialMarkdown==`string`?r.initialMarkdown:localStorage.getItem(`rs-markdown`)??M,editing:!1,busy:!1,message:``,history:[],lastSavedTheme:`auto`,services:{fileHandler:u,templateManager:f},managers:{workCenter:{instance:null,initialized:!1},history:{instance:null}},components:{settings:{view:null},markdown:{viewer:null,editor:null},quill:{editor:null},explorer:{element:null}}},E=(e,t=3e3)=>{T.message=e,setTimeout(()=>{T.message===e&&J()},0),setTimeout(()=>{T.message===e&&(T.message=``,J())},t)},O=async(e,t)=>{let n=e?.data&&typeof e.data==`object`?e.data:{},r=String(e?.type||``),i=r===`content-load`||r===`content-view`||r===`markdown-content`;if(!i)return!1;let a=ae(e,r);if(!a.ok)return console.warn(`[Shell] Markdown hydrator skipped:`,a.reason),!1;let o=e?.metadata&&typeof e.metadata==`object`?e.metadata:{},s=typeof o.source==`string`?o.source:``,c=typeof o.route==`string`?o.route:``,l=s.includes(`launch-queue`)||c.includes(`launch-queue`),u=e=>{let t=(e.name||``).toLowerCase(),n=(e.type||``).toLowerCase();return!n||n.startsWith(`text/`)||n.includes(`markdown`)||n.includes(`json`)||n.includes(`xml`)?!0:[`.md`,`.markdown`,`.mdown`,`.mkd`,`.mkdn`,`.txt`,`.html`,`.htm`].some(e=>t.endsWith(e))},d=typeof n.filename==`string`&&n.filename.trim().length>0?String(n.filename).trim():typeof n.hint?.filename==`string`?String(n.hint.filename).trim():void 0,f=n.file instanceof File?n.file:null,p=Array.isArray(n.files)?n.files.filter(e=>e instanceof File):[];if(p.length>0&&(f=oe(p,{hintFilename:d,isTextLike:u})??f),f){let e=ie(f);e.ok||(console.warn(`[Shell] Ingress file skipped:`,e.reason,f.name),f=null)}let m=l&&!!(f&&u(f));if(i&&f&&u(f)){try{let e=await f.text();if(t!==P)return!1;if(typeof e==`string`)return e.trim().length===0?!1:se(e)?(T.markdown=`> Received content does not look like UTF-8 text/markdown (binary or unsupported format).
...
`,!0):(T.markdown=e,!0)}return!1},j=new Map,N=(e,t)=>{let n=(j.get(e)??Promise.resolve()).then(()=>t()).catch(t=>console.warn(`[Shell] Minimal ingress failed:`,e,t));return j.set(e,n),n},P=0;if(v.registerHandler(`markdown-viewer`,{canHandle:e=>e.destination===`markdown-viewer`,handle:async e=>{let t=++P;await N(`markdown-surface`,async()=>{t===P&&(await b(),t===P&&await O(e,t)&&(T.view=`markdown-viewer`,F(),$()))})}}),v.registerHandler(`viewer`,{canHandle:e=>e.destination===`viewer`,handle:async e=>{let t=++P;await N(`markdown-surface`,async()=>{t===P&&(await b(),t===P&&await O(e,t)&&(T.view=`markdown-viewer`,H(`markdown-viewer`),F(),$(),E(`Content loaded in viewer`)))})}}),v.registerHandler(`workcenter`,{canHandle:e=>e.destination===`workcenter`,handle:async e=>{await N(`workcenter`,async()=>{await b();let t=T.managers?.workCenter?.instance;if(t){try{x(e)?await S(e,T,H,$,E,!0):t?.handleExternalMessage&&await t.handleExternalMessage(e)}catch(e){console.error(`[Shell] WorkCenter message handling failed:`,e)}return}try{ne(`workcenter`,e)}catch(e){console.warn(`[Shell] Failed to enqueue pending workcenter message:`,e)}T.view!==`workcenter`&&(T.view=`workcenter`,H(`workcenter`),$())})}}),v.registerHandler(`explorer`,{canHandle:e=>e.destination===`explorer`,handle:async e=>{await N(`explorer`,async()=>{await b(),T.view!==`file-explorer`&&(T.view=`file-explorer`,H(`file-explorer`),$()),await new Promise(t=>{setTimeout(async()=>{try{let t=e.data?.action||`save`,n=e.data?.path||e.data?.into||`/`;if(t===`save`&&(e.data?.file||e.data?.text||e.data?.content)){let t=null;if(e.data.file instanceof File)t=e.data.file;else if(e.data.blob instanceof Blob){let n=e.data.filename||`file-${Date.now()}`;t=new File([e.data.blob],n,{type:e.data.blob.type})}else if(e.data.text||e.data.content){let n=e.data.text||e.data.content,r=typeof n==`string`?n:JSON.stringify(n,null,2),i=e.data.filename||`content-${Date.now()}.txt`;t=new File([r],i,{type:`text/plain`})}t&&T.components.explorer.element&&(n&&n!==T.components.explorer.element.path&&(T.components.explorer.element.path=n),console.log(`[Shell] Saving file ${t.name} to Explorer at: ${n}`),T.message=`Saved ${t.name} to Explorer`,J(),setTimeout(()=>{T.message=``,J()},3e3))}else if(t===`view`&&e.data?.path)T.components.explorer.element&&n&&(T.components.explorer.element.path=n,console.log(`[Shell] Navigated Explorer to path: ${n}`),T.message=`Opened Explorer at ${n}`,J(),setTimeout(()=>{T.message=``,J()},2e3));else if(t===`place`&&e.data?.place&&e.data?.into){let t=e.data.into;T.components.explorer.element&&t&&(T.components.explorer.element.path=t,console.log(`[Shell] Navigated Explorer to place data at: ${t}`),T.message=`Explorer ready at ${t}`,J(),setTimeout(()=>{T.message=``,J()},3e3))}else t===`navigate`&&n&&T.components.explorer.element&&(T.components.explorer.element.path=n,T.message=`Explorer navigated to ${n}`,J(),setTimeout(()=>{T.message=``,J()},2e3))}catch(e){console.warn(`[Shell] Failed to handle explorer action:`,e),T.message=`Failed to perform Explorer action`,J(),setTimeout(()=>{T.message=``,J()},3e3)}finally{t()}},100)})})}}),v.registerHandler(`print`,{canHandle:e=>e.destination===`print`,handle:async e=>{await N(`print`,async()=>{if(await b(),e.data?.text||e.data?.content){let t=e.data.text||e.data.content,n=typeof t==`string`?t:JSON.stringify(t,null,2),r=globalThis?.open?.(``,`_blank`,`width=800,height=600`);r&&(r.document.write(`
      ...
      <div class="left">
        ...
        <button class="btn ${T.view===`workcenter`?`active`:``}" data-action="view-workcenter" type="button" title="AI Work Center">
          ...
          ${T.managers.workCenter.instance&&T.managers.workCenter.instance.getState().files.length>0?a`<span class="workcenter-badge" title="${T.managers.workCenter.instance.getState().files.length} files ready for processing">${T.managers.workCenter.instance.getState().files.length}</span>`:``}
        </button>
      ...
      <div class="right">
        ${t?a`<button class="btn btn-icon" data-action="open-md" type="button" title="Open Markdown File">
        ...
        ${e?a`<button class="btn" data-action="voice" type="button" title="Voice Input">
          <ui-icon icon="microphone" icon-style="duotone"></ui-icon>
          <span>Voice</span>
        </button>`:``}
        ${n?a`<button class="btn" data-action="process-content" type="button" title="Process Content">
        ...
        ${l?a`<button class="btn" data-action="snip" type="button" title="Screen Capture">
          <ui-icon icon="camera" icon-style="duotone"></ui-icon>
          <span>Snip</span>
        </button>`:``}
      </div>
    </div>`},G=W(),ve=a`<div class="status" aria-live="polite"></div>`,K=a`<div class="content"></div>`;c.append(G,K);let q=a`<input class="file-input" type="file" accept=".md,text/markdown,text/plain" />`;q.style.display=`none`,c.append(q),T.services.fileHandler.setupCompleteFileHandling(c,a`<button style="display:none">File Select</button>`,void 0,`*`);let J=()=>{ve.textContent=T.message||(T.busy?`Working…`:``),c.toggleAttribute(`data-busy`,T.busy)},ye=async()=>{let e=a`<div class="component-loading">
      <div class="loading-spinner"></div>
      <span>Loading Markdown Viewer...</span>
    </div>`;K.append(e);try{let t=(await s(`markdown-viewer`,()=>d(()=>import(`./_cwsp-disabled-entry_view-viewer-eo9jCha0.js`),[],import.meta.url),{componentName:`MarkdownViewer`})).component.createMarkdownView({content:T.markdown||M,title:`Markdown Viewer`,onOpen:()=>{q.click()},onCopy:e=>{T.message=`Content copied to clipboard`,J(),setTimeout(()=>{T.message=``,J()},2e3)},onDownload:e=>{T.message=`Content downloaded as markdown file`,J(),setTimeout(()=>{T.message=``,J()},2e3)},onAttachToWorkCenter:async e=>{try{let t=te(`content-share`,`main-app`,`markdown`,{text:e,filename:`content-${Date.now()}.md`},[`explicit-workcenter`],`button-attach-workcenter`);t.metadata={title:`Content from Viewer`,timestamp:Date.now(),source:`markdown-viewer`},await v.sendMessage(t)}catch(e){e instanceof Error&&e.message.includes(`throttled`)?console.log(`[Main] Message creation throttled - ignoring duplicate action`):(console.error(`[Main] Failed to create attach message:`,e),E(`Failed to attach content - please wait a moment`))}},onPrint:async e=>{await v.sendMessage({id:crypto.randomUUID(),type:`content-print`,source:`viewer`,destination:`print`,contentType:`markdown`,data:{text:e,filename:`print-${Date.now()}.md`},metadata:{title:`Print Content`,timestamp:Date.now(),source:`markdown-viewer`}})}}),n=t.render();u.setupDragAndDrop(n),u.setupPasteHandling(n),g(`markdown-viewer`,`viewer`);let r=_(`markdown-viewer`),i=!1;for(let e of r){let t=e;if(console.log(`[Viewer] Processing pending message:`,t),t.data?.text||t.data?.content){let e=t.data.text||t.data.content;T.markdown=typeof e==`string`?e:JSON.stringify(e,null,2),F(),i=!0}}return i&&(t?.updateContent?.(T.markdown),E(`Content loaded in viewer`)),e.replaceWith(n),n}catch(t){console.error(`Failed to load markdown viewer:`,t);let n=a`<div class="component-error">
        <h3>Failed to load Markdown Viewer</h3>
        <p>Please try refreshing the page.</p>
      </div>`;return e.replaceWith(n),n}},be=async()=>{let e=a`<div class="component-loading">
      <div class="loading-spinner"></div>
      <span>Loading Markdown Editor...</span>
    </div>`;K.append(e);try{let t=(await s(`markdown-editor`,()=>d(()=>import(`./MarkdownEditor-Bsq5p7Ep.js`),[],import.meta.url),{componentName:`MarkdownEditor`})).component.createMarkdownEditor({initialContent:T.markdown||``,onContentChange:e=>{T.markdown=e,F()},onSave:e=>{T.markdown=e,F(),T.message=`Content saved`,J(),setTimeout(()=>{T.message=``,J()},2e3)},placeholder:`Start writing your markdown here...`,autoSave:!0,autoSaveDelay:2e3}),n=t.render();g(`markdown-editor`,`markdown-editor`);let r=_(`markdown-editor`),i=!1;for(let e of r){let t=e;if(console.log(`[Editor] Processing pending message:`,t),t.data?.text||t.data?.content){let e=t.data.text||t.data.content;T.markdown=typeof e==`string`?e:JSON.stringify(e,null,2),F(),i=!0}}return i&&(t?.updateContent?.(T.markdown),E(`Content loaded in editor`)),e.replaceWith(n),n}catch(t){console.error(`Failed to load markdown editor:`,t);let n=a`<div class="component-error">
        <h3>Failed to load Markdown Editor</h3>
        <p>Please try refreshing the page.</p>
      </div>`;return e.replaceWith(n),n}},xe=async()=>{let e=a`<div class="component-loading">
      <div class="loading-spinner"></div>
      <span>Loading Rich Editor...</span>
    </div>`;K.append(e);try{let t=(await s(`quill-editor`,()=>d(()=>import(`./QuillEditor-CQ0s3EGZ.js`),[],import.meta.url),{componentName:`QuillEditor`})).component.createQuillEditor({initialContent:T.markdown||``,onContentChange:e=>{T.markdown=e,F()},onSave:e=>{T.markdown=e,F(),T.message=`Content saved`,J(),setTimeout(()=>{T.message=``,J()},2e3)},placeholder:`Start writing your rich text here...`,autoSave:!0,autoSaveDelay:2e3}),n=t.render();g(`rich-editor`,`rich-editor`);let r=_(`rich-editor`),i=!1;for(let e of r){let t=e;if(console.log(`[RichEditor] Processing pending message:`,t),t.data?.text||t.data?.content){let e=t.data.text||t.data.content;T.markdown=typeof e==`string`?e:JSON.stringify(e,null,2),F(),i=!0}}return i&&(t?.updateContent?.(T.markdown),E(`Content loaded in rich editor`)),e.replaceWith(n),n}catch(t){console.error(`Failed to load rich editor:`,t);let n=a`<div class="component-error">
        <h3>Failed to load Rich Editor</h3>
        <p>Please try refreshing the page.</p>
      </div>`;return e.replaceWith(n),n}},Se=async()=>{let e=a`<div class="component-loading">
      <div class="loading-spinner"></div>
      <span>Loading History...</span>
    </div>`;K.append(e);try{let t=(await s(`history-manager`,()=>d(()=>import(`./src-C8p-yYHh.js`).then(e=>(e.t(),e.n)),[],import.meta.url),{componentName:`HistoryManager`})).component.createHistoryManager();T.history.length===0&&(T.history=t.getAllEntries());let n=t.createHistoryView(e=>{T.view===`workcenter`&&s(`workcenter`,()=>d(()=>import(`./WorkCenter-6Idw5E8N.js`).then(e=>e.WorkCenterManager),[],import.meta.url),{componentName:`WorkCenter`}).then(()=>{T.managers.workCenter.instance&&(T.managers.workCenter.instance.getState().currentPrompt=e.prompt)})});g(`history-view`,`history`);let r=_(`history-view`);for(let e of r)console.log(`[History] Processing pending message:`,e),e.type===`navigation`&&(T.view=`history`,setTimeout(()=>$(),0));return e.replaceWith(n),n}catch(t){console.error(`Failed to load history view:`,t);let n=a`<div class="component-error">
        <h3>Failed to load History View</h3>
        <p>Please try refreshing the page.</p>
      </div>`;return e.replaceWith(n),n}};if(typeof BroadcastChannel<`u`)try{new BroadcastChannel(D.SHARE_TARGET).addEventListener(`message`,e=>{let{type:t,data:n}=e.data||{};t===`share-received`&&n&&(T.history.push({ts:Date.now(),prompt:`Share Target`,before:n.title||n.text||n.url||`Shared content`,after:n.title||n.text||n.url||`Shared content`,ok:!0}),I())}),new BroadcastChannel(D.CLIPBOARD).addEventListener(`message`,e=>{let{type:t,data:n}=e.data||{};t===`copy`&&n&&(T.history.push({ts:Date.now(),prompt:`Clipboard Copy`,before:``,after:typeof n==`string`?n:JSON.stringify(n),ok:!0}),I())}),new BroadcastChannel(`app-shell`).addEventListener(`message`,e=>{let t=e.data;if(console.log(`[Shell] Received message:`,t),t.type===`content-view`){if(t.data?.text||t.data?.content){let e=t.data.text||t.data.content;T.markdown=typeof e==`string`?e:JSON.stringify(e,null,2),T.view=`markdown-viewer`,H(`markdown-viewer`),F(),$(),E(`Content loaded in viewer`)}}else t.type===`content-attach`?S(t,T,H,$,E):t.type===`navigation`&&(t.destination===`settings`?(T.view=`settings`,H(`settings`),$()):t.destination===`history`&&(T.view=`history`,H(`history`),$()))}),new BroadcastChannel(`main-app`).addEventListener(`message`,e=>{let t=e.data;console.log(`[MainApp] Received message:`,t),t.type===`navigation`&&(t.destination===`settings`?(T.view=`settings`,H(`settings`),$()):t.destination===`history`&&(T.view=`history`,H(`history`),$()))}),new BroadcastChannel(p(`explorer`)||`file-explorer`).addEventListener(`message`,e=>{let t=e.data;console.log(`[FileExplorer] Received message:`,t),t.type===`content-explorer`&&(T.view!==`file-explorer`&&(T.view=`file-explorer`,H(`file-explorer`),$()),setTimeout(async()=>{try{let e=t.data?.action||`save`,n=t.data?.path||t.data?.into||`/`;if(e===`save`&&(t.data?.file||t.data?.text||t.data?.content)){let e=null;if(t.data.file instanceof File)e=t.data.file;else if(t.data.blob instanceof Blob){let n=t.data.filename||`file-${Date.now()}`;e=new File([t.data.blob],n,{type:t.data.blob.type})}else if(t.data.text||t.data.content){let n=t.data.text||t.data.content,r=typeof n==`string`?n:JSON.stringify(n,null,2),i=t.data.filename||`content-${Date.now()}.txt`;e=new File([r],i,{type:`text/plain`})}e&&T.components.explorer.element&&(n&&n!==T.components.explorer.element.path&&(T.components.explorer.element.path=n),E(`Saved ${e.name} to Explorer`))}else e===`view`&&t.data?.path&&T.components.explorer.element&&n&&(T.components.explorer.element.path=n,E(`Opened Explorer at ${n}`))}catch(e){console.warn(`[FileExplorer] Failed to handle message:`,e),E(`Failed to perform Explorer action`)}},100))}),new BroadcastChannel(p(`print`)||`print-viewer`).addEventListener(`message`,e=>{let t=e.data;if(console.log(`[PrintViewer] Received message:`,t),t.type===`content-print`&&(t.data?.text||t.data?.content)){let e=t.data.text||t.data.content,n=typeof e==`string`?e:JSON.stringify(e,null,2),r=globalThis?.open?.(``,`_blank`,`width=800,height=600`);r&&(r.document.write(`
                                <!DOCTYPE html>
                                <html>
                                <head>
                                    <title>Print - CWSP-shell</title>
...
`),a=i?.ok&&i?.data?String(i.data):``;T.history.push({ts:Date.now(),prompt:e,before:n,after:a||n,ok:!!(i?.ok&&a),error:i?.ok?void 0:i?.error||`Failed`}),I(),a?(T.markdown=a,F(),z(``),T.message=`Done.`):T.message=i?.error||`No output.`}catch(t){T.history.push({ts:Date.now(),prompt:e,before:n,after:n,ok:!1,error:String(t)}),I(),T.message=String(t)}finally{T.busy=!1,J(),$(),setTimeout(()=>{T.message===`Done.`&&(T.message=``,J())},1200)}},Z=!1,Q=!1,$=async()=>{if(Z){Q=!0;return}Z=!0,Q=!1;try{let e=W();G.replaceWith(e),G=e,we(),H(T.view),K.replaceChildren();let n=(e,t)=>{console.error(`Failed to load ${e}:`,t),K.innerHTML=`<div class="component-error"><h3>Failed to load ${e}</h3><p>Please try refreshing the page.</p></div>`,J()},r=e=>{K.append(e),J()},i={settings:async()=>{K.innerHTML=`<div class="component-loading"><div class="loading-spinner"></div><span>Loading Settings...</span></div>`;let e=(await k(`settings`,()=>d(()=>import(`./src-CbOgZi7F.js`),[],import.meta.url),{componentName:`Settings`})).component.createSettingsView({isExtension:B(),onTheme:e=>U(c,e)});g(`settings-view`,`settings`);let t=_(`settings-view`);for(let e of t)console.log(`[Settings] Processing pending message:`,e),e.type===`navigation`&&(T.view=`settings`,setTimeout(()=>$(),0));return K.innerHTML=``,e},"file-explorer":async()=>{K.innerHTML=`<div class="component-loading"><div class="loading-spinner"></div><span>Loading File Explorer...</span></div>`,await k(`file-explorer`,()=>d(()=>import(`./_cwsp-disabled-entry_view-explorer-CUvWHUlh.js`),[],import.meta.url),{componentName:`FileManager`});let e=document.createElement(`ui-file-manager`);e.addEventListener(`open-item`,async t=>{let{item:n}=t.detail;n?.kind===`file`&&n?.file&&await v.sendMessage({id:crypto.randomUUID(),type:`content-share`,source:`explorer`,destination:`workcenter`,contentType:`file`,data:{file:n.file,filename:n.name,path:e.path},metadata:{title:n.name,timestamp:Date.now(),source:`file-explorer`}})}),e.addEventListener(`open`,async t=>{let{item:n}=t.detail;if(n?.kind===`file`&&n?.file){let t=u.isMarkdownFile(n.file),r=t?`viewer`:`workcenter`;await v.sendMessage({id:crypto.randomUUID(),type:`content-share`,source:`explorer`,destination:r,contentType:t?`markdown`:`file`,data:{file:n.file,filename:n.name,path:e.path},metadata:{title:n.name,timestamp:Date.now(),source:`file-explorer`}})}}),e.addEventListener(`context-action`,async t=>{let{action:n,item:r}=t.detail;if(n===`attach-workcenter`&&r?.kind===`file`&&r?.file)await v.sendMessage({id:crypto.randomUUID(),type:`content-share`,source:`explorer`,destination:`workcenter`,contentType:`file`,data:{file:r.file,filename:r.name,path:e.path},metadata:{title:`Attach ${r.name} to Work Center`,timestamp:Date.now(),source:`file-explorer`}});else if(n===`view`&&r?.kind===`file`&&r?.file){let t=u.isMarkdownFile(r.file),n=t?`viewer`:`workcenter`;await v.sendMessage({id:crypto.randomUUID(),type:`content-share`,source:`explorer`,destination:n,contentType:t?`markdown`:`file`,data:{file:r.file,filename:r.name,path:e.path},metadata:{title:`View ${r.name}`,timestamp:Date.now(),source:`file-explorer`}})}}),g(`file-explorer`,`explorer`),T.components.explorer.element=e;let t=_(`file-explorer`);for(let n of t){let t=n;if(console.log(`[Explorer] Processing pending message:`,t),t.type===`content-explorer`){let n=t.data?.action||`save`,r=t.data?.path||t.data?.into||`/`;setTimeout(async()=>{try{if(n===`save`&&(t.data?.file||t.data?.text||t.data?.content)){let n=null;if(t.data.file instanceof File)n=t.data.file;else if(t.data.blob instanceof Blob){let e=t.data.filename||`file-${Date.now()}`;n=new File([t.data.blob],e,{type:t.data.blob.type})}else if(t.data.text||t.data.content){let e=t.data.text||t.data.content,r=typeof e==`string`?e:JSON.stringify(e,null,2),i=t.data.filename||`content-${Date.now()}.txt`;n=new File([r],i,{type:`text/plain`})}n&&e&&(r&&r!==e.path&&(e.path=r),E(`Saved ${n.name} to Explorer`))}else n===`view`&&t.data?.path&&e&&r&&(e.path=r,E(`Opened Explorer at ${r}`))}catch(e){console.warn(`[Explorer] Failed to handle pending message:`,e),E(`Failed to perform Explorer action`)}},100)}}return K.innerHTML=``,e},history:()=>Se(),"markdown-viewer":()=>ye(),"markdown-editor":()=>be(),"rich-editor":()=>xe()}[T.view];if(i){try{let e=await i();e&&r(e)}catch(e){n(T.view.replace(`-`,` `).replace(/\b\w/g,e=>e.toUpperCase()),e)}return}if(T.view===`file-picker`){K.innerHTML=`
            ...
            `;let e=K.querySelector(`[data-action="open-markdown"]`),t=K.querySelector(`[data-action="open-any"]`);e&&e.addEventListener(`click`,()=>{q.accept=`.md,.markdown,.txt,text/markdown`,q.click()}),t&&t.addEventListener(`click`,()=>{q.accept=`*`,q.click()}),J();return}if(T.view===`workcenter`){K.innerHTML=`<div class="component-loading"><div class="loading-spinner"></div><span>Loading Work Center...</span></div>`,s(`workcenter`,()=>d(()=>import(`./WorkCenter-6Idw5E8N.js`).then(e=>e.WorkCenterManager),[],import.meta.url),{componentName:`WorkCenter`}).then(async e=>{if(T.managers.workCenter.instance||(T.managers.workCenter.instance=new e.component({state:T,history:T.history,onFilesChanged:()=>{W()},getSpeechPrompt:t,showMessage:e=>E(e),render:()=>$()})),!T.managers.workCenter.initialized){T.managers.workCenter.initialized=!0,g(`workcenter-manager`,`workcenter`);let e=_(`workcenter-manager`);for(let t of e){console.log(`[WorkCenter] Processing pending message:`,t);try{x(t)?await S(t,T,H,$,E,!0):T.managers.workCenter.instance?.handleExternalMessage?await T.managers.workCenter.instance.handleExternalMessage(t):await S(t,T,H,$,E,!0)}catch(e){console.warn(`[WorkCenter] Failed to replay pending message:`,e)}}}let n=T.managers.workCenter.instance.renderWorkCenterView();K.innerHTML=``,K.append(n),J()}).catch(e=>{console.error(`Failed to load work center:`,e),K.innerHTML=`<div class="component-error"><h3>Failed to load Work Center</h3><p>Please try refreshing the page.</p></div>`,J()});return}ye().then(e=>{K.append(e),J()}).catch(e=>{console.error(`Failed to load default markdown viewer:`,e),K.innerHTML=`<div class="component-error"><h3>Failed to load Markdown Viewer</h3><p>Please try refreshing the page.</p></div>`,J()})}finally{Z=!1,Q&&setTimeout(()=>$(),0)}},we=()=>{G.addEventListener(`click`,async e=>{let n=(e.target?.closest?.(`button[data-action]`))?.dataset?.action;if(!n)return;let r=null;if(n===`view-markdown-viewer`&&(r=`markdown-viewer`),n===`view-markdown-editor`&&(r=`markdown-editor`),n===`view-rich-editor`&&(r=`rich-editor`),n===`view-workcenter`&&(r=`workcenter`),n===`view-settings`&&(r=`settings`),n===`view-history`&&(r=`history`),n===`view-file-explorer`&&(r=`file-explorer`),r&&(T.view=r,H(r)),n===`open-md`&&q.click(),n===`save-md`&&Ce(),n===`export-md`&&Y(),n===`export-docx`){let e=T.markdown||``;if(e.trim()){let{downloadMarkdownAsDocx:t}=await d(async()=>{let{downloadMarkdownAsDocx:e}=await import(`./DocxExport-DdHgCVIZ.js`);return{downloadMarkdownAsDocx:e}},[],import.meta.url);await t(e,{title:`CWSP-shell`,filename:`crossword-${Date.now()}.docx`})}}if(n===`toggle-edit`){if(T.view!==`markdown-viewer`&&T.view!==`markdown-editor`)return;T.editing=!T.editing}if(n===`snip`){if(!l)return;try{chrome.tabs.query({active:!0,lastFocusedWindow:!0,currentWindow:!0},e=>{let t=e?.[0]?.id;t!=null&&chrome.tabs.sendMessage(t,{type:`START_SNIP`})?.catch?.(()=>void 0);try{globalThis?.close?.()}catch{}})}catch{}}if(n===`process-content`&&T.managers.workCenter.instance&&await v.sendMessage({id:crypto.randomUUID(),type:`content-process`,source:`main-app`,destination:`workcenter`,data:{prompt:T.markdown||`Process this content`},metadata:{timestamp:Date.now(),correlationId:`main-${Date.now()}`}}),n===`save-to-explorer`&&T.managers.workCenter.instance){let e=T.managers.workCenter.instance.getState().results||[];if(e.length>0){let t=e[e.length-1];await v.sendMessage({id:crypto.randomUUID(),type:`content-save`,source:`main-app`,destination:`explorer`,data:{action:`save`,text:typeof t==`string`?t:JSON.stringify(t,null,2),filename:`workcenter-result-${Date.now()}.txt`,path:`/workcenter-results/`},metadata:{title:`Work Center Result`,timestamp:Date.now(),source:`workcenter`}})}else T.message=`No results to save`,J(),setTimeout(()=>{T.message=``,J()},2e3)}n===`solve`&&await X(`Solve equations and answer questions from the content above`,solveAndAnswer),n===`code`&&await X(`Generate code based on the description or requirements above`,writeCode),n===`css`&&await X(`Extract or generate CSS from the content or image above`,extractCSS),n===`voice`&&(async()=>{let e=await t();e&&await X(e)})(),$()})};we(),q.addEventListener(`change`,()=>{let e=q.files?.[0];e&&e.text().then(t=>{T.markdown=t||``,F(),z(``),T.view!==`markdown-viewer`&&(T.view=`markdown-viewer`,H(`markdown-viewer`)),T.message=`Loaded ${e.name}`,J(),$(),setTimeout(()=>{T.message=``,J()},3e3)}).catch(()=>void 0).finally(()=>{q.value=``})}),ue().then(e=>{T.lastSavedTheme=e?.appearance?.theme||`auto`,U(c,T.lastSavedTheme)}).catch(()=>U(c,`auto`));let Te=R();Te&&_e(Te).then(e=>{e&&(T.markdown=e,F(),$())}),$()}})))()}G();export{W as mountShellApp};