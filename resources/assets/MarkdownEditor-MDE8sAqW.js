import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{O as t,j as n,t as r}from"./src-C7QuTtnr.js";import{y as i}from"./UniformInterop-D6lR55tv.js";import{n as a,t as o}from"./preload-helper-DcjHEl26.js";import{n as s,r as c}from"./channel-mixin-xxxCJwOb.js";import{a as l,f as u}from"./UnifiedMessaging-CDibs2yQ.js";import{a as d,n as ee,r as f,t as p}from"./view-ingress-validation-BUwbjEBq.js";import{a as m,c as te,d as h,f as ne,l as re,s as g,t as _,u as ie}from"./src-R3RI73pV.js";import{a as v}from"./HistoryManager-B52KbQG4.js";import{a as y,i as b,n as ae,o as x}from"./Base64Data-DpzxunTw.js";import{a as oe,o as se}from"./Settings-CahzB18o.js";import{i as ce,r as le,t as ue}from"./object-DpwBpfvO.js";import{i as de,s as fe,t as pe}from"./icon-M8fpRh7n.js";import{n as me,t as he}from"./auto-render-BCgi03ou.js";import{n as ge,t as _e}from"./purify.es-B-w98i1w.js";import{n as ve,t as ye}from"./registry-nkKrCl1a.js";import{a as be,i as S,t as C}from"./channel-actions-D5ksGgGK.js";function xe(e){return{load(){try{let t=localStorage.getItem(e);return t?JSON.parse(t):null}catch{return null}},save(t){try{localStorage.setItem(e,JSON.stringify(t))}catch{}},clear(){try{localStorage.removeItem(e)}catch{}}}}var w,T,E;function D(){return(D=e((()=>{_(),l(),w=e=>String(e||`attachment`).toLowerCase().replace(/[^a-z0-9-]/g,`-`).replace(/-+/g,`-`).replace(/^-+|-+$/g,``)||`attachment`,T=async(e,t=`view-ipc`)=>{let n=[];for(let r of e){let e=r&&typeof r==`object`&&`data`in r?r.data:r;if(e)try{let i=r&&typeof r==`object`&&`source`in r?String(r.source||t):t,a=await y(e,{namePrefix:w(i),uriComponent:!0});n.push({hash:String(a.hash||``),name:String(a.name||a.file?.name||`attachment`),mimeType:String(a.mimeType||a.type||a.file?.type||`application/octet-stream`),size:Number(a.size||a.file?.size||0),source:i,data:a.file})}catch(e){console.warn(`[UniformViewTransport] Attachment normalization failed:`,e)}}return n},E=async e=>{let t=await T(e.attachments||[],e.source),n={...e.data||{},...t.length>0?{attachments:t,file:t[0]?.data,files:t.map(e=>e.data)}:{}},r=i({type:e.type,source:e.source,destination:e.destination,contentType:e.contentType,data:n,purpose:e.purpose||(t.length>0?[`attach`,`deliver`]:[`deliver`,`mail`]),protocol:`window`,op:e.op||(t.length>0?`attach`:`deliver`),srcChannel:e.source,dstChannel:e.destination,metadata:{...e.metadata||{},attachmentCount:t.length}});return u(r)}})))()}function Se(e){return e===`light`||e===`dark`?e:typeof globalThis.matchMedia==`function`&&globalThis.matchMedia(`(prefers-color-scheme: light)`).matches?`light`:`dark`}function O(e){if(e===`light`||e===`dark`||e===`system`)return e;if(typeof e==`string`){let t=e.trim().toLowerCase();if(t===`light`||t===`dark`||t===`system`)return t}}function k(e){if(e!=null){if(typeof e==`string`)return O(e.trim());if(typeof e==`object`){let t=e;return O(t.colorScheme??t.scheme??t.theme)}}}function Ce(e){if(e)return e.colorScheme?e.colorScheme:O(e.params?.colorScheme??e.params?.theme)}var A;function we(){return(we=e((()=>{A=`/*
...
@scope (
  ...
  @layer print {
    @media print {
      ...
      :is(html, body):has([data-shell=minimal]), :host {
...
}`})))()}function Te(e){let t=[],n=`__MD_MASK_`;return{masked:(e=>e.replace(H,e=>{let r=`${n}${t.length}__`;return t.push(e),r}))((e=>e.replace(V,e=>{let r=`${n}${t.length}__`;return t.push(e),r}))(e)),restore:e=>e.replace(/__MD_MASK_(\d+)__/g,(e,n)=>t[Number(n)]??``)}}var j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Ee,De;function Oe(){return(Oe=e((()=>{_(),ce(),r(),_e(),he(),fe(),c(),ve(),be(),oe(),D(),p(),we(),a(),j=async(e,t)=>{for await(let[n,r]of e.entries())if(r.kind===`file`)try{if(await r.isSameEntry(t))return n}catch{}else if(r.kind===`directory`){let e=await j(r,t);if(e)return`${n}/${e}`}return null},M=null,N=`rs-viewer-outline`,P=/\$\$[\s\S]*?\$\$|\\\[[\s\S]*?\\\]|(?<!\$)\$[^$\n]+\$|\\\([\s\S]*?\\\)/,F=35e4,I=96e3,L=12e5,R=2097152,z=48e4,B=6e5,V=/(^|\n)(`{3,}|~{3,})[^\n]*\n[\s\S]*?\n\2(?=\n|$)/g,H=/`[^`\n]+`/g,U={USE_PROFILES:{html:!0,mathMl:!0,svg:!0},FORBID_TAGS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`link`,`meta`,`base`,`form`,`noscript`,`template`],FORBID_CONTENTS:[`script`,`style`,`iframe`,`object`,`embed`,`applet`,`noscript`,`template`]},W=`g`,G=[`rs-md-base`,`rs-md-system`,`rs-md-modules`,`rs-md-user`,`rs-md-print`,`rs-md-user-print`],K=!1,q=()=>{if(!K)try{de(),pe(),K=!0}catch(e){console.warn(`[Viewer] Failed to initialize icon runtime:`,e)}},J=e=>navigator?.clipboard?.writeText?.(e)??Promise.resolve(void 0),Y=async()=>M||(M=(async()=>{let[{marked:e},{default:t}]=await Promise.all([o(()=>import(`./marked.esm-U97ULcOU.js`).then(e=>(e.n(),e.r)),[],import.meta.url),o(()=>import(`./src-CqaVamcJ.js`).then(e=>(e.t(),e.r)),[],import.meta.url)]);return e?.use?.(t({throwOnError:!1,nonStandard:!0,output:`mathml`,strict:!1}),{hooks:{preprocess:e=>{if(e.length>F||!P.test(e))return e;let{masked:t,restore:n}=Te(e),r=document.createElement(`div`);return r.textContent=t,me(r,{throwOnError:!1,nonStandard:!0,output:`mathml`,strict:!1,delimiters:[{left:`$$`,right:`$$`,display:!0},{left:`\\[`,right:`\\]`,display:!0},{left:`$`,right:`$`,display:!1},{left:`\\(`,right:`\\)`,display:!1}]}),n(r.innerHTML)}}}),async t=>await e.parse(t??``)})(),M),X=`rs-viewer-state`,Z=`# This is content`,Ee=`cw-view-viewer`,De=ye(Ee,e=>class extends e{id=`viewer`;name=`Viewer`;icon=`eye`;options;shellContext;element=null;slotProjectingHost=null;contentRef=ue(``);contentRefSubscriptionDispose=null;renderSeq=0;stateManager=xe(X);_sheet=null;pasteController=null;windowDnDController=null;isViewVisible=!1;isPointerInView=!1;sourceUrl=null;assetObjectUrls=[];sourceObserver=null;customSheet=null;userStyleModules={screenCss:``,printCss:``};markdownSettings={preset:`default`,fontFamily:`system`,fontSizePx:16,lineHeight:1.7,contentMaxWidthPx:860,printScale:1,page:{size:`auto`,orientation:`portrait`,marginMm:12},modules:{typography:!0,lists:!0,tables:!0,codeBlocks:!0,blockquotes:!0,media:!0,printBreaks:!0},plugins:{smartTypography:!1,softBreaksAsBr:!1,externalLinksNewTab:!0},customCss:``,printCss:``,extensions:[]};markdownSettingsPromise=null;outlineVisible=!1;viewerColorScheme=`system`;documentThemeSnapshot=null;disposeContentRefSubscription(){try{this.contentRefSubscriptionDispose?.()}catch{}this.contentRefSubscriptionDispose=null}subscribeContentRefToCurrentTargets(e,t){this.disposeContentRefSubscription();let n=le(this.contentRef,()=>{e&&t&&this.renderMarkdown(this.contentRef.value,e,t),this.saveState()});this.contentRefSubscriptionDispose=typeof n==`function`?n:null}lifecycle={onMount:()=>this.onMount(),onUnmount:()=>this.onUnmount(),onShow:()=>this.onShow(),onHide:()=>this.onHide(),onRefresh:()=>this.onRefresh()};constructor(e={}){super(),this.options=e,this.shellContext=e.shellContext,this.sourceUrl=this.normalizeSourceUrl(e.source),this.applyRouteParams(e.params),this.markdownSettingsPromise=this.loadMarkdownSettings();try{this.outlineVisible=globalThis.sessionStorage?.getItem(N)===`1`}catch{this.outlineVisible=!1}this.syncViewerColorSchemeFromOptions();let t=this.stateManager.load();if(this.contentRef.value=e.initialContent||t?.content||Z,!e.initialContent){let t=(e.params?.content||``).trim();t&&(this.contentRef.value=t)}}render=function(e){q(),this.slotProjectingHost=null,e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,this.applyRouteParams(e.params)),this.syncViewerColorSchemeFromOptions(),this._sheet=t(A),this.element=this.createViewerShellElement();let n=this.element.querySelector(`[data-render-target]`),r=this.element.querySelector(`[data-raw-target]`);return this.setupEventHandlers(r||void 0),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),n&&r&&this.renderMarkdown(this.contentRef.value,n,r),this.subscribeContentRefToCurrentTargets(n,r),this.refreshDocumentTheme(),this.element};shellNavigateHydrate(e,t){if(!this.element?.isConnected)return;e&&(this.options={...this.options,...e},this.shellContext=e.shellContext||this.shellContext,e.params!==void 0&&this.applyRouteParams(e.params),this.syncViewerColorSchemeFromOptions());let n=this.queryViewerSlotted(`[data-render-target]`),r=this.queryViewerSlotted(`[data-raw-target]`);n&&r&&(this.subscribeContentRefToCurrentTargets(n,r),this.renderMarkdown(this.contentRef.value,n,r)),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),this.refreshDocumentTheme()}renderIntoWebComponentHost(e,n){q(),n&&(this.options={...this.options,...n},this.shellContext=n.shellContext||this.shellContext,this.applyRouteParams(n.params)),this.syncViewerColorSchemeFromOptions(),this.slotProjectingHost=e,this._sheet??=t(A),this.element=this.createViewerShellElement(),e.replaceChildren(this.element);let r=e.querySelector(`[data-raw-target]`),i=e.querySelector(`[data-render-target]`);e.setAttribute(`data-view-id`,`viewer`),e.toggleAttribute(`data-cw-view-host`,!0),this.syncAdoptedSheetsToShadow();let a=i,o=r;this.setupEventHandlers(o),this.syncOutlineToolbarState(),this.syncToolbarDocumentTitle(),a&&o&&this.renderMarkdown(this.contentRef.value,a,o),this.subscribeContentRefToCurrentTargets(a,o),this.refreshDocumentTheme()}getToolbar(){return null}setContent(e,t,n){this.contentRef.value=e,t&&(this.options.filename=t),n!==void 0&&(this.sourceUrl=this.normalizeSourceUrl(n),this.options.source=n||void 0),this.syncToolbarDocumentTitle()}ingestOpenedMarkdownBody(e,t,n){if(e.length>0&&f(e)){this.setContent(`> This payload does not look like UTF-8 markdown (binary file or unsupported format).
>
> Open a \`.md\` / \`.txt\` file, paste as plain text, or attach binaries via Work Center.

`,t,n);return}this.setContent(e,t,n??void 0)}getContent(){return this.contentRef.value}setViewerColorScheme(e){this.viewerColorScheme=e,this.options.colorScheme=e,this.refreshDocumentTheme()}refreshDocumentTheme(){typeof document>`u`||this.applyViewerDocumentTheme(this.viewerColorScheme)}applyViewerDocumentTheme(e){let t=document.documentElement;if(e===`system`)return;this.documentThemeSnapshot||={prevAttr:t.getAttribute(`data-theme`),prevInlineCs:t.style.getPropertyValue(`color-scheme`)};let n=Se(e);t.setAttribute(`data-theme`,n),t.style.setProperty(`color-scheme`,n)}restoreViewerDocumentTheme(){let e=this.documentThemeSnapshot;if(this.documentThemeSnapshot=null,!e||typeof document>`u`)return;let t=document.documentElement;e.prevAttr===null||e.prevAttr===``?t.removeAttribute(`data-theme`):t.setAttribute(`data-theme`,e.prevAttr),e.prevInlineCs.trim()?t.style.setProperty(`color-scheme`,e.prevInlineCs):t.style.removeProperty(`color-scheme`)}syncViewerColorSchemeFromOptions(){let e=Ce(this.options);e&&(this.viewerColorScheme=e)}createViewerShellElement(){return v`
