import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{F as t,Q as n,X as r,t as i}from"./src-kpjtbscK.js";import{a,d as o,f as s,h as c,i as l,s as u}from"./cwsp-endpoint-resolve-CsyKvxBc.js";import{a as d,r as f}from"./SettingsTypes-BL3S2Z7F.js";import{a as p,i as ee}from"./Settings-_zeU2dzM.js";import{C as te,T as m,w as h,y as ne}from"./config-3CjwWmU9.js";import{F as re,I as g,L as _,M as v,P as y}from"./cwsp-app.js";import{i as ie,n as ae,r as oe}from"./frontend-debug-capture-DNrY09BI.js";import{a as se,i as ce,n as le,o as ue,r as de,t as b}from"./websocket-DOCbpCr1.js";import{n as fe,o as pe}from"./clipboard-device-C1jGUTXQ.js";var me,x,S,he,ge=e((()=>{u(),me=e=>typeof e==`string`?e.trim():``,x=e=>{let t=me(e).replace(/\/lna-probe\/?$/i,``).replace(/\/+$/,``);if(!t)return``;let n=o(t);if(!n?.host)return t;let r=n.protocol??`https`;return n.port?`${r}://${n.host}:${n.port}`:`${r}://${n.host}:8434`},S=(e,t,n)=>{let r=new Set(c(n.relay??``).map(e=>x(e))),i=new Set(c(n.direct??``).map(e=>x(e))),a=x(e);return r.has(a)?t===0?`Relay / gateway`:`Relay (alt)`:i.has(a)?`Direct peer`:a.includes(`192.168.0.200`)?`Gateway LAN fallback`:a.includes(`45.147.121.152`)?`Gateway WAN fallback`:a.includes(`127.0.0.1`)||a.includes(`localhost`)?`Loopback`:`Candidate ${t+1}`},he=(e,t)=>{let n=e.find(e=>e.ok)?.origin;if(n)return x(n);let r=a(t);return r[0]?r[0]:e[0]?.origin?x(e[0].origin):``}}));async function _e(e){if(!_())return null;let t=a(e);try{let n=await g({channel:`network:probe`,payload:{relay:x(C(e.relay)),direct:x(C(e.direct)),candidates:t}}),r=n.echo,i=n.results??r?.results;if(!Array.isArray(i)||!i.length)return null;let a=new Set,o=[];for(let t=0;t<i.length;t++){let n=i[t],r=x(String(n.url??``));if(!r||a.has(r))continue;a.add(r);let s=!!n.reachable,c=typeof n.statusCode==`number`?n.statusCode:void 0;o.push({label:S(r,o.length,e),origin:r,ok:s,status:c,error:D(n,s,c)})}return o.length?o:null}catch{return null}}async function ve(e,t){if(!_())return null;let n=x(e);if(!n)return null;let r=Date.now();try{let e=await g({channel:`network:dispatch-probe`,payload:{origin:n,clientId:C(t.clientId),token:C(t.token),accessToken:C(t.accessToken)}}),i=typeof e.statusCode==`number`?e.statusCode:void 0,a=!!e.ok,o=typeof e.error==`string`?e.error.trim():``,s=typeof e.bodySnippet==`string`?e.bodySnippet:``;return{origin:n,ok:a,status:i,latencyMs:Date.now()-r,bodySnippet:s,error:a?void 0:o||(i==null?`dispatch failed`:`HTTP ${i}`)}}catch{return null}}async function ye(e,t={}){let n=await _e(e);if(n?.length)return n;let r=await O(e);if(r?.length)return r;let i=t.timeoutMs??3500,o=t.maxCandidates??6,c=[],u=a(e);for(let t=0;t<u.length;t++){let n=u[t],r=S(n,t,e),a=l(n).slice(0,o);if(!a.length){c.push({label:r,origin:n,ok:!1,error:`invalid host`});continue}for(let e of a){let t=await s(e,{timeoutMs:i});if(c.push({label:r,...t}),t.ok)break}}return c}async function be(e,t){if(!w())return null;let n=T(`/service/endpoint-probe`);if(!n)return null;let r=globalThis.__WEBNATIVE_AUTH__?.key,i=a(e),o=typeof AbortController<`u`?new AbortController:void 0,s=o?globalThis.setTimeout(()=>o.abort(),12e3):void 0;try{let a=await fetch(n,{method:`POST`,headers:r?{"Content-Type":`application/json`,"X-API-Key":r}:{"Content-Type":`application/json`},body:JSON.stringify({origins:i,dispatch:!0,auth:t}),signal:o?.signal});if(!a.ok)return null;let s=await a.json();return{probes:(s.rows??[]).map((t,n)=>({label:S(t.origin,n,e),origin:t.origin,ok:t.ok,status:t.status,error:t.error,latencyMs:t.latencyMs})),dispatch:s.dispatch?{origin:s.dispatch.origin,ok:s.dispatch.ok,status:s.dispatch.status,error:s.dispatch.error,bodySnippet:s.dispatch.bodySnippet,latencyMs:s.dispatch.latencyMs}:void 0}}catch{return null}finally{s&&clearTimeout(s)}}async function xe(e,t,n,r=8e3){let i=e.filter(e=>e.ok).map(e=>x(e.origin)),o=i.length?i:a(t),s={origin:``,ok:!1,error:`no origin`};for(let e of o)if(s=await Se(e,n,r),s.ok)return s;return s}async function Se(e,t,n=8e3){let r=x(e),i=Date.now();if(!r)return{origin:``,ok:!1,error:`no origin`};let a=await ve(r,t);if(a)return a;let o=typeof AbortController<`u`?new AbortController:void 0,s=o&&n>0?globalThis.setTimeout(()=>o.abort(),n):void 0,c=C(t.clientId),l=C(t.token),u=C(t.accessToken),d={"Content-Type":`application/json`};u&&(d[`x-auth-token`]=u),l&&(d[`x-cws-token`]=l);let f={userId:c,byId:c,from:c,clientId:c,userKey:u||l,token:l||u,accessToken:u||l,op:`ask`,what:`debug:isReady`,payload:{}};try{let e=await fetch(`${r}/api/network/dispatch`,{method:`POST`,mode:`cors`,cache:`no-store`,credentials:`omit`,headers:d,body:JSON.stringify(f),signal:o?.signal}),t=await e.text().catch(()=>``),n=Date.now()-i,a=e.ok;return{origin:r,ok:a,status:e.status,statusText:e.statusText,latencyMs:n,bodySnippet:t.slice(0,240),error:a?void 0:`HTTP ${e.status}${e.statusText?` ${e.statusText}`:``}`.trim()}}catch(e){return{origin:r,ok:!1,error:E(e),latencyMs:Date.now()-i}}finally{s&&clearTimeout(s)}}async function Ce(e,t,n,r={}){let i=e.map(e=>e.trim()).filter(Boolean);if(!i.length)return[];let o=r.timeoutMs??8e3,s=[x(r.originHint||``),...a(t).map(x)].filter(Boolean)[0]||``;if(!s)return i.map(e=>({id:e,ok:!1,origin:``,error:`no gateway origin`}));let c=C(n.clientId),l=C(n.token),u=C(n.accessToken),d=[];for(let e of i){let t=Date.now(),n={"Content-Type":`application/json`};u&&(n[`x-auth-token`]=u),l&&(n[`x-cws-token`]=l);let r={userId:c,byId:c,from:c,clientId:c,userKey:u||l,token:l||u,accessToken:u||l,op:`ask`,what:`clipboard:isReady`,purpose:`clipboard`,nodes:[e],destinations:[e],payload:{probe:!0,destination:e}};if(_())try{let n=await g({channel:`network:dispatch-probe`,payload:{origin:s,clientId:c,token:l,accessToken:u,what:`clipboard:isReady`,nodes:[e],destinations:[e]}}),r=typeof n.statusCode==`number`?n.statusCode:void 0,i=!!n.ok,a=typeof n.error==`string`?n.error.trim():``;d.push({id:e,origin:s,ok:i,status:r,latencyMs:Date.now()-t,bodySnippet:typeof n.bodySnippet==`string`?n.bodySnippet:void 0,error:i?void 0:a||(r==null?`dispatch failed`:`HTTP ${r}`)});continue}catch{}let i=typeof AbortController<`u`?new AbortController:void 0,a=i&&o>0?globalThis.setTimeout(()=>i.abort(),o):void 0;try{let a=await fetch(`${s}/api/network/dispatch`,{method:`POST`,mode:`cors`,cache:`no-store`,credentials:`omit`,headers:n,body:JSON.stringify(r),signal:i?.signal}),o=await a.text().catch(()=>``),c=a.ok;d.push({id:e,origin:s,ok:c,status:a.status,latencyMs:Date.now()-t,bodySnippet:o.slice(0,240),error:c?void 0:`HTTP ${a.status}${a.statusText?` ${a.statusText}`:``}`.trim()})}catch(n){d.push({id:e,origin:s,ok:!1,error:E(n),latencyMs:Date.now()-t})}finally{a&&clearTimeout(a)}}return d}var C,w,T,E,D,O,k,we=e((()=>{u(),y(),ge(),C=e=>typeof e==`string`?e.trim():``,w=()=>{try{let e=globalThis;return!!(e.__WEBNATIVE_AUTH__||e.__CWS_WEBNATIVE_BOOT__)}catch{return!1}},T=e=>{try{let t=globalThis.__WEBNATIVE_AUTH__;return t?.port?`http://127.0.0.1:${t.port}${e}`:null}catch{return null}},E=e=>{let t=e instanceof Error?e.message:String(e??`fetch failed`);return/abort/i.test(t)?`timeout`:/refused|ECONNREFUSED/i.test(t)?`connection refused`:/ENOTFOUND|NAME_NOT_RESOLVED/i.test(t)?`host not found`:/certificate|cert\.|ssl|tls|ERR_CERT/i.test(t)?`TLS: ${t}`:/failed to fetch/i.test(t)&&_()?`WebView fetch blocked (CORS/TLS) — use native bridge`:t},D=(e,t,n)=>{if(t)return;let r=[];return e.error&&r.push(String(e.error)),n!=null&&n>=0&&n!==204&&r.push(`HTTP ${n}`),r.join(` · `)||`unreachable`},O=async e=>{let t=await be(e,{});return t?.probes.length?t.probes:null},k=e=>{let t=String(e||``).trim();if(!t)return[];let n=new Set,r=[];for(let e of t.split(/[,;\s\n\r]+/)){let t=e.trim();!t||n.has(t)||(n.add(t),r.push(t))}return r}})),A,j,M,N,Te,P,Ee,De,Oe=e((()=>{ie(),y(),fe(),A=e=>`${new Date(e.ts).toISOString()} [${e.level}] (${e.scope}) ${e.msg}`,j=(e=400)=>{let t=ae()?.tail(e)??[];return t.length?t.map(A).join(`
`)+`
...
`)?r:`${r}\n`}catch{}return``},Te=async(e,t=``)=>{let n=[`CWSP Network diagnostics export`,`generated: ${new Date().toISOString()}`,`userAgent: ${navigator.userAgent}`,``].join(`
...
`)},P=async e=>{let t=e||`(empty log)`;try{return await pe(t),!0}catch{return!1}},Ee=(e,t)=>{let n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=e,i.rel=`noopener`,document.body.append(i),i.click(),i.remove(),URL.revokeObjectURL(r)},De=e=>`${e}-${new Date().toISOString().replace(/[:.]/g,`-`)}.txt`})),F,I,ke,Ae,je=e((()=>{F={root:{selector:`.cw-network-view`,role:`main`,label:`CWSP Network`},statusGrid:{selector:`.cw-network-status-grid`,role:`status`,ariaLive:`polite`,ariaAtomic:`false`},activityLog:{selector:`[data-log]`,ariaLive:`polite`,ariaRelevant:`additions text`,role:`log`},probeList:{selector:`[data-probe-list]`,role:`list`},actions:[{action:`test`,label:`Run network test`},{action:`reconnect`,label:`Reconnect WebSocket`},{action:`open-settings`,label:`Open settings`},{action:`copy-frontend-log`,label:`Copy frontend log`},{action:`copy-logcat`,label:`Copy logcat`},{action:`save-page-logs`,label:`Save page logs`}],minTouchTargetPx:44},I=e=>{let{root:t,statusGrid:n,activityLog:r,probeList:i,actions:a}=F;e.setAttribute(`role`,t.role),!e.getAttribute(`aria-label`)&&!e.getAttribute(`aria-labelledby`)&&e.setAttribute(`aria-label`,t.label);let o=e.querySelector(`h1`);o&&!o.id&&(o.id=`cw-network-view-title`,e.setAttribute(`aria-labelledby`,o.id),e.removeAttribute(`aria-label`));let s=e.querySelector(n.selector);s instanceof HTMLElement&&(s.setAttribute(`role`,n.role),s.setAttribute(`aria-live`,n.ariaLive),s.setAttribute(`aria-atomic`,n.ariaAtomic));let c=e.querySelector(r.selector);c instanceof HTMLElement&&(c.setAttribute(`role`,r.role),c.setAttribute(`aria-live`,r.ariaLive),c.setAttribute(`aria-relevant`,r.ariaRelevant));let l=e.querySelector(i.selector);l instanceof HTMLElement&&l.setAttribute(`role`,i.role);for(let t of a){let n=e.querySelector(`[data-action="${t.action}"]`);n instanceof HTMLElement&&(!n.getAttribute(`aria-label`)&&!n.textContent?.trim()&&n.setAttribute(`aria-label`,t.label),n instanceof HTMLButtonElement&&!n.type&&(n.type=`button`))}},ke=e=>{let t=[],{root:n,statusGrid:r,activityLog:i,probeList:a,actions:o}=F;e.getAttribute(`role`)!==n.role&&t.push({code:`root-role`,message:`root role must be "${n.role}"`}),!e.getAttribute(`aria-label`)&&!e.getAttribute(`aria-labelledby`)&&t.push({code:`root-label`,message:`root needs aria-label or aria-labelledby`});let s=e.querySelector(r.selector);s?(s.getAttribute(`role`)!==r.role&&t.push({code:`status-role`,message:`status grid role must be "${r.role}"`}),s.getAttribute(`aria-live`)!==r.ariaLive&&t.push({code:`status-live`,message:`status grid aria-live must be "${r.ariaLive}"`})):t.push({code:`status-grid-missing`,message:`status grid missing`});let c=e.querySelector(i.selector);c?(c.getAttribute(`aria-live`)!==i.ariaLive&&t.push({code:`log-live`,message:`log aria-live must be "${i.ariaLive}"`}),c.getAttribute(`role`)!==i.role&&t.push({code:`log-role`,message:`log role must be "${i.role}"`})):t.push({code:`log-missing`,message:`activity log [data-log] missing`});let l=e.querySelector(a.selector);l?l.getAttribute(`role`)!==a.role&&t.push({code:`probe-list-role`,message:`probe list role must be "${a.role}"`}):t.push({code:`probe-list-missing`,message:`probe list missing`});for(let n of o){let r=e.querySelector(`[data-action="${n.action}"]`);if(!r){t.push({code:`action-missing:${n.action}`,message:`action button data-action="${n.action}" missing`});continue}r.getAttribute(`aria-label`)||r.textContent?.trim()||t.push({code:`action-label:${n.action}`,message:`action "${n.action}" needs accessible name`})}return t},Ae=(e=document)=>{let t=e.createElement(`div`);return t.className=`cw-network-view`,t.dataset.view=`network`,t.innerHTML=`
    ...
    `,I(t),t}})),Me,Ne=e((()=>{Me=`@layer ui-network {
...
}`})),L,R,z,B,V,Pe,H,U,W,G,K,Fe,q,J,Ie=e((()=>{i(),r(),ee(),ce(),ne(),y(),we(),f(),Oe(),ie(),je(),Ne(),L=()=>{try{let e=globalThis.Capacitor;return typeof e?.isNativePlatform==`function`&&!!e.isNativePlatform()}catch{return!1}},R=29110,z=`cwsp-neutralino-local`,B=()=>{try{let e=globalThis,t=e.__WEBNATIVE_AUTH__||e.__NEUTRALINO_AUTH__;return{port:Number(t?.port)||R,key:String(t?.key||z)}}catch{return{port:R,key:z}}},V=async()=>{try{let e=globalThis,t=typeof e.NL_PATH==`string`?e.NL_PATH:``,n=e.Neutralino?.filesystem?.readFile;if(!t||!n)return;let r=await n(`${t}/.tmp/cwsp-control-auth.json`),i=JSON.parse(r),a=Number(i?.port);if(!Number.isFinite(a)||a<1024||a===8434)return;let o={port:a,key:String(i?.key||`cwsp-neutralino-local`)};e.__WEBNATIVE_AUTH__=o,e.__NEUTRALINO_AUTH__=o}catch{}},Pe=async(e,t)=>{let n=typeof AbortSignal<`u`&&typeof AbortSignal.timeout==`function`?AbortSignal.timeout(1500):void 0;try{let r=await fetch(`http://127.0.0.1:${e}/service/clipboard-hub`,{method:`GET`,headers:{"X-API-Key":t},cache:`no-store`,signal:n});if(!r.ok)return null;let i=await r.json();return typeof i?.running!=`boolean`&&typeof i?.connected!=`boolean`?null:i}catch{return null}},H=async()=>{await V();let e=B(),t=Array.from(new Set([e.port,R,29110,19875,19876].filter(e=>e>1024)));for(let n of t){let t=await Pe(n,e.key);if(t){let r=globalThis;return r.__WEBNATIVE_AUTH__={port:n,key:e.key},r.__NEUTRALINO_AUTH__={port:n,key:e.key},t}}return null},U=async()=>{let e=await H(),{port:t,key:n}=B(),r=typeof AbortSignal<`u`&&typeof AbortSignal.timeout==`function`?AbortSignal.timeout(3e3):void 0;try{let i=await fetch(`http://127.0.0.1:${t}/service/clipboard-hub`,{method:`POST`,headers:{"Content-Type":`application/json`,"X-API-Key":n},body:JSON.stringify({reload:!0,force:!0}),cache:`no-store`,signal:r});return i.ok?await i.json():e}catch{return e}},W=0,G=0,K=async()=>{let e=Date.now();if(e-W<8e3)return!1;W=e;try{let e=globalThis.Neutralino;return e?.extensions?.dispatch?(await e.extensions.dispatch(`extNode`,`runNode`,{function:`backend.ensure`,parameter:null}),!0):!1}catch{return!1}},Fe=async()=>{let e=Date.now();return e-G<1e4?null:(G=e,U())},q=e=>{let t=[`${e.label}: ${e.origin}`];return e.ok?t.push(`OK (${e.latencyMs??`?`}ms)`):e.status&&t.push(`FAIL HTTP ${e.status}`),e.error&&t.push(e.error),t.join(` — `)},J=class{root=null;sheet=null;wsUnsub=null;nodeHubPoll=null;running=!1;logLines=[];probeSummary=``;els={wsCard:null,wsValue:null,wsDetail:null,nativeCard:null,nativeValue:null,configDetail:null,probeList:null,log:null,testBtn:null,destBtn:null,destInput:null,reconnectBtn:null};mount(e){return this.sheet??=n(Me),this.root=t`
