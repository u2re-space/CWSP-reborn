 ...
 * FullPath: apps/CWSP-reborn/src/backend/java/windows/space/u2re/cwsp/backend/windows/Settings.java
 * Change date and time: 16.42.00_10.07.2026
 * Reason for changes: Pass-II — Windows projection of the shared Java settings contract.
 */
...
/** Windows projection of shared settings helpers (parity with Node windows/settings.ts). */
