/*
 * Filename: Schema.ts
 * FullPath: apps/CWSP-reborn/src/protocol/web/packet/Schema.ts
 * Change date and time: 17.20.00_10.07.2026
 * Reason for changes: Thin web facade re-exporting canonical v2 validation helpers. | Alias migration 17.20.00_10.07.2026: long relative cwsp-shared imports -> @fest-lib/cwsp-shared/v2/*.
 *
