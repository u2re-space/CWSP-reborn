 ...
 * Reason for changes: Thin web facade re-exporting canonical packet builders for encoding. | Alias migration 17.20.00_10.07.2026: long relative cwsp-shared imports -> @fest-lib/cwsp-shared/v2/*.
 *
